...
import { KhamDoanGoiKhamSucKhoeTimKiem } from '../kham-doan-goi-kham-chung-suc-khoe.model';
...
@Component({
  ...
  templateUrl: './kham-doan-goi-kham-chung-suc-khoe-list.component.html',
  styleUrls: ['./kham-doan-goi-kham-chung-suc-khoe-list.component.scss']
})
export class KhamDoanGoiKhamChungSucKhoeListComponent implements OnInit {
  ...
  @ViewChild('maGoiKhamChungTemplate', { static: true }) maGoiKhamChungTemplate: TemplateRef<any>;
  ...
  ngOnInit() {
    ...
    if (this.route.snapshot.queryParams.holdQuery != undefined) {
      ...
      if (holdQuery != null && holdQuery) {
        var additionalSearchString = LocalStorageHelper.getItem<string>("additionalSearchStringKhamDoanDanhSachGoiKhamChung");
    ...
    if (!hasLocalSearchString) {
      ...
      LocalStorageHelper.removeItem("additionalSearchStringKhamDoanDanhSachGoiKhamChung");
    }
  ...
  timKiemNangCao() {
    ...
    LocalStorageHelper.setItem("additionalSearchStringKhamDoanDanhSachGoiKhamChung", queryString);
    this.grid.search();
  }
  ...
  xuLyXuatExcel() {
    ...
    if (this.authService.hasPermission(this.documentType, SecurityOperation.Process)) {
      this.apiService.postExportExcel<string>("KhamDoan/ExportDanhSachKhamSucKhoeDoanChung", this.grid._gridQueryInfo).subscribe(res => {
  ...
  xoa(Id: number) {
    if (this.authService.hasPermission(this.documentType, SecurityOperation.Delete)) {
      this.dialog.open(ConfirmComponent, {
        ...
        if (result == "Yes") {
          this.apiService.post<any>("KhamDoan/XoaGoiKhamSucKhoeDoanChung?id=" + Id).subscribe(() => {
