...
import { KhamDoanKhthDuyetTimKiem } from '../kham-doan-khth-duyet.model';
...
@Component({
    ...
    templateUrl: './kham-doan-khth-duyet-list.component.html',
    styleUrls: ['./kham-doan-khth-duyet-list.component.scss']
})
export class KhamDoanKhthDuyetListComponent implements OnInit {
    ...
    baseRoute = '/kham-doan/khth-duyet';
    ...
    timKiemObj: KhamDoanKhthDuyetTimKiem = new KhamDoanKhthDuyetTimKiem();
    ...
    ngOnInit() {
        ...
        if (holdQuery && LocalStorageHelper.getItem('additionalSearchStringDanhSachKHTHDuyetYeuCauNhanSuKhamSucKhoe')) {
            const additionalSearchString = LocalStorageHelper.getItem<string>('additionalSearchStringDanhSachKHTHDuyetYeuCauNhanSuKhamSucKhoe');
            ...
            LocalStorageHelper.removeItem("additionalSearchStringDanhSachKHTHDuyetYeuCauNhanSuKhamSucKhoe");
    ...
    timKiemNangCao() {
        ...
        const searchClone: KhamDoanKhthDuyetTimKiem = JSON.parse(JSON.stringify(this.timKiemObj));
        ...
        LocalStorageHelper.setItem('additionalSearchStringDanhSachKHTHDuyetYeuCauNhanSuKhamSucKhoe', this.strAdditionalSearchString);
