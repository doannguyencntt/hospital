...
@Component({
  ...
  templateUrl: './ket-qua-kham-suc-khoe-popup.component.html',
  styleUrls: ['./ket-qua-kham-suc-khoe-popup.component.scss']
})
export class KetQuaKhamSucKhoePopupComponent implements OnInit {
  icClose = icClose;
  ...
  getHtml() {
    ...
    this.apiService.postExportPdf<any>("KhamDoan/XuLyInKetQuaKhamSucKhoeAsync", obj).subscribe(res => {
