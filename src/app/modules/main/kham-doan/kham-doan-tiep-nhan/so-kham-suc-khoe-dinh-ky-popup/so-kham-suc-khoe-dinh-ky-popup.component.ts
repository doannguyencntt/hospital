...
@Component({
  ...
  templateUrl: './so-kham-suc-khoe-dinh-ky-popup.component.html',
  styleUrls: ['./so-kham-suc-khoe-dinh-ky-popup.component.scss']
})
export class SoKhamSucKhoeDinhKyPopupComponent implements OnInit {
  icClose = icClose;
  ...
  getHtml() {
    ...
    this.apiService.postExportPdf<string>("KhamDoan/XuLyInKhamSucKhoeAsync", obj).subscribe(res => {
  ...
  downloadFile() {
    ...
    CommonService.downLoadFile(this.file, 'application/pdf', 'SoKhamSucKhoeDinhKy' + dateTimeNow.getFullYear() + '.pdf');
  }
