...
import { KhamDoanNhanSuDuyetTimKiem } from '../kham-doan-nhan-su-duyet.model';
import { LoadingComponent } from 'src/app/shared/component/dialogs/loading/loading.component';

@Component({
    // tslint:disable-next-line: component-selector
    selector: 'app-kham-doan-nhan-su-duyet-list',
    templateUrl: './kham-doan-nhan-su-duyet-list.component.html',
    styleUrls: ['./kham-doan-nhan-su-duyet-list.component.scss']
})
export class KhamDoanNhanSuDuyetListComponent implements OnInit {
    ...
    baseRoute = '/kham-doan/nhan-su-duyet';
    ...
    urlGetData = 'KhamDoan/GetDataForYeuCauNhanSuKhamSucKhoePhongNhanSuGridAsync';
    urlTotalPage = 'KhamDoan/GetTotalPageForYeuCauNhanSuKhamSucKhoePhongNhanSuGridAsync';

    timKiemObj: KhamDoanNhanSuDuyetTimKiem = new KhamDoanNhanSuDuyetTimKiem();
    ...
    ngOnInit() {
        ...
        if (holdQuery && LocalStorageHelper.getItem('additionalSearchStringDanhSachNhanSuDuyetYeuCauNhanSuKhamSucKhoe')) {
            const additionalSearchString = LocalStorageHelper.getItem<string>
                ('additionalSearchStringDanhSachNhanSuDuyetYeuCauNhanSuKhamSucKhoe');
            ...
            LocalStorageHelper.removeItem("additionalSearchStringDanhSachNhanSuDuyetYeuCauNhanSuKhamSucKhoe");
    ...
    timKiemNangCao() {
        ...
        const searchClone: KhamDoanNhanSuDuyetTimKiem = JSON.parse(JSON.stringify(this.timKiemObj));
        ...
        LocalStorageHelper.setItem('additionalSearchStringDanhSachNhanSuDuyetYeuCauNhanSuKhamSucKhoe', this.strAdditionalSearchString);
