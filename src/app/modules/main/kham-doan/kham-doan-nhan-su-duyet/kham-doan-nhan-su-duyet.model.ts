...
export class KhamDoanNhanSuDuyetTimKiem {
    public constructor(
        public SearchString: string = null,
        public TrangThai: KhamDoanNhanSuDuyetTimKiemTrangThai = new KhamDoanNhanSuDuyetTimKiemTrangThai(),
        public NgayGui: KhamDoanNhanSuDuyetTimKiemDateRange = new KhamDoanNhanSuDuyetTimKiemDateRange(),
        public NgayKHTHDuyet: KhamDoanNhanSuDuyetTimKiemDateRange = new KhamDoanNhanSuDuyetTimKiemDateRange(),
        public NgayNhanSuDuyet: KhamDoanNhanSuDuyetTimKiemDateRange = new KhamDoanNhanSuDuyetTimKiemDateRange(),
        public NgayGiamDocDuyet: KhamDoanNhanSuDuyetTimKiemDateRange = new KhamDoanNhanSuDuyetTimKiemDateRange()
    ) { }
}

export class KhamDoanNhanSuDuyetTimKiemTrangThai {
    public constructor(
...
export class KhamDoanNhanSuDuyetTimKiemDateRange {
    public constructor(
