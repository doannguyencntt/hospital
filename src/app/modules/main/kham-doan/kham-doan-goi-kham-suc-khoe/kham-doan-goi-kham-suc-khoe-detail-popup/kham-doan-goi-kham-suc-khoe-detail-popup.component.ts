...
import { DichVuKhamSucKhoeDoanViewModel, GoiKhamSucKhoeNoiThucHienViewModel, KeyIdStringGoiDichVuKhamSucKhoeVo, KhamSucKhoeDoanViewModel } from '../kham-doan-goi-kham-suc-khoe.model';
...
@Component({
  ...
  templateUrl: './kham-doan-goi-kham-suc-khoe-detail-popup.component.html',
  styleUrls: ['./kham-doan-goi-kham-suc-khoe-detail-popup.component.scss']
})
export class KhamDoanGoiKhamSucKhoeDetailPopupComponent implements OnInit {
  @Input() dataKhamDoan: any;
  @Output() afterChangedFromHopDongKham = new EventEmitter<any>();

  khamSucKhoeDoan: KhamSucKhoeDoanViewModel = new KhamSucKhoeDoanViewModel();
  dichVuKhamSucKhoeDoan: DichVuKhamSucKhoeDoanViewModel = new DichVuKhamSucKhoeDoanViewModel();
  lstDichVuKhamSucKhoeDoanGrid: DichVuKhamSucKhoeDoanViewModel[] = [];
  ...
  getById(id: number) {
    ...
    if (self.authService.hasPermission(self.documentType, SecurityOperation.View)) {
      ...
      self.apiService.get<any>("KhamDoan/GetGoiKhamSucKhoeDoan?id=" + id).subscribe(
        resultData => {
          if (resultData != undefined && resultData != null) {
  ...
  themDichVu() {
    ...
    if (self.dichVuKhamSucKhoeDoan.GoiKhamSucKhoeNoiThucHiens != []) {
      self.dichVuKhamSucKhoeDoan.GoiKhamSucKhoeNoiThucHiens = new Array<GoiKhamSucKhoeNoiThucHienViewModel>();
    }
    ...
    self.apiService.post<DichVuKhamSucKhoeDoanViewModel>("KhamDoan/ThemDichVuKhamDoan", self.dichVuKhamSucKhoeDoan).subscribe(
      resultData => {
        if (resultData != undefined && resultData != null) {
  ...
  capNhatDichVu() {
    ...
    self.apiService.post<DichVuKhamSucKhoeDoanViewModel>("KhamDoan/CapNhatDichVuKhamDoan", dataUpdate).subscribe(
      resultData => {
        if (resultData != undefined && resultData != null) {
  ...
  xoaDichVu(dataItem: any) {
    this.dialog.open(ConfirmComponent, {
      ...
      if (result === 'Yes') {
        ...
        this.apiService.post<any>("KhamDoan/KiemTraNhanVienSuDungGoiKham?id=" + this.id).subscribe((res) => {
          if (res.Item1) {
