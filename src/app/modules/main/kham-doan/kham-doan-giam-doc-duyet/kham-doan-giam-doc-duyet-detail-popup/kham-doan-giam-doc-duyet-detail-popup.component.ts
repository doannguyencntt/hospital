...
import { YeuCauNhanSuKhamSucKhoeDetail } from '../kham-doan-giam-doc-duyet.model';
...
@Component({
    ...
    templateUrl: './kham-doan-giam-doc-duyet-detail-popup.component.html',
    styleUrls: ['./kham-doan-giam-doc-duyet-detail-popup.component.scss']
})
export class KhamDoanGiamDocDuyetDetailPopupComponent implements OnInit {
        ...
        if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
            this.dialog.open(ConfirmComponent, {
                ...
                .subscribe(result => {
                    if (result === 'Yes') {
                        this.apiService
                            .get<any>(`KhamDoan/DuyetGiamDoc?id=${this.id}`)
                            // tslint:disable-next-line: deprecation
                            .subscribe(
                                () => {
            ...
            this.dialog.open(KhamDoanKhthDuyetTuChoiPopupComponent, {
                ...
                .subscribe(result => {
                    if (result) {
                        ...
                        this.apiService
                            .post<any>('KhamDoan/TuChoiDuyetGiamDoc', requestTuChoi)
                            // tslint:disable-next-line: deprecation
                            .subscribe(
                                () => {
