...
export class KhamDoanGiamDocDuyetTimKiem {
    public constructor(
        public SearchString: string = null,
        public TrangThai: KhamDoanGiamDocDuyetTimKiemTrangThai = new KhamDoanGiamDocDuyetTimKiemTrangThai(),
        public NgayGui: KhamDoanGiamDocDuyetTimKiemDateRange = new KhamDoanGiamDocDuyetTimKiemDateRange(),
        public NgayKHTHDuyet: KhamDoanGiamDocDuyetTimKiemDateRange = new KhamDoanGiamDocDuyetTimKiemDateRange(),
        public NgayNhanSuDuyet: KhamDoanGiamDocDuyetTimKiemDateRange = new KhamDoanGiamDocDuyetTimKiemDateRange(),
        public NgayGiamDocDuyet: KhamDoanGiamDocDuyetTimKiemDateRange = new KhamDoanGiamDocDuyetTimKiemDateRange()
    ) { }
}

export class KhamDoanGiamDocDuyetTimKiemTrangThai {
    public constructor(
...
export class KhamDoanGiamDocDuyetTimKiemDateRange {
    public constructor(
