...
import { KhamDoanDaKetLuanSearch } from '../kham-doan-ket-luan-cls-ksk.model';


@Component({
  selector: 'app-kham-doan-da-ket-luan-ksk-list',
  templateUrl: './kham-doan-da-ket-luan-ksk-list.component.html',
  styleUrls: ['./kham-doan-da-ket-luan-ksk-list.component.scss']
})
export class KhamDoanDaKetLuanKskListComponent implements OnInit {
  ...
  backWithSearch() {
    ...
    if (this.route.snapshot.queryParams.holdQuery != undefined) {
      ...
      if (holdQuery != null && holdQuery) {
        var additionalSearchString = LocalStorageHelper.getItem<string>("additionalSearchStringKhamDoanDaKetLuanCLS");
    ...
    if (!hasLocalSearchString) {
      ...
      if (menuInfo.HinhThucKhamBenh != HinhThucKhamBenh.KhamDoanNgoaiVien) {
        LocalStorageHelper.removeItem("additionalSearchStringKhamDoanDaKetLuanCLS");
        ...
        queryString = JSON.stringify(this.khamDoanDaKetLuanSearch);
        LocalStorageHelper.setItem("additionalSearchStringKhamDoanDaKetLuanCLS", queryString);
      }
