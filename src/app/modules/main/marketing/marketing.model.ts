...
export class ChonGoiMarketing {
    constructor(
        public GoiMarketingId: number = null,
        public SoLuong: number = 1
    ) { }
}
export class GridGoiMarketingModel {
    constructor(
        public data: ThongTinGoiMarketingGridVo[] = [],
        public total: number = 0
    ) { }
}
export class ThongTinGoiMarketingGridVo {
    constructor(
        public Id: number = 0,
        public STT: number = 0,
        public TenGoi: string = null,
        public TenDisplay: string = null,
        public IsChecked: boolean = null,

        public TiLeChietKhau: number = null,
        public TiLeChietKhauDisplay: string = null,
        public GiaTruocChietKhau: number = null,
        public GiaSauChietKhau: number = null,
        public GiaTruocChietKhauDisplay: string = null,
        public GiaSauChietKhauDisplay: string = null,

        public TrangThai: number = null,
        public TrangThaiDisplay: number = null,

        public IsHaveGift: boolean = null,
        public CoCacDichVuKhac: boolean = null,

        public TongCong: number = null,
        public GiaGoi: number = null,
        public ChuaThu: number = null,
        public ChuaThuDisplay: string = null,
        public BenhNhanDaThanhToan: number = null,
        public BenhNhanDaThanhToanDisplay: string = null,
        public DangDung: number = null,
        public ConLai: number = null,
        public ConLaiDisplay: string = null,

        public GoiSoSinh: boolean = null,
        public NgayDangKy: Date = null,
        public NgayDangKyDisplay: string = null,
        public TrangThaiGoiDisplay: string = null,                
        public TrangThaiGoi: number = null,
        public NguoiDangKy: string = null,
    ) { }
}
