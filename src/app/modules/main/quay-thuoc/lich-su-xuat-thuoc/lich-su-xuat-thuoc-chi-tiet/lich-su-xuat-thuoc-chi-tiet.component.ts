...
import { BenhNhanThongTin, DanhSachThuoc, XacNhanInViewModel, XacNhanInThuocViewModel, XacNhanInThuocVatTuViewModel } from '../lich-su-xuat-thuoc.model';
...
@Component({
    ...
    templateUrl: './lich-su-xuat-thuoc-chi-tiet.component.html',
    styleUrls: ['./lich-su-xuat-thuoc-chi-tiet.component.scss']
})
export class LichSuXuatThuocChiTietComponent implements OnInit {
