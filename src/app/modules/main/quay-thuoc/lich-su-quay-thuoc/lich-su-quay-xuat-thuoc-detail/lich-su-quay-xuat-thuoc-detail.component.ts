...
import { BenhNhanThongTin, DanhSachThuoc, XacNhanInViewModel, XacNhanInThuocViewModel } from '../lich-su-quay-thuoc.model';
...
@Component({
    ...
    templateUrl: './lich-su-quay-xuat-thuoc-detail.component.html',
    styleUrls: ['./lich-su-quay-xuat-thuoc-detail.component.scss']
})
export class LichSuQuayXuatThuocDetailComponent implements OnInit {
    ...
    GetThongTinDonThuoc(id: number, idTaiKhoanBenhNhanThu: number) {
        ...
        if (self.authService.hasPermission(self.documentType, SecurityOperation.View)) {            
            self.apiService.post<Array<any>>
                ('QuayThuoc/GetDanhSachXuatThuocKhongBHYTLS?tiepNhanId=' + id + '&idTaiKhoanThu=' + idTaiKhoanBenhNhanThu).subscribe(
                    resultData => {
