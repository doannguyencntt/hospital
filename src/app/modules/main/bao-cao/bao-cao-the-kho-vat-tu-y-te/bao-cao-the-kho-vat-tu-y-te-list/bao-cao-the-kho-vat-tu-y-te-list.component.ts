...
import { BaoCaoTheKhoSearch } from '../bao-cao-the-kho-vat-tu-y-te.model';

@Component({
  selector: 'app-bao-cao-the-kho-vat-tu-y-te-list',
  templateUrl: './bao-cao-the-kho-vat-tu-y-te-list.component.html',
  styleUrls: ['./bao-cao-the-kho-vat-tu-y-te-list.component.scss']
})
export class BaoCaoTheKhoVatTuListComponent implements OnInit {
  ...
  urlGetDataGridChild = "BaoCaoVatTu/GetDataTheKhoVatTuForGridChildAsync";
  ...
  ngOnInit() {
    this.documentType = DocumentType.BaoCaoTheKhoVatTuYTe;
    ...
    this.gridColumns = [
      { Field: "STT", Title: "STT", Width: 20, hidden: true }, //0       
  ...
  XemBaoCao() {
    ...
    this.apiService.post<any>("BaoCaoVatTu/GetDataTheKhoVatTuForGridAsync", this.baoCaoTheKhoSearch).subscribe(resultData => {
  ...
  exportExcel() {
    ...
    if (this.authService.hasPermission(this.documentType, SecurityOperation.Process)) {
      ...
      this.apiService.postExportExcel<any>("BaoCaoVatTu/ExportTheKhoVatTu", this.baoCaoTheKhoSearch)
        .subscribe(res => {
          let dateTimeNow = new Date();
          CommonService.downLoadFile(res, "application/vnd.ms-excel", "BaoCaoXuatNhapTonVatTu" + dateTimeNow.getFullYear() + ".xlsx");
