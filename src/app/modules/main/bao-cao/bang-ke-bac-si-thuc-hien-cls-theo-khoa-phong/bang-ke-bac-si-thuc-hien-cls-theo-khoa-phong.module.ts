...
import { BangKeBacSiThucHienClsTheoKhoaPhongRoutingModule } from './bang-ke-bac-si-thuc-hien-cls-theo-khoa-phong-routing.module';
...
export class BangKeBacSiThucHienClsTheoKhoaPhongModule { }
