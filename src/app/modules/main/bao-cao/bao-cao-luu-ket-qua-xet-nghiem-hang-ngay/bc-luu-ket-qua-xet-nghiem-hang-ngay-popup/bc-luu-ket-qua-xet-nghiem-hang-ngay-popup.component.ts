...
@Component({
  ...
  templateUrl: './bc-luu-ket-qua-xet-nghiem-hang-ngay-popup.component.html',
  styleUrls: ['./bc-luu-ket-qua-xet-nghiem-hang-ngay-popup.component.scss']
})
export class BcLuuKetQuaXetNghiemHangNgayPopupComponent implements OnInit {
  icClose = icClose;
	...
	getALlFilePDFFromHtml(arrHtml) {
		...
		arrHtml.forEach((res) => {
			...
			this.apiService.postExportPdf<any>("BaoCao/GetFilePDFFromHtml", obj).subscribe(
				(file) => {
