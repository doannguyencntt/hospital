...
@Component({
  ...
  templateUrl: './thong-ke-thuoc-theo-bac-si-new.component.html',
  styleUrls: ['./thong-ke-thuoc-theo-bac-si-new.component.scss']
})
export class ThongKeThuocTheoBacSiNewComponent implements OnInit {
  ...
  xemBaoCao() {
    ...
    self.apiService.post<any>("BaoCao/ThongKeThuocTheoBacSiHTML",
