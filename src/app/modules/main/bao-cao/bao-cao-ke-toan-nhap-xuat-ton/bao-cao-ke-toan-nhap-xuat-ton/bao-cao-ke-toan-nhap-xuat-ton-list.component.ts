...
import { BaoCaoKeToanNhapXuatTonChiTietSearch, InBaoCaoKeToanNhapXuatTonChiTiet } from '../bao-cao-ke-toan-nhap-xuat-ton.model';

@Component({
  selector: 'app-bao-cao-ke-toan-nhap-xuat-ton-list',
  templateUrl: './bao-cao-ke-toan-nhap-xuat-ton-list.component.html',
  styleUrls: ['./bao-cao-ke-toan-nhap-xuat-ton-list.component.scss']
})

export class BaoCaoKeToanNhapXuatTonListComponent implements OnInit {
  ...
  ngOnInit() {
    this.documentType = DocumentType.BaoCaoNhapXuatTon;
  ...
  exportExcel() {
    ...
    if (this.authService.hasPermission(this.documentType, SecurityOperation.Process)) {
      ...
      this.apiService.postExportExcel<any>("BaoCao/ExportBaoCaoKTNhapXuatTon", this.baoCaoSearch)
        .subscribe(res => {
          let dateTimeNow = new Date();
          CommonService.downLoadFile(res, "application/vnd.ms-excel", "BaoCaoKTNhapXuatTon" + dateTimeNow.getFullYear() + ".xlsx");
