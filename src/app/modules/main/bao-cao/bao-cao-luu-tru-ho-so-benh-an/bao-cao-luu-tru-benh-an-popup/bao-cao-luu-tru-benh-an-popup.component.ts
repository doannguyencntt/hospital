...
@Component({
  ...
  templateUrl: './bao-cao-luu-tru-benh-an-popup.component.html',
  styleUrls: ['./bao-cao-luu-tru-benh-an-popup.component.scss']
})
export class BaoCaoLuuTruBenhAnPopupComponent implements OnInit {
  hostingName: string;
  modelPrint: any;
  src = '';
  icClose = icClose;
