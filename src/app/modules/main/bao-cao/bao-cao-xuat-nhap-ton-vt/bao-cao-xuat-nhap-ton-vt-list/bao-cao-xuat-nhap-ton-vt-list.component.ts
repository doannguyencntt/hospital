...
import { BaoCaoXuatNhapTonSearchVT, InBaoCaoXuatNhapTonVT } from '../bao-cao-xuat-nhap-ton-vt.model';
...
@Component({
  ...
  templateUrl: './bao-cao-xuat-nhap-ton-vt-list.component.html',
  styleUrls: ['./bao-cao-xuat-nhap-ton-vt-list.component.scss']
})
export class BaoCaoXuatNhapTonVtListComponent implements OnInit {

  baoCaoSearch: BaoCaoXuatNhapTonSearchVT = new BaoCaoXuatNhapTonSearchVT ();
  ...
  ngOnInit() {
    ...
    this.documentType = DocumentType.BaoCaoXNTVatTu;
    ...
    this.gridColumns = [
      ...
      { Field: "Ten", Title: "Tên vật tư", Width: 200, TemplateFooter: this.donGiaFooterTemplate, TemplateGroupFooter: this.donGiaGroupFooterTemplate },//1      
      { Field: "NuocSanXuat", Title: "Nước sản xuất", Width: 120 },//2
  ...
  exportExcel() {
    ...
    if (this.authService.hasPermission(this.documentType, SecurityOperation.Process)) {
      ...
      this.apiService.postExportExcel<any>("BaoCao/ExportBaoCaoXuatNhapTonVT", this.baoCaoSearch)
        .subscribe(res => {
          let dateTimeNow = new Date();
          CommonService.downLoadFile(res, "application/vnd.ms-excel", "BaoCaoXuatNhapTonVT" + dateTimeNow.getFullYear() + ".xlsx");
  ...
  XemBaoCao() {
    ...
    this.baoCaoSearch.FromDate = this.baoCaoSearch.TuNgayFormat;
    this.baoCaoSearch.ToDate = this.baoCaoSearch.DenNgayFormat;
    this.apiService.post<any>("BaoCao/GetDataBaoCaoXuatNhapTonVTForGridAsync", this.baoCaoSearch).subscribe(resultData => {
  ...
  InBaoCao() {
    ...
    this.dialog.open(BaoCaoXuatNhapTonVtPopupComponent, {
      disableClose: false,
      width: '1200px',
