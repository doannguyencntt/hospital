...
import { BaoCaoSoPhucTrinhPhauThuatThuThuatRoutingModule } from './bao-cao-so-phuc-trinh-phau-thuat-thu-thuat-routing.module';
import { BaoCaoSoPhucTrinhPhauThuatThuThuatService } from './bao-cao-so-phuc-trinh-phau-thuat-thu-thuat.service';
...
@NgModule({
  ...
  providers: [
    ...
    { provide: BaseService, useClass: BaoCaoSoPhucTrinhPhauThuatThuThuatService },
  ],
  entryComponents: [

  ]
})
export class BaoCaoSoPhucTrinhPhauThuatThuThuatModule { }