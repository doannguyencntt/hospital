...
@Component({
  ...
  templateUrl: './bao-cao-bs-ds-kham-ngoai-tru-popup.component.html',
  styleUrls: ['./bao-cao-bs-ds-kham-ngoai-tru-popup.component.scss']
})
export class BaoCaoBsDsKhamNgoaiTruPopupComponent implements OnInit {
  hostingName: string;
  modelPrint: any;
  src = '';
  icClose = icClose;
