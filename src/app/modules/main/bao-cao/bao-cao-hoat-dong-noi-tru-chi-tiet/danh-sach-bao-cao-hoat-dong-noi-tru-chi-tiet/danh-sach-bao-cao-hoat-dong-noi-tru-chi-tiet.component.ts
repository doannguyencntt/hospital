...
import { BaoCaoHoatDongNoiTruChiTiet } from '../bao-cao-hoat-dong-noi-tru-chi-tiet';
...
@Component({
  ...
  templateUrl: './danh-sach-bao-cao-hoat-dong-noi-tru-chi-tiet.component.html',
  styleUrls: ['./danh-sach-bao-cao-hoat-dong-noi-tru-chi-tiet.component.scss'],
  encapsulation: ViewEncapsulation.None,
})

export class DanhSachBaoCaoHoatDongNoiTruChiTietComponent implements OnInit {
  baoCaoSearch: BaoCaoHoatDongNoiTruChiTiet = new BaoCaoHoatDongNoiTruChiTiet();
  ...
  ngOnInit() {
    this.documentType = DocumentType.BaoCaoHoatDongNoiTruChiTiet;
  ...
  xemBaoCao() {
    ...
    this.apiService.post<any>("BaoCao/GetDataBaoCaoHoatDongNoiTruChiTietForGrid", this.baoCaoSearch).subscribe(resultData => {
  ...
  xuatBaoCao() {
    ...
    if (self.authService.hasPermission(self.documentType, SecurityOperation.Process)) {
      ...
      self.apiService.postExportExcel<string>
        ('BaoCao/ExportBaoCaoHoatDongNoiTruChiTiet', this.baoCaoSearch)
        .subscribe(
          resultData => {
            self.dialog.closeAll();
            const dateTimeNow = new Date();
            CommonService.downLoadFile(resultData, 'application/vnd.ms-excel',
              'BaoCaoHoatDongNoiTruChiTiet' + dateTimeNow.getFullYear() + '.xlsx');
          },
          (err: any) => {
