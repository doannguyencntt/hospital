...
@Component({
  ...
  templateUrl: './bao-cao-ket-qua-kham-chua-benh-popup.component.html',
  styleUrls: ['./bao-cao-ket-qua-kham-chua-benh-popup.component.scss']
})
export class BaoCaoKetQuaKhamChuaBenhPopupComponent implements OnInit {
  hosting: string;
  modelPrint: any;
  src = '';
  icClose = icClose;
