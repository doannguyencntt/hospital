...
@Component({
  ...
  templateUrl: './noi-dung-mau-email-sms-notify-list.component.html',
  styleUrls: ['./noi-dung-mau-email-sms-notify-list.component.scss']
})
export class NoiDungMauEmailSmsNotifyListComponent implements OnInit {
  ...
  ngOnInit() {
    this.documentType = DocumentType.QuanLyCacMessagingTemplate;
    this.gridColumns = [
  ...
  exportExcel() {
    ...
    if(this.authService.hasPermission(this.documentType, SecurityOperation.Process)) {
      this.apiService.postExportExcel<string>("TemplateEmail/ExportTemplate", this.gridChild._gridQueryInfo).subscribe(res => {
        let dateTimeNow = new Date();
        CommonService.downLoadFile(res, "application/vnd.ms-excel", "NoiDungMau" + dateTimeNow.getFullYear() + ".xlsx");
