...
@Component({
  ...
  templateUrl: './ho-so-nhan-vien-update.component.html',
  styleUrls: ['./ho-so-nhan-vien-update.component.scss'],
  animations: [
    stagger60ms,
    fadeInUp400ms
  ]
})
export class HoSoNhanVienUpdateComponent implements OnInit {

  @ViewChild(HoSoNhanVienShareComponent, { static: true }) shared;
  @ViewChild("updateNhanVien", { static: false }) updateNhanVien: FormfooterComponent;
