import { Component, Inject, IterableDiffers, OnInit, TemplateRef, ViewChild } from '@angular/core';
...
import { ChiDinhGoiDichVuTheoBenhNhanTiemChung, ChiTietGoiDichVuChiDinhTheoBenhNhanTiemChung, GoiDichVuMarketingDangChonTiemChung } from '../dich-vu/dich-vu.model';
...
@Component({
    selector: 'app-su-dung-goi-dich-vu-popup',
    templateUrl: './su-dung-goi-dich-vu-popup.component.html',
    styleUrls: ['./su-dung-goi-dich-vu-popup.component.scss']
})

export class SuDungGoiDichVuPopupComponent implements OnInit {
    ...
    arrChiTietDichVuDaXem: Array<ChiTietGoiDichVuChiDinhTheoBenhNhanTiemChung> = new Array<ChiTietGoiDichVuChiDinhTheoBenhNhanTiemChung>();
    arrChiTietDichVuDaChon: Array<ChiTietGoiDichVuChiDinhTheoBenhNhanTiemChung> = new Array<ChiTietGoiDichVuChiDinhTheoBenhNhanTiemChung>();
    arrGoiDangChon: Array<GoiDichVuMarketingDangChonTiemChung> = new Array<GoiDichVuMarketingDangChonTiemChung>();
    ...
    public dialogRef: MatDialogRef<SuDungGoiDichVuPopupComponent>,
    ...
    chonDichVu(event, dataItem)
    {
      if(event)
      {
        ...
        {
          var newElement = new ChiTietGoiDichVuChiDinhTheoBenhNhanTiemChung(
            dataItem.Id,
      ...
      if (event.Data.length > 0) {
        event.Data.forEach(element => {
          ...
          if (indexGoiDangChon == -1) {
            this.arrGoiDangChon.push(new GoiDichVuMarketingDangChonTiemChung(
              element.Id,
              element.TenGoiDichVu,
              element.ConLai,
              []
    ...
    luuDichVuChiDinh() {
      ...
      let yeuCauGoiMarketing: ChiDinhGoiDichVuTheoBenhNhanTiemChung = new ChiDinhGoiDichVuTheoBenhNhanTiemChung();
