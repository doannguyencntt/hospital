...
import { HoanTraThuocVatTuTiemChung, ThongTinHoanTraVatTuThuocTiemChung } from '../thuoc-vat-tu/thuoc-vat-tu.model';

import icClose from '@iconify/icons-ic/twotone-close';

@Component({
  selector: 'app-thuoc-vat-tu-hoan-tra-popup',
  templateUrl: './thuoc-vat-tu-hoan-tra-popup.component.html',
  styleUrls: ['./thuoc-vat-tu-hoan-tra-popup.component.scss']
})

export class ThuocVatTuHoanTraPopupComponent implements OnInit {
    thongTinTraVT: HoanTraThuocVatTuTiemChung = new HoanTraThuocVatTuTiemChung();
    thongTinHoanTraVTVo: ThongTinHoanTraVatTuThuocTiemChung = new ThongTinHoanTraVatTuThuocTiemChung();
    ...
    constructor(private dialog: MatDialog, @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<ThuocVatTuHoanTraPopupComponent>,
