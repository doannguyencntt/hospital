...
@Component({
    selector: 'app-dich-vu-nhom-dich-vu-loi-popup',
    templateUrl: './dich-vu-nhom-dich-vu-loi-popup.component.html',
    styleUrls: ['./dich-vu-nhom-dich-vu-loi-popup.component.scss']
})

export class DichVuNhomDichVuLoiPopupComponent implements OnInit {
    icClose = icClose;
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<DichVuNhomDichVuLoiPopupComponent>) { }
