...
@Component({
  ...
  templateUrl: './tiem-chung-nhom-dich-vu-loi-popup.component.html',
  styleUrls: ['./tiem-chung-nhom-dich-vu-loi-popup.component.scss']
})
export class TiemChungNhomDichVuLoiPopupComponent implements OnInit {
  ...
  public dialogRef: MatDialogRef<TiemChungNhomDichVuLoiPopupComponent>) { }
