...
@Component({
  selector: 'app-hoan-thanh-kham-tiem-chung-detail-popup',
  templateUrl: './hoan-thanh-kham-tiem-chung-detail-popup.component.html',
  styleUrls: ['./hoan-thanh-kham-tiem-chung-detail-popup.component.scss']
})
export class HoanThanhKhamTiemChungDetailPopupComponent implements OnInit {

  icClose = icClose;

  yeuCauKhamTiemChung: YeuCauDichVuKyThuat;
  documentType: DocumentType = DocumentType.TiemChungKhamSangLoc;
  isTabThucHienTiemDisplayed: boolean = false;
  yeuCauKhamTiemChungId: number;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<HoanThanhKhamTiemChungDetailPopupComponent>
  ) { }
  ...
  ngOnInit() {
    ...
    this.isTabThucHienTiemDisplayed = this.data.LoaiHangDoi == LaiHangDoiTiemVacxin.ThucHienTiem;
    this.getChiTietKhamTiemChung(this.yeuCauKhamTiemChungId);
  }
  ...
  getChiTietKhamTiemChung(yeuCauKhamTiemChungId: number = null) {
    ...
    var obj = {
      ...
      "LoaiHangDoi": LaiHangDoiTiemVacxin.LichSuTiem
    }
