...
@Component({
    selector: 'app-lich-su-tiem-chung-chi-tiet-shared',
    templateUrl: './lich-su-tiem-chung-chi-tiet-shared.component.html',
    styleUrls: ['./lich-su-tiem-chung-chi-tiet-shared.component.scss']
})

export class LichSuTiemChungChiTietSharedComponent implements OnInit {
    ...
    @Input() yeuCauKhamTiemChungId: number = null;
    ...
    quayLai() {
        this.router.navigateByUrl('/tiem-chung/lich-su-tiem?holdQuery=true');
    }
}