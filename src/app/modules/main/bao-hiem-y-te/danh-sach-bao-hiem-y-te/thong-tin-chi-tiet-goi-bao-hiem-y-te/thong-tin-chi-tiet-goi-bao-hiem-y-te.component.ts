...
import { XMLThongTinBenhNhan, HoSoChiTietThuoc, HoSoChiTietDVKT, HoSoCanLamSang, HoSoChiTietDienBienBenh, ThongTinBenhNhanViewModels, GoiDanhSachThongTinBenhNhanCoBHYT, DanhSachYeuCauTiepNhanIds, EnumTypeLoadingData } from "../bao-hiem-y-te";
...
@Component({
  ...
  templateUrl: "./thong-tin-chi-tiet-goi-bao-hiem-y-te.component.html",
  styleUrls: ["./thong-tin-chi-tiet-goi-bao-hiem-y-te.component.scss"],
  encapsulation: ViewEncapsulation.None
})

export class ThongTinChiTietGoiBaoHiemYTeComponent implements OnInit {
  public readonly: boolean = false;
  public thongtinbenhnhan: XMLThongTinBenhNhan;
  public thongTinBenhNhanViewModels = {} as ThongTinBenhNhanViewModels;
  ...
  public icWarning = icWarning;
  public showWarningMessages = Array<any>();
  public showHTMLWarningMessagesPopup = Array<any>();
  ...
  getThongBenhNhanTheoYeuCauTiepNhan(id: number) {
    const self = this;
    ...
    self.apiService.post<XMLThongTinBenhNhan>(`BHYT/GetThongTinHoSoGiamDinhs`, self.danhSachYeuCauTiepNhanIds).subscribe((resultData) => {
  ...
  goiHoSoGiamDinhNguoiBenh() {
    ...
    self.confrim = self.dialog.open(ConfirmComponent, {
      ...
      if (result == "Yes") {
        ...
        self.thongtinbenhnhan.IsDownLoad = true;
        self.apiService.post<any>(`BHYT/GuiChiTietTungHoSoGiamDinhNguoiBenhs`, self.thongtinbenhnhan).subscribe(
          (resultData) => {
