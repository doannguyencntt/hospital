...
@Component({
  ...
  templateUrl: './toa-thuoc-kham-benh-confirm.component.html',
  styleUrls: ['./toa-thuoc-kham-benh-confirm.component.scss']
})
export class ToaThuocKhamBenhConfirmComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<ToaThuocKhamBenhConfirmComponent>,
