...
import { RaVienNoiTruNgoaiKhoaThamMy, ThongTinChuanDoanKemTheo } from '../thong-tin-ra-vien.model';
...
@Component({
  selector: 'app-thong-tin-ngoai-khoa-tham-my',
  templateUrl: './thong-tin-ngoai-khoa-tham-my.component.html',
  styleUrls: ['./thong-tin-ngoai-khoa-tham-my.component.scss']
})
export class ThongTinNgoaiKhoaThamMyComponent implements OnInit {
  ...
  raVienNoiTru = new RaVienNoiTruNgoaiKhoaThamMy();
  ...
  getThongTinRaVien(id: any) {
    if (this.authService.hasPermission(this.documentType, SecurityOperation.View)) {
      this.apiService.get<any>("DieuTriNoiTru/GetRaVienNoiTruNgoaiKhoaThamMy/" + id)
  ...
  LuuThongTinBenhRaVien(inVaLuu: any) {
    ...
    this.apiService.post<any>("DieuTriNoiTru/LuuHoacCapNhatRaVienNoiKhoaThamMy", this.raVienNoiTru)
      .subscribe((resultData) => {
        if (inVaLuu) {
  ...
  ketThucThongTinBenhAnNgoaiKhoaVaThamMy() {
    this.validationErrors = [];
    this.cdRef.detectChanges();
    ...
    if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
      this.dialog.open(ConfirmComponent, {
        ...
        if (result === 'Yes') {
          this.raVienNoiTru.ChuanDoanKemTheos = this.dataSourceICDsPhuKhac.data;
          this.raVienNoiTru.YeuCauTiepNhanId = this.yeuCauTiepNhanId;
          this.apiService.post<any>("DieuTriNoiTru/KetThucThongTinBenhAnNgoaiKhoaThamMy", this.raVienNoiTru)
            .subscribe((resultData) => {
              this.validationErrors = [];
  ...
  moThongTinBenhAnNgoaiKhoaVaThamMy() {
    if (this.authService.hasPermission(this.documentTypeMoLaiBenhAn, SecurityOperation.Update)) {
      this.dialog.open(ConfirmComponent, {
        ...
        if (result === 'Yes') {
          this.raVienNoiTru.ChuanDoanKemTheos = this.dataSourceICDsPhuKhac.data;
          this.raVienNoiTru.YeuCauTiepNhanId = this.yeuCauTiepNhanId;
          this.apiService.post<any>("DieuTriNoiTru/MoThongTinBenhAnNgoaiKhoaThamMy", this.raVienNoiTru)
            .subscribe((resultData) => {
