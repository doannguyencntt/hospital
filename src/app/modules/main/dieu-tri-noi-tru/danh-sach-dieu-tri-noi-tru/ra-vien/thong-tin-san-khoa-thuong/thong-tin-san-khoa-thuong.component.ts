...
@Component({
  selector: 'app-thong-tin-san-khoa-thuong',
  templateUrl: './thong-tin-san-khoa-thuong.component.html',
  styleUrls: ['./thong-tin-san-khoa-thuong.component.scss']
})
export class ThongTinSanKhoaComponent implements OnInit {
  ...
  getThongTinRaVien(id: any) {
    if (this.authService.hasPermission(this.documentType, SecurityOperation.View)) {
      this.apiService.get<any>("DieuTriNoiTru/GetRaVienNoiTruSanKhoaThuong/" + id)
  ...
  LuuThongTinBenhRaVien(inVaLuu: any) {
    ...
    this.apiService.post<any>("DieuTriNoiTru/LuuHoacCapNhatRaVienNoiTruSanKhoaThuong", this.raVienNoiTru)
      .subscribe((resultData) => {
        if (inVaLuu) {
  ...
  ketThucThongTinBenhAnSanKhoaThuong() {
    this.validationErrors = [];
    this.cdRef.detectChanges();
    ...
    if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
      this.dialog.open(ConfirmComponent, {
        ...
        if (result === 'Yes') {
          this.validationErrors = [];
          this.raVienNoiTru.YeuCauTiepNhanId = this.yeuCauTiepNhanId;
          this.apiService.post<any>("DieuTriNoiTru/KetThucThongTinBenhAnSanKhoaThuong", this.raVienNoiTru)
            .subscribe((resultData) => {
  ...
  moThongTinBenhAnSanKhoaThuong() {
    if (this.authService.hasPermission(this.documentTypeMoLaiBenhAn, SecurityOperation.Update)) {
      this.dialog.open(ConfirmComponent, {
        ...
        if (result === 'Yes') {
          this.raVienNoiTru.YeuCauTiepNhanId = this.yeuCauTiepNhanId;
          this.apiService.post<any>("DieuTriNoiTru/MoThongTinBenhAnSanKhoaThuong", this.raVienNoiTru)
            .subscribe((resultData) => {
