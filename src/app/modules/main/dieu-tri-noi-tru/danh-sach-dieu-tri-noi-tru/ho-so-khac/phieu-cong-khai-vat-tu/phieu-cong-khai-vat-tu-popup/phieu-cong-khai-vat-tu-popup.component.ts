...
@Component({
  selector: 'app-phieu-cong-khai-vat-tu-popup',
  templateUrl: './phieu-cong-khai-vat-tu-popup.component.html',
  styleUrls: ['./phieu-cong-khai-vat-tu-popup.component.scss']
})
export class PhieuCongKhaiVatTuPopupComponent implements OnInit {
