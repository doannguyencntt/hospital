...
@Component({
  selector: 'app-bang-kiem-at-nguoi-benh-pt-popup',
  templateUrl: './bang-kiem-at-nguoi-benh-pt-popup.component.html',
  styleUrls: ['./bang-kiem-at-nguoi-benh-pt-popup.component.scss']
})
export class BangKiemAtNguoiBenhPtPopupComponent implements OnInit {
  hostingName: string;
  modelPrint: any;
  src = '';
  icClose = icClose;
