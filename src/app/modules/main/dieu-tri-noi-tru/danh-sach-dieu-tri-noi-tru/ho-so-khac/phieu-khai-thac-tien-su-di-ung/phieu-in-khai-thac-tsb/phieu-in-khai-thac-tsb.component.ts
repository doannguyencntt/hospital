...
@Component({
  selector: 'app-phieu-in-khai-thac-tsb',
  templateUrl: './phieu-in-khai-thac-tsb.component.html',
  styleUrls: ['./phieu-in-khai-thac-tsb.component.scss']
})
export class PhieuInKhaiThacTsbComponent implements OnInit {
  hostingName: string;
  modelPrint: any;
  src = '';
  icClose = icClose;
