...
import { GiayKhamChuaBenhTheoYcMessage, SystemMessage } from 'src/app/shared/configdata/system-message';
import { DocumentType } from 'src/app/shared/enum/document-type.enum';
import { ApiError } from 'src/app/shared/models/api-error.model';
import { GiayKhamChuaBenhTheoYc } from './giay-kham-chua-benh-theo-yc.model';
import { LoadingComponent } from 'src/app/shared/component/dialogs/loading/loading.component';
import { GiayKhamChuaBenhTheoYcPopupComponent } from '../giay-kham-chua-benh-theo-yc-popup/giay-kham-chua-benh-theo-yc-popup.component';
...
@Component({
    ...
    selector: 'app-giay-kham-chua-benh-theo-yc',
    templateUrl: './giay-kham-chua-benh-theo-yc.component.html',
    styleUrls: ['./giay-kham-chua-benh-theo-yc.component.scss']
})
export class GiayKhamChuaBenhTheoYcComponent implements OnInit {
    @Input() dieuTriNoiTruModel: ChiTietDieuTriNoiTruViewModel;
    documentType: DocumentType = DocumentType.DanhSachDieuTriNoiTru;
    validationErrors: any[] = [];
    filterSourceServer = [];
    giayKhamChuaBenhTheoYc = new GiayKhamChuaBenhTheoYc();
    id: number ;
    newEmployee = '';
    ...
    getById(id: number) {
        this.apiService.get<any>
            (`DieuTriNoiTru/GetGiayKhamChuaBenhTheoYc?yeuCauTiepNhanId=${id}`).subscribe(resultData => {
                this.giayKhamChuaBenhTheoYc = { ...resultData };
                if(this.giayKhamChuaBenhTheoYc.GioiTinhNguoiThan == null)
                {
                    this.giayKhamChuaBenhTheoYc.GioiTinhNguoiThan = 1;
                }
    ...
    print() {
        ...
        this.apiService.post<any>
            (`DieuTriNoiTru/UpdateGiayKhamChuaBenhTheoYc?yeuCauTiepNhanId=${this.id}`, this.giayKhamChuaBenhTheoYc)
            .subscribe(res => {
                this.giayKhamChuaBenhTheoYc = { ...res };
                this.returnId.emit(this.giayKhamChuaBenhTheoYc.IdNoiTruHoSo);
                const yeuCauTiepNhanId = this.id;
                this.dialog.open(GiayKhamChuaBenhTheoYcPopupComponent, {
                    disableClose: false,
                    width: '1200px',
    ...
    validation() {
        ...
        if (!this.giayKhamChuaBenhTheoYc.HoTenNguoiThan && this.giayKhamChuaBenhTheoYc.TaoLaAi === 1) {
            const validationItem = {
                Field: 'HoTen',
                Message: GiayKhamChuaBenhTheoYcMessage.MessageHoTenNotEmpty
            };
            validationResult.push(validationItem);
        }

        if (!this.giayKhamChuaBenhTheoYc.NamSinhNguoiThan && this.giayKhamChuaBenhTheoYc.TaoLaAi === 1) {
            const validationItem = {
                Field: 'NamSinhNguoiThan',
                Message: GiayKhamChuaBenhTheoYcMessage.MessageNamSinhNotEmpty
            };
            validationResult.push(validationItem);
        }

        if (!this.giayKhamChuaBenhTheoYc.GioiTinhNguoiThan && this.giayKhamChuaBenhTheoYc.TaoLaAi === 1) {
            const validationItem = {
                Field: 'GioiTinhNguoiThan',
                Message: GiayKhamChuaBenhTheoYcMessage.MessageGioiTinhNotEmpty
            };
            validationResult.push(validationItem);
        }

        if (!this.giayKhamChuaBenhTheoYc.DiaChiNguoiThan && this.giayKhamChuaBenhTheoYc.TaoLaAi === 1) {
            const validationItem = {
                Field: 'DiaChi',
                Message: GiayKhamChuaBenhTheoYcMessage.MessageDiaChiNotEmpty
            };
            validationResult.push(validationItem);
        }

        if (!this.giayKhamChuaBenhTheoYc.NgayThucHien) {
            const validationItem = {
                Field: 'NgayThucHien',
                Message: GiayKhamChuaBenhTheoYcMessage.MessageNgayThucHienNotEmpty
            };
            validationResult.push(validationItem);
        }
    ...
    save() {
        ...
        this.apiService.post<any>
            ...
            .subscribe(res => {
                ...
                this.getById( this.giayKhamChuaBenhTheoYc.IdNoiTruHoSo);
    ...
    changeNumberToLiteral(number: number) {
        if (!number) {
            this.giayKhamChuaBenhTheoYc.SoTienChu = null;
            return;
        }
        ...
        this.giayKhamChuaBenhTheoYc.SoTienChu = `(${letter[1].toUpperCase()}${letter.slice(2)}`;
    }
