...
import { GiayCamKetKyThuatMoiHS } from './giay-cam-ket-kt-moi-gay-me-hs.model';
import { GiayCamKetKtMoiGayMeHsPopupComponent } from '../giay-cam-ket-kt-moi-gay-me-hs-popup/giay-cam-ket-kt-moi-gay-me-hs-popup.component';

@Component({
  selector: 'app-giay-cam-ket-kt-moi-gay-me-hs',
  templateUrl: './giay-cam-ket-kt-moi-gay-me-hs.component.html',
  styleUrls: ['./giay-cam-ket-kt-moi-gay-me-hs.component.scss']
})
export class GiayCamKetKtMoiGayMeHsComponent implements OnInit {

  @Input() dieuTriNoiTruModel: ChiTietDieuTriNoiTruViewModel;
  documentType: DocumentType = DocumentType.DanhSachDieuTriNoiTru;
  validationErrors: any[] = [];
  filterSourceServer = [];
  giayCamKetKyThuatMoiHS = new GiayCamKetKyThuatMoiHS();
  id: number;
  newEmployee = '';
  ...
  changeTaoLaAi(event){
      this.giayCamKetKyThuatMoiHS.GioiTinh = 1;
  }
  getById(id: number) {
      this.apiService.get<any>
          (`DieuTriNoiTru/GetGiayCamKetKyThuatMoiHS?yeuCauTiepNhanId=${id}`).subscribe(resultData => {
              this.giayCamKetKyThuatMoiHS = { ...resultData };
              this.returnId.emit(this.giayCamKetKyThuatMoiHS.IdNoiTruHoSo);
  ...
  print() {
      this.dialog.open(ConfirmComponent, {
          ...
          if (res == "Yes") {
              ...
              (`DieuTriNoiTru/UpdateGiayCamKetKyThuatMoiHS?yeuCauTiepNhanId=${this.id}`, this.giayCamKetKyThuatMoiHS)
              .subscribe(res => {
                  this.giayCamKetKyThuatMoiHS = { ...res };
                  ...
                  this.dialog.open(GiayCamKetKtMoiGayMeHsPopupComponent, {
                      disableClose: false,
                      width: '1200px',
  ...
  validation() {
      ...
      if (!this.giayCamKetKyThuatMoiHS.HoTen && this.giayCamKetKyThuatMoiHS.TaoLaAi === 1) {
      ...
      if (this.giayCamKetKyThuatMoiHS.NamSinh != null){
          let year :number = yearNow.getFullYear();
          if (this.giayCamKetKyThuatMoiHS.NamSinh >  year && this.giayCamKetKyThuatMoiHS.TaoLaAi === 1) {
              const validationItem = {
                  Field: 'NamSinh',
      ...
      if (!this.giayCamKetKyThuatMoiHS.NgayThucHien) {
          const validationItem = {
              Field: 'NgayThucHien',
  ...
  changeNumberToLiteral(number: number) {
      if (!number) {
          this.giayCamKetKyThuatMoiHS.SoTienChu = null;
          return;
      }
      ...
      this.giayCamKetKyThuatMoiHS.SoTienChu = `(${letter[1].toUpperCase()}${letter.slice(2)}`;
  }
