...
@Component({
  selector: 'app-phieu-theo-doi-truyen-dich-popup',
  templateUrl: './phieu-theo-doi-truyen-dich-popup.component.html',
  styleUrls: ['./phieu-theo-doi-truyen-dich-popup.component.scss']
})
export class PhieuTheoDoiTruyenDichPopupComponent implements OnInit {
