...
@Component({
  selector: 'app-giay-ck-tu-nguyen-sd-thuoc-popup',
  templateUrl: './giay-ck-tu-nguyen-sd-thuoc-popup.component.html',
  styleUrls: ['./giay-ck-tu-nguyen-sd-thuoc-popup.component.scss']
})
export class GiayCkTuNguyenSdThuocPopupComponent implements OnInit {
  hostingName: string;
  modelPrint: any;
  src = '';
  icClose = icClose;
