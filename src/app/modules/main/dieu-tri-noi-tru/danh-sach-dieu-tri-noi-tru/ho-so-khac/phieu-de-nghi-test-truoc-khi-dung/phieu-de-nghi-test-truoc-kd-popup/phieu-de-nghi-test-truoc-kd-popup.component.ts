...
@Component({
  selector: 'app-phieu-de-nghi-test-truoc-kd-popup',
  templateUrl: './phieu-de-nghi-test-truoc-kd-popup.component.html',
  styleUrls: ['./phieu-de-nghi-test-truoc-kd-popup.component.scss']
})
export class PhieuDeNghiTestTruocKdPopupComponent implements OnInit {
