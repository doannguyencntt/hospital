...
@Component({
  ...
  templateUrl: './in-phieu-dang-ky-kham-popup.component.html',
  styleUrls: ['./in-phieu-dang-ky-kham-popup.component.scss']
})
export class InPhieuDangKyKhamPopupComponent implements OnInit {
