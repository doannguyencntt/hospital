...
@Component({
  ...
  templateUrl: './popup-lich-su-kiem-tra-bhyt.component.html',
  styleUrls: ['./popup-lich-su-kiem-tra-bhyt.component.scss']
})
export class PopupLichSuKiemTraBhytComponent implements OnInit {
  ...
  , private dialog: MatDialog, public dialogRef: MatDialogRef<PopupLichSuKiemTraBhytComponent>) { }
