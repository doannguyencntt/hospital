...
import { TrangThaiYeuCauKhamBenhObjEnum, TrangThaiYeuCauDichVuKyThuatObjEnum, ChiDinhGhiNhanVatTuThuocPTTT, GridItemGhiNhanVatTuThuocPTTT, PTTTHoanTraThuocVatTuVo, PTTTVatTuThuoc } from '../../../phau-thuat-thu-thuat/phau-thuat-thu-thuat.model';
...
@Component({
    ...
    templateUrl: "./ghi-nhan-vat-tu-thuoc.component.html",
    styleUrls: ["./ghi-nhan-vat-tu-thuoc.component.scss"],
    animations: [stagger60ms, fadeInUp400ms],
})

export class CĐHAGhiNhanVatTuThuocComponent implements OnInit {
    ...
    xuLyThemGhiNhanVatTuBenhVien() {
        ...
        this.chiDinhGhiNhanVatTuThuoc.LoaiNoiChiDinh = EnumLoaiNoiChiDinh.ChanDoanHinhAnh;
    ...
    hoanTra(dataItem: any) {
        ...
        if (this.authService.hasPermission(this.documentType, SecurityOperation.View)) {
            this.dialog.open(GhiNhanHoanTraPopupComponent, {
                disableClose: false,
                width: '1000px',
    ...
    suaVatTuThuoc(dataItem: any) {
        ...
        if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
            this.dialog.open(GhiNhanCapNhatPopupComponent, {
                disableClose: false,
                width: '600px',
