...
import { PTTTVatTuThuoc, PTTTVatTuThuocTonKho } from '../../../phau-thuat-thu-thuat/phau-thuat-thu-thuat.model';

@Component({
  selector: 'app-ghi-nhan-cap-nhat-popup',
  templateUrl: './ghi-nhan-cap-nhat-popup.component.html',
  styleUrls: ['./ghi-nhan-cap-nhat-popup.component.scss']
})
export class GhiNhanCapNhatPopupComponent implements OnInit {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<GhiNhanCapNhatPopupComponent>, private dialog: MatDialog,
