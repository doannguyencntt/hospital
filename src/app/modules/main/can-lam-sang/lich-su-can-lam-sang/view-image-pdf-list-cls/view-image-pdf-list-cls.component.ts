...
@Component({
  ...
  templateUrl: './view-image-pdf-list-cls.component.html',
  styleUrls: ['./view-image-pdf-list-cls.component.scss']
})
export class ViewImagePdfListClsComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    ...
    private http: Http,
    private dialogRef: MatDialogRef<ViewImagePdfListClsComponent>) {
