...
@Component({
  ...
  templateUrl: './cong-no-benh-nhan-het-no.component.html',
  styleUrls: ['./cong-no-benh-nhan-het-no.component.scss']
})

export class CongNoBenhNhanHetNoComponent implements OnInit,AfterContentInit {
    ...
    urlGetDanhSachBenhNhanConNo = `CongNoBenhNhan/GetDanhSachBenhNhanHetNo`;
    urlGetTotalPagesBenhNhanConNo = `CongNoBenhNhan/GetTotalPagesBenhNhanHetNo`;
    ...
    @ViewChild('gridBenhNhanHetNo', { static: true }) gridBenhNhanConNo: GridComponent;
