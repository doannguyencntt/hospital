...
@Component({
	...
	templateUrl: "./chi-tiet-da-quyet-toan-goi-marketing.component.html",
	styleUrls: ["./chi-tiet-da-quyet-toan-goi-marketing.component.scss"],
})

export class ChiTietDaQuyetToanMarketing implements OnInit {
