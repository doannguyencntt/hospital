...
@Component({
	selector: "app-xac-nhan-hoan-phieu",
	templateUrl: "./xac-nhan-hoan-phieu.component.html",
	styleUrls: ["./xac-nhan-hoan-phieu.component.scss"],
})
export class XacNhanHoanThuComponent implements OnInit {
	...
	ngOnInit() {
		...
		this.thongTinHuyPhieu.ChuyenTienQuaTamUng = false;
		...
		if (this.loaiType === "NgoaiTru") {
			if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
				if (this.thuHoiPhieu) {
					...
					this.apiService.post<any>("ThuNgan/HoanPhieuThu", this.thongTinHuyPhieu).subscribe(
						(resultData) => {
							this.dialog.closeAll();
							this.dialogRef.close("Yes");
						},
			...
			if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
				if (this.thuHoiPhieu) {
					...
					this.apiService.post<any>("ThuNganNoiTru/HoanPhieuThu", this.thongTinHuyPhieu).subscribe(
						(resultData) => {
							this.dialog.closeAll();
							this.dialogRef.close("Yes");
						},
