...
import { ThongTinHuyPhieu } from "../../noi-tru/cho-thu-tien/cho-thu-tien.model";
import { TrangThaiThuTienBenhNhan } from "../../ngoai-tru/cho-thu-tien/cho-thu-tien.model";
...
export class XacNhanHuyThuComponent implements OnInit {
	...
	loaiType: string = ""; // true ngoaij tru  , fasle noi tru
	LaTamUng: boolean;
	...
	ngOnInit() {
		...
		if (this.data.thongTinHuyPhieu.TamUng > 0) {
			this.LaTamUng = this.data.thongTinHuyPhieu.TamUng > 0;
			this.thongTinHuyPhieu.HuyPhieuHoanUng = true;
		}
	...
	xacNhanThongTinHuy() {
		...
		if (this.loaiType === "NgoaiTru") {
			if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
				if (this.thuHoiPhieu) {
					this.thongTinHuyPhieu.KiemTraThuHoi = true;
					this.apiService.post<any>("ThuNgan/CapnhatNguoiThuHoiPhieuThu", this.thongTinHuyPhieu).subscribe(
						(resultData) => {
							this.dialog.closeAll();
					...
					this.apiService.post<any>("ThuNgan/HuyPhieuThu", this.thongTinHuyPhieu).subscribe(
						(resultData) => {
							this.dialog.closeAll();
							this.dialogRef.close("Yes");
						},
		...
		} else if (this.loaiType === "NoiTru") {
			if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
				if (this.thuHoiPhieu) {
					this.thongTinHuyPhieu.KiemTraThuHoi = true;
					this.apiService.post<any>("ThuNganNoiTru/CapnhatNguoiThuHoiPhieuThu", this.thongTinHuyPhieu).subscribe(
						(resultData) => {
							this.dialog.closeAll();
							this.dialogRef.close("Yes");
						},
					...
					this.apiService.post<any>("ThuNganNoiTru/HuyThanhToan", this.thongTinHuyPhieu).subscribe(
						(resultData) => {
							this.dialog.closeAll();
							this.dialogRef.close("Yes");
						},
			...
			if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
				if (this.thuHoiPhieu) {
					this.thongTinHuyPhieu.KiemTraThuHoi = true;
					this.apiService.post<any>("ThuNganMarketing/CapnhatNguoiThuHoiPhieuThuMarketing", this.thongTinHuyPhieu).subscribe(
						(resultData) => {
							this.dialog.closeAll();
							this.dialogRef.close("Yes");
						},
					...
					this.apiService.post<any>("ThuNganMarketing/HuyPhieuThuMarketing", this.thongTinHuyPhieu).subscribe(
						(resultData) => {
							this.dialog.closeAll();
							this.dialogRef.close("Yes");
						},
