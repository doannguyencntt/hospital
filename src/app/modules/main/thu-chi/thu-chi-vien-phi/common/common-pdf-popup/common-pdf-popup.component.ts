...
@Component({
	selector: "common-pdf-popup",
	templateUrl: "./common-pdf-popup.component.html",
	styleUrls: ["./common-pdf-popup.component.scss"],
})
export class CommonPdfPopupComponent implements OnInit {
	icClose = icClose;
