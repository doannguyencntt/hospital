...
@Component({
	selector: "chon-miem-giam-bang-thanh-tien-ngoai-tru",
	templateUrl: "./chon-miem-giam-bang-thanh-tien-ngoai-tru.component.html",
	styleUrls: ["./chon-miem-giam-bang-thanh-tien-ngoai-tru.component.scss"],
})
export class ChonMiemGiamBangThanhTienDichVuNgoaiTruComponent implements OnInit {
