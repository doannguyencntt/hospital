...
export class TrangThaiDaThuTien {
	CongNo = 1;
	DaQuyetToan = 2;
}
...
export class CommonThuTien {
	...
	ThuTienTamUngThanhCong = "Đã thu tiền tạm ứng thành công.";
	...
	ErrorXacNhanBHYT = "Vui lòng xác nhận bảo hiểm y tế cho từng dịch vụ.";
}
...
export class ThongTinHuyPhieu {
	constructor(
		...
		public HuyPhieuHoanUng: boolean = null,
		public ChuyenTienQuaTamUng: boolean = null,
...
export class ThongTinSoPhieuDaThu {
	constructor(
		...
		public ChiPhiKhamChuaBenhNoiTruVos: DanhSachChiPhiKhamChuaBenh[] = []
	) { }
}
...
export class ChoThuTien {
	constructor(
		...
		public khoaKham: string = null,
		public DoiTuong: string = null,

		public SoTienDuTaiKhoan: number = 0,
		public KiemTraChonThanhToan: boolean = true,

		//========================Trạng thái phần nội trú chưa thu======================
		public ChoQuyetToan: boolean = true,
		public ChoTamUngThem: boolean = true,
		public DaTamUng: boolean = true,
		public ChuaTaoBenhAn: boolean = true,
		//========================Trạng thái phần nội trú đã thu========================
...
export class ThongTinBenhNhan {
	constructor(
		...
		public ThongTinBHYTNoiTrus: ThongTinBHYTNoiTru[] = []
	) { }
}

export class ThongTinBHYTNoiTru {
	constructor(
		public CoBHYT: boolean,
		public BHYTMaSoThe: string = null,
		public NgayHieuLucStr: string = null,
		...
		public BHYTDiaChi: string = null,
		public BHYTMucHuong: string = null,
		public TaiLieuDinhKemGiayMiemCungChiTra: TaiLieuDinhKemGiayMiemCungChiTra = null
	) { }
}
...
export class ApDungKhuyenMaiBenhNhanNoiTru {
	constructor(
		public YeuCauTiepNhanId: number = 0,
		public DsKhuyenMaiBenhNhanNoiTrus: DanhSachDichVuKhuyenMaiBenhNhanNoiTru[] = []
	) { }
}

export class DanhSachDichVuKhuyenMaiBenhNhanNoiTru {
	constructor(
		public Id: number = 0,
		public TenGoi: string = null,
		public DanhSachDichVuTrongGoiKhuyenMaiNoiTrus: DanhSachDichVuTrongGoiKhuyenMaiNoiTru[] = []
	) { }
}

export class DanhSachDichVuTrongGoiKhuyenMaiNoiTru {
	constructor(
		public Id: number = 0,
...
export class CapNhatDonGiaMoi {
	constructor(
		public Id: number = 0,
		public LoaiNhom: number = null,
		public DonGia: number = 0,
		public DonGiaCapNhat: number = 0,
	) { }
}
...
export class NoiDungMauGhiChuMiemGiam {
	public constructor(
		public Id: number = 0,
		public Ma: string = null,
		public Ten: string = null,
		public NoiDungMiemGiam: string = null
	) { }
}