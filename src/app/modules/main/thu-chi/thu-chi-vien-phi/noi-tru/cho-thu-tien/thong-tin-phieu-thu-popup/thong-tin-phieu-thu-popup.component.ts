...
export class ThongTinPhieuNoiTruPopupComponent implements OnInit {
	icClose = icClose;
	...
	getALlFilePDFFromHtml(data: any) {
		...
		this.apiService.postExportPdf<any>
			("ThuNganNoiTru/InPhieuThu?taiKhoanThuId=" + data.taiKhoanThuId + "&taiKhoanChiId=" + data.taiKhoanChiId + "&yeuCauTiepNhanId=" + data.idYeuCauTiepNhan + "&hostingName=" + hostingName + "&loaiTypes=" + data.loaiTypes + "&phieuHoanUngIds=" + data.phieuHoanUngIds).subscribe(
				(file) => {
