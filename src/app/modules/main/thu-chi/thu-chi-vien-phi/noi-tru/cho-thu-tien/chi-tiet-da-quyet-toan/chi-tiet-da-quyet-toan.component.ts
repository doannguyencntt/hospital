...
@Component({
	selector: "app-chi-tiet-da-quyet-toan",
	templateUrl: "./chi-tiet-da-quyet-toan.component.html",
	styleUrls: ["./chi-tiet-da-quyet-toan.component.scss"],
})
export class ChiTietDaQuyetToanComponent implements OnInit {
	...
	huyThanhCong(daHuy: boolean) {
		if (daHuy) {
			...
			this.router.navigateByUrl("/danh-sach-thu-tien-noi-tru/chi-tiet-cho-quyet-toan/" + this.idYeuCauTiepNhan + "?loaiThanhToan=1");
		}
	}
