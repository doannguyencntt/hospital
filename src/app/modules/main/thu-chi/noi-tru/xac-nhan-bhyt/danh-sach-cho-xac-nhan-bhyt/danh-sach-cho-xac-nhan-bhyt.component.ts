...
export class DanhSachChoXacNhanBhytComponent implements OnInit {
    ...
    urlListBhytNoiTru = 'XacNhanBHYT/GetDataForGridNoiTruAsync';
    urlBhytNoiTruTotalPage = 'XacNhanBHYT/GetTotalPageForGridNoiTruAsync';
    ...
    thongTinChiTiet(data: any) {
        this.router.navigateByUrl(
            '/xac-nhan-bhyt/noi-tru/ds-xac-nhan-bhyt/' +
            data.Id +
