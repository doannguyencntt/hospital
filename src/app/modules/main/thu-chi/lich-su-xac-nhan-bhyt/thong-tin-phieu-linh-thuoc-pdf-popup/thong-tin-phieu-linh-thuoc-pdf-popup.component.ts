...
@Component({
	...
	templateUrl: "./thong-tin-phieu-linh-thuoc-pdf-popup.component.html",
	styleUrls: ["./thong-tin-phieu-linh-thuoc-pdf-popup.component.scss"],
})
export class ThongTinPhieuBHYTPdfPopupComponent implements OnInit {
	icClose = icClose;
	...
	getALlFilePDFFromHtml(arrHtml) {
		...
		arrHtml.forEach((res) => {
			...
			this.apiService.postExportPdf<any>("XacNhanBHYT/GetFilePDFFromHtml", obj).subscribe(
				(file) => {
