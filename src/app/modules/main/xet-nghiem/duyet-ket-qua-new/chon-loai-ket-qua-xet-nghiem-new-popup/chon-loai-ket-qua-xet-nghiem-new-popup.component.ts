...
@Component({
  ...
  templateUrl: './chon-loai-ket-qua-xet-nghiem-new-popup.component.html',
  styleUrls: ['./chon-loai-ket-qua-xet-nghiem-new-popup.component.scss']
})
export class ChonLoaiKetQuaXetNghiemNewPopupComponent implements OnInit {
  ...
  public dialog: MatDialog,
   public dialogRef: MatDialogRef<ChonLoaiKetQuaXetNghiemNewPopupComponent>,
