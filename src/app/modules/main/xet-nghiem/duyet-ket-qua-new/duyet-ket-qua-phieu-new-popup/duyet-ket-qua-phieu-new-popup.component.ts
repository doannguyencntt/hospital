...
@Component({
  ...
  templateUrl: './duyet-ket-qua-phieu-new-popup.component.html',
  styleUrls: ['./duyet-ket-qua-phieu-new-popup.component.scss']
})
export class DuyetKetQuaPhieuNewPopupComponent implements OnInit {
    icClose = icClose;
