...
import { KetQuaXetNghiemSearch, PhieuDuyetKetQua } from '../ket-qua-xet-nghiem.model';
...
@Component({
  ...
  templateUrl: './ket-qua-xet-nghiem-list.component.html',
  styleUrls: ['./ket-qua-xet-nghiem-list.component.scss']
})
export class KetQuaXetNghiemListComponent implements OnInit {

  baseRoute: string = "/xet-nghiem/ket-qua";
  ...
  ketQuaXetNghiemSearch: KetQuaXetNghiemSearch = new KetQuaXetNghiemSearch();
  ...
  ngOnInit() {
    this.ketQuaXetNghiemSearch = new KetQuaXetNghiemSearch();
  ...
  checkboxChange($event, choKetQua: boolean = false, choDuyetKetQua: boolean = false, daCoKetQua: boolean = false) {
  ...
  backWithSearch() {
    ...
    if (this.route.snapshot.queryParams.holdQuery != undefined) {
      ...
      if (holdQuery != null && holdQuery) {
        var additionalSearchString = LocalStorageHelper.getItem<string>("additionalSearchStringKetQuaXetNghiem");
    ...
    if (!hasLocalSearchString) {
      LocalStorageHelper.removeItem("additionalSearchStringKetQuaXetNghiem");
    }
  }
  ...
  Timkiem() {
    ...
    LocalStorageHelper.setItem("additionalSearchStringKetQuaXetNghiem", queryString);
          ...
          dialogRef = this.dialog.open(ChonLoaiKetQuaXetNghiemPopupComponent, {
            ...
            if (result != undefined && result != null && result != "") {
              if (result == 'No') {
                ...
                this.apiService.post<Array<string>>('XetNghiem/GetAllHtmlPdfKetQuaXetNghiemKetQua', this.inPhieuDuyetKetQua).subscribe(
                  arrHtml => {
