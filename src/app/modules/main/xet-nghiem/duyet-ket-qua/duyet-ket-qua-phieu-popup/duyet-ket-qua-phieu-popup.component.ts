...
@Component({
    ...
    templateUrl: './duyet-ket-qua-phieu-popup.component.html',
    styleUrls: ['./duyet-ket-qua-phieu-popup.component.scss']
})
export class DuyetKetQuaPhieuPopupComponent implements OnInit {
