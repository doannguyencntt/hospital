...
import { TongHopDuTruMuaThuocTaiGiamDocService } from './du-tru-giam-doc.service';
...
@NgModule({
    ...
    providers: [
        ...
        { provide: BaseService, useClass: TongHopDuTruMuaThuocTaiGiamDocService },
    ],
    entryComponents: [
        DuTruGiamDocDeclinedPopupComponent
    ]
})
export class TongHopDuTruMuaThuocTaiGiamDocModule { }
