...
@Component({
  ...
  templateUrl: './duyet-yeu-cau-linh-thuoc-bu-shared.component.html',
  styleUrls: ['./duyet-yeu-cau-linh-thuoc-bu-shared.component.scss']
})
export class DuyetYeuCauLinhThuocBuSharedComponent implements OnInit {
  ...
  urlGetDataGrid: string = "YeuCauLinhDuocPham/GetDuocPhamYeuCauLinhBuDataForGrid";
  urlGetTotalPageGrid: string = "YeuCauLinhDuocPham/GetDuocPhamYeuCauLinhBuTotalPageForGrid";
  urlGetDataGridChild: string = "YeuCauLinhDuocPham/GetBenhNhanTheoDuocPhamCanLinhBuDataForGrid";
  urlGetTotalPageGridChild: string = "YeuCauLinhDuocPham/GetBenhNhanTheoDuocPhamCanLinhBuTotalPageForGrid";
  ...
  getById(id: number) {
    this.apiService.get<DuyetYeuCauLinhDuocPham>("YeuCauLinhDuocPham/GetYeuCauLinhDuocPhamBu?id=" + id)
