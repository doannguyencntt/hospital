...
import { YeuCauTraThuocTuBenhNhanGrid } from "../yeu-cau-tra-thuoc-tu-benh-nhan.model";
...
@Component({
  ...
  templateUrl: './yeu-cau-tra-thuoc-tu-benh-nhan-list.component.html',
  styleUrls: ['./yeu-cau-tra-thuoc-tu-benh-nhan-list.component.scss']
})
export class YeuCauTraThuocTuBenhNhanListComponent implements OnInit {
  documentType: DocumentType;
  danhSachYeuCauTraThuoc: YeuCauTraThuocTuBenhNhanGrid;

  baseRoute: string = "/nhap-xuat/duoc-pham/tu-benh-nhan/yeu-cau-tra-duoc-pham";
  urlGetData: string = "YeuCauTraThuocTuBenhNhan/GetDataForGridAsync";
  urlGetTotalPage: string = "YeuCauTraThuocTuBenhNhan/GetTotalPageForGridAsync";
  urlGetDataDuocPham: string = "YeuCauTraThuocTuBenhNhan/GetDataForGridAsyncDuocPhamChild";
  urlGetTotalPageDuocPham: string = "YeuCauTraThuocTuBenhNhan/GetTotalPageForGridAsyncDuocPhamChild";
  urlGetDataBenhNhan: string = "YeuCauTraThuocTuBenhNhan/GetDataForGridAsyncBenhNhanChild";
  urlGetTotalPageBenhNhan: string = "YeuCauTraThuocTuBenhNhan/GetTotalPageForGridAsyncBenhNhanChild";
  ...
  ngOnInit() {
    ...
    this.danhSachYeuCauTraThuoc = new YeuCauTraThuocTuBenhNhanGrid();
    this.backWithSearch();
    this.gridColumns = [
  ...
  backWithSearch() {
    ...
    if (this.route.snapshot.queryParams.holdQuery != undefined) {
      ...
      if (holdQuery != null && holdQuery) {
        var additionalSearchString = LocalStorageHelper.getItem<string>("additionalSearchStringDanhSachYeuCauTraThuoc");
    ...
    if (!hasLocalSearchString) {
      LocalStorageHelper.removeItem("additionalSearchStringDanhSachYeuCauTraThuoc");
    }
  }
  ...
  timKiem() {
    ...
    if (this.danhSachYeuCauTraThuoc.RangeFromDate != null && this.danhSachYeuCauTraThuoc.RangeFromDate.startDate != null) {
      this.danhSachYeuCauTraThuoc.RangeFromDate.TuNgay = CommonService.formatDateTime(this.danhSachYeuCauTraThuoc.RangeFromDate.startDate, "mm/dd/yyyy");
    }
    else {
    ...
    if (this.danhSachYeuCauTraThuoc.RangeFromDate != null && this.danhSachYeuCauTraThuoc.RangeFromDate.endDate != null) {
      this.danhSachYeuCauTraThuoc.RangeFromDate.DenNgay = CommonService.formatDateTime(this.danhSachYeuCauTraThuoc.RangeFromDate.endDate, "mm/dd/yyyy");
    }
    else {
    ...
    LocalStorageHelper.setItem("additionalSearchStringDanhSachYeuCauTraThuoc", queryString);
    this.gridChild.search();
  }
    ...
    self.dialog.open(ConfirmComponent, {
      ...
      if (res == "Yes") {
        if (self.authService.hasPermission(self.documentType, SecurityOperation.Delete)) {
          this.apiService.post<any>("YeuCauTraThuocTuBenhNhan/XoaPhieuTraThuoc?id=" + id).subscribe(
            () => {
  ...
  xuatExcel() {
    ...
    if (this.authService.hasPermission(this.documentType, SecurityOperation.Process)) {
      this.apiService.postExportExcel<string>("YeuCauTraThuocTuBenhNhan/ExportPhieuTraThuocTuBenhNhanNoiTru", this.gridChild._gridQueryInfo).subscribe(res => {
        let dateTimeNow = new Date();
        CommonService.downLoadFile(res, "application/vnd.ms-excel", "DSPhieuTraThuocTuBenhNhanNoiTru" + dateTimeNow.getFullYear() + ".xlsx");
