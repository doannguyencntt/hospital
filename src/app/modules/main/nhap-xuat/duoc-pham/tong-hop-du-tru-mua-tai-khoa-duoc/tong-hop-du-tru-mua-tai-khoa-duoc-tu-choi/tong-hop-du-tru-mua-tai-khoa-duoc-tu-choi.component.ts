...
import { TongHopDuTruMuaTaiKhoaDuoc ,TongHopDuTruTuaTaiKhoaDuocSearch,TongHopDuTruTuaTaiKhoaDuocSearchTuChoi} from '../tong-hop-du-tru-mua-tai-khoa-duoc.model';

@Component({
  selector: 'app-tong-hop-du-tru-mua-tai-khoa-duoc-tu-choi',
  templateUrl: './tong-hop-du-tru-mua-tai-khoa-duoc-tu-choi.component.html',
  styleUrls: ['./tong-hop-du-tru-mua-tai-khoa-duoc-tu-choi.component.scss']
})
...
groupsChildChild: GroupDescriptor[] = [{ field: 'Loai' }];
  ...
  if (
      this.holdQuery != null &&
      LocalStorageHelper.getItem('additionalSearchStringTongHopDuTruMuaDuocPhamTuChoiTaiKhoDuoc') != null
  ) {
      this.additionalSearchString = LocalStorageHelper.getItem(
          'additionalSearchStringTongHopDuTruMuaDuocPhamTuChoiTaiKhoDuoc'
      );
      ...
      LocalStorageHelper.setItem('additionalSearchStringTongHopDuTruMuaDuocPhamTuChoiTaiKhoDuoc', null);
...
this.gridChildChildColumns =[
  ...
  xemChiTiet(IdKhoaDuTruDuocPham:number, dataItem: any) {
