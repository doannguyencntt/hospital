...
import { DuTruMuaVatTuKhoDuocChiTietList, TongHopDuTruMuaTaiKhoaDuoc, TrangThaiDuyet } from '../tong-hop-du-tru-mua-ksnk-tai-khoa-duoc.model';
...
@Component({
    ...
    templateUrl: './duyet-du-tru-mua-ksnk-update.component.html',
    styleUrls: ['./duyet-du-tru-mua-ksnk-update.component.scss'],
    animations: [
        stagger60ms,
        fadeInUp400ms
    ]
})
export class DuyetDuTruMuaKSNKUpdateComponent implements OnInit {
    @ViewChild(DuyetDuTruMuaKSNKSharedComponent, {static: true}) shared;
    ...
    tuChoi(){
      ...
      if(self.thongTinDuTruMuaVatTuTaiKhoaDuoc.KhoId != 0){
        this.dialog.open(TuChoiDuyetKSNKPopupComponent, {
          disableClose: false,
          width: '400px',
