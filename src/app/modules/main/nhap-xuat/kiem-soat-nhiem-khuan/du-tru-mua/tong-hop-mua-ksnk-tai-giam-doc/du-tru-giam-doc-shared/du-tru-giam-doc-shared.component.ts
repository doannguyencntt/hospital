...
export class DuTruGiamDocSharedComponent implements OnInit {
    ...
    gridDataSource: any;
    urlGetDataChuaDuyetGrid = 'YeuCauMuaKSNK/GetDataForGridChildChuaDuyetAsync';
    urlGetDataDuyetGrid = 'YeuCauMuaKSNK/GetDataForGridChildDuyetAsync';
    urlGetDataGridChild = 'YeuCauMuaKSNK/GetDataForGridDuyetDetail';
    khos: any[] = [];
    hdts: any[] = [];
