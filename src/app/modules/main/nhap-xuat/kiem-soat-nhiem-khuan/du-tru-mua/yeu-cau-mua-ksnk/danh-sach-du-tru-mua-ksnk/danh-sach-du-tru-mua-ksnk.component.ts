...
import { PhieuYeuCauMuaVatTu, YeuCauMuaVatTuGridVo } from "../yeu-cau-mua-ksnk.model";
...
@Component({
  ...
  templateUrl: './danh-sach-du-tru-mua-ksnk.component.html',
  styleUrls: ['./danh-sach-du-tru-mua-ksnk.component.scss']
})
export class DanhSachDuTruMuaKSNKComponent implements OnInit {
  documentType: DocumentType;
  danhSachYeuCauMuaVatTu: YeuCauMuaVatTuGridVo;
  inPhieuVatTu: PhieuYeuCauMuaVatTu = new PhieuYeuCauMuaVatTu();

  baseRoute: string = "/nhap-xuat/ksnk/yeu-cau-mua-ksnk";
  urlGetData: string = "YeuCauMuaKSNK/GetYeuCauMuaKSNKDataForGridAsync";
  urlGetTotalPage: string = "YeuCauMuaKSNK/GetYeuCauMuaKSNKTotalPageForGridAsync";
  ...
  backWithSearch() {
    ...
    if (this.route.snapshot.queryParams.holdQuery != undefined) {
      ...
      if (holdQuery != null && holdQuery) {
        this.additionalSearchString = LocalStorageHelper.getItem<string>("additionalSearchStringDanhSachYeuCauMuaNhomKSNK");
    ...
    if (!hasLocalSearchString) {
      LocalStorageHelper.removeItem("additionalSearchStringDanhSachYeuCauMuaNhomKSNK");
    }
  }
  ...
  timKiem() {
    ...
    LocalStorageHelper.setItem("additionalSearchStringDanhSachYeuCauMuaNhomKSNK", queryString);
    this.gridChild.search();
  }
    ...
    self.dialog.open(ConfirmComponent, {
      ...
      if (res == "Yes") {
        if (self.authService.hasPermission(self.documentType, SecurityOperation.Delete)) {
          this.apiService.post<any>("YeuCauMuaKSNK/XoaYeuCauMuaDuTruKSNK?id=" + id).subscribe(
            () => {
  ...
  XuatExcel() {
    ...
    if (this.authService.hasPermission(this.documentType, SecurityOperation.Process)) {
      this.apiService.postExportExcel<string>("YeuCauMuaKSNK/ExportYeuCauMuaVatTu", this.gridChild._gridQueryInfo).subscribe(res => {
