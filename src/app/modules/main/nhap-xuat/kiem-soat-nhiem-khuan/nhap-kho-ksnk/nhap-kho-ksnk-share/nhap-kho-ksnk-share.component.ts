...
import { NhapKhoVatTu, NhapKhoVatTuChiTiet } from '../nhap-kho-ksnk';
...
@Component({
    ...
    templateUrl: './nhap-kho-ksnk-share.component.html',
    styleUrls: ['./nhap-kho-ksnk-share.component.scss']
})

export class NhapKhoKSNKShareComponent implements OnInit {
    @Input() isUpdate: boolean = false;
    @Input() daDuyet: boolean = null;
    @Input() tuChoiDuyet: boolean = null;
    @Input() chuaDuyet: boolean = null;

    nhapKho: NhapKhoVatTu;
    ...
    getById(id: number) {
        ...
        self.apiService.post<NhapKhoVatTu>("NhapKhoVatTuKSNK/GetGrid?id=" + id).subscribe(
            resultDataGrid => {
    ...
    getKhoVatTuYTe() {
        this.apiService.get<any>("NhapKhoVatTuKSNK/GetKhoVatTuYTe").subscribe(result => {
    ...
    UpdateRowGripView(dataItem: NhapKhoVatTuChiTiet) {
        ...
        if (this.authService.hasPermission(this.documentType, SecurityOperation.Update)) {
            ...
            if (self.nhapKhoChiTiet.HopDongThauVatTuId) {
                self.apiService.get<number>("NhapKhoVatTuKSNK/GetPriceOnContract?hopDongThauId="
    ...
    onChangeVatTu(event: any) {
        if (event !== null && event !== undefined) {
            ...
            //suggest nhom
            let self = this;
            this.apiService.post<any>("NhapKhoVatTuKSNK/SuggestLoaiSuDung?id=" + event.KeyId).subscribe(
                resultData => {
                    if (resultData != null && resultData != undefined) {
