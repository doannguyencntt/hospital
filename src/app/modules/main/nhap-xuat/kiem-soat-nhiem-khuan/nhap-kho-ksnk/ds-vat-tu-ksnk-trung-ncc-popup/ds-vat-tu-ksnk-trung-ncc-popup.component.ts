...
@Component({
  ...
  templateUrl: './ds-vat-tu-ksnk-trung-ncc-popup.component.html',
  styleUrls: ['./ds-vat-tu-ksnk-trung-ncc-popup.component.scss']
})

export class DsVatTuKSNKTrungNccPopupComponent implements OnInit {
