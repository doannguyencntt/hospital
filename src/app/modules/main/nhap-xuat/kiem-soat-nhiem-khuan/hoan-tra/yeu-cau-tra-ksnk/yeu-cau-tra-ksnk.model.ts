...
export class YeuCauTraKSNK {
    constructor(
        ...
        public YeuCauTraKSNKChiTiets: YeuCauTraKSNKChiTiet[] = [],
...
export class YeuCauTraKSNKChiTiet {
    constructor(
        public Id: number = 0,
...
export class YeuCauHoanTraKSNKViewModel {
    constructor(
        public Id: number = 0,
        public KhoXuatId: number = null,
        public KhoNhapId: number = null,
        ...
        public YeuCauTraKSNKChiTiets: VatTuXuatGridVo[] = [],
    ) { }
}
...
export class YeuCauHoanTraVT {
    constructor(
        ...
        public YeuCauHoanTraKSNKChiTiets: YeuCauHoanTraKSNKChiTiet[] = [],
        public YeuCauHoanTraKSNKChiTietHienThis: YeuCauHoanTraKSNKChiTietHienThi[] = []
    ) {
    }
}

export class YeuCauHoanTraKSNKChiTiet {
    constructor(
        public Id: number = 0,
...
export class YeuCauHoanTraKSNKChiTietHienThi {
    constructor(
...
export class YeuCauHoanTraKSNKSearch {
    constructor(
        ...
        public SearchString: string = null,
        public LoaiDuocPhamVatTu: number = null,
        public VatTuBenhVienVos: KSNKBenhVienChiTietVo[] = [],
    ) {
    }
}

export class KSNKBenhVienChiTietVo {
    constructor(
        public VatTuBenhVienId: number = null,
        public Ten: string = null,
        public Ma: string = null,
...
export class YeuCauHoanTraKSNKGridDaDuyet {
    constructor(
