...
import { LoaiDuocPhamVatTu, YeuCauHoanTraKSNKChiTiet, YeuCauHoanTraKSNKChiTietHienThi, YeuCauHoanTraKSNKGridDaDuyet, YeuCauHoanTraKSNKSearch, YeuCauHoanTraVT } from '../yeu-cau-tra-ksnk.model';

@Component({
    // tslint:disable-next-line: component-selector
    selector: 'app-yeu-cau-tra-ksnk-shared',
    templateUrl: './yeu-cau-tra-ksnk-shared.component.html',
    styleUrls: ['./yeu-cau-tra-ksnk-shared.component.scss']
})

export class YeuCauTraKSNKSharedComponent implements OnInit {
    yeuCauHoanTraVT: YeuCauHoanTraVT = new YeuCauHoanTraVT();
    yeuCauHoanTraVatTuSearch: YeuCauHoanTraKSNKSearch = new YeuCauHoanTraKSNKSearch();
    lstXuatKhoSearch: YeuCauHoanTraKSNKChiTietHienThi[] = new Array<YeuCauHoanTraKSNKChiTietHienThi>();
    lstXuatKho: YeuCauHoanTraKSNKChiTietHienThi[] = new Array<YeuCauHoanTraKSNKChiTietHienThi>();
    xuatKhoKhacGridDaDuyet: YeuCauHoanTraKSNKGridDaDuyet = new YeuCauHoanTraKSNKGridDaDuyet();
    ...
    urlGetData = "YeuCauTraKSNK/GetDataForGridAsyncKSNKTuTrucDaChon";
    urlGetTotal = "YeuCauTraKSNK/GetTotalPageForGridAsyncKSNKTuTrucDaChon";

    urlGetDataVatTuDaDuyet = "YeuCauTraKSNK/GetDataForGridChildAsyncDaDuyetKSNK";
    urlGetTotalVatTuDaDuyet = "YeuCauTraKSNK/GetTotalPageForGridChildAsyncDaDuyetKSNK";

    //clone dược phẩm
    urlGetDataDuocPhamDaDuyet = "YeuCauTraKSNK/GetDataForGridChildAsyncDuocPhamDaDuyetKSNK";
    urlGetTotalDuocPhamDaDuyet = "YeuCauTraKSNK/GetTotalPageForGridChildAsyncDuocPhamDaDuyetKSNK";
    ...
    dieuChuyenDuocPhamTheoNhomGrid(dataItem: any, gridNumber: number) {
        ...
        this.addingPage();
        this.apiService.post<any>("YeuCauTraKSNK/XuatKSNKHoanTraTheoNhom", model).subscribe(
            resultData => {
                if (resultData != undefined && resultData != null) {
    ...
    getById(id: number) {
        ...
        if (self.loaiDuocPhamVatTu === LoaiDuocPhamVatTu.LoaiVatTu) {
            if (self.authService.hasPermission(self.documentType, SecurityOperation.View)) {
                self.addingPage();
                self.apiService.get<any>("YeuCauTraKSNK/GetYeuCauHoanTraKSNKTuTruc?id=" + id).subscribe(
                    resultData => {
                        if (resultData != undefined && resultData != null) {
                            self.disabled = true;
            ...
            if (self.authService.hasPermission(self.documentType, SecurityOperation.View)) {
                self.addingPage();
                self.apiService.get<any>("YeuCauTraKSNK/GetYeuCauHoanTraDuocPhamTuTruc?id=" + id).subscribe(
                    resultData => {
                        if (resultData != undefined && resultData != null) {
                            self.disabled = true;
                            self.closepopupLoadingData();
    ...
    getSharedData() {
        this.yeuCauHoanTraVT.YeuCauHoanTraKSNKChiTiets = new Array<YeuCauHoanTraKSNKChiTiet>();
        this.lstXuatKho.forEach(element => {
            let yeuCauXuatKhoKhacChiTiet = new YeuCauHoanTraKSNKChiTiet();
