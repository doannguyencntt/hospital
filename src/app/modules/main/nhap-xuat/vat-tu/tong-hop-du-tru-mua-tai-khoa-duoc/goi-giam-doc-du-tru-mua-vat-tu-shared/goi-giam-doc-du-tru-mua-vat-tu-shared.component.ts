...
import { TongHopDuTruMuaTaiKhoaDuoc ,TrangThaiDuyet,DuTruMuaTaiKhoaDuocGoi} from '../tong-hop-du-tru-mua-vat-tu-tai-khoa-duoc.model';
...
@Component({
    ...
    templateUrl: './goi-giam-doc-du-tru-mua-vat-tu-shared.component.html',
    styleUrls: ['./goi-giam-doc-du-tru-mua-vat-tu-shared.component.scss']
})
export class GoiGiamDocDuTruMuaVatTuSharedComponent implements OnInit {
  ...
  this.gridChildChildColumns = [
    ...
    getById(id)
    {
      ...
      this.apiService.post<DuTruMuaTaiKhoaDuocGoi>("YeuCauMuaVatTu/GetDataGoiDuyetDuTruMuaVatTu?idKyDuTru=" + id)
    ...
    {
      this.isDisableTrangThai = true;
      this.apiService.post<DuTruMuaTaiKhoaDuocGoi>("YeuCauMuaVatTu/GetDataGoiDuyetDuTruMuaVatTuView?idKyDuTru=" + id + "&tinhTrang=" + tinhTrang)
          .subscribe((resultData) => {
            if (resultData !== undefined && resultData != null) {
              this.thongTinDuTruMuaVatTuTaiKhoaDuocGoi = resultData;
