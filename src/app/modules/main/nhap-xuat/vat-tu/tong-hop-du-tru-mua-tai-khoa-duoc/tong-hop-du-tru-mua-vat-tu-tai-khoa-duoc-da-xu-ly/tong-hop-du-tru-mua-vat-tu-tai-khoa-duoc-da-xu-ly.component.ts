...
import { TongHopDuTruTuaTaiKhoaDuocSearchDaXuLy } from '../../../vat-tu/tong-hop-du-tru-mua-tai-khoa-duoc/tong-hop-du-tru-mua-vat-tu-tai-khoa-duoc.model';
import { TongHopDuTruMuaTaiKhoaDuoc } from '../tong-hop-du-tru-mua-vat-tu-tai-khoa-duoc.model';
@Component({
    // tslint:disable-next-line: component-selector
    selector: 'app-tong-hop-du-tru-mua-vat-tu-tai-khoa-duoc-da-xu-ly',
    templateUrl: './tong-hop-du-tru-mua-vat-tu-tai-khoa-duoc-da-xu-ly.component.html',
    styleUrls: ['./tong-hop-du-tru-mua-vat-tu-tai-khoa-duoc-da-xu-ly.component.scss']
})
export class TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent implements OnInit {
    ...
    baseRoute: string = "/nhap-xuat/vat-tu/tong-hop-mua-thuoc-tai-khoa-duoc";
    gridDataSource: any = {};
    data: any[] = [];
    theFirstSearch: any;
    ...
    ngOnInit() {
        ...
        if (
            this.holdQuery != null &&
            LocalStorageHelper.getItem('additionalSearchStringTongHopDuTruMuaVatTuTaiKhoDuocDaXuLy') != null
        ) {
            this.additionalSearchString = LocalStorageHelper.getItem(
                'additionalSearchStringTongHopDuTruMuaVatTuTaiKhoDuocDaXuLy'
            );
            ...
            LocalStorageHelper.setItem('additionalSearchStringTongHopDuTruMuaVatTuTaiKhoDuocDaXuLy', null);
    ...
    xemChiTiet(id: number,TrangThaiDuTru:any) {
      ...
      xemChiTietDuTru(IdKhoaDuTruVatTuTheoKhoa:number, dataItem:any)
      {
