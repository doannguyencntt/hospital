...
@Component({
    ...
    templateUrl: './duyet-du-tru-mua-vat-tu-shared.component.html',
    styleUrls: ['./duyet-du-tru-mua-vat-tu-shared.component.scss']
})
export class DuyetDuTruMuaVatTuSharedComponent implements OnInit {
...
getById(id)
{
  ...
  this.apiService.post<any>("YeuCauMuaVatTu/GetDataUpdate?id=" + id + "&typeLoaiKho=" + this.loaiKhoThuoc)
