...
export class DuTruGiamDocListComponent implements OnInit {
    ...
    urlGetDataGridChild = 'TongHopDuTruMuaVatTuTaiGiamDoc/GetDataForGridChildDuyetAsync';
    urlGetTotalPageGridChild = 'TongHopDuTruMuaVatTuTaiGiamDoc/GetTotalPageForGridChildAsync';
    urlGetDataGridChildForChild = 'TongHopDuTruMuaVatTuTaiGiamDoc/GetDataForGridDuyetDetail';
    query: string = null;
    searchCtrl = new FormControl();
    baseRoute = 'nhap-xuat/vat-tu/tong-hop-mua-vat-tu-tai-giam-doc';
    khos: any[] = [];
    hdts: any[] = [];
    icInfo = icInfo;
    sort: SortDescriptor[] =
    ...
    ngOnInit() {
        ...
        if (
            this.holdQuery != null &&
            LocalStorageHelper.getItem('adtSearchVatTuDuTruGiamDoc') != null
        ) {
            this.additionalSearchString = LocalStorageHelper.getItem(
                'adtSearchVatTuDuTruGiamDoc'
            );
            ...
            LocalStorageHelper.setItem('adtSearchVatTuDuTruGiamDoc', null);
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, SecurityOperation.Process)) {
            ...
            self.apiService.postExportExcel<string>('TongHopDuTruMuaVatTuTaiGiamDoc/ExportTongHopDuTruMuaVatTuTaiGiamDoc',
                self.gridParent._gridQueryInfo).subscribe(
                    resultData => {
                        const dateTimeNow = new Date();
                        CommonService.downLoadFile(
                            resultData, 'application/vnd.ms-excel',
                            'TongHopDuTruMuaVatTuTaiGiamDoc' + dateTimeNow.getFullYear() + '.xlsx');
