...
@Component({
  ...
  templateUrl: './phieu-linh-vat-tu-thuong-popup.component.html',
  styleUrls: ['./phieu-linh-vat-tu-thuong-popup.component.scss']
})
export class PhieuLinhVatTuThuongPopupComponent implements OnInit {
  icClose = icClose;
  src: string = "";
  showNutIn :boolean = true;
  constructor(private dialog: MatDialog, public sanitizer: DomSanitizer,
    private dialogRef: MatDialogRef<PhieuLinhVatTuThuongPopupComponent>,
