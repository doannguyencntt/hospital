...
import { ThongTinVatTuChiTiet } from '../yeu-cau-mua-vat-tu.model';
@Component({
  selector: 'app-them-vat-tu-du-tru-mua-popup',
  templateUrl: './them-vat-tu-du-tru-mua-popup.component.html',
  styleUrls: ['./them-vat-tu-du-tru-mua-popup.component.scss']
})
export class ThemVatTuDuTruMuaPopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ThemVatTuDuTruMuaPopupComponent>,
  ...
  themVatTu() {
    ...
    self.dialog.open(ConfirmComponent, {
      ...
      if (result == "Yes") {
        ...
        self.apiService.post<ThongTinVatTuChiTiet>("YeuCauMuaVatTu/ThemVatTuChiTietGridVo", self.vatTu).subscribe(
          resultData => {
