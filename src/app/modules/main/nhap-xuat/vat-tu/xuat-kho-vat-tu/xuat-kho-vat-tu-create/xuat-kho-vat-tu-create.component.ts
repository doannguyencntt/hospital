...
@Component({
  ...
  templateUrl: './xuat-kho-vat-tu-create.component.html',
  styleUrls: ['./xuat-kho-vat-tu-create.component.scss'],
  animations: [
    stagger60ms,
    fadeInUp400ms
  ]
})
export class XuatKhoVatTuCreateComponent implements OnInit {

  loading: boolean = false;

  IsXuatKhac: boolean = false;

  @ViewChild(XuatKhoVatTuSharedComponent, { static: true }) shared;
