...
@Component({
    ...
    templateUrl: './tong-hop-du-tru-mua-vat-tu-tai-khoa-shared.component.html',
    styleUrls: ['./tong-hop-du-tru-mua-vat-tu-tai-khoa-shared.component.scss']
})
export class TongHopDuTruMuaVatTuTaiKhoaSharedComponent implements OnInit {
    ...
    khos: any[] = [];
    hdts: any[] = [];
    urlGetDataGridChildAsync = 'YeuCauMuaVatTu/GetDuTruMuaVatTuTaiKhoaChiTietForGridAsync';
    urlGetTotalPageGridChild = 'YeuCauMuaVatTu/GetTotalDuTruMuaVatTuTaiKhoaChiTietForGridAsync';

    urlGetDataDaXuLy = "YeuCauMuaVatTu/GetDuTruMuaVatTuTHDTChiTietForGridAsync";
    urlGetTotalPageDaXuLy = "YeuCauMuaVatTu/GetTotalDuTruMuaVatTuTHDTChiTietForGridAsync";
    urlGetDataDaXuLyChild = "YeuCauMuaVatTu/GetDuTruMuaVatTuTaiKhoaChiTietForGridAsyncChild";
    urlGetTotalPageDaXuLyChild = "YeuCauMuaVatTu/GetTotalDuTruMuaVatTuTaiKhoaChiTietForGridAsyncChild";
