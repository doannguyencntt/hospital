...
import {
    ...
    ThongTinLyDoHuyDuyetTaiKhoa,
    TongHopDuTruMuaVatTuTaiKhoa,
    TongHopDuTruMuaVatTuTaiKhoaSreach
...
import { ListStatusSelectTabTHDTKhoa } from '../../../duoc-pham/tong-hop-du-tru-mua-thuoc-tai-khoa/tong-hop-du-tru-mua-thuoc-tai-khoa.model';

@Component({
    // tslint:disable-next-line: component-selector
    selector: 'app-ds-tong-hop-du-tru-mua-vat-tu-tai-khoa',
    templateUrl: './ds-tong-hop-du-tru-mua-vat-tu-tai-khoa.component.html',
    styleUrls: ['./ds-tong-hop-du-tru-mua-vat-tu-tai-khoa.component.scss'],
    animations: [stagger60ms, fadeInUp400ms],
})
export class DsTongHopDuTruMuaVatTuTaiKhoaComponent implements OnInit {
    ...
    icInfo = icInfo;
    baseRoute = '/nhap-xuat/vat-tu/tong-hop-mua-vat-tu-tai-khoa';

    urlGetDataTuChoi = 'YeuCauMuaVatTu/GetDataDuTruMuaVatTuTuChoiTaiKhoaForGridAsync';
    urlGetTotalPageTuChoi = 'YeuCauMuaVatTu/GetTotalDuTruMuaVatTuTuChoiTaiKhoaForGridAsync';

    urlGetDataGridChildAsyncChoXuLy = "YeuCauMuaVatTu/GetDuTruMuaVatTuDangChoXuLyTaiKhoaChiTietForGridAsync";
    urlGetTotalPageGridChildChoXuLy: string = "YeuCauMuaVatTu/GetTotalDuTruMuaVatTuDangChoXuLyTaiKhoaChiTietForGridAsync";

    urlGetDataGridChildAsyncTuChoi = 'YeuCauMuaVatTu/GetDSTHDTTuChoiChildForGridAsync';
    urlGetTotalPageGridChildTuChoi = 'YeuCauMuaVatTu/GetTotalDSTHDTTuChoiChildForGridAsync';

    urlGetDataDaXuLyChiTietChild = "YeuCauMuaVatTu/GetDuTruMuaVatTuChiTietForGridAsyncChild";
    urlGetTotalDaXuLyChiTietChild = "YeuCauMuaVatTu/GetTotalDuTruMuaVatTuChiTietForGridAsyncChild";
    ...
    timKiem() {
        ...
        if (this.lstStatusSelectTabTHDTKhoa.selectedTabChoXuLy == true) {
            ...
            LocalStorageHelper.setItem("additionalSearchStringTHDTVatTuTaiKhoaSelectedTab", queryStringLstselectedTab);
        ...
        LocalStorageHelper.setItem('additionalSearchStringdanhSachTongHopDuTruMuaVatTuTaiKhoa', queryString);
    }
    ...
    TuChoi(id: any) {
        if (
            ...
            this.confrim = this.dialog.open(TongHopDuTruMuaVatTuTaiKhoaKhongDuyetComponent, {
                disableClose: true,
                width: '400px',
                height: '300px',
                ...
                if (result !== '' && result) {
                    ...
                    this.apiService.post<any>('YeuCauMuaVatTu/TuChoiDuyetTaiKhoa', this.thongTinLyDoHuyDuyetTaiKhoa)
    ...
    PheDuyet(id: any) {
        ...
        if (
            ...
            this.confrim = this.dialog.open(ConfirmComponent, {
                ...
                .subscribe((result) => {
                    if (result === 'Yes') {
                        this.apiService.post<any>('YeuCauMuaVatTu/DuyetTaiKhoa/', this.duyetDuTruMuaVatTuViewModel)
                            .subscribe((resultData) => {
                                if (resultData !== null && resultData !== undefined) {
                                    if (resultData) {
                                        this.gridChoDuyet.search();
        ...
        if (
            ...
            this.confrim = this.dialog.open(ConfirmComponent, {
                ...
                .subscribe((result) => {
                    ...
                    if (result === 'Yes') {
                        this.apiService.post<any>('YeuCauMuaVatTu/HuyDuyetTaiKhoa/' + id)
                            .subscribe((resultData) => {
                                if (resultData !== null && resultData !== undefined) {
                                    if (resultData) {
                                        this.gridChoDuyet.search();
    ...
    chuyenDen(element: any, event: any) {
        ...
        if (event.index == 0 || event.title == "CHỜ XỬ LÝ") {
            ...
            LocalStorageHelper.setItem("additionalSearchStringTHDTVatTuTaiKhoaSelectedTab", queryString);
            this.addtionStringDefault = additionalSearchString;
