...
let ChiSoXetNghiemCreateComponent = class ChiSoXetNghiemCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() { }
    onCreated() { this.router.navigate(['/danh-muc/nhom-he-thong/bao-hiem-y-te/chi-so-xet-nghiem']); }
};
ChiSoXetNghiemCreateComponent.ctorParameters = () => [
...
let ChiSoXetNghiemListComponent = class ChiSoXetNghiemListComponent {
    ...
    updateDanhMucChiSoXetNghiem(id, isDisabled) {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("ChiSoXetNghiem/ExportChiSoXetNghiem", this.gridChild._gridQueryInfo).subscribe(res => {
...
let ChiSoXetNghiemShareComponent = class ChiSoXetNghiemShareComponent {
...
ChiSoXetNghiemShareComponent.ctorParameters = () => [
...
let ChiSoXetNghiemUpdateComponent = class ChiSoXetNghiemUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() { }
...
ChiSoXetNghiemUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_chi_so_xet_nghiem_share_chi_so_xet_nghiem_share_component__WEBPACK_IMPORTED_MODULE_5__["ChiSoXetNghiemShareComponent"], { static: true })
...
let ChiSoXetNghiemService = class ChiSoXetNghiemService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'ChiSoXetNghiem';
    }
};
ChiSoXetNghiemService.ctorParameters = () => [
