...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tiep-nhan-benh-nhan-danh-sach-cho-kham-danh-sach-cho-kham-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachChoKhamChoQuyetComponent = /** @class */ (function () {
                function DanhSachChoKhamChoQuyetComponent(data, dialog, apiService, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                    this.apiService = apiService;
                    this.dialogRef = dialogRef;
                }
                DanhSachChoKhamChoQuyetComponent.prototype.ngOnInit = function () {
                    this.quetThongTinBenhNhan(this.data);
                };
                DanhSachChoKhamChoQuyetComponent.prototype.quetThongTinBenhNhan = function (model) {
                    var _this = this;
                ...
                return DanhSachChoKhamChoQuyetComponent;
            }());
            DanhSachChoKhamChoQuyetComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var DanhSachChoKhamCreateComponent = /** @class */ (function () {
                function DanhSachChoKhamCreateComponent() {
                }
                DanhSachChoKhamCreateComponent.prototype.ngOnInit = function () {
                };
                return DanhSachChoKhamCreateComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachChoKhamErrorComponent = /** @class */ (function () {
                function DanhSachChoKhamErrorComponent() {
                }
                DanhSachChoKhamErrorComponent.prototype.ngOnInit = function () {
                ...
                return DanhSachChoKhamErrorComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachChoKhamListComponent = /** @class */ (function () {
                function DanhSachChoKhamListComponent(apiService, authService, router, notificationService, dialog, route, location) {
                    this.apiService = apiService;
                ...
                DanhSachChoKhamListComponent.prototype.ngOnInit = function () {
                ...
                DanhSachChoKhamListComponent.prototype.backWithSearch = function () {
                ...
                DanhSachChoKhamListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.TimkiemNangCao();
                    }
                };
                DanhSachChoKhamListComponent.prototype.clearSearch = function () {
                    this.searchString = null;
                    this.danhSachChoKham.SearchString = null;
                    this.gridChild.search();
                };
                DanhSachChoKhamListComponent.prototype.Timkiem = function () {
                ...
                DanhSachChoKhamListComponent.prototype.TimkiemNangCao = function () {
                ...
                DanhSachChoKhamListComponent.prototype.searchChanges = function (event) {
                    var self = this;
                ...
                DanhSachChoKhamListComponent.prototype.thoiDiemTNChange = function () {
                    this.TimkiemNangCao();
                };
                DanhSachChoKhamListComponent.prototype.getSharedPrintForm = function (id) {
                    var _this = this;
                    return new Promise(function (resolve) {
                        _this.apiService
                            ...
                            // resolve(resultData);
                            var dialogRef = _this.dialog.open(_in_phieu_dang_ky_kham_popup_in_phieu_dang_ky_kham_popup_component__WEBPACK_IMPORTED_MODULE_31__["InPhieuDangKyKhamPopupComponent"], {
                                width: '1000px',
                                height: 'auto',
                ...
                DanhSachChoKhamListComponent.prototype.edit = function (id) {
                ...
                DanhSachChoKhamListComponent.prototype.deleteTinhTrang = function (id) {
                    var comfirm = "hủy";
                    var self = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_22__["SecurityOperation"].Update)) {
                        this.dialog
                ...
                DanhSachChoKhamListComponent.prototype.InBangKeChiPhiKhamBenh = function (id) {
                ...
                DanhSachChoKhamListComponent.prototype.InHoSoKhamBenh = function (id, laPhieuKhamBenh) {
                    var _this = this;
                    ...
                    this.apiService.get("DanhSachChoKham/InPhieuCacDichVuKhamBenh?yeuCauTiepNhanId=" + id
                        ...
                        if (resultData != null) {
                            _this.dialog.open(_ho_so_benh_an_popup_ho_so_benh_an_popup_component__WEBPACK_IMPORTED_MODULE_25__["HoSoBenhAnPopupComponent"], {
                                disableClose: true,
                                width: "1000px",
                ...
                DanhSachChoKhamListComponent.prototype.InTheBenhNhan = function (id) {
                ...
                DanhSachChoKhamListComponent.prototype.InVongDeoTay = function (id) {
                ...
                DanhSachChoKhamListComponent.prototype.InGiayNghiHuongBHXH = function (dataItem) {
                ...
                DanhSachChoKhamListComponent.prototype.changeQR = function ($event) {
                ...
                DanhSachChoKhamListComponent.prototype.QuetMaQRCodeClick = function () {
                    var elementBarcode = document.getElementById("barcodeActive");
                    if (elementBarcode != undefined) {
                        elementBarcode.click();
                    }
                };
                DanhSachChoKhamListComponent.prototype.getThongTinYeuCauBenhNhan = function (timKiemThongTinBenhNhan) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_22__["SecurityOperation"].Update)) {
                        this.apiService
                            ...
                            if (resultData !== null && resultData !== undefined) {
                                ...
                                _this.notificationService.showError("Không tìm thấy thông tin tiếp nhận cần tìm.");
                            }
                        });
                    }
                    else {
                ...
                DanhSachChoKhamListComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 81 && event.ctrlKey && this.isScanF1 != true) {
                        event.preventDefault();
                        this.QuetMaQRCodeClick();
                    }
                };
                DanhSachChoKhamListComponent.prototype.XuatExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_22__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("DanhSachChoKham/ExportDanhSachTiepNhan", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                //BVHD-3761
                //=======================================================================================================
                DanhSachChoKhamListComponent.prototype.InPhieuXN = function (id) {
                    var _this = this;
                    this.apiService
                ...
                return DanhSachChoKhamListComponent;
            }());
            DanhSachChoKhamListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachChoKhamPdfComponent = /** @class */ (function () {
                function DanhSachChoKhamPdfComponent(apiService) {
                    this.apiService = apiService;
                    this.danhSachChoKham = {};
                }
                DanhSachChoKhamPdfComponent.prototype.ngOnInit = function () {
                };
                return DanhSachChoKhamPdfComponent;
            }());
            DanhSachChoKhamPdfComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachChoKhamPopupComponent = /** @class */ (function () {
                function DanhSachChoKhamPopupComponent(data, dialog) {
                    this.data = data;
                    this.dialog = dialog;
                    this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
                }
                DanhSachChoKhamPopupComponent.prototype.ngOnInit = function () {
                    console.log(this.data);
                };
                DanhSachChoKhamPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return DanhSachChoKhamPopupComponent;
            }());
            DanhSachChoKhamPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachChoKhamRoutingModule = /** @class */ (function () {
                function DanhSachChoKhamRoutingModule() {
                }
                return DanhSachChoKhamRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var DanhSachChoKhamSharedComponent = /** @class */ (function () {
                function DanhSachChoKhamSharedComponent() {
                }
                DanhSachChoKhamSharedComponent.prototype.ngOnInit = function () {
                };
                return DanhSachChoKhamSharedComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachChoKhamUpdateComponent = /** @class */ (function () {
                function DanhSachChoKhamUpdateComponent(apiService, dialog, authService, router, notificationService, location, route, cdRef) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.authService = authService;
                    this.router = router;
                ...
                DanhSachChoKhamUpdateComponent.prototype.ngOnDestroy = function () {
                    //console.log("ngOnDestroy");
                    //this.cdRef.detectChanges();
                };
                DanhSachChoKhamUpdateComponent.prototype.ngOnInit = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.cloneTiepNhanBenhNhan = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.keyEvent = function (event) {
                    //console.log(event);
                ...
                DanhSachChoKhamUpdateComponent.prototype.QuetMaQRCodeClick = function () {
                    var elementBarcode = document.getElementById('barcodeActive');
                    if (elementBarcode != undefined) {
                        elementBarcode.click();
                        this.isScanF1 = true;
                ...
                //#region clear data
                DanhSachChoKhamUpdateComponent.prototype.setDefaultData = function () {
                    this.isDungTuyenDisplay = null;
                    this.isDungTuyen = false;
                    this.isSearchQRCodeEnable = true;
                ...
                DanhSachChoKhamUpdateComponent.prototype.clearThongTinTaiKhoanBenhNhan = function () {
                    this.thongTinTaiKhoanBenhNhan = null;
                };
                DanhSachChoKhamUpdateComponent.prototype.clearThemTaiLieu = function () {
                    this.themTaiLieu = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["ThemTaiLieuDinhKem"]();
                };
                DanhSachChoKhamUpdateComponent.prototype.clearData = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.congTyBaoHiemChange = function ($event) {
                    var _this = this;
                ...
                DanhSachChoKhamUpdateComponent.prototype.setThongTinTaiKhoanBenhNhan = function (idBenhNhan, idYeuCauTiepNhan) {
                    var _this = this;
                    this.apiService.post("TiepNhanBenhNhan/GetThongTinTaiKhoanBenhNhan?idBenhNhan=" + idBenhNhan + "&idYeuCauTiepNhan=" + idYeuCauTiepNhan).subscribe(function (resultData) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.getBenhNhan = function (id) {
                    var _this = this;
                    ...
                    this.apiService.post("TiepNhanBenhNhan/GetYeuCauKhamBenh?id=" + id).subscribe(function (resultData) {
                        ...
                        _this.benhNhanIdPopup = _this.tiepNhanBenhNhan.BenhNhanId;
                        _this.coYeuCauGoiDichVu = _this.tiepNhanBenhNhan.CoYeuCauGoiDichVu;
                        _this.benhNhanId = _this.tiepNhanBenhNhan.BenhNhanId;
                        //
                        _this.getDanhSachGoiBenhNhan(_this.benhNhanId);
                        //
                        _this.setThongTinTaiKhoanBenhNhan(_this.tiepNhanBenhNhan.BenhNhanId, id);
                        if (_this.tiepNhanBenhNhan.TuNhap != true && _this.tiepNhanBenhNhan.CoBHYT) {
                            _this.isDisableNhapTayForUpdate = true;
                        }
                        ...
                        if (resultData.BHYTNgayHieuLuc != null && resultData.BHYTNgayHieuLuc != undefined) {
                            ...
                            _this.tiepNhanBenhNhan.NgayCoHieuLucDisplay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].formatDate(ngayCoHieuLuc, "dd/mm/yyyy");
                        ...
                        if (resultData.BHYTNgayHetHan != null && resultData.BHYTNgayHetHan != undefined) {
                            ...
                            _this.tiepNhanBenhNhan.NgayHetHieuLucDisplay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].formatDate(ngayHetHan, "dd/mm/yyyy");
                        }
                        if (resultData.BHYTNgayDu5Nam != null && resultData.BHYTNgayDu5Nam != undefined) {
                            var ngayDu5Nam = new Date(resultData.BHYTNgayDu5Nam);
                            _this.tiepNhanBenhNhan.NgayDu5NamDisplay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].formatDate(ngayDu5Nam, "dd/mm/yyyy");
                        }
                        ...
                        if (resultData.BaoHiemTuNhans != undefined && resultData.BaoHiemTuNhans != null) {
                            resultData.BaoHiemTuNhans.forEach(function (item) {
                                var model = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["ThemBaoHiemTuNhanGridVo"]();
                                model.Id = item.Id;
                        ...
                        if (resultData.BenhNhan.NamSinh != null && resultData.BenhNhan.ThangSinh != null && resultData.BenhNhan.NgaySinh != null) {
                            ...
                            if (resultData.BenhNhan.NgayThangNamSinh != undefined && resultData.BenhNhan.NgayThangNamSinh != null) {
                                ...
                                var thang = (resultData.BenhNhan.ThangSinh == null || resultData.BenhNhan.ThangSinh == 0) ? 1 : resultData.BenhNhan.ThangSinh;
                                var ngay = (resultData.BenhNhan.NgaySinh == null || resultData.BenhNhan.NgaySinh == 0) ? 1 : resultData.BenhNhan.NgaySinh;
                        ...
                        if (_this.tiepNhanBenhNhan.BHYTMucHuong == null) {
                            ...
                            _this.isHaveBHYTForTheFistLoad = false;
                        }
                        if (_this.tiepNhanBenhNhan.IsCheckedBHYT) {
                            ...
                            _this.tiepNhanBenhNhan.TinhTrangThe = src_app_shared_enum_tinh_trang_the_enum__WEBPACK_IMPORTED_MODULE_19__["TinhTrangThe"].KhongXacDinh;
                        }
                        //
                        ...
                        _this.refreshGrid();
                        _this.dialog.closeAll();
                        _this.cloneTiepNhanBenhNhan();
                    }, function () {
                        _this.dialog.closeAll();
                        //console.log("error")
                    });
                };
                DanhSachChoKhamUpdateComponent.prototype.totalKhac = function (field, goiCoChietkhauId) {
                ...
                ;
                //#endregion grid
                DanhSachChoKhamUpdateComponent.prototype.getSoTienBHYTSeThanhToan = function () {
                    var _this = this;
                ...
                DanhSachChoKhamUpdateComponent.prototype.getListTenTrieuChungKham = function () {
                    var _this = this;
                ...
                DanhSachChoKhamUpdateComponent.prototype.refreshGrid = function () {
                ...
                //#region BHTN
                DanhSachChoKhamUpdateComponent.prototype.setValueForGridBHTN = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.updateBHTN = function () {
                    var _this = this;
                    this.tiepNhanBenhNhan.BaoHiemTuNhans = new Array();
                    this.lstBHTN.forEach(function (obj) {
                        var model = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["BaoHiemTuNhanViewModel"]();
                ...
                DanhSachChoKhamUpdateComponent.prototype.huyBHTN = function () {
                    this.isUpdateGrid = false;
                    this.clearThemBHTN();
                };
                DanhSachChoKhamUpdateComponent.prototype.clearThemBHTN = function () {
                    this.themBaoHiemTuNhanModel = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["ThemBaoHiemTuNhan"]();
                };
                DanhSachChoKhamUpdateComponent.prototype.ThemBHTN = function () {
                    var _this = this;
                    this.validationErrors = null;
                ...
                DanhSachChoKhamUpdateComponent.prototype.updateGridBHTN = function (dataItem) {
                    var _this = this;
                    console.log("updateGridBHTN");
                    this.validationErrors = null;
                    this.apiService.post("TiepNhanBenhNhan/IsHaveCongNo/?yeuCauTiepNhanId=" + this.id
                        + "&congTyId=" + dataItem.CongTyBaoHiemTuNhanId).subscribe(function (resultData) {
                        if (resultData != null && resultData != undefined && resultData == false) {
                            _this.isUpdateGrid = true;
                            //set
                            _this.themBaoHiemTuNhanModel.Id = dataItem.Id;
                            _this.themBaoHiemTuNhanModel.CongTyBaoHiemTuNhanId = dataItem.CongTyBaoHiemTuNhanId;
                            _this.themBaoHiemTuNhanModel.DiaChi = dataItem.DiaChi;
                            _this.themBaoHiemTuNhanModel.MaSoThe = dataItem.MaSoThe;
                            _this.themBaoHiemTuNhanModel.NgayHetHan = dataItem.NgayHetHan;
                            _this.themBaoHiemTuNhanModel.NgayHieuLuc = dataItem.NgayHieuLuc;
                            _this.themBaoHiemTuNhanModel.SoDienThoai = dataItem.SoDienThoai;
                            //this.themBaoHiemTuNhanModel.STT = dataItem.STT; 
                            _this.enableUpdateGird(_this.themBaoHiemTuNhanModel.CongTyBaoHiemTuNhanId);
                        }
                        else {
                            _this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["TiepNhanBenhNhanMessage"].MessageBHTNCongNoCapNhat);
                        }
                    }, function (err) {
                        if (err != undefined && err.ValidationErrors != null) {
                            _this.validationErrors = err.ValidationErrors;
                ...
                DanhSachChoKhamUpdateComponent.prototype.SuaBHTN = function () {
                    var _this = this;
                ...
                DanhSachChoKhamUpdateComponent.prototype.enableUpdateGird = function (id) {
                    this.isUpdateGrid = true;
                    this.isIdNeedUpdate = id;
                };
                DanhSachChoKhamUpdateComponent.prototype.disableUpdateGrid = function () {
                    this.isUpdateGrid = false;
                    this.isIdNeedUpdate = null;
                    this.clearThemBHTN();
                };
                DanhSachChoKhamUpdateComponent.prototype.checkValidAddBHTN = function (id) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.onTabSelect = function ($event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.MaDichVuGoiSelectionChange = function ($event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.MaDichVuSelectionChange = function ($event) {
                    //console.log("abc = ", $event);
                    //this.loaiTiepNhan = 1;
                ...
                DanhSachChoKhamUpdateComponent.prototype.SetEnableDuocHuongBHYT = function (dichVuId, loai) {
                    var _this = this;
                ...
                DanhSachChoKhamUpdateComponent.prototype.MaDichVuChange = function ($event, loaiDichVu, isCheckValidDonGia) {
                    var _this = this;
                    ...
                    var model = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["GetDonGiaVo"]();
                    if ($event != undefined && $event != null
                ...
                DanhSachChoKhamUpdateComponent.prototype.setThanhTienForDichVuModel = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.SoLuongChange = function ($event) {
                    if (this.themChiDinhDichVuModel.DonGia != undefined && this.themChiDinhDichVuModel.DonGia != null
                ...
                DanhSachChoKhamUpdateComponent.prototype.setDataForDichVuKhac = function () {
                    var _this = this;
                    if (this.tiepNhanBenhNhan.YeuCauKhacGrid != null) {
                        this.apiService.get("TiepNhanBenhNhan/GetSarsCoVs").subscribe(function (resultData) {
                            ...
                            if (_this.tiepNhanBenhNhan.YeuCauKhacGrid.length == 0) {
                                _this.showbuttonLuuVaInPhieuXetNghiem = false;
                            }
                            else {
                                if (_this.showbuttonLuuVaInPhieuXetNghiem == false) {
                                    _this.tiepNhanBenhNhan.YeuCauKhacGrid.forEach(function (element) {
                    ...
                    if (this.tiepNhanBenhNhan.YeuCauKhacGrid.filter(function (s) { return s.isCheckRowItem == true; }).length == this.tiepNhanBenhNhan.YeuCauKhacGrid.length) {
                        this.checkAll = true;
                    }
                    else {
                        this.checkAll = false;
                ...
                DanhSachChoKhamUpdateComponent.prototype.setSoLuongChoGridKhac = function () {
                    this.soLuongGoiCoChietKhau = this.gridDataKhacCoChietKhauArray.length - 1;
                };
                DanhSachChoKhamUpdateComponent.prototype.themChiDinhDichVuGoiNew = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.themChiDinhDichVuNew = function () {
                    var _this = this;
                    if (!this.checkValidateUpdateThongTinBHYT()) {
                        this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["TiepNhanBenhNhanMessage"].MessageBHYTThayDoi);
                        return;
                    ...
                    // }
                    //start update goi
                    var model = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["CheckDuSoLuongTonTrongGoi"]();
                ...
                DanhSachChoKhamUpdateComponent.prototype.themDichVu = function (model) {
                    var self = this;
                    var dataRes = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["DichVuTrongGoiKhiThem"]();
                ...
                DanhSachChoKhamUpdateComponent.prototype.addOneDvGoi = function (lstModelDichVu) {
                    var _this = this;
                    var modelCheck = new _danh_sach_cho_kham_model__WEBPACK_IMPORTED_MODULE_43__["CheckDuSoLuongTonTrongGoiListDichVu"]();
                    modelCheck.LstDichVuThem = lstModelDichVu;
                    var model = new _danh_sach_cho_kham_model__WEBPACK_IMPORTED_MODULE_43__["modelUpdateView"]();
                    ...
                    this.apiService.post("TiepNhanBenhNhan/CheckDuSoLuongTonTrongGoiLstDichVu", modelCheck).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null && resultData) {
                            //add goi
                            _this.apiService.post("TiepNhanBenhNhan/ThemDichVuFromGoiUpdateView", model).subscribe(function (resultData) {
                                //this.dialogRef.close(resultData);
                                if (resultData != null && resultData != undefined) {
                                    _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                                    _this.setDataForDichVuKhac();
                                    _this.refreshGrid();
                            ...
                            //ex
                            _this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["TiepNhanBenhNhanMessage"].MessageErrorDVOnGoi);
                        }
                    }, function (err) {
                        if (err != undefined && err.ValidationErrors != null) {
                            _this.validationErrors = err.ValidationErrors;
                ...
                DanhSachChoKhamUpdateComponent.prototype.addDanhSachTongCongFromDanhSachDaChon = function (data) {
                    var _this = this;
                    data.forEach(function (o) {
                        var item = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["DanhSachDichVuChonTrongLanPopup"]();
                ...
                DanhSachChoKhamUpdateComponent.prototype.checkValidateUpdateThongTinBHYT = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.checkValidAddGoiCoChietKhau = function (id) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.themChiDinhDichVuKhacKhamBenh = function (loaiDichVuKhac, lstDataGoi) {
                    var _this = this;
                    ...
                    if (this.gridInChiDinh != undefined && this.gridInChiDinh != null) {
                        var gridData = this.gridInChiDinh.getAllDataFromDatasource();
                        gridData.forEach(function (elements) {
                            ...
                            if (elements.isCheckRowItem == true) {
                                ...
                                _this.listChonDichVuChiDinhReLoad.push(obj);
                            }
                        });
                    }
                    this.themChiDinhDichVuModel.ListDichVuCheckTruocDos = this.listChonDichVuChiDinhReLoad;
                    var urlDefault = "TiepNhanBenhNhan/ThemDichVuForUpdateView";
                    if (loaiDichVuKhac == 4) {
                    ...
                    if (loaiDichVuKhac == 6) {
                        ...
                        this.apiService.post(urlDefault, this.themChiDinhGoiModel).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                ...
                                if (!added_1) {
                                    _this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["TiepNhanBenhNhanMessage"].MessageDichVuTrongGoiTonTai);
                                    return;
                                }
                                ;
                                //
                                var model = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["AddGoiForUpdateView"]();
                                model.LstGrid = new Array();
                                model.YeuCauTiepNhanId = _this.id;
                                model.LstGrid = resultData;
                                model.MucHuong = _this.tiepNhanBenhNhan.BHYTMucHuong;
                                var dialogRef = _this.dialog.open(_popup_them_goi_popup_them_goi_component__WEBPACK_IMPORTED_MODULE_30__["PopupThemGoiComponent"], {
                                    disableClose: false,
                                    width: '1000px',
                                    height: '450px',
                                    data: model,
                ...
                DanhSachChoKhamUpdateComponent.prototype.checkValidAddChiDinhDichVuKhac = function (id) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.setDataForTaiLieuDinhKem = function () {
                ...
                //#region BHYT
                DanhSachChoKhamUpdateComponent.prototype.setValueBHYT = function (model) {
                    var _this = this;
                    ...
                    if (model.dsLichSuKCB2018 != null && model.dsLichSuKCB2018 != undefined) {
                        model.dsLichSuKCB2018.forEach(function (element) {
                            var childModel = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["GridLichSuKCB"]();
                            childModel.STT = STT;
                    ...
                    if (model.dsLichSuKT2018 != null && model.dsLichSuKT2018 != undefined) {
                        model.dsLichSuKT2018.forEach(function (element) {
                            var childModel = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["GridLichSuKiemTraTheBHYT"]();
                            childModel.STT = STT2;
                    ...
                    if (model.isConnectSuccessfully == false) {
                        ...
                        var dialogRef = this.dialog.open(_popup_khong_kiem_tra_duoc_popup_khong_kiem_tra_duoc_component__WEBPACK_IMPORTED_MODULE_26__["PopupKhongKiemTraDuocComponent"], {
                            disableClose: true,
                            width: '700px',
                            height: '300px',
                ...
                DanhSachChoKhamUpdateComponent.prototype.onKey = function (event, isSoTheBHYT, loai) {
                    var _this = this;
                    ...
                    if (this.isSearchQRCodeEnable == true && isQrCodeScan == false) {
                        ...
                        if (event.keyCode === 13) {
                            ...
                            if (this.thongTinBenhNhan.MaThe != null && this.thongTinBenhNhan.MaThe != ""
                                ...
                                var dialogRef = this.dialog.open(_popup_cho_quet_popup_cho_quet_component__WEBPACK_IMPORTED_MODULE_27__["PopupChoQuetComponent"], {
                                    disableClose: true,
                                    width: '500px',
                                    height: '250px',
                                ...
                                dialogRef.afterClosed().subscribe(function (result) {
                                    ...
                                    if (result == null || (result != null && result.maKetQua !== "000" && result.maKetQua !== "004")) {
                                        ...
                                        var dialogRef_1 = _this.dialog.open(_popup_error_popup_error_component__WEBPACK_IMPORTED_MODULE_28__["PopupErrorComponent"], {
                                            disableClose: false,
                                            width: '700px',
                                            height: '300px',
                ...
                DanhSachChoKhamUpdateComponent.prototype.blurMaNoiDKBD = function ($event) {
                    this.setNoiDKBD(this.tiepNhanBenhNhan.BHYTMaDKBD);
                };
                DanhSachChoKhamUpdateComponent.prototype.onKeyMaNoiDKBD = function ($event) {
                    if ($event.keyCode === 13) {
                        this.setNoiDKBD(this.tiepNhanBenhNhan.BHYTMaDKBD);
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.setNoiDKBD = function (ma) {
                    var _this = this;
                ...
                DanhSachChoKhamUpdateComponent.prototype.blur = function ($event, isSoTheBHYT, loai) {
                    var _this = this;
                    if (loai === void 0) { loai = 1; }
                        ...
                        if (this.thongTinBenhNhan.MaThe != null && this.thongTinBenhNhan.MaThe != ""
                            ...
                            dialogRef.afterClosed().subscribe(function (result) {
                                ...
                                if (result == null || (result != null && result.maKetQua !== "000" && result.maKetQua !== "004")) {
                                    ...
                                    //
                                    _this.tiepNhanBenhNhan.MessageErrFromBHYT = result != null ? result.ghiChu : null;
                                    var dialogRef_2 = _this.dialog.open(_popup_error_popup_error_component__WEBPACK_IMPORTED_MODULE_28__["PopupErrorComponent"], {
                                        disableClose: true,
                                        width: '700px',
                                        height: '300px',
                                        data: _this.tiepNhanBenhNhan,
                ...
                DanhSachChoKhamUpdateComponent.prototype.inputQrCode = function (qrCode) {
                    var _this = this;
                    this.apiService.post("BHYT/GetInfoFromURL/?model=" + qrCode).subscribe(function (resultData) {
                        ...
                        if (err.Message != "Validation Failed" && err.Message != null && err.Message != '') {
                            _this.tiepNhanBenhNhan.MessageErrFromBHYT = err.Message;
                        }
                        else {
                            _this.tiepNhanBenhNhan.MessageErrFromBHYT = null;
                        }
                        var dialogRef = _this.dialog.open(_popup_error_popup_error_component__WEBPACK_IMPORTED_MODULE_28__["PopupErrorComponent"], {
                            disableClose: false,
                            width: '700px',
                            height: '300px',
                            data: _this.tiepNhanBenhNhan,
                ...
                DanhSachChoKhamUpdateComponent.prototype.setTuyenKhamBenh = function (maDKBD) {
                    var _this = this;
                    this.apiService.post("TiepNhanBenhNhan/IsDungTuyen?maBenhVien=" + maDKBD).subscribe(function (resultData) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.setSoPhanTramHuongBHYT = function (maThe) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.setSoPhanTramHuongBHYTForThemChiDinh = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.blurDiaChi = function ($event) {
                    this.setDiaChiBHYTForModel(this.tiepNhanBenhNhan.BHYTDiaChi);
                };
                DanhSachChoKhamUpdateComponent.prototype.onKeyDiaChi = function ($event) {
                    if ($event.keyCode === 13) {
                        this.setDiaChiBHYTForModel(this.tiepNhanBenhNhan.BHYTDiaChi);
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.setDiaChiBHYTForModel = function (diaChi) {
                    var _this = this;
                    var self = this;
                    ...
                    var model = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["DiaChiBHYT"]();
                ...
                DanhSachChoKhamUpdateComponent.prototype.kiemTraDiaChiDaCo = function (laGiamHo) {
                ...
                //   }
                // }
                DanhSachChoKhamUpdateComponent.prototype.blurNgayHetHieuLuc = function ($event) {
                    // if (this.removeBHYT != false) return;
                    // this.removeBHYT = true;
                    this.setDuocHuongBHYT(this.tiepNhanBenhNhan.CoBHYT, this.tiepNhanBenhNhan.LyDoVaoVien);
                    //this.setDuocHuongBHYTAndChangeGrid();
                };
                DanhSachChoKhamUpdateComponent.prototype.onKeyNgayHetHieuLuc = function ($event) {
                    if ($event.keyCode === 13) {
                        // if (this.removeBHYT != false) return;
                        // this.removeBHYT = true;
                        this.setDuocHuongBHYT(this.tiepNhanBenhNhan.CoBHYT, this.tiepNhanBenhNhan.LyDoVaoVien);
                ...
                DanhSachChoKhamUpdateComponent.prototype.blurNgayCoHieuLuc = function ($event) {
                    // if (this.removeBHYT != false) return;
                    // this.removeBHYT = true;
                    this.setDuocHuongBHYT(this.tiepNhanBenhNhan.CoBHYT, this.tiepNhanBenhNhan.LyDoVaoVien);
                    //this.setDuocHuongBHYTAndChangeGrid();
                };
                DanhSachChoKhamUpdateComponent.prototype.onKeyNgayCoHieuLuc = function ($event) {
                    if ($event.keyCode === 13) {
                        // if (this.removeBHYT != false) return;
                        // this.removeBHYT = true;
                        this.setDuocHuongBHYT(this.tiepNhanBenhNhan.CoBHYT, this.tiepNhanBenhNhan.LyDoVaoVien);
                ...
                DanhSachChoKhamUpdateComponent.prototype.setDuocHuongBHYTAndChangeGrid = function () {
                    var dateNow = new Date();
                ...
                DanhSachChoKhamUpdateComponent.prototype.setDuocHuongBHYT = function (CoBHYT, LyDoVaoVien) {
                    ...
                    var dateNgayHetHan = new Date(this.tiepNhanBenhNhan.BHYTNgayHetHan);
                    var dateCoHieuLuc = new Date(this.tiepNhanBenhNhan.BHYTNgayHieuLuc);
                ...
                DanhSachChoKhamUpdateComponent.prototype.kiemTraTheBHYTHieuLucHienTai = function () {
                    var dateNow = new Date((new Date()).toDateString());
                    var dateNgayHetHan = new Date(this.tiepNhanBenhNhan.BHYTNgayHetHan);
                    var dateCoHieuLuc = new Date(this.tiepNhanBenhNhan.BHYTNgayHieuLuc);
                ...
                DanhSachChoKhamUpdateComponent.prototype.addBHYTForGridChiDinhDichVu = function () {
                    //khac
                ...
                DanhSachChoKhamUpdateComponent.prototype.removeBHYTForGridChiDinhDichVu = function () {
                    //dich vu ky thuat
                    //khac
                ...
                DanhSachChoKhamUpdateComponent.prototype.addOrRemoveListDichVuToServer = function () {
                    var _this = this;
                    if (this.isAddOrDeleteGrid)
                        return;
                    this.isAddOrDeleteGrid = true;
                    var modelUpdate = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["GridUpdate"]();
                    this.setValueParamsUpdateListDichVu(modelUpdate);
                    this.apiService.post("TiepNhanBenhNhan/AddOrDeleteListDichVuToServer", modelUpdate).subscribe(function (resultData) {
                        //console.log("duocHuongBHYTChange = ", resultData);
                        _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                        _this.setDataForDichVuKhac();
                        _this.refreshGrid();
                        _this.isAddOrDeleteGrid = false;
                    }, function (err) {
                        _this.isAddOrDeleteGrid = false;
                        if (err != undefined && err.ValidationErrors != null) {
                            _this.validationErrors = err.ValidationErrors;
                ...
                DanhSachChoKhamUpdateComponent.prototype.setValueParamsUpdateListDichVu = function (modelUpdate) {
                    ...
                    this.tiepNhanBenhNhan.YeuCauKhacGrid.forEach(function (obj) {
                        if (obj.IsGoiCoChietKhau != true) {
                            var dichVu = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["ListChiDinhNeedUpdate"]();
                ...
                //     )
                // }
                DanhSachChoKhamUpdateComponent.prototype.checkOutOfDateBHYT = function (date) {
                    var _this = this;
                    ...
                    if (date.getTime() < dateNow.getTime()) {
                        ...
                        var dialogRef = this.dialog.open(_popup_het_hieu_luc_popup_het_hieu_luc_component__WEBPACK_IMPORTED_MODULE_25__["PopupHetHieuLucComponent"], {
                            disableClose: true,
                            width: '700px',
                            height: '300px',
                            data: this.tiepNhanBenhNhan,
                        ...
                        dialogRef.afterClosed().subscribe(function (result) {
                            ...
                            if (result == 1) {
                                _this.tiepNhanBenhNhan.TinhTrangThe = src_app_shared_enum_tinh_trang_the_enum__WEBPACK_IMPORTED_MODULE_19__["TinhTrangThe"].HetHieuLuc;
                                _this.clearData();
                            }
                            else if (result == 2) {
                                _this.tiepNhanBenhNhan.IsCheckedBHYT = null;
                ...
                //#endregion BHYT
                //#region upload file
                DanhSachChoKhamUpdateComponent.prototype.uploadFileDone = function (tapTin) {
                    //console.log(tapTin);
                ...
                DanhSachChoKhamUpdateComponent.prototype.uploadFileMienCungChiTraDone = function (tapTin) {
                    //console.log(tapTin);
                ...
                DanhSachChoKhamUpdateComponent.prototype.uploadTaiLieuDone = function ($event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.lichSuKBC = function () {
                    var dialogRef = this.dialog.open(_popup_lich_su_kham_chua_benh_popup_lich_su_kham_chua_benh_component__WEBPACK_IMPORTED_MODULE_29__["PopupLichSuKhamChuaBenhComponent"], {
                        disableClose: false,
                        width: '1000px',
                        height: '409px',
                        data: this.lichSuKCB,
                ...
                DanhSachChoKhamUpdateComponent.prototype.lichSuKiemTraTheBHYT = function () {
                    var dialogRef = this.dialog.open(_popup_lich_su_kiem_tra_bhyt_popup_lich_su_kiem_tra_bhyt_component__WEBPACK_IMPORTED_MODULE_32__["PopupLichSuKiemTraBhytComponent"], {
                        disableClose: false,
                        width: '1200px',
                        height: '500px',
                ...
                DanhSachChoKhamUpdateComponent.prototype.QuanHuyenChange = function ($event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.PhuongXaChange = function ($event) {
                    var _this = this;
                    if ($event != null && $event != undefined) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.QuanHuyenNguoiLienHeChange = function ($event) {
                    console.log("QuanHuyenNguoiLienHeChange = ", $event);
                    this.tiepNhanBenhNhan.NguoiLienHePhuongXaId = null;
                };
                DanhSachChoKhamUpdateComponent.prototype.TinhThanhPhoChange = function ($event) {
                    //console.log("TinhThanhPhoChange = ", $event)
                    this.tiepNhanBenhNhan.QuanHuyenId = null;
                    this.tiepNhanBenhNhan.PhuongXaId = null;
                };
                DanhSachChoKhamUpdateComponent.prototype.TinhThanhPhoNguoiLienHeChange = function ($event) {
                    console.log("TinhThanhPhoNguoiLienHeChange = ", $event);
                    this.tiepNhanBenhNhan.NguoiLienHeQuanHuyenId = null;
                    this.tiepNhanBenhNhan.NguoiLienHePhuongXaId = null;
                };
                DanhSachChoKhamUpdateComponent.prototype.KhoaKhamChange = function ($event) {
                    var _this = this;
                ...
                DanhSachChoKhamUpdateComponent.prototype.ThongTinBenhNhanHoTenChange = function ($event) {
                    if ($event != null) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.ThongTinBenhNhanMaSoTHeChange = function ($event) {
                    if ($event != null) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.ThongTinBenhNhanNgaySinhChange = function ($event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.LoaiDichVuKhacChange = function ($event) {
                    this.removeThemDichVuValue();
                    //this.themChiDinhDichVuModel.LoaiDichVuKhac = $event;
                };
                DanhSachChoKhamUpdateComponent.prototype.loaiTiepNhanChange = function ($event) {
                    if ($event == 1) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.removeThemDichVuValue = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.removeThemGoiValue = function () {
                    //console.log("removeThemDichVuValue");
                    this.themChiDinhGoiModel = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["ThemChiDinhDichVu"]();
                    //this.setDuocHuongBHYT();
                ...
                DanhSachChoKhamUpdateComponent.prototype.duocHuongBHYTChange = function ($event, id, nhom) {
                    var _this = this;
                    ...
                    modelUpdate.NgaySinh = this.tiepNhanBenhNhan.NgayThangNamSinh;
                    this.validationErrors = null;
                    this.apiService.post("TiepNhanBenhNhan/CheckOrUncheckBHYTForDichVu", modelUpdate).subscribe(function (resultData) {
                        //console.log("duocHuongBHYTChange = ", resultData);
                        _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                        _this.setDataForDichVuKhac();
                        _this.refreshGrid();
                ...
                DanhSachChoKhamUpdateComponent.prototype.changDuocHuongBHYT = function ($event, dataItem) {
                    var _this = this;
                    if (!this.checkValidateUpdateThongTinBHYT()) {
                        this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["TiepNhanBenhNhanMessage"].MessageBHYTThayDoi);
                        return;
                    ...
                    modelUpdate.yeuCauTiepNhanId = this.id;
                    this.validationErrors = null;
                    this.apiService.post("TiepNhanBenhNhan/CapNhatDuocHuongBHYTDichVu", modelUpdate).subscribe(function (resultData) {
                        _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                        _this.setDataForDichVuKhac();
                        _this.refreshGrid();
                    }, function (err) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.noiThucHienGridChange = function ($event, dataItem) {
                    var _this = this;
                    ...
                    this.validationErrors = null;
                    this.apiService.post("TiepNhanBenhNhan/NoiThucHienChange", modelUpdate).subscribe(function (resultData) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.removeGridKhac = function (dataItem) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                        ...
                        if (result == 'Yes') {
                            ...
                            var modelUpdate = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["GridUpdate"]();
                            modelUpdate.yeuCauTiepNhanId = _this.id;
                            modelUpdate.maDichVuId = dataItem.Id;
                            modelUpdate.nhom = dataItem.Nhom;
                            modelUpdate.mucHuong = _this.tiepNhanBenhNhan.BHYTMucHuong;
                            modelUpdate.model = _this.tiepNhanBenhNhan;
                            _this.listChonDichVuChiDinhReLoad = [];
                            if (_this.gridInChiDinh != undefined && _this.gridInChiDinh != null) {
                                var gridData = _this.gridInChiDinh.getAllDataFromDatasource();
                                gridData.forEach(function (elements) {
                                    if (elements.isCheckRowItem == true) {
                                        var obj = {
                                            Id: elements.Id,
                            ...
                            modelUpdate.ListDichVuCheckTruocDos = _this.listChonDichVuChiDinhReLoad;
                            _this.validationErrors = null;
                            _this.apiService.post("TiepNhanBenhNhan/RemoveDichVu", modelUpdate).subscribe(function (resultData) {
                                //console.log("duocHuongBHYTChange = ", resultData);
                                _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                                _this.setDataForDichVuKhac();
                                _this.refreshGrid();
                                _this.getDanhSachGoiBenhNhan(_this.tiepNhanBenhNhan.BenhNhanId);
                                _this.notificationService.showSuccess(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["TiepNhanBenhNhanMessage"].MessageRemoveDichVuSuccessfully);
                            }, function (err) {
                                if (err != undefined && err.ValidationErrors != null) {
                                    _this.validationErrors = err.ValidationErrors;
                                }
                ...
                DanhSachChoKhamUpdateComponent.prototype.removeGridKhacCoChietKhau = function (item) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                        disableClose: false,
                        width: '400px',
                        ...
                        if (result == 'Yes') {
                            ...
                            modelUpdate.model = _this.tiepNhanBenhNhan;
                            _this.validationErrors = null;
                            _this.apiService.post("TiepNhanBenhNhan/RemoveDichVuCoChietKhau", modelUpdate).subscribe(function (resultData) {
                                //console.log("duocHuongBHYTChange = ", resultData);
                                _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                                _this.setDataForDichVuKhac();
                                _this.refreshGrid();
                ...
                DanhSachChoKhamUpdateComponent.prototype.changeQR = function ($event) {
                    if ($event != null) {
                        this.modelQRCode = $event;
                ...
                DanhSachChoKhamUpdateComponent.prototype.huy = function () {
                    // this.router.navigate(['danh-sach-tiep-nhan/']);
                    this.location.back();
                };
                DanhSachChoKhamUpdateComponent.prototype.cloneDiaChiNguoiGiamHo = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.cloneDiaChiNguoiGiamHoLonHon6Tuoi = function () {
                    this.tiepNhanBenhNhan.NguoiLienHeTinhThanhId = null;
                    this.tiepNhanBenhNhan.NguoiLienHeQuanHuyenId = null;
                    this.tiepNhanBenhNhan.NguoiLienHePhuongXaId = null;
                    this.tiepNhanBenhNhan.NguoiLienHeDiaChi = null;
                };
                DanhSachChoKhamUpdateComponent.prototype.luuPhieu = function () {
                    var _this = this;
                    var self = this;
                    self.validationErrors = null;
                    var comfrim = "lưu phiếu khám bệnh cho bệnh nhân";
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
                        ...
                        this.isActiveAction = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                self.apiService.post("TiepNhanBenhNhan/UpdateYeuCauKhamBenh", _this.tiepNhanBenhNhan).subscribe(function (resultData) {
                                    //console.log("result", resultData)
                                    //self.router.navigate(['danh-sach-tiep-nhan/']);
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["SystemMessage"].ActionSuccessfully, ["Thay đổi"]));
                                    //self.ngOnInit();
                ...
                DanhSachChoKhamUpdateComponent.prototype.themTaiLieuButton = function () {
                    var _this = this;
                    ...
                    this.apiService.post("TiepNhanBenhNhan/GetNameLoaiTaiLieuDinhKem", this.themTaiLieu).subscribe(function (resultData) {
                        var taiLieuNew = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["HoSoYeuCauTiepNhanViewModel"]();
                ...
                DanhSachChoKhamUpdateComponent.prototype.removeTaiLieu = function (data) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.viewTaiLieu = function (file) {
                    //console.log("viewTaiLieu = ", dataItem);
                    var duongDan = file.DuongDan;
                    if (file.AddNew) {
                        duongDan = file.DuongDanTmp;
                    }
                    var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_31__["HttpParams"]({
                        fromObject: {
                ...
                DanhSachChoKhamUpdateComponent.prototype.removeGridBHTN = function (id) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                        disableClose: false,
                        width: '400px',
                        ...
                        if (result == 'Yes') {
                            _this.validationErrors = null;
                            _this.apiService.post("TiepNhanBenhNhan/IsHaveCongNo/?yeuCauTiepNhanId=" + _this.id
                                + "&congTyId=" + id).subscribe(function (resultData) {
                                if (resultData != null && resultData != undefined && resultData == false) {
                                    //remove BHTN
                                    ...
                                    _this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["TiepNhanBenhNhanMessage"].MessageBHTNCongNo);
                                }
                            }, function (err) {
                                if (err != undefined && err.ValidationErrors != null) {
                                    _this.validationErrors = err.ValidationErrors;
                ...
                DanhSachChoKhamUpdateComponent.prototype.LoaiGiaChange = function ($event) {
                    var _this = this;
                    var model = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["GetDonGiaVo"]();
                    if ($event != undefined && $event != null
                ...
                DanhSachChoKhamUpdateComponent.prototype.DonGiaChange = function ($event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.lyDoVaoVienChange = function ($event, removeBHYT) {
                    if (removeBHYT === void 0) { removeBHYT = false; }
                ...
                DanhSachChoKhamUpdateComponent.prototype.tuNhapChange = function ($event) {
                    if ($event == true) {
                        this.tiepNhanBenhNhan.CoBHYT = true;
                ...
                DanhSachChoKhamUpdateComponent.prototype.blurBHYTMucHuong = function ($event) {
                    //console.log("blurBHYTMucHuong");
                    this.mucHuongChange();
                };
                DanhSachChoKhamUpdateComponent.prototype.onKeyBHYTMucHuong = function ($event) {
                    if ($event.keyCode === 13) {
                        //console.log("onKeyBHYTMucHuong");
                        this.mucHuongChange();
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.soNhaDuongPhoChange = function (model) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.mucHuongChange = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.bindMucHuongFromSoTheBHYT = function (soTheBHYT) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.coBHYTChange = function ($event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.clearDataUpdateThongTinBHYTFromModel = function () {
                    this.tiepNhanBenhNhan.CoBHYT = false;
                    this.tiepNhanBenhNhan.TuNhap = false;
                ...
                DanhSachChoKhamUpdateComponent.prototype.clearDataUpdateThongTinBHYT = function () {
                    this.tiepNhanBenhNhan.BHYTCoQuanBHXH = null;
                    this.tiepNhanBenhNhan.BHYTDiaChi = null;
                    this.tiepNhanBenhNhan.BHYTMaDKBD = null;
                    this.tiepNhanBenhNhan.BHYTMaSoThe = null;
                ...
                //     });
                // }
                DanhSachChoKhamUpdateComponent.prototype.onOpenChange = function () {
                    this.voucherList.getDataForLookup();
                };
                DanhSachChoKhamUpdateComponent.prototype.NamSinhChange = function (event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.getAge = function (date_1, date_2) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.DaysInMonth = function (date2_UTC) {
                    var monthStart = new Date(date2_UTC.getFullYear(), date2_UTC.getMonth(), 1);
                    var monthEnd = new Date(date2_UTC.getFullYear(), date2_UTC.getMonth() + 1, 1);
                    var monthLength = (monthEnd - monthStart) / (1000 * 60 * 60 * 24);
                    return monthLength;
                };
                DanhSachChoKhamUpdateComponent.prototype.InTheBenhNhanTiepNhan = function () {
                    this.dialog
                ...
                DanhSachChoKhamUpdateComponent.prototype.InVongDeoTay = function () {
                    this.dialog
                ...
                DanhSachChoKhamUpdateComponent.prototype.onKeyScanner = function (event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.onKeyHinhThucDen = function (event) {
                    if (event.keyCode === 9) {
                        this.tabStrip.selectTab(0);
                        var self_1 = this;
                        setTimeout(function () {
                            //console.log("setTimeout = ", self.dichVuCombobox);
                            if (self_1.dichVuCombobox != undefined) {
                                self_1.dichVuCombobox.focusManual();
                            }
                        }, 100);
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.tabscripChange = function (event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.ngayCoHieuLucChange = function ($event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.OnChangeHinhThucDen = function (dataEvent) {
                    if (dataEvent != undefined && dataEvent.KeyId === 2) {
                        this.tiepNhanBenhNhan.NoiGioiThieuId = 1;
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.loaiGiaGridChange = function ($event, dataItem) {
                    var _this = this;
                    if ($event == undefined || $event == null) {
                    ...
                    this.validationErrors = null;
                    this.apiService.post("TiepNhanBenhNhan/LoaiGiaGridChange", modelUpdate).subscribe(function (resultData) {
                        //console.log("duocHuongBHYTChange = ", resultData);
                        _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                        _this.setDuocHuongBHYT($event, _this.tiepNhanBenhNhan.LyDoVaoVien);
                        _this.setDataForDichVuKhac();
                        _this.refreshGrid();
                    }, function (err) {
                        if (err != undefined && err.ValidationErrors != null) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.soLuongGridChange = function ($event, dataItem) {
                    // if ($event == undefined || $event == null) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.soLuongBlur = function (dataItem) {
                    var _this = this;
                    //console.log("soLuongBlur = ", dataItem);
                    var $event = dataItem.SoLuong;
                    if ($event == undefined || $event == null) {
                    ...
                    modelUpdate.soLuong = $event;
                    this.validationErrors = null;
                    this.apiService.post("TiepNhanBenhNhan/SoLuongGridChange", modelUpdate).subscribe(function (resultData) {
                        //console.log("duocHuongBHYTChange = ", resultData);
                        _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                        _this.setDuocHuongBHYT($event, _this.tiepNhanBenhNhan.LyDoVaoVien);
                        _this.setDataForDichVuKhac();
                ...
                DanhSachChoKhamUpdateComponent.prototype.onKeyMaDichVu = function ($event) {
                    if ($event.keyCode == 13) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.openCombobox = function ($event) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.getDanhSachGoiBenhNhan = function (benhNhanId) {
                    var _this = this;
                ...
                DanhSachChoKhamUpdateComponent.prototype.setUpDataTooltip = function (dataItem) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.suDungGoiMarketingChange = function (event) {
                    //console.log("suDungGoiMarketingChange = ", event);
                    if (event) {
                        this.openPopupGoiDichVu();
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.showPopupMarketingWithHyperlink = function (item) {
                    //console.log("showPopupMarketingWithHyperlink = ", item);
                    this.openPopupGoiDichVu(item);
                };
                DanhSachChoKhamUpdateComponent.prototype.openPopupGoiDichVu = function (danhSachGoiDaChon) {
                    var _this = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].View)) {
                        var duocHuongBHYT = this.kiemTraTheBHYTHieuLucHienTai();
                        //----------------------------//
                        this.listChonDichVuChiDinhReLoad = [];
                        this.listChonDichVuChiDinh = [];
                        if (this.gridInChiDinh != undefined && this.gridInChiDinh != null) {
                        ...
                        self.dialog.open(_popup_marketing_tnbn_update_popup_marketing_tnbn_update_component__WEBPACK_IMPORTED_MODULE_42__["PopupMarketingTnbnUpdateComponent"], {
                            ...
                            self.removeThemDichVuValue();
                            self.removeThemGoiValue();
                            var findDvGoi = _this.tiepNhanBenhNhan.YeuCauKhacGrid.filter(function (o) { return o.IsGoiCoChietKhau; });
                            if (result == undefined && _this.disabledCheckboxMarketing != true
                                && findDvGoi.length == 0) {
                                _this.suDungGoiMarketingModelTemp = false;
                            }
                        });
                ...
                DanhSachChoKhamUpdateComponent.prototype.removeGoi = function (item) {
                    var _this = this;
                    ...
                    this.isActiveAction = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                        ...
                        if (result == "Yes") {
                            _this.removeGoiGiuLaiDichVu(item);
                        }
                        else {
                            _this.removeGoiKhongGiuLaiDichVu(item);
                        }
                    });
                    //this.removeGoiDaChon(item.ChuongTrinhGoiDichVuId);
                };
                DanhSachChoKhamUpdateComponent.prototype.removeGoiGiuLaiDichVu = function (model) {
                    var _this = this;
                    this.apiService.post("TiepNhanBenhNhan/XoaGoiGiuLaiDichVu", model).subscribe(function (resultData) {
                        //this.dialogRef.close(resultData);
                        if (resultData != null && resultData != undefined) {
                            _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                            _this.setDataForDichVuKhac();
                ...
                DanhSachChoKhamUpdateComponent.prototype.removeGoiKhongGiuLaiDichVu = function (model) {
                    var _this = this;
                    this.apiService.post("TiepNhanBenhNhan/XoaGoiKhongGiuLaiDichVu", model).subscribe(function (resultData) {
                        //this.dialogRef.close(resultData);
                        if (resultData != null && resultData != undefined) {
                            _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                            _this.setDataForDichVuKhac();
                ...
                DanhSachChoKhamUpdateComponent.prototype.QuetMaQRCodeVoucherClick = function () {
                    var elementBarcode = document.getElementById("barcodeActive");
                    if (elementBarcode != undefined) {
                        elementBarcode.click();
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.changeVoucherQR = function ($event) {
                    if ($event != null && typeof $event == "string" && $event.endsWith("@")) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.getThongTinVoucher = function (id) {
                    var _this = this;
                    this.apiService.get("ThuNgan/GetMaVoucher?yeucauTiepNhanId=" + id).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData !== null) {
                            _this.tiepNhanBenhNhan.LstMaVoucher = [];
                            resultData.forEach(function (item) {
                                _this.value.push(item.DisplayName);
                                _this.listVoucherItem.push(item.KeyId + "|" + item.DisplayName);
                            });
                            _this.tiepNhanBenhNhan.LstMaVoucher = _this.listVoucherItem;
                        }
                    });
                };
                DanhSachChoKhamUpdateComponent.prototype.kiemTraThongTinMaVoucher = function (maVoucher) {
                    var _this = this;
                ...
                DanhSachChoKhamUpdateComponent.prototype.open = function () {
                    this.multiselect.toggle(false);
                };
                DanhSachChoKhamUpdateComponent.prototype.removeTag = function (ev) {
                    this.KiemTraTheVoucherSuDung(ev.dataItem);
                };
                DanhSachChoKhamUpdateComponent.prototype.KiemTraTheVoucherSuDung = function (theVoucher) {
                    var _this = this;
                    ...
                    this.apiService.post("TiepNhanBenhNhan/KiemTraTheVoucherSuDung", thongTinVoucherTheoYeuCauTiepNhan)
                        ...
                        if (resultData.Item1) {
                            _this.value = [];
                            _this.notificationService.showError(resultData.Item2);
                            _this.getThongTinVoucher(_this.id);
                            _this.newBarcode = "";
                            return true;
                        }
                        else {
                            ...
                            if (_this.tiepNhanBenhNhan.LstMaVoucher.length > 0) {
                                _this.tiepNhanBenhNhan.LstMaVoucher.forEach(function (element) {
                                    ...
                                    if (dataVoucher[1] !== theVoucher) {
                                        maVouchers_1.push(dataVoucher[0] + "|" + dataVoucher[1]);
                                    }
                                });
                                _this.listVoucherItem = maVouchers_1;
                                _this.tiepNhanBenhNhan.LstMaVoucher = maVouchers_1;
                                _this.newBarcode = "";
                            }
                        }
                    });
                };
                DanhSachChoKhamUpdateComponent.prototype.blurVoucher = function () {
                    if (this.newBarcode != "") {
                        this.kiemTraThongTinMaVoucher(this.newBarcode);
                    }
                    ;
                };
                DanhSachChoKhamUpdateComponent.prototype.onKeyBarCode = function (event) {
                    if (event.keyCode === 13) {
                        this.multiselect.blur();
                        this.multiselect.focus();
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.filterChange = function (filter) {
                    if (filter != null && filter != "") {
                        this.newBarcode = filter;
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.showTaoYCTNMoi = function () {
                ...
                DanhSachChoKhamUpdateComponent.prototype.taoYCTNMoi = function () {
                    var _this = this;
                    var self = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                        disableClose: false,
                ...
                DanhSachChoKhamUpdateComponent.prototype.checkboxIn = function (event, dataItem) {
                    ...
                    if (event == true) {
                        if (index == -1) {
                            ...
                            if (this.listChonDichVuChiDinh.length == this.gridDataKhacDisplay.data.filter(function (sp) { return ((sp.TrangThaiYeuCauKhamBenh != null && sp.TrangThaiYeuCauKhamBenh != 6) ||
                ...
                DanhSachChoKhamUpdateComponent.prototype.SelectcheckAllboxIn = function (event) {
                    var _this = this;
                    var gridDataIn = [];
                ...
                DanhSachChoKhamUpdateComponent.prototype.inChiDinh = function (kieuIn) {
                    var _this = this;
                    this.listChonDichVuChiDinhReLoad = [];
                    if (this.gridInChiDinh != undefined && this.gridInChiDinh != null) {
                        var gridData = this.gridInChiDinh.getAllDataFromDatasource();
                        ...
                        var listGridSelect_1 = [];
                        gridData.forEach(function (elements) {
                            if (elements.isCheckRowItem == true) {
                                listGridSelect_1.push(elements);
                            }
                        });
                        var dataIn = {
                            ...
                            listGridSelect: listGridSelect_1,
                            Loai: 1,
                            InDichVuBacSiChiDinh: true
                        };
                        var dialogRef = this.dialog.open(_popup_chon_loai_In_popup_chon_loai_in_view_popup_chon_loai_in_view_component__WEBPACK_IMPORTED_MODULE_51__["PopupChonLoaiInViewComponent"], {
                            width: '1000px',
                            data: { Model: dataIn }
                        });
                    }
                ...
                DanhSachChoKhamUpdateComponent.prototype.huyDichVuDaHuyThanhToan = function (dataItem) {
                    var _this = this;
                    this.dialog.open(_huy_dich_vu_huy_thanh_toan_popup_huy_dich_vu_huy_thanh_toan_popup_component__WEBPACK_IMPORTED_MODULE_45__["HuyDichVuHuyThanhToanPopupComponent"], {
                        ...
                        if (result != undefined && result != null && result != "") {
                            ...
                            _this.apiService.post("TiepNhanBenhNhan/RemoveDichVu", modelUpdate).subscribe(function (resultData) {
                                ...
                                _this.refreshGrid();
                                _this.getDanhSachGoiBenhNhan(_this.tiepNhanBenhNhan.BenhNhanId);
                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["SystemMessage"].ActionSuccessfully, ["Hủy dịch vụ "]));
                            }, function (err) {
                                if (err != undefined && err.ValidationErrors != null) {
                                    _this.validationErrors = err.ValidationErrors;
                                }
                ...
                DanhSachChoKhamUpdateComponent.prototype.cacDichVuKM = function () {
                ...
                //===================================BVHD-3825==========================================
                DanhSachChoKhamUpdateComponent.prototype.xemGoiDichVuKhuyenMai = function () {
                    var _this = this;
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].View)) {
                        ...
                        self.dialog.open(_dich_vu_khuyen_mai_dich_vu_khuyen_mai_popup_dich_vu_khuyen_mai_popup_component__WEBPACK_IMPORTED_MODULE_46__["DichVuKhuyenMaiPopupComponent"], {
                            ...
                            if (yeuCauGoiMarketing != undefined && yeuCauGoiMarketing != null && yeuCauGoiMarketing != "") {
                                ...
                                self.apiService.post("TiepNhanBenhNhan/KiemTraDichVuKhuyenMaiTrongGoiMarketingDaCoTheoYeuCauTiepNhan", yeuCauGoiMarketing).subscribe(function (resultData) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.xuLyThemNhomDichVuKhuyenMai = function (yeuCauGoiMarketing) {
                    var _this = this;
                    if (!this.checkValidateUpdateThongTinBHYT()) {
                        this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["TiepNhanBenhNhanMessage"].MessageBHYTThayDoi);
                        return;
                    ...
                    this.apiService.post("TiepNhanBenhNhan/ThemChiDinhGoiDichVuKhuyenMaiTheoTiepNhan", yeuCauGoiMarketing).subscribe(function (result) {
                        var mess = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["SystemMessage"].ActionSuccessfully, ["Thêm"]);
                        _this.notificationService.showSuccess(mess);
                        // reload grid
                        if (result == null)
                            return;
                        _this.tiepNhanBenhNhan.YeuCauKhacGrid = result;
                        _this.setDataForDichVuKhac();
                        _this.refreshGrid();
                ...
                DanhSachChoKhamUpdateComponent.prototype.changeDichVuKhuyenMai = function (event, dataItem) {
                    var _this = this;
                    var modelUpdate = {};
                    modelUpdate.lstChiDinhDichVu = new Array();
                    modelUpdate.yeuCauTiepNhanId = this.id;
                    ...
                    this.validationErrors = null;
                    this.apiService.post("TiepNhanBenhNhan/ChuyenDoiDichVuKhuyenMai", modelUpdate).subscribe(function (resultData) {
                        _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                        _this.setDataForDichVuKhac();
                        _this.refreshGrid();
                    }, function (err) {
                ...
                //======================================================================================
                DanhSachChoKhamUpdateComponent.prototype.changeDichVuTrongGoi = function (event, dataItem) {
                    var _this = this;
                    var modelUpdate = {};
                    modelUpdate.lstChiDinhDichVu = new Array();
                    modelUpdate.yeuCauTiepNhanId = this.id;
                    ...
                    modelUpdate.soLuong = dataItem.SoLuong;
                    this.validationErrors = null;
                    this.apiService.post("TiepNhanBenhNhan/ChuyenDoiDichVuTrongVaNgoaiGoi", modelUpdate).subscribe(function (resultData) {
                        _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                        // this.setDuocHuongBHYT($event, this.tiepNhanBenhNhan.LyDoVaoVien);
                        _this.setDataForDichVuKhac();
                        _this.refreshGrid();
                ...
                DanhSachChoKhamUpdateComponent.prototype.showPopupLoadingData = function (typeLoading) {
                    if (typeLoading === void 0) { typeLoading = src_app_shared_enum_kham_benh_enum__WEBPACK_IMPORTED_MODULE_50__["EnumTypeLoadingData"].View; }
                ...
                DanhSachChoKhamUpdateComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                DanhSachChoKhamUpdateComponent.prototype.xemNhomDichVuThuongDung = function () {
                    var _this = this;
                    var self = this;
                    var boPhan = src_app_shared_enum_bo_phan_enum__WEBPACK_IMPORTED_MODULE_55__["BoPhan"].TiepNhanNgoaiTru;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].View)) {
                        self.dialog.open(_kham_benh_kham_benh_lan_kham_hien_tai_lan_kham_hien_tai_nhom_dich_vu_thuong_dung_popup_lan_kham_hien_tai_nhom_dich_vu_thuong_dung_popup_component__WEBPACK_IMPORTED_MODULE_47__["LanKhamHienTaiNhomDichVuThuongDungPopupComponent"], {
                            ...
                            if (yeuCauGoiThuongDung) {
                                ...
                                self.apiService.post("KhamBenh/KiemTraDichVuTrongGoiDaCoTheoYeuCauTiepNhan", yeuCauGoiThuongDung).subscribe(function (resultData) {
                                    if (resultData && resultData.length > 0) {
                ...
                DanhSachChoKhamUpdateComponent.prototype.xuLyThemNhomDichVuThuongDung = function (yeuCauGoiThuongDung) {
                    var _this = this;
                    if (!this.checkValidateUpdateThongTinBHYT()) {
                        this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["TiepNhanBenhNhanMessage"].MessageBHYTThayDoi);
                        return;
                    ...
                    this.apiService.post("TiepNhanBenhNhan/ThemYeuGoiDichVuThuongDung", yeuCauGoiThuongDung).subscribe(function (result) {
                        var mess = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["SystemMessage"].ActionSuccessfully, ["Thêm "]);
                        _this.notificationService.showSuccess(mess);
                        // reload grid
                        if (result == null)
                ...
                DanhSachChoKhamUpdateComponent.prototype.capNhatThongTinThucHienDichVu = function (dataItem, isThucHien) {
                    var _this = this;
                    if (isThucHien === void 0) { isThucHien = true; }
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
                        var newObj = {
                        ...
                        this.dialog.open(_kham_benh_kham_benh_lan_kham_hien_tai_cap_nhat_thong_tin_thuc_hien_dvkt_popup_cap_nhat_thong_tin_thuc_hien_dvkt_popup_component__WEBPACK_IMPORTED_MODULE_52__["CapNhatThongTinThucHienDvktPopupComponent"], {
                            ...
                            if (res) {
                                ...
                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["SystemMessage"].ActionSuccessfully, [mess]));
                                _this.apiService.get("TiepNhanBenhNhan/GetGridDichVuDaChiDinh?yeuCauTiepNhanId=" + _this.id).subscribe(function (resultData) {
                                    _this.tiepNhanBenhNhan.YeuCauKhacGrid = resultData;
                                    _this.setDataForDichVuKhac();
                                    _this.refreshGrid();
                                }, function (err) {
                ...
                // BVHD-3761
                //================================================================================================
                DanhSachChoKhamUpdateComponent.prototype.getListDichVuSarsCoVs = function () {
                    var _this = this;
                    this.apiService.get("TiepNhanBenhNhan/GetSarsCoVs").subscribe(function (resultData) {
                        _this.dichVuSarsCoVs = [];
                        _this.dichVuSarsCoVs = resultData.Ids;
                ...
                //BVHD-3761
                //=======================================================================================================
                DanhSachChoKhamUpdateComponent.prototype.InPhieuXN = function () {
                    var _this = this;
                    ...
                    this.apiService
                        ...
                        if (resultData != null && resultData != "") {
                            var dialogRef = _this.dialog.open(_in_phieu_xn_covid_in_phieu_xn_covid_component__WEBPACK_IMPORTED_MODULE_54__["InPhieuXnCovidComponent"], {
                                width: '1000px',
                                height: 'auto',
                                data: { Model: resultData }
                            }).afterClosed().subscribe(function (result) {
                ...
                return DanhSachChoKhamUpdateComponent;
            }());
            DanhSachChoKhamUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachChoKhamModule = /** @class */ (function () {
                function DanhSachChoKhamModule() {
                }
                return DanhSachChoKhamModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachChoKhamService = /** @class */ (function (_super) {
                __extends(DanhSachChoKhamService, _super);
                function DanhSachChoKhamService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'DanhSachChoKham';
                    return _this;
                }
                return DanhSachChoKhamService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            DanhSachChoKhamService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HoSoBenhAnPopupComponent = /** @class */ (function () {
                function HoSoBenhAnPopupComponent(dialogRef, sanitizer, apiService, dialog, notificationService, data) {
                    this.dialogRef = dialogRef;
                ...
                HoSoBenhAnPopupComponent.prototype.ngOnInit = function () {
                    this.getALlFilePDFFromHtml(this.data.html);
                };
                HoSoBenhAnPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                HoSoBenhAnPopupComponent.prototype.getALlFilePDFFromHtml = function (arrHtml) {
                    var _this = this;
                ...
                HoSoBenhAnPopupComponent.prototype.downloadAllFile = function () {
                    var dateTimeNow = new Date();
                ...
                HoSoBenhAnPopupComponent.prototype.showPopupLoadingData = function () {
                ...
                HoSoBenhAnPopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData) {
                        this.popupLoadingData.close();
                    }
                };
                return HoSoBenhAnPopupComponent;
            }());
            HoSoBenhAnPopupComponent.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @iconify/icons-ic/twotone-close */ "./node_modules/@iconify/icons-ic/twotone-close.js");
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            var HuyDichVuHuyThanhToanPopupComponent = /** @class */ (function () {
                function HuyDichVuHuyThanhToanPopupComponent(data, dialog, cdRef, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                    this.cdRef = cdRef;
                    this.dialogRef = dialogRef;
                ...
                HuyDichVuHuyThanhToanPopupComponent.prototype.ngOnInit = function () {
                };
                HuyDichVuHuyThanhToanPopupComponent.prototype.Huy = function () {
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                ...
                HuyDichVuHuyThanhToanPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return HuyDichVuHuyThanhToanPopupComponent;
            }());
            HuyDichVuHuyThanhToanPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InPhieuDangKyKhamPopupComponent = /** @class */ (function () {
                function InPhieuDangKyKhamPopupComponent(data, sanitizer, apiService, dialog) {
                    this.data = data;
                    this.sanitizer = sanitizer;
                    this.apiService = apiService;
                    this.dialog = dialog;
                ...
                InPhieuDangKyKhamPopupComponent.prototype.ngOnInit = function () {
                ...
                InPhieuDangKyKhamPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                InPhieuDangKyKhamPopupComponent.prototype.InPhieu = function (loaiPhieu) {
                    this.loaiPhieu = loaiPhieu;
                    if (this.modelPrint != undefined) {
                    }
                    this.getSharedPrintForm();
                };
                InPhieuDangKyKhamPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    ...
                    if (this.loaiPhieu == 3) // dv xn covid
                     {
                        if (this.phieuDichVuChiDinhXetNghiemTestCovid.length == 0) {
                            var chuoiIn_7 = "Không có phiếu chỉ định xét nghiệm Sars Cov 2";
                            return new Promise(function (resolve) {
                                resolve(chuoiIn_7);
                                chuoiIn_7 = "";
                                _this.phieuDichVuKyThuatCLS = [];
                ...
                return InPhieuDangKyKhamPopupComponent;
            }());
            InPhieuDangKyKhamPopupComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NghiHuongBhxhTiepNhanDetailPopupComponent = /** @class */ (function () {
                function NghiHuongBhxhTiepNhanDetailPopupComponent(dialog, data) {
                    this.dialog = dialog;
                    this.data = data;
                    this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_2___default.a;
                    this.src = "";
                }
                NghiHuongBhxhTiepNhanDetailPopupComponent.prototype.ngOnInit = function () {
                    this.src = "data:text/html;charset=utf-8," + encodeURIComponent(this.data.templateLienSo1);
                };
                NghiHuongBhxhTiepNhanDetailPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                NghiHuongBhxhTiepNhanDetailPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        resolve(_this.data.templateLienSo1);
                        _this.close();
                    });
                };
                return NghiHuongBhxhTiepNhanDetailPopupComponent;
            }());
            NghiHuongBhxhTiepNhanDetailPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NghiHuongBhxhTiepNhanPopupComponent = /** @class */ (function () {
                function NghiHuongBhxhTiepNhanPopupComponent(apiService, notificationService, dialog, data, ref, dialogRef) {
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.dialog = dialog;
                    this.data = data;
                ...
                NghiHuongBhxhTiepNhanPopupComponent.prototype.ngOnInit = function () {
                    console.log(this.data);
                ...
                NghiHuongBhxhTiepNhanPopupComponent.prototype.xemGiayHuongBHXH = function () {
                    var _this = this;
                    var loading = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_7__["LoadingComponent"], {
                        disableClose: true,
                        width: "200px",
                        height: "90px",
                        data: { Title: "Đang tải dữ liệu..." },
                    ...
                    this.apiService.post("DanhSachChoKham/XemGiayNghiHuongBHYTLien1", this.thongTinNgayNghiHuongBHYT).subscribe(function (resultData1) {
                        if (resultData1 != undefined && resultData1 != null) {
                            loading.close();
                            _this.dialog.open(_nghi_huong_bhxh_tiep_nhan_detail_popup_nghi_huong_bhxh_tiep_nhan_detail_popup_component__WEBPACK_IMPORTED_MODULE_6__["NghiHuongBhxhTiepNhanDetailPopupComponent"], {
                                disableClose: true,
                                width: "1200px",
                                data: { templateLienSo1: resultData1, thongTinNgayNghiHuongBHYT: _this.thongTinNgayNghiHuongBHYT },
                            });
                ...
                NghiHuongBhxhTiepNhanPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                return NghiHuongBhxhTiepNhanPopupComponent;
            }());
            NghiHuongBhxhTiepNhanPopupComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _danh_muc_bao_hiem_y_te_bao_hiem_y_te_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../danh-muc/bao-hiem-y-te/bao-hiem-y-te.model */ "./src/app/modules/main/danh-muc/bao-hiem-y-te/bao-hiem-y-te.model.ts");
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var PopupChoQuetComponent = /** @class */ (function () {
                function PopupChoQuetComponent(data, dialog, apiService, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                    this.apiService = apiService;
                    this.dialogRef = dialogRef;
                }
                PopupChoQuetComponent.prototype.ngOnInit = function () {
                    this.quetThongTinBenhNhan(this.data);
                };
                PopupChoQuetComponent.prototype.quetThongTinBenhNhan = function (model) {
                    var _this = this;
                    this.apiService.post("BHYT/GetLichSuKhamChuaBenh", model).subscribe(function (resultData) {
                        if (resultData != undefined) {
                            //this.setValueBHYT(resultData);
                        ...
                        //console.log("err = ", err);
                        var errBHYT = new _danh_muc_bao_hiem_y_te_bao_hiem_y_te_model__WEBPACK_IMPORTED_MODULE_3__["BaoHiemYTe"]();
                        if (err.Message != "Validation Failed" && err.Message != null && err.Message != '') {
                ...
                return PopupChoQuetComponent;
            }());
            PopupChoQuetComponent.ctorParameters = function () { return [
                { type: _danh_muc_bao_hiem_y_te_bao_hiem_y_te_model__WEBPACK_IMPORTED_MODULE_3__["ThongTinBenhNhan"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupDichVuCheckTrungUpdateComponent = /** @class */ (function () {
                function PopupDichVuCheckTrungUpdateComponent(dialog, data, dialogRef, apiService, notificationService) {
                    this.dialog = dialog;
                    this.data = data;
                    this.dialogRef = dialogRef;
                    this.apiService = apiService;
                ...
                PopupDichVuCheckTrungUpdateComponent.prototype.ngOnInit = function () {
                };
                PopupDichVuCheckTrungUpdateComponent.prototype.Co = function () {
                    this.dialogRef.close(true);
                };
                PopupDichVuCheckTrungUpdateComponent.prototype.Khong = function () {
                    this.dialogRef.close(false);
                };
                return PopupDichVuCheckTrungUpdateComponent;
            }());
            PopupDichVuCheckTrungUpdateComponent.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupErrorComponent = /** @class */ (function () {
                function PopupErrorComponent(data, dialog, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                    this.dialogRef = dialogRef;
                    this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
                ...
                PopupErrorComponent.prototype.ngOnInit = function () {
                    this.errorMessage = src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_2__["TiepNhanBenhNhanMessage"].MessageSaiThongTinBenhNhan;
                    if (this.data != null) {
                        //console.log(this.data);
                ...
                PopupErrorComponent.prototype.close = function () {
                    //console.log("close");
                    this.dialog.closeAll();
                    //this.dialogRef.close(1);
                };
                PopupErrorComponent.prototype.khamKhongBHYT = function () {
                    //this.dialog.closeAll();
                    this.dialogRef.close(1);
                };
                PopupErrorComponent.prototype.huy = function () {
                    //console.log("huy");
                    this.dialog.closeAll();
                    //this.dialogRef.close(1);
                };
                PopupErrorComponent.prototype.chapNhanBHYTNhapTay = function () {
                    this.dialogRef.close(2);
                };
                return PopupErrorComponent;
            }());
            PopupErrorComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupHetHieuLucComponent = /** @class */ (function () {
                function PopupHetHieuLucComponent(data, dialog, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                    this.dialogRef = dialogRef;
                    this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_4___default.a;
                }
                PopupHetHieuLucComponent.prototype.ngOnInit = function () {
                };
                PopupHetHieuLucComponent.prototype.close = function () {
                    //this.dialog.closeAll();
                    this.dialogRef.close(1);
                };
                PopupHetHieuLucComponent.prototype.khamKhongBHYT = function () {
                    this.dialog.closeAll();
                };
                PopupHetHieuLucComponent.prototype.huy = function () {
                    this.dialogRef.close(1);
                };
                PopupHetHieuLucComponent.prototype.chapNhanBHYTNhapTay = function () {
                    this.dialogRef.close(2);
                };
                return PopupHetHieuLucComponent;
            }());
            PopupHetHieuLucComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_5__);
            /* harmony import */ var src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/component/dialogs/loading/loading.component */ "./src/app/shared/component/dialogs/loading/loading.component.ts");
            var InBangKeChiPhiKhamBenhComponent = /** @class */ (function () {
                function InBangKeChiPhiKhamBenhComponent(data, sanitizer, apiService, dialog) {
                    this.data = data;
                    this.sanitizer = sanitizer;
                    this.apiService = apiService;
                    this.dialog = dialog;
                ...
                InBangKeChiPhiKhamBenhComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    if (window.location.protocol == "http:") {
                        this.hostingName = "http://" + window.location.host;
                    }
                ...
                InBangKeChiPhiKhamBenhComponent.prototype.getSharedPrintForm = function (id) {
                    var _this = this;
                    return new Promise(function (resolve) {
                ...
                InBangKeChiPhiKhamBenhComponent.prototype.replaceAll = function (str, find, replace) {
                    return str.replace(new RegExp(find, "g"), replace);
                };
                InBangKeChiPhiKhamBenhComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return InBangKeChiPhiKhamBenhComponent;
            }());
            InBangKeChiPhiKhamBenhComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupKhongKiemTraDuocComponent = /** @class */ (function () {
                function PopupKhongKiemTraDuocComponent(data, dialog, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                    this.dialogRef = dialogRef;
                ...
                PopupKhongKiemTraDuocComponent.prototype.ngOnInit = function () {
                };
                PopupKhongKiemTraDuocComponent.prototype.khamKhongBHYT = function () {
                    this.dialogRef.close(false);
                    //this.dialogRef2.close();
                };
                PopupKhongKiemTraDuocComponent.prototype.chapNhanBHYTNhapTay = function () {
                    this.dialogRef.close(true);
                };
                // chapNhanCoBHYT(){
                //   this.dialogRef.close(true);
                //   //this.dialogRef2.close();
                // }
                PopupKhongKiemTraDuocComponent.prototype.close = function () {
                    this.dialogRef.close(false);
                };
                PopupKhongKiemTraDuocComponent.prototype.thuLai = function () {
                    var _this = this;
                    ...
                    var dialogRef = this.dialog.open(_popup_cho_quet_popup_cho_quet_component__WEBPACK_IMPORTED_MODULE_6__["PopupChoQuetComponent"], {
                        disableClose: true,
                        width: '500px',
                        height: '250px',
                        data: this.thongTinBenhNhan,
                    ...
                    dialogRef.afterClosed().subscribe(function (result) {
                        ...
                        if (result == null || (result != null && result.maKetQua !== "000" && result.maKetQua !== "004")) {
                            ...
                            var dialogRef_3 = _this.dialog.open(_popup_error_popup_error_component__WEBPACK_IMPORTED_MODULE_7__["PopupErrorComponent"], {
                                disableClose: false,
                                width: '400px',
                                height: '100px',
                ...
                return PopupKhongKiemTraDuocComponent;
            }());
            PopupKhongKiemTraDuocComponent.ctorParameters = function () { return [
                { type: _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_5__["TiepNhanBenhNhanViewModel"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_4__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialogRef"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            /* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
            var PopupLichSuKhamChuaBenhComponent = /** @class */ (function () {
                function PopupLichSuKhamChuaBenhComponent(data, dialog, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                    this.dialogRef = dialogRef;
                    this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
                ...
                PopupLichSuKhamChuaBenhComponent.prototype.ngOnInit = function () {
                ...
                PopupLichSuKhamChuaBenhComponent.prototype.setDataForGrid = function () {
                    this.gridData = {
                        data: this.data,
                ...
                PopupLichSuKhamChuaBenhComponent.prototype.close = function (answer) {
                    this.dialogRef.close(answer);
                };
                return PopupLichSuKhamChuaBenhComponent;
            }());
            PopupLichSuKhamChuaBenhComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            /* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
            var PopupLichSuKiemTraBhytComponent = /** @class */ (function () {
                function PopupLichSuKiemTraBhytComponent(data, dialog, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                    this.dialogRef = dialogRef;
                    this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
                ...
                PopupLichSuKiemTraBhytComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_2__["DocumentType"].YeuCauTiepNhan;
                    this.gridColumns = [
                ...
                PopupLichSuKiemTraBhytComponent.prototype.setDataForGrid = function () {
                    this.gridData = {
                        data: this.data,
                        total: this.data.length
                    };
                ...
                PopupLichSuKiemTraBhytComponent.prototype.close = function (answer) {
                    this.dialogRef.close(answer);
                };
                return PopupLichSuKiemTraBhytComponent;
            }());
            PopupLichSuKiemTraBhytComponent.ctorParameters = function () { return [
                { type: Array, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_4__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialogRef"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupMarketingCheckTrungUpdateComponent = /** @class */ (function () {
                function PopupMarketingCheckTrungUpdateComponent(dialog, data, dialogRef, apiService, notificationService) {
                    this.dialog = dialog;
                    this.data = data;
                    this.dialogRef = dialogRef;
                    this.apiService = apiService;
                ...
                PopupMarketingCheckTrungUpdateComponent.prototype.ngOnInit = function () {
                    this.gridColumns = [
                ...
                PopupMarketingCheckTrungUpdateComponent.prototype.Co = function () {
                    var item = this.danhSachGoiDaChonTrongLanPopup.filter(function (o) { return o.KhongThem; });
                    //console.log("Co = ", item);
                    this.dialogRef.close(item);
                };
                PopupMarketingCheckTrungUpdateComponent.prototype.Khong = function () {
                    this.dialogRef.close();
                };
                PopupMarketingCheckTrungUpdateComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                return PopupMarketingCheckTrungUpdateComponent;
            }());
            PopupMarketingCheckTrungUpdateComponent.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupMarketingTnbnUpdateComponent = /** @class */ (function () {
                function PopupMarketingTnbnUpdateComponent(dialog, data, dialogRef, apiService, notificationService) {
                    this.dialog = dialog;
                    this.data = data;
                    this.dialogRef = dialogRef;
                    this.apiService = apiService;
                ...
                PopupMarketingTnbnUpdateComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_2__["DocumentType"].DanhSachChoKham;
                    this.gridColumns = [
                    ...
                    if (this.yeuCauGoiDichVuIdPopup != null && this.yeuCauGoiDichVuIdPopup != undefined) {
                        var self_3 = this;
                        setTimeout(function () {
                            self_3.gridChild.onExpandRowDetail(0);
                        }, 500);
                    }
                };
                PopupMarketingTnbnUpdateComponent.prototype.onKeyGrid = function (event) {
                    if (event.keyCode == 13) {
                        this.Timkiem();
                    }
                };
                PopupMarketingTnbnUpdateComponent.prototype.Timkiem = function () {
                    this.gridChild._additionalSearchString = this.searchStringDefault;
                    this.gridChild.searchString = this.searchString;
                    this.gridChild.search();
                };
                PopupMarketingTnbnUpdateComponent.prototype.clearSearch = function () {
                    if ((this.searchString == "" || this.searchString == null) && this.gridChild != undefined) {
                        this.gridChild.searchString = "";
                        this.gridChild.search();
                    }
                };
                PopupMarketingTnbnUpdateComponent.prototype.chonDichVu = function (event, dataItem) {
                ...
                PopupMarketingTnbnUpdateComponent.prototype.setSoTienTTThem = function () {
                ...
                PopupMarketingTnbnUpdateComponent.prototype.changeSoLuongDichVu = function (event, dataItem) {
                ...
                PopupMarketingTnbnUpdateComponent.prototype.addDichVu = function (data) {
                    var _this = this;
                ...
                PopupMarketingTnbnUpdateComponent.prototype.removeDichVu = function (data) {
                    var _this = this;
                    var dataTemp = this.cloneItemDichVuChonTronLanNay(data);
                    var indexTemp = -1;
                    this.danhSachDichVuDaChonTrongLanPopup.forEach(function (element, index) {
                ...
                PopupMarketingTnbnUpdateComponent.prototype.cloneItemDichVuChonTronLanNay = function (data) {
                    var dataTemp = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_6__["DanhSachDichVuChonTrongLanPopup"]();
                    dataTemp.Id = data.Id;
                ...
                PopupMarketingTnbnUpdateComponent.prototype.capNhatThongTinGoiTuDanhSachDichVuDaChon = function () {
                    var _this = this;
                    this.danhSachGoiDaChonTrongLanPopup = new Array();
                    this.danhSachDichVuDaChonTrongLanPopup.forEach(function (o) {
                        ...
                        if (item.length == 0) {
                            var goi = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_6__["DanhSachGoiChonTrongLanPopup"]();
                ...
                // }
                PopupMarketingTnbnUpdateComponent.prototype.luuDichVuChiDinh = function () {
                    var _this = this;
                    if (this.danhSachDichVuDaChonTrongLanPopup != undefined && this.danhSachDichVuDaChonTrongLanPopup.length > 0) {
                        ...
                        if (danhSachDichVuTrung.length > 0) {
                            ...
                            var danhSachDichVuGoiDaChon_1 = new Array();
                            this.danhSachDichVuDaChonTrongLanPopup.forEach(function (e) {
                                var item = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_6__["ThemChiDinhDichVu"]();
                                item.LaGoi = true;
                                ...
                                //cheat cho lẹ
                                item.DuocHuongBHYT = _this.duocHuongBHYT;
                                item.yeuCauTiepNhanId = _this.yctnId;
                                item.benhNhanId = _this.benhNhanId;
                                danhSachDichVuGoiDaChon_1.push(item);
                            });
                            var model = new _danh_sach_cho_kham_model__WEBPACK_IMPORTED_MODULE_10__["modelUpdateView"]();
                            model.Data = danhSachDichVuGoiDaChon_1;
                            ...
                            //BVHD-3804
                            this.kiemTraCoDichVuKhongBaoLanh(model, danhSachDichVuGoiDaChon_1);
                        }
                        //luu dich vu
                        //this.luuDichVu(model, danhSachDichVuGoiDaChon);
                ...
                PopupMarketingTnbnUpdateComponent.prototype.openPopup = function (danhSachDichVuTrung) {
                    var _this = this;
                    var self = this;
                    self.dialog.open(_popup_marketing_check_trung_update_popup_marketing_check_trung_update_component__WEBPACK_IMPORTED_MODULE_12__["PopupMarketingCheckTrungUpdateComponent"], {
                        ...
                        if (result == undefined) {
                            ...
                            //luu dich vu
                            var danhSachDichVuGoiDaChon_2 = new Array();
                            danhSach.forEach(function (e) {
                                var item = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_6__["ThemChiDinhDichVu"]();
                                item.LaGoi = true;
                                item.TenNhomDichVu = e.TenNhomDichVu;
                                item.MaDichVuId = e.DichVuId;
                                ...
                                item.yeuCauTiepNhanId = _this.yctnId;
                                item.benhNhanId = _this.benhNhanId;
                                danhSachDichVuGoiDaChon_2.push(item);
                            });
                            var model = new _danh_sach_cho_kham_model__WEBPACK_IMPORTED_MODULE_10__["modelUpdateView"]();
                            model.Data = danhSachDichVuGoiDaChon_2;
                            model.YeuCauTiepNhanId = _this.yctnId;
                            model.BenhNhanid = _this.benhNhanId;
                            model.MucHuongBHYT = _this.mucHuong;
                            //this.luuDichVu(model, danhSachDichVuGoiDaChon);
                            //BVHD-3804
                            _this.kiemTraCoDichVuKhongBaoLanh(model, danhSachDichVuGoiDaChon_2);
                        }
                    });
                };
                PopupMarketingTnbnUpdateComponent.prototype.luuDichVu = function (model, danhSachDichVuGoiDaChon) {
                    var _this = this;
                    this.showPopupLoadingData();
                    var modelCheck = new _danh_sach_cho_kham_model__WEBPACK_IMPORTED_MODULE_10__["CheckDuSoLuongTonTrongGoiListDichVu"]();
                    ...
                    this.apiService.post("TiepNhanBenhNhan/CheckDuSoLuongTonTrongGoiLstDichVu", modelCheck).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null && resultData) {
                            ...
                            _this.closePopupLoadingData();
                            //ex
                            _this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["TiepNhanBenhNhanMessage"].MessageErrorDVOnGoi);
                        }
                    }, function (err) {
                        _this.closePopupLoadingData();
                        if (err != undefined && err.ValidationErrors != null) {
                ...
                PopupMarketingTnbnUpdateComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                // update gói marketing
                PopupMarketingTnbnUpdateComponent.prototype.xemChiTietGoiDichVu = function (event) {
                    var _this = this;
                    if (event.Data.length > 0) {
                        ...
                        event.Data.forEach(function (element) {
                            ...
                            if (indexGoiDangChon == -1) {
                                _this.arrGoiDangChon.push(new _danh_sach_cho_kham_model__WEBPACK_IMPORTED_MODULE_10__["GoiDichVuMarketingDangChonTiepNhan"](element.Id, 0, element.TenDisplay, element.ConLai, element.IsChecked, []));
                            }
                            else {
                ...
                PopupMarketingTnbnUpdateComponent.prototype.kiemTraGoiDichVuCoChonDichVu = function (yeuCauGoiDichVuId) {
                    var index = this.danhSachDichVuDaChonTrongLanPopup.findIndex(function (x) { return x.YeuCauGoiDichVuId == yeuCauGoiDichVuId; });
                    return index != -1;
                };
                PopupMarketingTnbnUpdateComponent.prototype.getArrayDichVuDaChonTheoGoi = function (yeuCauGoiDichVuId) {
                    return this.danhSachDichVuDaChonTrongLanPopup.filter(function (x) { return x.YeuCauGoiDichVuId == yeuCauGoiDichVuId; });
                };
                PopupMarketingTnbnUpdateComponent.prototype.tinhTongTienDichVuDangChon = function (yeuCauGoiDichVuId) {
                    var tongTien = 0;
                ...
                // cập nhật BVHD-3423
                PopupMarketingTnbnUpdateComponent.prototype.chonTatCaDichVuTrongGoi = function (event, yeuCauGoiDichVuId) {
                    if (event) {
                ...
                PopupMarketingTnbnUpdateComponent.prototype.chonTatCaDichVuTrongNhom = function (event, yeuCauGoiDichVuId, tenNhom) {
                ...
                //BVHD-3804
                PopupMarketingTnbnUpdateComponent.prototype.showPopupLoadingData = function () {
                ...
                PopupMarketingTnbnUpdateComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                PopupMarketingTnbnUpdateComponent.prototype.kiemTraCoDichVuKhongBaoLanh = function (model, danhSach) {
                    var self = this;
                ...
                return PopupMarketingTnbnUpdateComponent;
            }());
            PopupMarketingTnbnUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/core/services/notification.service */ "./src/app/core/services/notification.service.ts");
            var PopupThemGoiComponent = /** @class */ (function () {
                function PopupThemGoiComponent(data, apiService, notificationService, dialog, dialogRef) {
                    this.data = data;
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.dialog = dialog;
                ...
                PopupThemGoiComponent.prototype.ngOnInit = function () {
                    this.isGoiCoChietKhau = this.data.LstGrid[0].IsGoiCoChietKhau;
                    var index = 1;
                    this.data.LstGrid.forEach(function (obj) {
                        obj.STT = index;
                        index = index + 1;
                ...
                PopupThemGoiComponent.prototype.setDataForCoChietKhauGrid = function () {
                ...
                PopupThemGoiComponent.prototype.setDataForKhongCoChietKhauGrid = function () {
                ...
                PopupThemGoiComponent.prototype.ok = function () {
                    var _this = this;
                    //console.log("ok = ", this.data);
                    this.validationErrors = null;
                    var url = "TiepNhanBenhNhan/ThemGoiKhongChietKhauPopup";
                    if (this.isGoiCoChietKhau) {
                        url = "TiepNhanBenhNhan/ThemGoiCoChietKhauPopup";
                    }
                    this.apiService.post(url, this.data).subscribe(function (resultData) {
                        _this.dialogRef.close(resultData);
                    }, function (err) {
                        if (err != undefined && err.ValidationErrors != null) {
                            _this.validationErrors = err.ValidationErrors;
                ...
                PopupThemGoiComponent.prototype.huy = function () {
                    this.dialogRef.close();
                    //console.log("huy = ", this.data);
                };
                PopupThemGoiComponent.prototype.noiThucHienChange = function ($event, dataItem) {
                    //console.log("test = ", $event, dataItem);
                    var model = this.data.LstGrid.find(function (obj) { return obj == dataItem; });
                ...
                return PopupThemGoiComponent;
            }());
            PopupThemGoiComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaiKhamComponent = /** @class */ (function () {
                function TaiKhamComponent() {
                    this.gridColumns = [];
                ...
                TaiKhamComponent.prototype.ngOnInit = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            /* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
            var TheBenhNhanPopupComponent = /** @class */ (function () {
                function TheBenhNhanPopupComponent(data, sanitizer, apiService, dialogRef, dialog) {
                    this.data = data;
                    this.sanitizer = sanitizer;
                    this.apiService = apiService;
                    this.dialogRef = dialogRef;
                ...
                TheBenhNhanPopupComponent.prototype.ngOnInit = function () {
                    if (window.location.protocol == "http:") {
                        this.hostingName = "http://" + window.location.host;
                    }
                    else {
                ...
                TheBenhNhanPopupComponent.prototype.xemTheBenhNhan = function () {
                    var _this = this;
                    var yeuCauTiepNhanId = this.data;
                    this.apiService.get("DanhSachChoKham/InTheBenhNhan?yeuCauTiepNhanId=" + yeuCauTiepNhanId + "&hostingName=" + this.hostingName).subscribe(function (resultData) {
                        if (resultData != null) {
                            var html = resultData;
                ...
                TheBenhNhanPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    var yeuCauTiepNhanId = this.data;
                    return new Promise(function (resolve) {
                        _this.apiService.get("DanhSachChoKham/InTheBenhNhan?yeuCauTiepNhanId=" + yeuCauTiepNhanId + "&hostingName=" + _this.hostingName).subscribe(function (resultData) {
                            resolve(resultData);
                        });
                        _this.close();
                    });
                };
                TheBenhNhanPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                return TheBenhNhanPopupComponent;
            }());
            TheBenhNhanPopupComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__["DomSanitizer"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            /* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
            var VongDeoTayPopupComponent = /** @class */ (function () {
                function VongDeoTayPopupComponent(data, sanitizer, apiService, dialog) {
                    this.data = data;
                    this.sanitizer = sanitizer;
                    this.apiService = apiService;
                    this.dialog = dialog;
                ...
                VongDeoTayPopupComponent.prototype.ngOnInit = function () {
                    if (window.location.protocol == "http:") {
                        this.hostingName = "http://" + window.location.host;
                    }
                    else {
                ...
                VongDeoTayPopupComponent.prototype.xemVongDeoTay = function () {
                    var _this = this;
                    var yeuCauTiepNhanId = this.data;
                    this.apiService.get("DanhSachChoKham/InVongDeoTay?yeuCauTiepNhanId=" + yeuCauTiepNhanId + "&hostingName=" + this.hostingName).subscribe(function (resultData) {
                        if (resultData != null) {
                            var html = resultData;
                            _this.src = "data:text/html;charset=utf-8," + encodeURIComponent(html);
                        }
                ...
                VongDeoTayPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    var yeuCauTiepNhanId = this.data;
                    return new Promise(function (resolve) {
                        _this.apiService.get("DanhSachChoKham/InVongDeoTay?yeuCauTiepNhanId=" + yeuCauTiepNhanId + "&hostingName=" + _this.hostingName).subscribe(function (resultData) {
                            resolve(resultData);
                        });
                        _this.close();
                    });
                };
                VongDeoTayPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return VongDeoTayPopupComponent;
            }());
            VongDeoTayPopupComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__["DomSanitizer"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }
...
//# sourceMappingURL=tiep-nhan-benh-nhan-danh-sach-cho-kham-danh-sach-cho-kham-module-es5.js.map
//# sourceMappingURL=tiep-nhan-benh-nhan-danh-sach-cho-kham-danh-sach-cho-kham-module-es5.js.map