...
let BaoCaoTongHopDoanhThuThaiSanDaSinhRoutingModule = class BaoCaoTongHopDoanhThuThaiSanDaSinhRoutingModule {
};
...
let BaoCaoTongHopDoanhThuThaiSanDaSinhListComponent = class BaoCaoTongHopDoanhThuThaiSanDaSinhListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoTongHopDoanhThuThaiSanDaSinhForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoTongHopDoanhThuThaiSanDaSinhListComponent.ctorParameters = () => [
...
class BaoCaoTongHopDoanhThuThaiSanDaSinhSearch {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, StrQuery = "", Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
class InBaoCaoTongHopDoanhThuThaiSanDaSinh {
...
let BaoCaoTongHopDoanhThuThaiSanDaSinhModule = class BaoCaoTongHopDoanhThuThaiSanDaSinhModule {
};
