(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-dich-vu-hop-dong-kham-doan-bao-cao-dich-vu-hop-dong-kham-doan-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDichVuHopDongKhamDoanHopDongListComponent = /** @class */ (function () {
                function BaoCaoDichVuHopDongKhamDoanHopDongListComponent(apiService, authService, router, notificationService, dialog, route, location) {
                ...
                BaoCaoDichVuHopDongKhamDoanHopDongListComponent.prototype.totalSoLuong = function (field) {
                    switch (field) {
                        case 'SoLuongNhanVienTheoHopDong':
                            return this.dataToSumSoLuong.reduce(function (sum, item) { return sum + item.SoLuongNhanVienTheoHopDong; }, 0);
                        case 'SoLuongNhanVienKhamThucTe':
                            return this.dataToSumSoLuong.reduce(function (sum, item) { return sum + item.SoLuongNhanVienKhamThucTe; }, 0);
                        case 'SoLuongNhanVienThucTe':
                            return this.dataToSumSoLuong.reduce(function (sum, item) { return sum + item.SoLuongNhanVienThucTe; }, 0);
                    }
                };
                ;
                BaoCaoDichVuHopDongKhamDoanHopDongListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoDichVuHopDongKhamDoanHopDongListComponent.prototype.backWithSearch = function () {
                ...
                BaoCaoDichVuHopDongKhamDoanHopDongListComponent.prototype.daKhamChange = function (event, text, loai) {
                    if (loai == 1) {
                        if (text == 'Co') {
                            if (event == true) {
                ...
                BaoCaoDichVuHopDongKhamDoanHopDongListComponent.prototype.onDataBoundGridHopDong = function (data) {
                    this.dataToSumSoLuong = data.Data;
                };
                BaoCaoDichVuHopDongKhamDoanHopDongListComponent.prototype.timKiem = function () {
                ...
                BaoCaoDichVuHopDongKhamDoanHopDongListComponent.prototype.xemChiTiet = function (id) {
                ...
                BaoCaoDichVuHopDongKhamDoanHopDongListComponent.prototype.xuatExcel = function () {
                    var _this = this;
                    if (this.baoCaoDichVuHopDongKhamDoanTheoHopDong.Loai == null || this.baoCaoDichVuHopDongKhamDoanTheoHopDong.Loai == 1) {
                        ...
                        if (this.baoCaoDichVuHopDongKhamDoanTheoHopDong.ChuaKhamNhanVien == true) {
                            if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                                ...
                                this.apiService.postExportExcel("BaoCaoKhamDoanHopDong/ExportBaoCaoDichVuTrongGoiKhamDoanChuaKham", this.gridChildNhanVien._gridQueryInfo).subscribe(function (res) {
                            ...
                            if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                                ...
                                this.apiService.postExportExcel("BaoCaoKhamDoanHopDong/ExportBaoCaoDichVuTrongGoiKhamDoanDaKham", this.gridChildNhanVien._gridQueryInfo).subscribe(function (res) {
                                    var dateTimeNow = new Date();
                                    src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_6__["CommonService"].downLoadFile(res, "application/vnd.ms-excel", "BaoCaoDichVuTrongGoiKhamDoan" + dateTimeNow.getFullYear() + ".xlsx");
                                    _this.dialog.closeAll();
                                }, function (err) {
                            ...
                            if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                                ...
                                this.apiService.postExportExcel("BaoCaoKhamDoanHopDong/ExportBaoCaoDichVuTrongGoiKhamDoanDangKham", this.gridChildNhanVien._gridQueryInfo).subscribe(function (res) {
                                    var dateTimeNow = new Date();
                                    src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_6__["CommonService"].downLoadFile(res, "application/vnd.ms-excel", "BaoCaoDichVuTrongGoiKhamDoan" + dateTimeNow.getFullYear() + ".xlsx");
                                    _this.dialog.closeAll();
                                }, function (err) {
                ...
                return BaoCaoDichVuHopDongKhamDoanHopDongListComponent;
            }());
            BaoCaoDichVuHopDongKhamDoanHopDongListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDichVuHopDongKhamDoanNhanVienListComponent = /** @class */ (function () {
                function BaoCaoDichVuHopDongKhamDoanNhanVienListComponent(route, router, dialog, authService, apiService, ref, notificationService) {
                    this.route = route;
                    this.router = router;
                    this.dialog = dialog;
                    this.authService = authService;
                ...
                BaoCaoDichVuHopDongKhamDoanNhanVienListComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.queryParams.subscribe(function (param) {
                        _this.baoCaoDichVuHopDongKhamDoanTheoHopDong.HopDongKhamSucKhoeId = param['Id'];
                        ...
                        if (additionalSearchString != null && additionalSearchString != "") {
                            var baoCaoDichVuHopDong = JSON.parse(additionalSearchString);
                            _this.baoCaoDichVuHopDongKhamDoanTheoHopDong.FromDate1 = baoCaoDichVuHopDong.FromDate1;
                            _this.baoCaoDichVuHopDongKhamDoanTheoHopDong.ToDate1 = baoCaoDichVuHopDong.ToDate1;
                        }
                        _this.tinhTrang = parseInt(param['F']);
                        if (_this.tinhTrang == 0) {
                            _this.baoCaoDichVuHopDongKhamDoanTheoHopDong.ChuaKhamNhanVien = true;
                            _this.baoCaoDichVuHopDongKhamDoanTheoHopDong.DangKhamNhanVien = false;
                            _this.baoCaoDichVuHopDongKhamDoanTheoHopDong.DaKhamNhanVien = false;
                        }
                        else {
                            _this.baoCaoDichVuHopDongKhamDoanTheoHopDong.ChuaKhamNhanVien = false;
                            _this.baoCaoDichVuHopDongKhamDoanTheoHopDong.DangKhamNhanVien = false;
                            _this.baoCaoDichVuHopDongKhamDoanTheoHopDong.DaKhamNhanVien = true;
                        }
                        _this.addtionStringDefault = JSON.stringify(_this.baoCaoDichVuHopDongKhamDoanTheoHopDong);
                    });
                    this.gridColumns = [
                ...
                BaoCaoDichVuHopDongKhamDoanNhanVienListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                        ...
                        this.gridChildNhanVien._gridQueryInfo.additionalSearchString = JSON.stringify(this.baoCaoDichVuHopDongKhamDoanTheoHopDong);
                        this.apiService.postExportExcel("BaoCaoKhamDoanHopDong/ExportBaoCaoDichVuTrongGoiKhamDoanChiTiet", this.gridChildNhanVien._gridQueryInfo).subscribe(function (res) {
                            var dateTimeNow = new Date();
                            src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_6__["CommonService"].downLoadFile(res, "application/vnd.ms-excel", "BaoCaoDichVuTrongGoiKhamDoan" + dateTimeNow.getFullYear() + ".xlsx");
                            _this.dialog.closeAll();
                        }, function (err) {
                ...
                BaoCaoDichVuHopDongKhamDoanNhanVienListComponent.prototype.In = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCaoKhamDoanHopDong/InDanhSachNhanVien", this.inBaoCaoDichVuHopDongKhamDoanTheoNhanVien).subscribe(function (res) {
                        showDialog.close();
                        _this.dialog
                ...
                BaoCaoDichVuHopDongKhamDoanNhanVienListComponent.prototype.quayLai = function () {
                    this.router.navigate(["/bao-cao/bao-cao-benh-nhan-kham-suc-khoe-doan"], { queryParams: { holdQuery: true } });
                };
                return BaoCaoDichVuHopDongKhamDoanNhanVienListComponent;
            }());
            BaoCaoDichVuHopDongKhamDoanNhanVienListComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_8__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_12__["MatDialog"] },
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDichVuHopDongKhamDoanRoutingModule = /** @class */ (function () {
                function BaoCaoDichVuHopDongKhamDoanRoutingModule() {
                }
                return BaoCaoDichVuHopDongKhamDoanRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoDichVuHopDongKhamDoanTheoHopDong = /** @class */ (function () {
                function BaoCaoDichVuHopDongKhamDoanTheoHopDong(Loai, HopDongKhamSucKhoeId, TinhTrang, DaKham, ChuaKham, ChuaKhamNhanVien, DangKhamNhanVien, DaKhamNhanVien, ThoiDiemTiepNhanTuFormat, ThoiDiemTiepNhanDenFormat, FromDate, ToDate, ThoiDiemTiepNhanTuFormat1, ThoiDiemTiepNhanDenFormat1, FromDate1, ToDate1, SearchString) {
                    ...
                    if (ChuaKhamNhanVien === void 0) { ChuaKhamNhanVien = false; }
                    if (DangKhamNhanVien === void 0) { DangKhamNhanVien = true; }
                    if (DaKhamNhanVien === void 0) { DaKhamNhanVien = false; }
                    ...
                    if (ThoiDiemTiepNhanTuFormat1 === void 0) { ThoiDiemTiepNhanTuFormat1 = null; }
                    if (ThoiDiemTiepNhanDenFormat1 === void 0) { ThoiDiemTiepNhanDenFormat1 = null; }
                    if (FromDate1 === void 0) { FromDate1 = null; }
                    if (ToDate1 === void 0) { ToDate1 = null; }
                ...
                return BaoCaoDichVuHopDongKhamDoanTheoHopDong;
            }());
            var InBaoCaoDichVuHopDongKhamDoanTheoNhanVien = /** @class */ (function () {
                function InBaoCaoDichVuHopDongKhamDoanTheoNhanVien(Loai, TrangThai, HostingName, Datas) {
                ...
                return InBaoCaoDichVuHopDongKhamDoanTheoNhanVien;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDichVuHopDongKhamDoanModule = /** @class */ (function () {
                function BaoCaoDichVuHopDongKhamDoanModule() {
                }
                return BaoCaoDichVuHopDongKhamDoanModule;
            }());
...
//# sourceMappingURL=bao-cao-bao-cao-dich-vu-hop-dong-kham-doan-bao-cao-dich-vu-hop-dong-kham-doan-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-dich-vu-hop-dong-kham-doan-bao-cao-dich-vu-hop-dong-kham-doan-module-es5.js.map