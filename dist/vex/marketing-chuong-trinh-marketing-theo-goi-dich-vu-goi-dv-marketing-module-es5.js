...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["marketing-chuong-trinh-marketing-theo-goi-dich-vu-goi-dv-marketing-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChiTietSuDungChuongTrinhGoiDvComponent = /** @class */ (function () {
                function ChiTietSuDungChuongTrinhGoiDvComponent(dialog, data) {
                    this.dialog = dialog;
                    this.data = data;
                    this.goiMarketing = {};
                    this.sort = [
                ...
                ChiTietSuDungChuongTrinhGoiDvComponent.prototype.ngOnInit = function () {
                    this.gridColumn = [
                ...
                ChiTietSuDungChuongTrinhGoiDvComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                ChiTietSuDungChuongTrinhGoiDvComponent.prototype.onKey = function (event) {
                    if (event.keyCode === 13) {
                        this.timKiem();
                    }
                };
                ChiTietSuDungChuongTrinhGoiDvComponent.prototype.timKiem = function (isNull) {
                    if (isNull === void 0) { isNull = false; }
                    this.gridYeuCau.searchString = isNull ? '' : this.searchString;
                    this.gridYeuCau.search();
                };
                ChiTietSuDungChuongTrinhGoiDvComponent.prototype.searchChange = function () {
                    var _this = this;
                ...
                return ChiTietSuDungChuongTrinhGoiDvComponent;
            }());
            ChiTietSuDungChuongTrinhGoiDvComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiDvCtMarketingAddComponent = /** @class */ (function () {
                function GoiDvCtMarketingAddComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                GoiDvCtMarketingAddComponent.prototype.ngOnInit = function () {
                    this.idsub = this.route.snapshot.params.id;
                };
                GoiDvCtMarketingAddComponent.prototype.onCreated = function () {
                    this.router.navigate(['/marketing/ct-marketing/goi-dv'], {
                        queryParamsHandling: 'preserve',
                    });
                };
                GoiDvCtMarketingAddComponent.prototype.onValidateClient = function (isValidate) {
                    if (isValidate) {
                        this.shared.OnValidate();
                    }
                };
                GoiDvCtMarketingAddComponent.prototype.keyEvent = function (event) {
                ...
                return GoiDvCtMarketingAddComponent;
            }());
            GoiDvCtMarketingAddComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiDvCtMarketingListComponent = /** @class */ (function () {
                function GoiDvCtMarketingListComponent(authService, dialog, notificationService, apiService, router, location, route) {
                ...
                GoiDvCtMarketingListComponent.prototype.ngOnInit = function () {
                ...
                GoiDvCtMarketingListComponent.prototype.updateDichVu = function (id, isDisabled) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                self.apiService.post('GoiDichVuChuongTrinhMarketing/KichHoatGoiDichVuMarketing?id=' + id).subscribe(function () {
                ...
                GoiDvCtMarketingListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel('GoiDichVuChuongTrinhMarketing/ExportChuongTrinhGoiDichVuMarketing', this.gridGoiDv._gridQueryInfo).subscribe(function (res) {
                ...
                GoiDvCtMarketingListComponent.prototype.copy = function (id) {
                ...
                GoiDvCtMarketingListComponent.prototype.delete = function (id) {
                    this.gridGoiDv.delete(id);
                };
                GoiDvCtMarketingListComponent.prototype.detail = function (id) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].View)) {
                        this.apiService.get("GoiDichVuChuongTrinhMarketing/GetChiTietChuongTrinh?id=" + id).subscribe(function (resultData) {
                            var dataPassing = {
                                data: resultData,
                            };
                            _this.dialog.open(_chi_tiet_su_dung_chuong_trinh_goi_dv_chi_tiet_su_dung_chuong_trinh_goi_dv_component__WEBPACK_IMPORTED_MODULE_22__["ChiTietSuDungChuongTrinhGoiDvComponent"], {
                                disableClose: false,
                                width: '1200px',
                                height: '455px',
                ...
                GoiDvCtMarketingListComponent.prototype.clearSearch = function () {
                    var _this = this;
                    if (!this.search.SearchString) {
                        setTimeout(function () {
                            _this.gridGoiDv.searchString = '';
                            src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_28__["LocalStorageHelper"].setItem('additionalSearchStringChuongTrinhGoiDvMarketing', JSON.stringify(_this.search));
                            if (_this.firstRequest && _this.secondRequest) {
                                _this.gridGoiDv.search();
                            }
                            if (_this.firstRequest) {
                                _this.secondRequest = true;
                            }
                            _this.firstRequest = true;
                        }, 500);
                    }
                };
                GoiDvCtMarketingListComponent.prototype.onKey = function (event) {
                    if (event.keyCode === 13) {
                        this.Timkiem();
                    }
                };
                GoiDvCtMarketingListComponent.prototype.onKeyNgayBatDau = function (event) {
                    if (event.keyCode === 13) {
                        this.Timkiem();
                    }
                };
                GoiDvCtMarketingListComponent.prototype.onKeyNgayKetThuc = function (event) {
                    if (event.keyCode === 13) {
                        this.Timkiem();
                    }
                };
                GoiDvCtMarketingListComponent.prototype.changeNgayBatDauRange = function () {
                    this.Timkiem();
                };
                GoiDvCtMarketingListComponent.prototype.changeNgayKetThucRange = function () {
                    this.Timkiem();
                };
                GoiDvCtMarketingListComponent.prototype.blur = function () {
                    this.Timkiem();
                };
                GoiDvCtMarketingListComponent.prototype.them = function () {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Add)) {
                ...
                GoiDvCtMarketingListComponent.prototype.Timkiem = function () {
                    ...
                    if (searchClone.RangeFromDate.startDate) {
                        var startDate = new Date(searchClone.RangeFromDate.startDate);
                    ...
                    if (searchClone.RangeFromDate.endDate) {
                        var endDate = new Date(searchClone.RangeFromDate.endDate);
                    ...
                    if (searchClone.RangeToDate.startDate) {
                        var startDate = new Date(searchClone.RangeToDate.startDate);
                    ...
                    if (searchClone.RangeToDate.endDate) {
                        var endDate = new Date(searchClone.RangeToDate.endDate);
                    ...
                    var queryForHold = Object.assign({}, searchClone);
                ...
                return GoiDvCtMarketingListComponent;
            }());
            GoiDvCtMarketingListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiDvChuongTrinhMarketingRoutingModule = /** @class */ (function () {
                function GoiDvChuongTrinhMarketingRoutingModule() {
                }
                return GoiDvChuongTrinhMarketingRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiDvCtMarketingSharedComponent = /** @class */ (function () {
                function GoiDvCtMarketingSharedComponent(route, apiService, dialog, notificationService, baseService, authService) {
                    this.route = route;
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                ...
                GoiDvCtMarketingSharedComponent.prototype.tongThanhTien = function (field) {
                    switch (field) {
                        case 'ThanhTien': {
                            return this.goiMarketing.KhuyenMaiKems.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                        }
                        case 'ThanhTienBenhVien': {
                            return this.goiMarketing.NhomDichVus.reduce(function (sum, item) { return sum + item.ThanhTienBenhVien; }, 0);
                        }
                        case 'ThanhTienTruocChietKhau': {
                            this.goiMarketing.GiaTruocChietKhau = this.goiMarketing.NhomDichVus.reduce(function (sum, item) { return sum + item.ThanhTienTruocChietKhau; }, 0);
                            return this.goiMarketing.GiaTruocChietKhau;
                        }
                        case 'ThanhTienSauChietKhau': {
                            this.goiMarketing.GiaSauChietKhau = this.goiMarketing.NhomDichVus.reduce(function (sum, item) { return sum + item.ThanhTienSauChietKhau; }, 0);
                            return this.goiMarketing.GiaSauChietKhau;
                        }
                    }
                };
                GoiDvCtMarketingSharedComponent.prototype.ngOnInit = function () {
                ...
                GoiDvCtMarketingSharedComponent.prototype.OpenLoading = function () {
                ...
                GoiDvCtMarketingSharedComponent.prototype.CloseLoading = function () {
                    this.dialog.closeAll();
                };
                GoiDvCtMarketingSharedComponent.prototype.getById = function () {
                    var _this = this;
                    this.baseService.getById(this.id).subscribe(function (resultData) {
                        if (resultData) {
                            _this.CloseLoading();
                            if (_this.isCreate) {
                                _this.goiMarketing = Object.assign({}, resultData);
                                _this.goiMarketing.Id = 0;
                                _this.goiMarketing.QuaTangKems.forEach(function (x) {
                                    x.IdSys = 0;
                                    x.GoiDvChuongTrinhMarketingId = 0;
                                });
                                _this.coQuaTang = _this.goiMarketing.QuaTangKems && _this.goiMarketing.QuaTangKems.some(function (x) { return x; });
                                _this.coKhuyenMai = _this.goiMarketing.KhuyenMaiKems && _this.goiMarketing.KhuyenMaiKems.some(function (x) { return x; });
                                _this.setDataGridView();
                                _this.setDataGridViewKhuyenMai();
                                _this.setDataGridViewNhomDichVu();
                                if (_this.gridQuaTangKem) {
                                    _this.gridQuaTangKem.gridDataSource = Object.assign({}, _this.gridDataSource);
                                    _this.gridQuaTangKem.setDataSource();
                                }
                                if (_this.gridKhuyenMaiKem) {
                                    _this.gridKhuyenMaiKem.gridDataSource = Object.assign({}, _this.gridDataSourceKhuyenMai);
                                    _this.gridKhuyenMaiKem.setDataSource();
                                }
                                if (_this.gridNhomDichVu) {
                                    _this.gridNhomDichVu.gridDataSource = Object.assign({}, _this.gridDataSourceNhomDichVu);
                                    _this.gridNhomDichVu.setDataSource();
                                }
                                return;
                            }
                            _this.goiMarketing = Object.assign({}, resultData);
                            _this.notAllowChangeGoiDv = _this.goiMarketing.CoYeuCauSuDung;
                            _this.goiMarketing.TuNgay = _this.goiMarketing.TuNgay && _this.goiMarketing.TuNgay !== ''
                                ? new Date(_this.goiMarketing.TuNgay) : null;
                            _this.goiMarketing.DenNgay = _this.goiMarketing.DenNgay && _this.goiMarketing.DenNgay !== ''
                                ? new Date(_this.goiMarketing.DenNgay) : null;
                            _this.coQuaTang = _this.goiMarketing.QuaTangKems && _this.goiMarketing.QuaTangKems.some(function (x) { return x; });
                            _this.coKhuyenMai = _this.goiMarketing.KhuyenMaiKems && _this.goiMarketing.KhuyenMaiKems.some(function (x) { return x; });
                            _this.setDataGridView();
                            _this.setDataGridViewKhuyenMai();
                            ...
                            _this.nhomDichVuIdOld = JSON.parse(JSON.stringify(_this.goiMarketing.GoiDvId));
                            _this.nhomDichVusOld = _this.goiMarketing.NhomDichVus.slice();
                        }
                    }, function () {
                        _this.CloseLoading();
                    });
                };
                GoiDvCtMarketingSharedComponent.prototype.getSharedData = function () {
                    if (this.isCreate) {
                    ...
                    if (!this.coQuaTang && this.goiMarketing.QuaTangKems && this.goiMarketing.QuaTangKems.some(function (x) { return x; })) {
                        this.goiMarketing.QuaTangKems = [];
                    }
                    if (!this.coKhuyenMai && this.goiMarketing.KhuyenMaiKems && this.goiMarketing.KhuyenMaiKems.some(function (x) { return x; })) {
                        this.goiMarketing.KhuyenMaiKems = [];
                    }
                    return this.goiMarketing;
                };
                GoiDvCtMarketingSharedComponent.prototype.onChangeGoiDichVu = function (data) {
                    var _this = this;
                    if (data) {
                        ...
                        if (this.nhomDichVuIdOld != this.goiMarketing.GoiDvId) {
                            this.apiService.get("GoiDichVuChuongTrinhMarketing/GetDanhSachNhomDichVu?goiDvId=" + this.goiMarketing.GoiDvId).subscribe(function (resultData) {
                                _this.goiMarketing.NhomDichVus = resultData;
                                _this.setDataGridViewNhomDichVu();
                            });
                        }
                        else {
                ...
                GoiDvCtMarketingSharedComponent.prototype.onChangeTiLeCk = function (tiLeCk) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.onChangeGiaSauCk = function (giaSauCk) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.onChangeQuaTang = function (data) {
                    if (data) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.Reset = function () {
                ...
                GoiDvCtMarketingSharedComponent.prototype.ResetValidateFormForGrid = function () {
                    if (this.validationErrors && this.validationErrors.some(function (x) { return x.Field.includes('QuaTangId') || x.Field.includes('SoLuong'); })) {
                        for (var _i = 0, _a = this.validationErrors.filter(function (x) { return x.Field.includes('QuaTangId') || x.Field.includes('SoLuong'); }); _i < _a.length; _i++) {
                            var validationItem = _a[_i];
                            this.validationErrors.splice(this.validationErrors.indexOf(validationItem), 1);
                        }
                    }
                };
                GoiDvCtMarketingSharedComponent.prototype.ResetValidateForGrid = function () {
                    if (this.validationErrors && this.validationErrors.some(function (x) { return x.Field.includes('dataItem'); })) {
                        for (var _i = 0, _a = this.validationErrors.filter(function (x) { return x.Field.includes('dataItem'); }); _i < _a.length; _i++) {
                            var validationItem = _a[_i];
                            this.validationErrors.splice(this.validationErrors.indexOf(validationItem), 1);
                        }
                    }
                };
                GoiDvCtMarketingSharedComponent.prototype.onCheckQuaTang = function () {
                    this.ResetValidateFormForGrid();
                    this.ResetValidateForGrid();
                };
                GoiDvCtMarketingSharedComponent.prototype.Add = function () {
                    this.validationFormClient(this.quaTang);
                    this.AddingAfterValidation();
                };
                GoiDvCtMarketingSharedComponent.prototype.AddingAfterValidation = function () {
                ...
                GoiDvCtMarketingSharedComponent.prototype.setDataGridView = function () {
                    this.gridDataSource = {
                        data: this.goiMarketing.QuaTangKems.slice(),
                        total: this.goiMarketing.QuaTangKems.length
                    };
                };
                GoiDvCtMarketingSharedComponent.prototype.validationFormClient = function (quaTang) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.checkExist = function (quaTangId) {
                    return this.goiMarketing.QuaTangKems && this.goiMarketing.QuaTangKems.some(function (x) { return x.QuaTangId === quaTangId; });
                };
                GoiDvCtMarketingSharedComponent.prototype.ConfirmDelete = function (dataItem) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                        ...
                        if (result === 'Yes') {
                            _this.Delete(dataItem);
                        }
                    });
                };
                GoiDvCtMarketingSharedComponent.prototype.Delete = function (dataItem) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.OnValidate = function () {
                    this.validationErrors = [];
                    ...
                    if (this.validationErrors && !this.validationErrors.some(function (x) { return x; }) && this.coQuaTang) {
                        if (!this.goiMarketing.QuaTangKems || (this.goiMarketing.QuaTangKems && !this.goiMarketing.QuaTangKems.some(function (x) { return x; }))) {
                            var validate = {
                                Field: 'dvTrongGoi',
                        ...
                        if (this.goiMarketing.QuaTangKems && this.goiMarketing.QuaTangKems.some(function (x) { return !x.SoLuong; })) {
                            for (var _i = 0, _a = this.goiMarketing.QuaTangKems.filter(function (x) { return !x.SoLuong; }); _i < _a.length; _i++) {
                                var quaTang = _a[_i];
                                var validate = {
                    ...
                    if (this.validationErrors && !this.validationErrors.some(function (x) { return x; }) && this.coKhuyenMai) {
                        if (this.goiMarketing.KhuyenMaiKems && this.goiMarketing.KhuyenMaiKems.some(function (x) { return !x.SoLuong; })) {
                            for (var _b = 0, _c = this.goiMarketing.KhuyenMaiKems.filter(function (x) { return !x.SoLuong; }); _b < _c.length; _b++) {
                                var khuyenMai = _c[_b];
                                var validate = {
                        ...
                        //     }
                        // }
                        if (this.goiMarketing.KhuyenMaiKems && this.goiMarketing.KhuyenMaiKems.some(function (x) { return !x.SoNgaySuDung; })) {
                            for (var _d = 0, _e = this.goiMarketing.KhuyenMaiKems.filter(function (x) { return !x.SoNgaySuDung; }); _d < _e.length; _d++) {
                                var khuyenMai = _e[_d];
                                var validate = {
                    ...
                    if (this.validationErrors && !this.validationErrors.some(function (x) { return x; })) {
                        if (this.goiMarketing.NhomDichVus && this.goiMarketing.NhomDichVus.some(function (x) { return !x.SoLuong; })) {
                            for (var _f = 0, _g = this.goiMarketing.NhomDichVus.filter(function (x) { return !x.SoLuong; }); _f < _g.length; _f++) {
                                var nhomDichVu = _g[_f];
                                var validate = {
                ...
                GoiDvCtMarketingSharedComponent.prototype.onKeyAddQua = function (keyInput) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.openComboboxQuaTang = function (isOpen) {
                    this.quaTangDisabled = isOpen;
                };
                GoiDvCtMarketingSharedComponent.prototype.onCheckKhuyenMai = function () {
                    this.ResetValidateFormForGridKhuyenMai();
                    this.ResetValidateForGridKhuyenMai();
                };
                GoiDvCtMarketingSharedComponent.prototype.ResetValidateFormForGridKhuyenMai = function () {
                    if (this.validationErrors && this.validationErrors.some(function (x) { return x.Field.includes('DvId') || x.Field.includes('LoaiGia') || x.Field.includes('SoLuong') || x.Field.includes('DonGiaKhuyenMai'); })) {
                        for (var _i = 0, _a = this.validationErrors.filter(function (x) { return x.Field.includes('DvId') || x.Field.includes('LoaiGia') || x.Field.includes('SoLuong') || x.Field.includes('DonGiaKhuyenMai'); }); _i < _a.length; _i++) {
                            var validationItem = _a[_i];
                            this.validationErrors.splice(this.validationErrors.indexOf(validationItem), 1);
                        }
                    }
                };
                GoiDvCtMarketingSharedComponent.prototype.ResetValidateForGridKhuyenMai = function () {
                    if (this.validationErrors && this.validationErrors.some(function (x) { return x.Field.includes('dataItemKhuyenMai'); })) {
                        for (var _i = 0, _a = this.validationErrors.filter(function (x) { return x.Field.includes('dataItemKhuyenMai'); }); _i < _a.length; _i++) {
                            var validationItem = _a[_i];
                            this.validationErrors.splice(this.validationErrors.indexOf(validationItem), 1);
                        }
                    }
                };
                GoiDvCtMarketingSharedComponent.prototype.onChangeGoiDvLuaChon = function (event) {
                    if (event == 3) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.ResetKhuyenMai = function () {
                ...
                GoiDvCtMarketingSharedComponent.prototype.onChangeDichVu = function (data) {
                    var _this = this;
                    if (data) {
                        ...
                        switch (this.luaChonGoiDichVu) {
                            case 1: {
                                this.danhSachLoaiGia = null;
                                this.khuyenMaiKem.LoaiGia = null;
                                this.apiService.post('GoiDichVu/LoaiGiaDichVuKhamBenh?idDichVuKhamBenhId=' + this.khuyenMaiKem.DvId).subscribe(function (resultData) {
                                    _this.danhSachLoaiGia = resultData;
                                    if (_this.danhSachLoaiGia != null && _this.danhSachLoaiGia.length > 0) {
                                        _this.khuyenMaiKem.LoaiGia = _this.danhSachLoaiGia[0].KeyId;
                            ...
                            case 2: {
                                this.danhSachLoaiGia = null;
                                this.khuyenMaiKem.LoaiGia = null;
                                this.apiService.post('GoiDichVu/LoaiGiaNhomGiaDichVuKyThuatBenhVien?dichVuKyThuatId=' + this.khuyenMaiKem.DvId).subscribe(function (resultData) {
                                    _this.danhSachLoaiGia = resultData;
                                    if (_this.danhSachLoaiGia != null && _this.danhSachLoaiGia.length > 0) {
                                        _this.khuyenMaiKem.LoaiGia = _this.danhSachLoaiGia[0].KeyId;
                                        _this.onChangeLoaiGia(_this.danhSachLoaiGia[0]);
                            ...
                            case 3: {
                                this.danhSachLoaiGia = null;
                                this.khuyenMaiKem.LoaiGia = null;
                                this.apiService.post('GoiDichVu/LoaiGiaNhomGiaGiuongBenhVien?dichVuGiuongBenhVienId=' + this.khuyenMaiKem.DvId).subscribe(function (resultData) {
                                    _this.danhSachLoaiGia = resultData;
                                    if (_this.danhSachLoaiGia != null && _this.danhSachLoaiGia.length > 0) {
                                        _this.khuyenMaiKem.LoaiGia = _this.danhSachLoaiGia[0].KeyId;
                                        _this.onChangeLoaiGia(_this.danhSachLoaiGia[0]);
                ...
                GoiDvCtMarketingSharedComponent.prototype.onChangeLoaiGia = function (loaiGia) {
                    var _this = this;
                    ...
                    if (this.validationErrors && this.validationErrors.some(function (x) { return x.Field.includes('DonGiaKhuyenMai'); })) {
                        for (var _b = 0, _c = this.validationErrors.filter(function (x) { return x.Field.includes('DonGiaKhuyenMai'); }); _b < _c.length; _b++) {
                            var validationItem = _c[_b];
                            this.validationErrors.splice(this.validationErrors.indexOf(validationItem), 1);
                        }
                    }
                        ...
                        switch (this.luaChonGoiDichVu) {
                            case 1: {
                                this.apiService.post('GoiDichVu/GetChiPhiHienTaiDichVuKhamBenh?dichVuKhamBenhBenhVienId=' + this.khuyenMaiKem.DvId +
                                    '&nhomGiaDichVuKhamBenhBenhVienId=' + this.khuyenMaiKem.LoaiGia).subscribe(function (resultData) {
                                    _this.khuyenMaiKem.DonGia = resultData;
                                    _this.khuyenMaiKem.DonGiaKhuyenMai = resultData;
                                    _this.khuyenMaiKem.ThanhTien = _this.khuyenMaiKem.SoLuong != null ?
                                        resultData * _this.khuyenMaiKem.SoLuong : resultData;
                                });
                                break;
                            }
                            case 2: {
                                this.apiService.post('GoiDichVu/GetChiPhiHienTaiDichVuKyThuat?dichVuKyThuatBenhVienId=' + this.khuyenMaiKem.DvId +
                                    '&nhomGiaDichVuKyThuatBenhVienId=' + this.khuyenMaiKem.LoaiGia).subscribe(function (resultData) {
                                    _this.khuyenMaiKem.DonGia = resultData;
                                    _this.khuyenMaiKem.DonGiaKhuyenMai = resultData;
                                    _this.khuyenMaiKem.ThanhTien = _this.khuyenMaiKem.SoLuong != null ?
                                        resultData * _this.khuyenMaiKem.SoLuong : resultData;
                            ...
                            case 3: {
                                this.apiService.post('GoiDichVu/GetChiPhiChoDichVuGiuong?dichVuGiuongBenhVienId=' + this.khuyenMaiKem.DvId +
                                    '&nhomGiaId=' + this.khuyenMaiKem.LoaiGia).subscribe(function (resultData) {
                                    _this.khuyenMaiKem.DonGia = resultData;
                                    _this.khuyenMaiKem.DonGiaKhuyenMai = resultData;
                                    _this.khuyenMaiKem.ThanhTien = _this.khuyenMaiKem.SoLuong != null ?
                                        resultData * _this.khuyenMaiKem.SoLuong : resultData;
                ...
                GoiDvCtMarketingSharedComponent.prototype.ChangeSoLuong = function (soluong) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.ChangeSoLuongDataItem = function (soLuong, data) {
                    data.SoLuong = soLuong;
                    data.ThanhTien = data.SoLuong != null ?
                        data.DonGiaKhuyenMai * soLuong : data.DonGiaKhuyenMai;
                };
                GoiDvCtMarketingSharedComponent.prototype.ChangeDonGiaKhuyenMai = function (donGiaKhuyenMai) {
                    this.khuyenMaiKem.ThanhTien = donGiaKhuyenMai != null ?
                        donGiaKhuyenMai * this.khuyenMaiKem.SoLuong : null;
                };
                GoiDvCtMarketingSharedComponent.prototype.ChangeDonGiaKhuyenMaiDataItem = function (donGiaKhuyenMai, data) {
                    data.ThanhTien = data.SoLuong != null ?
                        donGiaKhuyenMai * data.SoLuong : donGiaKhuyenMai;
                };
                GoiDvCtMarketingSharedComponent.prototype.openComboboxKhamBenh = function (isOpen) {
                    this.khamBenhDisabled = isOpen;
                };
                GoiDvCtMarketingSharedComponent.prototype.openComboboxKyThuat = function (isOpen) {
                    this.kyThuatDisabled = isOpen;
                };
                GoiDvCtMarketingSharedComponent.prototype.openComboboxLoaiGiaKhamBenh = function (isOpen) {
                    this.loaiGiaKhamBenhDisabled = isOpen;
                };
                GoiDvCtMarketingSharedComponent.prototype.openComboboxLoaiGiaKyThuat = function (isOpen) {
                    this.loaiGiaKyThuatDisabled = isOpen;
                };
                GoiDvCtMarketingSharedComponent.prototype.openComboboxLoaiGiaGiuong = function (isOpen) {
                    this.loaiGiaGiuongDisabled = isOpen;
                };
                GoiDvCtMarketingSharedComponent.prototype.onKeyAddDv = function (keyInput, loai) {
                    if (loai === void 0) { loai = 0; }
                    if (keyInput.keyCode === 13) {
                        this.AddKhuyenMai();
                    }
                };
                GoiDvCtMarketingSharedComponent.prototype.AddKhuyenMai = function () {
                    switch (this.luaChonGoiDichVu) {
                        case 1: {
                ...
                GoiDvCtMarketingSharedComponent.prototype.AddingAfterValidationKhuyenMai = function (loaiNhom) {
                    var _this = this;
                    if (this.validationErrors && !this.validationErrors.some(function (x) { return x; })) {
                        this.khuyenMaiKem.Nhom = loaiNhom;
                        this.apiService.get('GoiDichVuMarketing/GetResultEnumDichVuTongHop?enumTongHop=' + this.khuyenMaiKem.Nhom).subscribe(function (resultData) {
                            _this.idDichVuKhamBenhComponent = _this.goiMarketing.KhuyenMaiKems.length + 1;
                            var goiDichVuModel = new _goi_dv_marketing_model__WEBPACK_IMPORTED_MODULE_17__["KhuyenMaiKem"]();
                            goiDichVuModel = Object.assign({}, _this.khuyenMaiKem);
                            ...
                            _this.goiMarketing.KhuyenMaiKems.push(goiDichVuModel);
                            _this.setDataGridViewKhuyenMai();
                            _this.gridKhuyenMaiKem.gridDataSource = Object.assign({}, _this.gridDataSource);
                            _this.gridKhuyenMaiKem.setDataSource();
                            _this.ResetKhuyenMai();
                        });
                    }
                };
                GoiDvCtMarketingSharedComponent.prototype.setDataGridViewKhuyenMai = function () {
                    this.gridDataSourceKhuyenMai = {
                        data: this.goiMarketing.KhuyenMaiKems.slice(),
                        total: this.goiMarketing.KhuyenMaiKems.length
                    };
                };
                GoiDvCtMarketingSharedComponent.prototype.validationFormClientForKhamBenh = function (dataval) {
                    this.validationErrors = [];
                    var array = [];
                    if (dataval) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.validationFormClientForKyThuat = function (dataval) {
                    this.validationErrors = [];
                    var array = [];
                    if (dataval) {
                        if (dataval.DvId === 0 || dataval.DvId == null) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.validationFormClientForGiuong = function (dataval) {
                    this.validationErrors = [];
                    var array = [];
                    if (dataval) {
                        if (dataval.DvId === 0 || dataval.DvId == null) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.checkExistKhuyenMai = function (dichVuKhamBenhBenhVienId, loaiNhom) {
                    return this.goiMarketing.KhuyenMaiKems.some(function (x) { return x.Nhom === loaiNhom && x.DvId === dichVuKhamBenhBenhVienId; });
                };
                GoiDvCtMarketingSharedComponent.prototype.ConfirmDeleteKM = function (dataItem) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                        disableClose: false,
                        width: '400px',
                        ...
                        if (result === 'Yes') {
                            _this.DeleteKM(dataItem);
                        }
                    });
                };
                GoiDvCtMarketingSharedComponent.prototype.DeleteKM = function (dataItem) {
                ...
                //Nhóm DV
                GoiDvCtMarketingSharedComponent.prototype.setDataGridViewNhomDichVu = function () {
                    this.gridDataSourceNhomDichVu = {
                        data: this.goiMarketing.NhomDichVus.slice(),
                        total: this.goiMarketing.NhomDichVus.length
                    };
                };
                GoiDvCtMarketingSharedComponent.prototype.ChangeSoLuongNhomDichVuDataItem = function (soLuong, data) {
                    data.SoLuong = soLuong;
                ...
                GoiDvCtMarketingSharedComponent.prototype.ChangeDonGiaTruocChietKhauDataItem = function (donGia, data) {
                ...
                GoiDvCtMarketingSharedComponent.prototype.ChangeDonGiaSauChietKhauDataItem = function (donGia, data) {
                    if (donGia != undefined && donGia != null) {
                        data.ThanhTienSauChietKhau = data.SoLuong != null ?
                            donGia * data.SoLuong : donGia;
                    }
                ...
                GoiDvCtMarketingSharedComponent.prototype.showFormNhapTruocChietKhauPopup = function () {
                    var _this = this;
                    ...
                    this.confrim = this.dialog
                        ...
                        if (result != null) {
                            _this.goiMarketing.NhomDichVus.forEach(function (item) {
                                ...
                                _this.ChangeDonGiaTruocChietKhauDataItem(item.DonGiaTruocChietKhau, item);
                            });
                        }
                    });
                };
                GoiDvCtMarketingSharedComponent.prototype.showFormNhapSauChietKhauPopup = function () {
                    var _this = this;
                    if (this.confrim != null) {
                        this.dialog.closeAll();
                        this.confrim = null;
                    ...
                    this.confrim = this.dialog
                        ...
                        if (result != null) {
                            _this.goiMarketing.NhomDichVus.forEach(function (item) {
                                ...
                                _this.ChangeDonGiaSauChietKhauDataItem(item.DonGiaSauChietKhau, item);
                            });
                        }
                    });
                };
                GoiDvCtMarketingSharedComponent.prototype.themLoaiGoi = function () {
                ...
                return GoiDvCtMarketingSharedComponent;
            }());
            GoiDvCtMarketingSharedComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _goi_dv_marketing_shared_goi_dv_marketing_shared_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../goi-dv-marketing-shared/goi-dv-marketing-shared.component */ "./src/app/modules/main/marketing/chuong-trinh-marketing/theo-goi-dich-vu/goi-dv-marketing-shared/goi-dv-marketing-shared.component.ts");
            var GoiDvCtMarketingUpdateComponent = /** @class */ (function () {
                function GoiDvCtMarketingUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                GoiDvCtMarketingUpdateComponent.prototype.ngOnInit = function () {
                    this.idsub = this.route.snapshot.params.id;
                };
                GoiDvCtMarketingUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/marketing/ct-marketing/goi-dv'], {
                        queryParamsHandling: 'preserve',
                    });
                };
                GoiDvCtMarketingUpdateComponent.prototype.onValidateClient = function (isValidate) {
                    if (isValidate) {
                        this.shared.OnValidate();
                    }
                };
                GoiDvCtMarketingUpdateComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode === 83 && event.ctrlKey) {
                        // ctrl + s
                        this.footer.update();
                        event.preventDefault();
                ...
                return GoiDvCtMarketingUpdateComponent;
            }());
            GoiDvCtMarketingUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var GoiDichVuChuongTrinhMarketing = /** @class */ (function () {
                function GoiDichVuChuongTrinhMarketing(Id, Ma, Ten, GoiDvId, GoiDv, GoiDichVu, GiaTruocChietKhau, TiLeChietKhau, GiaSauChietKhau, TuNgay, TuNgayDisplay, DenNgay, CongTyBaoHiemTuNhanId, DenNgayDisplay, TamNgung, MoTaGoiDichVu, CoYeuCauSuDung, GoiDvIdCu, GoiSoSinh, LoaiGoiDichVuId, TenLoaiGoiDichVu, QuaTangKems, YeuCauSuDungChuongTrinhs, KhuyenMaiKems, NhomDichVus) {
                    if (Id === void 0) { Id = null; }
                    if (Ma === void 0) { Ma = null; }
                    if (Ten === void 0) { Ten = null; }
                    if (GoiDvId === void 0) { GoiDvId = null; }
                    if (GoiDv === void 0) { GoiDv = null; }
                    ...
                    if (TuNgay === void 0) { TuNgay = new Date(); }
                    if (TuNgayDisplay === void 0) { TuNgayDisplay = null; }
                    if (DenNgay === void 0) { DenNgay = null; }
                    if (CongTyBaoHiemTuNhanId === void 0) { CongTyBaoHiemTuNhanId = null; }
                    if (DenNgayDisplay === void 0) { DenNgayDisplay = null; }
                    if (TamNgung === void 0) { TamNgung = null; }
                    if (MoTaGoiDichVu === void 0) { MoTaGoiDichVu = null; }
                    if (CoYeuCauSuDung === void 0) { CoYeuCauSuDung = null; }
                    if (GoiDvIdCu === void 0) { GoiDvIdCu = null; }
                    if (GoiSoSinh === void 0) { GoiSoSinh = null; }
                    if (LoaiGoiDichVuId === void 0) { LoaiGoiDichVuId = null; }
                    if (TenLoaiGoiDichVu === void 0) { TenLoaiGoiDichVu = null; }
                    if (QuaTangKems === void 0) { QuaTangKems = []; }
                    if (YeuCauSuDungChuongTrinhs === void 0) { YeuCauSuDungChuongTrinhs = []; }
                    if (KhuyenMaiKems === void 0) { KhuyenMaiKems = []; }
                    if (NhomDichVus === void 0) { NhomDichVus = []; }
                    this.Id = Id;
                    this.Ma = Ma;
                    this.Ten = Ten;
                ...
                return GoiDichVuChuongTrinhMarketing;
            }());
            var NhomDichVu = /** @class */ (function () {
                function NhomDichVu(Id, DvId, MaDv, TenDv, NhomDisplay, LoaiGiaDisplay, SoLuong, DonGiaBenhVien, DonGiaTruocChietKhau, DonGiaSauChietKhau, ThanhTienBenhVien, ThanhTienTruocChietKhau, ThanhTienSauChietKhau) {
                    if (Id === void 0) { Id = null; }
            ...
            var QuaTangKem = /** @class */ (function () {
                function QuaTangKem(Id, IdSys, QuaTangId, QuaTang, SoLuong, GhiChu, GoiDvChuongTrinhMarketingId) {
                    if (Id === void 0) { Id = null; }
                    if (IdSys === void 0) { IdSys = null; }
                    ...
                    if (GoiDvChuongTrinhMarketingId === void 0) { GoiDvChuongTrinhMarketingId = null; }
                    this.Id = Id;
                    this.IdSys = IdSys;
            ...
            var KhuyenMaiKem = /** @class */ (function () {
                function KhuyenMaiKem(Id, MaDv, TenDv, DvId, LoaiGia, GoiDichVuId, LoaiGiaDisplay, SoLuong, IdDatabase, DonGia, DonGiaKhuyenMai, ThanhTien, GhiChu, Nhom, // 1 là khám bệnh, 2 là kỹ thuật, 3 là giường bệnh
                NhomDisplay, SoNgaySuDung) {
                    if (Id === void 0) { Id = null; }
                    if (MaDv === void 0) { MaDv = null; }
                    if (TenDv === void 0) { TenDv = null; }
                    if (DvId === void 0) { DvId = null; }
                    ...
                    if (DonGiaKhuyenMai === void 0) { DonGiaKhuyenMai = 0; }
                    if (ThanhTien === void 0) { ThanhTien = null; }
                    if (GhiChu === void 0) { GhiChu = null; }
                    if (Nhom === void 0) { Nhom = null; }
                    if (NhomDisplay === void 0) { NhomDisplay = null; }
                    if (SoNgaySuDung === void 0) { SoNgaySuDung = 30; }
                    this.Id = Id;
                    this.MaDv = MaDv;
                    this.TenDv = TenDv;
                    this.DvId = DvId;
            ...
            var GoiDichVuChuongTrinhMarketingSearch = /** @class */ (function () {
                function GoiDichVuChuongTrinhMarketingSearch(SearchString, 
                ...
                RangeToDate) {
                    ...
                    if (RangeToDate === void 0) { RangeToDate = new RangeDate(); }
                    this.SearchString = SearchString;
                    this.RangeFromDate = RangeFromDate;
                    this.RangeToDate = RangeToDate;
                }
                return GoiDichVuChuongTrinhMarketingSearch;
            }());
            ...
            var LoaiGiaBenhVien = /** @class */ (function () {
                function LoaiGiaBenhVien(KeyId, DisplayName) {
                    if (DisplayName === void 0) { DisplayName = ""; }
                    this.KeyId = KeyId;
                    this.DisplayName = DisplayName;
                }
                return LoaiGiaBenhVien;
            }());
            var TruocChietKhau = /** @class */ (function () {
                function TruocChietKhau(ChietKhau, LoaiChietKhau) {
                    if (LoaiChietKhau === void 0) { LoaiChietKhau = 1; }
                    this.ChietKhau = ChietKhau;
                    this.LoaiChietKhau = LoaiChietKhau;
                }
                return TruocChietKhau;
            }());
            var LoaiGoiDichVu = /** @class */ (function () {
                function LoaiGoiDichVu(Id, Ma, Ten, IsDefault) {
                    if (Id === void 0) { Id = 0; }
                    if (Ma === void 0) { Ma = null; }
                    if (Ten === void 0) { Ten = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiDvMarketingModule = /** @class */ (function () {
                function GoiDvMarketingModule() {
                }
                return GoiDvMarketingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiDvChuongTrinhMarketingService = /** @class */ (function (_super) {
                __extends(GoiDvChuongTrinhMarketingService, _super);
                function GoiDvChuongTrinhMarketingService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'GoiDichVuChuongTrinhMarketing';
                    return _this;
                }
                return GoiDvChuongTrinhMarketingService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            GoiDvChuongTrinhMarketingService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoaiDichVuPopupComponent = /** @class */ (function () {
                function LoaiDichVuPopupComponent(data, authService, notificationService, apiService, dialog) {
                    this.data = data;
                    this.authService = authService;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                ...
                LoaiDichVuPopupComponent.prototype.ngOnInit = function () {
                    this.gridColumns = [
                ...
                LoaiDichVuPopupComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.grid.searchString = this.searchString;
                        this.grid.search();
                    }
                };
                LoaiDichVuPopupComponent.prototype.searchChange = function (event) {
                    if (event == null || event == "") {
                        this.clearSearch();
                    }
                };
                LoaiDichVuPopupComponent.prototype.clearSearch = function () {
                    this.searchString = null;
                    this.grid.searchString = null;
                    this.grid.search();
                };
                LoaiDichVuPopupComponent.prototype.savingPage = function () {
                ...
                LoaiDichVuPopupComponent.prototype.closepopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                LoaiDichVuPopupComponent.prototype.addingPage = function () {
                ...
                LoaiDichVuPopupComponent.prototype.closePopupAddingData = function () {
                    if (this.popupAddingData != undefined && this.popupAddingData != null) {
                        this.popupAddingData.close();
                    }
                };
                LoaiDichVuPopupComponent.prototype.loadingPage = function () {
                ...
                LoaiDichVuPopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                LoaiDichVuPopupComponent.prototype.deletingPage = function () {
                ...
                LoaiDichVuPopupComponent.prototype.closePopupDeletingData = function () {
                    if (this.popupDeletingData != undefined && this.popupDeletingData != null) {
                        this.popupDeletingData.close();
                    }
                };
                LoaiDichVuPopupComponent.prototype.them = function () {
                    this.validationErrors = [];
                    this.loaiGoiDichVu = new _goi_dv_marketing_model__WEBPACK_IMPORTED_MODULE_20__["LoaiGoiDichVu"]();
                    this.isShow = true;
                    this.isCreate = true;
                };
                LoaiDichVuPopupComponent.prototype.luu = function () {
                    var _this = this;
                    if (this.isCreate) {
                        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Add)) {
                            this.addingPage();
                            this.apiService.post("GoiDichVuChuongTrinhMarketing/ThemLoaiGoi", this.loaiGoiDichVu).subscribe(function () {
                        ...
                        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Update)) {
                            if (this.isDefault) {
                                ...
                                this.savingPage();
                                this.apiService.post("GoiDichVuChuongTrinhMarketing/CapNhatLoaiGoi", this.loaiGoiDichVu).subscribe(function () {
                ...
                LoaiDichVuPopupComponent.prototype.huy = function () {
                    this.validationErrors = [];
                    this.loaiGoiDichVu = new _goi_dv_marketing_model__WEBPACK_IMPORTED_MODULE_20__["LoaiGoiDichVu"]();
                    this.isShow = false;
                    this.isCreate = false;
                };
                LoaiDichVuPopupComponent.prototype.xem = function (id, isDefault) {
                    var _this = this;
                    this.isDefault = isDefault;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Update)) {
                        this.loadingPage();
                        this.apiService.get("GoiDichVuChuongTrinhMarketing/GetLoaiGoi?id=" + id)
                            ...
                            _this.loaiGoiDichVu = resultData;
                            _this.isShow = true;
                ...
                LoaiDichVuPopupComponent.prototype.xoa = function (id, isDefault) {
                    var _this = this;
                    if (isDefault) {
                        ...
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                if (_this.authService.hasPermission(_this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Delete)) {
                                    _this.deletingPage();
                                    _this.apiService.post("GoiDichVuChuongTrinhMarketing/XoaLoaiGoi?id=" + id)
                                        .subscribe(function () {
                ...
                return LoaiDichVuPopupComponent;
            }());
            LoaiDichVuPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapSauChietKhauPopupComponent = /** @class */ (function () {
                function NhapSauChietKhauPopupComponent(data, sanitizer, cdRef, dialogRef) {
                    this.data = data;
                ...
                NhapSauChietKhauPopupComponent.prototype.ngOnInit = function () {
                };
                NhapSauChietKhauPopupComponent.prototype.close = function () {
                    this.dialogRef.close(null);
                };
                NhapSauChietKhauPopupComponent.prototype.apDung = function () {
                    this.validationErrors = [];
                ...
                NhapSauChietKhauPopupComponent.prototype.onKeyUp = function (keyInput) {
                    if (keyInput.keyCode === 13) {
                        this.apDung();
                    }
                };
                return NhapSauChietKhauPopupComponent;
            }());
            NhapSauChietKhauPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @iconify/icons-ic/twotone-close */ "./node_modules/@iconify/icons-ic/twotone-close.js");
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_4__);
            var NhapTruocChietKhauPopupComponent = /** @class */ (function () {
                function NhapTruocChietKhauPopupComponent(data, sanitizer, cdRef, dialogRef) {
                    this.data = data;
                    this.sanitizer = sanitizer;
                    this.cdRef = cdRef;
                    this.dialogRef = dialogRef;
                ...
                NhapTruocChietKhauPopupComponent.prototype.ngOnInit = function () {
                    this.truocChietKhau.LoaiChietKhau = 1;
                };
                NhapTruocChietKhauPopupComponent.prototype.close = function () {
                    this.dialogRef.close(null);
                };
                NhapTruocChietKhauPopupComponent.prototype.apDung = function () {
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                ...
                NhapTruocChietKhauPopupComponent.prototype.onKeyUp = function (keyInput) {
                    if (keyInput.keyCode === 13) {
                        this.apDung();
                    }
                };
                return NhapTruocChietKhauPopupComponent;
            }());
            NhapTruocChietKhauPopupComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"] },
                { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] }
...
//# sourceMappingURL=marketing-chuong-trinh-marketing-theo-goi-dich-vu-goi-dv-marketing-module-es5.js.map
//# sourceMappingURL=marketing-chuong-trinh-marketing-theo-goi-dich-vu-goi-dv-marketing-module-es5.js.map