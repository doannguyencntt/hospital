...
let QuanHeThanNhanCreateComponent = class QuanHeThanNhanCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
QuanHeThanNhanCreateComponent.ctorParameters = () => [
...
let QuanHeThanNhanListComponent = class QuanHeThanNhanListComponent {
    ...
    updateQuanHeThanNhan(id, isDisabled) {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('QuanHeThanNhan/ExportQuanHeThanNhan', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
QuanHeThanNhanListComponent.ctorParameters = () => [
...
let QuanHeThanNhanRoutingModule = class QuanHeThanNhanRoutingModule {
};
...
let QuanHeThanNhanSharedComponent = class QuanHeThanNhanSharedComponent {
...
QuanHeThanNhanSharedComponent.ctorParameters = () => [
...
let QuanHeThanNhanUpdateComponent = class QuanHeThanNhanUpdateComponent {
...
QuanHeThanNhanUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let QuanHeThanNhanModule = class QuanHeThanNhanModule {
};
...
let QuanHeThanNhanService = class QuanHeThanNhanService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'QuanHeThanNhan';
    }
};
QuanHeThanNhanService.ctorParameters = () => [
