(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-chi-tiet-mien-phi-tron-vien-bao-cao-chi-tiet-mien-phi-tron-vien-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoChiTietMienPhiTronVienListComponent = /** @class */ (function () {
                function BaoCaoChiTietMienPhiTronVienListComponent(apiService, dialog, notificationService, authService) {
                ...
                BaoCaoChiTietMienPhiTronVienListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoChiTietMienPhiTronVienListComponent.prototype.totalGiamPhi = function () {
                    if (this.gridDataSource.data != undefined) {
                        return this.gridDataSource.data.reduce(function (sum, item) { return sum + item.GiamPhi; }, 0);
                    }
                };
                BaoCaoChiTietMienPhiTronVienListComponent.prototype.totalMienPhi = function () {
                    if (this.gridDataSource.data != undefined) {
                        return this.gridDataSource.data.reduce(function (sum, item) { return sum + item.MienPhi; }, 0);
                    }
                };
                BaoCaoChiTietMienPhiTronVienListComponent.prototype.totalTongGiamPhiMienPhi = function () {
                    if (this.gridDataSource.data != undefined) {
                        return this.gridDataSource.data.reduce(function (sum, item) { return sum + item.TongGiamPhiMienPhi; }, 0);
                    }
                };
                BaoCaoChiTietMienPhiTronVienListComponent.prototype.pageChange = function (event) {
                    this.skip = event;
                    // this.XemBaoCao();
                ...
                BaoCaoChiTietMienPhiTronVienListComponent.prototype.seachChange = function (event) {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoChiTietMienPhiTronVienListComponent.prototype.XemBaoCao = function () {
                ...
                BaoCaoChiTietMienPhiTronVienListComponent.prototype.getTongCong = function (queryInfo) {
                    var _this = this;
                    this.apiService.post("BaoCao/GetTongCongChiPhiMienPhiTronVien", queryInfo).subscribe(function (resultData) {
                        _this.giamPhi = resultData.GiamPhi;
                        _this.mienPhi = resultData.MienPhi;
                        _this.tongGiamPhi = resultData.TongGiamPhiMienPhi;
                    }, function (err) {
                ...
                BaoCaoChiTietMienPhiTronVienListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                return BaoCaoChiTietMienPhiTronVienListComponent;
            }());
            BaoCaoChiTietMienPhiTronVienListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoChiTietMienPhiTronVienRoutingModule = /** @class */ (function () {
                function BaoCaoChiTietMienPhiTronVienRoutingModule() {
                }
                return BaoCaoChiTietMienPhiTronVienRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoChiTietMienPhiTronVienSearch = /** @class */ (function () {
                function BaoCaoChiTietMienPhiTronVienSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                ...
                return BaoCaoChiTietMienPhiTronVienSearch;
            }());
            var InBaoCaoChiTietMienPhiTronVien = /** @class */ (function () {
                function InBaoCaoChiTietMienPhiTronVien(HostingName, FromDate, ToDate) {
                ...
                return InBaoCaoChiTietMienPhiTronVien;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoChiTietMienPhiTronVienModule = /** @class */ (function () {
                function BaoCaoChiTietMienPhiTronVienModule() {
                }
                return BaoCaoChiTietMienPhiTronVienModule;
            }());
...
//# sourceMappingURL=bao-cao-bao-cao-chi-tiet-mien-phi-tron-vien-bao-cao-chi-tiet-mien-phi-tron-vien-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-chi-tiet-mien-phi-tron-vien-bao-cao-chi-tiet-mien-phi-tron-vien-module-es5.js.map