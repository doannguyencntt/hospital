        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Update)) {
            this.dialog.open(_du_tru_giam_doc_declined_popup_du_tru_giam_doc_declined_popup_component__WEBPACK_IMPORTED_MODULE_12__["DuTruGiamDocDeclinedPopupComponent"], {
                ...
                if (result && result.includes('Yes')) {
                    ...
                    this.apiService.post('TongHopDuTruMuaVatTuTaiGiamDoc/Decline', reqParam).subscribe(() => {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Update)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                ...
                if (result === 'Yes') {
                    ...
                    this.apiService.post('TongHopDuTruMuaVatTuTaiGiamDoc/ApproveForm', reqParam).subscribe(() => {
...
let DuTruGiamDocListComponent = class DuTruGiamDocListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Process)) {
            ...
            self.apiService.postExportExcel('TongHopDuTruMuaVatTuTaiGiamDoc/ExportTongHopDuTruMuaVatTuTaiGiamDoc', self.gridParent._gridQueryInfo).subscribe(resultData => {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
            this.dialog.open(_du_tru_giam_doc_declined_popup_du_tru_giam_doc_declined_popup_component__WEBPACK_IMPORTED_MODULE_20__["DuTruGiamDocDeclinedPopupComponent"], {
                ...
                if (result && result.includes('Yes')) {
                    ...
                    this.apiService.post('TongHopDuTruMuaVatTuTaiGiamDoc/Decline', approve).subscribe(() => {
    ...
    Approve(item) {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_19__["ConfirmComponent"], {
                ...
                if (result === 'Yes') {
                    this.apiService.get(`TongHopDuTruMuaVatTuTaiGiamDoc/Approve?id=${item.Id}`).subscribe(() => {
...
let DuTruGiamDocSharedComponent = class DuTruGiamDocSharedComponent {
    ...
    ReturnData(lyDo = null) {
        ...
        this.duTruGiamDoc.DuTruGiamDocDetails.forEach(item => {
            const approveDetail = new _du_tru_giam_doc_model__WEBPACK_IMPORTED_MODULE_5__["ChiTietVatTu"]();
...
class DuTruGiamDoc {
    constructor(SoPhieu = null, KyDuTruDisplay = null, KyDuTru = null, NguoiYeuCau = null, NguoiDuyet = null, NgayYeuCauDisplay = null, Id = null, NgayYeuCau = null, NgayDuyetDisplay = null, NgayDuyet = null, GhiChu = null, TrangThai = null, // null: chờ, true: đã duyệt, false: từ chối duyệt
    TrangThaiDisplay = null, LyDoGiamDocTuChoi = null, DuTruGiamDocDetails = []) {
...
class DuTruGiamDocDetail {
    constructor(Loai = null, IsBhyt = null, VatTuId = null, VatTu = null, Id = null, QuyCach = null, Dvt = null, NhaSx = null, NuocSx = null, SoLuongDuTru = null, SoLuongDuKienTrongKy = null, SoLuongDuTruTrKhoa = null, SoLuongDuTruKhDuoc = null, SoLuongDuTruDirector = null, KhoDuTruTon = null, KhoTongTon = null, HdChuaNhap = null, TongTonList = [], HdChuaNhapList = []) {
        this.Loai = Loai;
        this.IsBhyt = IsBhyt;
...
class DuTruTheoVatTuDetail {
    constructor(Khoa = null, Kho = null, KyDuTruDisplay = null, KyDuTru = null, SoLuongDuTru = null, SoLuongDuKienTrongKy = null) {
        this.Khoa = Khoa;
        this.Kho = Kho;
        this.KyDuTruDisplay = KyDuTruDisplay;
        this.KyDuTru = KyDuTru;
...
class ApproveData {
    constructor(Id = null, LyDo = null, ChiTietVatTuList = []) {
        this.Id = Id;
        this.LyDo = LyDo;
...
let TongHopDuTruMuaVatTuTaiGiamDocModule = class TongHopDuTruMuaVatTuTaiGiamDocModule {
};
...
let TongHopDuTruMuaVatTuTaiGiamDocService = class TongHopDuTruMuaVatTuTaiGiamDocService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'TongHopDuTruMuaVatTuTaiGiamDoc';
    }
};
TongHopDuTruMuaVatTuTaiGiamDocService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
