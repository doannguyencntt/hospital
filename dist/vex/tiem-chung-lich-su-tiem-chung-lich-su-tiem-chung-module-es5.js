...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tiem-chung-lich-su-tiem-chung-lich-su-tiem-chung-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuTiemChungChiTietComponent = /** @class */ (function () {
                function LichSuTiemChungChiTietComponent(route) {
                    this.route = route;
                    this.yeuCauKhamTiemChungId = null;
                }
                LichSuTiemChungChiTietComponent.prototype.ngOnInit = function () {
                    var yeuCauDichVuKyThuatId = this.route.snapshot.paramMap.get('id');
                    if (yeuCauDichVuKyThuatId && !isNaN(Number(yeuCauDichVuKyThuatId))) {
                        this.yeuCauKhamTiemChungId = Number(yeuCauDichVuKyThuatId);
                    }
                };
                return LichSuTiemChungChiTietComponent;
            }());
            LichSuTiemChungChiTietComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuTiemChungRoutingModule = /** @class */ (function () {
                function LichSuTiemChungRoutingModule() {
                }
                return LichSuTiemChungRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuTiemChungModule = /** @class */ (function () {
                function LichSuTiemChungModule() {
                }
                return LichSuTiemChungModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuTiemChungService = /** @class */ (function (_super) {
                __extends(LichSuTiemChungService, _super);
                function LichSuTiemChungService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'TiemChung';
                    return _this;
                }
                return LichSuTiemChungService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            LichSuTiemChungService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuTiemChungComponent = /** @class */ (function () {
                function LichSuTiemChungComponent(router, location, route, authService, notificationService) {
                    this.router = router;
                ...
                LichSuTiemChungComponent.prototype.ngOnInit = function () {
                ...
                LichSuTiemChungComponent.prototype.chiTiet = function (id) {
                ...
                LichSuTiemChungComponent.prototype.evtSearchOnKey = function (event) {
                    if (event.key === "Enter") {
                        this.timKiemNangCao();
                    }
                };
                LichSuTiemChungComponent.prototype.evtSearchChanged = function (event) {
                    if (!event) {
                        this.timKiemNangCao();
                    }
                };
                LichSuTiemChungComponent.prototype.evtThoiDiemKhamOnKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiemNangCao();
                    }
                };
                ...
                // 	this.timKiemNangCao();
                // }
                LichSuTiemChungComponent.prototype.evtThoiGianCachLichHenOnKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiemNangCao();
                    }
                };
                LichSuTiemChungComponent.prototype.evtSearchCleared = function () {
                    this.lichSuTiemChungSearch.SearchString = '';
                    this.timKiemNangCao();
                };
                LichSuTiemChungComponent.prototype.timKiemNangCao = function () {
                    this.location.replaceState(this.baseRoute + '?holdQuery=true');
                    this.convertToUTCDateTime();
                    var queryString = JSON.stringify(this.lichSuTiemChungSearch);
                    this.reverseFromUTCDateTime();
                ...
                LichSuTiemChungComponent.prototype.convertToUTCDateTime = function () {
                ...
                LichSuTiemChungComponent.prototype.reverseFromUTCDateTime = function () {
                    if (this.lichSuTiemChungSearch.ThoiDiemKham.startDate) {
                ...
                return LichSuTiemChungComponent;
            }());
            LichSuTiemChungComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=tiem-chung-lich-su-tiem-chung-lich-su-tiem-chung-module-es5.js.map
//# sourceMappingURL=tiem-chung-lich-su-tiem-chung-lich-su-tiem-chung-module-es5.js.map