...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-dich-vu-giuong-benh-vien-dich-vu-giuong-benh-vien-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DichVuGiuongBenhVienCreateComponent = /** @class */ (function () {
                function DichVuGiuongBenhVienCreateComponent(router) {
                    this.router = router;
                }
                DichVuGiuongBenhVienCreateComponent.prototype.ngOnInit = function () {
                };
                DichVuGiuongBenhVienCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/dich-vu-giuong-tai-benh-vien']);
                };
                return DichVuGiuongBenhVienCreateComponent;
            }());
            DichVuGiuongBenhVienCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DichVuGiuongBenhVienListComponent = /** @class */ (function () {
                function DichVuGiuongBenhVienListComponent(notificationService, authService, dialog, apiService) {
                ...
                DichVuGiuongBenhVienListComponent.prototype.ngOnInit = function () {
                ...
                DichVuGiuongBenhVienListComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('DichVuGiuongBenhVien/ExportDichVuGiuongBenhVien', self.gridDichVuGiuongCha._gridQueryInfo).subscribe(function (resultData) {
                ...
                DichVuGiuongBenhVienListComponent.prototype.showPopupLoadingData = function () {
                ...
                DichVuGiuongBenhVienListComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return DichVuGiuongBenhVienListComponent;
            }());
            DichVuGiuongBenhVienListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DichVuGiuongBenhVienRoutingModule = /** @class */ (function () {
                function DichVuGiuongBenhVienRoutingModule() {
                }
                return DichVuGiuongBenhVienRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DichVuGiuongBenhVienSharedComponent = /** @class */ (function () {
                function DichVuGiuongBenhVienSharedComponent(route, baseService, apiService, cdr) {
                    this.route = route;
                ...
                DichVuGiuongBenhVienSharedComponent.prototype.ngOnInit = function () {
                ...
                // }
                DichVuGiuongBenhVienSharedComponent.prototype.getSharedData = function () {
                    return this.dichVuGiuongBenhVien;
                };
                DichVuGiuongBenhVienSharedComponent.prototype.XoaBaoHiem = function (position) {
                ...
                DichVuGiuongBenhVienSharedComponent.prototype.ThemBaoHiem = function () {
                    var viTriNew = new _dich_vu_giuong_benh_vien_model__WEBPACK_IMPORTED_MODULE_2__["DichVuGiuongBenhVienGiaBaoHiems"]();
                    this.dichVuGiuongBenhVien.DichVuGiuongBenhVienGiaBaoHiems.push(viTriNew);
                };
                DichVuGiuongBenhVienSharedComponent.prototype.XoaBenhVien = function (position) {
                ...
                DichVuGiuongBenhVienSharedComponent.prototype.ThemBenhVien = function () {
                    var viTriNew = new _dich_vu_giuong_benh_vien_model__WEBPACK_IMPORTED_MODULE_2__["DichVuGiuongBenhVienGiaBenhViens"]();
                    this.dichVuGiuongBenhVien.DichVuGiuongBenhVienGiaBenhViens.push(viTriNew);
                };
                DichVuGiuongBenhVienSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.dichVuGiuongBenhVien = resultData;
                            _this.dichvuGiuongId = resultData.DichVuGiuongId;
                            if (_this.dichVuGiuongBenhVien.DichVuGiuong == null) {
                                _this.dichVuGiuongBenhVien.DichVuGiuong = new _bao_hiem_y_te_dich_vu_giuong_dich_vu_giuong_model__WEBPACK_IMPORTED_MODULE_7__["DichVuGiuong"]();
                            }
                            _this.getObjKhoaId(_this.dichVuGiuongBenhVien.KhoaPhongIds);
                ...
                DichVuGiuongBenhVienSharedComponent.prototype.XuLyAnhXa = function (event) {
                    if (!event) {
                ...
                DichVuGiuongBenhVienSharedComponent.prototype.ChonDichVu = function (event) {
                    var _this = this;
                    if (event != undefined && event != null) {
                        ...
                        this.apiService.get('DichVuGiuongBenhVien/GetThongTinDichVuGiuong?dichVuGiuongId=' + event.KeyId).subscribe(function (resultData) {
                            if (resultData !== null && resultData !== undefined) {
                                _this.dichVuGiuongBenhVien.DichVuGiuong = resultData;
                            }
                        }, function () {
                        });
                    }
                ...
                DichVuGiuongBenhVienSharedComponent.prototype.changeKhoa = function (event) {
                    if (event == undefined || event == null || event.length == 0) {
                        this.dichVuGiuongBenhVien.NoiThucHienIds = [];
                    }
                    else {
                        var arrNoiThucHienHienTai = this.dichVuGiuongBenhVien.NoiThucHienIds.slice();
                        var arrNoiThucHienNew_1 = this.dichVuGiuongBenhVien.NoiThucHienIds.slice();
                        ...
                        this.dichVuGiuongBenhVien.NoiThucHienIds = arrNoiThucHienNew_1.slice();
                    }
                    this.getObjKhoaId(event);
                };
                DichVuGiuongBenhVienSharedComponent.prototype.getObjKhoaId = function (arr) {
                ...
                DichVuGiuongBenhVienSharedComponent.prototype.isItemSelected = function (dataItem) {
                    var _this = this;
                    //this.cdr.detectChanges();
                    if (this.dichVuGiuongBenhVien.NoiThucHienIds != undefined && this.dichVuGiuongBenhVien.NoiThucHienIds.length > 0) {
                        ...
                        if (dataItem.KhoaId === null || dataItem.KhoaId === '') {
                            var index = this.dichVuGiuongBenhVien.NoiThucHienIds.findIndex(function (x) { return x == dataItem.KeyId; });
                            if (index !== -1) // đang chọn khoa
                             {
                                if (index == this.dichVuGiuongBenhVien.NoiThucHienIds.length - 1) { // nếu vừa chọn khoa
                                    ...
                                    if (this.dichVuGiuongBenhVien.NoiThucHienIds.length > 1) {
                                        ...
                                        arrNoiThucHienTemp.forEach(function (element) {
                                            ...
                                            if (elementObj.KhoaId === currentItemValue_1.KhoaId && elementObj.PhongId != null && elementObj.PhongId != "") {
                                                var indexNoiThucHienXoa = _this.dichVuGiuongBenhVien.NoiThucHienIds.findIndex(function (x) { return x == element; });
                                                if (indexNoiThucHienXoa != -1) {
                                                    _this.dichVuGiuongBenhVien.NoiThucHienIds.splice(indexNoiThucHienXoa, 1);
                                 ...
                                 {
                                    var itemCuoiCung_1 = this.dichVuGiuongBenhVien.NoiThucHienIds[this.dichVuGiuongBenhVien.NoiThucHienIds.length - 1];
                                    ...
                                    if (itemCuoiCungObj_1.PhongId != null && itemCuoiCungObj_1.PhongId != '' && itemCuoiCungObj_1.KhoaId == currentItemValue_1.KhoaId) {
                                        ...
                                        this.dichVuGiuongBenhVien.NoiThucHienIds.forEach(function (element, index) {
                                        ...
                                        if (indexParentItemCuoiCung_1 != -1) // nếu đã chọn khoa trước đó
                                         ...
                                         {
                                            return this.dichVuGiuongBenhVien.NoiThucHienIds.some(function (item) { return item == dataItem.KeyId; });
                                        }
                                    }
                                    else {
                                        return this.dichVuGiuongBenhVien.NoiThucHienIds.some(function (item) { return item == dataItem.KeyId; });
                            ...
                            var indexParent = this.dichVuGiuongBenhVien.NoiThucHienIds.findIndex(function (item) { return item == dataItem.KhoaKeyId; });
                            if (indexParent != -1) {
                                return this.dichVuGiuongBenhVien.NoiThucHienIds.some(function (item) { return _this.checkedValue(item, dataItem.KeyId); });
                            }
                            else {
                                ...
                                var count_1 = 0;
                                var arrNoiThucHien = this.dichVuGiuongBenhVien.NoiThucHienIds.slice();
                                ...
                                if (count_1 == dataItem.CountItems) {
                                    var arr_1 = this.dichVuGiuongBenhVien.NoiThucHienIds.slice();
                                    var isPush_1 = false;
                                    ...
                                    this.dichVuGiuongBenhVien.NoiThucHienIds = arr_1.slice();
                                    this.cdr.detectChanges();
                ...
                DichVuGiuongBenhVienSharedComponent.prototype.checkedValue = function (itemInList, currentItem) {
                ...
                return DichVuGiuongBenhVienSharedComponent;
            }());
            DichVuGiuongBenhVienSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _dich_vu_giuong_benh_vien_shared_dich_vu_giuong_benh_vien_shared_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../dich-vu-giuong-benh-vien-shared/dich-vu-giuong-benh-vien-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/benh-vien/dich-vu-giuong-benh-vien/dich-vu-giuong-benh-vien-shared/dich-vu-giuong-benh-vien-shared.component.ts");
            var DichVuGiuongBenhVienUpdateComponent = /** @class */ (function () {
                function DichVuGiuongBenhVienUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                DichVuGiuongBenhVienUpdateComponent.prototype.ngOnInit = function () {
                };
                DichVuGiuongBenhVienUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/dich-vu-giuong-tai-benh-vien']);
                };
                return DichVuGiuongBenhVienUpdateComponent;
            }());
            DichVuGiuongBenhVienUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var DichVuGiuongBenhVien = /** @class */ (function () {
                function DichVuGiuongBenhVien(DichVuGiuongId, Ten, Ma, KhoaPhongIds, NoiThucHienIds, LoaiGiuong, LoaiGiuongText, DichVuGiuongModelText, MoTa, HieuLuc, AnhXa, DichVuGiuong, DichVuGiuongBenhVienGiaBaoHiems, DichVuGiuongBenhVienGiaBenhViens) {
                    ...
                    if (LoaiGiuongText === void 0) { LoaiGiuongText = null; }
                    if (DichVuGiuongModelText === void 0) { DichVuGiuongModelText = null; }
                    if (MoTa === void 0) { MoTa = null; }
                    if (HieuLuc === void 0) { HieuLuc = false; }
                    if (AnhXa === void 0) { AnhXa = null; }
                    if (DichVuGiuong === void 0) { DichVuGiuong = null; }
                    if (DichVuGiuongBenhVienGiaBaoHiems === void 0) { DichVuGiuongBenhVienGiaBaoHiems = []; }
                    if (DichVuGiuongBenhVienGiaBenhViens === void 0) { DichVuGiuongBenhVienGiaBenhViens = []; }
            ...
            var DichVuGiuongBenhVienGiaBaoHiems = /** @class */ (function () {
                function DichVuGiuongBenhVienGiaBaoHiems(DichVuGiuongBenhVienId, Gia, TuNgay, DenNgay, TiLeBaoHiemThanhToan) {
                    if (DichVuGiuongBenhVienId === void 0) { DichVuGiuongBenhVienId = 0; }
                ...
                return DichVuGiuongBenhVienGiaBaoHiems;
            }());
            var DichVuGiuongBenhVienGiaBenhViens = /** @class */ (function () {
                function DichVuGiuongBenhVienGiaBenhViens(NhomGiaDichVuGiuongBenhVienId, NhomGiaDichVuGiuongBenhVienText, DichVuGiuongBenhVienId, Gia, TuNgay, DenNgay, BaoPhong) {
                    if (NhomGiaDichVuGiuongBenhVienId === void 0) { NhomGiaDichVuGiuongBenhVienId = null; }
                    if (NhomGiaDichVuGiuongBenhVienText === void 0) { NhomGiaDichVuGiuongBenhVienText = null; }
                    if (DichVuGiuongBenhVienId === void 0) { DichVuGiuongBenhVienId = 0; }
                    if (Gia === void 0) { Gia = null; }
                    if (TuNgay === void 0) { TuNgay = null; }
                    if (DenNgay === void 0) { DenNgay = null; }
                ...
                return DichVuGiuongBenhVienGiaBenhViens;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DichVuGiuongBenhVienModule = /** @class */ (function () {
                function DichVuGiuongBenhVienModule() {
                }
                return DichVuGiuongBenhVienModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var DichVuGiuongBenhVienService = /** @class */ (function (_super) {
                __extends(DichVuGiuongBenhVienService, _super);
                function DichVuGiuongBenhVienService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'DichVuGiuongBenhVien';
                    return _this;
                }
                return DichVuGiuongBenhVienService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            DichVuGiuongBenhVienService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-dich-vu-giuong-benh-vien-dich-vu-giuong-benh-vien-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-dich-vu-giuong-benh-vien-dich-vu-giuong-benh-vien-module-es5.js.map