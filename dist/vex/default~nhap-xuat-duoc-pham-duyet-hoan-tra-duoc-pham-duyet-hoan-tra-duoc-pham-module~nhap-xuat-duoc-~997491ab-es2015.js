...
let DuyetHoanTraDuocPhamChiTietComponent = class DuyetHoanTraDuocPhamChiTietComponent {
    constructor(dialog, elem, router, route, authService, notificationService, apiService) {
        this.dialog = dialog;
        this.elem = elem;
        this.router = router;
        this.route = route;
    ...
    getThongTinDuyetKhoDuocPham(id) {
        this.apiService.get("HoanTra/GetThongTinDuyetHoanTraDuocPham/" + id).subscribe(res => {
            if (res) {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
            ...
            this.isLoading = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    ...
                    this.apiService.post("HoanTra/DuyetHoanTraDuocPham", this.thongTinDuyetHoanTraDuocPham).subscribe(res => {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
            ...
            this.isLoading = this.dialog.open(_tu_choi_duyet_hoan_tra_duoc_pham_tu_choi_duyet_hoan_tra_duoc_pham_component__WEBPACK_IMPORTED_MODULE_12__["TuChoiDuyetHoanTraDuocPhamComponent"], {
                ...
                if (result) {
                    ...
                    this.apiService.post("HoanTra/TuChoiDuyetHoanTraDuocPham", this.tuChoiDuyetHoanTraDuocPham).subscribe(res => {
...
DuyetHoanTraDuocPhamChiTietComponent.ctorParameters = () => [
...
let DuyetHoanTraDuocPhamListComponent = class DuyetHoanTraDuocPhamListComponent {
    constructor(dialog, elem, router, route, cd, location, authService, notificationService, apiService) {
        this.dialog = dialog;
        this.elem = elem;
        this.router = router;
        this.route = route;
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('HoanTra/ExportDuyetHoanTraDuocPham', self.gridCha._gridQueryInfo).subscribe(resultData => {
...
DuyetHoanTraDuocPhamListComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] },
...
let DuyetHoanTraDuocPhamRoutingModule = class DuyetHoanTraDuocPhamRoutingModule {
};
...
let DuyetHoanTraDuocPhamModule = class DuyetHoanTraDuocPhamModule {
};
...
let DuyetHoanTraDuocPhamService = class DuyetHoanTraDuocPhamService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'HoanTra';
    }
};
DuyetHoanTraDuocPhamService.ctorParameters = () => [
...
let InPhieuHoanTraCompoment = class InPhieuHoanTraCompoment {
...
InPhieuHoanTraCompoment.ctorParameters = () => [
...
let TuChoiDuyetHoanTraDuocPhamComponent = class TuChoiDuyetHoanTraDuocPhamComponent {
...
TuChoiDuyetHoanTraDuocPhamComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
