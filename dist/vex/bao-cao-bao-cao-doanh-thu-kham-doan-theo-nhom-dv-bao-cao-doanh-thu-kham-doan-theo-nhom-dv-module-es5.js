...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-doanh-thu-kham-doan-theo-nhom-dv-bao-cao-doanh-thu-kham-doan-theo-nhom-dv-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDoanhThuKhamDoanTheoNhomDvListComponent = /** @class */ (function () {
                function BaoCaoDoanhThuKhamDoanTheoNhomDvListComponent(apiService, dialog, authService, notificationService) {
                ...
                BaoCaoDoanhThuKhamDoanTheoNhomDvListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoDoanhThuKhamDoanTheoNhomDvListComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                BaoCaoDoanhThuKhamDoanTheoNhomDvListComponent.prototype.XemBaoCao = function () {
                ...
                //   });
                // }
                BaoCaoDoanhThuKhamDoanTheoNhomDvListComponent.prototype.getTongCong = function (queryInfo) {
                    var _this = this;
                    this.apiService.post("BaoCao/GetTongCongDoanhThuKhamDoanTheoNhomDichVu", queryInfo).subscribe(function (resultData) {
                        _this.sumKhamBenh = resultData.KhamBenh;
                        _this.sumXetNghiem = resultData.XetNghiem;
                        _this.sumNoiSoi = resultData.NoiSoi;
                        _this.sumNoiSoiTMH = resultData.NoiSoiTMH;
                        _this.sumSieuAm = resultData.SieuAm;
                        _this.sumXQuang = resultData.XQuang;
                        _this.sumCTScan = resultData.CTScan;
                        _this.sumMRI = resultData.MRI;
                        _this.sumDienTimDienNao = resultData.DienTimDienNao;
                        _this.sumDoLoangXuong = resultData.TDCNDoLoangXuong;
                        _this.sumDVKhac = resultData.DVKhac;
                        _this.sumTongTien = resultData.Total;
                    }, function (err) {
                ...
                return BaoCaoDoanhThuKhamDoanTheoNhomDvListComponent;
            }());
            BaoCaoDoanhThuKhamDoanTheoNhomDvListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDoanhThuKhamDoanTheoNhomDvRoutingModule = /** @class */ (function () {
                function BaoCaoDoanhThuKhamDoanTheoNhomDvRoutingModule() {
                }
                return BaoCaoDoanhThuKhamDoanTheoNhomDvRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoDoanhThuKhamDoanTheoNhomDVSearch = /** @class */ (function () {
                function BaoCaoDoanhThuKhamDoanTheoNhomDVSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, SearchString, Hosting) {
                ...
                return BaoCaoDoanhThuKhamDoanTheoNhomDVSearch;
            }());
            var DoanhThuKhamDoanTheoNhomDV = /** @class */ (function () {
                function DoanhThuKhamDoanTheoNhomDV(STT, Ten, DVT, SLTonDauKy, ThanhTienTonDauKy, SLNhapTrongKy, ThanhTienNhapTrongKy, SLXuatTrongKy, ThanhTienXuatTrongKy, SLTonCuoiKy, Gia, ThanhTien) {
                ...
                return DoanhThuKhamDoanTheoNhomDV;
            }());
            var InBaoCaoDoanhThuKhamDoanTheoNhomDV = /** @class */ (function () {
                function InBaoCaoDoanhThuKhamDoanTheoNhomDV(KhoId, HostingName, FromDate, ToDate) {
                ...
                return InBaoCaoDoanhThuKhamDoanTheoNhomDV;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDoanhThuKhamDoanTheoNhomDvModule = /** @class */ (function () {
                function BaoCaoDoanhThuKhamDoanTheoNhomDvModule() {
                }
                return BaoCaoDoanhThuKhamDoanTheoNhomDvModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDoanhThuKhamDoanTheoNhomDvService = /** @class */ (function (_super) {
                __extends(BaoCaoDoanhThuKhamDoanTheoNhomDvService, _super);
                function BaoCaoDoanhThuKhamDoanTheoNhomDvService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoDoanhThuKhamDoanTheoNhomDvService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoDoanhThuKhamDoanTheoNhomDvService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-kham-doan-theo-nhom-dv-bao-cao-doanh-thu-kham-doan-theo-nhom-dv-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-kham-doan-theo-nhom-dv-bao-cao-doanh-thu-kham-doan-theo-nhom-dv-module-es5.js.map