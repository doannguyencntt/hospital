...
let BangKeThuocVaVatTuPhauThuatListComponent = class BangKeThuocVaVatTuPhauThuatListComponent {
    constructor(apiService, dialog, authService, notificationService, cdref) {
    ...
    getDataPhong() {
        let queryInfo = new src_app_shared_models_common_model__WEBPACK_IMPORTED_MODULE_14__["LookupQueryInfo"]();
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCaoBangKeThuocVaVatTuPhauThuat/GetDataForGridAsync", this.baoCaoSearch).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                ...
                this.gridView = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_12__["process"])(this.dataSource.data, { group: this.groups });
                this.gridView.total = this.dataSource.total;
        ...
        switch (field) {
            case 'ThanhTien':
                if (this.danhSachThuocVaVatTuPhauThuat != undefined && this.danhSachThuocVaVatTuPhauThuat != null) {
                    return this.danhSachThuocVaVatTuPhauThuat.reduce((sum, item) => sum + item.ThanhTien, 0);
                }
        }
    }
};
BangKeThuocVaVatTuPhauThuatListComponent.ctorParameters = () => [
...
let BangKeThuocVatTuRoutingModule = class BangKeThuocVatTuRoutingModule {
};
...
class BangKeThuocVatTuSearch {
    constructor(FromDate = null, ToDate = null, TuNgay = null, DenNgay = null, PhongBenhVienId = 0, MaYeuCauTiepNhan = null, 
    //BVHD-3860
    BangKeThuocPhi = new PhiBangKeThuoc(), Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
class ThongTinBenhNhanPhauThuatQueryInfo {
    constructor(PhongBenhVienId = 0, TuNgay = null, DenNgay = null) {
        this.PhongBenhVienId = PhongBenhVienId;
        this.TuNgay = TuNgay;
        this.DenNgay = DenNgay;
    }
}
class ThongTinBenhNhanLookupItemVo {
    constructor(KeyId = 0, DisplayName = null, MaYeuCauTiepNhan = null, MaBN = null, MaBA = null) {
        this.KeyId = KeyId;
...
class PhongPTLookupItemVo {
    constructor(KeyId = 0, DisplayName = null) {
        this.KeyId = KeyId;
        this.DisplayName = DisplayName;
    }
}
class DanhSachThuocVaVatTuPhauThuat {
    constructor(STT = null, Loai = null, Nhom = null, TenDichVu = null, SoChungTu = null, HamLuongNoiSanXuat = null, DonViTinh = null, SoLuong = null, DonGia = 0, ThanhTien = 0) {
        this.STT = STT;
        this.Loai = Loai;
        this.Nhom = Nhom;
...
//BVHD-3860
class PhiBangKeThuoc {
    constructor(TinhPhi = true, KhongTinhPhi = false) {
...
let BangKeThuocVatTuPTModule = class BangKeThuocVatTuPTModule {
};
...
let BaoCaoBangKeThuocVaVatTuPhauThuatService = class BaoCaoBangKeThuocVaVatTuPhauThuatService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCaoBangKeThuocVaVatTuPhauThuat';
    }
};
BaoCaoBangKeThuocVaVatTuPhauThuatService.ctorParameters = () => [
