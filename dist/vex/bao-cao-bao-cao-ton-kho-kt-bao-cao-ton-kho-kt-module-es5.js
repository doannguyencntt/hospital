...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-ton-kho-kt-bao-cao-ton-kho-kt-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTonKhoKtListComponent = /** @class */ (function () {
                function BaoCaoTonKhoKtListComponent(apiService, dialog, authService, notificationService) {
                ...
                BaoCaoTonKhoKtListComponent.prototype.pageChange = function (event) {
                    this.baoCaoSearch.Skip = event.skip;
                    this.skip = event.skip;
                    //this.XemBaoCao();
                };
                BaoCaoTonKhoKtListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoTonKhoKtListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoTonKhoKtListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoTonKhoKtListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoTonKhoKtListComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoTonKhoKtListComponent.prototype.detailExpand = function (event) {
                ...
                BaoCaoTonKhoKtListComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                BaoCaoTonKhoKtListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                    ...
                    this.apiService.post("BaoCao/GetDataBaoCaoTonKhoKTForGridAsync", this.baoCaoSearch).subscribe(function (resultData) {
                ...
                //   });
                // }
                BaoCaoTonKhoKtListComponent.prototype.changeValueStart = function () {
                ...
                return BaoCaoTonKhoKtListComponent;
            }());
            BaoCaoTonKhoKtListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTonKhoKtRoutingModule = /** @class */ (function () {
                function BaoCaoTonKhoKtRoutingModule() {
                }
                return BaoCaoTonKhoKtRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoTonKhoKTSearch = /** @class */ (function () {
                function BaoCaoTonKhoKTSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, KhoId, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                ...
                return BaoCaoTonKhoKTSearch;
            }());
            var BaoCaoTonKhoKT = /** @class */ (function () {
                function BaoCaoTonKhoKT(STT, Ten, DVT, SLTonDauKy, ThanhTienTonDauKy, SLNhapTrongKy, ThanhTienNhapTrongKy, SLXuatTrongKy, ThanhTienXuatTrongKy, SLTonCuoiKy, Gia, ThanhTien) {
                ...
                return BaoCaoTonKhoKT;
            }());
            var InBaoCaoTonKhoKT = /** @class */ (function () {
                function InBaoCaoTonKhoKT(KhoId, HostingName, FromDate, ToDate) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTonKhoKtModule = /** @class */ (function () {
                function BaoCaoTonKhoKtModule() {
                }
                return BaoCaoTonKhoKtModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTonKhoKtService = /** @class */ (function (_super) {
                __extends(BaoCaoTonKhoKtService, _super);
                function BaoCaoTonKhoKtService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoTonKhoKtService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoTonKhoKtService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-ton-kho-kt-bao-cao-ton-kho-kt-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-ton-kho-kt-bao-cao-ton-kho-kt-module-es5.js.map