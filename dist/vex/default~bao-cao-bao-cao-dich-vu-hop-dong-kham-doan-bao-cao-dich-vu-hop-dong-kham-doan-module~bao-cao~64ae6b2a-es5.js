(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~bao-cao-bao-cao-dich-vu-hop-dong-kham-doan-bao-cao-dich-vu-hop-dong-kham-doan-module~bao-cao~64ae6b2a"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuCanLamSangRoutingModule = /** @class */ (function () {
                function LichSuCanLamSangRoutingModule() {
                }
                return LichSuCanLamSangRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuCanLamSangModule = /** @class */ (function () {
                function LichSuCanLamSangModule() {
                }
                return LichSuCanLamSangModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var LichSuCanLamSang = /** @class */ (function () {
                function LichSuCanLamSang(TimKiem, TuNgay, DenNgay, FromDate, ToDate) {
            ...
            var ThongTinBenhNhan = /** @class */ (function () {
                function ThongTinBenhNhan(Id, MaYeuCauTiepNhan, BenhNhanId, MaBN, HoTen, NgaySinh, ThangSinh, NamSinh, Tuoi, SoBenhAn, TenGioiTinh, GioiTinhStr, DiaChi, SoDienThoai, Email, DoiTuongUuDai, CongTyUuDai, BHYTMaSoThe, BHYTngayHieuLuc, BHYTNgayHetHan, BHYTDiaChi, BHYTMucHuong, TuyenKham, TenGiayChuyenVien, CongTyUuDaiId, NgayHieuLucStr, NgayHetHanStr, GiayChuyenVienId, DuocHuongBHYT, CoBHYT, DoiTuong, BHYTgiayMienCungChiTraId, TenGiayMiemCungTriTra, 
                //BVHD-3800
                LaCapCuu) {
                    if (Id === void 0) { Id = 0; }
                    ...
                    if (GioiTinhStr === void 0) { GioiTinhStr = null; }
            ...
            var ListDanhSachCanLamSang = /** @class */ (function () {
                function ListDanhSachCanLamSang(DanhSachCanLamSangs) {
                    if (DanhSachCanLamSangs === void 0) { DanhSachCanLamSangs = []; }
                    this.DanhSachCanLamSangs = DanhSachCanLamSangs;
                }
                return ListDanhSachCanLamSang;
            }());
            var ThongTinCanLamSang = /** @class */ (function () {
                function ThongTinCanLamSang(DichVuKyhuatId, TenDichVu, GhiChu, LoaiYeuCauKyThuat, GiayKetQuaLamSang) {
                    if (DichVuKyhuatId === void 0) { DichVuKyhuatId = 0; }
                    if (TenDichVu === void 0) { TenDichVu = null; }
                    if (GhiChu === void 0) { GhiChu = null; }
                    if (LoaiYeuCauKyThuat === void 0) { LoaiYeuCauKyThuat = 0; }
                    if (GiayKetQuaLamSang === void 0) { GiayKetQuaLamSang = []; }
                ...
                return ThongTinCanLamSang;
            }());
            var GiayKetQuaLamSang = /** @class */ (function () {
                function GiayKetQuaLamSang(Id, Ma, Ten, TenGuid, DuongDan, MoTa, KichThuoc, LoaiTapTin) {
                    if (Id === void 0) { Id = 0; }
                ...
                return GiayKetQuaLamSang;
            }());
            var CanLamSangLichSuTimKiem = /** @class */ (function () {
                function CanLamSangLichSuTimKiem(SearchString, TuNgayDenNgay) {
                    if (SearchString === void 0) { SearchString = null; }
                    if (TuNgayDenNgay === void 0) { TuNgayDenNgay = new CanLamSangLichSuTimKiemDateRange(); }
                    this.SearchString = SearchString;
                    this.TuNgayDenNgay = TuNgayDenNgay;
                }
                return CanLamSangLichSuTimKiem;
            }());
            var CanLamSangLichSuTimKiemDateRange = /** @class */ (function () {
                function CanLamSangLichSuTimKiemDateRange(startDate, endDate, TuNgay, DenNgay) {
                ...
                return CanLamSangLichSuTimKiemDateRange;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuDanhSachCanLamSangComponent = /** @class */ (function () {
                function LichSuDanhSachCanLamSangComponent(router, authService, dialog, apiService, notificationService, route, location) {
                    this.router = router;
                ...
                LichSuDanhSachCanLamSangComponent.prototype.ngOnInit = function () {
                ...
                LichSuDanhSachCanLamSangComponent.prototype.searchChange = function (event) {
                    if ((event == null || event == "") && this.strAdditionalSearchString != "") {
                        this.timKiemNangCao();
                    }
                };
                LichSuDanhSachCanLamSangComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiemNangCao();
                    }
                };
                LichSuDanhSachCanLamSangComponent.prototype.clearSearch = function () {
                    this.timKiemObj.SearchString = null;
                    this.gridChild.searchString = null;
                    this.timKiemNangCao();
                };
                LichSuDanhSachCanLamSangComponent.prototype.timKiemNangCao = function () {
                ...
                LichSuDanhSachCanLamSangComponent.prototype.view = function (id) {
                ...
                LichSuDanhSachCanLamSangComponent.prototype.exportExcel = function () {
                    var self = this;
                ...
                LichSuDanhSachCanLamSangComponent.prototype.showPopupLoadingData = function () {
                ...
                LichSuDanhSachCanLamSangComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return LichSuDanhSachCanLamSangComponent;
            }());
            LichSuDanhSachCanLamSangComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongTinLichSuChiTietComponent = /** @class */ (function () {
                function ThongTinLichSuChiTietComponent(route, baseService, router, apiService, dialog, location, notificationService, authService, http) {
                    this.route = route;
                ...
                ThongTinLichSuChiTietComponent.prototype.ngOnInit = function () {
                ...
                ThongTinLichSuChiTietComponent.prototype.showPopupLoadingData = function () {
                ...
                ThongTinLichSuChiTietComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                ThongTinLichSuChiTietComponent.prototype.BackToList = function () {
                    this.location.back();
                };
                ThongTinLichSuChiTietComponent.prototype.getThongTinYeuCauBenhNhan = function (id) {
                    var _this = this;
                    this.showPopupLoadingData();
                    this.baseService.getById(id).subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.thongTinBenhNhan = resultData;
                            if (_this.thongTinBenhNhan.NamSinh != null &&
                                _this.thongTinBenhNhan.ThangSinh != null &&
                                _this.thongTinBenhNhan.NgaySinh != null) {
                                var ngaySinh = new Date(_this.thongTinBenhNhan.ThangSinh +
                                    "/" +
                                    _this.thongTinBenhNhan.NgaySinh +
                                    "/" +
                                    _this.thongTinBenhNhan.NamSinh +
                                    "/");
                ...
                ThongTinLichSuChiTietComponent.prototype.getAge = function (date_1, date_2) {
                ...
                ThongTinLichSuChiTietComponent.prototype.DaysInMonth = function (date2_UTC) {
                    var monthStart = new Date(date2_UTC.getFullYear(), date2_UTC.getMonth(), 1);
                    var monthEnd = new Date(date2_UTC.getFullYear(), date2_UTC.getMonth() + 1, 1);
                    var monthLength = (monthEnd - monthStart) / (1000 * 60 * 60 * 24);
                    return monthLength;
                };
                ThongTinLichSuChiTietComponent.prototype.taiFileChuKy = function (dataItem) {
                    var _this = this;
                    this.showPopupLoadingData();
                    ...
                    this.apiService
                        ...
                        var options = new _angular_http__WEBPACK_IMPORTED_MODULE_15__["RequestOptions"]({ responseType: _angular_http__WEBPACK_IMPORTED_MODULE_15__["ResponseContentType"].Blob });
                        _this.http.get(resp, options).subscribe(function (res) {
                ...
                ThongTinLichSuChiTietComponent.prototype.xemKetQua = function (dataItem) {
                    var _this = this;
                    var obj = {
                        "Id": dataItem.Id,
                        "HostingName": window.location.protocol + "//" + window.location.host
                    };
                    this.apiService.post("CanLamSang/XuLyInPhieuKetQua", obj).subscribe(function (res) {
                        _this.closePopupLoadingData();
                        _this.dialog.open(_danh_sach_ket_qua_can_lam_sang_ket_qua_cdha_tdcn_in_phieu_popup_ket_qua_cdha_tdcn_in_phieu_popup_component__WEBPACK_IMPORTED_MODULE_17__["KetQuaCdhaTdcnInPhieuPopupComponent"], {
                            disableClose: false,
                            width: '1200px',
                            data: { res: res, yeuCauDVKyThuatId: dataItem.Id, dichVuKyThuatBenhVienId: dataItem.Id },
                ...
                ThongTinLichSuChiTietComponent.prototype.getThongTinCanLamSang = function (id) {
                ...
                ThongTinLichSuChiTietComponent.prototype.xemTaiLieu = function (dataItem) {
                    var _this = this;
                    this.showPopupLoadingData();
                    var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpParams"]({
                        fromObject: {
                ...
                ThongTinLichSuChiTietComponent.prototype.keyEvent = function (event) {
                ...
                ThongTinLichSuChiTietComponent.prototype.ViewImagePDF = function (dataItem) {
                ...
                return ThongTinLichSuChiTietComponent;
            }());
            ThongTinLichSuChiTietComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ViewImagePdfListClsComponent = /** @class */ (function () {
                function ViewImagePdfListClsComponent(data, sanitizer, apiService, dialog, http, dialogRef) {
                    this.data = data;
                ...
                ViewImagePdfListClsComponent.prototype.ngOnInit = function () {
                ...
                ViewImagePdfListClsComponent.prototype.setDataGridView = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                ViewImagePdfListClsComponent.prototype.ViewImagePDF = function (thongTinAnh) {
                    var _this = this;
                    ...
                    this.apiService
                        ...
                        if (result) {
                            if (thongTinAnh.TenGuid.indexOf(".pdf") != -1 ||
                                ...
                                _this.dialog.open(src_app_shared_component_dialogs_view_image_pdf_view_image_pdf_component__WEBPACK_IMPORTED_MODULE_6__["ViewImagePdfComponent"], {
                                    disableClose: true,
                                    width: '1000px',
                                    height: '600px',
                                    data: {
                ...
                ViewImagePdfListClsComponent.prototype.downloadFile = function (dataItem) {
                    var _this = this;
                    var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]({
                        fromObject: {
                            tenGuid: dataItem.TenGuid,
                    ...
                    this.apiService
                        ...
                        var options = new _angular_http__WEBPACK_IMPORTED_MODULE_10__["RequestOptions"]({ responseType: _angular_http__WEBPACK_IMPORTED_MODULE_10__["ResponseContentType"].Blob });
                ...
                ViewImagePdfListClsComponent.prototype.downloadFileAll = function (dataItem) {
                    var _this = this;
                ...
                ViewImagePdfListClsComponent.prototype.close = function (data) {
                    this.dialogRef.close(data);
                };
                return ViewImagePdfListClsComponent;
            }());
            ViewImagePdfListClsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XemKetQuaCdhaTdcnPopupComponent = /** @class */ (function () {
                function XemKetQuaCdhaTdcnPopupComponent(data, dialog, apiService, notificationService) {
                    this.data = data;
                    this.dialog = dialog;
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                ...
                XemKetQuaCdhaTdcnPopupComponent.prototype.ngOnInit = function () {
                    this.getHtml();
                };
                XemKetQuaCdhaTdcnPopupComponent.prototype.getHtml = function () {
                    var _this = this;
                    this.showPopupLoadingData();
                    var obj = {
                        "Id": this.data,
                ...
                XemKetQuaCdhaTdcnPopupComponent.prototype.getFilePDFFromHtml = function (html) {
                    var _this = this;
                    var obj = {
                        "Html": html,
                        "TenFile": "KetQuaCDHATDCN"
                    };
                    this.apiService.postExportPdf('CanLamSang/GetFilePDFFromHtml', obj).subscribe(function (file) {
                ...
                XemKetQuaCdhaTdcnPopupComponent.prototype.downloadFile = function () {
                    var dateTimeNow = new Date();
                ...
                XemKetQuaCdhaTdcnPopupComponent.prototype.showPopupLoadingData = function () {
                    if (this.popupLoadingData == undefined
                        || this.popupLoadingData == null
                        || this.popupLoadingData.openDialogs == undefined
                        || (this.popupLoadingData.openDialogs != undefined && this.popupLoadingData.openDialogs.length == 0)) {
                ...
                XemKetQuaCdhaTdcnPopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                return XemKetQuaCdhaTdcnPopupComponent;
            }());
            XemKetQuaCdhaTdcnPopupComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=default~bao-cao-bao-cao-dich-vu-hop-dong-kham-doan-bao-cao-dich-vu-hop-dong-kham-doan-module~bao-cao~64ae6b2a-es5.js.map
//# sourceMappingURL=default~bao-cao-bao-cao-dich-vu-hop-dong-kham-doan-bao-cao-dich-vu-hop-dong-kham-doan-module~bao-cao~64ae6b2a-es5.js.map