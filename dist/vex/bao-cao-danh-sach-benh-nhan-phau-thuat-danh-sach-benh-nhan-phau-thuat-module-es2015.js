...
let DanhSachBenhNhanPhauThuatListComponent = class DanhSachBenhNhanPhauThuatListComponent {
    ...
    renderDescendantBody(parent, data) {
        let result = '';
        const init = '<tr>';
        const finish = '</tr>';
        result += init;
    ...
    GetDataByGivenField(field, data) {
        switch (field) {
            case 'Bhyt': {
    ...
    GetDatasource() {
        ...
        this.apiService.post('DanhSachBenhNhanPhauThuat/GetDataForGridAsync', this.queryInfo).subscribe(resultData => {
            if (resultData) {
                this.gridDataSource.data = [...resultData.Data];
                this.isLoading = false;
            }
        });
        this.apiService.post('DanhSachBenhNhanPhauThuat/GetTotalPageForGridAsync', this.queryInfo).subscribe(resultData => {
            if (resultData) {
    ...
    getSharedPrintForm() {
        return new Promise(resolve => {
            this.apiService.post('BaoCaoDanhSachBenhNhanPhauThuat/InDanhMucDaHetHan', this.searchQuery).subscribe(resultData => {
                resolve(resultData);
            });
        });
    }
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel('BaoCaoDanhSachBenhNhanPhauThuat/ExportBaoCaoDanhSachBenhNhanPhauThuat', this.queryInfo).subscribe(resultData => {
...
DanhSachBenhNhanPhauThuatListComponent.ctorParameters = () => [
...
let DanhSachBenhNhanPhauThuatRoutingModule = class DanhSachBenhNhanPhauThuatRoutingModule {
};
...
class DanhSachBenhNhanPhauThuatVo {
    constructor(Id = null, Bhyt = null, DichVu = null, Goi = null, Ksk = null, KskDoan = null, SoLanCapCuu = null, SoNgayDieuTriNgoaiTru = null, SoNguoiBenhChuyenVien = null, SoNguoiBenhDieuTriNgoaiTru = null, SoNguoiBenhVaoVien = null, TongSo = null, TreEm = null, VienPhi = null) {
        this.Id = Id;
        this.Bhyt = Bhyt;
        this.DichVu = DichVu;
        this.Goi = Goi;
...
class QueryInfo {
    constructor(skip, take, pageSize, searchString, additionalSearchString) {
        this.skip = skip;
        this.take = take;
...
let DanhSachBenhNhanPhauThuatModule = class DanhSachBenhNhanPhauThuatModule {
};
...
let DanhSachBenhNhanPhauThuatService = class DanhSachBenhNhanPhauThuatService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DanhSachBenhNhanPhauThuat';
    }
};
DanhSachBenhNhanPhauThuatService.ctorParameters = () => [
