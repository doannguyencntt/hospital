...
let BaoCaoHoatDongClsListComponent = class BaoCaoHoatDongClsListComponent {
    constructor(apiService, dialog, notificationService, authService, baseService, cd) {
    ...
    XemBaoCao() {
        ...
        this.apiService.post(this.path, this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoHoatDongClsListComponent.ctorParameters = () => [
...
let BaoCaoHoatDongClsRoutingModule = class BaoCaoHoatDongClsRoutingModule {
};
...
class BaoCaoHoatDongClsSearch {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, MauId = null, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
let BaoCaoHoatDongClsModule = class BaoCaoHoatDongClsModule {
};
