...
let BaoCaoSoPhucTrinhPhauThuatThuThuatListComponent = class BaoCaoSoPhucTrinhPhauThuatThuThuatListComponent {
    constructor(apiService, notificationService, dialog, authService, cd) {
    ...
    XemBaoCao(isChagePage = false) {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoSoPhucTrinhPhauThuatThuThuatForGridAsync", this.queryInfo).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                ...
                this._isLoading = false;
                this.apiService.post("BaoCao/GetTotalPageBaoCaoSoPhucTrinhPhauThuatThuThuatForGridAsync", this.queryInfo).subscribe(resultDataTotal => {
...
BaoCaoSoPhucTrinhPhauThuatThuThuatListComponent.ctorParameters = () => [
...
let BaoCaoSoPhucTrinhPhauThuatThuThuatRoutingModule = class BaoCaoSoPhucTrinhPhauThuatThuThuatRoutingModule {
};
...
let BaoCaoSoPhucTrinhPhauThuatThuThuatModule = class BaoCaoSoPhucTrinhPhauThuatThuThuatModule {
};
...
let BaoCaoSoPhucTrinhPhauThuatThuThuatService = class BaoCaoSoPhucTrinhPhauThuatThuThuatService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoSoPhucTrinhPhauThuatThuThuatService.ctorParameters = () => [
...
class BaoCaoSoPhucTrinhPhauThuatThuThuatSearch {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, KhoaId = null, 
    //BVHD-3636
    KhoaPhongIds = [], NoiThucHienIds = [], LaPhauThuat = true, LaThuThuat = true, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
class BaoCaoSoPhucTrinhPhauThuatThuThuat {
...
class InBaoCaoSoPhucTrinhPhauThuatThuThuat {
