...
let BaoCaoXuatNhapTonVtListComponent = class BaoCaoXuatNhapTonVtListComponent {
    ...
    XemBaoCao() {
        ...
        this.baoCaoSearch.FromDate = this.baoCaoSearch.TuNgayFormat;
        this.baoCaoSearch.ToDate = this.baoCaoSearch.DenNgayFormat;
        this.apiService.post("BaoCao/GetDataBaoCaoXuatNhapTonVTForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoXuatNhapTonVtListComponent.ctorParameters = () => [
...
let BaoCaoXuatNhapTonVtPopupComponent = class BaoCaoXuatNhapTonVtPopupComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BaoCaoXuatNhapTonVtRoutingModule = class BaoCaoXuatNhapTonVtRoutingModule {
};
...
class BaoCaoXuatNhapTonSearchVT {
...
let BaoCaoXuatNhapTonVtModule = class BaoCaoXuatNhapTonVtModule {
};
...
let BaoCaoXuatNhapTonVtService = class BaoCaoXuatNhapTonVtService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoXuatNhapTonVtService.ctorParameters = () => [
