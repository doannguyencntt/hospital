...
let DSBaoCaoHoatDongNoiTruChiTietRoutingModule = class DSBaoCaoHoatDongNoiTruChiTietRoutingModule {
};
...
let BaoCaoHoatDongNoiTruChiTietModule = class BaoCaoHoatDongNoiTruChiTietModule {
};
...
class BaoCaoHoatDongNoiTruChiTiet {
...
let DanhSachBaoCaoHoatDongNoiTruChiTietComponent = class DanhSachBaoCaoHoatDongNoiTruChiTietComponent {
    ...
    xemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoHoatDongNoiTruChiTietForGrid", this.baoCaoSearch).subscribe(resultData => {
...
DanhSachBaoCaoHoatDongNoiTruChiTietComponent.ctorParameters = () => [
