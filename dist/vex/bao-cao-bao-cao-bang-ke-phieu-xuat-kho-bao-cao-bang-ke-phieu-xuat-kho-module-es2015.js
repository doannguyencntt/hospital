...
class BaoCaoBangKePhieuXuatKhoSearch {
...
class BaoCaoBangKePhieuXuatKho {
    constructor(STT = null, Ten = null, DVT = null, SoLuong = 0, Gia = 0, ThanhTien = 0) {
        this.STT = STT;
        this.Ten = Ten;
        this.DVT = DVT;
...
class InBaoCaoBangKePhieuXuatKho {
...
let BaoCaoBangKePhieuXuatKhoListComponent = class BaoCaoBangKePhieuXuatKhoListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoBangKePhieuXuatKhoForGridAsync", this.baoCaoSearch).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                this.dataToSumAllThanhTien = resultData.Data.reduce((sum, item) => sum + item.ThanhTien, 0);
                this.dataSource = {
...
BaoCaoBangKePhieuXuatKhoListComponent.ctorParameters = () => [
...
let BaoCaoBangKePhieuXuatKhoRoutingModule = class BaoCaoBangKePhieuXuatKhoRoutingModule {
};
...
let BaoCaoBangKePhieuXuatKhoModule = class BaoCaoBangKePhieuXuatKhoModule {
};
...
let BaoCaoBangKePhieuXuatKhoService = class BaoCaoBangKePhieuXuatKhoService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoBangKePhieuXuatKhoService.ctorParameters = () => [
