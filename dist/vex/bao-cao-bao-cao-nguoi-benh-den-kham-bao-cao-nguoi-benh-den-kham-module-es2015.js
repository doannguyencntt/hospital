...
let BaoCaoNguoiBenhDenKhamListComponent = class BaoCaoNguoiBenhDenKhamListComponent {
    ...
    XemBaoCao(isChagePage = false) {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoNguoiBenhDenKhamForGrid", this.queryInfo).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                ...
                this._isLoading = false;
                this.apiService.post("BaoCao/GetTotalBaoCaoNguoiBenhDenKhamForGrid", this.queryInfo).subscribe(resultDataTotal => {
...
BaoCaoNguoiBenhDenKhamListComponent.ctorParameters = () => [
...
let BaoCaoNguoiBenhDenKhamRoutingModule = class BaoCaoNguoiBenhDenKhamRoutingModule {
};
...
class BaoCaoNguoiBenhDenKhamTimKiemNangCao {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, SearchString = "", Skip = 0, Take = 50) {
...
let BaoCaoNguoiBenhDenKhamModule = class BaoCaoNguoiBenhDenKhamModule {
};
