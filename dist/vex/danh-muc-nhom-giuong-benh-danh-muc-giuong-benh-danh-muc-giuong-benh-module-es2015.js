...
let DanhMucGiuongBenhCreateComponent = class DanhMucGiuongBenhCreateComponent {
...
DanhMucGiuongBenhCreateComponent.ctorParameters = () => [
...
let DanhMucGiuongBenhListComponent = class DanhMucGiuongBenhListComponent {
    constructor(authService, router, dialog, notificationService, apiService) {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("GiuongBenh/ExportGiuongBenh", this.gridChild._gridQueryInfo).subscribe(res => {
...
DanhMucGiuongBenhListComponent.ctorParameters = () => [
...
let DanhMucGiuongBenhRoutingModule = class DanhMucGiuongBenhRoutingModule {
};
...
let DanhMucGiuongBenhSharedComponent = class DanhMucGiuongBenhSharedComponent {
    constructor(route, baseService, apiService, dialog, notificationService, authService) {
        this.route = route;
...
DanhMucGiuongBenhSharedComponent.ctorParameters = () => [
...
let DanhMucGiuongBenhUpdateComponent = class DanhMucGiuongBenhUpdateComponent {
...
DanhMucGiuongBenhUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
class DanhMucGiuongBenh {
}
class GiuongBenhSearch {
    constructor(KhoaId = null, PhongId = null, SearchValue = null) {
        this.KhoaId = KhoaId;
        this.PhongId = PhongId;
        this.SearchValue = SearchValue;
    }
}
class GiuongBenhViewModel {
    constructor(KhoaId = null, PhongBenhVienId = null, MoTa = null, Ten = null, Ma = null, CoHieuLuc = true, LaGiuongNoi = false) {
        this.KhoaId = KhoaId;
...
let DanhMucGiuongBenhModule = class DanhMucGiuongBenhModule {
};
...
let DanhMucGiuongBenhService = class DanhMucGiuongBenhService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'GiuongBenh';
    }
};
DanhMucGiuongBenhService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
