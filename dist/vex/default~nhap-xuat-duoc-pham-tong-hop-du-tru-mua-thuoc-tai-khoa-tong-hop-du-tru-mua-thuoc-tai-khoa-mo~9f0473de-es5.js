(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~nhap-xuat-duoc-pham-tong-hop-du-tru-mua-thuoc-tai-khoa-tong-hop-du-tru-mua-thuoc-tai-khoa-mo~9f0473de"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachDuTruMuaThuocComponent = /** @class */ (function () {
                function DanhSachDuTruMuaThuocComponent(dialog, router, apiService, authService, notificationService, route, location) {
                    this.dialog = dialog;
                    this.router = router;
                ...
                DanhSachDuTruMuaThuocComponent.prototype.ngOnInit = function () {
                ...
                DanhSachDuTruMuaThuocComponent.prototype.backWithSearch = function () {
                ...
                DanhSachDuTruMuaThuocComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                DanhSachDuTruMuaThuocComponent.prototype.clearSearch = function () {
                    this.danhSachYeuCauMuaThuoc.SearchString = null;
                    this.gridChild.search();
                };
                DanhSachDuTruMuaThuocComponent.prototype.searchChanges = function (event) {
                    var self = this;
                ...
                DanhSachDuTruMuaThuocComponent.prototype.trangThaiCheckBox = function (event, tinhTrang) {
                ...
                DanhSachDuTruMuaThuocComponent.prototype.timKiem = function () {
                ...
                DanhSachDuTruMuaThuocComponent.prototype.taoPhieuMuaThuoc = function () {
                ...
                DanhSachDuTruMuaThuocComponent.prototype.chinhSua = function (id) {
                ...
                DanhSachDuTruMuaThuocComponent.prototype.xoa = function (id) {
                    var _this = this;
                    var self = this;
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Delete)) {
                                _this.apiService.post("YeuCauMuaDuocPham/XoaYeuCauMuaDuTru?id=" + id).subscribe(function () {
                ...
                DanhSachDuTruMuaThuocComponent.prototype.inPhieu = function (id, loai) {
                    var self = this;
                    self.loadingPage();
                ...
                DanhSachDuTruMuaThuocComponent.prototype.loadingPage = function () {
                ...
                DanhSachDuTruMuaThuocComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                DanhSachDuTruMuaThuocComponent.prototype.XuatExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("YeuCauMuaDuocPham/ExportYeuCauMuaDuocPham", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                DanhSachDuTruMuaThuocComponent.prototype.changeNgayBatDauRange = function () {
                    this.timKiem();
                };
                DanhSachDuTruMuaThuocComponent.prototype.blur = function () {
                    this.timKiem();
                };
                return DanhSachDuTruMuaThuocComponent;
            }());
            DanhSachDuTruMuaThuocComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GuiPhieuMuaDuocPhamConfirmComponent = /** @class */ (function () {
                function GuiPhieuMuaDuocPhamConfirmComponent(dialogRef, data) {
                ...
                GuiPhieuMuaDuocPhamConfirmComponent.prototype.ngOnInit = function () {
                    this.Title = this.data.Title;
                    this.Message = this.data.Message;
                };
                GuiPhieuMuaDuocPhamConfirmComponent.prototype.close = function (result) {
                    this.dialogRef.close(result);
                };
                return GuiPhieuMuaDuocPhamConfirmComponent;
            }());
            GuiPhieuMuaDuocPhamConfirmComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LapPhieuMuaDuocPhamGuiLaiComponent = /** @class */ (function () {
                function LapPhieuMuaDuocPhamGuiLaiComponent(apiService, dialog, notificationService, authService, router, route, ref, location) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.ngOnInit = function () {
                ...
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.GetTrangThaiPhieuMuaDuTru = function (id) {
                    var _this = this;
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].View)) {
                        self.apiService.get("YeuCauMuaDuocPham/GetTrangThaiPhieuDuocPhamDuTru?phieuMuaDuocPhamId=" + id).subscribe(function (result) {
                ...
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.savingPage = function () {
                ...
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.closePopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.loadingPage = function () {
                ...
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.guiLaiPhieuMuaThuoc = function () {
                    var self = this;
                    self.dialog.open(_gui_phieu_mua_duoc_pham_confirm_gui_phieu_mua_duoc_pham_confirm_component__WEBPACK_IMPORTED_MODULE_17__["GuiPhieuMuaDuocPhamConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            ...
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                                self.savingPage();
                                self.apiService.post("YeuCauMuaDuocPham/GuiLaiPhieuMuaDuocPhamDuTru", self.yeuCauMuaThuoc).subscribe(function (result) {
                ...
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.inPhieuMuaThuoc = function () {
                    var self = this;
                ...
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.anHienButtonDuyet = function (event) {
                    if (event) {
                ...
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.cancel = function () {
                    this.location.back();
                };
                LapPhieuMuaDuocPhamGuiLaiComponent.prototype.keyEvent = function (event) {
                ...
                return LapPhieuMuaDuocPhamGuiLaiComponent;
            }());
            LapPhieuMuaDuocPhamGuiLaiComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LapPhieuMuaDuocPhamSharedComponent = /** @class */ (function () {
                function LapPhieuMuaDuocPhamSharedComponent(apiService, notificationService, authService, ref, route, dialog) {
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.authService = authService;
                    this.ref = ref;
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.ngOnInit = function () {
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.getCurrentUser = function () {
                    var _this = this;
                    ...
                    this.apiService.get("YeuCauLinhDuocPham/GetCurrentUser").subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            _this.yeuCauMuaThuoc.NhanVienYeuCauId = resultData.NhanVienYeuCauId;
                            _this.yeuCauMuaThuoc.TenNhanVienYeuCau = resultData.HoTen;
                        }
                    });
                };
                LapPhieuMuaDuocPhamSharedComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.clearGridDuocPham = function () {
                    this.huy();
                    this.lstDuocPhamGrid = [];
                    this.gridDataSource = {
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.chonDuocPham = function (dataItem) {
                    var _this = this;
                    if (dataItem != undefined && dataItem != null) {
                        ...
                        this.apiService.post("YeuCauMuaDuocPham/ThongTinDuocPham", this.duocPhamGrid).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.thongTinDuocPham = resultData;
                            }
                        });
                    }
                    else {
                ...
                //Validators
                LapPhieuMuaDuocPhamSharedComponent.prototype.kiemTraValidators = function () {
                    var _this = this;
                    this.duocPhamGrid.YeuCauMuaThuocChiTietValidators = new Array();
                    this.lstDuocPhamGrid.forEach(function (element) {
                        var duocPham = new _yeu_cau_mua_thuoc_model__WEBPACK_IMPORTED_MODULE_15__["YeuCauMuaThuocChiTietValidator"]();
                        duocPham.DuocPhamId = element.DuocPhamId;
                        duocPham.LaDuocPhamBHYT = element.LaDuocPhamBHYT;
                        _this.duocPhamGrid.YeuCauMuaThuocChiTietValidators.push(duocPham);
                    });
                };
                LapPhieuMuaDuocPhamSharedComponent.prototype.themDuocPham = function () {
                    if (this.dangXuLy)
                        return;
                    this.dangXuLy = true;
                    var self = this;
                    ...
                    self.ref.detectChanges();
                    self.apiService.post("YeuCauMuaDuocPham/ThemDuocPhamChiTietGridVo", self.duocPhamGrid).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.xoaDuocPham = function (dataItem) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_17__["ConfirmComponent"], {
                        ...
                        if (result === 'Yes') {
                            ...
                            _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_18__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_7__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
                            _this.validationErrorsDuocPham = [];
                            _this.setValueForGridDuocPham();
                        }
                    });
                };
                LapPhieuMuaDuocPhamSharedComponent.prototype.setValueForGridDuocPham = function () {
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.pushDataDuocPham = function () {
                    var _this = this;
                    this.yeuCauMuaThuoc.DuTruMuaDuocPhamChiTiets = new Array();
                    this.lstDuocPhamGrid.forEach(function (obj) {
                        var model = new _yeu_cau_mua_thuoc_model__WEBPACK_IMPORTED_MODULE_15__["YeuCauMuaThuocChiTiet"]();
                        ...
                        model.STT = obj.STT;
                        _this.yeuCauMuaThuoc.DuTruMuaDuocPhamChiTiets.push(model);
                        //console.log("this.yeuCauMuaThuoc.YeuCauMuaThuocChiTiets: ", this.yeuCauMuaThuoc.DuTruMuaDuocPhamChiTiets)
                    });
                };
                LapPhieuMuaDuocPhamSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].View)) {
                        self.apiService.get("YeuCauMuaDuocPham/GetPhieuMuaDuocPhamDuTru?id=" + id).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                //console.log(resultData)
                                _this.yeuCauMuaThuoc = resultData;
                                if (_this.yeuCauMuaThuoc.TruongKhoaDuyet == null) {
                                    _this.isCreate = true;
                                }
                                _this.lstDuocPhamGrid = [];
                                resultData.DuTruMuaDuocPhamChiTiets.forEach(function (element) {
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.huy = function () {
                    this.validationErrors = [];
                    this.validationErrorsDuocPham = [];
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.themThuoc = function () {
                    var self = this;
                ...
                LapPhieuMuaDuocPhamSharedComponent.prototype.getSharedData = function () {
                    this.setValueForGridDuocPham();
                    return this.yeuCauMuaThuoc;
                };
                return LapPhieuMuaDuocPhamSharedComponent;
            }());
            LapPhieuMuaDuocPhamSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LapPhieuMuaDuocPhamComponent = /** @class */ (function () {
                function LapPhieuMuaDuocPhamComponent(apiService, dialog, notificationService, authService, router, ref, location) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                LapPhieuMuaDuocPhamComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_14__["DocumentType"].DanhSachYeuCauDuTruMuaDuocPham;
                    this.yeuCauMuaThuoc = new _yeu_cau_mua_thuoc_model__WEBPACK_IMPORTED_MODULE_15__["YeuCauMuaThuoc"]();
                    this.trangThaiVo.TrangThai = null;
                };
                LapPhieuMuaDuocPhamComponent.prototype.savingPage = function () {
                    this.popupSavingData = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_12__["LoadingComponent"], {
                        disableClose: true,
                        width: "200px",
                        height: "90px",
                ...
                LapPhieuMuaDuocPhamComponent.prototype.closePopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                LapPhieuMuaDuocPhamComponent.prototype.loadingPage = function () {
                    this.popupLoadingData = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_12__["LoadingComponent"], {
                        disableClose: true,
                        width: "200px",
                        height: "90px",
                ...
                LapPhieuMuaDuocPhamComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                LapPhieuMuaDuocPhamComponent.prototype.guiPhieuMuaDuocPham = function () {
                    var self = this;
                    self.dialog.open(_gui_phieu_mua_duoc_pham_confirm_gui_phieu_mua_duoc_pham_confirm_component__WEBPACK_IMPORTED_MODULE_18__["GuiPhieuMuaDuocPhamConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            ...
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Add)) {
                                self.savingPage();
                                self.apiService.post("YeuCauMuaDuocPham/GuiPhieuMuaDuocPhamDuTru", self.yeuCauMuaThuoc).subscribe(function (result) {
                                    if (result != undefined && result != null) {
                ...
                LapPhieuMuaDuocPhamComponent.prototype.cancel = function () {
                    this.location.back();
                };
                LapPhieuMuaDuocPhamComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 27 && !event.ctrlKey) {
                        //esc
                        this.cancel();
                        event.preventDefault();
                ...
                return LapPhieuMuaDuocPhamComponent;
            }());
            LapPhieuMuaDuocPhamComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_7__["NotificationService"] },
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuMuaDuocPhamComponent = /** @class */ (function () {
                function PhieuMuaDuocPhamComponent(dialogRef, apiService, notificationService, data, ref) {
                    this.dialogRef = dialogRef;
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.data = data;
                ...
                PhieuMuaDuocPhamComponent.prototype.ngOnInit = function () {
                    //console.log(this.data)
                    this.xem();
                };
                PhieuMuaDuocPhamComponent.prototype.xem = function () {
                    var self = this;
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    self.inPhieuDuocPham.DuTruMuaDuocPhamId = self.data.Id;
                    self.inPhieuDuocPham.Header = false;
                    self.apiService.post("YeuCauMuaDuocPham/InPhieuDuTruMuaDuocPham", self.inPhieuDuocPham).subscribe(function (resData) {
                ...
                PhieuMuaDuocPhamComponent.prototype.getSharedPrintForm = function () {
                    if (this.data.Loai == 1) {
                ...
                PhieuMuaDuocPhamComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                return PhieuMuaDuocPhamComponent;
            }());
            PhieuMuaDuocPhamComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/core/utilities/common.helper */ "./src/app/core/utilities/common.helper.ts");
            /* harmony import */ var src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/shared/configdata/system-message */ "./src/app/shared/configdata/system-message.ts");
            var ThemDuocPhamDuTruMuaPopupComponent = /** @class */ (function () {
                function ThemDuocPhamDuTruMuaPopupComponent(apiService, dialog, notificationService, ref, authService, dialogRef, data) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.ref = ref;
                ...
                ThemDuocPhamDuTruMuaPopupComponent.prototype.ngOnInit = function () {
                ...
                ThemDuocPhamDuTruMuaPopupComponent.prototype.loadingPage = function () {
                ...
                ThemDuocPhamDuTruMuaPopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                ThemDuocPhamDuTruMuaPopupComponent.prototype.closePopup = function (result) {
                    this.dialogRef.close(result);
                };
                ThemDuocPhamDuTruMuaPopupComponent.prototype.huy = function () {
                    this.dialog.closeAll();
                };
                ThemDuocPhamDuTruMuaPopupComponent.prototype.themDuocPham = function () {
                    var self = this;
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                        ...
                        if (result == "Yes") {
                            ...
                            self.apiService.post("YeuCauMuaDuocPham/ThemDuocPhamChiTietGridVo", self.duocPham).subscribe(function (resultData) {
                                self.closePopupLoadingData();
                                if (resultData != undefined && resultData != null) {
                                    self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["Thêm"]));
                ...
                ThemDuocPhamDuTruMuaPopupComponent.prototype.chonDuongDung = function (dataItem) {
                    if (dataItem != undefined && dataItem != null) {
                ...
                ThemDuocPhamDuTruMuaPopupComponent.prototype.chonDVT = function (dataItem) {
                    if (dataItem != undefined && dataItem != null) {
                ...
                ThemDuocPhamDuTruMuaPopupComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        if (this.isSelectDuocPham != true) {
                            this.themDuocPham();
                        }
                ...
                ThemDuocPhamDuTruMuaPopupComponent.prototype.openCombobox = function (event) {
                    if (event) {
                        this.isSelectDuocPham = true;
                    }
                    else {
                ...
                return ThemDuocPhamDuTruMuaPopupComponent;
            }());
            ThemDuocPhamDuTruMuaPopupComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var YeuCauMuaThuocRoutingModule = /** @class */ (function () {
                function YeuCauMuaThuocRoutingModule() {
                }
                return YeuCauMuaThuocRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var YeuCauMuaThuocGridVo = /** @class */ (function () {
                function YeuCauMuaThuocGridVo(SoPhieu, TenNhanVienYeuCau, NgayYeuCauTuFormat, NgayYeuCauDenFormat, ChoDuyet, DaDuyet, TuChoiDuyet, TuNgay, DenNgay, SearchString, RangeFromDate) {
                ...
                return YeuCauMuaThuocGridVo;
            }());
            var YeuCauMuaThuoc = /** @class */ (function () {
                function YeuCauMuaThuoc(Id, SoPhieu, KyDuTruMuaDuocPhamVatTuId, NhomDuocPhamDuTru, TenNhomDuTru, TenKyDuTru, KhoId, TenKho, NhanVienYeuCauId, TenNhanVienYeuCau, NgayYeuCau, TruongKhoaId, TruongKhoaDuyet, NgayTaiKhoa, NgayKhoDuoc, NgayGiamDoc, TrangThai, TenTruongKhoa, NgayTruongKhoaDuyet, TenNhanVienKhoDuoc, NgayKhoDuocDuyet, TenGiamDoc, NgayGiamDocDuyet, GhiChu, LyDoTruongKhoaTuChoi, DuTruMuaDuocPhamChiTiets) {
                    if (Id === void 0) { Id = 0; }
                    if (SoPhieu === void 0) { SoPhieu = null; }
                    if (KyDuTruMuaDuocPhamVatTuId === void 0) { KyDuTruMuaDuocPhamVatTuId = null; }
                    if (NhomDuocPhamDuTru === void 0) { NhomDuocPhamDuTru = null; }
                    ...
                    if (DuTruMuaDuocPhamChiTiets === void 0) { DuTruMuaDuocPhamChiTiets = []; }
                    this.Id = Id;
                    this.SoPhieu = SoPhieu;
                ...
                return YeuCauMuaThuoc;
            }());
            var YeuCauMuaThuocChiTiet = /** @class */ (function () {
                function YeuCauMuaThuocChiTiet(STT, Id, DuocPhamId, LaDuocPhamBHYT, SoLuongDuTru, SoLuongDuKienSuDung, SoLuongDuTruTaiKhoaDuyet, NhomDieuTriDuPhong, DuTruMuaDuocPhamTheoKhoaChiTietId, DuTruMuaDuocPhamKhoDuocChiTietId, GhiChu) {
                ...
                return YeuCauMuaThuocChiTiet;
            }());
            var YeuCauMuaThuocChiTietValidator = /** @class */ (function () {
                function YeuCauMuaThuocChiTietValidator(DuocPhamId, LaDuocPhamBHYT) {
                    if (DuocPhamId === void 0) { DuocPhamId = 0; }
                    if (LaDuocPhamBHYT === void 0) { LaDuocPhamBHYT = null; }
                    this.DuocPhamId = DuocPhamId;
                    this.LaDuocPhamBHYT = LaDuocPhamBHYT;
                }
                return YeuCauMuaThuocChiTietValidator;
            }());
            var ThongTinThuocChiTiet = /** @class */ (function () {
                function ThongTinThuocChiTiet(STT, Id, DuocPhamId, LaDuocPhamBHYT, HoatChat, SoDangKy, NhomDuocPhamDuTru, HamLuong, DVT, TenDuongDung, DuongDungId, DonViTinhId, NhomDuTruId, NhaSX, NuocSX, SoLuongDuTru, SoLuongDuKienSuDung, NhomDuPhongId, SoLuongTonDuTru, SoLuongTonKhoTong, SoLuongChuaNhapVeHDT, // Hợp đồng thầu
                ThongTinChiTietTonKhoTongs, ThongTinChiTietTonHDTs, LoaiDuocPham, TenLoaiDuocPham, Ten, NhomDieuTriDuPhong, NhomDieuTriDuTru, GhiChu, SLTonDuTru, SLTonKhoTong, SLChuaNhapVeHDT, SoLuongDuTruTaiKhoaDuyet, SoLuongDuTruKhoaDuocDuyet, SoLuongDuTruGiamDocDuyet, NhomDuPhong, KhoId, IsThemDuocPham, YeuCauMuaThuocChiTietValidators) {
                    if (STT === void 0) { STT = 0; }
                    if (Id === void 0) { Id = 0; }
                    if (DuocPhamId === void 0) { DuocPhamId = null; }
                    if (LaDuocPhamBHYT === void 0) { LaDuocPhamBHYT = null; }
                    ...
                    if (NhomDuTruId === void 0) { NhomDuTruId = null; }
                    if (NhaSX === void 0) { NhaSX = null; }
                    if (NuocSX === void 0) { NuocSX = null; }
                    if (SoLuongDuTru === void 0) { SoLuongDuTru = null; }
                    if (SoLuongDuKienSuDung === void 0) { SoLuongDuKienSuDung = null; }
                    if (NhomDuPhongId === void 0) { NhomDuPhongId = null; }
                    ...
                    if (TenLoaiDuocPham === void 0) { TenLoaiDuocPham = null; }
                    if (Ten === void 0) { Ten = null; }
                    if (NhomDieuTriDuPhong === void 0) { NhomDieuTriDuPhong = null; }
                    if (NhomDieuTriDuTru === void 0) { NhomDieuTriDuTru = null; }
                    if (GhiChu === void 0) { GhiChu = null; }
                    ...
                    if (KhoId === void 0) { KhoId = null; }
                    if (IsThemDuocPham === void 0) { IsThemDuocPham = false; }
                    if (YeuCauMuaThuocChiTietValidators === void 0) { YeuCauMuaThuocChiTietValidators = []; }
                    this.STT = STT;
                    this.Id = Id;
                    this.DuocPhamId = DuocPhamId;
                    this.LaDuocPhamBHYT = LaDuocPhamBHYT;
            ...
            var PhieuYeuCauMuaThuoc = /** @class */ (function () {
                function PhieuYeuCauMuaThuoc(DuTruMuaDuocPhamId, HostingName, Header, TrangThai) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var YeuCauMuaThuocModule = /** @class */ (function () {
                function YeuCauMuaThuocModule() {
                }
                return YeuCauMuaThuocModule;
            }());
...
//# sourceMappingURL=default~nhap-xuat-duoc-pham-tong-hop-du-tru-mua-thuoc-tai-khoa-tong-hop-du-tru-mua-thuoc-tai-khoa-mo~9f0473de-es5.js.map
//# sourceMappingURL=default~nhap-xuat-duoc-pham-tong-hop-du-tru-mua-thuoc-tai-khoa-tong-hop-du-tru-mua-thuoc-tai-khoa-mo~9f0473de-es5.js.map