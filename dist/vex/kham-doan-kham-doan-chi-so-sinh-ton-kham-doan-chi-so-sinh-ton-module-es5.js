...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["kham-doan-kham-doan-chi-so-sinh-ton-kham-doan-chi-so-sinh-ton-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TestScheduler = /** @class */ (function (_super) {
                ...
                function TestScheduler(assertDeepEqual) {
                    var _this = _super.call(this, _scheduler_VirtualTimeScheduler__WEBPACK_IMPORTED_MODULE_5__["VirtualAction"], defaultMaxFrame) || this;
                ...
                TestScheduler.prototype.materializeInnerObservable = function (observable, outerFrame) {
                    ...
                    observable.subscribe(function (value) {
                        messages.push({ frame: _this.frame - outerFrame, notification: _Notification__WEBPACK_IMPORTED_MODULE_1__["Notification"].createNext(value) });
                    }, function (err) {
                        messages.push({ frame: _this.frame - outerFrame, notification: _Notification__WEBPACK_IMPORTED_MODULE_1__["Notification"].createError(err) });
                    }, function () {
                        messages.push({ frame: _this.frame - outerFrame, notification: _Notification__WEBPACK_IMPORTED_MODULE_1__["Notification"].createComplete() });
                    });
                    return messages;
                };
                TestScheduler.prototype.expectObservable = function (observable, subscriptionMarbles) {
                    ...
                    this.schedule(function () {
                        subscription = observable.subscribe(function (x) {
                            ...
                            actual.push({ frame: _this.frame, notification: _Notification__WEBPACK_IMPORTED_MODULE_1__["Notification"].createNext(value) });
                        }, function (err) {
                            actual.push({ frame: _this.frame, notification: _Notification__WEBPACK_IMPORTED_MODULE_1__["Notification"].createError(err) });
                        }, function () {
                            actual.push({ frame: _this.frame, notification: _Notification__WEBPACK_IMPORTED_MODULE_1__["Notification"].createComplete() });
                        });
                    }, subscriptionFrame);
                ...
                TestScheduler.prototype.expectSubscriptions = function (actualSubscriptionLogs) {
                    ...
                    return {
                        toBe: function (marbles) {
                            ...
                            flushTest.ready = true;
                            flushTest.expected = marblesArray.map(function (marbles) { return TestScheduler.parseMarblesAsSubscriptions(marbles, runMode); });
                        }
                    };
                };
            ...
            }(_scheduler_VirtualTimeScheduler__WEBPACK_IMPORTED_MODULE_5__["VirtualTimeScheduler"]));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanChiSoSinhTonDetailedComponent = /** @class */ (function () {
                function KhamDoanChiSoSinhTonDetailedComponent(authService, dialog, notificationService, location, apiService, data) {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.ngOnInit = function () {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.showPopupLoadingData = function () {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.submit = function () {
                    var _this = this;
                    var sendingParam = {
                        data: this.dataSourceSinhHieu.data.slice(),
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                        ...
                        this.apiService.post('KhamDoan/UpdateChiSoSinhTonAsync', sendingParam)
                            ...
                            _this.apiService.get("KhamDoan/GetDataListForChiSoSinhTon?id=" + _this.data.YeuCauTiepNhanId).subscribe(function (resultData) {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData) {
                        this.popupLoadingData.close();
                    }
                };
                KhamDoanChiSoSinhTonDetailedComponent.prototype.getDataCongTy = function (id, yeuCauTiepNhanId) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].View)) {
                        ...
                        rxjs_Observable__WEBPACK_IMPORTED_MODULE_17__["Observable"].forkJoin([
                            this.apiService.get("KhamDoan/GetHopDongKhamSucKhoe?id=" + id)
                                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["retryWhen"])(function (errors) { return errors.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["tap"])(function (_) {
                                _this.khamDoanSinhTon = new _kham_doan_chi_so_sinh_ton_model__WEBPACK_IMPORTED_MODULE_13__["KhamDoanChiSoSinhTonDetailed"]();
                            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["delayWhen"])(function (_) {
                            ...
                            _this.khamDoanSinhTon = Object.assign({}, results[0]);
                            _this.dataSourceSinhHieu = {
                                data: results[1].Data.slice(),
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.themChiSoSinhTon = function () {
                    var _this = this;
                    if (this.dataSourceSinhHieuDisplay.data.findIndex(function (x) { return x.Id === 0; }) === -1) {
                        var newItem = new _kham_doan_chi_so_sinh_ton_model__WEBPACK_IMPORTED_MODULE_13__["KetQuaSinhHieu"]();
                            ...
                            this.apiService.post('KhamDoan/UpdateChiSoSinhTonAsync', sendingParam)
                                ...
                                _this.apiService.get("KhamDoan/GetDataListForChiSoSinhTon?id=" + _this.data.YeuCauTiepNhanId).subscribe(function (resultData) {
                                    if (resultData !== null && resultData !== undefined) {
                                        ...
                                        var newItem = new _kham_doan_chi_so_sinh_ton_model__WEBPACK_IMPORTED_MODULE_13__["KetQuaSinhHieu"]();
                                        newItem.NgayThucHien = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].formatDateTimeSACH(_this.current, 'dd/mm/yyyy').toString();
                                        _this.dataSourceSinhHieuDisplay.data.push(newItem);
                                        _this.dataSourceSinhHieu.data.push(newItem);
                                    }
                                });
                                _this.closePopupLoadingData();
                            }, function (err) {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.onChangeNhipTim = function (data, input) {
                    if (input % 1 !== 0) {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.onChangeNhipTho = function (input, dataItem) {
                    if (input % 1 !== 0) {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.onChangeHuyetApTamThu = function (input, dataItem) {
                    if (input % 1 !== 0) {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.onChangeHuyetApTamTruong = function (input, dataItem) {
                    if (input % 1 !== 0) {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.onChangeCanNang = function (data) {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.onChangeChieuCao = function (data) {
                    var chieuCao = data.ChieuCao / 100;
                    if (chieuCao === 0) {
                        data.BMI = null;
                        return;
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.suaChiSoSinhHieu = function (dataItem) {
                    if (dataItem) {
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.xoaChiSoSinhHieu = function (item) {
                    var _this = this;
                ...
                KhamDoanChiSoSinhTonDetailedComponent.prototype.quayLai = function () {
                    this.location.back();
                };
                return KhamDoanChiSoSinhTonDetailedComponent;
            }());
            KhamDoanChiSoSinhTonDetailedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanChiSoSinhTonListComponent = /** @class */ (function () {
                function KhamDoanChiSoSinhTonListComponent(authService, notificationService, route, location, dialog, apiService, router) {
                    this.authService = authService;
                    this.notificationService = notificationService;
                    this.route = route;
                    this.location = location;
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.ngOnInit = function () {
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.changeLookupHopDong = function (event) {
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.changeCongTy = function (event) {
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.changeHopDong = function (event) {
                    if (event != undefined && event != null) {
                        this.getThongTinHopDongById();
                    }
                    else {
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.clearThongTinHopDong = function () {
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.clearThongTinCSST = function () {
                    this.yeuCauTiepNhanId = null;
                    this.ketQuaSinhHieu = new _kham_doan_chi_so_sinh_ton_model__WEBPACK_IMPORTED_MODULE_21__["KetQuaSinhHieu"]();
                };
                KhamDoanChiSoSinhTonListComponent.prototype.getThongTinHopDongById = function (reloadGrid) {
                    var _this = this;
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.showPopupLoadingData = function () {
                    if (this.popupLoadingData == null
                        || this.popupLoadingData.openDialogs == null
                        || (this.popupLoadingData.openDialogs && this.popupLoadingData.openDialogs.length === 0)) {
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.searchChanges = function (event) {
                    if ((event == null || event == "")) {
                        this.timKiemNangNhanChuaDo();
                    }
                };
                KhamDoanChiSoSinhTonListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiemNangNhanChuaDo();
                    }
                };
                KhamDoanChiSoSinhTonListComponent.prototype.clearSearch = function () {
                    this.timKiemObj.SearchString = null;
                    this.gridChild.searchString = null;
                    this.timKiemNangNhanChuaDo();
                };
                KhamDoanChiSoSinhTonListComponent.prototype.searchChangeDaDos = function (event) {
                    if ((event == null || event == "")) {
                        this.timKiemNangNhanDaDo();
                    }
                };
                KhamDoanChiSoSinhTonListComponent.prototype.onKeyDaDo = function (event) {
                    if (event.key == "Enter") {
                        this.timKiemNangNhanDaDo();
                    }
                };
                KhamDoanChiSoSinhTonListComponent.prototype.clearSearchDaDo = function () {
                    this.timKiemObj.SearchString = null;
                    this.gridChild.searchString = null;
                    this.timKiemNangNhanDaDo();
                };
                KhamDoanChiSoSinhTonListComponent.prototype.timKiemNangNhanChuaDo = function () {
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.timKiemNangNhanDaDo = function () {
                    this.location.replaceState(this.baseRoute + '?holdQuery=true');
                    this.kiemTraChonHopDong();
                    this.timKiemObj.TrangThai = null;
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.kiemTraChonHopDong = function () {
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.timKiemNangCao = function () {
                    this.location.replaceState(this.baseRoute + '?holdQuery=true');
                    this.kiemTraChonHopDong();
                    this.timKiemObj.TrangThai = null;
                    this.timKiemObj.TinhTrangDoChiSoSinhTon.ChuaDo = true;
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.xuLyXuatExcel = function () {
                    var _this = this;
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.showPopupChiTiet = function (id) {
                    if (id === void 0) { id = null; }
                    var securityOperation = src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].Add;
                    var url = '/them/';
                    if (id != null) {
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.xoa = function (Id) {
                    var _this = this;
                        ...
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_20__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                ...
                                _this.apiService.delete('KhamDoan/XuLyXoaCongTy?id=' + Id).subscribe(function (_) {
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_18__["SystemMessage"].ActionSuccessfully, ['Xóa']));
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.showPopupChiTietNhanVien = function (id, yeuCauTiepNhanId) {
                    this.yeuCauTiepNhanId = yeuCauTiepNhanId;
                    this.nhanVienId = id;
                    this.getThongTinHanhChinh(yeuCauTiepNhanId);
                    this.getDataCongTy(id, yeuCauTiepNhanId);
                };
                KhamDoanChiSoSinhTonListComponent.prototype.getThongTinHanhChinh = function (yeuCauTiepNhanId) {
                    var _this = this;
                    this.apiService
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.submit = function () {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_20__["ConfirmComponent"], {
                        disableClose: false,
                        width: "400px",
                        ...
                        .subscribe(function (result) {
                        if (result == "Yes") {
                            _this.dataSourceSinhHieu.data = [];
                            _this.ketQuaSinhHieu.IsUpdate = true;
                            _this.dataSourceSinhHieu.data.push(_this.ketQuaSinhHieu);
                            var sendingParam = {
                                data: _this.dataSourceSinhHieu.data.slice(),
                                Id: _this.yeuCauTiepNhanId
                            };
                            console.log(sendingParam);
                            if (_this.authService.hasPermission(_this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].Update)) {
                                ...
                                _this.apiService.post('KhamDoan/UpdateChiSoSinhTonAsync', sendingParam)
                                    ...
                                    _this.timKiemObj.SearchString = null;
                                    _this.timKiemObj.SearchDaDoString = null;
                                    _this.timKiemNangCao();
                                    _this.closePopupLoadingData();
                                }, function (err) {
                                    _this.notificationService.showError(err.Message);
                                ...
                                _this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_18__["SystemMessage"].UnAuthorizedMessage);
                            }
                        }
                    });
                };
                KhamDoanChiSoSinhTonListComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData) {
                        this.popupLoadingData.close();
                    }
                };
                KhamDoanChiSoSinhTonListComponent.prototype.getDataCongTy = function (id, yeuCauTiepNhanId) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].View)) {
                        ...
                        rxjs_compat__WEBPACK_IMPORTED_MODULE_24__["Observable"].forkJoin([
                            this.apiService.get("KhamDoan/GetHopDongKhamSucKhoe?id=" + id)
                                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_25__["retryWhen"])(function (errors) { return errors.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_25__["tap"])(function (_) {
                                _this.khamDoanSinhTon = new _kham_doan_chi_so_sinh_ton_model__WEBPACK_IMPORTED_MODULE_21__["KhamDoanChiSoSinhTonDetailed"]();
                            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_25__["delayWhen"])(function (_) {
                            ...
                            if (_this.dataSourceSinhHieu.data.length > 0) {
                                _this.ketQuaSinhHieu = _this.dataSourceSinhHieu.data[_this.dataSourceSinhHieu.data.length - 1];
                            }
                            else {
                                _this.ketQuaSinhHieu = new _kham_doan_chi_so_sinh_ton_model__WEBPACK_IMPORTED_MODULE_21__["KetQuaSinhHieu"]();
                                _this.ketQuaSinhHieu.NgayThucHien = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].formatDateTimeSACH(_this.current, 'dd/mm/yyyy').toString();
                            }
                            _this.closePopupLoadingData();
                        });
                    }
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.themChiSoSinhTon = function () {
                    var _this = this;
                    if (this.dataSourceSinhHieuDisplay.data.findIndex(function (x) { return x.Id === 0; }) === -1) {
                        var newItem = new _kham_doan_chi_so_sinh_ton_model__WEBPACK_IMPORTED_MODULE_21__["KetQuaSinhHieu"]();
                            ...
                            this.apiService.post('KhamDoan/UpdateChiSoSinhTonAsync', sendingParam)
                                ...
                                _this.apiService.get("KhamDoan/GetDataListForChiSoSinhTon?id=" + _this.yeuCauTiepNhanId).subscribe(function (resultData) {
                                    if (resultData !== null && resultData !== undefined) {
                                        ...
                                        var newItem = new _kham_doan_chi_so_sinh_ton_model__WEBPACK_IMPORTED_MODULE_21__["KetQuaSinhHieu"]();
                                        newItem.NgayThucHien = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].formatDateTimeSACH(_this.current, 'dd/mm/yyyy').toString();
                                        _this.dataSourceSinhHieuDisplay.data.push(newItem);
                                        _this.dataSourceSinhHieu.data.push(newItem);
                                    }
                                });
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.onChangeNhipTim = function (data, input) {
                    if (input % 1 !== 0) {
                        data.NhipTim = input.toFixed();
                        if (typeof data.NhipTim === 'string') {
                            data.NhipTim = Number(data.NhipTim);
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.onChangeNhipTho = function (input, dataItem) {
                    if (input % 1 !== 0) {
                        dataItem.NhipTho = input.toFixed();
                        if (typeof dataItem.NhipTho === 'string') {
                            dataItem.NhipTho = Number(dataItem.NhipTho);
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.onChangeHuyetApTamThu = function (input, dataItem) {
                    if (input % 1 !== 0) {
                        dataItem.HuyetApTamThu = input.toFixed();
                        if (typeof dataItem.HuyetApTamThu === 'string') {
                            dataItem.HuyetApTamThu = Number(dataItem.HuyetApTamThu);
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.onChangeHuyetApTamTruong = function (input, dataItem) {
                    if (input % 1 !== 0) {
                        dataItem.HuyetApTamTruong = input.toFixed();
                        if (typeof dataItem.HuyetApTamTruong === 'string') {
                            dataItem.HuyetApTamTruong = Number(dataItem.HuyetApTamTruong);
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.onChangeCanNang = function (data) {
                    var chieuCao = data.ChieuCao / 100;
                    if (chieuCao === 0) {
                        data.BMI = null;
                        return;
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.onChangeChieuCao = function (data) {
                    var chieuCao = data.ChieuCao / 100;
                    if (chieuCao === 0) {
                        data.BMI = null;
                        return;
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.suaChiSoSinhHieu = function (dataItem) {
                    if (dataItem) {
                        dataItem.IsUpdate = true;
                        this.dataSourceSinhHieu.data.filter(function (x) { return x === dataItem; })[0].IsUpdate = true;
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.xoaChiSoSinhHieu = function (item) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_20__["ConfirmComponent"], {
                        disableClose: false,
                        width: '400px',
                ...
                KhamDoanChiSoSinhTonListComponent.prototype.huy = function () {
                    this.ketQuaSinhHieu = new _kham_doan_chi_so_sinh_ton_model__WEBPACK_IMPORTED_MODULE_21__["KetQuaSinhHieu"]();
                };
                return KhamDoanChiSoSinhTonListComponent;
            }());
            KhamDoanChiSoSinhTonListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanChiSoSinhTonRoutingModule = /** @class */ (function () {
                function KhamDoanChiSoSinhTonRoutingModule() {
                }
                return KhamDoanChiSoSinhTonRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var KhamDoanChiSoSinhTonTimKiem = /** @class */ (function () {
                function KhamDoanChiSoSinhTonTimKiem(CongTyId, HopDongId, NgayHopDong, LoaiHopDong, TrangThai, SoBenhNhan, NgayHieuLuc, NgayKetThuc, DaTaoYCTN) {
                    ...
                    if (DaTaoYCTN === void 0) { DaTaoYCTN = true; }
                ...
                return KhamDoanChiSoSinhTonTimKiem;
            }());
            var KhamDoanChiSoSinhTonTimKiemGrid = /** @class */ (function () {
                function KhamDoanChiSoSinhTonTimKiemGrid(SearchString, 
                // tslint:disable-next-line: no-use-before-declare
                TrangThai, CongTyId, HopDongId) {
                    if (SearchString === void 0) { SearchString = null; }
                    if (TrangThai === void 0) { TrangThai = new KhamDoanTrangThai(); }
                    if (CongTyId === void 0) { CongTyId = null; }
                    if (HopDongId === void 0) { HopDongId = null; }
                ...
                return KhamDoanChiSoSinhTonTimKiemGrid;
            }());
            var KhamDoanTrangThai = /** @class */ (function () {
                function KhamDoanTrangThai(ChuaKham, DangKham, DaKham) {
                ...
                return KhamDoanTrangThai;
            }());
            var KhamDoanChiSoSinhTon = /** @class */ (function () {
                function KhamDoanChiSoSinhTon(MaNv, TenNv, Dv, GioiTinh, NamSinh, Sdt, Email, Cmt, Shc, DanToc, TinhThanh, NhomKham, GhiChu, TinhTrang) {
                    if (MaNv === void 0) { MaNv = null; }
                    if (TenNv === void 0) { TenNv = null; }
                    if (Dv === void 0) { Dv = null; }
                    if (GioiTinh === void 0) { GioiTinh = null; }
                    if (NamSinh === void 0) { NamSinh = null; }
                    if (Sdt === void 0) { Sdt = null; }
                    if (Email === void 0) { Email = null; }
                    if (Cmt === void 0) { Cmt = null; }
                    if (Shc === void 0) { Shc = null; }
                    if (DanToc === void 0) { DanToc = null; }
                    if (TinhThanh === void 0) { TinhThanh = null; }
                    if (NhomKham === void 0) { NhomKham = null; }
                ...
                return KhamDoanChiSoSinhTon;
            }());
            var KhamDoanChiSoSinhTonDetailed = /** @class */ (function () {
                function KhamDoanChiSoSinhTonDetailed(MaNhanVien, HoTen, HoTenKhac, NgayThangNamSinh, Tuoi, SoDienThoaiDisplay, GioiTinh, NgheNghiepId, NgheNghiep, QuocTichId, QuocTich, DanTocId, DanToc, TinhThanhId, TinhThanh, QuanHuyenId, QuanHuyen, PhuongXaId, PhuongXa, DiaChi, SoChungMinhThu, Email, TenDonViHoacBoPhan, NhomMau, NhomMauDisplay, YeuToRh, YeuToRhDisplay, DaLapGiaDinhDisplay, CoMangThai, NhomDoiTuongKhamSucKhoe, GhiChuTienSuBenh, GhiChuDiUngThuoc) {
                    ...
                    if (QuocTich === void 0) { QuocTich = null; }
                    ...
                    if (NhomMauDisplay === void 0) { NhomMauDisplay = null; }
                    if (YeuToRh === void 0) { YeuToRh = null; }
                    if (YeuToRhDisplay === void 0) { YeuToRhDisplay = null; }
                    if (DaLapGiaDinhDisplay === void 0) { DaLapGiaDinhDisplay = null; }
                ...
                return KhamDoanChiSoSinhTonDetailed;
            }());
            var KetQuaSinhHieu = /** @class */ (function () {
                function KetQuaSinhHieu(Id, NhipTim, NhipTho, ThanNhiet, HuyetAp, HuyetApTamThu, HuyetApTamTruong, ChieuCao, CanNang, BMI, SpO2, Glassgow, NoiThucHienId, NhanVienThucHienId, YeuCauTiepNhanId, NgayThucHien, IsUpdate, IsDelete, KSKPhanLoaiTheLuc) {
                    if (Id === void 0) { Id = 0; }
                    ...
                    if (KSKPhanLoaiTheLuc === void 0) { KSKPhanLoaiTheLuc = 0; }
                    this.Id = Id;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanChiSoSinhTonModule = /** @class */ (function () {
                function KhamDoanChiSoSinhTonModule() {
                }
                return KhamDoanChiSoSinhTonModule;
            }());
...
//# sourceMappingURL=kham-doan-kham-doan-chi-so-sinh-ton-kham-doan-chi-so-sinh-ton-module-es5.js.map
//# sourceMappingURL=kham-doan-kham-doan-chi-so-sinh-ton-kham-doan-chi-so-sinh-ton-module-es5.js.map