(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-kiem-soat-nhiem-khuan-yeu-cau-linh-ksnk-yeu-cau-linh-ksnk-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachYeuCauLinhKSNKComponent = /** @class */ (function () {
                function DanhSachYeuCauLinhKSNKComponent(dialog, router, apiService, authService, notificationService, cd, route, location) {
                    this.dialog = dialog;
                    this.router = router;
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.TimKiemId = function () {
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.blur = function ($event) {
                    this.TimkiemNangCao();
                };
                DanhSachYeuCauLinhKSNKComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.TimkiemNangCao();
                    }
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.onKeyDateRange = function (event) {
                    if (event.key == 'Enter') {
                        this.TimkiemNangCao();
                    }
                };
                DanhSachYeuCauLinhKSNKComponent.prototype.changRange = function (event) {
                    this.TimkiemNangCao();
                };
                DanhSachYeuCauLinhKSNKComponent.prototype.searchChanges = function () {
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.TimkiemNangCao = function () {
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.checkTrangThaiDCT = function (event, type) {
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.loadingPageDaDuyet = function () {
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.closePopupLoadingDataDaDuyet = function () {
                    if (this.popupLoadingDataDaDuyet != undefined && this.popupLoadingDataDaDuyet != null) {
                        this.popupLoadingDataDaDuyet.close();
                    }
                };
                /// in 
                DanhSachYeuCauLinhKSNKComponent.prototype.InPhieuLinh = function (data) {
                    var self = this;
                    if (data.LoaiPhieuLinh == 1 || data.LoaiPhieuLinh == 2) { //lĩnh dự trù(dự trù) hoặc lĩnh bù
                        ...
                        if (data.LoaiPhieuLinh == 1) {
                            self.apiService.post("YeuCauLinhKSNK/InPhieuLinhThuongKSNK", self.inPhieuLinhThuong).subscribe(function (resData) {
                        ...
                        if (data.LoaiPhieuLinh == 2) {
                            self.apiService.post("YeuCauLinhKSNK/InPhieuLinhBuKSNK", self.inPhieuLinhThuong).subscribe(function (resData) {
                                if (resData != undefined && resData != null) {
                                    self.closePopupLoadingDataDaDuyet();
                                    self.inPhieuLinhThuong.Header = false;
                                    self.dialog.open(_phieu_linh_ksnk_thuong_popup_phieu_linh_ksnk_thuong_popup_component__WEBPACK_IMPORTED_MODULE_28__["PhieuLinhKSNKThuongPopupComponent"], {
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.Huy = function (dataItem) {
                    var _this = this;
                        ...
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_26__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                ...
                                if (data.LoaiDuocPhamHayVatTu == true) {
                                    ...
                                    _this.apiService.post("YeuCauLinhKSNK/HuyItemYeuCauLinhThuoc?id=" + dataItem.Id).subscribe(function (resultData) {
                                        _this.notificationService.showSuccess("Xóa thành công");
                                        _this.TimkiemNangCao();
                                    }, function (err) {
                                        _this.validationErrors = err.ValidationErrors;
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.Xem = function (id, loaiPhieuLinh, daGui, loai) {
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    self.apiService.postExportExcel('YeuCauLinhKSNK/ExportDanhSachLinhKSNK', self.exportQueryInfoQueryInfo).subscribe(function (resultData) {
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.showPopupLoadingData = function () {
                ...
                DanhSachYeuCauLinhKSNKComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                DanhSachYeuCauLinhKSNKComponent.prototype.clearSearch = function () { };
                return DanhSachYeuCauLinhKSNKComponent;
            }());
            DanhSachYeuCauLinhKSNKComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InLinhKSNKComponent = /** @class */ (function () {
                function InLinhKSNKComponent(data, sanitizer, dialog) {
                    this.data = data;
                ...
                InLinhKSNKComponent.prototype.ngOnInit = function () {
                    this.modelPrint = this.data.Model;
                    this.loaiPhieuLinh = this.data.LoaiPhieuLinh;
                };
                InLinhKSNKComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        resolve(_this.modelPrint);
                    });
                };
                InLinhKSNKComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return InLinhKSNKComponent;
            }());
            InLinhKSNKComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _yeu_cau_linh_ksnk_model__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../yeu-cau-linh-ksnk.model */ "./src/app/modules/main/nhap-xuat/kiem-soat-nhiem-khuan/yeu-cau-linh-ksnk/yeu-cau-linh-ksnk.model.ts");
            /* harmony import */ var src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/core/utilities/common.helper */ "./src/app/core/utilities/common.helper.ts");
            var PhieuLinhKSNKBuGuiLaiSharedComponent = /** @class */ (function () {
                function PhieuLinhKSNKBuGuiLaiSharedComponent(apiService, notificationService, authService, ref, dialog, route) {
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.authService = authService;
                    this.ref = ref;
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.queryParams.subscribe(function (params) {
                        ...
                        if (khoLinhId != undefined && khoBuId != undefined && khoLinhId > 0 && khoBuId > 0) {
                            _this.yeuCauLinhBuKSNK.KhoXuatId = parseInt(khoLinhId);
                            _this.yeuCauLinhBuKSNK.KhoNhapId = parseInt(khoBuId);
                            _this.linhTuKhoId = parseInt(khoLinhId);
                            _this.linhVeKhoId = parseInt(khoBuId);
                            _this.ganDieuKienLoadGridKSNK(parseInt(khoLinhId), parseInt(khoBuId));
                        }
                    });
                };
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.getCurrentUser = function () {
                    var _this = this;
                    if (this.yeuCauLinhBuKSNK.LaNguoiTaoPhieu == null) {
                        ...
                        if (this.yeuCauLinhBuKSNK.NhanVienDuyetId == null) {
                            this.apiService.get("YeuCauLinhKSNK/GetCurrentUserKSNK").subscribe(function (resultData) {
                                if (resultData != undefined && resultData != null) {
                                    _this.yeuCauLinhBuKSNK.NhanVienYeuCauId = resultData.NhanVienYeuCauId;
                                    _this.yeuCauLinhBuKSNK.HoTenNguoiYeuCau = resultData.HoTen;
                                }
                            });
                        }
                    }
                };
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.loadingPage = function () {
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.linhTuKhoChange = function (event) {
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.linhVeKhoChange = function (event) {
                    var _this = this;
                    if (event != undefined && event != null) {
                        ...
                        if (this.trangThaiVo != undefined
                            ...
                            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                                ...
                                if (result == "Yes") {
                                    _this.yeuCauLinhBuKSNK.KhoNhapId = event;
                                    _this.linhVeKhoId = event;
                                    _this.ganDieuKienLoadGridKSNK(_this.linhTuKhoId, event);
                                }
                                else {
                                    _this.yeuCauLinhBuKSNK.KhoNhapId = _this.linhVeKhoPreviousId;
                                    _this.linhVeKhoId = event;
                                    _this.ganDieuKienLoadGridKSNK(_this.linhTuKhoId, _this.linhVeKhoPreviousId);
                                }
                            });
                        }
                        else {
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.ganDieuKienLoadGridKSNK = function (linhTuKhoId, linhVeKhoId) {
                    if (this.trangThaiVo != undefined) {
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.onDataBoundGrid = function (event) {
                    var _this = this;
                    if (event != undefined && event != null) {
                        if (this.isCreate) {
                            ...
                            event.Data.forEach(function (element) {
                                var yeuCauKSNKBenhVien = new _yeu_cau_linh_ksnk_model__WEBPACK_IMPORTED_MODULE_13__["YeuCauKSNKBenhVienViewModel"]();
                                ...
                                yeuCauKSNKBenhVien.KhoLinhTuId = _this.linhTuKhoId;
                                yeuCauKSNKBenhVien.KhoLinhVeId = _this.linhVeKhoId;
                                ...
                                _this.yeuCauLinhBuKSNK.YeuCauVatTuBenhViens.push(yeuCauKSNKBenhVien);
                            });
                        }
                        else {
                            this.yeuCauLinhBuKSNK.YeuCauVatTuBenhViens = [];
                            ...
                            event.Data.forEach(function (element) {
                                ...
                                yeuCauKSNKBenhVien.SoLuongCanBu = element.SoLuongCanBu;
                                yeuCauKSNKBenhVien.SoLuongTon = element.SoLuongTon;
                                yeuCauKSNKBenhVien.KhoLinhTuId = _this.yeuCauLinhBuKSNK.KhoXuatId;
                                yeuCauKSNKBenhVien.KhoLinhVeId = _this.yeuCauLinhBuKSNK.KhoNhapId;
                                yeuCauKSNKBenhVien.SoLuongYeuCau = element.SoLuongYeuCau;
                                yeuCauKSNKBenhVien.SoLuongDaBu = element.SoLuongDaBu;
                                yeuCauKSNKBenhVien.SLYeuCauLinhThucTe = element.SLYeuCauLinhThucTe;
                                yeuCauKSNKBenhVien.SLYeuCauLinhThucTeMax = element.SLYeuCauLinhThucTeMax;
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    var self = this;
                    self.loadingPage();
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].View)) {
                        ...
                        self.apiService.post("YeuCauLinhKSNK/GetYeuCauLinhKSNKBuTao", modelVO).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                self.closePopupLoadingData();
                                // console.log("data: ", resultData)
                                _this.yeuCauLinhBuKSNK = resultData;
                                if (_this.yeuCauLinhBuKSNK.LaNguoiTaoPhieu) {
                                    _this.disabledNguoiTaoPhieu.emit(true);
                                }
                                else {
                                    _this.disabledNguoiTaoPhieu.emit(false);
                                }
                                if (_this.yeuCauLinhBuKSNK.HoTenNguoiYeuCau == null) {
                                    _this.yeuCauLinhBuKSNK.HoTenNguoiYeuCau = resultData.TenNhanVienYeuCau;
                                }
                                console.log("yeuCauLinhBuKSNK: ", _this.yeuCauLinhBuKSNK);
                                if (_this.isCreate) {
                                    _this.linhVeKhoPreviousId = _this.yeuCauLinhBuKSNK.KhoNhapId;
                                }
                                _this.linhTuKhoId = _this.yeuCauLinhBuKSNK.KhoXuatId;
                                _this.linhVeKhoId = _this.yeuCauLinhBuKSNK.KhoNhapId;
                                if (_this.yeuCauLinhBuKSNK.DuocDuyet == null || _this.yeuCauLinhBuKSNK.DuocDuyet == false) {
                                    _this.isCreate = false;
                                }
                                _this.ganDieuKienLoadGridKSNK(_this.yeuCauLinhBuKSNK.KhoXuatId, _this.yeuCauLinhBuKSNK.KhoNhapId);
                            }
                        }, function (err) {
                            self.validationErrors = err.ValidationErrors;
                            if (err.Message != "Validation Failed") {
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.ganSLThucTeChange = function (soLuong, KSNKBenhVienId) {
                    if (soLuong != undefined && soLuong != null) {
                        this.yeuCauLinhBuKSNK.YeuCauVatTuBenhViens.filter(function (x) { return x.VatTuBenhVienId == KSNKBenhVienId; }).forEach(function (element) {
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.checkBoxDichVu = function (dataItem, event) {
                    var index = this.yeuCauLinhBuKSNK.YeuCauVatTuBenhViens.findIndex(function (z) { return z.VatTuBenhVienId == dataItem.VatTuBenhVienId; });
                    this.yeuCauLinhBuKSNK.YeuCauVatTuBenhViens[index].CheckBox = event;
                    var lstDataCurrent = this.gridKSNK.getAllDataFromDatasource();
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.checkBoxAllChange = function (event) {
                    var _this = this;
                    var lstDataCurrent = this.gridKSNK.getAllDataFromDatasource();
                    if (lstDataCurrent.length > 0) {
                        lstDataCurrent.forEach(function (element) {
                            element.CheckBox = event;
                            var index = _this.yeuCauLinhBuKSNK.YeuCauVatTuBenhViens.findIndex(function (z) { return z.VatTuBenhVienId == element.VatTuBenhVienId; });
                            _this.yeuCauLinhBuKSNK.YeuCauVatTuBenhViens[index].CheckBox = event;
                        });
                    }
                };
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.thoiDiemTNChange = function () {
                ...
                PhieuLinhKSNKBuGuiLaiSharedComponent.prototype.getSharedData = function () {
                ...
                return PhieuLinhKSNKBuGuiLaiSharedComponent;
            }());
            PhieuLinhKSNKBuGuiLaiSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuLinhKSNKBuGuiLaiComponent = /** @class */ (function () {
                function PhieuLinhKSNKBuGuiLaiComponent(dialog, route, notificationService, authService, apiService, router, ref) {
                    this.dialog = dialog;
                    this.route = route;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.loadingPage = function () {
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                PhieuLinhKSNKBuGuiLaiComponent.prototype.luuPhieuLinhBuKSNK = function (daGui) {
                    var self = this;
                    self.yeuCauLinhKSNK = self.shared.getSharedData();
                    if (self.yeuCauLinhKSNK.YeuCauVatTuBenhViens.every(function (z) { return !z.CheckBox; })) {
                        if (daGui) {
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.xacNhanLuuPhieuLinh = function () {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                        self.loadingPage();
                        self.yeuCauLinhKSNK.YeuCauLinhVatTuChiTiets = self.yeuCauLinhKSNK.YeuCauLinhVatTuChiTiets.sort(function (a, b) { return (a.Nhom > b.Nhom) ? 1 : -1; });
                        self.yeuCauLinhKSNK.YeuCauLinhVatTuChiTiets.forEach(function (element) {
                            element.DuocDuyet = null;
                        });
                        self.yeuCauLinhKSNK.DuocDuyet = null;
                        self.apiService.post("YeuCauLinhKSNK/GuiLaiPhieuLinhBu", self.yeuCauLinhKSNK).subscribe(function (result) {
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.xacNhanGuiPhieuLinh = function () {
                    debugger;
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                            ...
                            if (result != undefined && result != null) {
                                ...
                                self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmComponent"], {
                                    ...
                                    if (res == "Yes") {
                                        ...
                                        self.apiService.post("YeuCauLinhKSNK/InPhieuLinhBuKSNK", self.inPhieuLinhBu).subscribe(function (resData) {
                                            if (resData != undefined && resData != null) {
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.loadingPageDaDuyet = function () {
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.closePopupLoadingDataDaDuyet = function () {
                    if (this.popupLoadingDataDaDuyet != undefined && this.popupLoadingDataDaDuyet != null) {
                        this.popupLoadingDataDaDuyet.close();
                    }
                };
                ...
                //   });
                // }
                PhieuLinhKSNKBuGuiLaiComponent.prototype.anHienButtonDuyet = function (event) {
                    if (event) {
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.disableNguoiTaoPhieu = function (event) {
                    if (event) {
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.GetTrangThaiPhieuLinh = function (id) {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].View)) {
                        ...
                        self.apiService.post("YeuCauLinhKSNK/GetTrangThaiPhieuLinhKSNK", newModel).subscribe(function (result) {
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.inPhieu = function () {
                    var self = this;
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.cancel = function () {
                    var data;
                ...
                PhieuLinhKSNKBuGuiLaiComponent.prototype.keyEvent = function (event) {
                ...
                return PhieuLinhKSNKBuGuiLaiComponent;
            }());
            PhieuLinhKSNKBuGuiLaiComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _phieu_linh_ksnk_thuong_popup_phieu_linh_ksnk_thuong_popup_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../phieu-linh-ksnk-thuong-popup/phieu-linh-ksnk-thuong-popup.component */ "./src/app/modules/main/nhap-xuat/kiem-soat-nhiem-khuan/yeu-cau-linh-ksnk/phieu-linh-ksnk-thuong-popup/phieu-linh-ksnk-thuong-popup.component.ts");
            var PhieuLinhKSNKThuongGuiLaiComponent = /** @class */ (function () {
                function PhieuLinhKSNKThuongGuiLaiComponent(apiService, dialog, notificationService, authService, router, route, ref) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.loaiDuocPhamHayVatTu = function (event) {
                    this.loai = event;
                };
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.loadingPage = function () {
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.loadingPageDaDuyet = function () {
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.closePopupLoadingDataDaDuyet = function () {
                    if (this.popupLoadingDataDaDuyet != undefined && this.popupLoadingDataDaDuyet != null) {
                        this.popupLoadingDataDaDuyet.close();
                    }
                };
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.luuPhieuLinhThuong = function () {
                    var self = this;
                    self.yeuCauLinhKSNK = self.shared.getSharedData();
                    self.validationErrors = [];
                    self.ref.detectChanges();
                        ...
                        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                                    self.loadingPage();
                                    self.yeuCauLinhKSNK.YeuCauLinhVatTuChiTiets = self.yeuCauLinhKSNK.YeuCauLinhVatTuChiTiets.sort(function (a, b) { return (a.Nhom > b.Nhom || a.STT > b.STT || a.Ten > b.Ten) ? 1 : -1; });
                                    self.yeuCauLinhKSNK.YeuCauLinhVatTuChiTiets.forEach(function (element) {
                                        element.DuocDuyet = false;
                                    });
                                    self.yeuCauLinhKSNK.IsLuu = true;
                                    self.yeuCauLinhKSNK.DuocDuyet = false;
                                    self.apiService.post("YeuCauLinhKSNK/GuiLaiPhieuLinhThuongKSNK", self.yeuCauLinhKSNK).subscribe(function (result) {
                                        if (result != undefined && result != null) {
                                            self.yeuCauLinhKSNK.LastModified = result.LastModified;
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.guiPhieuLinhThuong = function () {
                    var _this = this;
                    var self = this;
                    self.yeuCauLinhKSNK = self.shared.getSharedData();
                    self.validationErrors = [];
                                        ...
                                        if (result != undefined && result != null) {
                                            ...
                                            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                                                ...
                                                if (res == "Yes") {
                                                    ...
                                                    self.inPhieuLinhThuongs.TrangThai = _this.trangThaiVo.TrangThai;
                                                    self.apiService.post("YeuCauLinhKSNK/InPhieuLinhThuongKSNK", self.inPhieuLinhThuongs).subscribe(function (resData) {
                                                        if (resData != undefined && resData != null) {
                                                            self.closePopupLoadingDataDaDuyet();
                                                            self.inPhieuLinhThuong.Header = false;
                                                            self.dialog.open(_phieu_linh_ksnk_thuong_popup_phieu_linh_ksnk_thuong_popup_component__WEBPACK_IMPORTED_MODULE_17__["PhieuLinhKSNKThuongPopupComponent"], {
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.luuVaGuiDuyetLai = function () {
                    var _this = this;
                    var self = this;
                    self.yeuCauLinhKSNK = self.shared.getSharedData();
                    self.validationErrors = [];
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.inPhieu = function () {
                    var self = this;
                    if (self.trangThaiVo != undefined && self.trangThaiVo != null && self.trangThaiVo.TrangThai == true) { //Đã duyệt
                        self.loadingPageDaDuyet();
                        self.inPhieuLinhThuongs.Header = true;
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.anHienButtonDuyet = function (event) {
                    if (event) {
                        this.isHideDuyet = true;
                    }
                    else {
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.disableNguoiTaoPhieu = function (event) {
                    if (event) {
                        this.isDisabledNguoiTaoPhieu = true;
                    }
                    else {
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.GetTrangThaiPhieuLinh = function (id) {
                    var _this = this;
                    var self = this;
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.cancel = function () {
                    var data;
                    if (this.trangThaiDanhSach.holdQuery == '0') {
                        data = 0;
                    }
                ...
                PhieuLinhKSNKThuongGuiLaiComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 27 && !event.ctrlKey) {
                        //esc
                        this.cancel();
                        event.preventDefault();
                ...
                return PhieuLinhKSNKThuongGuiLaiComponent;
            }());
            PhieuLinhKSNKThuongGuiLaiComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            /* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
            var PhieuLinhKSNKThuongPopupComponent = /** @class */ (function () {
                function PhieuLinhKSNKThuongPopupComponent(dialog, sanitizer, dialogRef, data) {
                    this.dialog = dialog;
                    this.sanitizer = sanitizer;
                ...
                PhieuLinhKSNKThuongPopupComponent.prototype.ngOnInit = function () {
                    // this.src = "data:text/html;charset=utf-8," + encodeURIComponent(this.data);
                };
                PhieuLinhKSNKThuongPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                PhieuLinhKSNKThuongPopupComponent.prototype.getSharedPrintForm = function () {
                ...
                return PhieuLinhKSNKThuongPopupComponent;
            }());
            PhieuLinhKSNKThuongPopupComponent.ctorParameters = function () { return [
                { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuLinhKSNKThuongSharedComponent = /** @class */ (function () {
                function PhieuLinhKSNKThuongSharedComponent(apiService, notificationService, authService, ref, route, dialog) {
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.authService = authService;
                    this.ref = ref;
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.ngOnInit = function () {
                    ...
                    var valueChiTiet = this.route.snapshot.params.valueChiTiet;
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.getCurrentUser = function () {
                    var _this = this;
                    ...
                    if (this.yeuCauLinhKSNK.LaNguoiTaoPhieu == null) {
                        ...
                        this.apiService.get("YeuCauLinhKSNK/GetCurrentUserKSNK").subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.yeuCauLinhKSNK.NhanVienYeuCauId = resultData.NhanVienYeuCauId;
                                _this.yeuCauLinhKSNK.HoTenNguoiYeuCau = resultData.HoTen;
                            }
                        });
                    }
                };
                PhieuLinhKSNKThuongSharedComponent.prototype.chonKSNK = function (dataItem) {
                    if (dataItem != undefined && dataItem != null) {
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.getArrayKSNKBenhVienId = function () {
                    var _this = this;
                    this.KSNKGrid.VatTuBenhViens = new Array();
                    this.lstKSNKGrid.forEach(function (element) {
                        var KSNKBenhVien = new _yeu_cau_linh_ksnk_model__WEBPACK_IMPORTED_MODULE_6__["KSNKGridViewModelValidator"]();
                        KSNKBenhVien.VatTuBenhVienId = element.VatTuBenhVienId;
                        KSNKBenhVien.LaVatTuBHYT = element.LaVatTuBHYT;
                        _this.KSNKGrid.VatTuBenhViens.push(KSNKBenhVien);
                        console.log("data BenhViens: ", _this.KSNKGrid.VatTuBenhViens);
                    });
                };
                PhieuLinhKSNKThuongSharedComponent.prototype.themKSNK = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Add)) {
                        if (this.dangXuLy)
                            return;
                        this.dangXuLy = true;
                        self.apiService.post("YeuCauLinhKSNK/ThemLinhThuongKSNKGridVo", self.KSNKGrid).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.setValueForGridKSNK = function () {
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.pushDataKSNK = function () {
                    var _this = this;
                    this.yeuCauLinhKSNK.YeuCauLinhVatTuChiTiets = new Array();
                    this.lstKSNKGrid.forEach(function (obj) {
                        var model = new _yeu_cau_linh_ksnk_model__WEBPACK_IMPORTED_MODULE_6__["YeuCauLinhKSNKChiTiet"]();
                        ...
                        model.Id = obj.Id;
                        _this.yeuCauLinhKSNK.YeuCauLinhVatTuChiTiets.push(model);
                    });
                };
                PhieuLinhKSNKThuongSharedComponent.prototype.xoaKSNK = function (dataItem) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_13__["ConfirmComponent"], {
                        ...
                        if (result === 'Yes') {
                            _this.lstKSNKGrid.splice(_this.lstKSNKGrid.findIndex(function (x) { return x == dataItem; }), 1);
                            ...
                            _this.setValueForGridKSNK();
                        }
                    });
                };
                PhieuLinhKSNKThuongSharedComponent.prototype.huy = function () {
                    this.validationErrors = [];
                    this.KSNKGrid.Ten = null;
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.clearGridKSNK = function () {
                    this.huy();
                    this.lstKSNKGrid = [];
                    this.gridDataSource = {
                        data: this.lstKSNKGrid,
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].View)) {
                        var model = {
                        ...
                        self.apiService.post("YeuCauLinhKSNK/GetPhieuLinhThuongKSNK", model).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.yeuCauLinhKSNK = resultData;
                                if (_this.yeuCauLinhKSNK.LaNguoiTaoPhieu) {
                                    _this.disabledNguoiTaoPhieu.emit(true);
                                }
                                else {
                                    _this.disabledNguoiTaoPhieu.emit(false);
                                ...
                                resultData.YeuCauLinhVatTuChiTiets.forEach(function (element) {
                                    _this.lstKSNKGrid.push(element);
                                });
                                //this.getArrayKSNKBenhVienId();
                                _this.setValueForGridKSNK();
                            }
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.getSharedData = function () {
                    this.setValueForGridKSNK();
                    this.yeuCauLinhKSNK.YeuCauLinhVatTuChiTiets.forEach(function (element) {
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                ...
                PhieuLinhKSNKThuongSharedComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                return PhieuLinhKSNKThuongSharedComponent;
            }());
            PhieuLinhKSNKThuongSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaoPhieuLinhKSNKBuComponent = /** @class */ (function () {
                function TaoPhieuLinhKSNKBuComponent(apiService, dialog, notificationService, authService, router, ref, location, urlService, route) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                TaoPhieuLinhKSNKBuComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                TaoPhieuLinhKSNKBuComponent.prototype.loadingPage = function () {
                ...
                TaoPhieuLinhKSNKBuComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TaoPhieuLinhKSNKBuComponent.prototype.loadingPageHoanThanh = function () {
                ...
                TaoPhieuLinhKSNKBuComponent.prototype.closePopupLoadingDataHoanThanh = function () {
                    if (this.popupLoadingDataHoanThanh != undefined && this.popupLoadingDataHoanThanh != null) {
                        this.popupLoadingDataHoanThanh.close();
                    }
                };
                TaoPhieuLinhKSNKBuComponent.prototype.luuPhieuLinhKSNK = function (daGui) {
                    var self = this;
                    self.yeuCauLinhBuKSNK = self.shared.getSharedData();
                    if (self.yeuCauLinhBuKSNK.YeuCauVatTuBenhViens.every(function (z) { return !z.CheckBox; })) {
                        if (daGui) {
                            self.notificationService.showError("Vui lòng chọn ksnk muốn gửi phiếu.");
                        }
                        else {
                ...
                TaoPhieuLinhKSNKBuComponent.prototype.xacNhanTaoPhieuLinh = function () {
                    var _this = this;
                    var self = this;
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
                        ...
                        self.loadingPage();
                        self.apiService.post("YeuCauLinhKSNK/GuiPhieuLinhBuKSNK", self.yeuCauLinhBuKSNK).subscribe(function (result) {
                            if (result != undefined && result != null) {
                                ...
                                self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_15__["ConfirmComponent"], {
                                    ...
                                    if (res == "Yes") {
                                        ...
                                        self.apiService.post("YeuCauLinhKSNK/InPhieuLinhBuKSNK", self.inPhieuLinhThuongs).subscribe(function (resData) {
                                            if (resData != undefined && resData != null) {
                                        ...
                                        _this.router.navigate(['/nhap-xuat/kiem-soat-nhiem-khuan/yeu-cau-linh-ksnk']);
                                    }
                                });
                            }
                            // self.closePopupLoadingData();
                ...
                TaoPhieuLinhKSNKBuComponent.prototype.xacNhanLuuPhieuLinh = function () {
                    debugger;
                    var self = this;
                    self.validationErrors = [];
                    self.ref.detectChanges();
                ...
                TaoPhieuLinhKSNKBuComponent.prototype.cancel = function () {
                    this.location.back();
                };
                TaoPhieuLinhKSNKBuComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 27 && !event.ctrlKey) {
                        //esc
                        this.cancel();
                        event.preventDefault();
                ...
                TaoPhieuLinhKSNKBuComponent.prototype.XemPhieuLinh = function () {
                    var _this = this;
                    var self = this;
                    self.yeuCauLinhBuKSNK = self.shared.getSharedData();
                    self.validationErrors = [];
                            ...
                            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_15__["ConfirmComponent"], {
                                ...
                                if (res == "Yes") {
                                    ...
                                    var dataIn = {
                                        ...
                                        YeuCauVatTuBenhViens: self.yeuCauLinhBuKSNK.YeuCauVatTuBenhViens.filter(function (d) { return d.CheckBox; })
                                    };
                                    self.apiService.post("YeuCauLinhKSNK/InPhieuLinhBuKSNKXemTruoc", dataIn).subscribe(function (resData) {
                                        if (resData != undefined && resData != null) {
                                            self.closePopupLoadingDataHoanThanh();
                                            self.inPhieuLinhThuong.Header = false;
                                            self.dialog.open(_phieu_linh_ksnk_thuong_popup_phieu_linh_ksnk_thuong_popup_component__WEBPACK_IMPORTED_MODULE_18__["PhieuLinhKSNKThuongPopupComponent"], {
                ...
                return TaoPhieuLinhKSNKBuComponent;
            }());
            TaoPhieuLinhKSNKBuComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _phieu_linh_ksnk_thuong_popup_phieu_linh_ksnk_thuong_popup_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../phieu-linh-ksnk-thuong-popup/phieu-linh-ksnk-thuong-popup.component */ "./src/app/modules/main/nhap-xuat/kiem-soat-nhiem-khuan/yeu-cau-linh-ksnk/phieu-linh-ksnk-thuong-popup/phieu-linh-ksnk-thuong-popup.component.ts");
            var TaoPhieuLinhKSNKThuongComponent = /** @class */ (function () {
                function TaoPhieuLinhKSNKThuongComponent(apiService, dialog, notificationService, authService, router, ref) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                TaoPhieuLinhKSNKThuongComponent.prototype.ngOnInit = function () {
                ...
                TaoPhieuLinhKSNKThuongComponent.prototype.loadingPage = function () {
                ...
                TaoPhieuLinhKSNKThuongComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TaoPhieuLinhKSNKThuongComponent.prototype.luuPhieuLinhThuongKSNK = function () {
                    var self = this;
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
                                self.loadingPage();
                                self.yeuCauLinhThuongKSNK.YeuCauLinhVatTuChiTiets = self.yeuCauLinhThuongKSNK.YeuCauLinhVatTuChiTiets.sort(function (a, b) { return (a.Nhom > b.Nhom || a.STT > b.STT || a.Ten > b.Ten) ? 1 : -1; });
                                self.apiService.post("YeuCauLinhKSNK/GuiPhieuLinhThuongKSNK", self.yeuCauLinhThuongKSNK).subscribe(function (result) {
                ...
                TaoPhieuLinhKSNKThuongComponent.prototype.guiPhieuLinhThuongKSNK = function () {
                    var self = this;
                    self.yeuCauLinhThuongKSNK = self.shared.getSharedData();
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
                                ...
                                self.yeuCauLinhThuongKSNK.YeuCauLinhVatTuChiTiets = self.yeuCauLinhThuongKSNK.YeuCauLinhVatTuChiTiets.sort(function (a, b) { return (a.Nhom > b.Nhom || a.STT > b.STT) ? 1 : -1; });
                                self.apiService.post("YeuCauLinhKSNK/GuiPhieuLinhThuongKSNK", self.yeuCauLinhThuongKSNK).subscribe(function (result) {
                                    if (result != undefined && result != null) {
                                        self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                                        self.closePopupLoadingData();
                ...
                TaoPhieuLinhKSNKThuongComponent.prototype.cancel = function () {
                    this.router.navigate(['/nhap-xuat/kiem-soat-nhiem-khuan/yeu-cau-linh-ksnk']);
                };
                TaoPhieuLinhKSNKThuongComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 27 && !event.ctrlKey) {
                        //esc
                        this.cancel();
                        event.preventDefault();
                ...
                return TaoPhieuLinhKSNKThuongComponent;
            }());
            TaoPhieuLinhKSNKThuongComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var YeuCauLinhKSNKRoutingModule = /** @class */ (function () {
                function YeuCauLinhKSNKRoutingModule() {
                }
                return YeuCauLinhKSNKRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var YeuCauLinhKSNKModule = /** @class */ (function () {
                function YeuCauLinhKSNKModule() {
                }
                return YeuCauLinhKSNKModule;
            }());
...
//# sourceMappingURL=nhap-xuat-kiem-soat-nhiem-khuan-yeu-cau-linh-ksnk-yeu-cau-linh-ksnk-module-es5.js.map
//# sourceMappingURL=nhap-xuat-kiem-soat-nhiem-khuan-yeu-cau-linh-ksnk-yeu-cau-linh-ksnk-module-es5.js.map