...
let HopDongThauDuocPhamCreateComponent = class HopDongThauDuocPhamCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
HopDongThauDuocPhamCreateComponent.ctorParameters = () => [
...
let HopDongThauDuocPhamListComponent = class HopDongThauDuocPhamListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('HopDongThauDuocPham/ExportHopDongThauDuocPham', self.gridHdtCha._gridQueryInfo).subscribe(resultData => {
...
HopDongThauDuocPhamListComponent.ctorParameters = () => [
...
let HopDongThauDuocPhamRoutingModule = class HopDongThauDuocPhamRoutingModule {
};
...
let HopDongThauDuocPhamSharedComponent = class HopDongThauDuocPhamSharedComponent {
    ...
    ngOnInit() {
        ...
        const hopDongThauDuocPhamChiTietDataSource = new _hop_dong_thau_duoc_pham_model__WEBPACK_IMPORTED_MODULE_2__["HopDongThauDuocPhamChiTiet"]();
    ...
    onChangeDuocPham(event) {
        if (event) {
            ...
            if (event.DuocPhamBenhVienId != null && event.DuocPhamBenhVienId != 0 && event.SuDungTaiBenhVien == true) {
                ...
                this.apiService.get("HopDongThauDuocPham/GetThongTinPhanNhomDuocPhamBenhVien?id=" + event.DuocPhamBenhVienId).subscribe(resultData => {
                    if (resultData) {
    ...
    Add() {
        ...
        this.apiService.post("HopDongThauDuocPham/KiemTraHopDongThauDuocPhamChiTiet", this.hopDongThauDuocPhamChiTiet).subscribe(resultValid => {
            ...
            this.hopDongThauDuocPhamSource.HopDongThauDuocPhamChiTiets.push(hopDongChiTietDataSource);
            // add into data
            let hopDongChiTiet = new _hop_dong_thau_duoc_pham_model__WEBPACK_IMPORTED_MODULE_2__["HopDongThauDuocPhamChiTiet"]();
    ...
    checkExistOnAmendation(duocPhamId, position) {
        let len = this.hopDongThauDuocPhamSource.HopDongThauDuocPhamChiTiets.length;
        for (let i = 0; i < len; i++) {
            if (i === position) {
                continue;
...
HopDongThauDuocPhamSharedComponent.ctorParameters = () => [
...
let HopDongThauDuocPhamUpdateComponent = class HopDongThauDuocPhamUpdateComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
class HopDongThauDuocPham {
    constructor(Id = 0, NhaThauId = 0, NhaThau = null, SoHopDong = null, SoQuyetDinh = null, CongBo = null, NgayKy = null, NgayHieuLuc = null, NgayHetHan = null, LoaiThau = null, TenLoaiThau = null, LoaiThuocThau = null, TenLoaiThuocThau = null, NhomThau = null, GoiThau = null, Nam = 0, HopDongThauDuocPhamChiTiets = [], NhapKhoDuocPhamChiTiets = []) {
        this.Id = Id;
...
class HopDongThauDuocPhamChiTiet {
    constructor(HopDongThauDuocPhamId = 0, DuocPhamId = 0, DuocPham = null, Gia = 0, GiaDisplay = null, SoLuong = 0, SoLuongDisplay = null, SoLuongDaCap = 0, Id = 0, IdGrid = null, SuDungTaiBenhVien = false, SuDungTaiBenhVienDisplay = null, //SuDungTaiBenhVien ==true ?"Có":"Không",
    MaDuocPhamBenhVien = null, 
    // public DuocPhamBenhVienPhanNhomId : number = null  ,
    // public DuocPhamBenhVienPhanNhomModelText: string = null,
    // BVHD-3454
    DuocPhamBenhVienId = null, DuocPhamBenhVienPhanNhomId = null, DuocPhamBenhVienPhanNhomConId = null, TenDuocPhamBenhVienPhanNhomCon = null, DuocPhamBenhVienPhanNhomChaId = null, TenDuocPhamBenhVienPhanNhomCha = null, MaDuocPhamTemps = []) {
...
let HopDongThauDuocPhamModule = class HopDongThauDuocPhamModule {
};
...
let HopDongThauDuocPhamService = class HopDongThauDuocPhamService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'HopDongThauDuocPham';
    }
};
HopDongThauDuocPhamService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
