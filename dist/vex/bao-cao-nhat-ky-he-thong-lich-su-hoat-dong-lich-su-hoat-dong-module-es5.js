...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-nhat-ky-he-thong-lich-su-hoat-dong-lich-su-hoat-dong-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuHoatDongListComponent = /** @class */ (function () {
                function LichSuHoatDongListComponent(dialog, apiService, notificationService, authService) {
                    this.dialog = dialog;
                ...
                LichSuHoatDongListComponent.prototype.ngOnInit = function () {
                ...
                LichSuHoatDongListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.searchHistoryAction();
                    }
                };
                LichSuHoatDongListComponent.prototype.searchHistoryAction = function () {
                    var NguoiTaoQueryString = null;
                    var HoatDongQueryString = null;
                    ...
                    var queryString = "{\"NguoiTaoId\":" + NguoiTaoQueryString + ",\"HoatDong\":" + HoatDongQueryString + ",\"TuNgay\":" + TuNgayQueryString + ",\"DenNgay\":" + DenNgayQueryString + ",\"NoiDung\":" + NoiDungQueryString + "}";
                    this.gridChild._additionalSearchString = queryString;
                    this.gridChild.search();
                };
                LichSuHoatDongListComponent.prototype.reset = function () {
                    ...
                    this.lsHoatDongInfo.HoatDongId = 0;
                    this.displayResetButton = false;
                    var queryString = "{\"NguoiTaoId\":0,\"HoatDong\":0,\"TuNgay\":null,\"DenNgay\":null,\"NoiDung\":null}";
                    this.gridChild._additionalSearchString = queryString;
                    this.gridChild.search();
                };
                LichSuHoatDongListComponent.prototype.ConvertDateTime = function (datime) {
                ...
                LichSuHoatDongListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("NhatKyHeThong/ExportLichSuHoatDong", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return LichSuHoatDongListComponent;
            }());
            LichSuHoatDongListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuHoatDongRoutingModule = /** @class */ (function () {
                function LichSuHoatDongRoutingModule() {
                }
                return LichSuHoatDongRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var searchLichSuHoatDong = /** @class */ (function () {
                function searchLichSuHoatDong(HoatDongId, TenHoatDong, NguoiTaoId, TenNguoiTao, TuNgay, DenNgay, skip, take, pageSize, searchString, additionalSearchString, sort, lazyLoadPage) {
                    if (HoatDongId === void 0) { HoatDongId = 0; }
                    if (TenHoatDong === void 0) { TenHoatDong = "Tất cả"; }
                    if (NguoiTaoId === void 0) { NguoiTaoId = 0; }
                    if (TenNguoiTao === void 0) { TenNguoiTao = "Tất cả"; }
                ...
                return searchLichSuHoatDong;
            }());
            var LichSuHoatDongInfo = /** @class */ (function () {
                function LichSuHoatDongInfo(HoatDongId, TenHoatDong, NguoiTaoId, TenNguoiTao, TuNgay, DenNgay, NoiDung) {
                    if (HoatDongId === void 0) { HoatDongId = 0; }
                    if (TenHoatDong === void 0) { TenHoatDong = "Tất cả"; }
                    if (NguoiTaoId === void 0) { NguoiTaoId = 0; }
                    if (TenNguoiTao === void 0) { TenNguoiTao = "Tất cả"; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuHoatDongModule = /** @class */ (function () {
                function LichSuHoatDongModule() {
                }
                return LichSuHoatDongModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuHoatDongService = /** @class */ (function (_super) {
                __extends(LichSuHoatDongService, _super);
                function LichSuHoatDongService(apiservice) {
                    var _this = _super.call(this, apiservice) || this;
                    _this.controllerName = 'NhatKyHeThong';
                    return _this;
                }
                return LichSuHoatDongService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            LichSuHoatDongService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-nhat-ky-he-thong-lich-su-hoat-dong-lich-su-hoat-dong-module-es5.js.map
//# sourceMappingURL=bao-cao-nhat-ky-he-thong-lich-su-hoat-dong-lich-su-hoat-dong-module-es5.js.map