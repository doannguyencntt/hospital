...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-phieu-xuat-hoa-chat-xet-nghiem-phieu-xuat-hoa-chat-xet-nghiem-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuXuatHoaChatXetNghiemChiTietPopupComponent = /** @class */ (function () {
                function PhieuXuatHoaChatXetNghiemChiTietPopupComponent(data, sanitizer, dialog, apiService, authService, notificationService) {
                    this.data = data;
                ...
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.ngOnInit = function () {
                ...
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.showDataXetNghiem = function (baoCaoSearch) {
                    var _this = this;
                    this._isLoading = true;
                    this._isLoadingTotalPage = true;
                    this.apiService.post("BaoCao/GetDataPhieuXuatHoaChatChiTietForGrid", baoCaoSearch).subscribe(function (resultData) {
                ...
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        var loading_1 = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_12__["LoadingComponent"], {
                            disableClose: true,
                            width: '200px',
                            height: '90px',
                ...
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.pageChange = function (event) {
                ...
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.reFresh = function () {
                    this.skip = 0;
                    this.showDataXetNghiem(this.baoCaoSearch);
                };
                PhieuXuatHoaChatXetNghiemChiTietPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return PhieuXuatHoaChatXetNghiemChiTietPopupComponent;
            }());
            PhieuXuatHoaChatXetNghiemChiTietPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoPhieuXuatHoaChatXetNghiemListComponent = /** @class */ (function () {
                function BaoCaoPhieuXuatHoaChatXetNghiemListComponent(apiService, dialog, notificationService, cd) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.cd = cd;
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.pageChange = function (event) {
                    this.skip = event.skip;
                    if (this.dataSource.data.length == 0) {
                        this.XemBaoCao();
                    }
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.dataTimeDefaut = function () {
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.getMinWidthColumn = function (minWidth) {
                    var widthParent = jQuery("#baoCaoGrid").parent().width();
                    var widthScreen = (widthParent != undefined ? Math.round(widthParent) : jQuery(window).width()) - 120;
                    var totalWidth = this.gridColumns.filter(function (item) {
                        return item.Width != null;
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.detailExpand = function (event) {
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.onDataBoundChild = function (event) {
                    console.log(event);
                    this.dataToSumThanhTien = event.Data;
                };
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.reFresh = function () {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.XemBaoCao = function () {
                    if (this.baoCaoSearch.TuNgay == null || this.baoCaoSearch.DenNgay == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                    }
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.changeValueStart = function () {
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.selectionChangeKhoHoaChat = function (dataItem) {
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.XemChiTiet = function (dataItem) {
                    var self = this;
                ...
                BaoCaoPhieuXuatHoaChatXetNghiemListComponent.prototype.loadDanhSachPhieuXuatXetNghiem = function (skip, take) {
                    var _this = this;
                    this.baoCaoSearch.Skip = skip;
                    this.baoCaoSearch.Take = take;
                    this.apiService.post("BaoCao/GetDataPhieuXuatHoaChatForGrid", this.baoCaoSearch).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.dataSource = {
                                data: resultData.Data,
                                total: resultData.TotalRowCount
                ...
                return BaoCaoPhieuXuatHoaChatXetNghiemListComponent;
            }());
            BaoCaoPhieuXuatHoaChatXetNghiemListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoPhieuXuatHoaChatXetNghiemRoutingModule = /** @class */ (function () {
                function BaoCaoPhieuXuatHoaChatXetNghiemRoutingModule() {
                }
                return BaoCaoPhieuXuatHoaChatXetNghiemRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTonKhoSearch = /** @class */ (function () {
                function BaoCaoTonKhoSearch(FromDate, ToDate, TuNgay, DenNgay, KhoId, DuocPhamId, MayXetNghiemId, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
            ...
            var ThongTinChiTietXetNghiem = /** @class */ (function () {
                function ThongTinChiTietXetNghiem(KhoId, DuocPhamId, MayXetNghiemId, TenDuocPham, TenKho, TuNgay, DenNgay) {
                    if (KhoId === void 0) { KhoId = null; }
                    if (DuocPhamId === void 0) { DuocPhamId = null; }
                    if (MayXetNghiemId === void 0) { MayXetNghiemId = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoPhieuXuatTonKhoXetNghiemModule = /** @class */ (function () {
                function BaoCaoPhieuXuatTonKhoXetNghiemModule() {
                }
                return BaoCaoPhieuXuatTonKhoXetNghiemModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoPhieuXuatHoaChatXetNghiemService = /** @class */ (function (_super) {
                __extends(BaoCaoPhieuXuatHoaChatXetNghiemService, _super);
                function BaoCaoPhieuXuatHoaChatXetNghiemService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoPhieuXuatHoaChatXetNghiemService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoPhieuXuatHoaChatXetNghiemService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-phieu-xuat-hoa-chat-xet-nghiem-phieu-xuat-hoa-chat-xet-nghiem-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-phieu-xuat-hoa-chat-xet-nghiem-phieu-xuat-hoa-chat-xet-nghiem-module-es5.js.map