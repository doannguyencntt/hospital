(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["kham-doan-kham-doan-goi-chung-suc-khoe-kham-doan-goi-kham-chung-suc-khoe-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanGoiKhamChungSucKhoeChonFilePopupComponent = /** @class */ (function () {
                function KhamDoanGoiKhamChungSucKhoeChonFilePopupComponent(dialog, dialogRef, cdRef) {
                    this.dialog = dialog;
                ...
                KhamDoanGoiKhamChungSucKhoeChonFilePopupComponent.prototype.ngOnInit = function () {
                };
                KhamDoanGoiKhamChungSucKhoeChonFilePopupComponent.prototype.showPopupLoadingData = function () {
                ...
                KhamDoanGoiKhamChungSucKhoeChonFilePopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                KhamDoanGoiKhamChungSucKhoeChonFilePopupComponent.prototype.uploadFileDone = function (event) {
                    this.fileExcel = event;
                    this.cdRef.detectChanges();
                };
                KhamDoanGoiKhamChungSucKhoeChonFilePopupComponent.prototype.close = function (result) {
                    if (result === void 0) { result = null; }
                    this.dialogRef.close(result);
                };
                return KhamDoanGoiKhamChungSucKhoeChonFilePopupComponent;
            }());
            KhamDoanGoiKhamChungSucKhoeChonFilePopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanGoiKhamChungSucKhoeDetailPopupComponent = /** @class */ (function () {
                function KhamDoanGoiKhamChungSucKhoeDetailPopupComponent(authService, dialog, notificationService, apiService, location, ref, router, route) {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.showPopupLoadingData = function () {
                    if (this.popupLoadingData == undefined
                        || this.popupLoadingData == null
                        || this.popupLoadingData.openDialogs == undefined
                        || (this.popupLoadingData.openDialogs != undefined && this.popupLoadingData.openDialogs.length == 0)) {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.showPopupSavingData = function () {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.closePopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.gioiTinhNuChange = function (event) {
                    if (event == false) {
                        this.dichVuKhamSucKhoeDoan.CoMangThai = null;
                        this.dichVuKhamSucKhoeDoan.KhongMangThai = null;
                    }
                };
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.mangThaiChange = function (event, text) {
                    if (text == 'Co') {
                        if (event == true) {
                            this.dichVuKhamSucKhoeDoan.KhongMangThai = null;
                        }
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.lapGDChange = function (event, text) {
                    if (text == 'Co') {
                        if (event == true) {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.loaiGiaChange = function (event, text) {
                    var _this = this;
                    this.dichVuStringId = null;
                    if (text == 'dichvu') {
                        this.validationErrors = [];
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.changeHinhThucKhamBenh = function () {
                    this.validationErrors = [];
                    this.dichVuKhamSucKhoeDoan.GoiKhamSucKhoeChungNoiThucHienIds = [];
                };
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.getById = function (id) {
                    var _this = this;
                    //IsCopy
                    var self = this;
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.huyDichVu = function () {
                    this.validationErrors = [];
                ...
                //   });
                // }
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.setValueForGridDichVu = function () {
                    this.gridDataSource = {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.pushDataDichVu = function () {
                    var _this = this;
                    ...
                    this.lstDichVuKhamSucKhoeDoanGrid.forEach(function (obj) {
                        var model = new _kham_doan_goi_kham_chung_suc_khoe_model__WEBPACK_IMPORTED_MODULE_14__["DichVuKhamSucKhoeDoanChungViewModel"]();
                        model.Id = obj.Id;
                        ...
                        model.GoiKhamSucKhoeChungNoiThucHienIds.forEach(function (element) {
                            var GoiKhamChung = new _kham_doan_goi_kham_chung_suc_khoe_model__WEBPACK_IMPORTED_MODULE_14__["GoiKhamSucKhoeNoiThucHienChungViewModel"]();
                        ...
                        _this.dichVuKhamSucKhoeDoan.GoiKhamSucKhoeChungNoiThucHiens = new Array();
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.themDichVu = function () {
                    ...
                    self.dichVuKhamSucKhoeDoan.GoiKhamSucKhoeChungNoiThucHienIds.forEach(function (element) {
                        var GoiKhamChung = new _kham_doan_goi_kham_chung_suc_khoe_model__WEBPACK_IMPORTED_MODULE_14__["GoiKhamSucKhoeNoiThucHienChungViewModel"]();
                        GoiKhamChung.PhongBenhVienId = element;
                    ...
                    self.apiService.post("KhamDoan/ThemDichVuKhamDoanChung", self.dichVuKhamSucKhoeDoan).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.getDichVuGrid = function (dataItem) {
                    var _this = this;
                    this.dichVuStringId = null;
                    this.huyDichVu();
                    ...
                    dataItem.GoiKhamSucKhoeChungNoiThucHienIds.forEach(function (element) {
                        _this.dichVuKhamSucKhoeDoan.GoiKhamSucKhoeChungNoiThucHienIds.push(element);
                    });
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.capNhatDichVu = function () {
                    var self = this;
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    ...
                    self.apiService.post("KhamDoan/CapNhatDichVuKhamDoanChung", dataUpdate).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.xoaDichVu = function (dataItem) {
                    var _this = this;
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.Luu = function () {
                    var _this = this;
                    var self = this;
                        ...
                        if (res == "Yes") {
                            ...
                            if (_this.id != null && _this.id != 0 && !_this.IsCopy) {
                                if (_this.authService.hasPermission(_this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Update)) {
                                    ...
                                    self.apiService.post("KhamDoan/CapNhatGoiKhamSucKhoeDoanChung", self.khamSucKhoeDoan).subscribe(function () {
                                ...
                                if (_this.authService.hasPermission(_this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Add)) {
                                    ...
                                    self.apiService.post("KhamDoan/ThemGoiKhamSucKhoeDoanChung", self.khamSucKhoeDoan).subscribe(function () {
                                        if (_this.dataKhamDoan != undefined && _this.dataKhamDoan != null) {
                                            _this.afterChangedFromHopDongKham.emit(true);
                                        }
                                        else {
                ...
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.checkGoiChung = function (event) {
                    this.khamSucKhoeDoan.GoiDichVuPhatSinh = false;
                    this.khamSucKhoeDoan.GoiChung = event;
                };
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.checkGoiDichVuPhatSinh = function (event) {
                    this.khamSucKhoeDoan.GoiChung = false;
                    this.khamSucKhoeDoan.GoiDichVuPhatSinh = event;
                };
                KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.prototype.quayLai = function () {
                ...
                return KhamDoanGoiKhamChungSucKhoeDetailPopupComponent;
            }());
            KhamDoanGoiKhamChungSucKhoeDetailPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanGoiKhamChungSucKhoeListComponent = /** @class */ (function () {
                function KhamDoanGoiKhamChungSucKhoeListComponent(authService, notificationService, route, location, dialog, apiService, router) {
                    this.authService = authService;
                    this.notificationService = notificationService;
                    this.route = route;
                    this.location = location;
                ...
                KhamDoanGoiKhamChungSucKhoeListComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_9__["DocumentType"].KhamDoanGoiKhamSucKhoe;
                ...
                KhamDoanGoiKhamChungSucKhoeListComponent.prototype.searchChanges = function (event) {
                    if ((event == null || event == "") && this.strAdditionalSearchString != "") {
                        this.timKiemNangCao();
                    }
                };
                KhamDoanGoiKhamChungSucKhoeListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiemNangCao();
                    }
                };
                KhamDoanGoiKhamChungSucKhoeListComponent.prototype.clearSearch = function () {
                    this.timKiemObj.SearchString = null;
                    this.grid.searchString = null;
                    this.timKiemNangCao();
                };
                KhamDoanGoiKhamChungSucKhoeListComponent.prototype.timKiemNangCao = function () {
                ...
                KhamDoanGoiKhamChungSucKhoeListComponent.prototype.xuLyXuatExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("KhamDoan/ExportDanhSachKhamSucKhoeDoanChung", this.grid._gridQueryInfo).subscribe(function (res) {
                ...
                KhamDoanGoiKhamChungSucKhoeListComponent.prototype.showPopupChiTiet = function (id, isCopy) {
                ...
                KhamDoanGoiKhamChungSucKhoeListComponent.prototype.xoa = function (Id) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Delete)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_22__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                _this.apiService.post("KhamDoan/XoaGoiKhamSucKhoeDoanChung?id=" + Id).subscribe(function () {
                ...
                return KhamDoanGoiKhamChungSucKhoeListComponent;
            }());
            KhamDoanGoiKhamChungSucKhoeListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanGoiChungKhamSucKhoeRoutingModule = /** @class */ (function () {
                function KhamDoanGoiChungKhamSucKhoeRoutingModule() {
                }
                return KhamDoanGoiChungKhamSucKhoeRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamSucKhoeDoanChungViewModel = /** @class */ (function () {
                function KhamSucKhoeDoanChungViewModel(Id, Ma, Ten, GoiChung, CoSuDungGoiChung, GoiDichVuPhatSinh, IsKetThucHopDong, IsCopy, DichVuKhamSucKhoeDoans, GoiKhamSucKhoeChungDichVuKhamBenhs, GoiKhamSucKhoeChungDichVuDichVuKyThuats) {
                    if (Id === void 0) { Id = 0; }
                    if (Ma === void 0) { Ma = null; }
                    if (Ten === void 0) { Ten = null; }
                    ...
                    if (GoiKhamSucKhoeChungDichVuKhamBenhs === void 0) { GoiKhamSucKhoeChungDichVuKhamBenhs = []; }
                    if (GoiKhamSucKhoeChungDichVuDichVuKyThuats === void 0) { GoiKhamSucKhoeChungDichVuDichVuKyThuats = []; }
                    this.Id = Id;
                    this.Ma = Ma;
                    this.Ten = Ten;
            ...
            var DichVuKhamSucKhoeDoanChungViewModel = /** @class */ (function () {
                function DichVuKhamSucKhoeDoanChungViewModel(Id, Nhom, MaNhomDichVuBenhVien, MaNhomDichVuBenhVienCha, TenNhom, 
                // public DichVuKyThuatBenhVienId: number = null,
                DichVuKyThuatBenhVienId, ChuyenKhoaKhamSucKhoe, TenDichVuKyThuatBenhVien, NhomGiaDichVuKyThuatBenhVienId, DonGiaBenhVien, DonGiaUuDai, DonGiaChuaUuDai, HinhThucKhamBenh, GioiTinhNam, GioiTinhNu, CoMangThai, KhongMangThai, DaLapGiaDinh, ChuaLapGiaDinh, SoTuoiTu, SoTuoiDen, SoTuoiDisplay, NoiThucHienString, Loai, SoLan, LaDichVuKham, GoiKhamSucKhoeChungNoiThucHienIds, GoiKhamSucKhoeChungNoiThucHiens, DichVuKhamBenhIds, DichVuKyThuatIds) {
                    if (Id === void 0) { Id = 0; }
                    ...
                    if (GoiKhamSucKhoeChungNoiThucHienIds === void 0) { GoiKhamSucKhoeChungNoiThucHienIds = []; }
                    if (GoiKhamSucKhoeChungNoiThucHiens === void 0) { GoiKhamSucKhoeChungNoiThucHiens = []; }
                ...
                return DichVuKhamSucKhoeDoanChungViewModel;
            }());
            var GoiKhamSucKhoeNoiThucHienChungViewModel = /** @class */ (function () {
                function GoiKhamSucKhoeNoiThucHienChungViewModel(GoiKhamSucKhoeDichVuKhamBenhId, GoiKhamSucKhoeDichVuDichVuKyThuatId, PhongBenhVienId) {
                ...
                return GoiKhamSucKhoeNoiThucHienChungViewModel;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanGoiKhamChungSucKhoeModule = /** @class */ (function () {
                function KhamDoanGoiKhamChungSucKhoeModule() {
                }
                return KhamDoanGoiKhamChungSucKhoeModule;
            }());
...
//# sourceMappingURL=kham-doan-kham-doan-goi-chung-suc-khoe-kham-doan-goi-kham-chung-suc-khoe-module-es5.js.map
//# sourceMappingURL=kham-doan-kham-doan-goi-chung-suc-khoe-kham-doan-goi-kham-chung-suc-khoe-module-es5.js.map