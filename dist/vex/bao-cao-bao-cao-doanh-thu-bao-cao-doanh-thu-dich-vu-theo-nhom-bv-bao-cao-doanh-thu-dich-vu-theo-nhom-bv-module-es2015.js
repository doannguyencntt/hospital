...
let BaoCaoDoanhThuDichVuTheoNhomBenhVienRoutingModule = class BaoCaoDoanhThuDichVuTheoNhomBenhVienRoutingModule {
};
...
let BaoCaoDoanhThuDichVuTheoNhomBenhVienModule = class BaoCaoDoanhThuDichVuTheoNhomBenhVienModule {
};
...
class BaoCaoDoanhThuTheoNhomBenhVienSearch {
    constructor(TuNgay = null, DenNgay = null, TuNgayFormat = null, DenNgayFormat = null) {
        this.TuNgay = TuNgay;
...
class BaoCaoThuTienVienPhi {
    constructor(STT = 0, Nhom = null, MaTN = null, HoVaTen = null, NamSinh = null, GioiTinh = null, SoBenhAn = null, NoiDung = null, NgayThu = null, NgayThuStr = null, NguoiGioiThieu = null, KhamBenh = null, XetNghiem = null, NoiSoi = null, NoiSoiTMH = null, SieuAm = null, XQuang = null, CTScan = null, MRI = null, DienTimDienNao = null, TDCNDoLoangXuong = null, ThuThuat = null, PhauThuat = null, NgayGiuong = null, DVKhac = null, Thuoc = null, VTYT = null) {
        this.STT = STT;
        this.Nhom = Nhom;
        this.MaTN = MaTN;
...
class BaoCaoDoanhThuTheoNhomBenhVienQueryInfo {
    constructor(TuNgay = null, DenNgay = null, NhanVienId = 0, PhongBenhVienId = 0, Skip = 0, Take = 10, PageSize = 10, SearchString = "", AdditionalSearchString = "", 
...
let BaoCaoDoanhThuDichVuTheoNhomBVComponent = class BaoCaoDoanhThuDichVuTheoNhomBVComponent {
    //================================End value total===========================
        ...
        switch (field) {
            case 'KhamBenh':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.KhamBenh, 0);
                }
            case 'XetNghiem':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.XetNghiem, 0);
                }
            case 'NoiSoi':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.NoiSoi, 0);
                }
            case 'NoiSoiTMH':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.NoiSoiTMH, 0);
                }
            case 'SieuAm':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.SieuAm, 0);
                }
            case 'XQuang':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.XQuang, 0);
                }
            case 'CTScan':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.CTScan, 0);
                }
            case 'MRI':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.MRI, 0);
                }
            case 'DienTimDienNao':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.DienTimDienNao, 0);
                }
            case 'TDCNDoLoangXuong':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.TDCNDoLoangXuong, 0);
                }
            case 'ThuThuat':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.ThuThuat, 0);
                }
            case 'PhauThuat':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.PhauThuat, 0);
                }
            case 'NgayGiuong':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.NgayGiuong, 0);
                }
            case 'DVKhac':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.DVKhac, 0);
                }
            case 'Thuoc':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.Thuoc, 0);
                }
            case 'VTYT':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.VTYT, 0);
                }
            case 'TongCong':
                if (this.dataToSumAllThanhTien != undefined && this.dataToSumAllThanhTien != null) {
                    return this.dataToSumAllThanhTien.reduce((sum, item) => sum + item.TongCong, 0);
                }
        }
    }
    searchRefresh() {
    ...
    returnDetail() {
        let denNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].formatDateTime(this.search.RangeDateTimeFilter.DateEnd, "mm/dd/yyyy");
        let tuNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].formatDateTime(this.search.RangeDateTimeFilter.DateStart, "mm/dd/yyyy");
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetBaoCaoDoanhThuDichVuTheoNhomBenhVienForGridAsync", this.baoCaoDoanhThuTheoNhomBenhVienQueryInfo).subscribe(resultData => {
...
BaoCaoDoanhThuDichVuTheoNhomBVComponent.ctorParameters = () => [
