...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-nhom-khoa-phong-khoa-phong-nhan-vien-khoa-phong-nhan-vien-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaPhongNhanVienCreateComponent = /** @class */ (function () {
                function KhoaPhongNhanVienCreateComponent(router) {
                    this.router = router;
                }
                KhoaPhongNhanVienCreateComponent.prototype.ngOnInit = function () {
                };
                KhoaPhongNhanVienCreateComponent.prototype.onCreated = function () { this.router.navigate(['/danh-muc/nhom-khoa-phong/khoa-phong-nhan-vien']); };
                return KhoaPhongNhanVienCreateComponent;
            }());
            KhoaPhongNhanVienCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaPhongNhanVienListComponent = /** @class */ (function () {
                function KhoaPhongNhanVienListComponent(notificationService, authService, dialog, apiService) {
                ...
                KhoaPhongNhanVienListComponent.prototype.ngOnInit = function () {
                ...
                KhoaPhongNhanVienListComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('KhoaPhongNhanVien/ExportKhoaPhongNhanVien', self.gridChild._gridQueryInfo).subscribe(function (resultData) {
                ...
                KhoaPhongNhanVienListComponent.prototype.showPopupLoadingData = function () {
                ...
                KhoaPhongNhanVienListComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return KhoaPhongNhanVienListComponent;
            }());
            KhoaPhongNhanVienListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaPhongNhanVienRoutingModule = /** @class */ (function () {
                function KhoaPhongNhanVienRoutingModule() {
                }
                return KhoaPhongNhanVienRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaPhongNhanVienSharedComponent = /** @class */ (function () {
                function KhoaPhongNhanVienSharedComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.khoaPhongNhanVien = {};
                    this.isCreate = true;
                }
                KhoaPhongNhanVienSharedComponent.prototype.ngOnInit = function () {
                ...
                KhoaPhongNhanVienSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.khoaPhongNhanVien = resultData;
                        }
                    });
                };
                KhoaPhongNhanVienSharedComponent.prototype.getSharedData = function () {
                    return this.khoaPhongNhanVien;
                };
                return KhoaPhongNhanVienSharedComponent;
            }());
            KhoaPhongNhanVienSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaPhongNhanVienUpdateComponent = /** @class */ (function () {
                function KhoaPhongNhanVienUpdateComponent(router) {
                    this.router = router;
                }
                KhoaPhongNhanVienUpdateComponent.prototype.ngOnInit = function () {
                };
                KhoaPhongNhanVienUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-khoa-phong/khoa-phong-nhan-vien']);
                };
                return KhoaPhongNhanVienUpdateComponent;
            }());
            KhoaPhongNhanVienUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaPhongNhanVienModule = /** @class */ (function () {
                function KhoaPhongNhanVienModule() {
                }
                return KhoaPhongNhanVienModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var KhoaPhongNhanVienService = /** @class */ (function (_super) {
                __extends(KhoaPhongNhanVienService, _super);
                function KhoaPhongNhanVienService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'KhoaPhongNhanVien';
                    return _this;
                }
                return KhoaPhongNhanVienService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            KhoaPhongNhanVienService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
...
//# sourceMappingURL=danh-muc-nhom-he-thong-nhom-khoa-phong-khoa-phong-nhan-vien-khoa-phong-nhan-vien-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-nhom-khoa-phong-khoa-phong-nhan-vien-khoa-phong-nhan-vien-module-es5.js.map