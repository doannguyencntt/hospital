...
let DanhSachYeuCauLinhThuocComponent = class DanhSachYeuCauLinhThuocComponent {
    ...
    InPhieuLinh(data) {
        ...
        if (data.LoaiPhieuLinh == 1 || data.LoaiPhieuLinh == 2) { //lĩnh dự trù(dự trù) hoặc lĩnh bù
            ...
            self.apiService.post("YeuCauLinhDuocPham/InPhieuLinhThuongDuocPham", self.inPhieuLinhThuong).subscribe(resData => {
            ...
            this.apiService.post("YeuCauLinhDuocPham/InLinhDuocPham", dataIn).subscribe(resultData => {
                let dialogRef = this.dialog.open(_in_linh_duoc_pham_in_linh_duoc_pham_component__WEBPACK_IMPORTED_MODULE_15__["InLinhDuocPhamComponent"], {
                    width: '1000px',
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_21__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('YeuCauLinhDuocPham/ExportDanhSachLinhDuocPham', self.exportQueryInfoQueryInfo).subscribe(resultData => {
...
DanhSachYeuCauLinhThuocComponent.ctorParameters = () => [
...
let InLinhDuocPhamComponent = class InLinhDuocPhamComponent {
    ...
    getSharedPrintForm() {
        ...
        const templateHeaderGayNghien = '<div class=\'wrap\'><div class=\'content\'>PHIẾU LĨNH DƯỢC PHẨM</div></div>';
...
InLinhDuocPhamComponent.ctorParameters = () => [
...
let PhieuLinhThuocBuGuiLaiComponent = class PhieuLinhThuocBuGuiLaiComponent {
            ...
            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmComponent"], {
                ...
                if (res == "Yes") {
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
                        ...
                        self.loadingPage();
                        self.apiService.post("YeuCauLinhDuocPham/GuiLaiPhieuLinhBu", self.yeuCauLinhDuocPham).subscribe((result) => {
                            if (result != undefined && result != null) {
                                ...
                                self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmComponent"], {
                                    ...
                                    if (res == "Yes") {
                                        ...
                                        self.apiService.post("YeuCauLinhDuocPham/InPhieuLinhBuDuocPham", self.inPhieuLinhBu).subscribe(resData => {
                                            if (resData != undefined && resData != null) {
                                                self.closePopupLoadingData();
    ...
    GetTrangThaiPhieuLinh(id) {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].View)) {
            self.apiService.get("YeuCauLinhDuocPham/GetTrangThaiPhieuLinh?phieuLinhId=" + id).subscribe((result) => {
...
PhieuLinhThuocBuGuiLaiComponent.ctorParameters = () => [
...
let PhieuLinhThuocBuPopupComponent = class PhieuLinhThuocBuPopupComponent {
...
PhieuLinhThuocBuPopupComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"] },
...
let PhieuLinhThuocBuSharedComponent = class PhieuLinhThuocBuSharedComponent {
    ...
    ganDieuKienLoadGridDuocPham(linhTuKhoId, linhVeKhoId) {
        if (this.trangThaiVo != undefined) {
        ...
        if (event != undefined && event != null) {
            if (this.isCreate) {
                ...
                event.Data.forEach(element => {
                    let yeuCauDuocPhamBenhVien = new _yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["YeuCauDuocPhamBenhVienViewModel"]();
    ...
    getById(id) {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].View)) {
            self.loadingPage();
            self.apiService.get("YeuCauLinhDuocPham/GetYeuCauLinhDuocPhamBuTao?id=" + id).subscribe(resultData => {
                if (resultData != undefined && resultData != null) {
                    self.closePopupLoadingData();
    ...
    ganSLThucTeChange(soLuong, duocPhamBenhVienId) {
...
PhieuLinhThuocBuSharedComponent.ctorParameters = () => [
...
let PhieuLinhThuocThuongGuiLaiComponent = class PhieuLinhThuocThuongGuiLaiComponent {
    constructor(dialog, route, notificationService, authService, apiService, router, ref) {
        this.dialog = dialog;
        this.route = route;
        this.notificationService = notificationService;
            ...
            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                ...
                if (res == "Yes") {
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                        ...
                        self.apiService.post("YeuCauLinhDuocPham/GuiLaiPhieuLinhThuong", self.yeuCauLinhDuocPham).subscribe((result) => {
                            if (result != undefined && result != null) {
                                self.yeuCauLinhDuocPham.LastModified = result.LastModified;
...
PhieuLinhThuocThuongGuiLaiComponent.ctorParameters = () => [
...
let PhieuLinhThuocThuongPopupComponent = class PhieuLinhThuocThuongPopupComponent {
    constructor(dialog, sanitizer, dialogRef, data) {
        this.dialog = dialog;
        this.sanitizer = sanitizer;
        this.dialogRef = dialogRef;
...
PhieuLinhThuocThuongPopupComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"] },
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
...
let PhieuLinhThuocThuongSharedComponent = class PhieuLinhThuocThuongSharedComponent {
    ...
    getCurrentUser() {
        ...
        if (this.yeuCauLinhDuocPham.LaNguoiTaoPhieu == null) {
            ...
            if (this.phieuLinhId != null) {
                this.apiService.get("YeuCauLinhDuocPham/GetNhanVienDuyet?id=" + this.phieuLinhId).subscribe(resultData => {
                    if (resultData != undefined && resultData != null) {
    ...
    getDataXetNghiemWhenChangeDP(duocPhamBenhVienId) {
        this.queryMayXetNghiem.ParameterDependencies = '{DuocPhamBenhVienId:' + duocPhamBenhVienId + '}';
        this.queryMayXetNghiem.Take = 50;
        this.apiService.post("YeuCauLinhDuocPham/GetAllMayXetNghiemYeuCauLinh", this.queryMayXetNghiem).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                this.bindMayXNKhiChangeData(resultData, _yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["ChangeDuocPhamBenhVienOrXetNghiem"].DuocPhamBenhVien);
    ...
    bindMayXNKhiChangeData(dataItem, changeDuocPhamBenhVienOrXetNghiem) {
        this.DanhSachMayXetNghiemId = null;
        this.DanhSachTenMayXetNghiem = null;
        let danhSachMayXetNghiemId = Array();
        let danhSachMayXetNghiemTen = Array();
    ...
    getArrayDuocPhamBenhVienId() {
        ...
        this.lstDuocPhamGrid.forEach(element => {
            let duocPhamBenhVien = new _yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["DuocPhamGridViewModelValidator"]();
    ...
    xoaDuocPham(dataItem) {
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
            ...
            if (result === 'Yes') {
                ...
                this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_10__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
    ...
    themDuocPham() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Add)) {
            if (this.dangXuLy)
                return;
            this.dangXuLy = true;
            self.apiService.post("YeuCauLinhDuocPham/ThemLinhThuongDuocPhamGridVo", self.duocPhamGrid).subscribe(resultData => {
                if (resultData != undefined && resultData != null) {
    ...
    pushDataDuocPham() {
        ...
        this.lstDuocPhamGrid.forEach(obj => {
            let model = new _yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["YeuCauLinhDuocPhamChiTiet"]();
    ...
    getById(id) {
        var self = this;
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].View)) {
            self.apiService.get("YeuCauLinhDuocPham/GetPhieuLinhThuongDuocPham?id=" + id).subscribe(resultData => {
                if (resultData != undefined && resultData != null) {
...
PhieuLinhThuocThuongSharedComponent.ctorParameters = () => [
...
let PhieuLinhThuocTrucTiepGuiLaiComponent = class PhieuLinhThuocTrucTiepGuiLaiComponent {
    ...
    inPhieu() {
        ...
        if (this.trangThai.DuocDuyet == false) {
            ...
            this.apiService.post("YeuCauLinhDuocPham/InPhieuLinhTrucTiepDuocPham", this.inPhieuLinhTrucTiep).subscribe(resData => {
                if (resData != undefined && resData != null) {
                    this.inPhieuLinhTrucTiep.Header = false;
                    this.dialog.open(_phieu_linh_thuoc_truc_tiep_popup_phieu_linh_thuoc_truc_tiep_popup_component__WEBPACK_IMPORTED_MODULE_16__["PhieuLinhThuocTrucTiepPopupComponent"], {
                        disableClose: false,
                        width: '1200px',
                        height: 'auto',
                        //height: '600',
            ...
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                ...
                if (res == "Yes") {
                    ...
                    if (kiemTraCoDuocPhamKhongDuTon.length == 0) {
                        ...
                        this.dialog.open(_popup_thong_bao_dp_khong_the_tao_popup_thong_bao_dp_khong_the_tao_component__WEBPACK_IMPORTED_MODULE_18__["PopupThongBaoDpKhongTheTaoComponent"], {
                            disableClose: false,
                            width: '500px',
    ...
    getItemKhongDuTon(danhSachYeuCauDuocPhamBenhVien) {
        let data = [];
        let dataKhongChoTao = [];
        let dataList = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_17__["process"])(danhSachYeuCauDuocPhamBenhVien, this.state);
    ...
    newcreate() {
        this.loadingPage();
        this.apiService.post("YeuCauLinhDuocPham/GuiLaiPhieuLinhTrucTiep", this.yeuCauLinhDuocPham).subscribe((result) => {
            this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_15__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
            if (result != undefined && result != null) {
                this.closePopupLoadingData();
                this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                    disableClose: false,
...
PhieuLinhThuocTrucTiepGuiLaiComponent.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_7__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_9__["NotificationService"] },
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"] },
...
let PhieuLinhThuocTrucTiepPopupComponent = class PhieuLinhThuocTrucTiepPopupComponent {
    constructor(data, sanitizer, dialog) {
        this.data = data;
        this.sanitizer = sanitizer;
        this.dialog = dialog;
...
PhieuLinhThuocTrucTiepPopupComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"] },
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }
];
...
let PhieuLinhThuocTrucTiepSharedComponent = class PhieuLinhThuocTrucTiepSharedComponent {
    ...
    ngOnInit() {
        this.route.queryParams.subscribe(params => {
            ...
            if (khoLinhId != undefined && phongLinhVeId != undefined && khoLinhId > 0) {
                ...
                this.apiService.post('YeuCauLinhDuocPham/ThongTinDanhSachCanLinh?idKhoLinh=' + khoLinhId + "&phongLinhVeId=" + phongLinhVeId).subscribe(resultData => {
                    ...
                    this.apiService.post('YeuCauLinhDuocPham/GetData', { idKhoLinh: parseInt(khoLinhId), phongDangNhapId: phongLinhVeId, dateSearchStart: "", dateSearchEnd: "" }).subscribe(resultData => {
                        this.gridDataSource = {
                            data: resultData,
    ...
    getTrangThaiDuyet(id) {
        this.apiService.post('YeuCauLinhDuocPham/GetTrangThaiDuyet?IdYeuCauLinh=' + id).subscribe(resultData => {
            ...
            if (this.trangThaiDuyet == true) {
                this.trangThaiYeuCau.emit(new _yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_2__["TrangThaiDuyetYeuCauLinh"]("Đã duyệt", resultData));
                this.apiService.post('YeuCauLinhDuocPham/GetDaDuyet?IdYeuCauLinh=' + id).subscribe(resultData => {
                ...
                this.trangThaiYeuCau.emit(new _yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_2__["TrangThaiDuyetYeuCauLinh"]("Từ chối duyệt", resultData));
                this.apiService.post('YeuCauLinhDuocPham/GetDaDuyet?IdYeuCauLinh=' + id).subscribe(resultData => {
                    this.daDuyet.NguoiDuyet = resultData.NguoiDuyet;
                    this.daDuyet.NgayDuyet = resultData.NgayDuyet;
                    if (this.daDuyet.NguoiDuyet != null && this.daDuyet.NgayDuyet != null) {
                ...
                this.trangThaiYeuCau.emit(new _yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_2__["TrangThaiDuyetYeuCauLinh"]("Đang chờ duyệt", resultData));
    ...
    getById(id) {
        ...
        self.apiService.get("YeuCauLinhDuocPham/GetALL?id=" + id).subscribe(resultData => {
            if (resultData != undefined && resultData != null) {
                ...
                self.apiService.post('YeuCauLinhDuocPham/ThongTinLinhTuKhoDaTao?idYeuCauLinhDP=' + id).subscribe(resultDatas => {
                    ...
                    this.apiService.post('YeuCauLinhDuocPham/GetDataDaTao?idKhoLinh=' + resultData.KhoXuatId + '&idYeuCauLinhDuocPham=' + id + '&phongDangNhapId=' + resultDatas[0].NoiChiDinhId + "&trangThai=" + trangThai).subscribe(resultData => {
                        this.gridDataSource = {
                            data: resultData,
                            total: resultData.length
                        };
    ...
    timkiem() {
        if (this.khoLinhIdSearch != undefined && this.phongLinhIdSearch != undefined && this.khoLinhIdSearch > 0) {
            ...
            this.KiemTraCheckGrid = true;
            this.loadingPage();
            this.apiService.post('YeuCauLinhDuocPham/ThongTinDanhSachCanLinh?idKhoLinh=' + this.khoLinhIdSearch + "&phongLinhVeId=" + this.phongLinhIdSearch).subscribe(resultData => {
                this.linhTrucTiepDuocPhamObject.NhanVienYeuCauId = this.getNhanVienId.AccessToken.Id;
                this.linhTrucTiepDuocPhamObject.KhoNhapId = resultData.LinhVePhongId;
                this.LinhVeKhoa = resultData.LinhVeKhoa;
                this.ngayYeuCau = new Date();
                ...
                this.dateBatDau = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].formatDateTime(this.searchDanhSachThongDuocPham.TuNgay, "mm/dd/yyyy");
                this.dateKetThuc = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].formatDateTime(this.searchDanhSachThongDuocPham.DenNgay, "mm/dd/yyyy");
                this.apiService.post('YeuCauLinhDuocPham/GetData', { idKhoLinh: this.khoLinhIdSearch, phongDangNhapId: this.phongLinhIdSearch, dateSearchStart: this.dateBatDau, dateSearchEnd: this.dateKetThuc }).subscribe(
...
PhieuLinhThuocTrucTiepSharedComponent.ctorParameters = () => [
...
let PhieuLinhTrucTiepChoGoiSharedComponent = class PhieuLinhTrucTiepChoGoiSharedComponent {
    constructor(notificationService, cdRef, dialog, apiService, route, baseService, authService) {
        this.notificationService = notificationService;
        this.cdRef = cdRef;
        this.dialog = dialog;
    ...
    getById(id) {
        this.linhTrucTiepDuocPhamObject.Id = id;
        this.apiService.get("YeuCauLinhDuocPham/GetALL?id=" + id).subscribe(resultData => {
            if (resultData != undefined && resultData != null) {
                this.phieuLinhTrucTiep.KeyId = resultData.KhoXuatId;
                this.phieuLinhTrucTiep.DisplayName = resultData.TenKhoXuat;
                let vo = {
                ...
                this.apiService.post('YeuCauLinhDuocPham/ThongTinLinhTuKhoDaTao?idYeuCauLinhDP=' + id).subscribe(resultDatas => {
                    this.linhTrucTiepDuocPhamObject.NhanVienYeuCauId = resultDatas[0].NhanVienYeuCauId;
                    this.linhTrucTiepDuocPhamObject.KhoNhapId = resultDatas[0].LinhVePhongId;
                    this.LinhVeKhoa = resultDatas[0].LinhVeKhoa;
                    this.nguoiYeuCau = resultDatas[0].NguoiYeuCau;
                    ...
                    this.ngayYeuCau = dataTime;
                    this.ghiChu = resultDatas[0].GhiChu;
                    this.apiService.post('YeuCauLinhDuocPham/GetDataGridYeuCauLinhDuocPhamLuuTamThoi', vo).subscribe(resultData => {
                        this.gridDataSource = {
                            data: resultData,
                            total: resultData.length
                        };
    ...
    timkiem() {
        this.loadingPage();
        this.apiService.get("YeuCauLinhDuocPham/GetALL?id=" + this.yeuCauLinhDuocPhamId).subscribe(resultData => {
            if (resultData != undefined && resultData != null) {
                this.phieuLinhTrucTiep.KeyId = resultData.KhoXuatId;
                this.phieuLinhTrucTiep.DisplayName = resultData.TenKhoXuat;
                let vo = {
                    ...
                    TuNgay: src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].formatDateTime(this.searchDanhSachThongDuocPham.TuNgay, "mm/dd/yyyy"),
                    DenNgay: src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].formatDateTime(this.searchDanhSachThongDuocPham.DenNgay, "mm/dd/yyyy")
                };
                this.apiService.post('YeuCauLinhDuocPham/ThongTinLinhTuKhoDaTao?idYeuCauLinhDP=' + this.yeuCauLinhDuocPhamId).subscribe(resultDatas => {
                    this.linhTrucTiepDuocPhamObject.NhanVienYeuCauId = resultDatas[0].NhanVienYeuCauId;
                    this.linhTrucTiepDuocPhamObject.KhoNhapId = resultDatas[0].LinhVePhongId;
                    this.LinhVeKhoa = resultDatas[0].LinhVeKhoa;
                    this.nguoiYeuCau = resultDatas[0].NguoiYeuCau;
...
PhieuLinhTrucTiepChoGoiSharedComponent.ctorParameters = () => [
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_3__["NotificationService"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_9__["MatDialog"] },
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
...
let PopupThongBaoDpKhongTheTaoComponent = class PopupThongBaoDpKhongTheTaoComponent {
...
PopupThongBaoDpKhongTheTaoComponent.ctorParameters = () => [
...
let TaoPhieuLinhThuocBuComponent = class TaoPhieuLinhThuocBuComponent {
    ...
    xacNhanTaoPhieuLinh() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Add)) {
            self.yeuCauLinhDuocPham.DaGui = true;
            self.loadingPage();
            self.apiService.post("YeuCauLinhDuocPham/GuiPhieuLinhBu", self.yeuCauLinhDuocPham).subscribe((result) => {
                if (result != undefined && result != null) {
            ...
            if (self.yeuCauLinhDuocPham.YeuCauDuocPhamBenhViens.every(z => !z.CheckBox)) {
                ...
                self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                    ...
                    if (res == "Yes") {
                        ...
                        self.apiService.post("YeuCauLinhDuocPham/InPhieuLinhBuDuocPhamXemTruoc", dataIn).subscribe(resData => {
                            if (resData != undefined && resData != null) {
                                self.closePopupLoadingDataHoanThanh();
                                self.inPhieuLinhBu.Header = false;
                                self.dialog.open(_phieu_linh_thuoc_bu_popup_phieu_linh_thuoc_bu_popup_component__WEBPACK_IMPORTED_MODULE_18__["PhieuLinhThuocBuPopupComponent"], {
...
TaoPhieuLinhThuocBuComponent.ctorParameters = () => [
...
let TaoPhieuLinhThuocThuongComponent = class TaoPhieuLinhThuocThuongComponent {
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmComponent"], {
            ...
            if (res == "Yes") {
                ...
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Add)) {
                    ...
                    self.loadingPage();
                    self.yeuCauLinhDuocPham.YeuCauLinhDuocPhamChiTiets = self.yeuCauLinhDuocPham.YeuCauLinhDuocPhamChiTiets.sort((a, b) => (a.Nhom > b.Nhom || a.STT > b.STT || a.Ten > b.Ten) ? 1 : -1);
                    self.apiService.post("YeuCauLinhDuocPham/GuiPhieuLinhThuong", self.yeuCauLinhDuocPham).subscribe((result) => {
                        if (result != undefined && result != null) {
...
TaoPhieuLinhThuocThuongComponent.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
...
let TaoPhieuLinhThuocTrucTiepComponent = class TaoPhieuLinhThuocTrucTiepComponent {
    constructor(apiService, dialog, notificationService, authService, router, 
        ...
        if (self.yeuCauLinhDuocPham.YeuCauDuocPhamBenhIds.length == 0) {
            ...
            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                ...
                if (res == "Yes") {
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Add)) {
                        self.loadingPage();
                        let objInDuocPhamXemTruoc = new _yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_13__["XemTruocPhieuLinhThuocTrucTiep"]();
                        ...
                        self.apiService.post("YeuCauLinhDuocPham/XemTruocInPhieuLinhTrucTiepDuocPham", objInDuocPhamXemTruoc).subscribe(resData => {
                            if (resData != undefined && resData != null) {
    ...
    getItemKhongDuTon(danhSachYeuCauDuocPhamBenhVien) {
        let data = [];
        let dataKhongChoTao = [];
        let dataList = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_21__["process"])(danhSachYeuCauDuocPhamBenhVien, this.state);
        dataList.data.forEach(element => {
            let tongSlYeuCau = 0;
            let tenDuocPham = "";
            let slTon = 0;
    ...
    newcreate() {
        var self = this;
        self.loadingPage();
        self.apiService.post("YeuCauLinhDuocPham/GuiPhieuLinhTrucTiep", self.yeuCauLinhDuocPham).subscribe((result) => {
            ...
            if (result != undefined && result != null) {
                ...
                self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                    ...
                    if (res == "Yes") {
                        ...
                        self.apiService.post("YeuCauLinhDuocPham/InPhieuLinhTrucTiepDuocPham", self.inPhieuLinhTrucTiep).subscribe(resData => {
                            if (resData != undefined && resData != null) {
                                self.inPhieuLinhTrucTiep.Header = false;
                                self.dialog.open(_phieu_linh_thuoc_truc_tiep_popup_phieu_linh_thuoc_truc_tiep_popup_component__WEBPACK_IMPORTED_MODULE_18__["PhieuLinhThuocTrucTiepPopupComponent"], {
                                    disableClose: false,
...
TaoPhieuLinhThuocTrucTiepComponent.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_11__["NotificationService"] },
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"] },
...
let YeuCauLinhThuocRoutingModule = class YeuCauLinhThuocRoutingModule {
};
...
let YeuCauLinhThuocModule = class YeuCauLinhThuocModule {
};
