...
let CongTyBhtnCreateComponent = class CongTyBhtnCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() { }
...
CongTyBhtnCreateComponent.ctorParameters = () => [
...
let CongTyBhtnListComponent = class CongTyBhtnListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel('CongTyBhtn/ExportCongTyBhtn', this.gridChild._gridQueryInfo).subscribe(res => {
...
CongTyBhtnListComponent.ctorParameters = () => [
...
let CongTyBhtnRoutingModule = class CongTyBhtnRoutingModule {
};
...
let CongTyBhtnSharedComponent = class CongTyBhtnSharedComponent {
...
CongTyBhtnSharedComponent.ctorParameters = () => [
...
let CongTyBhtnUpdateComponent = class CongTyBhtnUpdateComponent {
...
CongTyBhtnUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let CongTyBhtnModule = class CongTyBhtnModule {
};
...
let CongTyBhtnService = class CongTyBhtnService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'CongTyBhtn';
    }
};
CongTyBhtnService.ctorParameters = () => [
