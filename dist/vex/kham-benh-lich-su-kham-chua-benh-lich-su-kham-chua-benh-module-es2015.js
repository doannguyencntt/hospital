...
let LichSuKhamChuaBenhListComponent = class LichSuKhamChuaBenhListComponent {
    ...
    timKiemNangCao() {
        ...
        this.apiService.post("LichSuKhamChuaBenh/TimKiemNguoiBenhDaTiepNhan", this.timKiemNangCaoObj).subscribe((res) => {
    ...
    showPopupTimKiemNguoiBenh() {
        let dialogRef = this.dialog.open(_lich_su_kham_chua_benh_nguoi_benh_popup_lich_su_kham_chua_benh_nguoi_benh_popup_component__WEBPACK_IMPORTED_MODULE_19__["LichSuKhamChuaBenhNguoiBenhPopupComponent"], {
            disableClose: false,
            width: '1400px',
            height: '600px',
    ...
    getLichSuKhamChuaBenhTheoNguoiBenh() {
        if (this.nguoiBenhId != null && this.nguoiBenhId != 0) {
            this.showPopupLoadingData();
            this.apiService.get("LichSuKhamChuaBenh/GetLichSuKhamChuaBenhTheoNguoiBenh?nguoiBenhId=" + this.nguoiBenhId).subscribe((res) => {
                this.closePopupLoadingData();
                if (res) {
    ...
    showPopupLoadingData(typeLoading = src_app_shared_enum_kham_benh_enum__WEBPACK_IMPORTED_MODULE_18__["EnumTypeLoadingData"].View) {
    ...
    xemBenhAn(dataItem, hienBenhAn = true) {
    ...
    getThongTinPhieuInLichSuKham(objQueryInfo) {
        this.showPopupLoadingData();
        this.apiService.postExportPdf('LichSuKhamChuaBenh/GetFilePDFLichSuKhamChuaBenhFromHtml', objQueryInfo).subscribe(file => {
...
LichSuKhamChuaBenhListComponent.ctorParameters = () => [
...
let LichSuKhamChuaBenhNguoiBenhPopupComponent = class LichSuKhamChuaBenhNguoiBenhPopupComponent {
...
LichSuKhamChuaBenhNguoiBenhPopupComponent.ctorParameters = () => [
...
let LichSuKhamChuaBenhRoutingModule = class LichSuKhamChuaBenhRoutingModule {
};
...
class LichSuKhamChuaBenhTimKiemNangCao {
    constructor(SearchString = null, NamSinh = null, SoDienThoai = null, CoQuyenXemKhamBenh = false, CoQuyenXemCanLamSang = false, CoQuyenXemYLenh = false, TuNgayDenNgay = new LichSuKhamChuaBenhTimKiemTuNgayDenNgay()) {
...
class LichSuKhamChuaBenhTimKiemTuNgayDenNgay {
...
class PhieuInLichSuKhamQueryInfo {
    constructor(YeuCauTiepNhanId = null, LoaiLichSuKhamChuaBenh = null, LoaiLichSuKhamChuaBenhChiTiet = null, YeuCauDichVuId = null, NoiTruBenhAnId = null, LoaiHoSoDieuTriNoiTru = null, // ở BE là enum
    NoiTruHoSoKhacId = null, Hosting = null, HienLichSuNoiTru = false) {
...
let LichSuKhamChuaBenhModule = class LichSuKhamChuaBenhModule {
};
