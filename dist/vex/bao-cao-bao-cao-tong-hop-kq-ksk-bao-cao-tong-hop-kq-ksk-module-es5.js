...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-tong-hop-kq-ksk-bao-cao-tong-hop-kq-ksk-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTongHopKqKskListComponent = /** @class */ (function () {
                function BaoCaoTongHopKqKskListComponent(apiService, dialog, authService, notificationService) {
                ...
                BaoCaoTongHopKqKskListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoTongHopKqKskListComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                BaoCaoTongHopKqKskListComponent.prototype.xem = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
                        if (this.baoCaoSearch.CongTyId == null || this.baoCaoSearch.HopDongId == null) {
                            this.notificationService.showError("Yêu cầu nhập công ty và hợp đồng");
                        ...
                        this.apiService.post("BaoCao/GetHTMLBaoCaoTongHopKetQuaKSK", this.baoCaoSearch).subscribe(function (resultData) {
                ...
                BaoCaoTongHopKqKskListComponent.prototype.changeLookupHopDong = function (event) {
                    if (event && event.length > 0 && this.baoCaoSearch.CongTyId && !this.baoCaoSearch.HopDongId) {
                        this.baoCaoSearch.HopDongId = event[0].KeyId;
                    }
                };
                BaoCaoTongHopKqKskListComponent.prototype.changeCongTy = function (event) {
                    this.baoCaoSearch.CongTyId = event;
                    this.baoCaoSearch.HopDongId = null;
                };
                return BaoCaoTongHopKqKskListComponent;
            }());
            BaoCaoTongHopKqKskListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTongHopKqKskRoutingModule = /** @class */ (function () {
                function BaoCaoTongHopKqKskRoutingModule() {
                }
                return BaoCaoTongHopKqKskRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoTongHopKetQuaKSK = /** @class */ (function () {
                function BaoCaoTongHopKetQuaKSK(FromDate, ToDate, CongTyId, HopDongId, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTongHopKqKskModule = /** @class */ (function () {
                function BaoCaoTongHopKqKskModule() {
                }
                return BaoCaoTongHopKqKskModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTongHopKqKskService = /** @class */ (function (_super) {
                __extends(BaoCaoTongHopKqKskService, _super);
                function BaoCaoTongHopKqKskService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoTongHopKqKskService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoTongHopKqKskService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-tong-hop-kq-ksk-bao-cao-tong-hop-kq-ksk-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-tong-hop-kq-ksk-bao-cao-tong-hop-kq-ksk-module-es5.js.map