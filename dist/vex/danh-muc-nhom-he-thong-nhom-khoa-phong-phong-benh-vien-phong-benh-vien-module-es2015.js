...
let PhongBenhVienCreateComponent = class PhongBenhVienCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
PhongBenhVienCreateComponent.ctorParameters = () => [
...
let PhongBenhVienListComponent = class PhongBenhVienListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('PhongBenhVien/ExportKhoaPhongPhongKham', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
PhongBenhVienListComponent.ctorParameters = () => [
...
let PhongBenhVienRoutingModule = class PhongBenhVienRoutingModule {
};
...
let PhongBenhVienSharedComponent = class PhongBenhVienSharedComponent {
...
PhongBenhVienSharedComponent.ctorParameters = () => [
...
let PhongBenhVienUpdateComponent = class PhongBenhVienUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
PhongBenhVienUpdateComponent.ctorParameters = () => [
...
let PhongBenhVienModule = class PhongBenhVienModule {
};
...
let PhongBenhVienService = class PhongBenhVienService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'PhongBenhVien';
    }
};
PhongBenhVienService.ctorParameters = () => [
