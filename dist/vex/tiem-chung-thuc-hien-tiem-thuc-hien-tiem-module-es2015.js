...
let ThucHienTiemRoutingModule = class ThucHienTiemRoutingModule {
};
...
let ThucHienTiemModule = class ThucHienTiemModule {
};
...
let ThucHienTiemService = class ThucHienTiemService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'TiemChung';
    }
};
ThucHienTiemService.ctorParameters = () => [
...
let ThucHienTiemComponent = class ThucHienTiemComponent {
    constructor() {
