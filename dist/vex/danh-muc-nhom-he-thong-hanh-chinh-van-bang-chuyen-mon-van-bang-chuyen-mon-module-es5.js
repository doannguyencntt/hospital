...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-hanh-chinh-van-bang-chuyen-mon-van-bang-chuyen-mon-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VanBangChuyenMonCreateComponent = /** @class */ (function () {
                function VanBangChuyenMonCreateComponent(router) {
                    this.router = router;
                }
                VanBangChuyenMonCreateComponent.prototype.ngOnInit = function () {
                };
                VanBangChuyenMonCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/hanh-chinh/van-bang-chuyen-mon']);
                };
                return VanBangChuyenMonCreateComponent;
            }());
            VanBangChuyenMonCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VanBangChuyenMonListComponent = /** @class */ (function () {
                function VanBangChuyenMonListComponent(authService, dialog, notificationService, apiService) {
                ...
                VanBangChuyenMonListComponent.prototype.ngOnInit = function () {
                ...
                VanBangChuyenMonListComponent.prototype.updateTinhTrang = function (id, isDisabled) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Delete)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                self.apiService.post("VanBangChuyenMon/KichHoatTrangThai?id=" + id).subscribe(function () {
                ...
                VanBangChuyenMonListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("VanBangChuyenMon/ExportVanBangChuyenMon", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return VanBangChuyenMonListComponent;
            }());
            VanBangChuyenMonListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VanBangChuyenMonRoutingModule = /** @class */ (function () {
                function VanBangChuyenMonRoutingModule() {
                }
                return VanBangChuyenMonRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VanBangChuyenMonShareComponent = /** @class */ (function () {
                function VanBangChuyenMonShareComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.trinhDoChuyenMon = {};
                    this.isCreate = true;
                }
                VanBangChuyenMonShareComponent.prototype.ngOnInit = function () {
                ...
                VanBangChuyenMonShareComponent.prototype.getSharedData = function () {
                    return this.trinhDoChuyenMon;
                };
                VanBangChuyenMonShareComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.trinhDoChuyenMon = resultData;
                    });
                };
                return VanBangChuyenMonShareComponent;
            }());
            VanBangChuyenMonShareComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _van_bang_chuyen_mon_share_van_bang_chuyen_mon_share_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../van-bang-chuyen-mon-share/van-bang-chuyen-mon-share.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/hanh-chinh/van-bang-chuyen-mon/van-bang-chuyen-mon-share/van-bang-chuyen-mon-share.component.ts");
            var VanBangChuyenMonUpdateComponent = /** @class */ (function () {
                function VanBangChuyenMonUpdateComponent(router) {
                    this.router = router;
                }
                VanBangChuyenMonUpdateComponent.prototype.ngOnInit = function () {
                };
                VanBangChuyenMonUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/hanh-chinh/van-bang-chuyen-mon']);
                };
                return VanBangChuyenMonUpdateComponent;
            }());
            VanBangChuyenMonUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_van_bang_chuyen_mon_share_van_bang_chuyen_mon_share_component__WEBPACK_IMPORTED_MODULE_3__["VanBangChuyenMonShareComponent"], { static: true })
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VanBangChuyenMonModule = /** @class */ (function () {
                function VanBangChuyenMonModule() {
                }
                return VanBangChuyenMonModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VanBangChuyenMonService = /** @class */ (function (_super) {
                __extends(VanBangChuyenMonService, _super);
                function VanBangChuyenMonService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'VanBangChuyenMon';
                    return _this;
                }
                return VanBangChuyenMonService;
            }(_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            VanBangChuyenMonService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-hanh-chinh-van-bang-chuyen-mon-van-bang-chuyen-mon-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-hanh-chinh-van-bang-chuyen-mon-van-bang-chuyen-mon-module-es5.js.map