...
let TiepNhanNoiTruBenhAnPopupComponent = class TiepNhanNoiTruBenhAnPopupComponent {
    ...
    getThongTinBenhAn(yeuCauTiepNhanId) {
        ...
        this.apiService
            ...
            if (resultData !== undefined && resultData != null) {
                ...
                if (this.dataYeuCauTiepNhan.NoiTruBenhAn.LoaiBenhAn == src_app_shared_enum_dieu_tri_noi_tru_enum__WEBPACK_IMPORTED_MODULE_11__["LoaiBenhAn"].TreSoSinh) {
                    this.IsTreSoSinh = true;
                }
                var ngaySinh = new Date(this.dataYeuCauTiepNhan.ThangSinh +
                    "/" +
    ...
    xuLyThem() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_8__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.validationErrors = [];
                    this.apiService.post("DieuTriNoiTru/XuLyTaoBenhAn", this.dataYeuCauTiepNhan)
                        .subscribe(() => {
                        this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_10__["SystemMessage"].ActionSuccessfully, ["Tạo bệnh án"]));
    ...
    xuLyLuu() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_8__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.validationErrors = [];
                    this.apiService.put("DieuTriNoiTru/XuLyCapNhatBenhAn", this.dataYeuCauTiepNhan)
                        .subscribe(() => {
                        this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_10__["SystemMessage"].ActionSuccessfully, ["Chỉnh sửa"]));
                        this.close(true);
                    }, (err) => {
                        this.validationErrors = err.ValidationErrors;
                        if (err.Message != "Validation Failed") {
...
TiepNhanNoiTruBenhAnPopupComponent.ctorParameters = () => [
...
let TiepNhanNoiTruChiDinhPopupComponent = class TiepNhanNoiTruChiDinhPopupComponent {
    constructor(authService, dialog, notificationService, apiService, data, dialogRef) {
        this.authService = authService;
        this.dialog = dialog;
        this.notificationService = notificationService;
    ...
    xuLyLuuChiDinh() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Add)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_8__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.validationErrors = [];
                    this.apiService.post("DieuTriNoiTru/XuLyChiDinhEkipVaDichVuGiuongNoiTru", this.chiDinh)
                        .subscribe(() => {
                        this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].View)) {
            self.dialog.open(_kham_benh_kham_benh_lan_kham_hien_tai_lan_kham_hien_tai_su_dung_goi_dich_vu_popup_lan_kham_hien_tai_su_dung_goi_dich_vu_popup_component__WEBPACK_IMPORTED_MODULE_13__["LanKhamHienTaiSuDungGoiDichVuPopupComponent"], {
                ...
                if (dichVuGiuong) {
                    ...
                    this.apiService.post("KhamBenh/GetDichVuGiuongBenhVien", query).subscribe(res => {
...
TiepNhanNoiTruChiDinhPopupComponent.ctorParameters = () => [
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"] },
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
...
let TiepNhanNoiTruHuyNhapVienPopupComponent = class TiepNhanNoiTruHuyNhapVienPopupComponent {
    constructor(dialogRef, data, authService, notificationService, apiService, dialog) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.authService = authService;
        this.notificationService = notificationService;
    ...
    XuLyHuyNhapVien() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
            ...
            this.apiService.put("DieuTriNoiTru/XuLyHuyNhapVien", obj)
                .subscribe(() => {
                this.closePopupLoadingData();
                this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Hủy nhập viện"]));
                this.close('ok');
            }, (err) => {
                this.validationErrors = err.ValidationErrors;
                if (err.Message != "Validation Failed") {
...
TiepNhanNoiTruHuyNhapVienPopupComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"] },
...
let TiepNhanNoiTruListComponent = class TiepNhanNoiTruListComponent {
    constructor(authService, notificationService, route, location, dialog, apiService) {
        this.authService = authService;
        this.notificationService = notificationService;
        this.route = route;
    ...
    xuLyXuatExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("DieuTriNoiTru/ExportDanhSachTiepNhanNoiTru", this.gridChild._gridQueryInfo).subscribe(res => {
...
TiepNhanNoiTruListComponent.ctorParameters = () => [
...
let TiepNhanNoiTruRoutingModule = class TiepNhanNoiTruRoutingModule {
};
...
let TiepNhanNoiTruSoDoGiuongPopupComponent = class TiepNhanNoiTruSoDoGiuongPopupComponent {
    constructor(dialog, apiService, data, notificationService, dialogRef) {
        this.dialog = dialog;
        this.apiService = apiService;
        this.data = data;
        this.notificationService = notificationService;
...
TiepNhanNoiTruSoDoGiuongPopupComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
...
let TiepNhanNoiTruThongTinDoiTuongPopupComponent = class TiepNhanNoiTruThongTinDoiTuongPopupComponent {
    constructor(authService, dialog, notificationService, apiService, data, dialogRef, router, cdRef, el) {
        this.authService = authService;
        this.dialog = dialog;
        this.notificationService = notificationService;
        this.apiService = apiService;
    ...
    closePopupLoadingData(elementType = null, strId = null) {
        if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
            this.popupLoadingData.close();
        }
        if (elementType != null) {
    ...
    getThongTinTiepNhan(yeuCauTiepNhanId) {
        this.showPopupLoadingData();
        this.apiService
            ...
            if (this.tiepNhanBenhNhan.NamSinh != null &&
                this.tiepNhanBenhNhan.ThangSinh != null &&
                this.tiepNhanBenhNhan.NgaySinh != null) {
                var ngaySinh = new Date(this.tiepNhanBenhNhan.ThangSinh +
                    "/" +
                ...
                if (result == "Yes") {
                    ...
                    if (this.tiepNhanBenhNhan.CoBHYT == true
                        ...
                        if (indexTheChuaNhap == -1) {
                            ...
                            var count = 0;
                            this.tiepNhanBenhNhan.YeuCauTiepNhanTheBHYTs.forEach(element => {
                                let thongTinBenhNhan = new _tiep_nhan_noi_tru_model__WEBPACK_IMPORTED_MODULE_19__["ThongTinBenhNhanTimKiemBHYT"](element.MaSoThe, this.tiepNhanBenhNhan.HoTen, this.tiepNhanBenhNhan.NgayThangNamSinh, null, this.tiepNhanBenhNhan.NamSinh);
                                this.apiService
    ...
    xuLyCapNhatDoiTuong() {
        ...
        this.apiService.put("DieuTriNoiTru/XuLyCapNhatThongTinDoiTuong", this.tiepNhanBenhNhan)
            .subscribe((resultMess) => {
            if (resultMess != undefined && resultMess != null && resultMess != '') {
                this.notificationService.showWarning(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_18__["SystemMessage"].ActionSuccessfully, ["Lưu"]) + " " + resultMess);
            }
            else {
                this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_18__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
            }
            this.closePopupLoadingData();
            this.close(true);
        }, (err) => {
    ...
    cloneDiaChiNguoiGiamHo(important = false) {
    ...
    bindMucHuongFromSoTheBHYT(soTheBHYT, theBHYT) {
    ...
    setNoiDKBD(theBHYT) {
        this.apiService.post("TiepNhanBenhNhan/GetNoiDangKyBaoHiem?ma=" + theBHYT.MaDKBD).subscribe(resultData => {
    ...
    setDiaChiBHYTForModel(diaChi) {
        ...
        let model = new _tiep_nhan_benh_nhan_tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_23__["DiaChiBHYT"]();
    ...
    getThongTinTheBHYT(theBHYT, index) {
        if (theBHYT.MaSoThe
            ...
            && !this.tiepNhanBenhNhan.TuNhap) {
            this.showPopupLoadingData();
            let thongTinBenhNhan = new _tiep_nhan_noi_tru_model__WEBPACK_IMPORTED_MODULE_19__["ThongTinBenhNhanTimKiemBHYT"](theBHYT.MaSoThe, this.tiepNhanBenhNhan.HoTen, this.tiepNhanBenhNhan.NgayThangNamSinh, null, this.tiepNhanBenhNhan.NamSinh);
            this.apiService
                .post("BHYT/GetLichSuKhamChuaBenh", thongTinBenhNhan)
                .subscribe((resultData) => {
                if (resultData == null || (resultData != null && resultData.maKetQua == "050")) {
                    ...
                    this.isLoadingDataBHYT = false;
                    this.closePopupLoadingData(src_app_shared_enum_kham_benh_enum__WEBPACK_IMPORTED_MODULE_24__["EnumTypeComponent"].KTextBox, 'SoTheBHYT' + index);
                }
                else {
    ...
    themTheBHYT() {
        ...
        this.apiService
            ...
            .subscribe((resultData) => {
            let newYeuCauTiepNhanTheBHYT = new _tiep_nhan_noi_tru_model__WEBPACK_IMPORTED_MODULE_19__["YeuCauTiepNhanTheBHYT"]();
            newYeuCauTiepNhanTheBHYT.BenhNhanId = this.tiepNhanBenhNhan.BenhNhanId;
            this.files.push(null);
            this.tiepNhanBenhNhan.YeuCauTiepNhanTheBHYTs.push(newYeuCauTiepNhanTheBHYT);
            this.closePopupLoadingData();
    ...
    ThemBHTN() {
        ...
        this.apiService.post("DieuTriNoiTru/KiemTraThemCongTyBHTN", this.themBaoHiemTuNhanModel).subscribe(resultData => {
            let isValid = this.checkValidAddBHTN(this.themBaoHiemTuNhanModel.CongTyBaoHiemTuNhanId);
            if (isValid == false) {
                this.notificationService.showError(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_18__["TiepNhanBenhNhanMessage"].MessageThemBHTN);
            }
            else {
...
TiepNhanNoiTruThongTinDoiTuongPopupComponent.ctorParameters = () => [
...
let TiepNhanNoiTruModule = class TiepNhanNoiTruModule {
};
