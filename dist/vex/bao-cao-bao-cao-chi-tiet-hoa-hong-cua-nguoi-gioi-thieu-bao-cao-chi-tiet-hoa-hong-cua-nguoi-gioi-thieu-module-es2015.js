...
let BaoCaoChiTietHoaHongCuaNguoiGioiThieuListComponent = class BaoCaoChiTietHoaHongCuaNguoiGioiThieuListComponent {
    ...
    getTongCong(queryInfo) {
        this.apiService.post("BaoCao/GetTonGcongHoaHongCuaNguoiGioiThieu", queryInfo).subscribe(resultData => {
...
BaoCaoChiTietHoaHongCuaNguoiGioiThieuListComponent.ctorParameters = () => [
...
let BaoCaoChiTietHoaHongCuaNguoiGioiThieuRoutingModule = class BaoCaoChiTietHoaHongCuaNguoiGioiThieuRoutingModule {
};
...
class BaoCaoChiTietHoaHongCuaNguoiGioiThieuSearch {
    constructor(HinhThucDenId = null, NoiGioiThieuId = null, MaYeuCauTiepNhan = "0", FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
class ChiTietHoaHongCuaNguoiGioiThieu {
    constructor(SoTienDV = null) {
        this.SoTienDV = SoTienDV;
    }
}
class DoanhThuNhaThuocVo {
    constructor(Id = null, ThanhTien = null, TienMat = null, Chuyen = null, Pos = null, CongNo = null) {
        this.Id = Id;
...
class InBaoCaoChiTietHoaHongCuaNguoiGioiThieu {
...
let BaoCaoChiTietHoaHongCuaNguoiGioiThieuModule = class BaoCaoChiTietHoaHongCuaNguoiGioiThieuModule {
};
...
let BaoCaoChiTietHoaHongCuaNguoiGioiThieuService = class BaoCaoChiTietHoaHongCuaNguoiGioiThieuService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoChiTietHoaHongCuaNguoiGioiThieuService.ctorParameters = () => [
