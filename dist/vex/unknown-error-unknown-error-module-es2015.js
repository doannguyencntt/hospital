...
let UnknownErrorRoutingModule = class UnknownErrorRoutingModule {
};
...
let UnknownErrorComponent = class UnknownErrorComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let UnknownErrorModule = class UnknownErrorModule {
};
