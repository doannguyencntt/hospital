...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-thuoc-don-vi-tinh-don-vi-tinh-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DonViTinhCreateComponent = /** @class */ (function () {
                function DonViTinhCreateComponent(router) {
                    this.router = router;
                }
                DonViTinhCreateComponent.prototype.ngOnInit = function () {
                };
                DonViTinhCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/thuoc/don-vi-tinh']);
                };
                return DonViTinhCreateComponent;
            }());
            DonViTinhCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DonViTinhListComponent = /** @class */ (function () {
                function DonViTinhListComponent(dialog, authService, apiService, notificationService) {
                    this.dialog = dialog;
                ...
                DonViTinhListComponent.prototype.ngOnInit = function () {
                ...
                DonViTinhListComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('DonViTinh/ExportDonViTinh', self.gridDonViTinh._gridQueryInfo).subscribe(function (resultData) {
                ...
                DonViTinhListComponent.prototype.showPopupLoadingData = function () {
                ...
                DonViTinhListComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return DonViTinhListComponent;
            }());
            DonViTinhListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DonViTinhRoutingModule = /** @class */ (function () {
                function DonViTinhRoutingModule() {
                }
                return DonViTinhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DonViTinhSharedComponent = /** @class */ (function () {
                function DonViTinhSharedComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.donViTinh = {};
                    this.isCreate = true;
                }
                DonViTinhSharedComponent.prototype.ngOnInit = function () {
                ...
                DonViTinhSharedComponent.prototype.getSharedData = function () {
                    return this.donViTinh;
                };
                DonViTinhSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.donViTinh = resultData;
                    });
                };
                return DonViTinhSharedComponent;
            }());
            DonViTinhSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _don_vi_tinh_shared_don_vi_tinh_shared_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../don-vi-tinh-shared/don-vi-tinh-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/thuoc/don-vi-tinh/don-vi-tinh-shared/don-vi-tinh-shared.component.ts");
            var DonViTinhUpdateComponent = /** @class */ (function () {
                function DonViTinhUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                DonViTinhUpdateComponent.prototype.ngOnInit = function () {
                    this.idsub = this.route.snapshot.params.id;
                };
                DonViTinhUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/thuoc/don-vi-tinh']);
                };
                return DonViTinhUpdateComponent;
            }());
            DonViTinhUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DonViTinhModule = /** @class */ (function () {
                function DonViTinhModule() {
                }
                return DonViTinhModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DonViTinhService = /** @class */ (function (_super) {
                __extends(DonViTinhService, _super);
                function DonViTinhService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'DonViTinh';
                    return _this;
                }
                return DonViTinhService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            DonViTinhService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-thuoc-don-vi-tinh-don-vi-tinh-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-thuoc-don-vi-tinh-don-vi-tinh-module-es5.js.map