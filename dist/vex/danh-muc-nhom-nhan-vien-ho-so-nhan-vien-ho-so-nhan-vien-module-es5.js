...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-nhan-vien-ho-so-nhan-vien-ho-so-nhan-vien-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HoSoNhanVienCreateComponent = /** @class */ (function () {
                function HoSoNhanVienCreateComponent(router) {
                    this.router = router;
                }
                HoSoNhanVienCreateComponent.prototype.ngOnInit = function () {
                };
                HoSoNhanVienCreateComponent.prototype.onCreated = function () { this.router.navigate(['/danh-muc/nhom-nhan-vien/ho-so-nhan-vien']); };
                HoSoNhanVienCreateComponent.prototype.keyEvent = function (event) {
                ...
                return HoSoNhanVienCreateComponent;
            }());
            HoSoNhanVienCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HoSoNhanVienListComponent = /** @class */ (function () {
                function HoSoNhanVienListComponent(dialog, notificationService, apiService, authService) {
                    this.dialog = dialog;
                ...
                HoSoNhanVienListComponent.prototype.ngOnInit = function () {
                ...
                HoSoNhanVienListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("NhanVien/ExportHoSoNhanVien", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return HoSoNhanVienListComponent;
            }());
            HoSoNhanVienListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HoSoNhanVienRoutingModule = /** @class */ (function () {
                function HoSoNhanVienRoutingModule() {
                }
                return HoSoNhanVienRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HoSoNhanVienShareComponent = /** @class */ (function () {
                function HoSoNhanVienShareComponent(route, baseService, dialog, apiService) {
                    this.route = route;
                ...
                HoSoNhanVienShareComponent.prototype.ngOnInit = function () {
                    this.gridKhoaPhongsColumn = [
                        {
                ...
                HoSoNhanVienShareComponent.prototype.onSelectAll = function (isCheck) {
                    var _this = this;
                    if (isCheck) {
                        // đang check
                        this.dataSourceKhoaPhong.data.forEach(function (khoaPhong) {
                            khoaPhong.IsChecked = true;
                            if (!_this.sreachKhoaPhong.PhongBenhVienIds.some(function (x) { return x === khoaPhong.Id; })) {
                                _this.sreachKhoaPhong.PhongBenhVienIds.push(khoaPhong.Id);
                                _this.modelFE.PhongBenhVienIds.push(khoaPhong.Id);
                            }
                        });
                        this.nhomKhoaPhongs.forEach(function (nhomKhoaPhong) {
                            var id = '#check_' + nhomKhoaPhong.Id;
                            if (!$(id).hasClass('mat-checkbox-checked')) {
                                $(id).addClass('mat-checkbox-checked');
                                $(id).attr('ng-reflect-model', 'true');
                            }
                            if (!_this.sreachKhoaPhong.KhoaPhongIds.some(function (x) { return x === nhomKhoaPhong.Id; })) {
                                _this.sreachKhoaPhong.KhoaPhongIds.push(nhomKhoaPhong.Id);
                                _this.modelFE.KhoaPhongIds.push(nhomKhoaPhong.Id);
                            }
                        });
                    }
                    else {
                        ...
                        this.dataSourceKhoaPhong.data.forEach(function (khoaPhong) {
                            ...
                            if (_this.sreachKhoaPhong.PhongBenhVienIds.some(function (x) { return x === khoaPhong.Id; })) {
                                var pos = _this.sreachKhoaPhong.PhongBenhVienIds.indexOf(khoaPhong.Id);
                                if (pos > -1) {
                                    _this.sreachKhoaPhong.PhongBenhVienIds.splice(pos, 1);
                                }
                                var posDb = _this.modelFE.PhongBenhVienIds.indexOf(khoaPhong.Id);
                                if (posDb > -1) {
                                    _this.modelFE.PhongBenhVienIds.splice(posDb, 1);
                                }
                            }
                        });
                        this.nhomKhoaPhongs.forEach(function (nhomKhoaPhong) {
                            ...
                            if (_this.sreachKhoaPhong.KhoaPhongIds.some(function (x) { return x === nhomKhoaPhong.Id; })) {
                                var pos = _this.sreachKhoaPhong.KhoaPhongIds.indexOf(nhomKhoaPhong.Id);
                                if (pos > -1) {
                                    _this.sreachKhoaPhong.KhoaPhongIds.splice(pos, 1);
                                }
                                var posDb = _this.modelFE.KhoaPhongIds.indexOf(nhomKhoaPhong.Id);
                                if (posDb > -1) {
                                    _this.modelFE.KhoaPhongIds.splice(posDb, 1);
                                }
                            }
                        });
                    }
                ...
                HoSoNhanVienShareComponent.prototype.OnChangeParent = function (isChecked, data, aggregates) {
                    var _this = this;
                    aggregates.items.forEach(function (item) {
                        item.IsCheckedParent = true;
                        if (item.IsChecked === false) {
                            item.IsCheckedParent = false;
                        }
                    });
                    var id = '#check_' + data.items[0].NhomKhoaId;
                    isChecked = !$(id).hasClass('mat-checkbox-checked');
                    if (isChecked) {
                        data.items.forEach(function (children) {
                            children.IsChecked = true;
                            if (!_this.sreachKhoaPhong.PhongBenhVienIds.some(function (x) { return x === children.Id; })) {
                                _this.sreachKhoaPhong.PhongBenhVienIds.push(children.Id);
                                _this.modelFE.PhongBenhVienIds.push(children.Id);
                            }
                        });
                        if (!$(id).hasClass('mat-checkbox-checked')) {
                            setTimeout(function () {
                        ...
                        data.items.forEach(function (children) {
                            ...
                            if (_this.sreachKhoaPhong.PhongBenhVienIds.some(function (x) { return x === children.Id; })) {
                                var pos = _this.sreachKhoaPhong.PhongBenhVienIds.indexOf(children.Id);
                                if (pos > -1) {
                                    _this.sreachKhoaPhong.PhongBenhVienIds.splice(pos, 1);
                                }
                                var posDb = _this.modelFE.PhongBenhVienIds.indexOf(children.Id);
                                if (posDb > -1) {
                                    _this.modelFE.PhongBenhVienIds.splice(posDb, 1);
                                }
                            }
                        ...
                        if (this.sreachKhoaPhong.KhoaPhongIds.some(function (x) { return x === data.items[0].NhomKhoaId; })) {
                            var pos = this.sreachKhoaPhong.KhoaPhongIds.indexOf(data.items[0].NhomKhoaId);
                            if (pos > -1) {
                                this.sreachKhoaPhong.KhoaPhongIds.splice(pos, 1);
                            }
                            var posDb = this.modelFE.KhoaPhongIds.indexOf(data.items[0].NhomKhoaId);
                            if (posDb > -1) {
                ...
                HoSoNhanVienShareComponent.prototype.OnChangeChildren = function (isChecked, kpNv) {
                    kpNv.IsChecked = isChecked;
                    var id = '#check_' + kpNv.NhomKhoaId;
                    if (!this.dataSourceKhoaPhong.data.some(function (x) { return x.NhomKhoaId === kpNv.NhomKhoaId && !x.IsChecked; })) {
                        if (!$(id).hasClass('mat-checkbox-checked')) {
                            $(id).addClass('mat-checkbox-checked');
                            $(id).attr('ng-reflect-model', 'true');
                        }
                    ...
                    if (isChecked) {
                        ...
                        if (this.sreachKhoaPhong.PhongBenhVienIds.some(function (x) { return x === kpNv.Id; })) {
                            var pos = this.sreachKhoaPhong.PhongBenhVienIds.indexOf(kpNv.Id);
                            if (pos > -1) {
                                this.sreachKhoaPhong.PhongBenhVienIds.splice(pos, 1);
                            }
                            var posDb = this.modelFE.PhongBenhVienIds.indexOf(kpNv.Id);
                            if (posDb > -1) {
                                this.modelFE.PhongBenhVienIds.splice(posDb, 1);
                            }
                        }
                        if (this.dataSourceKhoaPhong.data.some(function (x) { return x.NhomKhoaId === kpNv.NhomKhoaId && !x.IsChecked; })) {
                            if (this.sreachKhoaPhong.KhoaPhongIds.some(function (x) { return x === kpNv.NhomKhoaId; })) {
                                var pos = this.sreachKhoaPhong.KhoaPhongIds.indexOf(kpNv.NhomKhoaId);
                                if (pos > -1) {
                                    this.sreachKhoaPhong.KhoaPhongIds.splice(pos, 1);
                                }
                                var posDb = this.modelFE.KhoaPhongIds.indexOf(kpNv.NhomKhoaId);
                                if (posDb > -1) {
                                    this.modelFE.KhoaPhongIds.splice(posDb, 1);
                                }
                            }
                ...
                HoSoNhanVienShareComponent.prototype.GetDataKhoaPhong = function (result) {
                    var _this = this;
                    ...
                    setTimeout(function () {
                        result.Data.forEach(function (x) {
                            if (x.PhongChinh === true) {
                                ...
                                _this.modelFE.PhongChinhId = x.Id;
                            }
                            else {
                ...
                HoSoNhanVienShareComponent.prototype.WillCheckAll = function () {
                ...
                HoSoNhanVienShareComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.modelFE = resultData;
                            _this.modelFE.IsUpdateView = true;
                            if (_this.modelFE.KhoaPhongIds.length > 0) {
                                _this.isChonKhoaPhong = false;
                            }
                            _this.khoaPhongIds = JSON.stringify(_this.modelFE.KhoaPhongIds);
                ...
                HoSoNhanVienShareComponent.prototype.searchChanges = function (dataEvent) {
                    var _this = this;
                    if (dataEvent != "" && dataEvent != undefined) {
                        var searchStr = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].removeVietnamese(dataEvent.toLowerCase().trim());
                        var data = this.filtreText(this.khoaPhongViewModel, searchStr);
                    ...
                    setTimeout(function () {
                        $('#phongChinh' + _this.modelFE.PhongChinhId).prop('checked', true);
                ...
                HoSoNhanVienShareComponent.prototype.searchKhoChanges = function (dataEvent) {
                    if (dataEvent != "" && dataEvent != undefined) {
                        var searchStr = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].removeVietnamese(dataEvent).toLowerCase().trim();
                        var data = this.filtreTextKho(this.khoViewModel, searchStr);
                ...
                HoSoNhanVienShareComponent.prototype.filtreText = function (arr, searchStr) {
                ...
                HoSoNhanVienShareComponent.prototype.filtreTextKho = function (arr, searchStr) {
                    return arr.filter(function (el) {
                        if (el.TenPhong !== null)
                ...
                HoSoNhanVienShareComponent.prototype.bindCheckEditUserKho = function (data) {
                    var _this = this;
                ...
                HoSoNhanVienShareComponent.prototype.getSharedData = function () {
                    // this.checkPasswordChange();
                    return this.modelFE;
                };
                HoSoNhanVienShareComponent.prototype.fileProgress = function (fileInput) {
                    this.fileData = fileInput.target.files[0];
                    this.preview();
                };
                HoSoNhanVienShareComponent.prototype.preview = function () {
                    var _this = this;
                    if (this.fileData !== undefined) {
                        ...
                        reader_1.onload = function (_event) {
                            _this.modelFE.Avatar = reader_1.result;
                        };
                    }
                };
                HoSoNhanVienShareComponent.prototype.ViewImage = function (thongTinAnh) {
                ...
                HoSoNhanVienShareComponent.prototype.onSelectChangeKhoaPhong = function (ev) {
                    if (ev.length === 0) {
                        this.isChonKhoaPhong = true;
                        this.modelFE.PhongBenhVienIds = [];
                    }
                ...
                HoSoNhanVienShareComponent.prototype.OnOpen = function (isOpen) {
                    if (isOpen) {
                        var url = 'NhanVien/GetListPhongByKhoas?nhanVienId=' + this.userId + '&khoaphongIds=' + this.khoaPhongIds;
                ...
                HoSoNhanVienShareComponent.prototype.loadPhongKhamHienTaiByNhanVien = function (userId, khoaPhongs) {
                    var _this = this;
                    this.apiService
                        ...
                        if (resultData !== null && resultData !== undefined) {
                            ...
                            var phongKhams_1 = [];
                            _this.phongKhamHienTais.forEach(function (element) {
                                phongKhams_1.push(element.KeyId);
                            });
                            if (_this.modelFE.PhongBenhVienIds !== undefined &&
                                _this.modelFE.PhongBenhVienIds.length > 0 &&
                                phongKhams_1.length > 0) {
                                var removePhongKhongChonKhoas = _this.differenceOf2Arrays(_this.modelFE.PhongBenhVienIds, phongKhams_1);
                                _this.modelFE.PhongBenhVienIds = removePhongKhongChonKhoas;
                            }
                        }
                    });
                };
                HoSoNhanVienShareComponent.prototype.ChonPhongChinh = function (phongChinh) {
                    this.modelFE.PhongChinhId = phongChinh;
                };
                HoSoNhanVienShareComponent.prototype.SelectionKho = function (khoIds) {
                    var _this = this;
                    this.modelFE.KhoNhanVienQuanLyIds = [];
                    khoIds.forEach(function (element) {
                        _this.modelFE.KhoNhanVienQuanLyIds.push(element);
                    });
                };
                HoSoNhanVienShareComponent.prototype.GetDataKho = function (data) {
                    var _this = this;
                    this.modelFE.KhoNhanVienQuanLyIds = [];
                    ...
                    setTimeout(function () {
                        data.Data.forEach(function (element) {
                            if (element.DaChon) {
                                ...
                                //reset lại                   
                                _this.modelFE.KhoNhanVienQuanLyIds.push(element.Id);
                            }
                        });
                    }, 100);
                };
                HoSoNhanVienShareComponent.prototype.differenceOf2Arrays = function (arr1, arr2) {
                    var temp = [];
                ...
                return HoSoNhanVienShareComponent;
            }());
            HoSoNhanVienShareComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_vex_animations_stagger_animation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/@vex/animations/stagger.animation */ "./src/@vex/animations/stagger.animation.ts");
            /* harmony import */ var _ho_so_nhan_vien_share_ho_so_nhan_vien_share_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ho-so-nhan-vien-share/ho-so-nhan-vien-share.component */ "./src/app/modules/main/danh-muc/nhom-nhan-vien/ho-so-nhan-vien/ho-so-nhan-vien-share/ho-so-nhan-vien-share.component.ts");
            var HoSoNhanVienUpdateComponent = /** @class */ (function () {
                function HoSoNhanVienUpdateComponent(router) {
                    this.router = router;
                }
                HoSoNhanVienUpdateComponent.prototype.ngOnInit = function () {
                };
                HoSoNhanVienUpdateComponent.prototype.onUpdated = function () { this.router.navigate(['/danh-muc/nhom-nhan-vien/ho-so-nhan-vien']); };
                HoSoNhanVienUpdateComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 83 && event.ctrlKey) {
                ...
                return HoSoNhanVienUpdateComponent;
            }());
            HoSoNhanVienUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_ho_so_nhan_vien_share_ho_so_nhan_vien_share_component__WEBPACK_IMPORTED_MODULE_5__["HoSoNhanVienShareComponent"], { static: true })
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaPhongIdViewModel = /** @class */ (function () {
                function KhoaPhongIdViewModel(NhanVienId, KhoaPhongIds) {
                    this.NhanVienId = NhanVienId;
                    this.KhoaPhongIds = KhoaPhongIds;
                }
                return KhoaPhongIdViewModel;
            }());
            ...
            var ThongTinKhoaPhong = /** @class */ (function () {
                function ThongTinKhoaPhong(NhomKhoa, NhomKhoaId, MaPhong, TenPhong, PhongChinh, IsChecked, IsCheckedParent, Id) {
                    ...
                    if (IsCheckedParent === void 0) { IsCheckedParent = null; }
            ...
            var ThongTinKho = /** @class */ (function () {
                function ThongTinKho(TenKhoa, TenKho, TenPhong) {
            ...
            var GridThongTinKhoaPhongModel = /** @class */ (function () {
                function GridThongTinKhoaPhongModel(data, total) {
                    if (data === void 0) { data = []; }
            ...
            var GridThongTinKhoModel = /** @class */ (function () {
                function GridThongTinKhoModel(data, total) {
                    if (data === void 0) { data = []; }
                    if (total === void 0) { total = 0; }
                    this.data = data;
                    this.total = total;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HoSoNhanVienModule = /** @class */ (function () {
                function HoSoNhanVienModule() {
                }
                return HoSoNhanVienModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HoSoNhanVienService = /** @class */ (function (_super) {
                __extends(HoSoNhanVienService, _super);
                function HoSoNhanVienService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'NhanVien';
                    return _this;
                }
                return HoSoNhanVienService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            HoSoNhanVienService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-nhan-vien-ho-so-nhan-vien-ho-so-nhan-vien-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-nhan-vien-ho-so-nhan-vien-ho-so-nhan-vien-module-es5.js.map