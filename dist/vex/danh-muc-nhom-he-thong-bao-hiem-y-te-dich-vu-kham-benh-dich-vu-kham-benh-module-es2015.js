...
let DichVuKhamBenhCreateComponent = class DichVuKhamBenhCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
DichVuKhamBenhCreateComponent.ctorParameters = () => [
...
let DichVuKhamBenhListComponent = class DichVuKhamBenhListComponent {
    ...
    updateDichVuKhamBenh(id, isDisabled) {
    ...
    exportExcel() {
        ...
        this.apiService.postExportExcel("DichVuKhamBenh/ExportDichVuKhamBenh", this.gridChild._gridQueryInfo).subscribe(res => {
...
DichVuKhamBenhListComponent.ctorParameters = () => [
...
let DichVuKhamBenhRoutingModule = class DichVuKhamBenhRoutingModule {
};
...
let DichVuKhamBenhSharedComponent = class DichVuKhamBenhSharedComponent {
    ...
    ngOnInit() {
        ...
        if (this.isCreate) {
            let dichVuKhamBenhThongTinGiaBaoHiemYTe = new _dich_vu_kham_benh_model__WEBPACK_IMPORTED_MODULE_2__["DichVuKhamBenhThongTinGiaBaoHiemYTe"]();
        ...
        if (this.dichvukhambenh.DichVuKhamBenhThongTinGias.length > 1) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                ...
                if (result === 'Yes') {
                    ...
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
                }
            });
        }
    }
...
DichVuKhamBenhSharedComponent.ctorParameters = () => [
...
let DichVuKhamBenhUpdateComponent = class DichVuKhamBenhUpdateComponent {
...
DichVuKhamBenhUpdateComponent.ctorParameters = () => [
...
let DichVuKhamBenhModule = class DichVuKhamBenhModule {
};
...
let DichVuKhamBenhService = class DichVuKhamBenhService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DichVuKhamBenh';
    }
};
DichVuKhamBenhService.ctorParameters = () => [
