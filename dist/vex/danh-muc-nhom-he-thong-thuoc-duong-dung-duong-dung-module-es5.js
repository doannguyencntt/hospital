...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-thuoc-duong-dung-duong-dung-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuongDungCreateComponent = /** @class */ (function () {
                function DuongDungCreateComponent(router) {
                    this.router = router;
                }
                DuongDungCreateComponent.prototype.ngOnInit = function () {
                };
                DuongDungCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/thuoc/duong-dung']);
                };
                return DuongDungCreateComponent;
            }());
            DuongDungCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuongDungListComponent = /** @class */ (function () {
                function DuongDungListComponent(authService, dialog, notificationService, apiService) {
                ...
                DuongDungListComponent.prototype.ngOnInit = function () {
                ...
                DuongDungListComponent.prototype.updateDuongDung = function (id, isDisabled) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_2__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_3__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                self.apiService.post("DuongDung/KichHoatDuongDung?id=" + id).subscribe(function () {
                ...
                DuongDungListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_2__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("DuongDung/ExportDuongDung", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return DuongDungListComponent;
            }());
            DuongDungListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuongDungRoutingModule = /** @class */ (function () {
                function DuongDungRoutingModule() {
                }
                return DuongDungRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuongDungSharedComponent = /** @class */ (function () {
                function DuongDungSharedComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.duongdung = {};
                    this.isCreate = true;
                }
                DuongDungSharedComponent.prototype.ngOnInit = function () {
                ...
                DuongDungSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.duongdung = resultData;
                    });
                };
                DuongDungSharedComponent.prototype.getSharedData = function () {
                    return this.duongdung;
                };
                return DuongDungSharedComponent;
            }());
            DuongDungSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuongDungUpdateComponent = /** @class */ (function () {
                function DuongDungUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                DuongDungUpdateComponent.prototype.ngOnInit = function () {
                };
                DuongDungUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/thuoc/duong-dung']);
                };
                return DuongDungUpdateComponent;
            }());
            DuongDungUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuongDungModule = /** @class */ (function () {
                function DuongDungModule() {
                }
                return DuongDungModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuongDungService = /** @class */ (function (_super) {
                __extends(DuongDungService, _super);
                function DuongDungService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'DuongDung';
                    return _this;
                }
                return DuongDungService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            DuongDungService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-thuoc-duong-dung-duong-dung-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-thuoc-duong-dung-duong-dung-module-es5.js.map