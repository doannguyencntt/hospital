(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-ksk-chuyen-khoa-bao-cao-ksk-chuyen-khoa-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKskChuyenKhoaListComponent = /** @class */ (function () {
                function BaoCaoKskChuyenKhoaListComponent(authService, dialog, notificationService, apiService) {
                ...
                BaoCaoKskChuyenKhoaListComponent.prototype.totalSoLuong = function (field) {
                    switch (field) {
                        case 'TongSo':
                ...
                ;
                BaoCaoKskChuyenKhoaListComponent.prototype.ngOnInit = function () {
                    this.GetDatasource();
                };
                BaoCaoKskChuyenKhoaListComponent.prototype.GetDatasource = function () {
                    var _this = this;
                    ...
                    this.apiService.post('BaoCaoKSKChuyenKhoa/GetDataForGridAsyncKSKChuyenKhoa', this.hoatDongKhamDoanSearch).subscribe(function (resultData) {
                        if (resultData != null && resultData != []) {
                            ...
                            _this.data.forEach(function (item) {
                                item.NoiThucHienCuaNguoiBenhs.forEach(function (phongKham) {
                                    if (_this.dataHeader.every(function (z) { return z.TenChuyenKhoaKhamSucKhoe != phongKham.TenChuyenKhoaKhamSucKhoe; })) {
                ...
                BaoCaoKskChuyenKhoaListComponent.prototype.timKiem = function () {
                    var _this = this;
                    this.data = [];
                    this.dataHeader = [];
                    this.dataSumSoLuongHeader = [];
                ...
                BaoCaoKskChuyenKhoaListComponent.prototype.getSum = function (chuyenKhoaKhamSucKhoe) {
                    var sum = 0;
                ...
                BaoCaoKskChuyenKhoaListComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                BaoCaoKskChuyenKhoaListComponent.prototype.xuatExcel = function () {
                    var _this = this;
                ...
                return BaoCaoKskChuyenKhoaListComponent;
            }());
            BaoCaoKskChuyenKhoaListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKskChuyenKhoaRoutingModule = /** @class */ (function () {
                function BaoCaoKskChuyenKhoaRoutingModule() {
                }
                return BaoCaoKskChuyenKhoaRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKskChuyenKhoaModule = /** @class */ (function () {
                function BaoCaoKskChuyenKhoaModule() {
                }
                return BaoCaoKskChuyenKhoaModule;
            }());
...
//# sourceMappingURL=bao-cao-bao-cao-ksk-chuyen-khoa-bao-cao-ksk-chuyen-khoa-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-ksk-chuyen-khoa-bao-cao-ksk-chuyen-khoa-module-es5.js.map