...
let VatTuDaHetHanListComponent = class VatTuDaHetHanListComponent {
    ...
    inBaoCaoVatTuDaHetHan() {
        ...
        self.apiService.post("TonKho/XemVatTuDaHetHan", self.inVatTuDaHetHan).subscribe((result) => {
    ...
    getSharedPrintForm() {
        ...
        return new Promise(resolve => {
            self.closePopupLoading();
            this.apiService.post("TonKho/XemVatTuDaHetHan", self.inVatTuDaHetHan).subscribe(resultData => {
                resolve(resultData);
            });
        });
    }
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_21__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("TonKho/ExportVatTuDaHetHan", this.gridChild._gridQueryInfo).subscribe(res => {
...
VatTuDaHetHanListComponent.ctorParameters = () => [
...
let VatTuDaHetHanPopupComponent = class VatTuDaHetHanPopupComponent {
...
VatTuDaHetHanPopupComponent.ctorParameters = () => [
...
let VatTuDaHetHanRoutingModule = class VatTuDaHetHanRoutingModule {
};
...
let VatTuDaHetHanModule = class VatTuDaHetHanModule {
};
...
let VatTuDaHetHanService = class VatTuDaHetHanService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'TonKho';
    }
};
VatTuDaHetHanService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
