...
let PhuongPhapVoCamCreateComponent = class PhuongPhapVoCamCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
PhuongPhapVoCamCreateComponent.ctorParameters = () => [
...
let PhuongPhapVoCamListComponent = class PhuongPhapVoCamListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('PhuongPhapVoCam/ExportPhuongPhapVoCam', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
PhuongPhapVoCamListComponent.ctorParameters = () => [
...
let PhuongPhapVoCamRoutingModule = class PhuongPhapVoCamRoutingModule {
};
...
let PhuongPhapVoCamSharedComponent = class PhuongPhapVoCamSharedComponent {
...
PhuongPhapVoCamSharedComponent.ctorParameters = () => [
...
let PhuongPhapVoCamUpdateComponent = class PhuongPhapVoCamUpdateComponent {
...
PhuongPhapVoCamUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let PhuongPhapVoCamModule = class PhuongPhapVoCamModule {
};
...
let PhuongPhapVoCamService = class PhuongPhapVoCamService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'PhuongPhapVoCam';
    }
};
PhuongPhapVoCamService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
