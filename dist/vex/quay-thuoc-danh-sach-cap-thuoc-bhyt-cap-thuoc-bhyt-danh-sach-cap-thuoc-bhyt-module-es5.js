...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["quay-thuoc-danh-sach-cap-thuoc-bhyt-cap-thuoc-bhyt-danh-sach-cap-thuoc-bhyt-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachCapThuocBHYTRoutingModule = /** @class */ (function () {
                function DanhSachCapThuocBHYTRoutingModule() {
                }
                return DanhSachCapThuocBHYTRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TimBenhNhanChoCapThuoc = /** @class */ (function () {
                function TimBenhNhanChoCapThuoc(MaBenhNhan, MaTiepNhan, HoTen, SoDienThoai, RangeDate) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachCapThuocBHYTModule = /** @class */ (function () {
                function DanhSachCapThuocBHYTModule() {
                }
                return DanhSachCapThuocBHYTModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachCapThuocBHYTService = /** @class */ (function (_super) {
                __extends(DanhSachCapThuocBHYTService, _super);
                function DanhSachCapThuocBHYTService(apiService) {
                    return _super.call(this, apiService) || this;
                }
                return DanhSachCapThuocBHYTService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            DanhSachCapThuocBHYTService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachDonThuocChoCapThuocComponent = /** @class */ (function () {
                function DanhSachDonThuocChoCapThuocComponent(router, location, authService, apiService, notificationService, route, cd, dialog) {
                    this.router = router;
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.ngOnInit = function () {
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.TimKiemChoCapThuocBHYT = function () {
                    this.location.replaceState(this.baseRoute + '?holdQuery=true');
                    var timKiemChoCapThuocBHYTJSon = JSON.stringify(this.timKiem);
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.TimKiemChoCapThuocBHYT();
                    }
                };
                DanhSachDonThuocChoCapThuocComponent.prototype.searchChangeMaBN = function (event) {
                    var self = this;
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.convertDateTimeToUTC = function () {
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.reverseDateTime = function () {
                    if (this.timKiem.RangeDate.startDate) {
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.showLoadingPopup = function () {
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.xemChoCapThuocBHYT = function (event) {
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.exportExcel = function () {
                    var self = this;
                    self.showLoadingPopup();
                    var timKiemChoCapThuocBHYTJSon = JSON.stringify(self.timKiem);
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('QuayThuoc/ExportDonThuocChoCapThuocBHYT', self.exportQueryInfoQueryInfo).subscribe(function (resultData) {
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.showSavingPopup = function () {
                    if (!this.loadingPopup) {
                        this.loadingPopup = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_8__["LoadingComponent"], {
                            disableClose: true,
                            width: '200px',
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.closeAllDialogs = function () {
                    if (this.loadingPopup) {
                        this.loadingPopup.close();
                        this.loadingPopup = null;
                    }
                };
                DanhSachDonThuocChoCapThuocComponent.prototype.PrinAllDonThuocBenhNhan = function (donThuocThanhToanId, LoaiDonThuoc, YeuCauKhambenhId) {
                    var _this = this;
                    var data = {
                    ...
                    this.apiService.post("QuayThuoc/InThuocBenhNhan", data).subscribe(function (resultData) {
                        var dialogRef = _this.dialog.open(_in_don_thuoc_pop_up_in_don_thuoc_pop_up_component__WEBPACK_IMPORTED_MODULE_18__["InDonThuocPopUpComponent"], {
                            width: '1000px',
                            data: { Model: resultData, InDonThuocDanhSachList: false, InBangKe: true, InPhieuThu: false }
                        }).afterClosed().subscribe(function () { });
                    }, function () { });
                };
                DanhSachDonThuocChoCapThuocComponent.prototype.QuetMaQRCodeClick = function () {
                    var elementBarcode = document.getElementById('barcodeActive');
                    if (elementBarcode != undefined) {
                        elementBarcode.click();
                    }
                };
                DanhSachDonThuocChoCapThuocComponent.prototype.searchChangeMaTN = function (event) {
                    //xóa sreach trước đó
                    var self = this;
                    if (this.timeoutSearchChange != null) {
                        clearTimeout(this.timeoutSearchChange);
                ...
                DanhSachDonThuocChoCapThuocComponent.prototype.changeQR = function ($event) {
                ...
                return DanhSachDonThuocChoCapThuocComponent;
            }());
            DanhSachDonThuocChoCapThuocComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChoCapThuocBHYTChiTietComponent = /** @class */ (function () {
                function ChoCapThuocBHYTChiTietComponent(route, notificationService, dialog, apiService, router, cdRef) {
                    this.route = route;
                    this.notificationService = notificationService;
                    this.dialog = dialog;
                    this.apiService = apiService;
                ...
                ChoCapThuocBHYTChiTietComponent.prototype.ngOnInit = function () {
                ...
                ChoCapThuocBHYTChiTietComponent.prototype.GetThongTinBenhNhan = function (benhNhanId, tiepNhanId) {
                    var _this = this;
                ...
                ChoCapThuocBHYTChiTietComponent.prototype.Huy = function () {
                    this.router.navigate(['danh-sach-don-thuoc-cho-cap-thuoc'], { queryParams: { holdQuery: true } });
                };
                ChoCapThuocBHYTChiTietComponent.prototype.ngAfterViewChecked = function () {
                    this.cdRef.detectChanges();
                };
                ChoCapThuocBHYTChiTietComponent.prototype.afterChangedCongNo = function () {
                    this.cdRef.detectChanges();
                    this.apDungCongNoThuoc = false;
                };
                ChoCapThuocBHYTChiTietComponent.prototype.afterChangedMienGiam = function () {
                    this.cdRef.detectChanges();
                };
                ChoCapThuocBHYTChiTietComponent.prototype.changeTab = function () {
                    this.tabQuayThuoc.selectTab(1);
                };
                ChoCapThuocBHYTChiTietComponent.prototype.inXemTruocBangKeThuoc = function () {
                    var _this = this;
                    ...
                    if (this.xemTruocBangKeThuoc.DanhSachDonThuocs === undefined &&
                        ...
                        this.apiService.postExportPdf('QuayThuoc/XemTruocBangKeThuoc', this.xemTruocBangKeThuoc).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.dialog.open(_thong_tin_phieu_pdf_popup_thong_tin_phieu_pdf_popup_component__WEBPACK_IMPORTED_MODULE_10__["ThongTinPhieuPdfPopupComponent"], {
                                    disableClose: true,
                                    width: '1000px',
                ...
                ChoCapThuocBHYTChiTietComponent.prototype.showPopupLoadingIn = function () {
                ...
                ChoCapThuocBHYTChiTietComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                ChoCapThuocBHYTChiTietComponent.prototype.GetThongTinDonThuoc = function (id) {
                    var _this = this;
                    var self = this;
                    ...
                    this.apiService.post("QuayThuoc/GetDanhSachXuatThuocBHYT?tiepNhanId=" + id).subscribe(function (resultData) {
                        _this.dataSourcedanhsachThuocBHYT.data = resultData;
                        var index = 1;
                        _this.dataSourcedanhsachThuocBHYT.data.forEach(function (x) {
                            x.STT = index;
                            index++;
                        });
                        _this.danhSachThuoc.ThuocBHYT = _this.dataSourcedanhsachThuocBHYT.data.slice();
                    }, function () { });
                ...
                ChoCapThuocBHYTChiTietComponent.prototype.GuiData = function () {
                    var _this = this;
                        ...
                        if (result == "Yes") {
                            _this.apiService.post("QuayThuoc/XuatDonThuocBHYT", _this.danhSachThuoc).subscribe(function (resultData) {
                                if (resultData != null && resultData != undefined && resultData != "") {
                                    ...
                                    _this.router.navigate(['danh-sach-don-thuoc-cho-cap-thuoc'], { queryParams: { holdQuery: false } });
                                }
                            }, function (err) {
                            });
                        }
                ...
                ChoCapThuocBHYTChiTietComponent.prototype.KeThuoc = function () {
                    var _this = this;
                    this.showPopupLoadingIn();
                    var data = {
                        Hosting: null,
                ...
                ChoCapThuocBHYTChiTietComponent.prototype.keyEvent = function (event) {
                ...
                return ChoCapThuocBHYTChiTietComponent;
            }());
            ChoCapThuocBHYTChiTietComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
//# sourceMappingURL=quay-thuoc-danh-sach-cap-thuoc-bhyt-cap-thuoc-bhyt-danh-sach-cap-thuoc-bhyt-module-es5.js.map
//# sourceMappingURL=quay-thuoc-danh-sach-cap-thuoc-bhyt-cap-thuoc-bhyt-danh-sach-cap-thuoc-bhyt-module-es5.js.map