(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-mau-mau-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MauRoutingModule = /** @class */ (function () {
                function MauRoutingModule() {
                }
                return MauRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapKhoMauCreateComponent = /** @class */ (function () {
                function NhapKhoMauCreateComponent(notificationService, authService, apiService, router, dialog, location) {
                ...
                NhapKhoMauCreateComponent.prototype.ngOnInit = function () {
                    this.documentype = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_8__["DocumentType"].NhapKhoMau;
                };
                NhapKhoMauCreateComponent.prototype.getTrangThaiYeuCau = function (event) {
                    if (event != undefined && event != null) {
                        this.trangThai = event;
                    }
                };
                NhapKhoMauCreateComponent.prototype.xuLyLuu = function (inPhieu) {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Add)) {
                        this.dialog
                            ...
                            if (result == "Yes") {
                                ...
                                var phieuNhapKho = _this.shared.getData();
                                phieuNhapKho.InPhieu = inPhieu;
                                _this.apiService.post("NhapKhoMau/XuLyTaoPhieuNhapKhoMau", phieuNhapKho).subscribe(function (res) {
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_3__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_4__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                                    if (inPhieu) {
                                        _this.dialog.open(_nhap_kho_mau_in_phieu_popup_nhap_kho_mau_in_phieu_popup_component__WEBPACK_IMPORTED_MODULE_11__["NhapKhoMauInPhieuPopupComponent"], {
                                            disableClose: false,
                                            width: '1200px',
                                            data: res,
                ...
                NhapKhoMauCreateComponent.prototype.huy = function () {
                    //this.router.navigate([this.baseRoute]);
                    this.location.back();
                };
                return NhapKhoMauCreateComponent;
            }());
            NhapKhoMauCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapKhoMauInPhieuPopupComponent = /** @class */ (function () {
                function NhapKhoMauInPhieuPopupComponent(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                    this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
                    this.src = "";
                }
                NhapKhoMauInPhieuPopupComponent.prototype.ngOnInit = function () {
                    this.src = "data:text/html;charset=utf-8," + encodeURIComponent(this.data);
                };
                NhapKhoMauInPhieuPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                NhapKhoMauInPhieuPopupComponent.prototype.replaceAll = function (str, find, replace) {
                    return str.replace(new RegExp(find, "g"), replace);
                };
                NhapKhoMauInPhieuPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    ...
                    return new Promise(function (resolve) {
                        var source = _this.replaceAll(_this.data, "<p  style='background: #005dab;color:#fff; height:40px; font-size:30px;text-align:center'><th>PHIẾU TRUYỀN MÁU</th></p>", "");
                        source = _this.replaceAll(source, "zoom:100%;", "zoom:80%;");
                        setTimeout(function () {
                            resolve(source);
                        }, 100);
                        _this.close();
                ...
                return NhapKhoMauInPhieuPopupComponent;
            }());
            NhapKhoMauInPhieuPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapKhoMauListComponent = /** @class */ (function () {
                function NhapKhoMauListComponent(authService, notificationService, route, location, dialog, apiService, router) {
                    this.authService = authService;
                    this.notificationService = notificationService;
                    this.route = route;
                    this.location = location;
                ...
                NhapKhoMauListComponent.prototype.ngOnInit = function () {
                ...
                NhapKhoMauListComponent.prototype.searchChanges = function (event) {
                    if ((event == null || event == "") && this.strAdditionalSearchString != "") {
                        this.timKiemNangCao();
                    }
                };
                NhapKhoMauListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiemNangCao();
                    }
                };
                NhapKhoMauListComponent.prototype.clearSearch = function () {
                    this.timKiemObj.SearchString = null;
                    this.gridChild.searchString = null;
                    this.timKiemNangCao();
                };
                NhapKhoMauListComponent.prototype.timKiemNangCao = function () {
                ...
                NhapKhoMauListComponent.prototype.themNhapKhoMau = function () {
                ...
                NhapKhoMauListComponent.prototype.xuLyXuatExcel = function () {
                    var _this = this;
                ...
                NhapKhoMauListComponent.prototype.xemChiTiet = function (dataItem) {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Update)) {
                ...
                NhapKhoMauListComponent.prototype.xoaNhapKhoMau = function (nhapKhoMauId) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Delete)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_21__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                _this.apiService.delete("NhapKhoMau/XuLyXoaPhieuNhapKhoMau?id=" + nhapKhoMauId).subscribe(function (res) {
                ...
                return NhapKhoMauListComponent;
            }());
            NhapKhoMauListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapKhoMauSharedComponent = /** @class */ (function () {
                function NhapKhoMauSharedComponent(apiService, route, notificationService, authService, cdRef, dialog) {
                    this.apiService = apiService;
                    this.route = route;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                NhapKhoMauSharedComponent.prototype.ngOnInit = function () {
                    this.documentype = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_8__["DocumentType"].NhapKhoMau;
                ...
                NhapKhoMauSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    ...
                    this.apiService.get("NhapKhoMau/GetPhieuNhapKhoMau?id=" + id)
                        ...
                        if (resultData !== undefined && resultData != null) {
                            ...
                            _this.trangThaiYeuCau.emit(new _mau_model__WEBPACK_IMPORTED_MODULE_10__["TrangThaiDuyetNhapKhoMau"](_this.phieuNhapKhoMau.TenTrangThai, _this.phieuNhapKhoMau.DuocKeToanDuyet));
                            _this.gridDataSource.data = _this.phieuNhapKhoMau.NhapKhoMauChiTiets;
                ...
                NhapKhoMauSharedComponent.prototype.showPopupLoadingData = function () {
                ...
                NhapKhoMauSharedComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                NhapKhoMauSharedComponent.prototype.getData = function () {
                    var _this = this;
                    this.phieuNhapKhoMau.NhapKhoMauChiTiets.forEach(function (element, index) {
                        element.MaTuiMauDangNhaps = _this.phieuNhapKhoMau.NhapKhoMauChiTiets.filter(function (x) { return x != element; }).map(function (_a) {
                            var MaTuiMau = _a.MaTuiMau;
                            return MaTuiMau;
                        });
                        element.YeuCauTruyenMauIdDangChons = _this.phieuNhapKhoMau.NhapKhoMauChiTiets.filter(function (x) { return x != element; }).map(function (_a) {
                            var YeuCauTruyenMauId = _a.YeuCauTruyenMauId;
                            return YeuCauTruyenMauId;
                        });
                    });
                    return this.phieuNhapKhoMau;
                };
                NhapKhoMauSharedComponent.prototype.changeLoaiNguoiGiao = function () {
                    this.phieuNhapKhoMau.NguoiGiaoId = this.phieuNhapKhoMau.TenNguoiGiao = null;
                };
                NhapKhoMauSharedComponent.prototype.huyThongTinMau = function () {
                    this.phieuNhapKhoMauChiTiet = new _mau_model__WEBPACK_IMPORTED_MODULE_10__["NhapKhoMauChiTiet"]();
                ...
                NhapKhoMauSharedComponent.prototype.chonNhomMau = function (event) {
                    if (event != undefined && event != null) {
                ...
                NhapKhoMauSharedComponent.prototype.chonYeuToRh = function (event) {
                    if (event != undefined && event != null) {
                ...
                NhapKhoMauSharedComponent.prototype.chonYeuCauTruyenMau = function (event) {
                    if (event != undefined && event != null) {
                ...
                NhapKhoMauSharedComponent.prototype.chonNguoiLamXNHP = function (event) {
                    if (event != undefined && event != null) {
                ...
                NhapKhoMauSharedComponent.prototype.themThongTinMau = function () {
                    var _this = this;
                    this.validationErrorsChiTiet = [];
                    ...
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Add)) {
                        this.phieuNhapKhoMauChiTiet.MaTuiMauDangNhaps = this.phieuNhapKhoMau.NhapKhoMauChiTiets.map(function (_a) {
                            var MaTuiMau = _a.MaTuiMau;
                            return MaTuiMau;
                        });
                        this.phieuNhapKhoMauChiTiet.YeuCauTruyenMauIdDangChons = this.phieuNhapKhoMau.NhapKhoMauChiTiets.map(function (_a) {
                            var YeuCauTruyenMauId = _a.YeuCauTruyenMauId;
                            return YeuCauTruyenMauId;
                        });
                        this.apiService.post("NhapKhoMau/KiemTraValidationThemMauVaChePham", this.phieuNhapKhoMauChiTiet).subscribe(function (res) {
                            _this.phieuNhapKhoMau.NhapKhoMauChiTiets.push(res);
                            _this.huyThongTinMau();
                        }, function (err) {
                            _this.validationErrorsChiTiet = err.ValidationErrors;
                            if (err.Message != "Validation Failed") {
                                _this.notificationService.showError(err.Message);
                            }
                        });
                ...
                NhapKhoMauSharedComponent.prototype.capNhatThongTinMau = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                        var index_1 = this.phieuNhapKhoMauChiTiet.Index;
                        var chiTiet = this.phieuNhapKhoMau.NhapKhoMauChiTiets[index_1];
                        if (chiTiet != undefined && chiTiet != null) {
                            this.phieuNhapKhoMauChiTiet.MaTuiMauDangNhaps = this.phieuNhapKhoMau.NhapKhoMauChiTiets.filter(function (x) { return x.Index != index_1; }).map(function (_a) {
                                var MaTuiMau = _a.MaTuiMau;
                                return MaTuiMau;
                            });
                            this.phieuNhapKhoMauChiTiet.YeuCauTruyenMauIdDangChons = this.phieuNhapKhoMau.NhapKhoMauChiTiets.filter(function (x) { return x.Index != index_1; }).map(function (_a) {
                                var YeuCauTruyenMauId = _a.YeuCauTruyenMauId;
                                return YeuCauTruyenMauId;
                            });
                            this.apiService.post("NhapKhoMau/KiemTraValidationThemMauVaChePham", this.phieuNhapKhoMauChiTiet).subscribe(function (res) {
                                _this.phieuNhapKhoMau.NhapKhoMauChiTiets[index_1] = Object.assign({}, res);
                                _this.huyThongTinMau();
                            }, function (err) {
                                _this.validationErrorsChiTiet = err.ValidationErrors;
                                if (err.Message != "Validation Failed") {
                ...
                NhapKhoMauSharedComponent.prototype.xoaNhapMauChiTiet = function (index) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Delete)) {
                        if (this.phieuNhapKhoMau.NhapKhoMauChiTiets != null && this.phieuNhapKhoMau.NhapKhoMauChiTiets.length > 0) {
                            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                                ...
                                if (result == "Yes") {
                                    _this.phieuNhapKhoMau.NhapKhoMauChiTiets.splice(index, 1);
                                }
                            });
                        }
                    }
                ...
                NhapKhoMauSharedComponent.prototype.suaNhapMauChiTiet = function (dataItem, index) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                        if (this.phieuNhapKhoMau.NhapKhoMauChiTiets != null && this.phieuNhapKhoMau.NhapKhoMauChiTiets.length > 0) {
                            this.validationErrorsChiTiet = [];
                            ...
                            setTimeout(function () {
                                _this.phieuNhapKhoMauChiTiet = Object.assign({}, dataItem);
                                _this.phieuNhapKhoMauChiTiet.NguoiLamXetNghiemHoaHopId = dataItem.NguoiLamXetNghiemHoaHopId;
                                _this.phieuNhapKhoMauChiTiet.NguoiLamXetNghiemHoaHop = dataItem.NguoiLamXetNghiemHoaHop;
                                _this.phieuNhapKhoMauChiTiet.TenMauVaChePham = dataItem.TenMauVaChePham;
                            }, 300);
                ...
                NhapKhoMauSharedComponent.prototype.xoaKetQuaXetNghiemKhac = function (phieuNhapKhoMauChiTiet, index) {
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Delete)) {
                ...
                NhapKhoMauSharedComponent.prototype.clearValidateErrorOtherCallback = function (event) {
                ...
                return NhapKhoMauSharedComponent;
            }());
            NhapKhoMauSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/shared/component/dialogs/confirm/confirm.component */ "./src/app/shared/component/dialogs/confirm/confirm.component.ts");
            var NhapKhoMauUpdateComponent = /** @class */ (function () {
                function NhapKhoMauUpdateComponent(notificationService, authService, apiService, router, dialog, location) {
                    this.notificationService = notificationService;
                    this.authService = authService;
                    this.apiService = apiService;
                    this.router = router;
                ...
                NhapKhoMauUpdateComponent.prototype.ngOnInit = function () {
                    this.documentype = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_10__["DocumentType"].NhapKhoMau;
                };
                NhapKhoMauUpdateComponent.prototype.getTrangThaiYeuCau = function (event) {
                    if (event != undefined && event != null) {
                        this.trangThai = event;
                    }
                };
                NhapKhoMauUpdateComponent.prototype.xuLyLuu = function (inPhieu) {
                    var _this = this;
                    if (inPhieu === void 0) { inPhieu = false; }
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Add)) {
                        this.dialog
                            ...
                            if (result == "Yes") {
                                ...
                                var phieuNhapKho = _this.shared.getData();
                                phieuNhapKho.InPhieu = inPhieu;
                                _this.apiService.put("NhapKhoMau/XuLyCapNhatPhieuNhapKhoMau", phieuNhapKho).subscribe(function (res) {
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                                    if (inPhieu) {
                                        _this.dialog.open(_nhap_kho_mau_in_phieu_popup_nhap_kho_mau_in_phieu_popup_component__WEBPACK_IMPORTED_MODULE_12__["NhapKhoMauInPhieuPopupComponent"], {
                                            disableClose: false,
                                            width: '1200px',
                                            data: res,
                                        }).afterClosed().subscribe(function (result) {
                ...
                NhapKhoMauUpdateComponent.prototype.xuLyInPhieu = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].View)) {
                        ...
                        this.apiService.get("NhapKhoMau/XuLyInPhieuTruyenMau?phieuTruyenMauId=" + phieuNhapKho.Id).subscribe(function (res) {
                            _this.dialog.open(_nhap_kho_mau_in_phieu_popup_nhap_kho_mau_in_phieu_popup_component__WEBPACK_IMPORTED_MODULE_12__["NhapKhoMauInPhieuPopupComponent"], {
                                disableClose: false,
                                width: '1200px',
                                data: res,
                ...
                NhapKhoMauUpdateComponent.prototype.huy = function () {
                    //this.router.navigate([this.baseRoute]);
                    this.location.back();
                };
                return NhapKhoMauUpdateComponent;
            }());
            NhapKhoMauUpdateComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=nhap-xuat-mau-mau-module-es5.js.map
//# sourceMappingURL=nhap-xuat-mau-mau-module-es5.js.map