...
let DichVuGiuongListComponent = class DichVuGiuongListComponent {
    constructor(route, apiService, dialog, notificationService) {
        this.route = route;
    ...
    exportExcel() {
        ...
        this.apiService.postExportExcel("DichVuGiuong/ExportDichVuGiuong", this.gridChild._gridQueryInfo).subscribe(res => {
...
DichVuGiuongListComponent.ctorParameters = () => [
...
let DichVuGiuongRoutingModule = class DichVuGiuongRoutingModule {
};
...
let DichVuGiuongModule = class DichVuGiuongModule {
};
...
let DichVuGiuongService = class DichVuGiuongService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DichVuGiuong';
    }
};
DichVuGiuongService.ctorParameters = () => [
