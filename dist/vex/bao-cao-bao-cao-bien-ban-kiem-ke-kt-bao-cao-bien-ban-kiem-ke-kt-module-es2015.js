...
let BaoCaoBienBanKiemKeKtListComponent = class BaoCaoBienBanKiemKeKtListComponent {
    ...
    pageChange(event) {
        ...
        if (this.dataSource.data.length == 0) {
            ...
            this.apiService.post("BaoCao/GetDataBaoCaoBienBanKiemKeKTForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoBienBanKiemKeKtListComponent.ctorParameters = () => [
...
let BaoCaoBienBanKiemKeKtRoutingModule = class BaoCaoBienBanKiemKeKtRoutingModule {
};
...
class BaoCaoBienBanKiemKeKTSearch {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, KhoaPhongId = null, KhoId = null, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
let BaoCaoBienBanKiemKeKtModule = class BaoCaoBienBanKiemKeKtModule {
};
...
let BaoCaoBienBanKiemKeKtService = class BaoCaoBienBanKiemKeKtService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoBienBanKiemKeKtService.ctorParameters = () => [
