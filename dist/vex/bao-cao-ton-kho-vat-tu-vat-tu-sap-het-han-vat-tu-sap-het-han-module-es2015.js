...
let VatTuSapHetHanListComponent = class VatTuSapHetHanListComponent {
    ...
    xemBaoCao() {
        ...
        let dialogRef = this.dialog.open(_vat_tu_sap_het_han_popup_vat_tu_sap_het_han_popup_component__WEBPACK_IMPORTED_MODULE_10__["VatTuSapHetHanPopupComponent"], {
            //disableClose: true,
            width: '1500px',
            // height: '500px',
    ...
    getSharedPrintForm() {
        ...
        return new Promise(resolve => {
            this.apiService.get(`TonKho/GetVatTuSapHetHanHTML?searchString=${queryString}`).subscribe(resultData => {
                resolve(resultData);
            });
        });
    }
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_22__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("TonKho/ExportVatTuSapHetHan", this.gridChild._gridQueryInfo).subscribe(res => {
...
VatTuSapHetHanListComponent.ctorParameters = () => [
...
let VatTuSapHetHanPopupComponent = class VatTuSapHetHanPopupComponent {
    ...
    GetHTML() {
        this.loading = true;
        this.apiService.get(`TonKho/GetVatTuSapHetHanHTML?searchString=${this.data.searchString}`).subscribe(res => {
            if (res != null) {
                var html = res;
                $(".a").show();
                $(".showPdf").append(html);
    ...
    getSharedPrintForm() {
        return new Promise(resolve => {
            this.apiService.get(`TonKho/GetVatTuSapHetHanHTML?searchString=${this.data.searchString}`).subscribe(resultData => {
                resolve(resultData);
...
VatTuSapHetHanPopupComponent.ctorParameters = () => [
...
let VatTuSapHetHanRoutingModule = class VatTuSapHetHanRoutingModule {
};
...
let VatTuSapHetHanModule = class VatTuSapHetHanModule {
};
...
let VatTuSapHetHanService = class VatTuSapHetHanService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'TonKho';
    }
};
VatTuSapHetHanService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
