(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-tinh-hinh-benh-tat-tu-vong-bao-cao-tinh-hinh-benh-tat-tu-vong-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTinhHinhBenhTatTuVongRoutingModule = /** @class */ (function () {
                function BaoCaoTinhHinhBenhTatTuVongRoutingModule() {
                }
                return BaoCaoTinhHinhBenhTatTuVongRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTinhHinhBenhTatTuVongModule = /** @class */ (function () {
                function BaoCaoTinhHinhBenhTatTuVongModule() {
                }
                return BaoCaoTinhHinhBenhTatTuVongModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoTinhHinhBenhTatTuVong = /** @class */ (function () {
                function BaoCaoTinhHinhBenhTatTuVong(TuNgay, DenNgay) {
                    if (TuNgay === void 0) { TuNgay = null; }
                    if (DenNgay === void 0) { DenNgay = null; }
                    this.TuNgay = TuNgay;
                    this.DenNgay = DenNgay;
                }
                return BaoCaoTinhHinhBenhTatTuVong;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachBaoCaoTinhHinhBenhTatTuVongComponent = /** @class */ (function () {
                function DanhSachBaoCaoTinhHinhBenhTatTuVongComponent(apiService, dialog, notificationService, authService, ref) {
                ...
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.ngOnInit = function () {
                ...
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.pageChange = function (event) {
                ...
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.xemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetDataTinhHinhBenhTatTuVongForGrid", this.baoCaoSearch).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            ...
                            _this.sumHDKBSoLanKhamChung = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.HDKBSoLanKhamChung; }, 0);
                            _this.sumHDKBSoLanKhamTreEm = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.HDKBSoLanKhamTreEm; }, 0);
                            _this.sumHDKBSoTuVong = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.HDKBSoTuVong; }, 0);
                            _this.sumTSBNSoMacBenh = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.TSBNSoMacBenh; }, 0);
                            _this.sumTSBNSoTuVong = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.TSBNSoTuVong; }, 0);
                            _this.sumTSBNNgayDieuTri = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.TSBNNgayDieuTri; }, 0);
                            _this.sumTEMacTS = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.TEMacTS; }, 0);
                            _this.sumTEMacDuoi6T = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.TEMacDuoi6T; }, 0);
                            _this.sumTESoTuVongTS = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.TESoTuVongTS; }, 0);
                            _this.sumTESoTuVongDuoi6T = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.TESoTuVongDuoi6T; }, 0);
                            _this.sumTENgayDieuTriTS = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.TENgayDieuTriTS; }, 0);
                            _this.sumTENgayDieuTriDuoi6T = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.TENgayDieuTriDuoi6T; }, 0);
                            _this.sumTren60TMacBenhTS = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.Tren60TMacBenhTS; }, 0);
                            _this.sumTren60TMacBenhLaNu = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.Tren60TMacBenhLaNu; }, 0);
                            _this.sumTren60TTuVongTS = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.Tren60TTuVongTS; }, 0);
                            _this.sumTren60TTuVongLaNu = resultData.Data.filter(function (c) { return c.LaChuong !== true; }).reduce(function (sum, item) { return sum + item.Tren60TTuVongLaNu; }, 0);
                            _this.closeAllDialogs();
                        }
                    });
                };
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.xuatBaoCao = function () {
                    var self = this;
                    if (this.baoCaoSearch.TuNgay == null || this.baoCaoSearch.DenNgay == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.showLoadingPopup = function () {
                ...
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.showSavingPopup = function () {
                    if (!this.loadingPopup) {
                        this.loadingPopup = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_8__["LoadingComponent"], {
                            disableClose: true,
                            width: '200px',
                ...
                DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.prototype.closeAllDialogs = function () {
                    if (this.loadingPopup) {
                        this.loadingPopup.close();
                        this.loadingPopup = null;
                    }
                };
                return DanhSachBaoCaoTinhHinhBenhTatTuVongComponent;
            }());
            DanhSachBaoCaoTinhHinhBenhTatTuVongComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-tinh-hinh-benh-tat-tu-vong-bao-cao-tinh-hinh-benh-tat-tu-vong-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-tinh-hinh-benh-tat-tu-vong-bao-cao-tinh-hinh-benh-tat-tu-vong-module-es5.js.map