...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-hanh-chinh-chuc-vu-chuc-vu-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChucVuCreateComponent = /** @class */ (function () {
                function ChucVuCreateComponent(router) {
                    this.router = router;
                }
                ChucVuCreateComponent.prototype.ngOnInit = function () {
                };
                ChucVuCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/hanh-chinh/chuc-vu']);
                };
                return ChucVuCreateComponent;
            }());
            ChucVuCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChucVuListComponent = /** @class */ (function () {
                function ChucVuListComponent(authService, dialog, notificationService, apiService) {
                ...
                ChucVuListComponent.prototype.updateChucVu = function (id, isDisabled) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_4__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                self.apiService.post("ChucVu/KichHoatChucVu?id=" + id).subscribe(function () {
                ...
                ChucVuListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_4__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("ChucVu/ExportChucVu", this.gridChild._gridQueryInfo).subscribe(function (res) {
            ...
            ChucVuListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChucVuRoutingModule = /** @class */ (function () {
                function ChucVuRoutingModule() {
                }
                return ChucVuRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChucVuSharedComponent = /** @class */ (function () {
                function ChucVuSharedComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.chucvu = {};
                    this.isCreate = true;
                }
                ChucVuSharedComponent.prototype.ngOnInit = function () {
                ...
                ChucVuSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.chucvu = resultData;
                    });
                };
                ChucVuSharedComponent.prototype.getSharedData = function () {
                    return this.chucvu;
                };
                return ChucVuSharedComponent;
            }());
            ChucVuSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChucVuUpdateComponent = /** @class */ (function () {
                function ChucVuUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                ChucVuUpdateComponent.prototype.ngOnInit = function () {
                };
                ChucVuUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/hanh-chinh/chuc-vu']);
                };
                return ChucVuUpdateComponent;
            }());
            ChucVuUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChucVuService = /** @class */ (function (_super) {
                __extends(ChucVuService, _super);
                function ChucVuService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'ChucVu';
                    return _this;
                }
                return ChucVuService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            ChucVuService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-hanh-chinh-chuc-vu-chuc-vu-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-hanh-chinh-chuc-vu-chuc-vu-module-es5.js.map