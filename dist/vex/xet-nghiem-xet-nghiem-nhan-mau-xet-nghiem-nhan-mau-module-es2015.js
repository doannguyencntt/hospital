...
let XetNghiemNhanMauListComponent = class XetNghiemNhanMauListComponent {
...
XetNghiemNhanMauListComponent.ctorParameters = () => [
...
let XetNghiemNhanMauRoutingModule = class XetNghiemNhanMauRoutingModule {
};
...
class XetNghiemNhanMauTimKiem {
    constructor(SearchString = null, HopDongKhamSucKhoeId = 0, YeuCauTiepNhanId = null, PhienXetNghiemId = null, TrangThai = new XetNghiemNhanMauTimKiemTrangThai(), TuNgayDenNgay = new _xet_nghiem_cap_code_xet_nghiem_cap_code_model__WEBPACK_IMPORTED_MODULE_1__["XetNghiemCapCodeTimKiemDateRange"](), ThoiDiemHienTai = new Date(), SoLuong = null) {
...
class XetNghiemNhanMauTimKiemTrangThai {
    constructor(ChuaNhanMau = true, DaNhanMau = false) {
...
let XetNghiemNhanMauModule = class XetNghiemNhanMauModule {
};
...
let XetNghiemNhanMauService = class XetNghiemNhanMauService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = "XetNghiem";
    }
};
XetNghiemNhanMauService.ctorParameters = () => [
