...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-cap-quan-ly-benh-vien-cap-quan-ly-benh-vien-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CapQuanLyBenhVienCreateComponent = /** @class */ (function () {
                function CapQuanLyBenhVienCreateComponent(router) {
                    this.router = router;
                }
                CapQuanLyBenhVienCreateComponent.prototype.ngOnInit = function () {
                };
                CapQuanLyBenhVienCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/cap-quan-ly-benh-vien']);
                };
                return CapQuanLyBenhVienCreateComponent;
            }());
            CapQuanLyBenhVienCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CapQuanLyBenhVienListComponent = /** @class */ (function () {
                function CapQuanLyBenhVienListComponent(notificationService, authService, dialog, apiService) {
                ...
                CapQuanLyBenhVienListComponent.prototype.ngOnInit = function () {
                ...
                CapQuanLyBenhVienListComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('CapQuanLyBenhVien/ExportCapQuanLyBenhVien', self.gridChild._gridQueryInfo).subscribe(function (resultData) {
                ...
                CapQuanLyBenhVienListComponent.prototype.showPopupLoadingData = function () {
                ...
                CapQuanLyBenhVienListComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return CapQuanLyBenhVienListComponent;
            }());
            CapQuanLyBenhVienListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CapQuanLyBenhVienRoutingModule = /** @class */ (function () {
                function CapQuanLyBenhVienRoutingModule() {
                }
                return CapQuanLyBenhVienRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CapQuanLyBenhVienSharedComponent = /** @class */ (function () {
                function CapQuanLyBenhVienSharedComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.capQuanLyBenhVien = {};
                }
                CapQuanLyBenhVienSharedComponent.prototype.ngOnInit = function () {
                    var id = this.route.snapshot.params.id;
                    if (id !== undefined && id !== null) {
                        this.getById(id);
                    }
                };
                CapQuanLyBenhVienSharedComponent.prototype.getSharedData = function () {
                    return this.capQuanLyBenhVien;
                };
                CapQuanLyBenhVienSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.capQuanLyBenhVien = resultData;
                    });
                };
                return CapQuanLyBenhVienSharedComponent;
            }());
            CapQuanLyBenhVienSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _cap_quan_ly_benh_vien_shared_cap_quan_ly_benh_vien_shared_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../cap-quan-ly-benh-vien-shared/cap-quan-ly-benh-vien-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/benh-vien/cap-quan-ly-benh-vien/cap-quan-ly-benh-vien-shared/cap-quan-ly-benh-vien-shared.component.ts");
            var CapQuanLyBenhVienUpdateComponent = /** @class */ (function () {
                function CapQuanLyBenhVienUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                CapQuanLyBenhVienUpdateComponent.prototype.ngOnInit = function () {
                };
                CapQuanLyBenhVienUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/cap-quan-ly-benh-vien']);
                };
                return CapQuanLyBenhVienUpdateComponent;
            }());
            CapQuanLyBenhVienUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CapQuanLyBenhVienModule = /** @class */ (function () {
                function CapQuanLyBenhVienModule() {
                }
                return CapQuanLyBenhVienModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CapQuanLyBenhVienService = /** @class */ (function (_super) {
                __extends(CapQuanLyBenhVienService, _super);
                function CapQuanLyBenhVienService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'CapQuanLyBenhVien';
                    return _this;
                }
                return CapQuanLyBenhVienService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            CapQuanLyBenhVienService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-cap-quan-ly-benh-vien-cap-quan-ly-benh-vien-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-cap-quan-ly-benh-vien-cap-quan-ly-benh-vien-module-es5.js.map