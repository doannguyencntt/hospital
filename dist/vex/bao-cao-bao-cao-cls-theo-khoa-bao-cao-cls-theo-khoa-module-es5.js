...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-cls-theo-khoa-bao-cao-cls-theo-khoa-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoClsTheoKhoaListComponent = /** @class */ (function () {
                function BaoCaoClsTheoKhoaListComponent(apiService, dialog, notificationService, authService, ref) {
                ...
                BaoCaoClsTheoKhoaListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoClsTheoKhoaListComponent.prototype.columnResize = function (event) {
                    var _this = this;
                ...
                BaoCaoClsTheoKhoaListComponent.prototype.getSoLanSum = function (value) {
                    if (value) {
                        return value.sum;
                    }
                };
                BaoCaoClsTheoKhoaListComponent.prototype.totalSoLan = function () {
                    if (this.gridDataSource.data != undefined) {
                        return this.gridDataSource.data.reduce(function (sum, item) { return sum + item.SoLan; }, 0);
                    }
                };
                BaoCaoClsTheoKhoaListComponent.prototype.totalThanhTienNiemYet = function () {
                    if (this.gridDataSource.data != undefined) {
                        return this.gridDataSource.data.reduce(function (sum, item) { return sum + item.TongThanhTienNiemYet; }, 0);
                    }
                };
                BaoCaoClsTheoKhoaListComponent.prototype.totalThanhTienThucThu = function () {
                    if (this.gridDataSource.data != undefined) {
                        return this.gridDataSource.data.reduce(function (sum, item) { return sum + item.TongThanhTienThucThu; }, 0);
                    }
                };
                BaoCaoClsTheoKhoaListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoClsTheoKhoaListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoClsTheoKhoaListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoClsTheoKhoaListComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoClsTheoKhoaListComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoClsTheoKhoaListComponent.prototype.changeNgayBatDauRange = function () {
                };
                BaoCaoClsTheoKhoaListComponent.prototype.searchRefresh = function () {
                };
                BaoCaoClsTheoKhoaListComponent.prototype.pageChange = function (event) {
                ...
                BaoCaoClsTheoKhoaListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCaoThucHienCls/GetDataForGridAsyncHoatDongCLS", this.baoCaoClsTheoKhoa).subscribe(function (resultData) {
                ...
                BaoCaoClsTheoKhoaListComponent.prototype.reFresh = function () {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoClsTheoKhoaListComponent.prototype.XuatBaoCao = function () {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        ...
                        self.apiService.postExportExcel('BaoCaoThucHienCls/ExportBaoCaoHoatDongClsTheoKhoa', this.baoCaoClsTheoKhoa).subscribe(function (resultData) {
                ...
                return BaoCaoClsTheoKhoaListComponent;
            }());
            BaoCaoClsTheoKhoaListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoClsTheoKhoaRoutingModule = /** @class */ (function () {
                function BaoCaoClsTheoKhoaRoutingModule() {
                }
                return BaoCaoClsTheoKhoaRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoClsTheoKhoaBacSi = /** @class */ (function () {
                function BaoCaoClsTheoKhoaBacSi(SearchString, RangeFromDate, KhoaId, BacSiKetLuanId, FromDate, ToDate, ThoiDiemTiepNhanTuFormat, ThoiDiemTiepNhanDenFormat) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoClsTheoKhoaModule = /** @class */ (function () {
                function BaoCaoClsTheoKhoaModule() {
                }
                return BaoCaoClsTheoKhoaModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var BaoCaoClsTheoKhoaService = /** @class */ (function (_super) {
                __extends(BaoCaoClsTheoKhoaService, _super);
                function BaoCaoClsTheoKhoaService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCaoThucHienCls';
                    return _this;
                }
                return BaoCaoClsTheoKhoaService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            BaoCaoClsTheoKhoaService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
...
//# sourceMappingURL=bao-cao-bao-cao-cls-theo-khoa-bao-cao-cls-theo-khoa-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-cls-theo-khoa-bao-cao-cls-theo-khoa-module-es5.js.map