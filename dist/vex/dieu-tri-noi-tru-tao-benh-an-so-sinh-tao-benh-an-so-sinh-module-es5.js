(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dieu-tri-noi-tru-tao-benh-an-so-sinh-tao-benh-an-so-sinh-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaoBenhAnSoSinhRoutingModule = /** @class */ (function () {
                function TaoBenhAnSoSinhRoutingModule() {
                }
                return TaoBenhAnSoSinhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaoBenhAnSoSinhComponent = /** @class */ (function () {
                function TaoBenhAnSoSinhComponent(route, authService, notificationService, baseService, apiService, dialog, cdRef) {
                    this.route = route;
                ...
                TaoBenhAnSoSinhComponent.prototype.ngOnInit = function () {
                    this.getKhoaPhongChuyenVe();
                    this.tiepNhanBenhNhan.NgayThangNamSinh = this.dacDiemTreSoSinh.DeLuc;
                };
                TaoBenhAnSoSinhComponent.prototype.getThongTinBenhAnMe = function (yeuCauTiepNhanId) {
                    var _this = this;
                    ...
                    this.apiService
                        ...
                        _this.tiepNhanBenhNhan.NgayThangNamSinh = _this.dacDiemTreSoSinh.DeLuc;
                        _this.getKhoaPhongChuyenVe();
                ...
                TaoBenhAnSoSinhComponent.prototype.getChonBenhAnMe = function () {
                    var _this = this;
                    this.apiService.post("DieuTriNoiTru/ChonBenhAnMe").subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.dataThongTinBenhAnMe = resultData;
                            //this.comboboxChonBA.getDataForLookup();
                        }
                    });
                };
                TaoBenhAnSoSinhComponent.prototype.getKhoaPhongChuyenVe = function () {
                    var _this = this;
                    this.apiService.post("DieuTriNoiTru/KhoaChuyenBenhAnSoSinhVe").subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.dataKhoaPhongChuyenVe = resultData;
                            _this.tiepNhanBenhNhan.KhoaChuyenBenhAnSoSinhVeId = resultData[0].KeyId;
                            _this.currentKhoaPhongChuyenVe.KeyId = resultData[0].KeyId;
                            _this.currentKhoaPhongChuyenVe.DisplayName = resultData[0].DisplayName;
                        }
                    });
                };
                TaoBenhAnSoSinhComponent.prototype.getThongTinHanhChinh = function (id) {
                    var _this = this;
                    this.apiService.get("DieuTriNoiTru/" + id).subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.dieuTriNoiTru = resultData;
                            _this.getThongTinBenhAnMe(id);
                        }
                    });
                };
                TaoBenhAnSoSinhComponent.prototype.selectionChangeBenhAnMe = function (dateItem) {
                ...
                TaoBenhAnSoSinhComponent.prototype.TinhThanhPhoChange = function (event) {
                ...
                TaoBenhAnSoSinhComponent.prototype.QuanHuyenChange = function (event) {
                    if (event == undefined || event == null) {
                        // this.tiepNhanBenhNhan.QuanHuyenId = event;
                        this.tiepNhanBenhNhan.PhuongXaId = null;
                    }
                };
                TaoBenhAnSoSinhComponent.prototype.PhuongXaChange = function ($event) {
                    var _this = this;
                ...
                TaoBenhAnSoSinhComponent.prototype.TinhThanhPhoNguoiLienHeChange = function (event) {
                    if (event == undefined || event == null) {
                ...
                TaoBenhAnSoSinhComponent.prototype.QuanHuyenNguoiLienHeChange = function (event) {
                    if (event == undefined || event == null) {
                        this.tiepNhanBenhNhan.NguoiLienHePhuongXaId = null;
                    }
                };
                TaoBenhAnSoSinhComponent.prototype.PhuongXaNguoiLienHeChange = function (event) {
                    var _this = this;
                    if (event != null && event != undefined) {
                        this.apiService.post("TiepNhanBenhNhan/SetTinhThanhQuanHuyen?phuongXaId=" + event).subscribe(function (resultData) {
                ...
                TaoBenhAnSoSinhComponent.prototype.showPopupLoadingData = function () {
                ...
                TaoBenhAnSoSinhComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TaoBenhAnSoSinhComponent.prototype.xuLyTaoBenhAnSoSinh = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Add)) {
                        ...
                        if (this.tiepNhanBenhNhan.TenBanDau == undefined && this.tiepNhanBenhNhan.TenBanDau == null) {
                            ...
                            if (this.thongTinBenhAnMe.KeyId != undefined && this.thongTinBenhAnMe.KeyId != null) {
                                this.apiService.get("DieuTriNoiTru/BenhAnMeCoConTrungTen?yeuCauTiepNhanBenhAnMeId=" + this.thongTinBenhAnMe.KeyId + "&hoTen=" + this.tiepNhanBenhNhan.TenBanDau).subscribe(function (resultData) {
                                    if (resultData) {
                                        _this.taoBenhAnSoSinh("<span class=\"red-text\">\u0110\u00E3 t\u1EA1o BA con c\u00F3 t\u00EAn " + _this.tiepNhanBenhNhan.TenBanDau.toUpperCase().bold() + " .B\u1EA1n c\u00F3 ch\u1EAFc mu\u1ED1n t\u1EA1o ti\u1EBFp BA n\u00E0y kh\u00F4ng?</span>");
                                    }
                                    else {
                                        _this.taoBenhAnSoSinh("Bạn có chắc chắn muốn tạo bệnh án sơ sinh không?");
                                    }
                                });
                            }
                        }
                ...
                TaoBenhAnSoSinhComponent.prototype.taoBenhAnSoSinh = function (message) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_13__["ConfirmComponent"], {
                        ...
                        if (result == "Yes") {
                            ...
                            if (_this.dieuTriNoiTru != undefined && _this.dieuTriNoiTru != null) {
                                _this.LuuDacDiemSoSinhCuaChoBenhAnMeKhacKhoa(_this.thongTinBenhAnMe.KeyId);
                            }
                        }
                    });
                };
                TaoBenhAnSoSinhComponent.prototype.LuuDacDiemSoSinhCuaChoBenhAnMeKhacKhoa = function (yeuCauTiepNhanMeId) {
                    var _this = this;
                    var taoBenhAnSoSinhKhacKhoa = new _dieu_tri_noi_tru_model__WEBPACK_IMPORTED_MODULE_7__["TaoBenhAnSoSinhKhacKhoa"]();
                    ...
                    this.apiService.post("DieuTriNoiTru/XuLyTaoBenhAnSoSinhKhacKhoa", taoBenhAnSoSinhKhacKhoa)
                        .subscribe(function (result) {
                        _this.closePopupLoadingData();
                        _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ["Tạo bệnh án"]));
                        _this.xuLyChiDinhEkipVaDichVuGiuong(result.BenhAnSoSinhChiTietViewModel);
                        if (result.ResultYeuCauTiepNhanId != undefined && result.ResultYeuCauTiepNhanId != null) {
                            _this.luuThongTinSoSinhDuocChon(_this.thongTinBenhAnMe.YeuCauTiepNhanMeId, result.ResultYeuCauTiepNhanId);
                        }
                    }, function (err) {
                ...
                TaoBenhAnSoSinhComponent.prototype.luuThongTinSoSinhDuocChon = function (yeuCauTiepNhanMeId, yeuCauTiepNhanConId) {
                    var _this = this;
                ...
                TaoBenhAnSoSinhComponent.prototype.selectionChangeKhoaPhongChuyenVe = function (dataItem) {
                ...
                TaoBenhAnSoSinhComponent.prototype.xuLyChiDinhEkipVaDichVuGiuong = function (yeuCauTiepNhan) {
                    var _this = this;
                ...
                TaoBenhAnSoSinhComponent.prototype.modelChangeGioiTinh = function (event) {
                    if (event === 1) {
                ...
                TaoBenhAnSoSinhComponent.prototype.modelChangeGioiTinhTiepNhan = function (event) {
                    if (event === 1) {
                ...
                TaoBenhAnSoSinhComponent.prototype.modelChangeNgaySinh = function (event) {
                    this.dacDiemTreSoSinh.DeLuc = event;
                };
                TaoBenhAnSoSinhComponent.prototype.modelChangeDeLuc = function (event) {
                    this.tiepNhanBenhNhan.NgayThangNamSinh = event;
                };
                TaoBenhAnSoSinhComponent.prototype.huy = function () {
                    this.getKhoaPhongChuyenVe();
                    this.tiepNhanBenhNhan = new _tiep_nhan_noi_tru_tiep_nhan_noi_tru_model__WEBPACK_IMPORTED_MODULE_8__["ThongTinDoiTuongSoSinhTiepNhan"]();
                    this.dacDiemTreSoSinh = new _dieu_tri_noi_tru_model__WEBPACK_IMPORTED_MODULE_7__["DacDiemTreSoSinh"]();
                    this.dieuTriNoiTru = new _dieu_tri_noi_tru_model__WEBPACK_IMPORTED_MODULE_7__["ChiTietDieuTriNoiTruViewModel"]();
                ...
                return TaoBenhAnSoSinhComponent;
            }());
            TaoBenhAnSoSinhComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ThongTinBenhAnMe = /** @class */ (function () {
                function ThongTinBenhAnMe(KeyId, DisplayName, YeuCauTiepNhanMeId, MaBA, MaTN, MaBN, HoTen, NamSinh) {
                ...
                return ThongTinBenhAnMe;
            }());
            var LookupItemChuyenKhoaVo = /** @class */ (function () {
                function LookupItemChuyenKhoaVo(KeyId, DisplayName) {
                    if (KeyId === void 0) { KeyId = null; }
                    if (DisplayName === void 0) { DisplayName = null; }
                    this.KeyId = KeyId;
                    this.DisplayName = DisplayName;
                }
                return LookupItemChuyenKhoaVo;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaoBenhAnSoSinhModule = /** @class */ (function () {
                function TaoBenhAnSoSinhModule() {
                }
                return TaoBenhAnSoSinhModule;
            }());
...
//# sourceMappingURL=dieu-tri-noi-tru-tao-benh-an-so-sinh-tao-benh-an-so-sinh-module-es5.js.map
//# sourceMappingURL=dieu-tri-noi-tru-tao-benh-an-so-sinh-tao-benh-an-so-sinh-module-es5.js.map