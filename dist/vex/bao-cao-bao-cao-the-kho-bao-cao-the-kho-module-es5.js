...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-the-kho-bao-cao-the-kho-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTheKhoListComponent = /** @class */ (function () {
                // public pageChange(event: PageChangeEvent): void {
                //   this.baoCaoTheKhoSearch.Skip = event.skip;
                //   this.skip = event.skip;
                //   // this.XemBaoCao();
                // }
                function BaoCaoTheKhoListComponent(apiService, dialog, authService, notificationService, cd) {
                ...
                BaoCaoTheKhoListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoTheKhoListComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoTheKhoListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoTheKhoListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoTheKhoListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoTheKhoListComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoTheKhoListComponent.prototype.totalTonDauKy = function (field) {
                    if (this.dataSource.data.length > 0) {
                        return this.dataSource.data[0].TongSLTonDauKy;
                        // return this.dataSource.data.reduce((sum, item) => sum + item.ThanhTien, 0);
                    }
                };
                BaoCaoTheKhoListComponent.prototype.totalSL = function (field) {
                    switch (field) {
                        case 'TongSLNhap':
                ...
                BaoCaoTheKhoListComponent.prototype.detailExpand = function (event) {
                    if (event.dataItem) {
                ...
                BaoCaoTheKhoListComponent.prototype.searchChanges = function (event) { };
                BaoCaoTheKhoListComponent.prototype.pageChange = function (event) {
                    this.skip = event.skip;
                    this.XemBaoCao();
                };
                BaoCaoTheKhoListComponent.prototype.reFresh = function () {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoTheKhoListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCaoTheKho/GetDataForGridAsync", this.baoCaoTheKhoSearch).subscribe(function (resultData) {
                ...
                BaoCaoTheKhoListComponent.prototype.InBaoCao = function () {
                    // let khoId = 0;
                ...
                BaoCaoTheKhoListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.baoCaoTheKhoSearch.RangeFromDate.startDate == null || this.baoCaoTheKhoSearch.RangeFromDate.endDate == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                BaoCaoTheKhoListComponent.prototype.changeValueStart = function (dataItem) {
                ...
                BaoCaoTheKhoListComponent.prototype.khoChange = function (khoId) {
                ...
                BaoCaoTheKhoListComponent.prototype.selectionChangeDpVT = function (dataItem) {
                ...
                return BaoCaoTheKhoListComponent;
            }());
            BaoCaoTheKhoListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var BaoCaoTheKhoPopupComponent = /** @class */ (function () {
                function BaoCaoTheKhoPopupComponent() {
                }
                BaoCaoTheKhoPopupComponent.prototype.ngOnInit = function () {
                };
                return BaoCaoTheKhoPopupComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTheKhoSearch = /** @class */ (function () {
                function BaoCaoTheKhoSearch(RangeFromDate, startDate, endDate, KhoId, DuocPhamHoacVatTuBenhVienId, LoaiDuocPhamHoacVatTu, NgayThang, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTheKhoService = /** @class */ (function (_super) {
                __extends(BaoCaoTheKhoService, _super);
                function BaoCaoTheKhoService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCaoTheKho';
                    return _this;
                }
                return BaoCaoTheKhoService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoTheKhoService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-the-kho-bao-cao-the-kho-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-the-kho-bao-cao-the-kho-module-es5.js.map