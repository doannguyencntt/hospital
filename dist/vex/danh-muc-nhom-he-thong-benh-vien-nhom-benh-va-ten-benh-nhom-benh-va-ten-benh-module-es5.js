...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-nhom-benh-va-ten-benh-nhom-benh-va-ten-benh-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomBenhVaTenBenhCreateComponent = /** @class */ (function () {
                function NhomBenhVaTenBenhCreateComponent(router) {
                    this.router = router;
                }
                NhomBenhVaTenBenhCreateComponent.prototype.ngOnInit = function () {
                };
                NhomBenhVaTenBenhCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/nhom-benh-va-ten-benh']);
                };
                return NhomBenhVaTenBenhCreateComponent;
            }());
            NhomBenhVaTenBenhCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomBenhVaTenBenhListComponent = /** @class */ (function () {
                function NhomBenhVaTenBenhListComponent(authService, dialog, notificationService, apiService) {
                ...
                NhomBenhVaTenBenhListComponent.prototype.ngOnInit = function () {
                ...
                NhomBenhVaTenBenhListComponent.prototype.updateTinhTrang = function (id, isDisabled) {
                    var self = this;
                    var comfirm = isDisabled ? "sử dụng" : "ngừng sử dụng";
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_17__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                self.apiService.post("NhomICDTheoBenhVien/KichHoatTrangThaiNhoBenhVaTenBenh?id=" + id).subscribe(function () {
                ...
                NhomBenhVaTenBenhListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("QuocGia/ExportQuocGia", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return NhomBenhVaTenBenhListComponent;
            }());
            NhomBenhVaTenBenhListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomBenhVaTenBenhRoutingModule = /** @class */ (function () {
                function NhomBenhVaTenBenhRoutingModule() {
                }
                return NhomBenhVaTenBenhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomBenhVaTenBenhSharedComponent = /** @class */ (function () {
                function NhomBenhVaTenBenhSharedComponent(route, baseService, notificationService) {
                    this.route = route;
                ...
                NhomBenhVaTenBenhSharedComponent.prototype.ngOnInit = function () {
                ...
                NhomBenhVaTenBenhSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (res) {
                        _this.nhomBenhVaTenBenh = res;
                        _this.queryMaICD.ParameterDependencies = '{MaICD:\'' + _this.nhomBenhVaTenBenh.MoTa + '\'}';
                        _this.queryMaICD.Take = 50;
                        _this.maICDMultiselect.queryInfo = _this.queryMaICD;
                        _this.maICDMultiselect.getDataForLookup();
                    });
                };
                NhomBenhVaTenBenhSharedComponent.prototype.getSharedData = function () {
                    return this.nhomBenhVaTenBenh;
                };
                return NhomBenhVaTenBenhSharedComponent;
            }());
            NhomBenhVaTenBenhSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _nhom_benh_va_ten_benh_shared_nhom_benh_va_ten_benh_shared_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../nhom-benh-va-ten-benh-shared/nhom-benh-va-ten-benh-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/benh-vien/nhom-benh-va-ten-benh/nhom-benh-va-ten-benh-shared/nhom-benh-va-ten-benh-shared.component.ts");
            var NhomBenhVaTenBenhUpdateComponent = /** @class */ (function () {
                function NhomBenhVaTenBenhUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                NhomBenhVaTenBenhUpdateComponent.prototype.ngOnInit = function () {
                };
                NhomBenhVaTenBenhUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/nhom-benh-va-ten-benh']);
                };
                return NhomBenhVaTenBenhUpdateComponent;
            }());
            NhomBenhVaTenBenhUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomBenhVaTenBenhModule = /** @class */ (function () {
                function NhomBenhVaTenBenhModule() {
                }
                return NhomBenhVaTenBenhModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomBenhVaTenBenhService = /** @class */ (function (_super) {
                __extends(NhomBenhVaTenBenhService, _super);
                function NhomBenhVaTenBenhService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'NhomICDTheoBenhVien';
                    return _this;
                }
                return NhomBenhVaTenBenhService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            NhomBenhVaTenBenhService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-nhom-benh-va-ten-benh-nhom-benh-va-ten-benh-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-nhom-benh-va-ten-benh-nhom-benh-va-ten-benh-module-es5.js.map