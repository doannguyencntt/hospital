...
let DichVuKyThuatChonFilePopupComponent = class DichVuKyThuatChonFilePopupComponent {
    ...
    xuLyFile() {
        ...
        if (this.fileExcel != undefined && this.fileExcel != null) {
            ...
            self.apiService.get("DichVuKyThuat/ImportDichVuKyThuat", params).subscribe((resp) => {
                if (resp) {
    ...
    TaiFileMau() {
        this.apiService.postExportExcel('DichVuKyThuat/DownloadTemplateDichVuKyThuat').subscribe(resultData => {
...
DichVuKyThuatChonFilePopupComponent.ctorParameters = () => [
...
let DichVuKyThuatCreateComponent = class DichVuKyThuatCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
DichVuKyThuatCreateComponent.ctorParameters = () => [
...
let DichVuKyThuatListComponent = class DichVuKyThuatListComponent {
    constructor(authService, notificationService, dialog, router, apiService) {
    ...
    updateDichVuKyThuat(id, isDisabled) {
    ...
    exportExcel() {
        ...
        this.apiService.postExportExcel("DichVuKyThuat/ExportDichVuKyThuat", this.gridChild._gridQueryInfo).subscribe(res => {
    ...
    NhapDichVuKyThuatFileExcel() {
        this.dialog.open(_dich_vu_ky_thuat_chon_file_popup_dich_vu_ky_thuat_chon_file_popup_component__WEBPACK_IMPORTED_MODULE_22__["DichVuKyThuatChonFilePopupComponent"], {
            ...
            if (result) {
                if (result.length > 0) {
                    this.dialog.open(_thong_tin_dich_vu_ky_thuat_popup_thong_tin_dich_vu_ky_thuat_popup_component__WEBPACK_IMPORTED_MODULE_23__["ThongTinDichVuKyThuatPopupComponent"], {
                        disableClose: false,
                        width: '800px',
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmComponent"], {
            ...
            if (res == "Yes") {
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Delete)) {
                    this.apiService.post("DichVuKyThuat/XoaDichVuKyThuat?id=" + id).subscribe(() => {
...
DichVuKyThuatListComponent.ctorParameters = () => [
...
let DichVuKyThuatRoutingModule = class DichVuKyThuatRoutingModule {
};
...
let DichVuKyThuatSharedComponent = class DichVuKyThuatSharedComponent {
    constructor(route, baseService, dialog, notificationService) {
        this.route = route;
    ...
    ngOnInit() {
        ...
        if (this.isCreate) {
            let dichVuKyThuatThongTinGiaBaoHiemYTe = new _dich_vu_ky_thuat_model__WEBPACK_IMPORTED_MODULE_6__["DichVuKyThuatThongTinGiaBaoHiemYTe"]();
        ...
        if (this.dichVuKyThuat.DichVuKyThuatThongTinGias.length > 1) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                ...
                if (result === 'Yes') {
                    ...
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_4__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_8__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
                }
            });
        }
    }
...
DichVuKyThuatSharedComponent.ctorParameters = () => [
...
let DichVuKyThuatUpdateComponent = class DichVuKyThuatUpdateComponent {
...
DichVuKyThuatUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
...
let DichVuKyThuatModule = class DichVuKyThuatModule {
};
...
let DichVuKyThuatService = class DichVuKyThuatService extends _app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DichVuKyThuat';
    }
};
DichVuKyThuatService.ctorParameters = () => [
...
let ThongTinDichVuKyThuatPopupComponent = class ThongTinDichVuKyThuatPopupComponent {
    constructor(dialog, cdRef, data) {
        this.dialog = dialog;
        this.cdRef = cdRef;
        this.data = data;
...
ThongTinDichVuKyThuatPopupComponent.ctorParameters = () => [
