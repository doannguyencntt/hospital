...
let DanhSachDuTruMuaKSNKComponent = class DanhSachDuTruMuaKSNKComponent {
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
            ...
            if (res == "Yes") {
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Delete)) {
                    this.apiService.post("YeuCauMuaKSNK/XoaYeuCauMuaDuTruKSNK?id=" + id).subscribe(() => {
    ...
    XuatExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("YeuCauMuaKSNK/ExportYeuCauMuaVatTu", this.gridChild._gridQueryInfo).subscribe(res => {
...
DanhSachDuTruMuaKSNKComponent.ctorParameters = () => [
...
let GuiPhieuMuaKSNKConfirmComponent = class GuiPhieuMuaKSNKConfirmComponent {
...
GuiPhieuMuaKSNKConfirmComponent.ctorParameters = () => [
...
let LapPhieuMuaKSNKGuiLaiComponent = class LapPhieuMuaKSNKGuiLaiComponent {
        ...
        self.dialog.open(_gui_phieu_mua_ksnk_confirm_gui_phieu_mua_ksnk_confirm_component__WEBPACK_IMPORTED_MODULE_17__["GuiPhieuMuaKSNKConfirmComponent"], {
            ...
            if (res == "Yes") {
                ...
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                    self.savingPage();
                    self.apiService.post("YeuCauMuaKSNK/GuiLaiPhieuMuaKSNKDuTru", self.yeuCauMuaVatTu).subscribe((result) => {
...
LapPhieuMuaKSNKGuiLaiComponent.ctorParameters = () => [
...
let LapPhieuMuaKSNKSharedComponent = class LapPhieuMuaKSNKSharedComponent {
    ...
    chonVatTu(dataItem) {
        if (dataItem != undefined && dataItem != null) {
            ...
            this.apiService.post("YeuCauMuaKSNK/ThongTinKSNK", this.vatTuGrid).subscribe(resultData => {
                if (resultData != undefined && resultData != null) {
    ...
    xoaVatTu(dataItem) {
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
            ...
            if (result === 'Yes') {
                ...
                this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_7__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
                this.validationErrorsVatTu = [];
    ...
    themVatTu() {
        ...
        self.ref.detectChanges();
        self.apiService.post("YeuCauMuaKSNK/ThemKSNKChiTietGridVo", self.vatTuGrid).subscribe(resultData => {
            if (resultData != undefined && resultData != null) {
    ...
    kiemTraValidators() {
        ...
        this.lstVatTuGrid.forEach(element => {
            let vatTu = new _yeu_cau_mua_ksnk_model__WEBPACK_IMPORTED_MODULE_17__["YeuCauMuaVatTuChiTietValidator"]();
    ...
    pushDataVatTu() {
        ...
        this.lstVatTuGrid.forEach(obj => {
            let model = new _yeu_cau_mua_ksnk_model__WEBPACK_IMPORTED_MODULE_17__["YeuCauMuaVatTuChiTiet"]();
    ...
    getById(id) {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].View)) {
            self.apiService.get("YeuCauMuaKSNK/GetPhieuMuaKSNKDuTru?id=" + id).subscribe(resultData => {
                if (resultData != undefined && resultData != null) {
                    //console.log(resultData)
...
LapPhieuMuaKSNKSharedComponent.ctorParameters = () => [
...
let LapPhieuMuaKSNKComponent = class LapPhieuMuaKSNKComponent {
        ...
        self.dialog.open(_gui_phieu_mua_ksnk_confirm_gui_phieu_mua_ksnk_confirm_component__WEBPACK_IMPORTED_MODULE_17__["GuiPhieuMuaKSNKConfirmComponent"], {
            ...
            if (res == "Yes") {
                ...
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Add)) {
                    self.savingPage();
                    self.apiService.post("YeuCauMuaKSNK/GuiPhieuMuaKSNKDuTru", self.yeuCauMuaVatTu).subscribe((result) => {
                        if (result != undefined && result != null) {
...
LapPhieuMuaKSNKComponent.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_7__["NotificationService"] },
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"] },
...
let PhieuMuaKSNKComponent = class PhieuMuaKSNKComponent {
    ...
    xemPhieuVatTuVaDuocPham() {
        ...
        self.apiService.post('YeuCauMuaKSNK/InPhieuMuaDuTruVatTuVaDuocPhamKSNK', self.inPhieu).subscribe(resData => {
            if (resData) {
    ...
    xemPhieuVatTu() {
        ...
        self.inPhieu.DuTruMuaVatTuId = self.data.Id;
        self.inPhieu.Header = false;
        self.apiService.post("YeuCauMuaKSNK/InPhieuMuaDuTruKSNK", self.inPhieu).subscribe(resData => {
    ...
    xemPhieuDuocPham() {
        ...
        self.inPhieu.DuTruMuaDuocPhamId = self.data.Id;
        self.inPhieu.Header = false;
        self.apiService.post("YeuCauMuaKSNK/InPhieuMuaDuTruDuocPhamKSNK", self.inPhieu).subscribe(resData => {
            if (resData != undefined && resData != null) {
                self.inPhieu.Header = false;
                self.dataHTML = resData;
                self.src = "data:text/html;charset=utf-8," + encodeURIComponent(resData);
...
PhieuMuaKSNKComponent.ctorParameters = () => [
...
let ThemKSNKDuTruMuaPopupComponent = class ThemKSNKDuTruMuaPopupComponent {
    ...
    themVatTu() {
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmComponent"], {
            ...
            if (result == "Yes") {
                ...
                self.apiService.post("YeuCauMuaKSNK/ThemKSNKChiTietGridVo", self.vatTu).subscribe(resultData => {
                    self.closePopupLoadingData();
                    if (resultData != undefined && resultData != null) {
...
ThemKSNKDuTruMuaPopupComponent.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
...
let YeuCauMuaKSNKRoutingModule = class YeuCauMuaKSNKRoutingModule {
};
...
class PhieuYeuCauMuaVatTu {
    constructor(DuTruMuaVatTuId = null, DuTruMuaDuocPhamId = null, HostingName = null, Header = null, TrangThai = null) {
...
class ThongTinVatTuChiTiet {
    constructor(STT = 0, Id = 0, NhomVatTuId = null, VatTuId = null, LaVatTuBHYT = null, Ma = null, DVT = null, QuyCach = null, NhaSX = null, NuocSX = null, SoLuongDuTru = null, SoLuongDuKienSuDung = null, SoLuongTonDuTru = null, SoLuongTonKhoTong = null, SoLuongChuaNhapVeHDT = null, ThongTinChiTietTonKhoTongs = [], ThongTinChiTietTonHDTs = [], LoaiVatTu = null, TenLoaiVatTu = null, Ten = null, SLTonDuTru = null, SLTonKhoTong = null, SLChuaNhapVeHDT = null, SoLuongDuTruTaiKhoaDuyet = null, SoLuongDuTruKhoaDuocDuyet = null, SoLuongDuTruGiamDocDuyet = null, KhoId = null, IsThemVatTu = false, GhiChu = null, YeuCauMuaVatTuChiTietValidators = []) {
        this.STT = STT;
        this.Id = Id;
...
let YeuCauMuaKSNKSModule = class YeuCauMuaKSNKSModule {
};
