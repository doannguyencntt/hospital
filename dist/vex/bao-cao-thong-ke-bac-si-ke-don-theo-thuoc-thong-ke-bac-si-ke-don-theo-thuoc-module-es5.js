...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-thong-ke-bac-si-ke-don-theo-thuoc-thong-ke-bac-si-ke-don-theo-thuoc-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongKeBacSiKeDonTheoThuocRoutingModule = /** @class */ (function () {
                function ThongKeBacSiKeDonTheoThuocRoutingModule() {
                }
                return ThongKeBacSiKeDonTheoThuocRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var thongKeBSKeDonTheoThuocSearch = /** @class */ (function () {
                function thongKeBSKeDonTheoThuocSearch(SearchString, TuNgay, DenNgay, BacSiId, ThuocId, Skip, Take, PageSize) {
                ...
                return thongKeBSKeDonTheoThuocSearch;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongKeBacSiKeDonTheoThuocModule = /** @class */ (function () {
                function ThongKeBacSiKeDonTheoThuocModule() {
                }
                return ThongKeBacSiKeDonTheoThuocModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongKeBacSiKeDonTheoThuocService = /** @class */ (function (_super) {
                __extends(ThongKeBacSiKeDonTheoThuocService, _super);
                function ThongKeBacSiKeDonTheoThuocService(apiService) {
                    return _super.call(this, apiService) || this;
                }
                return ThongKeBacSiKeDonTheoThuocService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            ThongKeBacSiKeDonTheoThuocService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongKeBacSiKeDonTheoThuocComponent = /** @class */ (function () {
                function ThongKeBacSiKeDonTheoThuocComponent(apiService, dialog, notificationService, authService) {
                ...
                ThongKeBacSiKeDonTheoThuocComponent.prototype.ngOnInit = function () {
                ...
                ThongKeBacSiKeDonTheoThuocComponent.prototype.xemBaoCao = function () {
                    var self = this;
                    ...
                    self.apiService.post("BaoCao/GetDataThongKeBacSiKeDonTheoThuocForGrid", self.baoCaoSearch).subscribe(function (resultData) {
                ...
                ThongKeBacSiKeDonTheoThuocComponent.prototype.xuatBaoCao = function () {
                    var self = this;
                    if (self.baoCaoSearch.TuNgay == null ||
                        self.baoCaoSearch.DenNgay == null) {
                        self.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                ...
                ThongKeBacSiKeDonTheoThuocComponent.prototype.totalGroup = function (dataGroups) {
                    console.log(dataGroups);
                };
                ;
                ThongKeBacSiKeDonTheoThuocComponent.prototype.total = function (field) {
                    switch (field) {
                        case 'SoLuongDon':
                ...
                ;
                ThongKeBacSiKeDonTheoThuocComponent.prototype.XuLyTotalForField = function (field) {
                    var sum = 0;
                ...
                ThongKeBacSiKeDonTheoThuocComponent.prototype.showLoadingPopup = function () {
                ...
                ThongKeBacSiKeDonTheoThuocComponent.prototype.showSavingPopup = function () {
                    if (!this.loadingPopup) {
                        this.loadingPopup = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_7__["LoadingComponent"], {
                            disableClose: true,
                            width: '200px',
                ...
                ThongKeBacSiKeDonTheoThuocComponent.prototype.closeAllDialogs = function () {
                    if (this.loadingPopup) {
                        this.loadingPopup.close();
                        this.loadingPopup = null;
                    }
                };
                return ThongKeBacSiKeDonTheoThuocComponent;
            }());
            ThongKeBacSiKeDonTheoThuocComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
...
//# sourceMappingURL=bao-cao-thong-ke-bac-si-ke-don-theo-thuoc-thong-ke-bac-si-ke-don-theo-thuoc-module-es5.js.map
//# sourceMappingURL=bao-cao-thong-ke-bac-si-ke-don-theo-thuoc-thong-ke-bac-si-ke-don-theo-thuoc-module-es5.js.map