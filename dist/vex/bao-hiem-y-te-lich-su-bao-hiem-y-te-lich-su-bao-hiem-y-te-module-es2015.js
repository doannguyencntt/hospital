...
let ChiTietLichSuBaoHiemYTeComponent = class ChiTietLichSuBaoHiemYTeComponent {
    ...
    getThongBenhNhanTheoYeuCauTiepNhan(id, version) {
        const self = this;
        ...
        self.apiService.post(`BHYT/GetThongTinChiTietBaoHiemYTe`, self.goiDanhSachThongTinBenhNhanCoBHYT).subscribe((resultData) => {
    ...
    AddNewThuoc() {
        let viTriNew = new _lich_su_bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_2__["HoSoChiTietThuoc"]();
        viTriNew.NgayYLenh = new Date();
        this.thongtinbenhnhan.HoSoChiTietThuoc.push(viTriNew);
    }
    AddDichVuKyThuat() {
        let viTriNew = new _lich_su_bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_2__["HoSoChiTietDVKT"]();
        viTriNew.NgayYLenh = new Date();
        viTriNew.NgayKetQua = new Date();
        this.thongtinbenhnhan.HoSoChiTietDVKT.push(viTriNew);
    }
    AddDichVuKyThuatCanLamSang() {
        let viTriNew = new _lich_su_bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_2__["HoSoCanLamSang"]();
        viTriNew.NgayKQ = new Date();
        this.thongtinbenhnhan.HoSoCanLamSang.push(viTriNew);
    }
    AddDienBienBenh() {
        let viTriNew = new _lich_su_bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_2__["HoSoChiTietDienBienBenh"]();
        viTriNew.NgayYLenh = new Date();
    ...
    capNhatThongTinHoSoGiamDinh() {
        ...
        self.confrim = self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
            ...
            if (result == "Yes") {
                ...
                self.thongtinbenhnhan.IsDownLoad = true;
                self.apiService.post(`BHYT/CapNhatDownloadHoSoGiamDinhXMLLichSuBHYT`, self.thongtinbenhnhan).subscribe((version) => {
    ...
    goiHoSoGiamDinhNguoiBenh() {
        ...
        self.confrim = self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
            ...
            if (result == "Yes") {
                ...
                self.thongtinbenhnhan.IsDownLoad = true;
                self.apiService.post(`BHYT/GuiChiTietTungHoSoGiamDinhNguoiBenhLichSuBHYT`, self.thongtinbenhnhan).subscribe((resultData) => {
    ...
    showPopupLoadingData(typeLoading = _danh_sach_bao_hiem_y_te_bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_11__["EnumTypeLoadingData"].View) {
        let mess = "";
        switch (typeLoading) {
...
ChiTietLichSuBaoHiemYTeComponent.ctorParameters = () => [
...
let DsLichSuBaoHiemYTeComponent = class DsLichSuBaoHiemYTeComponent {
    constructor(router, authService, notificationService, dialog, location, route, apiService) {
        this.router = router;
    ...
    clearSearch() {
        if (this.timKiemDSBaoHiemYTe.SearchString == "" || this.timKiemDSBaoHiemYTe.SearchString == null) {
            ...
            let xuatKhoClone = JSON.parse(JSON.stringify(this.timKiemDSBaoHiemYTe));
    ...
    DownloadFileExcels() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel("BHYT/ExportLichSuBaoHiemYTe", this.gridChild._gridQueryInfo).subscribe((resultData) => {
...
DsLichSuBaoHiemYTeComponent.ctorParameters = () => [
...
let LichSuBaoHiemYTeRoutingModule = class LichSuBaoHiemYTeRoutingModule {
};
...
let LichSuBaoHiemYTeModule = class LichSuBaoHiemYTeModule {
};
...
class DsLSBaoHiemYTe {
    constructor(MaTN = null, MaBN = null, HoTen = null, GioiTinh = null, DiaChi = null, MucHuong = null, SoTienBHYTDuyet = null) {
        this.MaTN = MaTN;
        this.MaBN = MaBN;
        this.HoTen = HoTen;
...
class HoSoChiTietDienBienBenh {
    constructor(STT = null, DienBien = null, HoiChuan = null, PhauThuat = null, NgayYLenh = null) {
        this.STT = STT;
...
class GoiDanhSachThongTinBenhNhanCoBHYT {
    constructor(YeuCauTiepNhanIds, Version = 0) {
