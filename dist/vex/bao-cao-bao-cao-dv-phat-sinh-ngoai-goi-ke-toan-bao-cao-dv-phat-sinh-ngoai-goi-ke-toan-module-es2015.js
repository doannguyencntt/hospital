...
let BaoCaoDvPhatSinhNgoaiGoiKeToanListComponent = class BaoCaoDvPhatSinhNgoaiGoiKeToanListComponent {
    //================================End value total===========================
    ...
    XemBaoCao() {
        ...
        this.baoCaoDichVuPhatSinhNgoaiGoiPhiQueryInfoQueryInfo.DenNgay = this.search.RangeDateTimeFilter.DateEnd;
        this.baoCaoDichVuPhatSinhNgoaiGoiPhiQueryInfoQueryInfo.HopDongId = this.search.HopDongId;
        this.apiService.post("BaoCao/GetBaoCaoChiTietThuTienDichVuNgoaiGoiForGridAsync", this.baoCaoDichVuPhatSinhNgoaiGoiPhiQueryInfoQueryInfo).subscribe(resultData => {
        ...
        this.apiService.post("BaoCao/GetTotalBaoCaoChiTietThuTienDichVuNgoaiGoiForGridAsync", this.baoCaoDichVuPhatSinhNgoaiGoiPhiQueryInfoQueryInfo).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                this.baoCaoThuTienVienPhi = resultData.Data;
    ...
    merceCell(type, element, soBienLaiRemoveSpecialOld, idOld) {
...
BaoCaoDvPhatSinhNgoaiGoiKeToanListComponent.ctorParameters = () => [
...
let BaoCaoDvPhatSinhNgoaiGoiKeToanRoutingModule = class BaoCaoDvPhatSinhNgoaiGoiKeToanRoutingModule {
};
...
class SearchThuNgan {
    constructor(TuNgay = null, DenNgay = null, HopDongId = 0, CongTyId = 0) {
        this.TuNgay = TuNgay;
...
class Search {
    constructor(RangeDateTimeFilter = new DateTimeFilter, HopDongId = 0, CongTyId = 0) {
...
class BaoCaoDichVuPhatSinhNgoaiGoi {
...
class BaoCaoDichVuPhatSinhNgoaiGoiPhiQueryInfoQueryInfo {
    constructor(TuNgay = null, DenNgay = null, HopDongId = 0, CongTyId = 0, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", 
...
let BaoCaoDvPhatSinhNgoaiGoiKeToanModule = class BaoCaoDvPhatSinhNgoaiGoiKeToanModule {
};
...
let BaoCaoDvPhatSinhNgoaiGoiKeToanService = class BaoCaoDvPhatSinhNgoaiGoiKeToanService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoDvPhatSinhNgoaiGoiKeToanService.ctorParameters = () => [
