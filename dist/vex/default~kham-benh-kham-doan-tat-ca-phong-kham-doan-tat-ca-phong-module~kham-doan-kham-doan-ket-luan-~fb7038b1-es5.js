(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~kham-benh-kham-doan-tat-ca-phong-kham-doan-tat-ca-phong-module~kham-doan-kham-doan-ket-luan-~fb7038b1"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KetLuanKhamSucKhoeDoanChiTietComponent = /** @class */ (function () {
                function KetLuanKhamSucKhoeDoanChiTietComponent(dialog, route, notificationService, authService, apiService, ref, location, router) {
                    this.dialog = dialog;
                    this.route = route;
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.route.queryParams.subscribe(function (param) {
                        ...
                        _this.id = param['Id'];
                        _this.yeuCauTiepNhanId = param['YeuCauTiepNhanId'];
                        _this.from = param['f'];
                        _this.getByYeuCauTiepNhanId(_this.yeuCauTiepNhanId, _this.id);
                    });
                };
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.loadingPage = function () {
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.savingPage = function () {
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.closePopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.ketQuaMau = function () {
                    var _this = this;
                    var self = this;
                    ...
                    self.loadingPage();
                    self.apiService.post("KhamDoan/GetKetQuaMaus", self.khamDoanChuaKetLuan).subscribe(function (resultData) {
                        ...
                        if (resultData != undefined && resultData != null) {
                            ...
                            self.dialog
                                ...
                                width: "400px",
                                data: resultData,
                            }).afterClosed().subscribe(function (datas) {
                                if (datas != undefined && datas != null && datas.length > 0) {
                                    console.log(datas);
                                    datas.forEach(function (element) {
                                        if (element.IsCheck) {
                                            if (_this.khamDoanChuaKetLuan.KSKKetLuanCacBenhTat == null) {
                                                _this.khamDoanChuaKetLuan.KSKKetLuanCacBenhTat = "";
                                            }
                                            _this.khamDoanChuaKetLuan.KSKKetLuanCacBenhTat += element.Value + "; ";
                                        }
                                    });
                                }
                            });
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.getByYeuCauTiepNhanId = function (yeuCauTiepNhanId, hopDongKhamSucKhoeNhanVienId) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].View)) {
                        ...
                        this.apiService.post("KhamDoan/GetGoiKhamSucKhoeDoanYeuCauTNYeuCauTN", obj).subscribe(function (resultData) {
                            _this.closePopupLoadingData();
                            if (resultData != undefined && resultData != null) {
                                _this.khamDoanChuaKetLuan = resultData;
                                _this.khamLamSanBindData(_this.khamDoanChuaKetLuan.KetLuanKhamSucKhoeDoanDichVuKhamTemplates);
                                console.log("resultData: ", resultData);
                                if (_this.thongTinKhamTheoDichVuDatas != []) {
                                    _this.convertPhanLoai();
                                }
                            }
                        }, function (err) {
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.convertPhanLoai = function () {
                    for (var i = 1; i < this.thongTinKhamTheoDichVuDatas.length; i += 2) {
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.khamLamSanBindData = function (dataItem) {
                    var _this = this;
                    dataItem.forEach(function (element) {
                        _this.thongTinKhamTheoDichVuTemplate = JSON.parse(element.ThongTinKhamTheoDichVuTemplate);
                        _this.thongTinKhamTheoDichVuData = element.ThongTinKhamTheoDichVuData;
                        if (_this.thongTinKhamTheoDichVuData == null) {
                            _this.thongTinKhamTheoDichVuTemplate = undefined;
                        }
                        _this.bindDataDynamicComponent(element.Type);
                    });
                    // console.log("tmplate: ", this.thongTinKhamTheoDichVuDatas)
                };
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.bindDataDynamicComponent = function (type) {
                    var _this = this;
                    var strData = this.thongTinKhamTheoDichVuData;
                    if (strData != undefined && strData != null) {
                        var dataObj_1 = JSON.parse(strData);
                        var itemTemp_1 = null;
                        if (this.thongTinKhamTheoDichVuTemplate !== null) {
                            this.thongTinKhamTheoDichVuTemplate.ComponentDynamics.forEach(function (item) {
                                if (item.groupItems != undefined && item.groupItems != null && item.groupItems.length > 0) {
                                    if (item.Type == 4) {
                                        ...
                                        _this.thongTinKhamTheoDichVuDatas.push(dataGroups);
                                    }
                                    item.groupItems.forEach(function (element) {
                                        ...
                                        _this.thongTinKhamTheoDichVuDatas.push(data);
                                    });
                                }
                                else {
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.luuVaHoanThanhKhamKSKDoan = function () {
                    var self = this;
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.hoanThanhKham = function () {
                    var _this = this;
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
                        ...
                        self.khamDoanChuaKetLuan.Id = this.yeuCauTiepNhanId;
                        self.khamDoanChuaKetLuan.HopDongKhamSucKhoeId = this.id;
                        self.apiService.post("KhamDoan/LuuHoacLuuVaHoanThanhKhamKetLuanKSKDoan", self.khamDoanChuaKetLuan).subscribe(function () {
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.luuKSKDoan = function () {
                    var _this = this;
                    var self = this;
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
                        disableClose: false,
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
                                ...
                                self.khamDoanChuaKetLuan.Id = _this.yeuCauTiepNhanId;
                                self.khamDoanChuaKetLuan.HopDongKhamSucKhoeId = _this.id;
                                self.apiService.post("KhamDoan/LuuHoacLuuVaHoanThanhKhamKetLuanKSKDoan", self.khamDoanChuaKetLuan).subscribe(function (resData) {
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.huy = function () {
                    // this.ngOnInit();
                    this.location.back();
                };
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.keyEvent = function (event) {
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.inSoKSK = function () {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].View)) {
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.inKetQuaKSK = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].View)) {
                        ...
                        //   data: this.id
                        // });
                        this.apiService.post("KhamDoan/GetDataKetQuaKSKDoanEdit?hopDongKhamSucKhoeId=" + this.id).subscribe(function (resData) {
                            if (resData != undefined && resData != null) {
                                var dialogRef = _this.dialog.open(_popup_ket_qua_ksk_edit_popup_ket_qua_ksk_edit_component__WEBPACK_IMPORTED_MODULE_19__["PopupKetQuaKskEditComponent"], {
                                    disableClose: false,
                                    width: '1500px',
                                    data: { Model: resData, hopDongKhamSucKhoeId: _this.id, ShowIn: true }
                                });
                ...
                KetLuanKhamSucKhoeDoanChiTietComponent.prototype.redirectKetLuanCLS = function () {
                    var _this = this;
                    var self = this;
                ...
                return KetLuanKhamSucKhoeDoanChiTietComponent;
            }());
            KetLuanKhamSucKhoeDoanChiTietComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KetLuanKhamSucKhoeDoanChuaKetLuanListComponent = /** @class */ (function () {
                function KetLuanKhamSucKhoeDoanChuaKetLuanListComponent(authService, router, notificationService, apiService, route) {
                    this.authService = authService;
                    this.router = router;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.ngOnInit = function () {
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.backWithSearch = function () {
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.clearSearch = function () {
                    this.khamDoanChuaKetLuanSearch.SearchString = null;
                    this.gridChild.search();
                };
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.searchChanges = function (event) {
                    var self = this;
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.trangThaiCheckBox = function (event, tinhTrang) {
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.timKiem = function () {
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.congTyKhamSucKhoeChange = function (event) {
                    this.khamDoanChuaKetLuanSearch.LaHopDongDaKetLuan = false;
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.soHopDongChange = function (event) {
                    this.khamDoanChuaKetLuanSearch.LaHopDongDaKetLuan = false;
                    if (event != undefined && event != null) {
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.chinhSua = function (id, yeuCauTiepNhanId) {
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.changeLookupHopDong = function (event) {
                ...
                KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.prototype.redirectKetLuanCLS = function () {
                    this.router.navigate(['/kham-doan/kham-doan-ket-luan-cls-ksk'], { queryParams: { "holdQuery": true } });
                };
                return KetLuanKhamSucKhoeDoanChuaKetLuanListComponent;
            }());
            KetLuanKhamSucKhoeDoanChuaKetLuanListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/shared/configdata/system-message */ "./src/app/shared/configdata/system-message.ts");
            /* harmony import */ var src_app_shared_enum_kham_doan_enum__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! src/app/shared/enum/kham-doan.enum */ "./src/app/shared/enum/kham-doan.enum.ts");
            var KetLuanKhamSucKhoeDoanDaKetLuanListComponent = /** @class */ (function () {
                function KetLuanKhamSucKhoeDoanDaKetLuanListComponent(authService, router, notificationService, route) {
                    this.authService = authService;
                    this.router = router;
                    this.notificationService = notificationService;
                    this.route = route;
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_2__["DocumentType"].KhamDoanKetLuanKhamSucKhoeDoan;
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.backWithSearch = function () {
                    var hasLocalSearchString = false;
                    if (this.route.snapshot.queryParams.holdQuery != undefined) {
                        var holdQuery = this.route.snapshot.queryParams.holdQuery;
                        if (holdQuery != null && holdQuery) {
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.clearSearch = function () {
                    this.khamDoanDaKetLuanSearch.SearchString = null;
                    this.gridChildDaKetLuan.search();
                };
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.searchChanges = function (event) {
                    var self = this;
                    if (event != undefined && (event == null || event == "")) {
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.trangThaiCheckBox = function (event, tinhTrang) {
                    if (tinhTrang == "chuaketluan") {
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.timKiem = function () {
                    // this.location.replaceState(this.baseRoute + '?holdQuery=true');
                    this.router.navigateByUrl('/kham-doan/ket-luan-kham-suc-khoe-doan?holdQuery=true');
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.congTyKhamSucKhoeChange = function (event) {
                    // this.location.replaceState(this.baseRoute + '?holdQuery=true');
                    this.changeDataCongTy = true;
                    if (event != undefined && event != null) {
                        this.router.navigateByUrl('/kham-doan/ket-luan-kham-suc-khoe-doan?holdQuery=true');
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.soHopDongChange = function (event) {
                    if (event != undefined && event != null) {
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.chinhSua = function (id, yeuCauTiepNhanId) {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
                        var url = '/chi-tiet';
                        this.router.navigate([this.baseRoute + url], { queryParams: { Id: id, YeuCauTiepNhanId: yeuCauTiepNhanId } });
                    }
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.openCombobox = function (event) {
                    if (event) {
                        this.isSelectDuocPham = true;
                    }
                    else {
                ...
                KetLuanKhamSucKhoeDoanDaKetLuanListComponent.prototype.changeLookupHopDong = function (event) {
                    if (!this.lanDauLoadData && this.changeDataCongTy) {
                ...
                return KetLuanKhamSucKhoeDoanDaKetLuanListComponent;
            }());
            KetLuanKhamSucKhoeDoanDaKetLuanListComponent.ctorParameters = function () { return [
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KetLuanKhamSucKhoeDoanListComponent = /** @class */ (function () {
                function KetLuanKhamSucKhoeDoanListComponent(route) {
                    this.route = route;
                    this.baseRoute = "/kham-doan/ket-luan-kham-suc-khoe-doan";
                    this.indexTap = 0;
                    this.holdQuery = null;
                ...
                KetLuanKhamSucKhoeDoanListComponent.prototype.ngOnInit = function () {
                ...
                KetLuanKhamSucKhoeDoanListComponent.prototype.chuyenDen = function (event) {
                    if (event.index == 0) {
                        this.listStatusSelectTabKhamDoanKetLuan.selectedTabChuaKetLuan = true;
                        this.listStatusSelectTabKhamDoanKetLuan.selectedTabDaKetLuan = false;
                    }
                ...
                return KetLuanKhamSucKhoeDoanListComponent;
            }());
            KetLuanKhamSucKhoeDoanListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../kham-doan-ket-luan.model */ "./src/app/modules/main/kham-doan/kham-doan-ket-luan/kham-doan-ket-luan.model.ts");
            var KetLuanKskDoanDvChuaKhamListPopupComponent = /** @class */ (function () {
                function KetLuanKskDoanDvChuaKhamListPopupComponent(data, dialogRef) {
                    this.data = data;
                ...
                KetLuanKskDoanDvChuaKhamListPopupComponent.prototype.ngOnInit = function () {
                ...
                KetLuanKskDoanDvChuaKhamListPopupComponent.prototype.close = function (result) {
                    this.dialogRef.close(result);
                };
                return KetLuanKskDoanDvChuaKhamListPopupComponent;
            }());
            KetLuanKskDoanDvChuaKhamListPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanKetLuanRoutingModule = /** @class */ (function () {
                function KhamDoanKetLuanRoutingModule() {
                }
                return KhamDoanKetLuanRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ListStatusSelectTabKhamDoanKetLuan = /** @class */ (function () {
                function ListStatusSelectTabKhamDoanKetLuan(selectedTabChuaKetLuan, selectedTabDaKetLuan) {
                    if (selectedTabChuaKetLuan === void 0) { selectedTabChuaKetLuan = true; }
                    if (selectedTabDaKetLuan === void 0) { selectedTabDaKetLuan = false; }
                    this.selectedTabChuaKetLuan = selectedTabChuaKetLuan;
                    this.selectedTabDaKetLuan = selectedTabDaKetLuan;
                }
                return ListStatusSelectTabKhamDoanKetLuan;
            }());
            var KhamDoanChuaKetLuanSearch = /** @class */ (function () {
                function KhamDoanChuaKetLuanSearch(CongTyKhamSucKhoeId, TenCongTy, HopDongKhamSucKhoeId, TenSoHopDong, ChuaKetLuan, DaKetLuan, KetLuan, LaHopDongDaKetLuan, SearchString) {
                    ...
                    if (TenSoHopDong === void 0) { TenSoHopDong = null; }
                    if (ChuaKetLuan === void 0) { ChuaKetLuan = true; }
                    if (DaKetLuan === void 0) { DaKetLuan = true; }
                    if (KetLuan === void 0) { KetLuan = null; }
                    if (LaHopDongDaKetLuan === void 0) { LaHopDongDaKetLuan = null; }
                ...
                return KhamDoanChuaKetLuanSearch;
            }());
            var KhamDoanDaKetLuanSearch = /** @class */ (function () {
                function KhamDoanDaKetLuanSearch(CongTyKhamSucKhoeId, TenCongTy, HopDongKhamSucKhoeId, TenSoHopDong, ChuaKetLuan, DaKetLuan, LaHopDongDaKetLuan, SearchString) {
                    if (CongTyKhamSucKhoeId === void 0) { CongTyKhamSucKhoeId = null; }
                    if (TenCongTy === void 0) { TenCongTy = null; }
                    if (HopDongKhamSucKhoeId === void 0) { HopDongKhamSucKhoeId = null; }
                    if (TenSoHopDong === void 0) { TenSoHopDong = null; }
                ...
                return KhamDoanDaKetLuanSearch;
            }());
            var KhamDoanChuaKetLuan = /** @class */ (function () {
                function KhamDoanChuaKetLuan(Id, HopDongKhamSucKhoeId, PhanLoaiSucKhoeId, KSKKetQuaCanLamSang, KSKDanhGiaCanLamSang, KSKKetLuanPhanLoaiSucKhoe, KSKKetLuanGhiChu, KSKKetLuanCacBenhTat, IsEnableKetLuan, IsHiddenKetLuan, CoHienThiPhanLoai, IsOnlySave, CoDichVuChuaKham, LaGetKetQuaMau, DichVuKhamChuaKhams, DichVuKyThuatChuaThucHiens, LastModified, TrangThaiYeuCauTiepNhan, KetLuanKhamSucKhoeDoanDichVuKhamTemplates, CongTyKhamSucKhoeId) {
                    if (Id === void 0) { Id = null; }
                    if (HopDongKhamSucKhoeId === void 0) { HopDongKhamSucKhoeId = null; }
                    if (PhanLoaiSucKhoeId === void 0) { PhanLoaiSucKhoeId = null; }
                    if (KSKKetQuaCanLamSang === void 0) { KSKKetQuaCanLamSang = null; }
                    if (KSKDanhGiaCanLamSang === void 0) { KSKDanhGiaCanLamSang = null; }
                    if (KSKKetLuanPhanLoaiSucKhoe === void 0) { KSKKetLuanPhanLoaiSucKhoe = null; }
                    if (KSKKetLuanGhiChu === void 0) { KSKKetLuanGhiChu = null; }
                    if (KSKKetLuanCacBenhTat === void 0) { KSKKetLuanCacBenhTat = null; }
                    if (IsEnableKetLuan === void 0) { IsEnableKetLuan = null; }
                    if (IsHiddenKetLuan === void 0) { IsHiddenKetLuan = null; }
                    if (CoHienThiPhanLoai === void 0) { CoHienThiPhanLoai = null; }
                    if (IsOnlySave === void 0) { IsOnlySave = null; }
                    if (CoDichVuChuaKham === void 0) { CoDichVuChuaKham = null; }
                    if (LaGetKetQuaMau === void 0) { LaGetKetQuaMau = null; }
                    if (DichVuKhamChuaKhams === void 0) { DichVuKhamChuaKhams = null; }
                    if (DichVuKyThuatChuaThucHiens === void 0) { DichVuKyThuatChuaThucHiens = null; }
                    if (LastModified === void 0) { LastModified = null; }
                    if (TrangThaiYeuCauTiepNhan === void 0) { TrangThaiYeuCauTiepNhan = null; }
                    if (KetLuanKhamSucKhoeDoanDichVuKhamTemplates === void 0) { KetLuanKhamSucKhoeDoanDichVuKhamTemplates = []; }
                    if (CongTyKhamSucKhoeId === void 0) { CongTyKhamSucKhoeId = null; }
                    this.Id = Id;
                    this.HopDongKhamSucKhoeId = HopDongKhamSucKhoeId;
                ...
                return KhamDoanChuaKetLuan;
            }());
            var KetLuanKhamSucKhoeDoanDichVuKhamTemplate = /** @class */ (function () {
                function KetLuanKhamSucKhoeDoanDichVuKhamTemplate(Type, TypeTemplate, Title, ThongTinKhamTheoDichVuTemplate, ThongTinKhamTheoDichVuData, KetLuanKhamSucKhoeDoanDichVuKhamTemplateValues) {
                    if (Type === void 0) { Type = null; }
                    if (TypeTemplate === void 0) { TypeTemplate = null; }
                    if (Title === void 0) { Title = null; }
                    if (ThongTinKhamTheoDichVuTemplate === void 0) { ThongTinKhamTheoDichVuTemplate = null; }
                    if (ThongTinKhamTheoDichVuData === void 0) { ThongTinKhamTheoDichVuData = null; }
                    if (KetLuanKhamSucKhoeDoanDichVuKhamTemplateValues === void 0) { KetLuanKhamSucKhoeDoanDichVuKhamTemplateValues = []; }
                    this.Type = Type;
                ...
                return KetLuanKhamSucKhoeDoanDichVuKhamTemplate;
            }());
            var KetLuanKhamSucKhoeDoanDichVuKhamTemplateValue = /** @class */ (function () {
                function KetLuanKhamSucKhoeDoanDichVuKhamTemplateValue(Label, Value) {
                    if (Label === void 0) { Label = null; }
                    if (Value === void 0) { Value = null; }
                    this.Label = Label;
                    this.Value = Value;
                }
                return KetLuanKhamSucKhoeDoanDichVuKhamTemplateValue;
            }());
            var InSoKhamSucKhoeVaKetQua = /** @class */ (function () {
                function InSoKhamSucKhoeVaKetQua(Id, HostingName, Loai) {
                    if (Id === void 0) { Id = null; }
                ...
                return InSoKhamSucKhoeVaKetQua;
            }());
            var KhamDoanKetQuaMau = /** @class */ (function () {
                function KhamDoanKetQuaMau(IsCheck, Value) {
                    if (IsCheck === void 0) { IsCheck = true; }
                    if (Value === void 0) { Value = null; }
                    this.IsCheck = IsCheck;
                    this.Value = Value;
                }
                return KhamDoanKetQuaMau;
            }());
            var KetQuaKhamChuyenKhoaNoi = /** @class */ (function () {
                function KetQuaKhamChuyenKhoaNoi(TuanHoan, HoHap, TieuHoa, ThanKinh, CoXuongKhop, ThanTietNieu, NoiTiet, TamThan) {
                    if (TuanHoan === void 0) { TuanHoan = null; }
                    if (HoHap === void 0) { HoHap = null; }
                    if (TieuHoa === void 0) { TieuHoa = null; }
                    if (ThanKinh === void 0) { ThanKinh = null; }
                    if (CoXuongKhop === void 0) { CoXuongKhop = null; }
                    if (ThanTietNieu === void 0) { ThanTietNieu = null; }
                    if (NoiTiet === void 0) { NoiTiet = null; }
                    if (TamThan === void 0) { TamThan = null; }
                ...
                return KetQuaKhamChuyenKhoaNoi;
            }());
            var KetQuaNgoaiDaLieuSanPhuKhoa = /** @class */ (function () {
                function KetQuaNgoaiDaLieuSanPhuKhoa(value) {
                    if (value === void 0) { value = null; }
                    this.value = value;
                }
                return KetQuaNgoaiDaLieuSanPhuKhoa;
            }());
            var KetQuaKhamChuyenKhoaMat = /** @class */ (function () {
                function KetQuaKhamChuyenKhoaMat(KhongKinhMatPhai, KhongKinhMatTrai, CoKinhMatPhai, CoKinhMatTrai, CacBenhVeMat) {
                    if (KhongKinhMatPhai === void 0) { KhongKinhMatPhai = null; }
                    if (KhongKinhMatTrai === void 0) { KhongKinhMatTrai = null; }
                    if (CoKinhMatPhai === void 0) { CoKinhMatPhai = null; }
                    if (CoKinhMatTrai === void 0) { CoKinhMatTrai = null; }
                    if (CacBenhVeMat === void 0) { CacBenhVeMat = null; }
                ...
                return KetQuaKhamChuyenKhoaMat;
            }());
            var KetQuaKhamChuyenKhoaTaiMuiHong = /** @class */ (function () {
                function KetQuaKhamChuyenKhoaTaiMuiHong(TaiPhaiNoiThuong, TaiPhaiNoiTham, TaiTraiNoiThuong, TaiTraiNoiTham, CacBenhTaiMuiHong) {
                    if (TaiPhaiNoiThuong === void 0) { TaiPhaiNoiThuong = null; }
                    if (TaiPhaiNoiTham === void 0) { TaiPhaiNoiTham = null; }
                    if (TaiTraiNoiThuong === void 0) { TaiTraiNoiThuong = null; }
                    if (TaiTraiNoiTham === void 0) { TaiTraiNoiTham = null; }
                    if (CacBenhTaiMuiHong === void 0) { CacBenhTaiMuiHong = null; }
                ...
                return KetQuaKhamChuyenKhoaTaiMuiHong;
            }());
            var KetQuaKhamChuyenKhoaNoiRangHamMat = /** @class */ (function () {
                function KetQuaKhamChuyenKhoaNoiRangHamMat(HamTren, HamDuoi, CacBenhRangHamMat) {
                    if (HamTren === void 0) { HamTren = null; }
                    if (HamDuoi === void 0) { HamDuoi = null; }
                    if (CacBenhRangHamMat === void 0) { CacBenhRangHamMat = null; }
                    this.HamTren = HamTren;
                    this.HamDuoi = HamDuoi;
                    this.CacBenhRangHamMat = CacBenhRangHamMat;
                }
                return KetQuaKhamChuyenKhoaNoiRangHamMat;
            }());
            ...
            var ItemEditKetQua = /** @class */ (function () {
                function ItemEditKetQua(Id, Type, value, JsonValueEdit) {
                    if (Id === void 0) { Id = null; }
                    if (Type === void 0) { Type = null; }
                    if (value === void 0) { value = null; }
                    if (JsonValueEdit === void 0) { JsonValueEdit = null; }
                    this.Id = Id;
                    this.Type = Type;
                    this.value = value;
                    this.JsonValueEdit = JsonValueEdit;
                }
                return ItemEditKetQua;
            }());
            var KetQuaKhamSucKhoe = /** @class */ (function () {
                function KetQuaKhamSucKhoe(YeuCauTiepNhanId, HopDongKhamSucKhoeId, JsonKetQuaKSK, JsonKetLuan) {
                    if (YeuCauTiepNhanId === void 0) { YeuCauTiepNhanId = null; }
                    if (HopDongKhamSucKhoeId === void 0) { HopDongKhamSucKhoeId = null; }
                    if (JsonKetQuaKSK === void 0) { JsonKetQuaKSK = null; }
                    if (JsonKetLuan === void 0) { JsonKetLuan = null; }
                    this.YeuCauTiepNhanId = YeuCauTiepNhanId;
                    this.HopDongKhamSucKhoeId = HopDongKhamSucKhoeId;
                    this.JsonKetQuaKSK = JsonKetQuaKSK;
                    this.JsonKetLuan = JsonKetLuan;
                }
                return KetQuaKhamSucKhoe;
            }());
            var KetQuaKhamSucKhoeModel = /** @class */ (function () {
                function KetQuaKhamSucKhoeModel(DanhSachGridKhamSucKhoe) {
                    if (DanhSachGridKhamSucKhoe === void 0) { DanhSachGridKhamSucKhoe = []; }
                    this.DanhSachGridKhamSucKhoe = DanhSachGridKhamSucKhoe;
                }
                return KetQuaKhamSucKhoeModel;
            }());
            var KetQuaSinhHieu = /** @class */ (function () {
                function KetQuaSinhHieu(Id, NhipTim, NhipTho, ThanNhiet, HuyetAp, HuyetApTamThu, HuyetApTamTruong, ChieuCao, CanNang, BMI, Glassgow, NoiThucHienId, NhanVienThucHienId, YeuCauTiepNhanId, NgayThucHien, IsUpdate, IsDelete) {
                    if (Id === void 0) { Id = 0; }
                    if (NhipTim === void 0) { NhipTim = null; }
                    if (NhipTho === void 0) { NhipTho = null; }
                    if (ThanNhiet === void 0) { ThanNhiet = null; }
                    if (HuyetAp === void 0) { HuyetAp = null; }
                    if (HuyetApTamThu === void 0) { HuyetApTamThu = null; }
                    if (HuyetApTamTruong === void 0) { HuyetApTamTruong = null; }
                    if (ChieuCao === void 0) { ChieuCao = null; }
                    if (CanNang === void 0) { CanNang = null; }
                    if (BMI === void 0) { BMI = null; }
                    if (Glassgow === void 0) { Glassgow = null; }
                    ...
                    if (NgayThucHien === void 0) { NgayThucHien = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanKetLuanModule = /** @class */ (function () {
                function KhamDoanKetLuanModule() {
                }
                return KhamDoanKetLuanModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupKetQuaKskEditComponent = /** @class */ (function () {
                function PopupKetQuaKskEditComponent(data, dialogRef, route, router, apiService, dialog, notificationService, authService, ref, location) {
                    this.data = data;
                    this.dialogRef = dialogRef;
                    this.route = route;
                    this.router = router;
                ...
                PopupKetQuaKskEditComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_3__["DocumentType"].KhamDoanKetLuanKhamSucKhoeDoan;
                ...
                PopupKetQuaKskEditComponent.prototype.ngAfterContentInit = function () {
                    this.gridPhanLoaiCacBenhTatVaDeNghi(this.data.hopDongKhamSucKhoeId);
                    this.fullscreen();
                };
                PopupKetQuaKskEditComponent.prototype.close = function (result) {
                    this.dialogRef.close(result);
                };
                PopupKetQuaKskEditComponent.prototype.getGridSinhHieu = function () {
                    var _this = this;
                    this.apiService.get("KhamDoan/GetDataListForChiSoSinhTon?id=" + this.yeuCauTiepNhanId).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null && resultData != "") {
                            _this.dataSourceSinhHieu = {
                                data: resultData.Data.slice(),
                                total: resultData.Data.length
                            };
                            _this.dataSourceSinhHieuDisplay = {
                                data: resultData.Data.slice(),
                                total: resultData.Data.length
                            };
                        }
                ...
                //   }
                // }
                PopupKetQuaKskEditComponent.prototype.Luu = function (isSave) {
                    var _this = this;
                    var ketQuaKhamSucKhoe = new _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_13__["KetQuaKhamSucKhoe"]();
                    ...
                    this.apiService.post("KhamDoan/SaveBanInKhamDoanTiepNhan", ketQuaKhamSucKhoe).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null && resultData != "") {
                            _this.closeLoading(loading);
                            var sendingParam = {
                                data: _this.dataSourceSinhHieu.data.slice(),
                                Id: _this.yeuCauTiepNhanId
                            };
                            if (_this.authService.hasPermission(_this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Update)) {
                                _this.apiService.post('KhamDoan/UpdateChiSoSinhTonAsync', sendingParam)
                                    ...
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_11__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                                    if (isSave == 2) {
                                        ...
                                        // });
                                        loading = _this.showLoading("Đang in...");
                                        var obj = {
                                            "Id": _this.data.hopDongKhamSucKhoeId,
                                            "HostingName": window.location.protocol + "//" + window.location.host
                                        };
                                        _this.apiService.postExportPdf("KhamDoan/XuLyInKetQuaKhamSucKhoeKetLuanAsync", obj).subscribe(function (res) {
                                    ...
                                    if (isSave != 3) // hoặc kiểm tra yctn ! = undefine
                                     {
                                        _this.apiService.get("KhamDoan/GetDataListForChiSoSinhTon?id=" + _this.yeuCauTiepNhanId).subscribe(function (resultData) {
                ...
                PopupKetQuaKskEditComponent.prototype.themChiSoSinhTon = function () {
                    if (this.dataSourceSinhHieuDisplay.data.findIndex(function (x) { return x.Id === 0; }) === -1) {
                        var newItem = new _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_13__["KetQuaSinhHieu"]();
                ...
                PopupKetQuaKskEditComponent.prototype.onChangeNhipTim = function (data, input) {
                    if (input % 1 !== 0) {
                ...
                PopupKetQuaKskEditComponent.prototype.onChangeNhipTho = function (input, dataItem) {
                    if (input % 1 !== 0) {
                ...
                PopupKetQuaKskEditComponent.prototype.onChangeHuyetApTamThu = function (input, dataItem) {
                    if (input % 1 !== 0) {
                ...
                PopupKetQuaKskEditComponent.prototype.onChangeHuyetApTamTruong = function (input, dataItem) {
                    if (input % 1 !== 0) {
                ...
                PopupKetQuaKskEditComponent.prototype.onChangeCanNang = function (data) {
                ...
                PopupKetQuaKskEditComponent.prototype.onChangeChieuCao = function (data) {
                    var chieuCao = data.ChieuCao / 100;
                    if (chieuCao === 0) {
                        data.BMI = null;
                        return;
                ...
                PopupKetQuaKskEditComponent.prototype.suaChiSoSinhHieu = function (dataItem) {
                    if (dataItem) {
                        dataItem.IsUpdate = true;
                        this.dataSourceSinhHieu.data.filter(function (x) { return x === dataItem; })[0].IsUpdate = true;
                ...
                PopupKetQuaKskEditComponent.prototype.xoaChiSoSinhHieu = function (item) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
                        ...
                        if (result === 'Yes' && _this.dataSourceSinhHieuDisplay.data.some(function (x) { return x === item; })) {
                            _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_11__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
                            _this.dataSourceSinhHieu.data.filter(function (x) { return x === item; })[0].IsDelete = true;
                            _this.dataSourceSinhHieuDisplay.data.splice(_this.dataSourceSinhHieuDisplay.data.findIndex(function (x) { return x === item; }), 1);
                        }
                    });
                };
                PopupKetQuaKskEditComponent.prototype.gridPhanLoaiCacBenhTatVaDeNghi = function (hopDongKhamSucKhoeId) {
                    var _this = this;
                    this.apiService.post("KhamDoan/GetGridPhanLoaiVaCacBenhtatDenghi?hopDongKhamSucKhoeId=" + hopDongKhamSucKhoeId).subscribe(function (resData) {
                        if (resData != undefined && resData != null) {
                            if (resData.length == 0) {
                                _this.showGrid = false;
                            }
                            _this.gridDataSourcePhanLoaiCacBenhTatVaDeNghi = {
                                data: resData.slice(),
                                total: resData.slice().length
                            };
                        }
                    }, function (err) {
                        if (err.Message != "Validation Failed") {
                ...
                PopupKetQuaKskEditComponent.prototype.changePhanLoai = function (dataItem, value) {
                    var _this = this;
                    ...
                    if (dataItem.DaCoketLuan != true && value != undefined && value != null) {
                        this.apiService.post("KhamDoan/GetPhanLoaiSucKhoeKetLuan?id=" + dataItem.PhanLoaiIdCapNhatId).subscribe(function (resData) {
                            if (resData != undefined && resData != null) {
                ...
                PopupKetQuaKskEditComponent.prototype.changePhanLoaiCapNhat = function (dataItem, value) {
                    var _this = this;
                    dataItem.PhanLoaiIdCapNhat = value;
                    if (dataItem.DaCoketLuan != true && value != undefined && value != null) {
                        this.apiService.post("KhamDoan/GetPhanLoaiSucKhoeKetLuan?id=" + value).subscribe(function (resData) {
                            if (resData != undefined && resData != null) {
                                dataItem.KetQua = resData[0].DisplayName;
                            }
                        }, function (err) {
                ...
                PopupKetQuaKskEditComponent.prototype.changeCacBenhTatVaDeNghi = function (dataItem, value) {
                    if (dataItem.DaCoketLuan != true && value != undefined && value != null && value != "") {
                        dataItem.KetQuaDefault = value;
                        dataItem.KetQua = value;
                    }
                };
                PopupKetQuaKskEditComponent.prototype.showLoading = function (title) {
                ...
                PopupKetQuaKskEditComponent.prototype.closeLoading = function (loading) {
                    loading.close();
                };
                PopupKetQuaKskEditComponent.prototype.fullscreen = function () {
                ...
                PopupKetQuaKskEditComponent.prototype.CopyKetQuaHienThi = function () {
                ...
                PopupKetQuaKskEditComponent.prototype.setDataGridView = function () {
                    this.gridChinhSua.gridDataSource = this.gridDataSource.data;
                    if (this.gridChinhSua !== undefined)
                        this.gridChinhSua.setDataSource();
                };
                return PopupKetQuaKskEditComponent;
            }());
            PopupKetQuaKskEditComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/component/dialogs/loading/loading.component */ "./src/app/shared/component/dialogs/loading/loading.component.ts");
            var PopupKetQuaKskKetLuanComponent = /** @class */ (function () {
                function PopupKetQuaKskKetLuanComponent(data, dialog, apiService, notificationService) {
                    this.data = data;
                    this.dialog = dialog;
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                ...
                PopupKetQuaKskKetLuanComponent.prototype.ngOnInit = function () {
                    this.getHtml();
                };
                PopupKetQuaKskKetLuanComponent.prototype.getHtml = function () {
                    var _this = this;
                    ...
                    this.apiService.postExportPdf("KhamDoan/XuLyInKetQuaKhamSucKhoeKetLuanAsync", obj).subscribe(function (res) {
                        var newBlob = new Blob([res], { type: "application/pdf" });
                ...
                //     });
                // }
                PopupKetQuaKskKetLuanComponent.prototype.downloadFile = function () {
                ...
                PopupKetQuaKskKetLuanComponent.prototype.showPopupLoadingData = function () {
                ...
                PopupKetQuaKskKetLuanComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                return PopupKetQuaKskKetLuanComponent;
            }());
            PopupKetQuaKskKetLuanComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupKetQuaKskSharedComponent = /** @class */ (function () {
                function PopupKetQuaKskSharedComponent(data, dialogRef, route, router, apiService, dialog, notificationService, authService, ref) {
                    this.data = data;
                    this.dialogRef = dialogRef;
                    this.route = route;
                    this.router = router;
                ...
                PopupKetQuaKskSharedComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    if (this.data.JsonStringKetQua == null) {
                        this.apiService.post("KhamDoan/GetDataKetQuaKhamTheoKhoa?id=" + this.data.Id + "&type=" + this.data.Type).subscribe(function (resData) {
                            if (_this.data.Type == _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_1__["LoaiChuyenKhoaVaDichVuKyThuat"].ChuyenKhoaNoi) {
                                _this.ketQuaKhamChuyenKhoaNoi = resData.KetQuaKhamChuyenKhoaNoiOBJ;
                            }
                            if (_this.data.Type == _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_1__["LoaiChuyenKhoaVaDichVuKyThuat"].ChuyenKhoaTaiMuiHong) {
                                _this.KetQuaKhamChuyenKhoaTaiMuiHong = resData.KetQuaKhamChuyenKhoaTaiMuiHongOBJ;
                            }
                            if (_this.data.Type == _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_1__["LoaiChuyenKhoaVaDichVuKyThuat"].ChuyenKhoaRangHamMat) {
                                _this.ketQuaKhamChuyenKhoaNoiRangHamMat = resData.KetQuaKhamChuyenKhoaNoiRangHamMatOBJ;
                            }
                            if (_this.data.Type == _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_1__["LoaiChuyenKhoaVaDichVuKyThuat"].ChuyenKhoaMat) {
                                _this.ketQuaKhamChuyenKhoaMat = resData.KetQuaKhamChuyenKhoaMatOBJ;
                            }
                            if (_this.data.Type == _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_1__["LoaiChuyenKhoaVaDichVuKyThuat"].ChuyenSanPhuKhoa || _this.data.Type == _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_1__["LoaiChuyenKhoaVaDichVuKyThuat"].ChuyenDaLieu || _this.data.Type == _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_1__["LoaiChuyenKhoaVaDichVuKyThuat"].ChuyenNgoaiKhoa) {
                                _this.ketQuaNgoaiDaLieuSanPhuKhoa = resData.KetQuaNgoaiDaLieuSanPhuKhoaOBJ;
                            }
                            if (_this.data.Type == _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_1__["LoaiChuyenKhoaVaDichVuKyThuat"].Dvkt) // dịch vụ kỹ thuật
                             {
                                _this.ketQuaNgoaiDaLieuSanPhuKhoa = resData.KetQuaDVKTOBJ;
                            }
                        }, function (err) {
                            _this.validationErrors = err.ValidationErrors;
                            if (err.Message != "Validation Failed") {
                        ...
                        var jsonPar = JSON.parse(this.data.JsonStringKetQua);
                ...
                PopupKetQuaKskSharedComponent.prototype.close = function (result) {
                    if (result == 'Yes') {
                        if (this.data.Type == _kham_doan_ket_luan_model__WEBPACK_IMPORTED_MODULE_1__["LoaiChuyenKhoaVaDichVuKyThuat"].ChuyenKhoaNoi) {
                ...
                return PopupKetQuaKskSharedComponent;
            }());
            PopupKetQuaKskSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanThongTinHanhChinhComponent = /** @class */ (function () {
                function KhamDoanThongTinHanhChinhComponent(apiService, notificationService) {
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.thongTinHanhChinh = new _kham_doan_model__WEBPACK_IMPORTED_MODULE_4__["KhamDoanThongTinHanhChinh"]();
                }
                KhamDoanThongTinHanhChinhComponent.prototype.ngOnInit = function () {
                    this.getThongTinHanhChinh(this.yeuCauTiepNhanId);
                };
                KhamDoanThongTinHanhChinhComponent.prototype.getThongTinHanhChinh = function (yeuCauTiepNhanId) {
                    var _this = this;
                    this.apiService
                        .get("KhamDoan/GetThongTinHanhChinh?yeuCauTiepNhanId=" + yeuCauTiepNhanId).subscribe(function (resultData) {
                        _this.thongTinHanhChinh = resultData;
                    }, function (err) {
                        if (err.Message != "Validation Failed") {
                            _this.notificationService.showError(err.Message);
                        }
                ...
                return KhamDoanThongTinHanhChinhComponent;
            }());
            KhamDoanThongTinHanhChinhComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanThongTinHanhChinhModule = /** @class */ (function () {
                function KhamDoanThongTinHanhChinhModule() {
                }
                return KhamDoanThongTinHanhChinhModule;
            }());
...
//# sourceMappingURL=default~kham-benh-kham-doan-tat-ca-phong-kham-doan-tat-ca-phong-module~kham-doan-kham-doan-ket-luan-~fb7038b1-es5.js.map
//# sourceMappingURL=default~kham-benh-kham-doan-tat-ca-phong-kham-doan-tat-ca-phong-module~kham-doan-kham-doan-ket-luan-~fb7038b1-es5.js.map