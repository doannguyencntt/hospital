...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~kham-benh-lich-su-kham-benh-lich-su-kham-benh-module~quay-thuoc-danh-sach-cap-thuoc-bhyt-cap~f2f72aff"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApDungMiemGiamChoTungLoaiThuocPopupComponent = /** @class */ (function () {
                function ApDungMiemGiamChoTungLoaiThuocPopupComponent(data, sanitizer, notificationService, dialogRef, cdRef) {
                    this.data = data;
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.ngOnInit = function () {
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.resetLaiTongSoTienMG = function () {
                    this.data.dataItem.DanhSachMienGiamVos.forEach(function (item) {
                        item.TongTienMiemGiam = 0;
                    });
                };
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.soTienTruocKhiMiemGiam = function () {
                    var thanhTien = this.data.dataItem.DonGia * this.data.dataItem.SoLuongMua;
                    var soTienCongNo = 0;
                    if (this.data.dataItem.DanhSachCongNoChoThus != undefined && this.data.dataItem.DanhSachCongNoChoThus.length > 0) {
                        this.data.dataItem.DanhSachCongNoChoThus.forEach(function (item) {
                            soTienCongNo = soTienCongNo + item.SoTienCongNoChoThu;
                        });
                    }
                    return thanhTien - soTienCongNo;
                };
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.changePhanTram = function (ev, item) {
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.changeSoTien = function (ev, item) {
                    if (ev != undefined && ev != null) {
                        item.SoTien = ev;
                    }
                    else {
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.kiemTraTiLeVaSoTien = function () {
                    var _this = this;
                    this.data.dataItem.DanhSachMienGiamVos.forEach(function (element) {
                        if (element.LoaiMienGiam === 3) {
                            if (_this.firstApDungDauTien && element.TiLe === _this.tiLeBanDau && element.SoTien === _this.soTienBanDau) {
                                _this.kiemTraThayDoiSoTienTiLe = true;
                            }
                        }
                    });
                };
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.apDungPhanTram = function (ev, item) {
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.apDungSoTien = function (ev, item) {
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.resetPhanTram = function () {
                    this.data.dataItem.DanhSachMienGiamVos.forEach(function (element) {
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.resetSoTien = function () {
                    this.data.dataItem.DanhSachMienGiamVos.forEach(function (element) {
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.replaceAll = function (str, find, replace) {
                    return str.replace(new RegExp(find, "g"), replace);
                };
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.resetMGT = function () {
                    this.data.dataItem.DanhSachMienGiamVos.forEach(function (element) {
                        if (element.LoaiMienGiam === 3 && element.LoaiChietKhau == 1) {
                            element.TiLe = 0;
                            element.TongTienMiemGiam = 0;
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.close = function () {
                    this.tamdanhSachChiPhi.apdungMGTThanhCong = false;
                    this.dialogRef.close(this.tamdanhSachChiPhi);
                };
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.HuyApDungMGT = function () {
                    this.tamdanhSachChiPhi.apdungMGTThanhCong = false;
                    this.dialogRef.close(this.tamdanhSachChiPhi);
                };
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.ApDungMGT = function () {
                    var _this = this;
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                    this.data.dataItem.DanhSachMienGiamVos.forEach(function (element) {
                        if (_this.disableInputPhanTram && element.LoaiMienGiam === 3 && element.LoaiChietKhau == 1 && (element.TiLe === undefined || element.TiLe === null || element.TiLe === 0)) {
                            _this.validationErrors.push({
                                Message: "Vui lòng nhập tỉ lệ miễn giảm.",
                                Field: "TiLe",
                            });
                        }
                        if (_this.disableInputSoTien && element.LoaiMienGiam === 3 && element.LoaiChietKhau == 2 && (element.SoTien === undefined || element.SoTien === null || element.SoTien === 0)) {
                            _this.validationErrors.push({
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.tinhSoTienMiemGiamTiLe = function (dataItem) {
                    var _this = this;
                    this.tongTatCaSoTienMg = 0;
                    ...
                    if (this.tongTienTungDichVu !== 0) {
                        ...
                        dsMienGiamTheoSoTien.forEach(function (item) {
                            _this.tongTatCaSoTienMg += item.TongTienMiemGiam;
                        });
                        if (dsMienGiamTheoPhanTram != null && dsMienGiamTheoPhanTram.length > 0) {
                            ...
                            dsMienGiamTheoPhanTram.forEach(function (item) {
                                ...
                                item.TongTienMiemGiam = _this.tongTienTungDichVu !== 0 ? (item.TiLe * _this.tongTienTungDichVu) / 100 : 0;
                                _this.tongTatCaSoTienMg += item.TongTienMiemGiam;
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.tinhSoTienMiemGiamSoTienMGT = function (dataItem) {
                    var _this = this;
                    this.tongTatCaSoTienMg = 0;
                    ...
                    if (this.tongTienTungDichVu !== 0) {
                        ...
                        if (dsMienGiamTheoSoTien != null && dsMienGiamTheoSoTien.length > 0) {
                            ...
                            dsMienGiamTheoSoTien.forEach(function (item) {
                                ...
                                item.TongTienMiemGiam = _this.tongTienTungDichVu !== 0 ? item.SoTien : 0;
                                _this.tongTatCaSoTienMg += item.TongTienMiemGiam;
                            });
                        }
                    }
                };
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.tinhSoTienMiemGiam = function (dataItem) {
                    var _this = this;
                    this.tongTatCaSoTienMg = 0;
                    var tiLePhanTramConLai = 100;
                    var soTienConLai = this.tongTienTungDichVu;
                ...
                ApDungMiemGiamChoTungLoaiThuocPopupComponent.prototype.bindCheckboxMienGiamThem = function (dataItem) {
                    var _this = this;
                    if (dataItem.DanhSachMienGiamVos != null) {
                        dataItem.DanhSachMienGiamVos.filter(function (item) { return item.LoaiMienGiam === 3; }).forEach(function (item) {
                            if (item.LoaiChietKhau === _this.loaiChietKhau.ChietKhauTheoTiLe) {
                                if (item.TiLe != null && item.TiLe != 0) {
                                    _this.disablePhanTram = true;
                                    _this.disableInputPhanTram = true;
                                    _this.tiLeBanDau = item.TiLe;
                                }
                                else {
                                    _this.disablePhanTram = false;
                                    _this.disableInputPhanTram = false;
                                    item.TongTienMiemGiam = 0;
                                }
                            }
                            if (item.LoaiChietKhau === _this.loaiChietKhau.ChietKhauTheoSoTien) {
                                if (item.SoTien != null && item.SoTien != 0) {
                                    _this.disableSoTien = true;
                                    _this.disableInputSoTien = true;
                                    _this.soTienBanDau = item.SoTien;
                                }
                                else {
                                    _this.disableSoTien = false;
                                    _this.disableInputSoTien = false;
                                    item.TongTienMiemGiam = 0;
                                }
                            }
                        });
                ...
                return ApDungMiemGiamChoTungLoaiThuocPopupComponent;
            }());
            ApDungMiemGiamChoTungLoaiThuocPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApDungMiemGiamThemPopupComponent = /** @class */ (function () {
                function ApDungMiemGiamThemPopupComponent(data, sanitizer, cdRef, dialogRef) {
                    this.data = data;
                    this.sanitizer = sanitizer;
                    this.cdRef = cdRef;
                    this.dialogRef = dialogRef;
                ...
                ApDungMiemGiamThemPopupComponent.prototype.ngOnInit = function () {
                };
                ApDungMiemGiamThemPopupComponent.prototype.apDungPhanTram = function (ev) {
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                    this.disablePhanTram = !ev;
                    this.apDungMiemGiamThem.TiLe = 0;
                };
                ApDungMiemGiamThemPopupComponent.prototype.apDungSoTien = function (ev) {
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                    this.disableSoTien = !ev;
                    this.apDungMiemGiamThem.SoTien = 0;
                };
                ApDungMiemGiamThemPopupComponent.prototype.replaceAll = function (str, find, replace) {
                    return str.replace(new RegExp(find, "g"), replace);
                };
                ApDungMiemGiamThemPopupComponent.prototype.HuyApDungMGT = function () {
                    this.dialogRef.close(null);
                };
                ApDungMiemGiamThemPopupComponent.prototype.ApDungMGT = function () {
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                ...
                ApDungMiemGiamThemPopupComponent.prototype.close = function () {
                    this.dialogRef.close(null);
                };
                return ApDungMiemGiamThemPopupComponent;
            }());
            ApDungMiemGiamThemPopupComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"] },
                { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InBangThuTienPopUpComponent = /** @class */ (function () {
                function InBangThuTienPopUpComponent(data, sanitizer, dialog) {
                    this.data = data;
                    this.sanitizer = sanitizer;
                    this.dialog = dialog;
                    this.src = '';
                ...
                InBangThuTienPopUpComponent.prototype.ngOnInit = function () {
                ...
                InBangThuTienPopUpComponent.prototype.InPhieu = function (loaiPhieu) {
                    this.loaiPhieu = loaiPhieu;
                    this.getSharedPrintForm();
                };
                InBangThuTienPopUpComponent.prototype.getSharedPrintForm = function () {
                    var tmpBangKeThu = '<table id=\'showHeader\' style=\'width: 100%; height: 40px; background: #005dab;color:#fff;\'> <tr><th rowspan = \'3\' style = \'font-size: 20px;\'>BẢNG KÊ THU TIỀN THUỐC</th></tr></table>';
                    var tmpPhieuThu = '<table class=\'showHeader\' style=\'width: 100%; height: 40px; background: #005dab;color:#fff;\'> <tr><th rowspan = \'3\' style = \'font-size: 20px;\'>PHIẾU THU</th></tr></table>';
                    var data;
                    ...
                    if (this.loaiPhieu == 1) {
                        ...
                        if (dataphieukeThuTienThuoc[1] != undefined || dataphieukeThuTienThuoc[1] != null) {
                            ...
                            var message_1 = "Không có phiếu thu tiền";
                            return new Promise(function (resolve) {
                                resolve(message_1);
                            });
                        }
                ...
                InBangThuTienPopUpComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return InBangThuTienPopUpComponent;
            }());
            InBangThuTienPopUpComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            /* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
            var InDonThuocPopUpComponent = /** @class */ (function () {
                function InDonThuocPopUpComponent(data, sanitizer, dialog) {
                    this.data = data;
                    this.sanitizer = sanitizer;
                    this.dialog = dialog;
                    this.src = '';
                ...
                InDonThuocPopUpComponent.prototype.ngOnInit = function () {
                    this.modelPrint = this.data.Model;
                    this.kiemtraPhieuInManhinh = this.data.InDonThuocDanhSachList;
                    this.InPhieuThu = this.data.InPhieuThu;
                    this.InBangKe = this.data.InBangKe;
                ...
                InDonThuocPopUpComponent.prototype.InPhieu = function (loaiPhieu) {
                    this.loaiPhieu = loaiPhieu;
                    this.getSharedPrintForm();
                };
                InDonThuocPopUpComponent.prototype.getSharedPrintForm = function () {
                    var tmpBHYT = "<p  style='background: #005dab;color:#fff; height:40px; font-size:30px;text-align:center'>" +
                        "<th>TOA THUỐC BẢO HIỂM Y TẾ</th>" +
                        "</p>";
                    var tmpKBHYT = "<p  style='background: #005dab;color:#fff; height:40px; font-size:30px;text-align:center'>" +
                        "<th>TOA THUỐC KHÔNG BẢO HIỂM Y TẾ</th>" +
                        "</p>";
                    var tmpTNBV = "<p  style='background: #005dab;color:#fff; height:40px; font-size:30px;text-align:center'>" +
                        "<th>TOA THUỐC NGOÀI BỆNH VIỆN</ th>" +
                        "</p>";
                    var tmpTuVan = "<p  style='background: #005dab;color:#fff; height:40px; font-size:30px;text-align:center'>" +
                        "<th>ĐƠN TƯ VẤN</ th>" +
                        "</p>";
                    var data;
                    ...
                    if (this.loaiPhieu == 1) {
                        ...
                        if (dataphieukeThuTienThuoc[1] != undefined || dataphieukeThuTienThuoc[1] != null) {
                            ...
                            var message_2 = "Không có phiếu thu tiền";
                            return new Promise(function (resolve) {
                                resolve(message_2);
                            });
                        }
                ...
                InDonThuocPopUpComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return InDonThuocPopUpComponent;
            }());
            InDonThuocPopUpComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"] },
                { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocChoThanhToanComponent = /** @class */ (function () {
                function QuayThuocChoThanhToanComponent(router, route, cd, dialog) {
                    this.router = router;
                    this.route = route;
                    this.cd = cd;
                    this.dialog = dialog;
                ...
                QuayThuocChoThanhToanComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.queryParams.subscribe(function (params) {
                        _this.id = params.page; // id là đã thanh toán
                        _this.hoquerySearch = params.hoQuerysearch;
                    });
                ...
                QuayThuocChoThanhToanComponent.prototype.getonHaddleDataSearch = function (event) {
                    this.dataQuayThuocSearch = event;
                };
                QuayThuocChoThanhToanComponent.prototype.ToKhachVangLai = function (typeDanhSachThanhToan) {
                ...
                QuayThuocChoThanhToanComponent.prototype.getkiemTraDonThuocThanhToan = function (event) {
                    this.cd.detectChanges();
                    // this.typeDanhSachThanhToan = event;
                };
                QuayThuocChoThanhToanComponent.prototype.getonHaddleUuTienSearch = function (event) {
                    // this.gridQuayThuocList.queryStringSearchUuTien = null;
                    this.queryStringSearchUuTien = event;
                    this.cd.detectChanges();
                };
                QuayThuocChoThanhToanComponent.prototype.KiemTraeXportExel = function (event) {
                    this.xacNhanIn = event;
                };
                QuayThuocChoThanhToanComponent.prototype.getData = function (event) {
                    this.benhNhan = event;
                    ...
                    if (event.Id > 0) {
                        ...
                        if (event.DonThuocThanhToanExits == true) {
                            ...
                            var dialogRef = this.dialog.open(_quay_thuoc_xac_nhan_mua_thuoc_khach_vang_lai_pop_up_quay_thuoc_xac_nhan_mua_thuoc_khach_vang_lai_pop_up_component__WEBPACK_IMPORTED_MODULE_3__["QuayThuocXacNhanMuaThuocKhachVangLaiPopUpComponent"], {
                                disableClose: true,
                                width: '500px',
                ...
                return QuayThuocChoThanhToanComponent;
            }());
            QuayThuocChoThanhToanComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocChoXuatThuocComponent = /** @class */ (function () {
                function QuayThuocChoXuatThuocComponent(route, dialog, apiService, router, notificationService) {
                    this.route = route;
                    this.dialog = dialog;
                ...
                QuayThuocChoXuatThuocComponent.prototype.ngOnInit = function () {
                ...
                QuayThuocChoXuatThuocComponent.prototype.ngOnChanges = function () {
                    if (this.flagOnce == false) {
                        this.GetThongTinDonThuoc(this.id);
                        this.flagOnce = true;
                    }
                };
                QuayThuocChoXuatThuocComponent.prototype.loadingPage = function () {
                    var self = this;
                ...
                QuayThuocChoXuatThuocComponent.prototype.GetThongTinDonThuoc = function (id) {
                    var _this = this;
                    var self = this;
                    var dialogRef = self.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_8__["LoadingComponent"], {
                        disableClose: true,
                    ...
                    //     },
                    //     () => { });
                    this.apiService.post("QuayThuoc/GetDanhSachXuatThuocKhongBHYT?tiepNhanId=" + id).subscribe(function (resultData) {
                        _this.dataSourcedanhsachThuocKhongBHYT.data = resultData;
                        var index = 1;
                        _this.dataSourcedanhsachThuocKhongBHYT.data.forEach(function (x) {
                            x.STT = index;
                            index++;
                        });
                        _this.danhSachThuoc.ThuocKhongBHYT = _this.dataSourcedanhsachThuocKhongBHYT.data.slice();
                    }, function () { });
                    dialogRef.close();
                };
                QuayThuocChoXuatThuocComponent.prototype.GuiData = function () {
                    var _this = this;
                    ...
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                        ...
                        if (result == "Yes") {
                            _this.apiService.post("QuayThuoc/XuatDonThuocBHYT", _this.danhSachThuoc).subscribe(function (resultData) {
                                if (resultData != null && resultData != undefined && resultData != "") {
                                    _this.notificationService.showError(resultData);
                                }
                                else {
                                    if (_this.ttcheck == 1) {
                                        _this.router.navigate(['nha-thuoc'], { queryParams: { page: _this.ttcheck, hoQuerysearch: false } });
                                    }
                                    if (_this.ttcheck == 2) {
                                        _this.router.navigate(['nha-thuoc'], { queryParams: { page: _this.ttcheck, hoQuerysearch: false } });
                                    }
                ...
                QuayThuocChoXuatThuocComponent.prototype.KeThuoc = function () {
                    var _this = this;
                    ...
                    this.apiService.postExportPdf("QuayThuoc/XacNhanInThuocCoBhyt", data).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            _this.dialog.open(_thong_tin_phieu_pdf_popup_thong_tin_phieu_pdf_popup_component__WEBPACK_IMPORTED_MODULE_9__["ThongTinPhieuPdfPopupComponent"], {
                                disableClose: true,
                                width: '1000px',
                ...
                QuayThuocChoXuatThuocComponent.prototype.showPopupLoadingIn = function () {
                ...
                QuayThuocChoXuatThuocComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return QuayThuocChoXuatThuocComponent;
            }());
            QuayThuocChoXuatThuocComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocHinhThucThanhToanComponent = /** @class */ (function () {
                function QuayThuocHinhThucThanhToanComponent(route, apiService, notificationService, dialog, cdRef, authService, router) {
                    this.route = route;
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.dialog = dialog;
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.total = function (field) {
                    switch (field) {
                        case 'BNConPhaiThanhToan':
                            return this.dataSourcedanhsachThuoc.data.filter(function (x) { return x.CheckedDefault; })
                                .reduce(function (sum, item) { return sum + item.BNConPhaiThanhToan; }, 0);
                        case 'SoTienMG':
                            return this.dataSourcedanhsachThuoc.data.filter(function (x) { return x.CheckedDefault; })
                                .reduce(function (sum, item) { return sum + item.SoTienMG; }, 0);
                        case 'ThanhTienHienThi':
                            return this.dataSourcedanhsachThuoc.data.filter(function (x) { return x.CheckedDefault; })
                                .reduce(function (sum, item) { return sum + item.ThanhTienHienThi; }, 0);
                        case 'BNConPhaiThanhToanHienThi':
                            return this.dataSourcedanhsachThuoc.data.filter(function (x) { return x.CheckedDefault; })
                                .reduce(function (sum, item) { return sum + item.BNConPhaiThanhToanHienThi; }, 0);
                        case 'ThanhTien':
                            return this.dataSourcedanhsachThuoc.data.filter(function (x) { return x.CheckedDefault; })
                                .reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                    }
                };
                QuayThuocHinhThucThanhToanComponent.prototype.ngOnInit = function () {
                    ...
                    var tiepNhanId = this.route.snapshot.params.id;
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.checkLoaiYCTN = function (tiepNhanId) {
                    var _this = this;
                    this.apiService.post('QuayThuoc/CheckLoaiYCTN?tiepNhanId=' + tiepNhanId).subscribe(function (resultData) {
                        _this.loaiYeuCauTiepNhanKhachVangLai = resultData;
                    });
                };
                QuayThuocHinhThucThanhToanComponent.prototype.ngOnChanges = function () {
                    if (this.apDungCongNoThuoc === true) {
                        this.apDungCNAndMiemGiam = true;
                        this.bindChiaTienCongNo();
                        var soTienCongNoApply = this.thongTinTam[this.viTri].SoTien;
                        var soTienTongHienTai = this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.bindChiaPhanTramDoiTuongUuDai = function () {
                    var _this = this;
                    ...
                    if (this.dataSourcedanhsachThuoc.data.length > 0) {
                        if (this.thongTinTam.length === 0) {
                            for (var _i = 0, _a = this.dataSourcedanhsachThuoc.data; _i < _a.length; _i++) {
                                var dsChiPhiKhamChuaBenh = _a[_i];
                        ...
                        if (this.thongTinMienGiamVos != undefined && this.thongTinMienGiamVos != null) {
                            ...
                            if (this.thongTinMienGiamVos.ThongTinMienGiamVoucherVo !== null &&
                                ...
                                if (this.thongTinMienGiamVos.ThongTinMienGiamVoucherVo.LoaiVoucher === 2) {
                                    var soTienMiemGiamThemConLaiVoucherCase = this.thongTinMienGiamVos.ThongTinMienGiamVoucherVo.SoTienVoucherMiemGiam;
                                    var soTienMiemGiamThemConLaiTamVoucherCase = 0;
                                    for (var _b = 0, _c = this.dataSourcedanhsachThuoc.data; _b < _c.length; _b++) {
                                        var dsChiPhiKhamChuaBenh = _c[_b];
                                ...
                                if (this.thongTinMienGiamVos.ThongTinMienGiamVoucherVo.LoaiVoucher === 1) {
                                    ...
                                    var soTienVoucherConLai_1 = this.thongTinMienGiamVos.ThongTinMienGiamVoucherVo.SoTienVoucherMiemGiam;
                                    this.thongTinMienGiamVos.ThongTinMienGiamVoucherVo.DuocPhamMienGiamTheoTiLes.forEach(function (element) {
                                        for (var _i = 0, _a = _this.dataSourcedanhsachThuoc.data; _i < _a.length; _i++) {
                                            var dsChiPhiKhamChuaBenh = _a[_i];
                                            if (dsChiPhiKhamChuaBenh.CheckedDefault === true) {
                                                var totalCongNo = _this.itemTotalCongNo(dsChiPhiKhamChuaBenh.DanhSachCongNoChoThus);
                                                if (dsChiPhiKhamChuaBenh.DuocPhamId === element.DuocPhamId) {
                                                    ...
                                                    if (soTienVoucherConLai_1 < dsChiPhiKhamChuaBenh.SoTienMG) {
                                                        dsChiPhiKhamChuaBenh.SoTienMG = soTienVoucherConLai_1;
                                                    }
                                                    soTienVoucherConLai_1 = soTienVoucherConLai_1 - dsChiPhiKhamChuaBenh.SoTienMG;
                                                    dsChiPhiKhamChuaBenh.BNConPhaiThanhToan =
                            ...
                            if (this.thongTinMienGiamVos.ThongTinMienGiamThemVo != undefined && this.thongTinMienGiamVos.ThongTinMienGiamThemVo != null &&
                                ...
                                if (this.thongTinMienGiamVos.ThongTinMienGiamThemVo.LoaiMienGiamThem === 1) {
                                    var soTienMiemGiamThemConLai = this.thongTinMienGiamVos.ThongTinMienGiamThemVo.SoTienMGConLai;
                                    var soTienMiemGiamThemConLaiTam = 0;
                                    for (var _d = 0, _e = this.dataSourcedanhsachThuoc.data; _d < _e.length; _d++) {
                                        var dsChiPhiKhamChuaBenh = _e[_d];
                                        var totalCongNo = this.itemTotalCongNo(dsChiPhiKhamChuaBenh.DanhSachCongNoChoThus);
                                        if (dsChiPhiKhamChuaBenh.CheckedDefault === true) {
                                            if (dsChiPhiKhamChuaBenh.BNConPhaiThanhToan !== 0
                                    ...
                                    var isApDungDichVuId = false;
                                    var tiLeMienGiam = this.thongTinMienGiamVos.ThongTinMienGiamThemVo.TiLeMienGiam;
                                    for (var _f = 0, _g = this.dataSourcedanhsachThuoc.data; _f < _g.length; _f++) {
                                        var dsChiPhiKhamChuaBenh = _g[_f];
                                        var totalCongNo = this.itemTotalCongNo(dsChiPhiKhamChuaBenh.DanhSachCongNoChoThus);
                                        if (dsChiPhiKhamChuaBenh.CheckedDefault === true) {
                                    ...
                                    if (isApDungDichVuId) {
                                        for (var _h = 0, _j = this.dataSourcedanhsachThuoc.data; _h < _j.length; _h++) {
                                            var dsChiPhiKhamChuaBenh = _j[_h];
                    ...
                    this.tongTienGrid = Math.round(this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.BNConPhaiThanhToan; }, 0) + 0.0000001);
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.itemTotalCongNo = function (danhSachCongNoChoThus) {
                    var toatalCongNo = 0;
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.selectDataDanhSachDaChon = function () {
                    var totalThanhTien = 0;
                    this.dataSourcedanhsachThuoc.data.forEach(function (element) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.totalCongNoPrivate = function () {
                    var totalCongNoThanhToan = 0;
                    if (this.thongTinTam.length !== 0) {
                        // tslint:disable-next-line: prefer-for-of
                        for (var index = 0; index < this.thongTinTam.length; index++) {
                            totalCongNoThanhToan += this.thongTinTam[index].SoTien;
                        }
                    }
                    return totalCongNoThanhToan;
                };
                QuayThuocHinhThucThanhToanComponent.prototype.tinhTienCongNo = function (itemThanhTien, congNoId, totalTT) {
                    var totalCongNo = 0;
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.tinhTiLeMiemGiamInGrid = function (data) {
                    var tongCongNoItem = this.itemTotalCongNo(data.DanhSachCongNoChoThus);
                    var sumSoTienBenhNhanTra = (data.ThanhTien - tongCongNoItem);
                    if (sumSoTienBenhNhanTra === 0) {
                        return 0;
                    }
                    return Math.round((data.SoTienMG / sumSoTienBenhNhanTra) * 100);
                };
                QuayThuocHinhThucThanhToanComponent.prototype.bindChiaTienCongNo = function () {
                    var _this = this;
                    var totalTT = this.selectDataDanhSachDaChon();
                    var totalCongNo = this.totalCongNoPrivate();
                    ...
                    if (this.danhSachCongNoChoThus[0].CongNoChoThus.length !== 0) {
                        this.danhSachCongNoChoThus[0].CongNoChoThus.forEach(function (congNo) {
                            if (congNo.ViTri === _this.viTri) {
                                if (_this.thongTinTam.length !== 0) {
                                    congNo.SoTienCongNoChoThu = _this.thongTinTam[_this.viTri].SoTien;
                                }
                            }
                        });
                    }
                    // mỗi lần cập nhật công nợ thông tin tạm thì sẽ luôn cập nhập thông tin đơn thuốc danh sách công nợ (dùng cho việc thu tiền)
                    this.thongTinTam.forEach(function (element) {
                        _this.thongtinDonThuoc.DanhSachCongNos.forEach(function (congNoDonThuoc) {
                    ...
                    if (this.thongTinTam.length > 0) {
                        var danhSachCongNoChoThu = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["DanhSachCongNoChoThu"]();
                        for (var index = 0; index < this.thongTinTam.length; index++) {
                            var congNo = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["CongNoChoThu"]();
                            congNo.ViTri = index;
                        ...
                        var tongCongNo = 0;
                        for (var index = 0; index < this.dataSourcedanhsachThuoc.data.length; index++) {
                        ...
                        this.dataSourcedanhsachThuoc.data.forEach(function (element) {
                            var totalCongNoEle = 0;
                            element.DanhSachCongNoChoThus.forEach(function (elementCongNo) {
                                totalCongNoEle += elementCongNo.SoTienCongNoChoThu;
                            });
                            var soTienMG = _this.tinhSoTienMiemGiam(element);
                    ...
                    //     this.thongtinDonThuoc.TienMat = this.tongTien;
                    // }
                    var items = this.hinhThucThanhToan.filter(function (item) { return item.Selected == true; });
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.findLast = function () {
                    for (var index = this.dataSourcedanhsachThuoc.data.length - 1; index >= 0; index--) {
                        if (this.dataSourcedanhsachThuoc.data[index].CheckedDefault === true) {
                            return index;
                        }
                    }
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.myDanhSachChuaThanhToan = function () {
                    var _this = this;
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.danhSachXemTruocBangKeThuocVaVatTu = function (danhSachChuaThanhToans) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.setSelectAll = function () {
                    setTimeout(function () {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.chuyenDen = function (event) {
                    if (event.index === 0) {
                        this.cdRef.detectChanges();
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.onSelectChangeCheckbox = function (e, val) {
                    ...
                    if (len === 0) {
                        ...
                        .filter(function (obj) { return obj.HideCheckbox == null || (obj.HideCheckbox != undefined && obj.HideCheckbox == false); })
                        .length) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.onSelectDuocPham = function (event) {
                    var _this = this;
                    var loai = 0;
                    if (event == undefined || event == null) {
                        ...
                        this.apiService.post('QuayThuoc/GetThongTinDuocPham?duocPhamId=' + event.KeyId + "&LoaiDuocPhamHoacVatTu=" + event.LoaiDuocPhamHoacVatTu).subscribe(function (resultData) {
                            var soLuongTon = 0;
                            _this.lstthongTinDonThuoc = resultData;
                            if (_this.lstDonThuocMoiThem.length > 0) {
                                _this.lstDonThuocMoiThem.forEach(function (x) {
                                    if (x.DuocPhamId === _this.themDuocPham.DuocPhamId) {
                                        soLuongTon = soLuongTon + x.SoLuongMua;
                                    }
                                });
                            }
                            _this.themDuocPham.SoLuongTon = resultData.reduce(function (sum, item) { return sum + item.SoLuongTon; }, 0) - soLuongTon;
                        }, function () {
                        });
                    }
                };
                QuayThuocHinhThucThanhToanComponent.prototype.unCheckedBindSoTienMG = function (id) {
                    // tslint:disable-next-line: prefer-for-of
                    for (var index = 0; index < this.dataSourcedanhsachThuoc.data.length; index++) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.delete = function (event) {
                    var _this = this;
                    if (event != undefined && event != null) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                ...
                                var i = 0;
                                var stt = event.STT;
                                for (var index = 0; index < _this.dataSourcedanhsachThuoc.data.length; index++) {
                                    if (_this.dataSourcedanhsachThuoc.data[index].STT === event.STT) {
                                        i = index;
                                    }
                                }
                                _this.dataSourcedanhsachThuoc.data[i].HighLightClass = null;
                                _this.deleteItem.push(_this.dataSourcedanhsachThuoc.data[i]);
                                if (_this.lstthongTinDonThuoc === undefined) {
                                    _this.lstthongTinDonThuoc = [];
                                }
                                _this.lstthongTinDonThuoc.push(_this.dataSourcedanhsachThuoc.data[i]);
                                _this.dataSourcedanhsachThuoc.data.splice(i, 1);
                                _this.lstDonThuocMoiThem = new Array();
                                for (var index0 = 0; index0 < i; index0++) {
                                    _this.lstDonThuocMoiThem.push(_this.dataSourcedanhsachThuoc.data[index0]);
                                }
                                for (var index1 = i; index1 < _this.dataSourcedanhsachThuoc.data.length; index1++) {
                                    _this.dataSourcedanhsachThuoc.data[index1].STT = stt;
                                    _this.lstDonThuocMoiThem.push(_this.dataSourcedanhsachThuoc.data[index1]);
                                    stt++;
                                }
                                _this.tongTienGrid = Math.round(_this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.BNConPhaiThanhToan; }, 0) + 0.0000001);
                                _this.tongTien = _this.tongTienGrid;
                                if (_this.benhnhanThongTin.SoDuTaiKhoan > 0) {
                                    if (_this.tongTien > _this.benhnhanThongTin.SoDuTaiKhoan) {
                                        _this.tongTien -= _this.benhnhanThongTin.SoDuTaiKhoan;
                                    }
                                    else {
                                        _this.tongTien = 0;
                                    }
                                ...
                                //     this.thongtinDonThuoc.TienMat = this.tongTien;
                                // }
                                var items = _this.hinhThucThanhToan.filter(function (item) { return item.Selected == true; });
                                if (items != null && items.length > 0) {
                                    _this.tinhTienChoPhuongThucThanhToan(items[0].KeyId);
                                }
                            }
                        });
                    }
                };
                QuayThuocHinhThucThanhToanComponent.prototype.clearHinhThucThanhToan = function () {
                    this.flagCheckSeletedTienMat = false;
                    this.flagCheckSeletedChuyenKhoan = false;
                    this.flagCheckSeletedPos = false;
                    this.flagCheckSeletedSoTienCongNo = false;
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.GetTenBenhNhan = function (id) {
                    var _this = this;
                    this.apiService.post('QuayThuoc/GetTenBenhNhan?benhNhanId=' + id).subscribe(function (resultData) {
                        _this.thongtinDonThuoc.HoTenBenhNhan = resultData;
                        _this.GetThongTinDonThuoc(_this.id);
                    }, function () {
                    });
                };
                QuayThuocHinhThucThanhToanComponent.prototype.onSelectAllChange = function (checkedState) {
                    var _this = this;
                    var allData = this.dataSourcedanhsachThuoc.data;
                    ...
                    if (checkedState === 'checked') {
                        this.mySelectionInPage = allData
                            .filter(function (obj) { return obj.HideCheckbox == null || (obj.HideCheckbox != undefined && obj.HideCheckbox == false); }).map(function (item) { return item[_this.keySelectBy]; });
                        this.mySelection = this.mySelection.concat(this.mySelectionInPage);
                        this.selectAllState = 'checked';
                    }
                    else {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.GetThongTinDonThuoc = function (id) {
                    var _this = this;
                    this.apiService.post('QuayThuoc/GetDataDonThuoc?tiepNhanId=' + id).subscribe(function (resultData) {
                        _this.dataSourcedanhsachThuoc.data = resultData;
                        var index = 1;
                        _this.dataSourcedanhsachThuoc.data.forEach(function (x) {
                            x.STT = index;
                            index++;
                            x.KiemTraTienSoTienItemDichVu = false;
                        });
                        _this.myDanhSachChuaThanhToan();
                        _this.getSoDuTaiKhoanBenhNhan(id);
                        _this.closedialog.close();
                    }, function () {
                    });
                };
                QuayThuocHinhThucThanhToanComponent.prototype.getSoDuTaiKhoanBenhNhan = function (id) {
                    var _this = this;
                    this.apiService.get('ThuNgan/SoDuTaiKhoanBenhNhan/' + id).subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            ...
                            _this.benhnhanThongTin.SoDuTaiKhoan = 0;
                            _this.tongTienGrid = Math.round(_this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.BNConPhaiThanhToan; }, 0) + 0.0000001);
                            _this.tongTien = _this.tongTienGrid;
                            if (_this.benhnhanThongTin.SoDuTaiKhoan > 0) {
                                if (_this.tongTien > _this.benhnhanThongTin.SoDuTaiKhoan) {
                            ...
                            _this.thongtinDonThuoc.TienMat = _this.tongTien;
                            _this.thongtinDonThuoc.HinhThucThanhToan = [1];
                            _this.getDanhSachBHTN();
                        }
                    });
                };
                QuayThuocHinhThucThanhToanComponent.prototype.getDanhSachBHTN = function () {
                    var _this = this;
                    this.apiService.get('QuayThuoc/GetListCongTyBaoHiemTuNhans?tiepNhanId=' + this.maYCTNId).subscribe(function (resultData) {
                        if (resultData.length > 0) {
                            ...
                            // tslint:disable-next-line: prefer-for-of
                            for (var index = 0; index < _this.dataSourcedanhsachThuoc.data.length; index++) {
                                _this.dataSourcedanhsachThuoc.data[index].DanhSachCongNoChoThus = [];
                            }
                            _this.danhSachCongNoChoThus = [];
                            // tslint:disable-next-line: prefer-for-of
                            for (var index = 0; index < _this.dataSourcedanhsachThuoc.data.length; index++) {
                                // tslint:disable-next-line: prefer-for-of
                                for (var subIndex = 0; subIndex < danhSachCongNoChoThu.CongNoChoThus.length; subIndex++) {
                                    var congNoItem = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["CongNoChoThu"]();
                                    ...
                                    _this.dataSourcedanhsachThuoc.data[index].DanhSachCongNoChoThus.push(congNoItem);
                                }
                                var totalCongNo = _this.itemTotalCongNo(_this.dataSourcedanhsachThuoc.data[index].DanhSachCongNoChoThus);
                                _this.dataSourcedanhsachThuoc.data[index].BNConPhaiThanhToan =
                                    _this.dataSourcedanhsachThuoc.data[index].ThanhTien - totalCongNo - _this.dataSourcedanhsachThuoc.data[index].SoTienMG;
                            }
                            _this.danhSachCongNoChoThus.push(danhSachCongNoChoThu);
                            _this.danhSachCongNoChoThus[0].CongNoChoThus.forEach(function (element) {
                                var congNo = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["CongNoVo"]();
                                congNo.CongTyCongNoId = element.CongNoId;
                                congNo.SoTienCongNo = element.SoTienCongNoChoThu;
                                _this.thongtinDonThuoc.DanhSachCongNos.push(congNo);
                            });
                        }
                        _this.gridData = _this.dataSourcedanhsachThuoc.data;
                        _this.setSelectAll();
                        // this.getThongTinMienGiam(this.maYCTNId);  // to do
                    });
                };
                QuayThuocHinhThucThanhToanComponent.prototype.totalCongno = function (field) {
                    var sumCongNoItem = 0;
                    this.dataSourcedanhsachThuoc.data.forEach(function (element) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.GuiVaXuatThuocData = function (data) {
                    var _this = this;
                    this.apiService.post('QuayThuoc/ThuTienVaXuatThuoc', data).subscribe(function (resultData) {
                        if (resultData.ThanhCong === false) {
                            _this.notificationService.showError(resultData.Error);
                            if (resultData.DanhSachDuocPhamVuotTonKho != null) {
                                // tslint:disable-next-line: prefer-for-of
                                for (var i = 0; i < resultData.DanhSachDuocPhamVuotTonKho.length; i++) {
                                    // tslint:disable-next-line: prefer-for-of
                                    for (var j = 0; j < _this.dataSourcedanhsachThuoc.data.length; j++) {
                                        if (resultData.DanhSachDuocPhamVuotTonKho[i].Stt === _this.dataSourcedanhsachThuoc.data[j].STT) {
                                            _this.dataSourcedanhsachThuoc.data[j].HighLightClass = 'bg-row-lightpink';
                                            _this.dataSourcedanhsachThuoc.data[j].SoLuongDung =
                            ...
                            _this.dataSourcedanhsachThuoc.data = [];
                            _this.lstDonThuocMoiThem = [];
                            _this.cdRef.detectChanges();
                            _this.gridData = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_10__["process"])(_this.dataSourcedanhsachThuoc.data, _this.state);
                            _this.dialog.open(_quay_thuoc_xac_nhan_in_pop_up_quay_thuoc_xac_nhan_in_pop_up_component__WEBPACK_IMPORTED_MODULE_9__["QuayThuocXacNhanInPopUpComponent"], {
                                disableClose: true,
                                width: '500px',
                                data: { Model: resultData, Title: 'XÁC NHẬN' }
                            }).afterClosed().subscribe(function (result) {
                                if (result.Response !== 'No answer') {
                                    _this.changeTab.emit(2);
                                    _this.tongTien = 0;
                                    _this.getSoDuTaiKhoanBenhNhan(data.Id);
                                    _this.thongtinDonThuoc.TienMat = 0;
                                    _this.thongtinDonThuoc.ChuyenKhoan = 0;
                                    _this.thongtinDonThuoc.BenhNhanDua = 0;
                                    _this.thongtinDonThuoc.TienTraLai = 0;
                                    _this.XacNhanIn(result);
                                }
                                else {
                                    _this.changeTab.emit(2);
                                    _this.getSoDuTaiKhoanBenhNhan(data.Id);
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.GuiData = function (data) {
                    var _this = this;
                    this.apiService.post('QuayThuoc/ThemThanhToanDonThuoc', data).subscribe(function (resultData) {
                        if (resultData.ThanhCong === false) {
                            _this.notificationService.showError(resultData.Error);
                            if (resultData.DanhSachDuocPhamVuotTonKho != null) {
                                // tslint:disable-next-line: prefer-for-of
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.XacNhanIn = function (data) {
                    var _this = this;
                    this.showPopupLoadingIn();
                    data.Hosting = window.location.protocol + '//' + window.location.host;
                    this.apiService.postExportPdf('QuayThuoc/XacNhanIn', data).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            if (data.InBangKe == false && data.InPhieuThu == false) {
                                _this.notificationService.showError('Không có phiếu in được chọn.');
                                _this.closePopupLoadingData();
                            }
                            else {
                                _this.dialog.open(_thong_tin_phieu_pdf_popup_thong_tin_phieu_pdf_popup_component__WEBPACK_IMPORTED_MODULE_18__["ThongTinPhieuPdfPopupComponent"], {
                                    disableClose: true,
                                    width: '1000px',
                                    data: { Model: resultData }
                                }).afterClosed().subscribe(function () {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.shareData = function () {
                    this.thongtinDonThuoc.DanhSachDonThuocs = this.dataSourcedanhsachThuoc.data.slice();
                    this.thongtinDonThuoc.Id = this.id;
                    for (var index = 0; index < this.thongtinDonThuoc.DanhSachDonThuocs.length; index++) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.kiemTraNhapSoTienTra = function (dataThuTien) {
                    var soTienNhapTra = dataThuTien.ChuyenKhoan + dataThuTien.POS + dataThuTien.TienMat + dataThuTien.SoTienCongNo;
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.ThuTienVaXuatThuoc = function () {
                    var _this = this;
                    var checkTien = true;
                    ...
                    if (this.dataSourcedanhsachThuoc.data.filter(function (x) { return x.CheckedDefault; }).length === 0) {
                    ...
                    if (this.dataSourcedanhsachThuoc.length != 0) {
                        this.dataSourcedanhsachThuoc.data.forEach(function (element) {
                            if (element.KiemTraTienSoTienItemDichVu === true) {
                                _this.notificationService.showError('Thanh toán không hợp lệ');
                                checkTien = false;
                            }
                        });
                    }
                    ...
                    this.thongtinDonThuoc.DanhSachDonThuocs = this.dataSourcedanhsachThuoc.data.filter(function (x) { return x.CheckedDefault; });
                    this.apiService.post('QuayThuoc/CheckValidationForQuayThuoc', this.thongtinDonThuoc).subscribe(function () {
                        if (checkTien === true) {
                            if (_this.confirm != null) {
                                // this.dialog.closeAll();
                                _this.confirm = null;
                            }
                            _this.confirm = _this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                                disableClose: true,
                                width: '700px',
                                data: {
                                    Title: 'Xác nhận', Message: 'Bạn chắc chắn muốn thu của người bệnh ' +
                                        _this.benhnhanThongTin.HoTen.bold() + ' với số tiền là ' +
                                        _this.tongTien.toLocaleString('vi-VI').bold() + ' đồng hay không?'
                                }
                            }).afterClosed().subscribe(function (result) {
                                if (result === 'Yes') {
                                    _this.GuiVaXuatThuocData(_this.thongtinDonThuoc);
                                    _this.setDefeautTienMat = [1];
                                    _this.checkSeletedTienMat = true;
                                    _this.defeautSoTien();
                                }
                            });
                        }
                    }, function (err) {
                        _this.validationThuThuocErrors = err.ValidationErrors;
                    });
                };
                // ======= End Thu tiền và xuất thuốc 
                QuayThuocHinhThucThanhToanComponent.prototype.ThuTien = function () {
                    var _this = this;
                    var checkTien = true;
                    if (this.validationErrors !== undefined) {
                        this.validationThuThuocErrors = [];
                    ...
                    this.apiService.post('QuayThuoc/CheckValidationForQuayThuoc', this.thongtinDonThuoc).subscribe(function () {
                        if (checkTien === true) {
                            ...
                            _this.confirm = _this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                                ...
                                if (result === 'Yes') {
                                    _this.GuiData(_this.thongtinDonThuoc);
                                    _this.setDefeautTienMat = [1];
                                    _this.checkSeletedTienMat = true;
                                    _this.defeautSoTien();
                                }
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.extCheckboxSelection = function (event) {
                    var _this = this;
                    this.dataSourcedanhsachThuoc.data.forEach(function (element) {
                    ...
                    if (event.length > 0) {
                        var _loop_1 = function (index) {
                            this_1.dataSourcedanhsachThuoc.data.forEach(function (element) {
                                var soTienMG = _this.tinhSoTienMiemGiam(element);
                                element.SoTienMG = soTienMG;
                                // số tiền người bệnh phải trả đã trừ số tiền miễn giảm
                                var soTienCN = _this.soTienCongNoChoTungDichVu(element);
                    ...
                    this.tongTien = Math.round(this.dataSourcedanhsachThuoc.data.filter(function (x) { return x.CheckedDefault; })
                        .reduce(function (sum, item) { return sum + item.BNConPhaiThanhToan; }, 0));
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.resetGiaTienCongNo = function () {
                    this.dataSourcedanhsachThuoc.data.forEach(function (element) {
                        if (element.CheckedDefault !== true) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.themThuoc = function () {
                    var _this = this;
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                    ...
                    if (this.lstDonThuocMoiThem.length > 0) {
                        this.lstDonThuocMoiThem.forEach(function (x) {
                            if (x.DuocPhamId === _this.themDuocPham.DuocPhamId) {
                    ...
                    if (this.themDuocPham.SoLuongTon >= this.themDuocPham.SoLuong) {
                        ...
                        var count = this.themDuocPham.SoLuong;
                        var tamp = this.lstthongTinDonThuoc;
                        if (this.lstDonThuocMoiThem != undefined || this.lstDonThuocMoiThem != null) {
                            for (var jisoo = 0; jisoo < this.lstDonThuocMoiThem.length; jisoo++) {
                                for (var jihoo = 0; jihoo < this.lstthongTinDonThuoc.length; jihoo++) {
                        ...
                        var dsMGThem1 = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["DanhSachMienGiamVo"]();
                        var dsMGThem2 = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["DanhSachMienGiamVo"]();
                        var danhSachMienGiamVos = new Array();
                        ...
                        for (var index = 0; index < tamp.length; index++) { // tmp don thuuoc
                            if (tamp[index].SoLuongTon > 0) {
                                if (count !== 0) {
                                    var item = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["ThongTinDuocPham"]();
                                    if (count <= this.lstthongTinDonThuoc[index].SoLuongTon) {
                                        ...
                                        if (this.danhSachCongNoChoThus.length > 0) {
                                            if (this.danhSachCongNoChoThus[0].CongNoChoThus.length !== 0 ||
                                                ...
                                                for (var i = 0; i < this.danhSachCongNoChoThus[0].CongNoChoThus.length; i++) {
                                                    var congNo = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["CongNoChoThu"]();
                                                    congNo.ViTri = i;
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.modelChangeSoLuongMua = function (ev, dsQuayThuocs) {
                    // tslint:disable-next-line: prefer-for-of
                    for (var index = 0; index < this.dataSourcedanhsachThuoc.data.length; index++) {
                        if (this.dataSourcedanhsachThuoc.data[index].CheckedDefault === true) {
                            if (this.dataSourcedanhsachThuoc.data[index].Id === dsQuayThuocs.Id) {
                                this.dataSourcedanhsachThuoc.data[index].SoLuongMua = ev;
                                var soTienMGiam = this.tinhSoTienMiemGiam(this.dataSourcedanhsachThuoc.data[index]);
                                ...
                                if (this.dataSourcedanhsachThuoc.data[index].DanhSachCongNoChoThus != null) {
                                    if (this.dataSourcedanhsachThuoc.data[index].DanhSachCongNoChoThus.length > 0) {
                                        // tslint:disable-next-line: prefer-for-of
                                        for (var i = 0; i < this.dataSourcedanhsachThuoc.data[index].DanhSachCongNoChoThus.length; i++) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.modelChangeSoTienMg = function (ev, data) {
                    data.SoTienMG = ev;
                    this.changeInputSoTienMgBindGrid(data);
                    this.myDanhSachChuaThanhToan();
                };
                QuayThuocHinhThucThanhToanComponent.prototype.changeInputSoTienMgBindGrid = function (data) {
                    var totalCongNo = this.itemTotalCongNo(data.DanhSachCongNoChoThus);
                    // tslint:disable-next-line: prefer-for-of
                    for (var index = 0; index < this.dataSourcedanhsachThuoc.data.length; index++) {
                        if (this.dataSourcedanhsachThuoc.data[index].CheckedDefault === true) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.getThongTinMienGiam = function (id) {
                    var _this = this;
                    this.apiService.get('ThuNgan/GetThongTinMienGiam?yeuCauTiepNhanId=' + id).subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.thongTinMienGiamVos = resultData;
                            _this.bindChiaPhanTramDoiTuongUuDai();
                            if (_this.apDungMienGiam === true) {
                                _this.notificationService.showSuccess('Áp dụng miễn giảm thành công.');
                            }
                            _this.afterChangedMg.emit();
                        }
                    });
                    this.cdRef.detectChanges();
                };
                QuayThuocHinhThucThanhToanComponent.prototype.modelChangeCongNo = function (ev, data, vtri) {
                    data.DanhSachCongNoChoThus[vtri].SoTienCongNoChoThu = ev;
                    data.SoTienMG = 0;
                    this.changeInputCongNoBindGrid(data);
                    this.myDanhSachChuaThanhToan();
                };
                QuayThuocHinhThucThanhToanComponent.prototype.changeInputCongNoBindGrid = function (data) {
                    var totalCongNo = this.itemTotalCongNo(data.DanhSachCongNoChoThus);
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.modelChangePos = function (ev, type) {
                    var total = (this.thongtinDonThuoc.TienMat + this.thongtinDonThuoc.ChuyenKhoan + this.thongtinDonThuoc.SoTienCongNo) === 0 ?
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.modelChangeChuyenKhoan = function (ev, type) {
                    var total = (this.thongtinDonThuoc.TienMat + this.thongtinDonThuoc.POS + this.thongtinDonThuoc.SoTienCongNo) !== 0 ?
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.modelChangeTienMat = function (ev, type) {
                    var total = (this.thongtinDonThuoc.ChuyenKhoan + this.thongtinDonThuoc.POS + this.thongtinDonThuoc.SoTienCongNo) === 0 ?
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.modelChangeSoTienCongNo = function (ev, type) {
                    var total = (this.thongtinDonThuoc.ChuyenKhoan + this.thongtinDonThuoc.POS + this.thongtinDonThuoc.TienMat) === 0 ?
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.modelChangeTienBNDua = function (input) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.onChangeBenhNhanDua = function () {
                    this.thongtinDonThuoc.TienTraLai = this.thongtinDonThuoc.BenhNhanDua - this.thongtinDonThuoc.TienMat;
                    if (this.thongtinDonThuoc.TienTraLai < 0) {
                        this.thongtinDonThuoc.TienTraLai = 0;
                    }
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.defeautSoTien = function () {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.tinhTienChoPhuongThucThanhToan = function (item) {
                    switch (item) {
                        case 1:
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.ChangeHinhThucThanhToan = function (event) {
                    var _this = this;
                    this.clearHinhThucThanhToan();
                    this.defeautSoTien();
                    this.showCanhBaoSoTienNhap = false;
                    ...
                    event.forEach(function (element) {
                        switch (element) {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                _this.flagCheckSeletedSoTienCongNo = true;
                                break;
                        }
                    });
                            ...
                            if (event.length == 1) {
                                switch (item.KeyId) {
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        _this.thongtinDonThuoc.ChuyenKhoan = _this.tongTien;
                                        break;
                                    case 3:
                                        _this.thongtinDonThuoc.POS = _this.tongTien;
                                        break;
                                    case 4:
                                        _this.thongtinDonThuoc.SoTienCongNo = _this.tongTien;
                                        break;
                                }
                            }
                        }
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.onValueChange = function (event, type) {
                    if (this.thongtinDonThuoc.TienTraLai < 0) {
                        this.thongtinDonThuoc.TienTraLai = 0;
                    }
                    this.hinhThucThanhToan.forEach(function (item) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.changeSoTien = function (items) {
                    switch (items) {
                        case 1:
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.changeTienTraLaiBenhNhan = function () {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.onKeyEnterAddItem = function (event) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter" && !this.isSelectingItem) {
                        if (this.isSelectingItem != true) {
                            this.themThuoc();
                        }
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.apDungMiemGiamThem = function () {
                    var _this = this;
                    var dataMGT = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["ApDungMiemGiamThem"];
                    ...
                    this.confrim = this.dialog.open(_ap_dung_miem_giam_them_popup_ap_dung_miem_giam_them_popup_component__WEBPACK_IMPORTED_MODULE_15__["ApDungMiemGiamThemPopupComponent"], {
                        ...
                        if (result != null) {
                            ...
                            //     }
                            // });
                            _this.dataSourcedanhsachThuoc.data.forEach(function (element) {
                                element.GhiChuMienGiamThem = result.GhiChu;
                                element.DanhSachMienGiamVos = new Array();
                                if (result.TiLe != undefined && result.TiLe != null) {
                                    var dsMiemGiamThem = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["DanhSachMienGiamVo"]();
                            ...
                            _this.dataSourcedanhsachThuoc.data.forEach(function (element) {
                                ...
                                if (element.SoTienMG > element.BNConPhaiThanhToan) {
                                    _this.notificationService.showSuccess('Số tiền áp dụng lớn hơn số tiền cần thanh toán.');
                                }
                                // số tiền người bệnh phải trả đã trừ số tiền miễn giảm
                                var soTienCN = _this.soTienCongNoChoTungDichVu(element);
                                if (element.BNConPhaiThanhToan >= element.SoTienMG) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.tinhSoTienMiemGiam = function (dataItem) {
                    var tongTatCaSoTienMg = 0;
                    var tiLePhanTramConLai = 100;
                    var tongTienTungDichVu = ((dataItem.DonGia * dataItem.SoLuongMua)) - this.soTienCongNoChoTungDichVu(dataItem);
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.soTienCongNoChoTungDichVu = function (dataItem) {
                    var soTienCongNo = 0;
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.apDungMiemGiamChoTungDichVu = function (dataItem) {
                    var _this = this;
                    ...
                    this.confrim = this.dialog.open(_ap_dung_miem_giam_cho_tung_loai_thuoc_popup_ap_dung_miem_giam_cho_tung_loai_thuoc_popup_component__WEBPACK_IMPORTED_MODULE_16__["ApDungMiemGiamChoTungLoaiThuocPopupComponent"], {
                        ...
                        if (result != null) {
                            ...
                            if (result.apdungMGTThanhCong) {
                                ...
                                console.log("data", _this.dataSourcedanhsachThuoc.data);
                                _this.notificationService.showSuccess("Áp dụng miễn giảm thành công.");
                            }
                            else {
                                _this.dataSourcedanhsachThuoc.data.forEach(function (element) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.modelChangeSoTienMG = function (data) {
                    this.changeInputSoTienMGBindGrid(data);
                    this.myDanhSachChuaThanhToan();
                };
                QuayThuocHinhThucThanhToanComponent.prototype.changeInputSoTienMGBindGrid = function (dsChiPhiKhamChuaBenh) {
                    for (var index = 0; index < this.dataSourcedanhsachThuoc.data.length; index++) {
                        var totalCongNo = this.itemTotalCongNo(dsChiPhiKhamChuaBenh.DanhSachCongNoChoThus);
                        if (this.dataSourcedanhsachThuoc.data[index].CheckedDefault === true) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.nguoiBenhKhongMuaThuoc = function () {
                    var _this = this;
                    debugger;
                    var self = this;
                    var yeuCauTiepNhanId = this.route.snapshot.params.id;
                    if (this.dataSourcedanhsachThuoc.data.length > 0) {
                        ...
                        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Delete)) {
                            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                                ...
                                if (result == "Yes") {
                                    self.apiService.post("QuayThuoc/NguoiBenhKhongMuaDonThuoc", nguoiDungKhongMuaDonThuoc).subscribe(function () {
                                        ...
                                        _this.router.navigate(['nha-thuoc']);
                                    }, function (err) {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.showPopupLoadingIn = function () {
                ...
                QuayThuocHinhThucThanhToanComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return QuayThuocHinhThucThanhToanComponent;
            }());
            QuayThuocHinhThucThanhToanComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocKhachVangLaiChoThanhToanComponent = /** @class */ (function () {
                function QuayThuocKhachVangLaiChoThanhToanComponent(apiService, notificationService, dialog, snackBar, cdRef, router) {
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.dialog = dialog;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.ngOnInit = function () {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.onSelectDuocPham = function (event) {
                    var _this = this;
                    if (event !== undefined) {
                        this.apiService.post('QuayThuoc/GetThongTinDuocPham?duocPhamId=' + event.KeyId + "&LoaiDuocPhamHoacVatTu=" + event.LoaiDuocPhamHoacVatTu).subscribe(function (resultData) {
                            debugger;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.delete = function (event) {
                    var _this = this;
                    if (event != undefined && event != null) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                            disableClose: false,
                            ...
                            if (res == "Yes") {
                                ...
                                for (var index = 0; index < _this.dataSourcedanhsachThuoc.data.length; index++) {
                                    if (_this.dataSourcedanhsachThuoc.data[index].STT == event.STT) {
                                        i = index;
                                        _this.soLuongTonTrongKho = _this.dataSourcedanhsachThuoc.data[index].SoLuongTon;
                                    }
                                }
                                _this.dataSourcedanhsachThuoc.data[i].SoLuongDung = null;
                                _this.dataSourcedanhsachThuoc.data[i].HighLightClass = null;
                                _this.deleteItem.push(_this.dataSourcedanhsachThuoc.data[i]);
                                _this.lstthongTinDonThuoc = new Array();
                                _this.lstthongTinDonThuoc.push(_this.dataSourcedanhsachThuoc.data[i]);
                                _this.dataSourcedanhsachThuoc.data.splice(i, 1);
                                var soLuongTon_1 = 0;
                                var tenDuocPhamText_1 = "";
                                var duocPhamId_1 = 0;
                                if (_this.deleteItem.length > 0) {
                                    _this.deleteItem.forEach(function (x) {
                                        soLuongTon_1 = soLuongTon_1 + x.SoLuongMua;
                                        tenDuocPhamText_1 = x.TenDuocPham;
                                        duocPhamId_1 = x.DuocPhamId;
                                    });
                                }
                                _this.thongtinDonThuoc.BenhNhanDua = 0;
                                _this.thongtinDonThuoc.TienTraLai = null;
                                _this.lstDonThuocMoiThem = new Array();
                                for (var index0 = 0; index0 < i; index0++) {
                                    _this.lstDonThuocMoiThem.push(_this.dataSourcedanhsachThuoc.data[index0]);
                                }
                                ...
                                _this.tongTien = Math.round(_this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0) + 0.0000001);
                                _this.tongTienHienThi = _this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                                // if (this.thongtinDonThuoc.HinhThucThanhToan.indexOf(1) >= 0) {
                                //     this.thongtinDonThuoc.TienMat = this.tongTien;
                                // }
                                var items = _this.hinhThucThanhToan.filter(function (item) { return item.Selected == true; });
                                ...
                                if (_this.themDuocPham.DuocPhamId == duocPhamId_1) {
                                    _this.apiService.post("QuayThuoc/GetThongTinDuocPham?duocPhamId=" + event.DuocPhamId).subscribe(function (resultData) {
                                        var soLuongTon = 0;
                                        if (_this.dataSourcedanhsachThuoc.data.length != 0) {
                                            _this.dataSourcedanhsachThuoc.data.forEach(function (x) {
                                ...
                                _this.notificationService.showSuccess("Xóa thành công");
                                _this.danhSachXemTruocBangKeThuocVaVatTu(_this.dataSourcedanhsachThuoc.data);
                            }
                        });
                    }
                    ;
                };
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.onChangeTienThoi = function () {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.setLastItemDelete = function () {
                    if (this.arrayThanhToanstmp.length > 1 && this.arrayThanhToanstmp[this.arrayThanhToanstmp.length - 2].length > this.arrayThanhToans.length) {
                        ...
                        var valRemove = truoc.filter(function (arr1Item) { return !sau.includes(arr1Item); });
                        var val = 0;
                        if (valRemove == 3) {
                        ...
                        var lastKeCuoi = this.arrayThanhToanstmp[this.arrayThanhToanstmp.length - 1];
                        var kiemTraCuoiCongNoKhong = lastKeCuoi[lastKeCuoi.length - 1];
                        if (kiemTraCuoiCongNoKhong === 4) {
                            var kpCongNo = lastKeCuoi[lastKeCuoi.length - 2];
                            if (kpCongNo == 2) {
                            ...
                            var kpCongNo = lastKeCuoi[lastKeCuoi.length - 1];
                            if (kpCongNo == 2) {
                                this.thongtinDonThuoc.ChuyenKhoan += val;
                            }
                            if (kpCongNo == 3) {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.clearHinhThucThanhToan = function () {
                    this.flagCheckSeletedTienMat = false;
                    this.flagCheckSeletedChuyenKhoan = false;
                    this.flagCheckSeletedPos = false;
                    this.checkSeletedTienMat = false;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.setLastItem = function () {
                    this.arrayThanhToans.sort();
                    var lastItem = this.arrayThanhToans[this.arrayThanhToans.length - 1];
                    if (lastItem == 1) {
                        this.checkSeletedTienMat = true;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.setLastItemBangTien = function (input) {
                    this.arrayThanhToans.sort();
                    var lastItem = this.arrayThanhToans[this.arrayThanhToans.length - 1];
                    if (lastItem == 1) {
                        this.checkSeletedTienMat = true;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.changeSoTien = function (items) {
                    switch (items) {
                        case 1:
                            this.thongtinDonThuoc.TienMat = (this.tongTien - this.thongtinDonThuoc.ChuyenKhoan - this.thongtinDonThuoc.POS - this.thongtinDonThuoc.SoTienCongNo) < 0 ? 0 :
                                this.tongTien - this.thongtinDonThuoc.ChuyenKhoan - this.thongtinDonThuoc.POS - this.thongtinDonThuoc.SoTienCongNo;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.onValueChange = function (event, type) {
                    if (this.thongtinDonThuoc.TienTraLai < 0) {
                        this.thongtinDonThuoc.TienTraLai = 0;
                    }
                    this.hinhThucThanhToan.forEach(function (item) {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.changeTienTraLaiBenhNhan = function () {
                    if (this.thongtinDonThuoc.BenhNhanDua > this.thongtinDonThuoc.TienMat) {
                        this.thongtinDonThuoc.TienTraLai =
                            this.thongtinDonThuoc.BenhNhanDua - this.thongtinDonThuoc.TienMat;
                    }
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.modelChangePos = function (ev, type) {
                    var total = (this.thongtinDonThuoc.TienMat + this.thongtinDonThuoc.ChuyenKhoan + this.thongtinDonThuoc.SoTienCongNo) === 0 ?
                        this.tongTien : this.tongTien - (this.thongtinDonThuoc.TienMat + this.thongtinDonThuoc.ChuyenKhoan + this.thongtinDonThuoc.SoTienCongNo);
                    this.selectMoneyTienPos = [total, 0];
                    this.thongtinDonThuoc.POS = ev;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.modelChangeChuyenKhoan = function (ev, type) {
                    var total = (this.thongtinDonThuoc.TienMat + this.thongtinDonThuoc.POS + this.thongtinDonThuoc.SoTienCongNo) !== 0 ?
                        this.tongTien : this.tongTien - (this.thongtinDonThuoc.TienMat + this.thongtinDonThuoc.POS + this.thongtinDonThuoc.SoTienCongNo);
                    this.selectMoneyTienChuyenKhoan = [total, 0];
                    this.thongtinDonThuoc.ChuyenKhoan = ev;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.modelChangeTienMat = function (ev, type) {
                    var total = (this.thongtinDonThuoc.ChuyenKhoan + this.thongtinDonThuoc.POS + this.thongtinDonThuoc.SoTienCongNo) === 0 ?
                        this.tongTien : this.tongTien - (this.thongtinDonThuoc.ChuyenKhoan + this.thongtinDonThuoc.POS + this.thongtinDonThuoc.SoTienCongNo);
                    this.selectMoneyTienMat = [total, 0];
                    this.thongtinDonThuoc.TienTraLai = this.thongtinDonThuoc.BenhNhanDua - this.thongtinDonThuoc.TienMat;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.modelChangeSoTienCongNo = function (ev, type) {
                    var total = (this.thongtinDonThuoc.ChuyenKhoan + this.thongtinDonThuoc.POS + this.thongtinDonThuoc.TienMat) === 0 ?
                        this.tongTien : this.tongTien - (this.thongtinDonThuoc.ChuyenKhoan + this.thongtinDonThuoc.POS + this.thongtinDonThuoc.TienMat);
                    this.selectMoneySoTienCongNo = [total, 0];
                    this.thongtinDonThuoc.SoTienCongNo = ev;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.modelChangeTienBNDua = function (input) {
                    this.selectMoneyTienBNDua = [this.tongTien, 100000000];
                    this.thongtinDonThuoc.TienTraLai = input - this.thongtinDonThuoc.TienMat;
                    if (this.thongtinDonThuoc.TienTraLai < 0) {
                        this.thongtinDonThuoc.TienTraLai = 0;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.onChangeBenhNhanDua = function () {
                    this.thongtinDonThuoc.TienTraLai = this.thongtinDonThuoc.BenhNhanDua - this.thongtinDonThuoc.TienMat;
                    if (this.thongtinDonThuoc.TienTraLai < 0) {
                        this.thongtinDonThuoc.TienTraLai = 0;
                    }
                };
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.XacNhanIn = function (data) {
                    var _this = this;
                    this.showPopupLoadingIn();
                    data.Hosting = window.location.protocol + '//' + window.location.host;
                    this.apiService.postExportExcel('QuayThuoc/XacNhanIn', data).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            if (data.InBangKe == false && data.InPhieuThu == false) {
                                _this.notificationService.showError('Không có phiếu in được chọn.');
                                _this.closePopupLoadingData();
                                ...
                                _this.dialog.open(_thong_tin_phieu_pdf_popup_thong_tin_phieu_pdf_popup_component__WEBPACK_IMPORTED_MODULE_13__["ThongTinPhieuPdfPopupComponent"], {
                                    disableClose: true,
                                    width: '1000px',
                                    data: { Model: resultData }
                                }).afterClosed().subscribe(function () {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.shareData = function () {
                    this.thongtinDonThuoc.DanhSachDonThuocs = this.dataSourcedanhsachThuoc.data.slice();
                    for (var index = 0; index < this.thongtinDonThuoc.DanhSachDonThuocs.length; index++) {
                        this.thongtinDonThuoc.DanhSachDonThuocs[index].HighLightClass = null;
                        if (this.thongtinDonThuoc.DanhSachDonThuocs[index].CheckedDefault == false) {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.ThuTienVaXuatThuoc = function () {
                    var _this = this;
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                    ...
                    var index = this.dataSourcedanhsachThuoc.data.findIndex(function (x) { return x.LoaiDonThuoc == 1; });
                    if (index != -1) {
                        this.notificationService.showError("Đang có thuốc bảo hiểm trong đơn thuốc.");
                        return;
                    }
                    var indexHetThuoc = this.dataSourcedanhsachThuoc.data.findIndex(function (x) { return x.ThuocTrongKhoExit == true; });
                    if (indexHetThuoc != -1) {
                    ...
                    if (this.donThuocId.maBN != null) {
                        ...
                        function (resultData) {
                            _this.thongTinKhachVangLai.Id = resultData.Id;
                            _this.thongTinKhachVangLai.HoTen = resultData.HoTen;
                            _this.thongTinKhachVangLai.GioiTinh = resultData.GioiTinh;
                            _this.thongTinKhachVangLai.DiaChi = resultData.DiaChi;
                            _this.thongTinKhachVangLai.DiaChiDayDu = resultData.DiaChiDayDu;
                            _this.thongTinKhachVangLai.NamSinh = resultData.NamSinh;
                            _this.thongTinKhachVangLai.PhuongXaId = resultData.PhuongXaId;
                            _this.thongTinKhachVangLai.QuanHuyenId = resultData.QuanHuyenId;
                            _this.thongTinKhachVangLai.SoDienThoai = resultData.SoDienThoai;
                            _this.thongTinKhachVangLai.TinhThanhId = resultData.TinhThanhId;
                            _this.thongTinKhachVangLai.Email = resultData.Email;
                        });
                        this.apiService.post("QuayThuoc/GetTenBenhNhan?benhNhanId=" + this.maBN).subscribe(// to do maBn => benhNhanId
                        // to do maBn => benhNhanId
                        function (// to do maBn => benhNhanId
                        resultData) {
                            _this.tenBN = resultData;
                            validationCheck.HoTen = _this.tenBN;
                            validationCheck.NamSinh = _this.thongTinKhachVangLai.NamSinh;
                            _this.thongtinDonThuoc.HoTenBenhNhan = _this.tenBN;
                            _this.thongTinKhachVangLai.HoTen = _this.tenBN;
                            _this.apiService.post("QuayThuoc/CheckValidationForQuayThuocKhachVangLai", validationCheck).subscribe(function () {
                                var khachVangLaiChoThanhToan = {
                                    ThongTinKhach: _this.thongTinKhachVangLai,
                                    ThongTinThuChi: _this.thongtinDonThuoc,
                                    DanhSachDonThuoc: _this.lstDonThuocMoiThem
                                };
                                var chuInHoa = _this.thongTinKhachVangLai.HoTen.toUpperCase();
                                _this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                                    //disableClose: true,
                                    width: '1000px',
                                    data: {
                                        Title: 'Xác nhận', Message: 'Bạn chắc chắn muốn thu của người bệnh ' +
                                    ...
                                    if (result == 'Yes') {
                                        _this.apiService.post("QuayThuoc/ThuTienKhachVangLaiVaXuatThuoc", khachVangLaiChoThanhToan).subscribe(function (resultData) {
                                            ...
                                            if (resultData.ThanhCong == false) {
                                                ...
                                                for (var i = 0; i < resultData.DanhSachDuocPhamVuotTonKho.length; i++) {
                                                    for (var j = 0; j < _this.dataSourcedanhsachThuoc.data.length; j++) {
                                                        if (resultData.DanhSachDuocPhamVuotTonKho[i].Stt == _this.dataSourcedanhsachThuoc.data[j].STT) {
                                                            _this.dataSourcedanhsachThuoc.data[j].HighLightClass = 'bg-row-lightpink';
                                                            _this.dataSourcedanhsachThuoc.data[j].SoLuongDung = resultData.DanhSachDuocPhamVuotTonKho[i].SoLuongTonKho;
                                                        }
                                                    }
                                                }
                                            }
                                                ...
                                                _this.dataSourcedanhsachThuoc.data = [];
                                                if (_this.gridDanhSachMuaThuoc !== undefined) {
                                                    _this.gridDanhSachMuaThuoc.setDataSource();
                                                }
                                                _this.tongTien = Math.round(_this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0) + 0.0000001);
                                                _this.tongTienHienThi = _this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                                                if (_this.thongtinDonThuoc.HinhThucThanhToan.indexOf(1) >= 0) {
                                                    _this.thongtinDonThuoc.TienMat = _this.tongTien;
                                                }
                                                _this.benhNhanResultData = resultData;
                                                _this.apiService.post("QuayThuoc/GetBenhNhanForNavigation?taiKhoanThuId=" + resultData.TaiKhoanBenhNhanThuId).subscribe(function (result1) {
                                                    var dialogRef = _this.dialog.open(_quay_thuoc_xac_nhan_in_pop_up_quay_thuoc_xac_nhan_in_pop_up_component__WEBPACK_IMPORTED_MODULE_8__["QuayThuocXacNhanInPopUpComponent"], {
                                                        disableClose: true,
                                                        width: '500px',
                                                        data: { Model: _this.benhNhanResultData, Title: "XÁC NHẬN" }
                                                    }).afterClosed().subscribe(function (result) {
                                                        if (result.Response != "No answer") {
                                                            _this.changeTab.emit(2);
                                                            _this.MaTiepNhanBenhNhanDaThuTien.emit(result1);
                                                            _this.XacNhanIn(result);
                                                        }
                                                        else {
                                                            _this.changeTab.emit(2);
                                ...
                                if (_this.validationErrors.length !== 0) {
                                    for (var i = 0; i < _this.validationErrors.length; i++) {
                                        if (_this.validationErrors[i].Field === "HoTen") {
                                            _this.validationErrorsThongTin.push(_this.validationErrors[i]);
                                        }
                                        if (_this.validationErrors[i].Field === "NamSinh") {
                                            _this.validationErrorsThongTin.push(_this.validationErrors[i]);
                                        }
                                    }
                                }
                                _this.valueChangeThuTien.emit(_this.validationErrorsThongTin);
                                return;
                            });
                        }, function () { });
                    }
                    else {
                        this.apiService.post("QuayThuoc/CheckValidationForQuayThuocKhachVangLai", validationCheck).subscribe(function () {
                            var khachVangLaiChoThanhToan = {
                                ThongTinKhach: _this.thongTinKhachVangLai,
                                ThongTinThuChi: _this.thongtinDonThuoc,
                                DanhSachDonThuoc: _this.lstDonThuocMoiThem
                            ...
                            _this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                                width: '1000px',
                                data: { Title: "Xác nhận", Message: "Bạn chắc chắn muốn thu của người bệnh " + chuInHoa.bold() + " với số tiền là " + _this.tongTien.toLocaleString("vi-VI").bold() + " đồng hay không?" }
                            }).afterClosed().subscribe(function (result) {
                                if (result == 'Yes') {
                                    _this.apiService.post("QuayThuoc/ThuTienKhachVangLaiVaXuatThuoc", khachVangLaiChoThanhToan).subscribe(function (resultData) {
                                        khachVangLaiChoThanhToan.DanhSachDonThuoc = [];
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.ThuTien = function () {
                    var _this = this;
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                    if (this.dataSourcedanhsachThuoc.data === [] || this.dataSourcedanhsachThuoc.data.length == 0) {
                        ...
                        resultData) {
                            ...
                            _this.apiService.post("QuayThuoc/CheckValidationForQuayThuocKhachVangLai", validationCheck).subscribe(function () {
                                ...
                                _this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                                    ...
                                    if (result == 'Yes') {
                                        _this.apiService.post("QuayThuoc/ThuTienKhachVangLai", khachVangLaiChoThanhToan).subscribe(function (resultData) {
                                            khachVangLaiChoThanhToan.DanhSachDonThuoc = [];
                                            _this.lstDonThuocMoiThem = [];
                                            if (resultData.ThanhCong == false) {
                                                _this.notificationService.showError(resultData.Error);
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.showError = function (message) {
                    this.showIt(message);
                };
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.showIt = function (message) {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.them1 = function () {
                    var _this = this;
                    ...
                    if (this.themDuocPham.SoLuongTon >= this.themDuocPham.SoLuong) {
                        ...
                        for (var index = 0; index < tamp.length; index++) {
                            if (tamp[index].SoLuongTon > 0) {
                                if (count != 0) {
                                    var item = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_3__["ThongTinDuocPham"]();
                                    if (count <= this.lstthongTinDonThuoc[index].SoLuongTon) {
                                        item = Object.assign({}, this.lstthongTinDonThuoc[index]);
                                        item.SoLuongMua = count;
                                        item.STT = stt;
                        ...
                        this.themDuocPham.SoLuongTon = this.themDuocPham.SoLuongTon - this.themDuocPham.SoLuong;
                        this.tongTien = Math.round(this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0) + 0.0000001);
                        this.tongTienHienThi = this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.danhSachXemTruocBangKeThuocVaVatTu = function (danhSachChuaThanhToans) {
                    // lý do trả về danhSachChuaThanhToan cho quay-thuoc-mua-thuoc.component
                    // để xem trước bảng kê
                    this.danhSachChuaThanhToan.emit(danhSachChuaThanhToans);
                };
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.getDonThuocChiTietCu = function () {
                    var _this = this;
                    var toaThuocCuId = [];
                    if (typeof (this.donThuocId.ToaThuoc) == 'string') {
                        ...
                        this.donThuocId.ToaThuoc.forEach(function (element) {
                            toaThuocCuId.push(element);
                        });
                    }
                    this.apiService.post("QuayThuoc/GetDonthuocChiTietCu", { ToaThuoc: toaThuocCuId }).subscribe(function (resultData) {
                        _this.validationThuocErrors = [];
                        var soLuongDaMua = 0;
                        if (_this.lstDonThuocMoiThem.length > 0) {
                            _this.lstDonThuocMoiThem.forEach(function (x) {
                                if (x.DuocPhamId == _this.themDuocPham.DuocPhamId) {
                        ...
                        if (_this.themDuocPham.SoLuongTon >= _this.themDuocPham.SoLuong) {
                            var stt = 1;
                            var idNew = 1;
                            if (_this.dataSourcedanhsachThuoc.data.length > 0) {
                                stt = _this.dataSourcedanhsachThuoc.data[_this.dataSourcedanhsachThuoc.data.length - 1].STT + 1;
                                idNew = _this.dataSourcedanhsachThuoc.data[_this.dataSourcedanhsachThuoc.data.length - 1].Id + 1;
                            }
                            for (var index = 0; index < resultData.length; index++) {
                                var count = _this.themDuocPham.SoLuong;
                                if (count != 0) {
                                    var item = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_3__["ThongTinDuocPham"]();
                                    if (count <= resultData[index].SoLuongTon) {
                                        ...
                                        item.BacSiKeToa = "Nhà Thuốc";
                                        item.ThanhTien = item.SoLuongMua * item.DonGia;
                                        _this.lstDonThuocMoiThem.push(item);
                                        resultData[index].SoLuongTon = resultData[index].SoLuongTon - count;
                                        _this.dataSourcedanhsachThuoc.data.push(item);
                                        count = 0;
                                    }
                                    else {
                                        item = Object.assign({}, _this.lstthongTinDonThuoc[index]);
                                    ...
                                    _this.gridDanhSachMuaThuoc.setSelectCheckbox(idNew);
                                    idNew++;
                                    stt++;
                                }
                                else {
                            ...
                            _this.themDuocPham.SoLuongTon = _this.themDuocPham.SoLuongTon - _this.themDuocPham.SoLuong;
                            _this.tongTien = Math.round(_this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0) + 0.0000001);
                            _this.tongTienHienThi = _this.dataSourcedanhsachThuoc.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                            if (_this.thongtinDonThuoc.HinhThucThanhToan.length == 1 && _this.thongtinDonThuoc.HinhThucThanhToan[0] == 1) {
                                _this.thongtinDonThuoc.TienMat = _this.tongTien;
                            }
                            _this.themDuocPham = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_3__["ThemDuocPham"]();
                        }
                        else {
                            _this.notificationService.showError("Số lượng bạn nhập lớn hơn số lượng tồn");
                        }
                        // });
                    }, function () { });
                };
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.reset = function () {
                    this.thongtinDonThuoc.HinhThucThanhToan = [1];
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.onKeyEnterAddItem = function (event) {
                    if (event.key == "Enter" && !this.isSelectingItem) {
                        if (this.isSelectingItem != true) {
                            this.them1();
                        }
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.openCombobox = function (event) {
                    if (event) {
                        this.isSelectingItem = true;
                    }
                    else {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter" && !this.isSelectingItem) {
                        if (this.isSelectingItem != true) {
                            this.them1();
                        }
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.modelChangeSoLuongMua = function (ev, dsQuayThuocs) {
                    // tslint:disable-next-line: prefer-for-of
                    for (var index = 0; index < this.dataSourcedanhsachThuoc.data.length; index++) {
                        if (this.dataSourcedanhsachThuoc.data[index].CheckedDefault === true) {
                            if (this.dataSourcedanhsachThuoc.data[index].Id === dsQuayThuocs.Id) {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.bindHinhThucThanhToanChangeGrid = function (item) {
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                    this.clearHinhThucThanhToan();
                    this.defeautSoTien();
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.defeautSoTien = function () {
                    this.thongtinDonThuoc.TienMat = 0;
                    this.thongtinDonThuoc.POS = 0;
                    this.thongtinDonThuoc.SoTienCongNo = 0;
                    this.thongtinDonThuoc.ChuyenKhoan = 0;
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.tinhTienChoPhuongThucThanhToan = function (item) {
                    switch (item) {
                        case 1:
                            this.thongtinDonThuoc.TienMat = this.tongTien - this.thongtinDonThuoc.ChuyenKhoan - this.thongtinDonThuoc.POS - this.thongtinDonThuoc.SoTienCongNo;
                            if (this.thongtinDonThuoc.TienMat < 0) {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.ChangeHinhThucThanhToan = function (event) {
                    var _this = this;
                    this.validationErrors = [];
                    this.cdRef.detectChanges();
                    this.clearHinhThucThanhToan();
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.showPopupLoadingIn = function () {
                ...
                QuayThuocKhachVangLaiChoThanhToanComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return QuayThuocKhachVangLaiChoThanhToanComponent;
            }());
            QuayThuocKhachVangLaiChoThanhToanComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocKhachVangLaiChoXuatThuocComponent = /** @class */ (function () {
                function QuayThuocKhachVangLaiChoXuatThuocComponent(route, dialog, apiService, router, notificationService) {
                    this.route = route;
                    this.dialog = dialog;
                    this.apiService = apiService;
                    this.router = router;
                ...
                QuayThuocKhachVangLaiChoXuatThuocComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    if (this.ThongTinBenhNhanDaThuTienData != undefined) {
                        this.apiService.post("QuayThuoc/GetDanhSachXuatThuocKhongBHYT?tiepNhanId=" + this.ThongTinBenhNhanDaThuTienData.YeuCauTiepNhanId).subscribe(function (resultData) {
                            _this.dataSourcedanhsachThuoc.data = resultData;
                        });
                    }
                    else {
                ...
                QuayThuocKhachVangLaiChoXuatThuocComponent.prototype.ngOnChanges = function (event) {
                    this.ngOnInit();
                };
                QuayThuocKhachVangLaiChoXuatThuocComponent.prototype.GuiData = function () {
                    var _this = this;
                        ...
                        if (result == "Yes") {
                            _this.apiService.post("QuayThuoc/XuatDonThuocBHYT", _this.danhSachThuoc).subscribe(function (resultData) {
                                if (resultData != null && resultData != undefined && resultData != "") {
                                    ...
                                    if (_this.ttCheck == 1) {
                                        _this.router.navigate(['nha-thuoc'], { queryParams: { page: _this.ttCheck } });
                                    }
                                    if (_this.ttCheck == 2) {
                                        _this.router.navigate(['nha-thuoc'], { queryParams: { page: _this.ttCheck } });
                                    }
                ...
                return QuayThuocKhachVangLaiChoXuatThuocComponent;
            }());
            QuayThuocKhachVangLaiChoXuatThuocComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var QuayThuocKhachVangLaiThongTinHanhChinhComponent = /** @class */ (function () {
                function QuayThuocKhachVangLaiThongTinHanhChinhComponent(apiService) {
                    this.apiService = apiService;
                    this.thongTinBenhNhan = {};
                    this.valueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                    this.data = {};
                }
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.ngOnInit = function () {
                    var maBN = this.donThuocId.maBN;
                    if (this.MaBN != null) {
                        maBN = this.MaBN;
                    }
                    else {
                ...
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.ngOnChanges = function (event) {
                    this.ngOnInit();
                };
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.GetThongTinBenhNhan = function (maBN) {
                    var _this = this;
                    this.apiService.post("QuayThuoc/GetThongTinBenhNhan1?maBN=" + maBN).subscribe(function (resultData) {
                ...
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.GetThongTinBenhNhanTN = function (maTN) {
                    var _this = this;
                    this.apiService.post("QuayThuoc/GetThongTinBenhNhanTN?maTN=" + maTN).subscribe(function (resultData) {
                        _this.data = resultData;
                        console.log(resultData);
                    }, function () {
                        console.log("Loi roi");
                ...
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.TinhThanhPhoChange = function (tinhThanh) {
                ...
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.QuanHuyenChange = function (quanHuyen) {
                ...
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.PhuongXaChange = function (phuongXa) {
                    var _this = this;
                    this.thongTinBenhNhan.PhuongXaId = phuongXa;
                    if (this.thongTinBenhNhan.PhuongXaId != null) {
                        this.apiService.post("QuayThuoc/GetTinhHuyen?phuongXaId=" + phuongXa).subscribe(function (resultData) {
                            _this.thongTinBenhNhan.QuanHuyenId = resultData[0].HuyenId;
                            _this.thongTinBenhNhan.TinhThanhId = resultData[0].TinhId;
                            _this.thongTinBenhNhan.TenHuyenDisplay = resultData[0].TenHuyen;
                            _this.thongTinBenhNhan.TenTinhDisplay = resultData[0].TenTinh;
                            _this.thongTinBenhNhan.PhuongXaId = phuongXa;
                        }, function () {
                            console.log("Loi roi");
                        });
                    }
                ...
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.onSaveTen = function () {
                    this.valueChange.emit(this.thongTinBenhNhan);
                };
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.onSaveSDT = function (sdt) {
                    this.thongTinBenhNhan.SoDienThoai = sdt;
                    this.valueChange.emit(this.thongTinBenhNhan);
                };
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.onSaveGioiTinh = function (gioiTinh) {
                    this.thongTinBenhNhan.GioiTinh = gioiTinh;
                    this.valueChange.emit(this.thongTinBenhNhan);
                };
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.onSaveNamSinh = function (namSinh) {
                    this.thongTinBenhNhan.NamSinh = namSinh;
                    this.valueChange.emit(this.thongTinBenhNhan);
                };
                QuayThuocKhachVangLaiThongTinHanhChinhComponent.prototype.onSaveDiaChi = function (diaChi) {
                    this.thongTinBenhNhan.DiaChi = diaChi;
                    this.valueChange.emit(this.thongTinBenhNhan);
                };
                return QuayThuocKhachVangLaiThongTinHanhChinhComponent;
            }());
            QuayThuocKhachVangLaiThongTinHanhChinhComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocKhachVangLaiComponent = /** @class */ (function () {
                function QuayThuocKhachVangLaiComponent(route, notificationService, router, dialog, apiService) {
                    this.route = route;
                    this.notificationService = notificationService;
                    this.router = router;
                    this.dialog = dialog;
                ...
                QuayThuocKhachVangLaiComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route
                        .queryParams
                    ...
                    this.route.queryParams.subscribe(function (params) {
                        _this.ttCheck = params.page;
                    });
                    if (this.ttCheck == undefined) {
                        this.route.queryParams.subscribe(function (params) {
                            _this.ttCheck = params.ttCheck;
                        });
                    }
                    this.route.queryParams.subscribe(function (params) {
                        _this.MaBN = params.MaBN;
                    });
                    this.route.queryParams.subscribe(function (params) {
                        _this.TenBenhNhan = params.TenBenhNhan;
                    });
                    this.route.queryParams.subscribe(function (params) {
                        _this.SDT = params.SDT;
                    });
                };
                QuayThuocKhachVangLaiComponent.prototype.onTabSelect = function (event) {
                ...
                QuayThuocKhachVangLaiComponent.prototype.Huy = function () {
                    var _this = this;
                    this.route.queryParams.subscribe(function (v) {
                        if (v.page != null) {
                            _this.ttCheck = v.page;
                        }
                    });
                    this.route.queryParams.subscribe(function (v) {
                        if (v.ttCheck != null) {
                            _this.ttCheck = v.ttCheck;
                        }
                    });
                    if (this.ttCheck == 1) {
                ...
                QuayThuocKhachVangLaiComponent.prototype.switchValueChanges = function (data) {
                    this.thongTinBenhNhan = data;
                };
                QuayThuocKhachVangLaiComponent.prototype.switchValueChangesChoThanhToan = function (data) {
                    this.validationErrorForThongTin = data;
                };
                QuayThuocKhachVangLaiComponent.prototype.changeTab = function (event) {
                    this.trangThai = event;
                };
                QuayThuocKhachVangLaiComponent.prototype.MaTiepNhanBenhNhanDaThuTien = function (event) {
                ...
                QuayThuocKhachVangLaiComponent.prototype.danhSachChuaThanhToan = function (data) {
                    this.xemTruocBangKeThuoc.DanhSachDonThuocs = data;
                };
                QuayThuocKhachVangLaiComponent.prototype.inXemTruocBangKeThuoc = function () {
                    var _this = this;
                    this.showPopupLoadingIn();
                    ...
                    if (this.xemTruocBangKeThuoc.DanhSachDonThuocs === undefined &&
                        ...
                        this.apiService.postExportPdf('QuayThuoc/XemTruocBangKeThuoc', this.xemTruocBangKeThuoc).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.dialog.open(_thong_tin_phieu_pdf_popup_thong_tin_phieu_pdf_popup_component__WEBPACK_IMPORTED_MODULE_8__["ThongTinPhieuPdfPopupComponent"], {
                                    disableClose: true,
                                    width: '1000px',
                                    data: { Model: resultData }
                                }).afterClosed().subscribe(function () {
                ...
                QuayThuocKhachVangLaiComponent.prototype.showPopupLoadingIn = function () {
                ...
                QuayThuocKhachVangLaiComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                QuayThuocKhachVangLaiComponent.prototype.keyEvent = function (event) {
                ...
                return QuayThuocKhachVangLaiComponent;
            }());
            QuayThuocKhachVangLaiComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocListComponent = /** @class */ (function () {
                function QuayThuocListComponent(router, apiService, dialog, route, authService, notificationService) {
                    this.router = router;
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.route = route;
                ...
                QuayThuocListComponent.prototype.ngOnInit = function () {
                    this.gridChildColumnsChoThanhToan = [
                ...
                QuayThuocListComponent.prototype.Xem = function (event) {
                ...
                QuayThuocListComponent.prototype.ngOnChanges = function (event) {
                    if (event.queryStringSearchUuTien != null || event.queryStringSearchUuTien != undefined) {
                        if (event.queryStringSearchUuTien.currentValue != null || event.queryStringSearchUuTien.currentValue != undefined) {
                            if (event.queryStringSearchUuTien.currentValue != null) {
                                ...
                                var kiemTraDieuKienLoad = JSON.parse(event.queryStringSearchUuTien.currentValue);
                ...
                QuayThuocListComponent.prototype.PrinAllDonThuocBenhNhan = function (donThuocThanhToanId, LoaiDonThuoc, YeuCauKhambenhId) {
                    var _this = this;
                    var data = {
                    ...
                    this.apiService.post("QuayThuoc/InThuocBenhNhan", data).subscribe(function (resultData) {
                        var dialogRef = _this.dialog.open(_in_don_thuoc_pop_up_in_don_thuoc_pop_up_component__WEBPACK_IMPORTED_MODULE_9__["InDonThuocPopUpComponent"], {
                            width: '1000px',
                            data: { Model: resultData, InDonThuocDanhSachList: false, InBangKe: true, InPhieuThu: false }
                        }).afterClosed().subscribe(function () { });
                    }, function () { });
                };
                QuayThuocListComponent.prototype.onDataBound = function (data) {
                    this.OnHandleDieuKienLoadXemChiTiet.emit(true);
                    this.OnHandleDataQuayThuocSearchList.emit(data);
                };
                QuayThuocListComponent.prototype.nguoiBenhKhongMuaThuoc = function (dataItem) {
                    var _this = this;
                    var self = this;
                    var yeuCauTiepNhanId = dataItem.Id;
                ...
                return QuayThuocListComponent;
            }());
            QuayThuocListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _thong_tin_phieu_pdf_popup_thong_tin_phieu_pdf_popup_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../thong-tin-phieu-pdf-popup/thong-tin-phieu-pdf-popup.component */ "./src/app/modules/main/quay-thuoc/thong-tin-phieu-pdf-popup/thong-tin-phieu-pdf-popup.component.ts");
            /* harmony import */ var src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/core/services/notification.service */ "./src/app/core/services/notification.service.ts");
            var QuayThuocMuaThuocComponent = /** @class */ (function () {
                function QuayThuocMuaThuocComponent(route, notificationService, dialog, apiService, router, cdRef) {
                    this.route = route;
                    this.notificationService = notificationService;
                    this.dialog = dialog;
                    this.apiService = apiService;
                ...
                QuayThuocMuaThuocComponent.prototype.ngOnInit = function () {
                    var tiepNhanId = this.route.snapshot.params.id;
                    var benhNhanId = this.route.snapshot.params.idsub;
                ...
                QuayThuocMuaThuocComponent.prototype.GetThongTinBenhNhan = function (benhNhanId, tiepNhanId) {
                    var _this = this;
                    this.apiService.post("QuayThuoc/GetThongTinBenhNhan?benhNhanId=" + benhNhanId + "&tiepNhanId=" + tiepNhanId).subscribe(function (resultData) {
                        _this.benhnhanThongTin = resultData;
                    }, function () { });
                };
                QuayThuocMuaThuocComponent.prototype.onTabSelect = function (event) {
                    this.tabIndex = event.index;
                    if (event.index == 1) {
                        this.flagAllowLoadThuoc = false;
                    }
                ...
                QuayThuocMuaThuocComponent.prototype.Huy = function () {
                    if (this.ttcheck == 1) {
                ...
                QuayThuocMuaThuocComponent.prototype.ngAfterViewChecked = function () {
                    this.cdRef.detectChanges();
                };
                QuayThuocMuaThuocComponent.prototype.afterChangedCongNo = function () {
                    this.cdRef.detectChanges();
                    this.apDungCongNoThuoc = false;
                };
                QuayThuocMuaThuocComponent.prototype.afterChangedMienGiam = function () {
                    this.cdRef.detectChanges();
                    this.apDungMienGiam = false;
                };
                QuayThuocMuaThuocComponent.prototype.getBaoHiem = function (data) {
                    this.apDungCongNoThuoc = data.apDungCongNoThuoc;
                    this.thongTinTam = data.thongTinTam;
                    this.viTri = data.viTri;
                };
                QuayThuocMuaThuocComponent.prototype.getMg = function (data) {
                    this.apDungMienGiam = data.apDungMienGiam;
                    this.thongTinMienGiamVos = data.thongTinMienGiam;
                };
                QuayThuocMuaThuocComponent.prototype.danhSachChuaThanhToan = function (data) {
                    var bnThanhToan = 0;
                ...
                QuayThuocMuaThuocComponent.prototype.changeTab = function () {
                    this.tabQuayThuoc.selectTab(1);
                    this.flagAllowLoadThuoc = false;
                };
                QuayThuocMuaThuocComponent.prototype.inXemTruocBangKeThuoc = function () {
                    var _this = this;
                    this.showPopupLoadingIn();
                    this.xemTruocBangKeThuoc.Hosting = window.location.protocol + '//' + window.location.host;
                    this.xemTruocBangKeThuoc.YeuCauTiepNhanId = this.route.snapshot.params.id;
                ...
                QuayThuocMuaThuocComponent.prototype.showPopupLoadingIn = function () {
                ...
                QuayThuocMuaThuocComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                QuayThuocMuaThuocComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 83 && event.ctrlKey) {
                        // ctrl + s
                        if (this.tabIndex == 0) {
                            this.quayThuocHinhThucThanhToan.ThuTien();
                ...
                return QuayThuocMuaThuocComponent;
            }());
            QuayThuocMuaThuocComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_9__["NotificationService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatDialog"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocRoutingModule = /** @class */ (function () {
                function QuayThuocRoutingModule() {
                }
                return QuayThuocRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            /* harmony import */ var src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/services/notification.service */ "./src/app/core/services/notification.service.ts");
            var QuayThuocThongTinBaoHiemTuNhanComponent = /** @class */ (function () {
                function QuayThuocThongTinBaoHiemTuNhanComponent(route, apiService, cdRef, notificationService) {
                    this.route = route;
                    this.apiService = apiService;
                    this.cdRef = cdRef;
                    this.notificationService = notificationService;
                ...
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.ngOnInit = function () {
                ...
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.ngOnChanges = function () {
                    this.tongTienBNThanhToanPrivate = this.tongTienBNThanhToan;
                };
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.getDanhSachBHTN = function () {
                    var _this = this;
                    this.apiService.get("QuayThuoc/GetListCongTyBaoHiemTuNhans?tiepNhanId=" + this.idMYCTN).subscribe(function (resultData) {
                        if (resultData != null && resultData != undefined) {
                            _this.dataSourceDanhSachBHTN.data = resultData;
                            ...
                            _this.CheckThongTinBenhNhan(_this.idMYCTN);
                        }
                    });
                };
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.CheckThongTinBenhNhan = function (tiepNhanId) {
                    var _this = this;
                    this.apiService.post("QuayThuoc/CheckBenhNhanExistBaoHiemTuNhan?yctnId=" + tiepNhanId).subscribe(function (resultData) {
                        if (resultData.length > 0) {
                            _this.checkHaveBHTN = true;
                        }
                        else {
                            _this.checkHaveBHTN = false;
                        }
                        _this.getThongTinMienGiam(tiepNhanId);
                    }, function () { });
                };
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.getThongTinMienGiam = function (id) {
                    var _this = this;
                    this.apiService.get("ThuNgan/GetThongTinMienGiam?yeuCauTiepNhanId=" + id).subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.khachVangLaiMuaThuoc = resultData.KhachVangLaiMuaThuoc;
                            ...
                            if (resultData.ThongTinMienGiamThemVo != null || resultData.ThongTinMienGiamThemVo != undefined) {
                                ...
                                if (_this.thongTinMienGiamThem.SoTienMG != 0) {
                                    ...
                                    _this.soTienMgCheck = true;
                                    _this.tiLeMgCheck = false;
                                }
                                if (_this.thongTinMienGiamThem.TiLeMienGiam != 0) {
                                    _this.disabledTiLeMG = false;
                                    _this.soTienMgCheck = false;
                                    _this.tiLeMgCheck = true;
                                }
                                if (_this.thongTinMienGiamThem.TaiLieuDinhKemGiayMiemGiam.Ten != null) {
                ...
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.uploadFileDone = function (tapTin) {
                    this.thongTinMienGiamThem.TaiLieuDinhKemGiayMiemGiam = tapTin;
                    this.cdRef.detectChanges();
                };
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.onApplyMGThem = function () {
                    var _this = this;
                    ...
                    this.apiService.post("ThuNgan/ThemThongTinMiemGiamThemVaVoucher", thongTinMGThem)
                        ...
                        if (resultData) {
                            _this.getThongTinMienGiam(_this.idMYCTN);
                        }
                        _this.apDungMienGiam = true;
                        var mienGiamObj = {
                            apDungMienGiam: _this.apDungMienGiam,
                            thongTinMienGiam: _this.thongTinMienGiamVo
                        };
                        _this.valueChangeMg.emit(mienGiamObj);
                    }, function (err) {
                        _this.quayThuocValidationErrors = err.ValidationErrors;
                        _this.disabledSoTienMG = true;
                        _this.thongTinMienGiamThem = {
                            LoaiMienGiamThem: loaiMGThem,
                            LyDoMiemGiam: _this.thongTinMienGiamThem.LyDoMiemGiam,
                            SoTienMG: _this.thongTinMienGiamThem.SoTienMG,
                            TiLeMienGiam: _this.thongTinMienGiamThem.TiLeMienGiam,
                            SoTienMGConLai: _this.thongTinMienGiamThem.SoTienMGConLai,
                            TaiLieuDinhKemGiayMiemGiam: _this.thongTinMienGiamThem.TaiLieuDinhKemGiayMiemGiam,
                        };
                    });
                };
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.onChangeLoaiMg = function (value) {
                    if (value === 1) {
                        this.soTienMgCheck = true;
                        this.tiLeMgCheck = false;
                ...
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.onKeyCongNo = function (event, indexRow) {
                    if (event.key == "Enter") {
                        this.ApDungCongNo(indexRow);
                    }
                };
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.ApDungCongNo = function (indexRow) {
                ...
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.onChangeVoucher = function (data) {
                    if (data === false) {
                        this.flagEnableVoucher = false;
                        ...
                        if (lengthQuayThuocValidators != 0) {
                            for (var i = 0; i < lengthQuayThuocValidators; i++) {
                ...
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.onChangeMienGiam = function (data) {
                    if (data === false) {
                        this.flagEnableMGThem = false;
                ...
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.onOpenChange = function () {
                    this.voucherList.getDataForLookup();
                };
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.onSelectChangeVoucher = function (voucherId) {
                    var _this = this;
                ...
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.valueChangeTheVoucher = function (value) {
                    var _this = this;
                    var voucherId = [];
                ...
                QuayThuocThongTinBaoHiemTuNhanComponent.prototype.differenceOf2Arrays = function (arr1, arr2) {
                    var temp = [];
                ...
                return QuayThuocThongTinBaoHiemTuNhanComponent;
            }());
            QuayThuocThongTinBaoHiemTuNhanComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
                { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_5__["NotificationService"] }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            /* harmony import */ var _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../quay-thuoc.model */ "./src/app/modules/main/quay-thuoc/quay-thuoc.model.ts");
            var QuayThuocThongTinHanhChinhComponent = /** @class */ (function () {
                function QuayThuocThongTinHanhChinhComponent(route, apiService) {
                    this.route = route;
                    this.apiService = apiService;
                    this.data = {};
                }
                QuayThuocThongTinHanhChinhComponent.prototype.ngOnInit = function () {
                    var id = this.route.snapshot.params.idsub;
                    if (this.benhnhanThongTin == null) {
                ...
                QuayThuocThongTinHanhChinhComponent.prototype.GetThongTinBenhNhan = function (id) {
                    var _this = this;
                    this.apiService.post("QuayThuoc/GetThongTinBenhNhan1?maBN=" + id).subscribe(function (resultData) {
                        _this.data = resultData;
                    }, function () { });
                };
                return QuayThuocThongTinHanhChinhComponent;
            }());
            QuayThuocThongTinHanhChinhComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _in_don_thuoc_pop_up_in_don_thuoc_pop_up_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../in-don-thuoc-pop-up/in-don-thuoc-pop-up.component */ "./src/app/modules/main/quay-thuoc/in-don-thuoc-pop-up/in-don-thuoc-pop-up.component.ts");
            var QuayThuocTimBenhNhanPopUpComponent = /** @class */ (function () {
                function QuayThuocTimBenhNhanPopUpComponent(dialogRef, dataItem, apiService, dialog) {
                    this.dialogRef = dialogRef;
                ...
                QuayThuocTimBenhNhanPopUpComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_2__["DocumentType"].QuayThuoc;
                ...
                QuayThuocTimBenhNhanPopUpComponent.prototype.close = function (answer, type) {
                    if (type == 1) {
                ...
                QuayThuocTimBenhNhanPopUpComponent.prototype.PrinAllDonThuocBenhNhan = function (YeuCauTiepNhanId) {
                    var _this = this;
                    var data = {
                        Hosting: null,
                ...
                return QuayThuocTimBenhNhanPopUpComponent;
            }());
            QuayThuocTimBenhNhanPopUpComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocTimBenhNhanComponent = /** @class */ (function () {
                function QuayThuocTimBenhNhanComponent(apiService, dialog, router, cd, authService, notificationService, route) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.router = router;
                    this.cd = cd;
                ...
                QuayThuocTimBenhNhanComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    if (this.kiemTraDanhSachThanhToan == true && this.kiemTraDanhSachDaThanhToan == true) {
                        ...
                        var data = this.timKiem.KiemTraThanhToan;
                    }
                    ...
                    this.route
                        .queryParams
                        .subscribe(function (v) {
                        _this.timKiem.KiemTraThanhToan = v.page;
                    });
                    this.TimKiem(false);
                };
                QuayThuocTimBenhNhanComponent.prototype.TimkiemId = function (typeDanhSachThanhToan) {
                ...
                QuayThuocTimBenhNhanComponent.prototype.ngOnChanges = function (event) {
                ...
                QuayThuocTimBenhNhanComponent.prototype.XemChiTiet = function (data) {
                    if (data != null) {
                ...
                QuayThuocTimBenhNhanComponent.prototype.searchAll = function () {
                    var _this = this;
                    var maBenhNhanQueryString = null;
                    var maTiepNhanQueryString = null;
                    var hoTenNhanQueryString = null;
                    var sdtQueryString = null;
                    var KtraQueryString = null;
                    var KtraQueryRangeStartString = null;
                    var KtraQueryRangeEndString = null;
                    ...
                    var queryString = "{\"MaBenhNhan\":" + maBenhNhanQueryString + ",\"MaTiepNhan\":" + maTiepNhanQueryString
                    ...
                    this.apiService.post("QuayThuoc/TimKiemBenhNhan?search=" + queryString).subscribe(function (resultData) {
                        // dialogRef.close();
                        if (resultData != null && resultData.length > 0) {
                            if (resultData.length == 1) {
                                //KHông có toa thuốc đang chờ thanh toán hoặc chờ xuất thuốc
                                if (resultData[0].Id > 0) {
                                    if (_this.timKiem.KiemTraThanhToan == undefined) {
                                        _this.timKiem.KiemTraThanhToan = 3;
                                    }
                                    _this.router.navigate(['nha-thuoc/mua-thuoc/' + resultData[0].Id + '/' + resultData[0].MaBN + '/' + resultData[0].TrangThai + '/' + _this.timKiem.KiemTraThanhToan]);
                                }
                                else if (resultData[0].DonThuocThanhToanExits == true) {
                                    if (_this.timKiem.KiemTraThanhToan == undefined) {
                                        _this.timKiem.KiemTraThanhToan = 3;
                                    }
                                    _this.router.navigate(['nha-thuoc/mua-toa-cu/' + resultData[0].MaBN + '/' + _this.timKiem.KiemTraThanhToan]);
                                }
                            }
                            else {
                                if (resultData.length == 1) {
                                    if (resultData[0].Id > 0) {
                                        ...
                                        if (resultData[0].DonThuocThanhToanExits == true) {
                                            ...
                                            var dialogRef = _this.dialog.open(_quay_thuoc_xac_nhan_mua_thuoc_khach_vang_lai_pop_up_quay_thuoc_xac_nhan_mua_thuoc_khach_vang_lai_pop_up_component__WEBPACK_IMPORTED_MODULE_8__["QuayThuocXacNhanMuaThuocKhachVangLaiPopUpComponent"], {
                                                disableClose: true,
                                                width: '500px',
                                                data: { Model: resultData[0], KiemTraThanhToan: _this.timKiem.KiemTraThanhToan, Title: "XÁC NHẬN" }
                                            }).afterClosed().subscribe(function (result) {
                                            });
                                        }
                                    }
                                    ...
                                    var dialogRef = _this.dialog.open(_quay_thuoc_tim_benh_nhan_pop_up_quay_thuoc_tim_benh_nhan_pop_up_component__WEBPACK_IMPORTED_MODULE_7__["QuayThuocTimBenhNhanPopUpComponent"], {
                                        width: '1500px',
                                        data: { Model: resultData, Title: "Tìm kiếm người bệnh" }
                                    }).afterClosed().subscribe(function (result) {
                                        if (typeof (result) == 'object') {
                                            _this.dataSearch.emit(result);
                                        }
                                    });
                                }
                            }
                            ...
                            _this.notificationService.showError("Không có người bệnh.");
                        }
                        else {
                            ...
                            var dialogRef = _this.dialog.open(_quay_thuoc_xac_nhan_mua_thuoc_khach_vang_lai_pop_up_quay_thuoc_xac_nhan_mua_thuoc_khach_vang_lai_pop_up_component__WEBPACK_IMPORTED_MODULE_8__["QuayThuocXacNhanMuaThuocKhachVangLaiPopUpComponent"], {
                                disableClose: true,
                                width: '500px',
                                data: { Model: null, KiemTraThanhToan: _this.timKiem.KiemTraThanhToan, TenBenhNhanSearch: _this.timKiem.HoTen, SoDienThoaiSearch: _this.timKiem.SoDienThoai, Title: "XÁC NHẬN" } // null là người bệnh không tồn tại
                            }).afterClosed().subscribe(function (result) {
                            });
                        }
                    }, function (err) {
                ...
                QuayThuocTimBenhNhanComponent.prototype.keyEvent = function (event) {
                ...
                QuayThuocTimBenhNhanComponent.prototype.QuetMaQRCodeClick = function () {
                    var elementBarcode = document.getElementById('barcodeActive');
                    if (elementBarcode != undefined) {
                        elementBarcode.click();
                    }
                };
                QuayThuocTimBenhNhanComponent.prototype.changeQR = function ($event) {
                ...
                QuayThuocTimBenhNhanComponent.prototype.onKey3 = function (event) {
                    if (event.key == 'Enter') {
                    }
                };
                QuayThuocTimBenhNhanComponent.prototype.changRange = function (event) {
                };
                QuayThuocTimBenhNhanComponent.prototype.TimKiem = function (kiemTra) {
                    ...
                    var queryStringSearchUuTien = JSON.stringify(this.quayThuocGridVo);
                ...
                QuayThuocTimBenhNhanComponent.prototype.KhachVangLai = function () { };
                QuayThuocTimBenhNhanComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.TimKiem(true);
                    }
                };
                QuayThuocTimBenhNhanComponent.prototype.blurChange = function ($event, isSoTheBHYT) {
                };
                QuayThuocTimBenhNhanComponent.prototype.shareData1 = function () {
                    return this.benhNhanId;
                };
                QuayThuocTimBenhNhanComponent.prototype.checkTrangThai = function (event, type) {
                    this.cd.detectChanges();
                ...
                QuayThuocTimBenhNhanComponent.prototype.searchChangeMaBN = function (event) {
                    //xóa sreach trước đó
                    var self = this;
                ...
                QuayThuocTimBenhNhanComponent.prototype.searchChangeMaTN = function (event) {
                    //xóa sreach trước đó
                    var self = this;
                    if (this.timeoutSearchChange != null) {
                        clearTimeout(this.timeoutSearchChange);
                ...
                // EXPORT ÊXCEL
                QuayThuocTimBenhNhanComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('QuayThuoc/ExportDonThuocTrongNgay', self.exportQueryInfoQueryInfo).subscribe(function (resultData) {
                ...
                QuayThuocTimBenhNhanComponent.prototype.showPopupLoadingData = function () {
                ...
                QuayThuocTimBenhNhanComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                QuayThuocTimBenhNhanComponent.prototype.blur = function (event) {
                    this.TimKiem(true);
                };
                return QuayThuocTimBenhNhanComponent;
            }());
            QuayThuocTimBenhNhanComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
                { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocToaThuocCuComponent = /** @class */ (function () {
                function QuayThuocToaThuocCuComponent(route, router, notificationService) {
                    this.route = route;
                    this.router = router;
                    this.notificationService = notificationService;
                    this.id = this.route.snapshot.params.id;
                ...
                QuayThuocToaThuocCuComponent.prototype.ngOnInit = function () {
                ...
                QuayThuocToaThuocCuComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.TimKiem();
                    }
                };
                QuayThuocToaThuocCuComponent.prototype.ConvertDateTime = function (datime) {
                ...
                QuayThuocToaThuocCuComponent.prototype.TimKiem = function () {
                    var dvKhamQueryString = null;
                    var ChuanDoanQueryString = null;
                    var BSQueryString = null;
                    var ngayKhamStartQueryString = null;
                    var ngayKhamEndQueryString = null;
                    ...
                    var queryString = "{\"DVKham\":" + dvKhamQueryString + ",\"ChuanDoan\":" + ChuanDoanQueryString
                        + ",\"BacSi\":" + BSQueryString + ",\"DateStart\":" + ngayKhamStartQueryString + ",\"DateEnd\":" + ngayKhamEndQueryString + "}";
                    this.gridChild._additionalSearchString = queryString;
                    this.gridChild.search();
                };
                QuayThuocToaThuocCuComponent.prototype.extCheckboxSelection = function (event) {
                    this.donThuocId = event;
                };
                QuayThuocToaThuocCuComponent.prototype.ChonThuoc = function () {
                ...
                QuayThuocToaThuocCuComponent.prototype.Huy = function () {
                    this.router.navigate(['nha-thuoc']);
                };
                QuayThuocToaThuocCuComponent.prototype.onKey3 = function (event) {
                    if (event.key == 'Enter') {
                        // this.TimKiem();
                    }
                };
                QuayThuocToaThuocCuComponent.prototype.changRange = function (event) {
                    // this.TimKiem();
                };
                return QuayThuocToaThuocCuComponent;
            }());
            QuayThuocToaThuocCuComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_5__["NotificationService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
            /* harmony import */ var _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../quay-thuoc.model */ "./src/app/modules/main/quay-thuoc/quay-thuoc.model.ts");
            var QuayThuocXacNhanInPopUpComponent = /** @class */ (function () {
                function QuayThuocXacNhanInPopUpComponent(dialogRef, dataItem) {
                    this.dialogRef = dialogRef;
                    this.dataItem = dataItem;
                    this.Title = null;
                ...
                QuayThuocXacNhanInPopUpComponent.prototype.ngOnInit = function () {
                };
                QuayThuocXacNhanInPopUpComponent.prototype.close = function (answer) {
                    this.thongTin.Response = answer;
                    this.dialogRef.close(this.thongTin);
                };
                return QuayThuocXacNhanInPopUpComponent;
            }());
            QuayThuocXacNhanInPopUpComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var QuayThuocXacNhanMuaThuocKhachVangLaiPopUpComponent = /** @class */ (function () {
                function QuayThuocXacNhanMuaThuocKhachVangLaiPopUpComponent(dialogRef, dataItem, router) {
                    this.dialogRef = dialogRef;
                    this.dataItem = dataItem;
                    this.router = router;
                    this.Title = null;
                ...
                QuayThuocXacNhanMuaThuocKhachVangLaiPopUpComponent.prototype.ngOnInit = function () {
                };
                QuayThuocXacNhanMuaThuocKhachVangLaiPopUpComponent.prototype.close = function (answer) {
                    if (answer == 1) {
                ...
                return QuayThuocXacNhanMuaThuocKhachVangLaiPopUpComponent;
            }());
            QuayThuocXacNhanMuaThuocKhachVangLaiPopUpComponent.ctorParameters = function () { return [
                { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var QuayThuocXacNhanPopUpComponent = /** @class */ (function () {
                function QuayThuocXacNhanPopUpComponent(route, dialogRef, dataItem) {
                    this.route = route;
                    this.dialogRef = dialogRef;
                    this.dataItem = dataItem;
                    this.Title = null;
                    ...
                    this.soTien = dataItem.Model.DanhSachDonThuocs.reduce(function (sum, item) { return sum + item.BNConPhaiThanhToan; }, 0);
                    this.tenBenhNhan = dataItem.Model.HoTenBenhNhan;
                    this.Title = dataItem.Title;
                }
                QuayThuocXacNhanPopUpComponent.prototype.ngOnInit = function () {
                };
                QuayThuocXacNhanPopUpComponent.prototype.close = function (answer) {
                    this.dialogRef.close(answer);
                };
                return QuayThuocXacNhanPopUpComponent;
            }());
            QuayThuocXacNhanPopUpComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
                { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuayThuocModule = /** @class */ (function () {
                function QuayThuocModule() {
                }
                return QuayThuocModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var QuayThuocService = /** @class */ (function (_super) {
                __extends(QuayThuocService, _super);
                function QuayThuocService(apiService) {
                    return _super.call(this, apiService) || this;
                }
                return QuayThuocService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            QuayThuocService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongTinPhieuThuThuoc = /** @class */ (function () {
                function ThongTinPhieuThuThuoc(route, notificationService, apiService, authService, router, dialog) {
                    this.route = route;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                    this.authService = authService;
                ...
                ThongTinPhieuThuThuoc.prototype.ngOnInit = function () {
                    this.getThongSoPhieu();
                };
                ThongTinPhieuThuThuoc.prototype.total = function (field) {
                    switch (field) {
                        case 'ThanhTien':
                        ...
                        case 'TongCongNo':
                            return this.thongTinSoPhieuDaThu.DanhSachThuPhis
                                .reduce(function (sum, item) { return sum + item.TongCongNo; }, 0);
                        case 'SoTienMG':
                            return this.thongTinSoPhieuDaThu.DanhSachThuPhis
                                .reduce(function (sum, item) { return sum + item.SoTienMG; }, 0);
                        case 'DaThanhToan':
                            return this.thongTinSoPhieuDaThu.DanhSachThuPhis
                                .reduce(function (sum, item) { return sum + item.DaThanhToan; }, 0);
                    }
                };
                ThongTinPhieuThuThuoc.prototype.getThongSoPhieu = function () {
                    var _this = this;
                    this.apiService.post("QuayThuoc/GetSoPhieuQuayThuoc/" + this.yeuCauTiepNhanId).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData !== null) {
                            _this.dataSoPhieus = resultData;
                            if (resultData.length > 0) {
                                _this.xemThongTinPhieu(resultData[0].KeyId);
                            }
                        }
                    });
                };
                ThongTinPhieuThuThuoc.prototype.xemThongTinPhieu = function (keyId) {
                    var _this = this;
                    var loading = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_8__["LoadingComponent"], {
                        disableClose: true,
                        width: "200px",
                        height: "90px",
                        data: {},
                    });
                    this.apiService.get("QuayThuoc/GetThongTinPhieuThu/" + keyId).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData !== null) {
                ...
                ThongTinPhieuThuThuoc.prototype.selectionChangeSoPhieu = function (event) {
                    if (event != undefined && event != null) {
                ...
                ThongTinPhieuThuThuoc.prototype.huyPhieuThu = function (thongTinSoPhieuDaThu, thuHoiPhieu) {
                    var _this = this;
                    var thongTinHuyPhieu = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_9__["ThongTinHuyPhieu"]();
                    ...
                    var loaiType = true;
                    this.dialog
                        .open(_xac_nhan_phieu_huy_thu_xac_nhan_phieu_huy_thu_component__WEBPACK_IMPORTED_MODULE_11__["XacNhanHuyThuComponent"], { disableClose: true, width: "800px", data: { thongTinHuyPhieu: thongTinHuyPhieu, thuHoiPhieu: thuHoiPhieu, loaiType: loaiType } })
                        .afterClosed()
                        .subscribe(function (resultData) {
                ...
                ThongTinPhieuThuThuoc.prototype.phieuIn = function () {
                    var self = this;
                    var hosting = window.location.protocol + '//' + window.location.host;
                    var xacNhanInData = new _lich_su_quay_thuoc_lich_su_quay_thuoc_model__WEBPACK_IMPORTED_MODULE_13__["XacNhanInViewModel"]();
                    xacNhanInData = {
                ...
                return ThongTinPhieuThuThuoc;
            }());
            ThongTinPhieuThuThuoc.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_5__["NotificationService"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/core/utilities/common.helper */ "./src/app/core/utilities/common.helper.ts");
            /* harmony import */ var src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/component/dialogs/loading/loading.component */ "./src/app/shared/component/dialogs/loading/loading.component.ts");
            var ThongTinPhieuPdfPopupComponent = /** @class */ (function () {
                function ThongTinPhieuPdfPopupComponent(data, apiService, dialog, notificationService) {
                    this.data = data;
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                ...
                ThongTinPhieuPdfPopupComponent.prototype.ngOnInit = function () {
                    this.getALlFilePDFFromHtml(this.data.Model);
                };
                ThongTinPhieuPdfPopupComponent.prototype.getALlFilePDFFromHtml = function (arrHtml) {
                ...
                ThongTinPhieuPdfPopupComponent.prototype.downloadAllFile = function () {
                    var dateTimeNow = new Date();
                ...
                ThongTinPhieuPdfPopupComponent.prototype.showPopupLoadingData = function () {
                ...
                ThongTinPhieuPdfPopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                return ThongTinPhieuPdfPopupComponent;
            }());
            ThongTinPhieuPdfPopupComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../quay-thuoc.model */ "./src/app/modules/main/quay-thuoc/quay-thuoc.model.ts");
            var XacNhanHuyThuBanThuocComponent = /** @class */ (function () {
                function XacNhanHuyThuBanThuocComponent(data, dialogRef, authService, dialog, notificationService, apiService) {
                    this.data = data;
                    this.dialogRef = dialogRef;
                    this.authService = authService;
                    this.dialog = dialog;
                ...
                XacNhanHuyThuBanThuocComponent.prototype.ngOnInit = function () {
                    this.huyXuatThuocTrongNgay = this.data.huyXuatThuocTrongNgay;
                };
                XacNhanHuyThuBanThuocComponent.prototype.modelChangeThuHoiPhieu = function (e) {
                    var _this = this;
                    if (e) {
                        var currentUser_1 = this.authService.getAccessUser();
                        this.apiService.get("NhanVien/GetNhanVienProflie/" + currentUser_1.Id).subscribe(function (resultData) {
                            _this.huyXuatThuocTrongNgay.NguoiThuHoiId = currentUser_1.Id;
                            _this.huyXuatThuocTrongNgay.TenNguoiThuHoi = resultData.HoTen;
                            _this.huyXuatThuocTrongNgay.ThoiGianThuHoi = new Date();
                        });
                    }
                    else {
                ...
                XacNhanHuyThuBanThuocComponent.prototype.xacNhanThongTinHuy = function () {
                    var _this = this;
                    this.showLoadingPopup();
                    this.apiService.post("QuayThuoc/HuyBanThuocTrongNgay", this.huyXuatThuocTrongNgay).subscribe(function (resultData) {
                ...
                XacNhanHuyThuBanThuocComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                XacNhanHuyThuBanThuocComponent.prototype.showLoadingPopup = function () {
                ...
                XacNhanHuyThuBanThuocComponent.prototype.closeAllDialogs = function () {
                    if (this.loadingPopup) {
                        this.loadingPopup.close();
                        this.loadingPopup = null;
                    }
                };
                return XacNhanHuyThuBanThuocComponent;
            }());
            XacNhanHuyThuBanThuocComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XacNhanHuyThuComponent = /** @class */ (function () {
                function XacNhanHuyThuComponent(data, dialogRef, authService, dialog, notificationService, apiService) {
                    this.data = data;
                    this.dialogRef = dialogRef;
                    this.authService = authService;
                    this.dialog = dialog;
                ...
                XacNhanHuyThuComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    if (this.thuHoiPhieu) {
                        var currentUser_2 = this.authService.getAccessUser();
                        this.apiService.get("NhanVien/GetNhanVienProflie/" + currentUser_2.Id).subscribe(function (resultData) {
                            _this.thongTinHuyPhieu.NguoiThuHoiId = currentUser_2.Id;
                            _this.thongTinHuyPhieu.TenNguoiThuHoi = resultData.HoTen;
                            _this.thongTinHuyPhieu.ThoiGianThuHoi = new Date();
                        });
                    }
                };
                XacNhanHuyThuComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                XacNhanHuyThuComponent.prototype.modelChangeThuHoiPhieu = function (e) {
                    var _this = this;
                    if (e) {
                        var currentUser_3 = this.authService.getAccessUser();
                        this.apiService.get("NhanVien/GetNhanVienProflie/" + currentUser_3.Id).subscribe(function (resultData) {
                            _this.thongTinHuyPhieu.NguoiThuHoiId = currentUser_3.Id;
                            _this.thongTinHuyPhieu.TenNguoiThuHoi = resultData.HoTen;
                            _this.thongTinHuyPhieu.ThoiGianThuHoi = new Date();
                        });
                    }
                ...
                XacNhanHuyThuComponent.prototype.xacNhanThongTinHuy = function () {
                    var _this = this;
                    ...
                    if (this.loaiType) {
                        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Update)) {
                            if (this.thuHoiPhieu) {
                                this.apiService.post("QuayThuoc/CapnhatNguoiThuHoiPhieuThuThuoc", this.thongTinHuyPhieu).subscribe(function (resultData) {
                                ...
                                this.apiService.post("QuayThuoc/HuyPhieuThuThuoc", this.thongTinHuyPhieu).subscribe(function (resultData) {
                                    _this.dialog.closeAll();
                                    _this.dialogRef.close("Yes");
                                }, function (err) {
                                    err.ValidationErrors === null || err.ValidationErrors.length == 0 ? _this.notificationService.showError(err.Message) : (_this.validationErrors = err.ValidationErrors);
                        ...
                        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Update)) {
                            if (this.thuHoiPhieu) {
                                ...
                                this.apiService.post("QuayThuoc/HuyThanhToan", this.thongTinHuyPhieu).subscribe(function (resultData) {
                                    _this.dialog.closeAll();
                                    _this.dialogRef.close("Yes");
                                }, function (err) {
                                    err.ValidationErrors === null || err.ValidationErrors.length == 0 ? _this.notificationService.showError(err.Message) : (_this.validationErrors = err.ValidationErrors);
                ...
                return XacNhanHuyThuComponent;
            }());
            XacNhanHuyThuComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"] },
...
//# sourceMappingURL=default~kham-benh-lich-su-kham-benh-lich-su-kham-benh-module~quay-thuoc-danh-sach-cap-thuoc-bhyt-cap~f2f72aff-es5.js.map
//# sourceMappingURL=default~kham-benh-lich-su-kham-benh-lich-su-kham-benh-module~quay-thuoc-danh-sach-cap-thuoc-bhyt-cap~f2f72aff-es5.js.map