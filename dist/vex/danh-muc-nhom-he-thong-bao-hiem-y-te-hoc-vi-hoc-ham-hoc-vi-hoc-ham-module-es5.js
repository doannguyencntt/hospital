...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-bao-hiem-y-te-hoc-vi-hoc-ham-hoc-vi-hoc-ham-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HocViHocHamCreateComponent = /** @class */ (function () {
                function HocViHocHamCreateComponent(router) {
                    this.router = router;
                }
                HocViHocHamCreateComponent.prototype.ngOnInit = function () {
                };
                HocViHocHamCreateComponent.prototype.onCreated = function () { this.router.navigate(['/danh-muc/nhom-he-thong/bao-hiem-y-te/hoc-vi-hoc-ham']); };
                return HocViHocHamCreateComponent;
            }());
            HocViHocHamCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HocViHocHamListComponent = /** @class */ (function () {
                function HocViHocHamListComponent(dialog, notificationService, apiService, authService) {
                    this.dialog = dialog;
                ...
                HocViHocHamListComponent.prototype.ngOnInit = function () {
                ...
                HocViHocHamListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("HocViHocHam/ExportHocViHocHam", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return HocViHocHamListComponent;
            }());
            HocViHocHamListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HocViHocHamRoutingModule = /** @class */ (function () {
                function HocViHocHamRoutingModule() {
                }
                return HocViHocHamRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HocViHocHamShareComponent = /** @class */ (function () {
                function HocViHocHamShareComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.modelFE = {};
                }
                HocViHocHamShareComponent.prototype.ngOnInit = function () {
                    var id = this.route.snapshot.params.id;
                    if (id !== undefined && id !== null) {
                        this.getById(id);
                    }
                };
                HocViHocHamShareComponent.prototype.getById = function (id) {
                    var _this = this;
                ...
                HocViHocHamShareComponent.prototype.getSharedData = function () {
                    return this.modelFE;
                };
                return HocViHocHamShareComponent;
            }());
            HocViHocHamShareComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_vex_animations_stagger_animation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/@vex/animations/stagger.animation */ "./src/@vex/animations/stagger.animation.ts");
            /* harmony import */ var _hoc_vi_hoc_ham_share_hoc_vi_hoc_ham_share_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../hoc-vi-hoc-ham-share/hoc-vi-hoc-ham-share.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/bao-hiem-y-te/hoc-vi-hoc-ham/hoc-vi-hoc-ham-share/hoc-vi-hoc-ham-share.component.ts");
            var HocViHocHamUpdateComponent = /** @class */ (function () {
                function HocViHocHamUpdateComponent(router) {
                    this.router = router;
                }
                HocViHocHamUpdateComponent.prototype.ngOnInit = function () {
                };
                HocViHocHamUpdateComponent.prototype.onUpdated = function () { this.router.navigate(['/danh-muc/nhom-he-thong/bao-hiem-y-te/hoc-vi-hoc-ham']); };
                return HocViHocHamUpdateComponent;
            }());
            HocViHocHamUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_hoc_vi_hoc_ham_share_hoc_vi_hoc_ham_share_component__WEBPACK_IMPORTED_MODULE_5__["HocViHocHamShareComponent"], { static: true })
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HocViHocHamModule = /** @class */ (function () {
                function HocViHocHamModule() {
                }
                return HocViHocHamModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HocViHocHamService = /** @class */ (function (_super) {
                __extends(HocViHocHamService, _super);
                function HocViHocHamService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'HocViHocHam';
                    return _this;
                }
                return HocViHocHamService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            HocViHocHamService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-bao-hiem-y-te-hoc-vi-hoc-ham-hoc-vi-hoc-ham-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-bao-hiem-y-te-hoc-vi-hoc-ham-hoc-vi-hoc-ham-module-es5.js.map