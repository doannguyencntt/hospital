...
let HoSoCuaToiRoutingModule = class HoSoCuaToiRoutingModule {
};
...
let HoSoCuaToiModule = class HoSoCuaToiModule {
};
...
class ThongTinKhoaPhong {
    constructor(NhomKhoa = null, NhomKhoaId = null, MaPhong = null, TenPhong = null, PhongChinh = null, IsChecked = null, Id = null) {
...
class ThongTinKho {
    constructor(DaChon = null, Id = null, TenKho = null, TenKhoa = null, TenPhong = null) {
        this.DaChon = DaChon;
        this.Id = Id;
        this.TenKho = TenKho;
...
class GridThongTinKhoaPhongModel {
    constructor(Data = [], TotalRowCount = 0) {
        this.Data = Data;
...
let ThongTinHoSoCuaToiComponent = class ThongTinHoSoCuaToiComponent {
    constructor(dialog, notificationService, baseService, authService, apiService) {
        this.dialog = dialog;
...
ThongTinHoSoCuaToiComponent.ctorParameters = () => [
