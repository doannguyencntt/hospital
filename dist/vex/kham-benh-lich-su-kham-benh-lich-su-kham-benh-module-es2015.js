...
let LichSuKhamBenhListComponent = class LichSuKhamBenhListComponent {
    constructor(router, authService, notificationService, apiService, dialog, route, location) {
        this.router = router;
    ...
    XuatExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("KhamBenh/ExportLichSuKhamBenh", this.gridChild._gridQueryInfo).subscribe(res => {
    ...
    In(dataItem, loaiPhieuIn) {
        console.log(dataItem);
        switch (loaiPhieuIn) {
            case src_app_shared_enum_kham_benh_enum__WEBPACK_IMPORTED_MODULE_26__["LoaiPhieuIn"].InPhieuChiDinh:
                this.apiService.post("KhamBenh/GetDanhSachDichVuChiDinhCuaBenhNhan?yeuCauTiepNhanId=" + dataItem.YeuCauTiepNhanId + "&yeuCauKhamBenhId=" + dataItem.Id).subscribe(resultData => {
                    if (resultData.Data.length != 0) {
                        ...
                        let dialogRef = this.dialog.open(_popup_chon_loai_In_popup_chon_loai_in_view_popup_chon_loai_in_view_component__WEBPACK_IMPORTED_MODULE_27__["PopupChonLoaiInViewComponent"], {
                            width: '1000px',
                            data: { Model: dataIn }
                        });
                    }
                    else {
                        let dialogRef = this.dialog.open(_popup_message_khong_co_dich_vu_vu_in_popup_message_khong_co_dich_vu_vu_in_component__WEBPACK_IMPORTED_MODULE_28__["PopupMessageKhongCoDichVuVuInComponent"], {
                            width: '400px',
            ...
            case src_app_shared_enum_kham_benh_enum__WEBPACK_IMPORTED_MODULE_26__["LoaiPhieuIn"].InDonThuocBHYT:
                ...
                if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                    this.apiService.post("KhamBenh/InToaThuocBHYTVaKhongBHYTDanhSachKhamBenh", data).subscribe(result => {
            ...
            case src_app_shared_enum_kham_benh_enum__WEBPACK_IMPORTED_MODULE_26__["LoaiPhieuIn"].InDonThuocNhaThuoc:
                ...
                if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                    this.apiService.post("KhamBenh/InToaThuocBHYTVaKhongBHYTDanhSachKhamBenh", dataCanInDonThuocKhongBHYT).subscribe(result => {
                        if (result != undefined && result != null && result != "") {
                            this.dialog
                                .open(_toa_thuoc_kham_benh_popup_toa_thuoc_kham_benh_popup_component__WEBPACK_IMPORTED_MODULE_29__["ToaThuocKhamBenhPopupComponent"], {
                                disableClose: true,
            ...
            case src_app_shared_enum_kham_benh_enum__WEBPACK_IMPORTED_MODULE_26__["LoaiPhieuIn"].InPhieuKhamBenh:
                ...
                this.apiService.post("KhamBenh/InPhieuKhamBenh", dataPhieuKhamBenh).subscribe(resultData => {
            ...
            case src_app_shared_enum_kham_benh_enum__WEBPACK_IMPORTED_MODULE_26__["LoaiPhieuIn"].InPhieuKhamBenhVaoVien:
                ...
                if (dataItem.CoNhapVien == true) {
                    this.apiService.post("KhamBenh/InPhieuKhamBenh", dataPhieuKhamBenhVaoVien).subscribe(resultData => {
                        if (resultData != undefined && resultData != null && resultData != "") {
                            this.dialog
                                .open(_kham_benh_lan_kham_hien_tai_phieu_kham_benh_vao_vien_popup_phieu_kham_benh_vao_vien_popup_component__WEBPACK_IMPORTED_MODULE_30__["PhieuKhamBenhVaoVienPopupComponent"], {
                                disableClose: true,
...
LichSuKhamBenhListComponent.ctorParameters = () => [
...
let LichSuKhamBenhRoutingModule = class LichSuKhamBenhRoutingModule {
};
...
let LichSuKhamBenhModule = class LichSuKhamBenhModule {
};
...
let PopupMessageKhongCoDichVuVuInComponent = class PopupMessageKhongCoDichVuVuInComponent {
...
PopupMessageKhongCoDichVuVuInComponent.ctorParameters = () => [
...
let ToaThuocKhamBenhConfirmComponent = class ToaThuocKhamBenhConfirmComponent {
    constructor(dialog, apiService, notificationService, authService, dialogRef, dataItem) {
        this.dialog = dialog;
        this.apiService = apiService;
        this.notificationService = notificationService;
        this.authService = authService;
    ...
    InToaThuoc() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Process)) {
            self.apiService.post("KhamBenh/InToaThuocBHYTVaKhongBHYTDanhSachKhamBenh", self.thongTin).subscribe(result => {
...
ToaThuocKhamBenhConfirmComponent.ctorParameters = () => [
...
let ToaThuocKhamBenhPopupComponent = class ToaThuocKhamBenhPopupComponent {
    constructor(dialog, sanitizer, data) {
        this.dialog = dialog;
...
ToaThuocKhamBenhPopupComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
