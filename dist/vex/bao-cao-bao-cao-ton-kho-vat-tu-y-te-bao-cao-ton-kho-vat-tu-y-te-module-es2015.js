...
let BaoCaoTonKhoVatTuYteListComponent = class BaoCaoTonKhoVatTuYteListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCaoVatTu/GetDataBaoCaoTonKhoVatTuForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoTonKhoVatTuYteListComponent.ctorParameters = () => [
