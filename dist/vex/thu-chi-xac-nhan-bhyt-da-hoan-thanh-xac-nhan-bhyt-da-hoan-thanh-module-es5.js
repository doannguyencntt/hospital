...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["thu-chi-xac-nhan-bhyt-da-hoan-thanh-xac-nhan-bhyt-da-hoan-thanh-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChiTietLanXacNhanListComponent = /** @class */ (function () {
                function ChiTietLanXacNhanListComponent(route) {
                    this.route = route;
                ...
                ChiTietLanXacNhanListComponent.prototype.totalThanhTien = function (field, id) {
                    var self = this;
                    switch (field) {
                        case 'ThanhTienBenhVien': {
                            if (self.lanXacNhanLog.length !== 0 && self.lanXacNhanLog.filter(function (x) { return x.Id === Number(id); }).length !== 0) {
                                return self.lanXacNhanLog.filter(function (x) { return x.Id === Number(id); })[0].
                                    DaXacNhanBhyt.reduce(function (sum, item) { return sum + item.ThanhTienBenhVien; }, 0);
                            }
                            return 0;
                        }
                        case 'TtbhytChiTra': {
                            if (self.lanXacNhanLog.length !== 0 && self.lanXacNhanLog.filter(function (x) { return x.Id === Number(id); }).length !== 0) {
                                return self.lanXacNhanLog.filter(function (x) { return x.Id === Number(id); })[0].
                                    DaXacNhanBhyt.reduce(function (sum, item) { return sum + item.TtbhytChiTra; }, 0);
                            }
                            return 0;
                        }
                        default: {
                ...
                ChiTietLanXacNhanListComponent.prototype.ngOnInit = function () {
                ...
                ChiTietLanXacNhanListComponent.prototype.onDataBoundForChildren = function (event) {
                    var duyetChiTiet = [];
                    this.data = event.Data;
                    this.data.forEach(function (duyetChiTietItem) {
                        duyetChiTiet.push(duyetChiTietItem);
                    });
                    var lanXacNhan = new _xac_nhan_bhyt_da_hoan_thanh_model__WEBPACK_IMPORTED_MODULE_4__["LanXacNhanLogList"]();
                    lanXacNhan = {
                ...
                ChiTietLanXacNhanListComponent.prototype.setMasterName = function (eventData) {
                    this.currentMasterName = eventData.dataItem.Id.toString();
                };
                ChiTietLanXacNhanListComponent.prototype.removeLog = function (eventData) {
                    var deletedPosition = this.lanXacNhanLog.indexOf(this.lanXacNhanLog.filter(function (x) { return x.Id === eventData.dataItem.Id; })[0]);
                    this.lanXacNhanLog.splice(deletedPosition, 1);
                };
                return ChiTietLanXacNhanListComponent;
            }());
            ChiTietLanXacNhanListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DaXacNhanBhytListComponent = /** @class */ (function () {
                function DaXacNhanBhytListComponent(dialog, authService, notificationService, route, apiService) {
                    this.dialog = dialog;
                ...
                DaXacNhanBhytListComponent.prototype.totalBNConPhaiThanhToan = function (field) {
                    switch (field) {
                        case 'BnThanhToan':
                            return this.data.reduce(function (sum, item) { return sum + item.BnThanhToan; }, 0);
                    }
                };
                DaXacNhanBhytListComponent.prototype.totaLThanhTien = function (field) {
                    switch (field) {
                        case 'ThanhTienBenhVien':
                            return this.data.reduce(function (sum, item) { return sum + item.ThanhTienBenhVien; }, 0);
                    }
                };
                DaXacNhanBhytListComponent.prototype.totalTTBHYTChiTra = function (field) {
                    switch (field) {
                        case 'TtbhytChiTra':
                            return this.data.reduce(function (sum, item) { return sum + item.TtbhytChiTra; }, 0);
                    }
                };
                DaXacNhanBhytListComponent.prototype.ngOnInit = function () {
                ...
                DaXacNhanBhytListComponent.prototype.onDataBoundChild = function (event) {
                    this.data = event.Data;
                    this.valueChange.emit();
                };
                DaXacNhanBhytListComponent.prototype.lichSuXacNhan = function (data) {
                    var self = this;
                    var lichSuModel = {
                        Id: data.IdDatabase,
                ...
                DaXacNhanBhytListComponent.prototype.roundUp = function (num, precision) {
                    precision = Math.pow(10, precision);
                    return Math.ceil(num * precision) / precision;
                };
                return DaXacNhanBhytListComponent;
            }());
            DaXacNhanBhytListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListDuyetHistoryComponent = /** @class */ (function () {
                function ListDuyetHistoryComponent(dialog, data) {
                    this.dialog = dialog;
                    this.data = data;
                ...
                ListDuyetHistoryComponent.prototype.ngOnInit = function () {
                ...
                ListDuyetHistoryComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return ListDuyetHistoryComponent;
            }());
            ListDuyetHistoryComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XacNhanBhytDaHoanThanhDetailedComponent = /** @class */ (function () {
                function XacNhanBhytDaHoanThanhDetailedComponent(route, router, authService, notificationService, dialog, apiService) {
                    this.route = route;
                    this.router = router;
                    this.authService = authService;
                    this.notificationService = notificationService;
                ...
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.ngOnInit = function () {
                    var self = this;
                ...
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.getById = function (id) {
                    var _this = this;
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].View)) {
                        this.apiService
                            ...
                            if (resultData !== undefined && resultData != null) {
                                _this.thongTinXacNhanBhyt = resultData;
                                _this.thongTinXacNhanBhyt.MaBN = resultData.BenhNhan != null ? resultData.BenhNhan.MaBN : '';
                                _this.thongTinXacNhanBhyt.DoiTuongUuDai = resultData.DoiTuongUuDai != null ? resultData.DoiTuongUuDai.Ten : '';
                                _this.thongTinXacNhanBhyt.CongTyUuDai = resultData.CongTyUuDai != null ? resultData.CongTyUuDai.Ten : '';
                            }
                        });
                    }
                    else {
                ...
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.showPopupLoadingData = function () {
                ...
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.switchDaXacNhan = function () {
                    this.closePopupLoadingData();
                };
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.onHuy = function () {
                    this.router.navigate(['/xac-nhan-bhyt-da-hoan-thanh/ngoai-tru'], {
                        queryParamsHandling: 'preserve',
                    });
                };
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.viewDocument = function (idFile, type) {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].View)) {
                        self.apiService
                ...
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.onTabSelect = function (ev) {
                    var self = this;
                    self.tabIndex = ev.index;
                };
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.phieuLinhThuocBenhNhanBHYT = function () {
                    var _this = this;
                ...
                XacNhanBhytDaHoanThanhDetailedComponent.prototype.keyEvent = function (event) {
                ...
                return XacNhanBhytDaHoanThanhDetailedComponent;
            }());
            XacNhanBhytDaHoanThanhDetailedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XacNhanBhytDaHoanThanhListComponent = /** @class */ (function () {
                function XacNhanBhytDaHoanThanhListComponent(notificationService, router, route, authService, dialog, apiService) {
                    this.notificationService = notificationService;
                    this.router = router;
                    this.route = route;
                    this.authService = authService;
                ...
                XacNhanBhytDaHoanThanhListComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_2__["DocumentType"].XacNhanBhytDaHoanThanh;
                ...
                XacNhanBhytDaHoanThanhListComponent.prototype.exportExcel = function () {
                    var self = this;
                    self.showPopupLoadingData();
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('XacNhanBhytDaHoanThanh/ExportXacNhanBhytDaHoanThanh', self.gridChild._gridQueryInfo).subscribe(function (resultData) {
                ...
                XacNhanBhytDaHoanThanhListComponent.prototype.showPopupLoadingData = function () {
                ...
                XacNhanBhytDaHoanThanhListComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                XacNhanBhytDaHoanThanhListComponent.prototype.thongTinChiTiet = function (dataItem) {
                ...
                XacNhanBhytDaHoanThanhListComponent.prototype.onKey = function (event) {
                    if (event.key === 'Enter') {
                        this.Timkiem();
                    }
                };
                XacNhanBhytDaHoanThanhListComponent.prototype.Timkiem = function () {
                    ...
                    var queryString = JSON.stringify(this.searchDaHt);
                ...
                XacNhanBhytDaHoanThanhListComponent.prototype.searchChanges = function () {
                    var self = this;
                ...
                XacNhanBhytDaHoanThanhListComponent.prototype.clearSearch = function () {
                    this.searchDaHt.SearchString = '';
                    this.gridChild.search();
                };
                XacNhanBhytDaHoanThanhListComponent.prototype.toggleColumnVisibility = function (column, event) {
                    this.gridBhyt.toggleColumnVisibility(column, event);
                };
                XacNhanBhytDaHoanThanhListComponent.prototype.thoiDiemTNChange = function (event) {
                    if (event.key === 'Enter') {
                        this.Timkiem();
                    }
                };
                return XacNhanBhytDaHoanThanhListComponent;
            }());
            XacNhanBhytDaHoanThanhListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XacNhanBhytDaHoanThanhRoutingModule = /** @class */ (function () {
                function XacNhanBhytDaHoanThanhRoutingModule() {
                }
                return XacNhanBhytDaHoanThanhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ThongTinXacNhanBhyt = /** @class */ (function () {
                function ThongTinXacNhanBhyt(Id, MaYeuCauTiepNhan, BenhNhanId, MaBN, HoTen, NamSinh, GioiTinh, DiaChi, SoDienThoai, Email, DoiTuongUuDai, CongTyUuDai, BHYTMaSoThe, BHYTngayHieuLucStr, BHYTngayHetHanStr, DKBD, LyDoVaoVienDisplay, GiayChuyenVienDisplay, GiayChuyenVienId, GiayMienCungChiTraDisplay, BHYTGiayMienCungChiTraId, BHYTMucHuong) {
                    ...
                    if (LyDoVaoVienDisplay === void 0) { LyDoVaoVienDisplay = null; }
                    if (GiayChuyenVienDisplay === void 0) { GiayChuyenVienDisplay = null; }
                    if (GiayChuyenVienId === void 0) { GiayChuyenVienId = null; }
                    if (GiayMienCungChiTraDisplay === void 0) { GiayMienCungChiTraDisplay = null; }
                ...
                return ThongTinXacNhanBhyt;
            }());
            var DaXacNhanBhytList = /** @class */ (function () {
                function DaXacNhanBhytList(STT, Nhom, MaDichVu, TenDichVu, LoaiGia, SoLuong, DonGiaBenhVien, ThanhTienBenhVien, DgbhytThamKhao, ThanhTienBhytThamKhao, TiLeBhyt, DgbhytChiTra, TtbhytChiTra, BnThanhToan) {
                    ...
                    if (TiLeBhyt === void 0) { TiLeBhyt = null; }
                ...
                return DaXacNhanBhytList;
            }());
            var LanXacNhanLogList = /** @class */ (function () {
                function LanXacNhanLogList(Id, DaXacNhanBhyt) {
                    if (Id === void 0) { Id = null; }
                    if (DaXacNhanBhyt === void 0) { DaXacNhanBhyt = []; }
                    this.Id = Id;
                    this.DaXacNhanBhyt = DaXacNhanBhyt;
                }
                return LanXacNhanLogList;
            }());
            var Search = /** @class */ (function () {
                function Search(SearchString, ThoiDiemDuyetBaoHiemTu, ThoiDiemDuyetBaoHiemDen, FromDate, ToDate) {
                    if (SearchString === void 0) { SearchString = null; }
                    if (ThoiDiemDuyetBaoHiemTu === void 0) { ThoiDiemDuyetBaoHiemTu = null; }
                    if (ThoiDiemDuyetBaoHiemDen === void 0) { ThoiDiemDuyetBaoHiemDen = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XacNhanBhytDaHoanThanhModule = /** @class */ (function () {
                function XacNhanBhytDaHoanThanhModule() {
                }
                return XacNhanBhytDaHoanThanhModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var XacNhanBHYTDaHoanThanhService = /** @class */ (function (_super) {
                __extends(XacNhanBHYTDaHoanThanhService, _super);
                function XacNhanBHYTDaHoanThanhService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'XacNhanBhytDaHoanThanh';
                    return _this;
                }
                return XacNhanBHYTDaHoanThanhService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            XacNhanBHYTDaHoanThanhService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
...
//# sourceMappingURL=thu-chi-xac-nhan-bhyt-da-hoan-thanh-xac-nhan-bhyt-da-hoan-thanh-module-es5.js.map
//# sourceMappingURL=thu-chi-xac-nhan-bhyt-da-hoan-thanh-xac-nhan-bhyt-da-hoan-thanh-module-es5.js.map