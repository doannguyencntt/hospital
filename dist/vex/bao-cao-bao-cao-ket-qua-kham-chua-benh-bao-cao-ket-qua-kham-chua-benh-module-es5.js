(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-ket-qua-kham-chua-benh-bao-cao-ket-qua-kham-chua-benh-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKetQuaKhamChuaBenhPopupComponent = /** @class */ (function () {
                function BaoCaoKetQuaKhamChuaBenhPopupComponent(data, sanitizer, dialog) {
                    this.data = data;
                ...
                BaoCaoKetQuaKhamChuaBenhPopupComponent.prototype.ngOnInit = function () {
                    this.modelPrint = this.data.Model;
                };
                BaoCaoKetQuaKhamChuaBenhPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        resolve(_this.modelPrint);
                    });
                };
                BaoCaoKetQuaKhamChuaBenhPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return BaoCaoKetQuaKhamChuaBenhPopupComponent;
            }());
            BaoCaoKetQuaKhamChuaBenhPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKetQuaKhamChuaBenhRoutingModule = /** @class */ (function () {
                function BaoCaoKetQuaKhamChuaBenhRoutingModule() {
                }
                return BaoCaoKetQuaKhamChuaBenhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchBaoCao = /** @class */ (function () {
                function SearchBaoCao(DateStart, DateEnd) {
            ...
            var BaoCaoKetQuaKhamChuaBenhAnVo = /** @class */ (function () {
                function BaoCaoKetQuaKhamChuaBenhAnVo(TuNgay, DenNgay, hosting) {
                ...
                return BaoCaoKetQuaKhamChuaBenhAnVo;
            }());
            var ColumnsTitleTable = /** @class */ (function () {
                function ColumnsTitleTable(Html) {
                    if (Html === void 0) { Html = ""; }
                    this.Html = Html;
                }
                return ColumnsTitleTable;
            }());
            var TimKiemBaoCaoKhamChuaBenh = /** @class */ (function () {
                function TimKiemBaoCaoKhamChuaBenh(TuNgayDenNgay, SearchString) {
                ...
                return TimKiemBaoCaoKhamChuaBenh;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKetQuaKhamChuaBenhModule = /** @class */ (function () {
                function BaoCaoKetQuaKhamChuaBenhModule() {
                }
                return BaoCaoKetQuaKhamChuaBenhModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var BaoCaoKetQuaKhamChuaBenhService = /** @class */ (function () {
                function BaoCaoKetQuaKhamChuaBenhService() {
                }
                return BaoCaoKetQuaKhamChuaBenhService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKetQuaKhamChuaBenhComponent = /** @class */ (function () {
                function BaoCaoKetQuaKhamChuaBenhComponent(apiService, dialog, notificationService, authService, ref) {
                ...
                BaoCaoKetQuaKhamChuaBenhComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoKetQuaKhamChuaBenhComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    this.columnsTitleTable = new Array();
                    var baoCaoInfo = new _bao_cao_ket_qua_kham_chua_benh_model__WEBPACK_IMPORTED_MODULE_10__["BaoCaoKetQuaKhamChuaBenhAnVo"]();
                    ...
                    this.apiService.post("BaoCao/GetDataTemplateBaoCaoKetQuaKhamChuaBenhAsync", baoCaoInfo).subscribe(function (resultData) {
                ...
                BaoCaoKetQuaKhamChuaBenhComponent.prototype.InbaoCao = function () {
                    var _this = this;
                    if (this.showPrintExport == true) {
                        ...
                        this.apiService.post("BaoCao/InBaoCaoKetQuaKhamChuaBenh", baoCaoInfo).subscribe(function (result) {
                            _this.dialog.open(_bao_cao_ket_qua_kham_chua_benh_popup_bao_cao_ket_qua_kham_chua_benh_popup_component__WEBPACK_IMPORTED_MODULE_11__["BaoCaoKetQuaKhamChuaBenhPopupComponent"], {
                                disableClose: true,
                                width: '1000px',
                                data: { Model: result }
                ...
                BaoCaoKetQuaKhamChuaBenhComponent.prototype.XuatBaoCao = function () {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
                        ...
                        //tạm thời đóng lại
                        //this.XemBaoCao();
                        self.apiService.postExportExcel('BaoCao/ExportBaoCaoKetQuaKhamChuaBenh', baoCaoInfo).subscribe(function (resultData) {
                ...
                BaoCaoKetQuaKhamChuaBenhComponent.prototype.showPopupLoadingData = function () {
                ...
                BaoCaoKetQuaKhamChuaBenhComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return BaoCaoKetQuaKhamChuaBenhComponent;
            }());
            BaoCaoKetQuaKhamChuaBenhComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-ket-qua-kham-chua-benh-bao-cao-ket-qua-kham-chua-benh-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-ket-qua-kham-chua-benh-bao-cao-ket-qua-kham-chua-benh-module-es5.js.map