(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-duoc-chi-tiet-xuat-noi-bo-bao-cao-duoc-chi-tiet-xuat-noi-bo-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDuocChiTietXuatNoiBoListComponent = /** @class */ (function () {
                function BaoCaoDuocChiTietXuatNoiBoListComponent(apiService, dialog, notificationService, authService, cd) {
                ...
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.getSoLuong = function (field, thongTinThuoc) {
                    if (this.gridTemp) {
                        var sumSoLuongs = this.gridTemp.filter(function (s) { return s.Kho == field && s.ThongTinThuoc == thongTinThuoc; });
                        if (sumSoLuongs.length > 0) {
                            return sumSoLuongs.reduce(function (sum, item) { return sum + item.SoLuong; }, 0);
                        }
                    }
                };
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.getThanhTien = function (field, thongTinThuoc) {
                    if (this.gridTemp) {
                        var sumTTiens = this.gridTemp.filter(function (s) { return s.Kho == field && s.ThongTinThuoc == thongTinThuoc; });
                        if (sumTTiens.length > 0) {
                            return sumTTiens.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                        }
                    }
                };
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.totalThanhTien = function (field) {
                    if (this.gridTemp) {
                        var listItemTheoKho = this.gridTemp.filter(function (s) { return s.Kho == field; });
                        if (listItemTheoKho.length > 0) {
                            return listItemTheoKho.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                        }
                    }
                };
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.pageChange = function (event) {
                    this.baoCaoSearch.Skip = event.skip;
                    this.skip = event.skip;
                    this.XemBaoCao();
                };
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.reFresh = function () {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetDataBaoCaoDuocChiTietXuatNoiBoForGridAsync", this.baoCaoSearch).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            if (resultData.TotalRowCount !== undefined && resultData.TotalRowCount != 0) {
                                _this.showPrintExport = true;
                            }
                            _this.gridTemp = resultData.Data.slice();
                            _this.gridTemp.forEach(function (element) {
                                var check = _this.gridDataSource.data.filter(function (s) { return s.ThongTinThuoc == element.ThongTinThuoc; })[0];
                                if (!check) {
                                    _this.gridDataSource.data.push({ Id: element.Id, ThongTinThuoc: element.ThongTinThuoc, DVT: element.DVT });
                                }
                                var check1 = _this.listKho.filter(function (s) { return s == element.Kho; })[0];
                                if (!check1) {
                                    _this.listKho.push(element.Kho);
                                }
                            });
                ...
                BaoCaoDuocChiTietXuatNoiBoListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                return BaoCaoDuocChiTietXuatNoiBoListComponent;
            }());
            BaoCaoDuocChiTietXuatNoiBoListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDuocChiTietXuatNoiBoRoutingModule = /** @class */ (function () {
                function BaoCaoDuocChiTietXuatNoiBoRoutingModule() {
                }
                return BaoCaoDuocChiTietXuatNoiBoRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoDuocChiTietXuatNoiBoSearch = /** @class */ (function () {
                function BaoCaoDuocChiTietXuatNoiBoSearch(KhoId, FromDate, ToDate, TuNgayFormat, DenNgayFormat, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                ...
                return BaoCaoDuocChiTietXuatNoiBoSearch;
            }());
            var InBaoCaoDuocChiTietXuatNoiBo = /** @class */ (function () {
                function InBaoCaoDuocChiTietXuatNoiBo(HostingName, FromDate, ToDate) {
                ...
                return InBaoCaoDuocChiTietXuatNoiBo;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDuocChiTietXuatNoiBoModule = /** @class */ (function () {
                function BaoCaoDuocChiTietXuatNoiBoModule() {
                }
                return BaoCaoDuocChiTietXuatNoiBoModule;
            }());
...
//# sourceMappingURL=bao-cao-bao-cao-duoc-chi-tiet-xuat-noi-bo-bao-cao-duoc-chi-tiet-xuat-noi-bo-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-duoc-chi-tiet-xuat-noi-bo-bao-cao-duoc-chi-tiet-xuat-noi-bo-module-es5.js.map