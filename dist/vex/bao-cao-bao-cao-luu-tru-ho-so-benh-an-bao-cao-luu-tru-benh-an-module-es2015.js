...
let BaoCaoLuuTruBenhAnPopupComponent = class BaoCaoLuuTruBenhAnPopupComponent {
...
BaoCaoLuuTruBenhAnPopupComponent.ctorParameters = () => [
...
let BaoCaoLuuTruBenhAnRoutingModule = class BaoCaoLuuTruBenhAnRoutingModule {
};
...
let BaoCaoLuuTruBenhAnModule = class BaoCaoLuuTruBenhAnModule {
};
...
let BaoCaoLuuTruBenhAnService = class BaoCaoLuuTruBenhAnService {
    constructor() { }
};
...
let BaoCaoLuuTruBenhAnComponent = class BaoCaoLuuTruBenhAnComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataLuuTruHoSoBenhAnForGridAsync", this.baoCaoSearch).subscribe(resultData => {
    ...
    InbaoCao() {
        if (this.showPrintExport == true) {
            let baoCaoLuuHoSoBenhAnVo = new _bao_cao_luu_tru_ho_so_benh_an_model__WEBPACK_IMPORTED_MODULE_8__["BaoCaoLuuHoSoBenhAnVo"]();
            ...
            this.apiService.post("BaoCao/InBaoCaoLuuTruHoSoBenhAn", baoCaoLuuHoSoBenhAnVo).subscribe((result) => {
                this.dialog.open(_bao_cao_luu_tru_benh_an_popup_bao_cao_luu_tru_benh_an_popup_component__WEBPACK_IMPORTED_MODULE_7__["BaoCaoLuuTruBenhAnPopupComponent"], {
                    disableClose: true,
                    width: '1000px',
                    data: { Model: result }
...
BaoCaoLuuTruBenhAnComponent.ctorParameters = () => [
...
class SearchBaoCao {
    constructor(KhoaId = null, DateStart = null, DateEnd = null, TenKhoa = null) {
        this.KhoaId = KhoaId;
...
class BaoCaoLuuHoSoBenhAnVo {
    constructor(KhoaId = 0, NgayVaoVien = null, NgayRaVien = null, hosting = null) {
        this.KhoaId = KhoaId;
...
class BaoCaoLuuTruHoSoBenhAnSearch {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, KhoaId = null, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = [], BHYT = false, VienPhi = true) {
...
class InBaoCaoLuuTruHoSoBenhAn {
    constructor(KhoaId = 0, HostingName = null, FromDate = null, ToDate = null) {
        this.KhoaId = KhoaId;
