...
let KhoDuocPhamCreateComponent = class KhoDuocPhamCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
KhoDuocPhamCreateComponent.ctorParameters = () => [
...
let KhoDuocPhamListComponent = class KhoDuocPhamListComponent {
    constructor(dialog, notificationService, apiService, authService, router) {
        this.dialog = dialog;
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel('KhoDuocPham/ExportKhoDuocPham', this.gridChild._gridQueryInfo).subscribe(res => {
...
KhoDuocPhamListComponent.ctorParameters = () => [
...
let KhoDuocPhamRoutingModule = class KhoDuocPhamRoutingModule {
};
...
let KhoDuocPhamShareComponent = class KhoDuocPhamShareComponent {
    ...
    getById(id) {
        this.baseService.getById(id).subscribe(resultData => {
            if (resultData != null) {
                this.modelFE = Object.assign({}, resultData);
                if (this.modelFE.LoaiKho === src_app_shared_enum_loai_kho_enum__WEBPACK_IMPORTED_MODULE_5__["EnumLoaiKho"].KhoLe) {
    ...
    OnLoadPhongBenhVien(isOpen) {
        if (isOpen) {
            const dropDownListModel = new src_app_shared_models_common_model__WEBPACK_IMPORTED_MODULE_7__["LookupQueryInfo"]();
            dropDownListModel.Id = this.modelFE.KhoaPhongId;
            this.apiService.post(`${this.controllerName}/GetListPhongBenhVienByKhoa`, dropDownListModel).subscribe(res => {
                this.data = [...res];
            });
        }
    }
...
KhoDuocPhamShareComponent.ctorParameters = () => [
...
let KhoDuocPhamUpdateComponent = class KhoDuocPhamUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
KhoDuocPhamUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_kho_duoc_pham_share_kho_duoc_pham_share_component__WEBPACK_IMPORTED_MODULE_5__["KhoDuocPhamShareComponent"], { static: true })
...
let KhoDuocPhamModule = class KhoDuocPhamModule {
};
...
let KhoDuocPhamService = class KhoDuocPhamService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'KhoDuocPham';
    }
};
KhoDuocPhamService.ctorParameters = () => [
