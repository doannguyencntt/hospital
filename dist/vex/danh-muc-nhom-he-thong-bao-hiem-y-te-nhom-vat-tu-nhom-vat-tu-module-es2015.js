...
let NhomVatTuListComponent = class NhomVatTuListComponent {
    ...
    iconClass({ text, ListNhomVatTuChildren }) {
        return {
    ...
    ngOnInit() {
        ...
        this.baseService.getDataForGrid(this._gridQueryInfo, "NhomVatTu/GetDataTreeView").subscribe((resultData) => {
...
NhomVatTuListComponent.ctorParameters = () => [
...
let NhomVatTuRoutingModule = class NhomVatTuRoutingModule {
};
...
let NhomVatTuModule = class NhomVatTuModule {
};
...
let NhomVatTuService = class NhomVatTuService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'NhomVatTu';
    }
};
NhomVatTuService.ctorParameters = () => [
