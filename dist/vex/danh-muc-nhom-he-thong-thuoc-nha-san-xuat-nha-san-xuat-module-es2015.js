...
let NhaSanXuatCreateComponent = class NhaSanXuatCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
NhaSanXuatCreateComponent.ctorParameters = () => [
...
let NhaSanXuatListComponent = class NhaSanXuatListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('NhaSanXuat/ExportNhaSanXuat', self.gridNhaSanXuat._gridQueryInfo).subscribe(resultData => {
...
NhaSanXuatListComponent.ctorParameters = () => [
...
let NhaSanXuatRoutingModule = class NhaSanXuatRoutingModule {
};
...
let NhaSanXuatSharedComponent = class NhaSanXuatSharedComponent {
    ...
    ngOnInit() {
        ...
        let newNhaSanXuat = new _nha_san_xuat_model__WEBPACK_IMPORTED_MODULE_2__["NhaSanXuatTheoQuocGias"]();
...
NhaSanXuatSharedComponent.ctorParameters = () => [
...
let NhaSanXuatUpdateComponent = class NhaSanXuatUpdateComponent {
...
NhaSanXuatUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
class NhaSanXuat {
    constructor(Id = 0, Ma = null, Ten = null, NhaSanXuatTheoQuocGias = []) {
        this.Id = Id;
        this.Ma = Ma;
        this.Ten = Ten;
...
class NhaSanXuatTheoQuocGias {
    constructor(NhaSanXuatId = 0, QuocGiaId = 0, DiaChi = "", TenQuocGia = null) {
...
let NhaSanXuatModule = class NhaSanXuatModule {
};
...
let NhaSanXuatService = class NhaSanXuatService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'NhaSanXuat';
    }
};
NhaSanXuatService.ctorParameters = () => [
