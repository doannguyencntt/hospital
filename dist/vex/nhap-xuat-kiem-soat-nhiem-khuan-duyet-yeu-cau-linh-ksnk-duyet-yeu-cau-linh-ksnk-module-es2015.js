...
let DuyetYeuCauLinhKSNKBuSharedComponent = class DuyetYeuCauLinhKSNKBuSharedComponent {
    ...
    getById(id) {
        ...
        this.apiService.post("YeuCauLinhKSNK/GetYeuCauLinhKSNKBu", model)
            ...
            if (resultData !== undefined && resultData != null) {
                ...
                this.trangThaiYeuCau.emit(new _duyet_yeu_cau_linh_ksnk_model__WEBPACK_IMPORTED_MODULE_5__["TrangThaiDuyetYeuCauLinh"](this.yeuCauLinh.TenTrangThai, this.yeuCauLinh.DuocDuyet));
                this.gridColumns = [
                    { Field: "STT", Title: "#", Width: 60, Template: this.sttTemplate },
                    { Field: "TenVatTu", Title: "Tên vật tư", Width: 180 },
                    { Field: "Nhom", Title: "Nhóm", Width: 100, Sortable: true, Hidden: true, TemplateGroupHeader: this.nhomGroupHeaderTemplate },
...
DuyetYeuCauLinhKSNKBuSharedComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhKSNKBuComponent = class DuyetYeuCauLinhKSNKBuComponent {
        ...
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_2__["ConfirmComponent"], {
            ...
            if (result === 'Yes') {
                ...
                this.apiService.post("YeuCauLinhKSNK/XuLyDuyetYeuCauLinhKSNKBu", this.yeuCauLinhKSNK)
                    ...
                    if (resultData != undefined && resultData != null) {
                        this.dialog.open(_phieu_xuat_linh_ksnk_popup_phieu_xuat_linh_ksnk_popup_component__WEBPACK_IMPORTED_MODULE_7__["PhieuXuatLinhKSNKPopupComponent"], {
                            disableClose: false,
                            width: '1200px',
                            data: resultData,
                        }).afterClosed().subscribe(result => {
...
DuyetYeuCauLinhKSNKBuComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhKSNKListComponent = class DuyetYeuCauLinhKSNKListComponent {
    ...
    exportExcel() {
        ...
        self.apiService.postExportExcel('YeuCauLinhKSNK/ExportDanhSachDuyetLinhKSNK', self.exportQueryInfoQueryInfo).subscribe(resultData => {
    ...
    InDuocPham(dataItem, loaiPhieuLinh, loai) {
        ...
        if (loai == true) {
            this.apiService.post("YeuCauLinhDuocPham/InYeuCauLinhDuocPhamTrucTiep?yeuCauLinhId=" + dataItem + "&loaiPhieuLinh=" + 1)
                .subscribe((resultData) => {
                if (resultData != undefined && resultData != null) {
                    this.dialog.open(_phieu_xuat_linh_ksnk_popup_phieu_xuat_linh_ksnk_popup_component__WEBPACK_IMPORTED_MODULE_21__["PhieuXuatLinhKSNKPopupComponent"], {
                        disableClose: false,
                        width: '1200px',
                        data: resultData,
                    }).afterClosed().subscribe(result => {
...
DuyetYeuCauLinhKSNKListComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhKSNKRoutingModule = class DuyetYeuCauLinhKSNKRoutingModule {
};
...
let DuyetYeuCauLinhKSNKThuongSharedComponent = class DuyetYeuCauLinhKSNKThuongSharedComponent {
    constructor(apiService, route, notificationService) {
        this.apiService = apiService;
        this.route = route;
        this.notificationService = notificationService;
    ...
    getById(id) {
        ...
        this.apiService.post("YeuCauLinhKSNK/GetYeuCauLinhKSNKThuong", model)
            ...
            if (resultData !== undefined && resultData != null) {
                ...
                this.trangThaiYeuCau.emit(new _duyet_yeu_cau_linh_ksnk_model__WEBPACK_IMPORTED_MODULE_6__["TrangThaiDuyetYeuCauLinh"](this.yeuCauLinh.TenTrangThai, this.yeuCauLinh.DuocDuyet));
                this.gridDataSource = {
                    data: this.yeuCauLinh.DuyetYeuCauLinhVatTuChiTiets,
                    total: this.yeuCauLinh.DuyetYeuCauLinhVatTuChiTiets.length
                };
...
DuyetYeuCauLinhKSNKThuongSharedComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhKSNKThuongComponent = class DuyetYeuCauLinhKSNKThuongComponent {
    constructor(dialog, location, apiService, notificationService, router, route) {
        this.dialog = dialog;
        this.location = location;
        this.apiService = apiService;
...
DuyetYeuCauLinhKSNKThuongComponent.ctorParameters = () => [
...
class DuyetYeuCauLinhKSNK {
    constructor(Id = null, KhoXuatId = null, TenKhoXuat = null, KhoNhapId = null, TenKhoNhap = null, LoaiPhieuLinh = null, TenLoaiPhieuLinh = null, NhanVienYeuCauId = null, TenNhanVienYeuCau = null, NhanVienDuyetId = null, TenNhanVienDuyet = null, NgayYeuCau = null, NgayDuyet = null, GhiChu = null, SlYeuCau = null, NguoiXuatKhoId = null, TenNguoiXuatKho = null, NguoiNhapKhoId = null, TenNguoiNhapKho = null, isHideDuyet = false, DuocDuyet = null, TenTrangThai = null, LyDoKhongDuyet = null, DuyetYeuCauLinhVatTuChiTiets = [], LastModified = null, LoaiDuocPhamHayVatTu = null) {
        this.Id = Id;
...
class DuyetYeuCauLinhVatTuChiTiet {
    constructor(VatTuBenhVienId = null, LaVatTuBhyt = null, TenDuocPham = null, NongDoHamLuong = null, HoatChat = null, DuongDung = null, Dvt = null, HangSanXuat = null, NuocSanXuat = null, SlTon = null, SoLuong = null, Nhom = null, Index = null, LoaiDuocPhamHayVatTu = null) {
...
let DuyetYeuCauLinhKSNKModule = class DuyetYeuCauLinhKSNKModule {
};
...
let PhieuXuatLinhKSNKPopupComponent = class PhieuXuatLinhKSNKPopupComponent {
    constructor(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
...
PhieuXuatLinhKSNKPopupComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
];
