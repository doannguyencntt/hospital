...
let BaoCaoNguoiBenhDenLamDvktListComponent = class BaoCaoNguoiBenhDenLamDvktListComponent {
    ...
    XemBaoCao(isChagePage = false) {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoNguoiBenhDenLamDVKTForGrid", this.queryInfo).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                ...
                this._isLoading = false;
                this.apiService.post("BaoCao/GetTotalBaoCaoNguoiBenhDenLamDVKTForGrid", this.queryInfo).subscribe(resultDataTotal => {
...
BaoCaoNguoiBenhDenLamDvktListComponent.ctorParameters = () => [
...
let BaoCaoNguoiBenhDenLamDvktRoutingModule = class BaoCaoNguoiBenhDenLamDvktRoutingModule {
};
...
class BaoCaoNguoiBenhDenLamDvktTimKiemNangCao {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, SearchString = "") {
...
let BaoCaoNguoiBenhDenLamDvktModule = class BaoCaoNguoiBenhDenLamDvktModule {
};
