...
let NoiDungMauPdfListComponent = class NoiDungMauPdfListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("Template/ExportTemplate", this.gridChild._gridQueryInfo).subscribe(res => {
...
NoiDungMauPdfListComponent.ctorParameters = () => [
...
let NoiDungMauPdfRoutingModule = class NoiDungMauPdfRoutingModule {
};
...
let NoiDungMauPdfShareComponent = class NoiDungMauPdfShareComponent {
...
NoiDungMauPdfShareComponent.ctorParameters = () => [
...
let NoiDungMauPdfUpdateComponent = class NoiDungMauPdfUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
NoiDungMauPdfUpdateComponent.ctorParameters = () => [
...
let NoiDungMauPdfModule = class NoiDungMauPdfModule {
};
...
let NoiDungMauPdfService = class NoiDungMauPdfService extends _app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'Template';
    }
};
NoiDungMauPdfService.ctorParameters = () => [
