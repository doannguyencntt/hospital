...
let DsTongHopDuTruMuaKSNKTaiKhoaComponent = class DsTongHopDuTruMuaKSNKTaiKhoaComponent {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
            ...
            this.confrim = this.dialog.open(null, {
                ...
                if (result !== '' && result) {
                    ...
                    this.apiService.post('YeuCauMuaKSNK/TuChoiDuyetTaiKhoa', this.thongTinLyDoHuyDuyetTaiKhoa)
    ...
    PheDuyet(id) {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
            ...
            this.confrim = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_28__["ConfirmComponent"], {
                ...
                .subscribe((result) => {
                if (result === 'Yes') {
                    this.apiService.post('YeuCauMuaKSNK/DuyetTaiKhoa/', this.duyetDuTruMuaVatTuViewModel)
                        .subscribe((resultData) => {
                        if (resultData !== null && resultData !== undefined) {
                            if (resultData) {
                                this.gridChoDuyet.search();
    ...
    HuyDuyet(id) {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
            ...
            this.confrim = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_28__["ConfirmComponent"], {
                ...
                if (result === 'Yes') {
                    this.apiService.post('YeuCauMuaKSNK/HuyDuyetTaiKhoa/' + id)
                        .subscribe((resultData) => {
                        if (resultData !== null && resultData !== undefined) {
                            if (resultData) {
                                this.gridChoDuyet.search();
...
DsTongHopDuTruMuaKSNKTaiKhoaComponent.ctorParameters = () => [
...
let PhieuMuaTruKSNKTaiKhoaComponent = class PhieuMuaTruKSNKTaiKhoaComponent {
    ...
    xemPhieuVatTuVaDuocPham() {
        ...
        self.apiService.post('YeuCauMuaKSNK/InPhieuVatTuVaDuocPhamTaiKhoa', self.inPhieu).subscribe(resData => {
            if (resData) {
    ...
    xemPhieuVatTu() {
        ...
        self.inPhieu.DuTruMuaVatTuTheoKhoaId = self.data.Id;
        self.inPhieu.Header = true;
        self.apiService.post('YeuCauMuaKSNK/InPhieuDuTruMuaTaiKhoa', self.inPhieu).subscribe(resData => {
            if (resData) {
                self.inPhieu.Header = false;
                self.dataHTML = resData;
                self.src = 'data:text/html;charset=utf-8,' + encodeURIComponent(resData);
...
PhieuMuaTruKSNKTaiKhoaComponent.ctorParameters = () => [
...
let TongHopDuTruMuaKSNKTaiKhoaDetailComponent = class TongHopDuTruMuaKSNKTaiKhoaDetailComponent {
    ...
    GetTrangThaiPhieuMuaDuTru(id) {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].View)) {
            self.apiService.get("YeuCauMuaKSNK/GetTrangThaiPhieuMuaKSNK?phieuMuaKSNKId=" + id).subscribe((result) => {
...
TongHopDuTruMuaKSNKTaiKhoaDetailComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
...
let TongHopDuTruMuaKSNKTaiKhoaDuyetComponent = class TongHopDuTruMuaKSNKTaiKhoaDuyetComponent {
...
TongHopDuTruMuaKSNKTaiKhoaDuyetComponent.ctorParameters = () => [
...
let TongHopDuTruMuaKSNKTaiKhoaRoutingModule = class TongHopDuTruMuaKSNKTaiKhoaRoutingModule {
};
...
let TongHopDuTruMuaKSNKTaiKhoaSharedComponent = TongHopDuTruMuaKSNKTaiKhoaSharedComponent_1 = class TongHopDuTruMuaKSNKTaiKhoaSharedComponent {
...
TongHopDuTruMuaKSNKTaiKhoaSharedComponent.ctorParameters = () => [
...
class TongHopDuTruMuaVatTuTaiKhoaSreach {
    constructor(Id = 0, NgayYeuCauTuFormat = null, NgayYeuCauDenFormat = null, FromDate = null, ToDate = null, ChoDuyet = true, DaDuyet = true, DaDuyetDaXuLy = true, DaGuiChoDuyet = true, TuChoiDuyet = true, SearchString = null, SearchStringDaXuLy = null, SearchStringTuChoi = null, RangeFromDate = new _xuat_kho_ksnk_xuat_kho_ksnk_xuat_kho_ksnk_model__WEBPACK_IMPORTED_MODULE_1__["RangeDate"](), RangeFromDateDaXuLy = new _xuat_kho_ksnk_xuat_kho_ksnk_xuat_kho_ksnk_model__WEBPACK_IMPORTED_MODULE_1__["RangeDate"](), RangeFromDateTuChoi = new _xuat_kho_ksnk_xuat_kho_ksnk_xuat_kho_ksnk_model__WEBPACK_IMPORTED_MODULE_1__["RangeDate"]()) {
        this.Id = Id;
...
class PhieuInDuTruMuaTaiKhoa {
    constructor(DuTruMuaVatTuTheoKhoaId = null, DuTruMuaDuocPhamTheoKhoaId = null, Header = null) {
...
let TongHopDuTruMuaKSNKTaiKhoaModule = class TongHopDuTruMuaKSNKTaiKhoaModule {
};
