(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-ket-qua-kham-chua-benh-kt-bao-cao-ket-qua-kham-chua-benh-kt-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachBaoCaoKetQuaKhamChuaBenhKTRoutingModule = /** @class */ (function () {
                function DanhSachBaoCaoKetQuaKhamChuaBenhKTRoutingModule() {
                }
                return DanhSachBaoCaoKetQuaKhamChuaBenhKTRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachBaoCaoKetQuaKhamChuaBenhKTModule = /** @class */ (function () {
                function DanhSachBaoCaoKetQuaKhamChuaBenhKTModule() {
                }
                return DanhSachBaoCaoKetQuaKhamChuaBenhKTModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoKetQuaKhamChuaBenh = /** @class */ (function () {
                function BaoCaoKetQuaKhamChuaBenh(TuNgay, DenNgay) {
                    if (TuNgay === void 0) { TuNgay = null; }
                    if (DenNgay === void 0) { DenNgay = null; }
                    this.TuNgay = TuNgay;
                    this.DenNgay = DenNgay;
                }
                return BaoCaoKetQuaKhamChuaBenh;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent = /** @class */ (function () {
                function DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent(apiService, dialog, notificationService, authService, ref) {
                ...
                DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent.prototype.ngOnInit = function () {
                ...
                DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent.prototype.getMonday = function (d) {
                    d = new Date(d);
                    var day = d.getDay(), diff = d.getDate() - day + (day == 0 ? -6 : 1); // adjust when day is sunday
                    return new Date(d.setDate(diff));
                };
                DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent.prototype.xemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetDataBaoCaoKetQuaKhamChuaBenhKTForGrid", this.baoCaoSearch).subscribe(function (resultData) {
                ...
                DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent.prototype.xuatBaoCao = function () {
                    var self = this;
                    if (this.baoCaoSearch.TuNgay == null || this.baoCaoSearch.DenNgay == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent.prototype.showLoadingPopup = function () {
                ...
                DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent.prototype.showSavingPopup = function () {
                    if (!this.loadingPopup) {
                        this.loadingPopup = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_8__["LoadingComponent"], {
                            disableClose: true,
                            width: '200px',
                ...
                DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent.prototype.closeAllDialogs = function () {
                    if (this.loadingPopup) {
                        this.loadingPopup.close();
                        this.loadingPopup = null;
                    }
                };
                return DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent;
            }());
            DanhSachBaoCaoKetQuaKhamChuaBenhKTComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-ket-qua-kham-chua-benh-kt-bao-cao-ket-qua-kham-chua-benh-kt-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-ket-qua-kham-chua-benh-kt-bao-cao-ket-qua-kham-chua-benh-kt-module-es5.js.map