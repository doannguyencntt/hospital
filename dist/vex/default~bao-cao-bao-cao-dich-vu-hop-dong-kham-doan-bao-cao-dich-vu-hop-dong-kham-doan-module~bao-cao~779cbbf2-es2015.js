...
let DanhSachNhomDichVuThuongDungComponent = class DanhSachNhomDichVuThuongDungComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel('NhomDichVuThuongDung/ExportGoiDichVu', this.gridChild._gridQueryInfo).subscribe(res => {
...
DanhSachNhomDichVuThuongDungComponent.ctorParameters = () => [
...
let NhomDichVuThuongDungCreatePopupComponent = class NhomDichVuThuongDungCreatePopupComponent {
    constructor(router, data, dialogRef) {
        this.router = router;
        this.data = data;
...
NhomDichVuThuongDungCreatePopupComponent.ctorParameters = () => [
...
let NhomDichVuThuongDungCreateComponent = class NhomDichVuThuongDungCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
NhomDichVuThuongDungCreateComponent.ctorParameters = () => [
...
let NhomDichVuThuongDungRoutingModule = class NhomDichVuThuongDungRoutingModule {
};
...
let NhomDichVuThuongDungSharedComponent = class NhomDichVuThuongDungSharedComponent {
    constructor(route, apiService, authService, baseService, dialog, cdRef, notificationService) {
        this.route = route;
        this.apiService = apiService;
        this.authService = authService;
            ...
            switch (this.luaChonGoiDichVu) {
                ...
                case 2: {
                    this.apiService.post('GoiDichVu/GetChiPhiHienTaiDichVuKyThuat?dichVuKyThuatBenhVienId=' + this.dvTrongGois.DvId +
                        ...
                        if (this.dvTrongGois.SoLuong === null)
                            this.dvTrongGois.SoLuong = 1;
                        this.dvTrongGois.ThanhTien = this.dvTrongGois.SoLuong != null ?
                            resultData * this.dvTrongGois.SoLuong : resultData;
                    });
    ...
    AddingAfterValidation(loaiNhom) {
        if (this.validationErrors && !this.validationErrors.some(x => x)) {
            ...
            this.apiService.get('GoiDichVuMarketing/GetResultEnumDichVuTongHop?enumTongHop=' + this.dvTrongGois.Nhom).subscribe((resultData) => {
                ...
                let goiDichVuModel = new _nhom_dich_vu_thuong_dung__WEBPACK_IMPORTED_MODULE_14__["DvTrongGoi"]();
    ...
    checkExistOnKhamBenh(dichVuKhamBenhBenhVienId) {
    ...
    checkExistOnAmendationForKhamBenh(dichVuKhamBenhBenhVienId, position) {
...
NhomDichVuThuongDungSharedComponent.ctorParameters = () => [
...
let NhomDichVuThuongDungUpdateComponent = class NhomDichVuThuongDungUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
NhomDichVuThuongDungUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('footer', { static: false })
...
let NhomDichVuThuongDungModule = class NhomDichVuThuongDungModule {
};
...
class GoiDichVu {
    constructor(Id = 0, TenGoiDv = null, IsDisabled = false, MoTa = null, LoaiGoiDichVu = 2, BoPhanId = null, TenBoPhan = null, DvTrongGois = []) {
        this.Id = Id;
...
class DvTrongGoi {
    constructor(Id = null, MaDv = null, TenDv = null, DvId = null, LoaiGia = 1, GoiDichVuId = null, LoaiGiaDisplay = null, SoLuong = null, IdDatabase = null, DonGia = null, ThanhTien = null, GhiChu = null, Nhom = null, // 1 là khám bệnh, 2 là kỹ thuật, 3 là giường bệnh
    NhomDisplay = null) {
        this.Id = Id;
        this.MaDv = MaDv;
        this.TenDv = TenDv;
