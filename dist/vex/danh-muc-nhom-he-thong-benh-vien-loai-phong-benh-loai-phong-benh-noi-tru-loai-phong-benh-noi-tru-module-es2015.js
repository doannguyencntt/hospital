...
let LoaiPhongBenhNoiTruCreateComponent = class LoaiPhongBenhNoiTruCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
LoaiPhongBenhNoiTruCreateComponent.ctorParameters = () => [
...
let LoaiPhongBenhNoiTruListComponent = class LoaiPhongBenhNoiTruListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('LoaiPhongBenhNoiTru/ExportLoaiPhongBenhNoiTru', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
LoaiPhongBenhNoiTruListComponent.ctorParameters = () => [
...
let LoaiPhongBenhNoiTruRoutingModule = class LoaiPhongBenhNoiTruRoutingModule {
};
...
let LoaiPhongBenhNoiTruSharedComponent = class LoaiPhongBenhNoiTruSharedComponent {
...
LoaiPhongBenhNoiTruSharedComponent.ctorParameters = () => [
...
let LoaiPhongBenhNoiTruUpdateComponent = class LoaiPhongBenhNoiTruUpdateComponent {
...
LoaiPhongBenhNoiTruUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let LoaiPhongBenhNoiTruModule = class LoaiPhongBenhNoiTruModule {
};
...
let LoaiPhongBenhNoiTruService = class LoaiPhongBenhNoiTruService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'LoaiPhongBenhNoiTru';
    }
};
LoaiPhongBenhNoiTruService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
