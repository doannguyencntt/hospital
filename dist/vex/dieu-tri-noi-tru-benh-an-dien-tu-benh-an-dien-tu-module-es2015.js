...
let BenhAnDienTuBenhAnPopupComponent = class BenhAnDienTuBenhAnPopupComponent {
    constructor(data, dialogRef, notificationService) {
        this.data = data;
...
BenhAnDienTuBenhAnPopupComponent.ctorParameters = () => [
...
let BenhAnDienTuListComponent = class BenhAnDienTuListComponent {
    ...
    timKiemNangCao() {
        ...
        this.apiService.post("BenhAnDienTu/TimKiemNoiTruBenhAn", this.timKiemNangCaoObj).subscribe((res) => {
    ...
    showPopupTimKiemNguoiBenh() {
        let dialogRef = this.dialog.open(_benh_an_dien_tu_benh_an_popup_benh_an_dien_tu_benh_an_popup_component__WEBPACK_IMPORTED_MODULE_21__["BenhAnDienTuBenhAnPopupComponent"], {
            disableClose: false,
            width: '1400px',
            height: '600px',
    ...
    getGayBenhAnDienTuTheoBenhAn() {
        if (this.noiTruBenhAnId != null && this.noiTruBenhAnId != 0) {
            this.showPopupLoadingData();
            this.apiService.get("BenhAnDienTu/GetGayBenhAnDienTuTheoBenhAn?noiTruBenhAnId=" + this.noiTruBenhAnId).subscribe((res) => {
                this.closePopupLoadingData();
                if (res) {
    ...
    chonGayBenhAn(gayBenhAn, indexGay = 0) {
    ...
    getThongTinTheoGayBenhAn(gayBenhAn, indexGay = 0, isLoadPrev = false, isLoadNext = false, layTatCa = false) {
        ...
        let thongTinBenhAnCanIn = new _benh_an_dien_tu_model__WEBPACK_IMPORTED_MODULE_15__["BenhAnDienTuDetail"]();
        ...
        if (gayBenhAn != null && gayBenhAn.Htmls && !layTatCa) {
            ...
            this.apiService.post('BenhAnDienTu/GetFilePDFBenhAnDienTuFromHtml', thongTinBenhAnCanIn).subscribe(htmls => {
                if (gayBenhAn != undefined && gayBenhAn != null) {
    ...
    showPopupLoadingData(typeLoading = src_app_shared_enum_kham_benh_enum__WEBPACK_IMPORTED_MODULE_19__["EnumTypeLoadingData"].View) {
    ...
    phieuInTaCa() {
        let arrFileUrl = [];
        let arrFilePdf = [];
        let loading = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_20__["LoadingComponent"], {
            disableClose: true,
            width: "200px",
            height: "90px",
            data: {},
        ...
        this.apiService.postExportPdf("DieuTriNoiTru/InPhieuThu?yeuCauTiepNhanId=" + this.noiTruBenhAnId + "&hostingName=" + hostingName).subscribe((file) => {
            let newBlob = new Blob([file], { type: "application/pdf" });
            let datalocalURL = window.URL.createObjectURL(newBlob);
    ...
    phieuInChiPhiTheoKhoa() {
        ...
        let hostingName = window.location.protocol + '//' + window.location.host;
        this.apiService.postExportPdf("DieuTriNoiTru/XemBangKeChiPhiTheoKhoa?yeuCauTiepNhanId=" + this.noiTruBenhAnId + "&hostingName=" + hostingName).subscribe((file) => {
            let newBlob = new Blob([file], { type: "application/pdf" });
            let datalocalURL = window.URL.createObjectURL(newBlob);
            arrFileUrl.push(datalocalURL);
            arrFilePdf.push(file);
...
BenhAnDienTuListComponent.ctorParameters = () => [
...
let BenhAnDienTuRoutingModule = class BenhAnDienTuRoutingModule {
};
...
class BenhAnDienTuTimKiemNangCao {
    constructor(SearchString = null, TuNgayDenNgayNhapVien = new BenhAnDienTuTimKiemTuNgayDenNgay(), TuNgayDenNgayXuatVien = new BenhAnDienTuTimKiemTuNgayDenNgay()) {
        this.SearchString = SearchString;
        this.TuNgayDenNgayNhapVien = TuNgayDenNgayNhapVien;
        this.TuNgayDenNgayXuatVien = TuNgayDenNgayXuatVien;
    }
}
class BenhAnDienTuTimKiemTuNgayDenNgay {
...
class BenhAnDienTuDetail {
    constructor(NoiTruBenhAnId = null, MaYeuCauTiepNhan = null, BenhNhanId = null, Hosting = null, LaInPhieu = false, GayBenhAns = []) {
...
class BenhAnDienTuMenuInfo {
    constructor(ViTri = null, TenGayHoSo = null, ChiTietHoSos = []) {
        this.ViTri = ViTri;
        this.TenGayHoSo = TenGayHoSo;
        this.ChiTietHoSos = ChiTietHoSos;
    }
}
class BenhAnDienTuChiTietMenuInfo {
    constructor(LoaiHoSo = null, Value = null) {
...
let BenhAnDienTuModule = class BenhAnDienTuModule {
};
