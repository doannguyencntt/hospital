...
let DuyetVatTuNhapKhoChiTietComponent = class DuyetVatTuNhapKhoChiTietComponent {
    ...
    duyet() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
            ...
            this.confrim = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.apiService.post("KeToan/DuyetDuocVatTuKho/" + this.yeuCauNhapKhoVatTuId)
                        .subscribe((resultData) => {
                        if (resultData !== null && resultData !== undefined) {
                            if (resultData === "") {
                                ...
                                this.dialog.open(_nhap_xuat_vat_tu_nhap_kho_xac_nhan_chon_phieu_in_vat_tu_popup_xac_nhan_chon_phieu_in_vat_tu_popup_component__WEBPACK_IMPORTED_MODULE_16__["XacNhanChonPhieuInVatTuPopupComponent"], {
                                    disableClose: false,
                                    width: "400px",
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
            ...
            this.confrim = this.dialog.open(_tu_choi_duyet_vat_tu_tu_choi_duyet_vat_tu_component__WEBPACK_IMPORTED_MODULE_13__["TuChoiDuyetVatTuComponent"], {
                ...
                if (result != "" && result != undefined) {
                    ...
                    this.apiService.post("KeToan/TuChoiDuyetVatTuNhapKho", this.thongTinLyDoHuyNhapKhoVatTu)
                        .subscribe((resultData) => {
                        if (resultData !== null && resultData !== undefined) {
                            if (resultData) {
...
DuyetVatTuNhapKhoChiTietComponent.ctorParameters = () => [
...
let DuyetVatTuNhapKhoListComponent = class DuyetVatTuNhapKhoListComponent {
    constructor(authService, cd, dialog, elem, notificationService, apiService, router, route) {
        this.authService = authService;
        this.cd = cd;
        this.dialog = dialog;
        this.elem = elem;
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('KeToan/ExportDuyetVatTu', self.gridCha._gridQueryInfo).subscribe(resultData => {
    ...
    duyetLai(id) {
        var self = this;
        self.loadingPage();
        self.apiService.post("KeToan/HuyDuyetNhapKhoVatTu?yeuCauNhapKhoVatTuId=" + id).subscribe(() => {
            self.closePopupLoadingDatas();
...
DuyetVatTuNhapKhoListComponent.ctorParameters = () => [
...
let DuyetVatTuNhapKhoRoutingModule = class DuyetVatTuNhapKhoRoutingModule {
};
...
let DuyetVatTuNhapKhoModule = class DuyetVatTuNhapKhoModule {
};
