...
let KhoaPhongCreateComponent = class KhoaPhongCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
KhoaPhongCreateComponent.ctorParameters = () => [
...
let KhoaPhongListComponent = class KhoaPhongListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('KhoaPhong/ExportKhoaPhong', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
KhoaPhongListComponent.ctorParameters = () => [
...
let KhoaPhongRoutingModule = class KhoaPhongRoutingModule {
};
...
let KhoaPhongSharedComponent = class KhoaPhongSharedComponent {
...
KhoaPhongSharedComponent.ctorParameters = () => [
...
let KhoaPhongUpdateComponent = class KhoaPhongUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
KhoaPhongUpdateComponent.ctorParameters = () => [
...
let KhoaPhongModule = class KhoaPhongModule {
};
...
let KhoaPhongService = class KhoaPhongService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'KhoaPhong';
    }
};
KhoaPhongService.ctorParameters = () => [
