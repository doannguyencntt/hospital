...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~kham-benh-kham-doan-tat-ca-phong-kham-doan-tat-ca-phong-module~kham-doan-kham-doan-ket-luan-~89aa333d"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanChuaKetLuanKskListComponent = /** @class */ (function () {
                function KhamDoanChuaKetLuanKskListComponent(apiService, authService, router, notificationService, dialog, route, location) {
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.ngOnInit = function () {
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.backWithSearch = function () {
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                KhamDoanChuaKetLuanKskListComponent.prototype.clearSearch = function () {
                    this.khamDoanChuaKetLuanSearch.SearchString = null;
                    this.gridChild.search();
                };
                KhamDoanChuaKetLuanKskListComponent.prototype.searchChanges = function (event) {
                    var self = this;
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.trangThaiCheckBox = function (event, tinhTrang) {
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.timKiem = function () {
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.congTyKhamSucKhoeChange = function (event) {
                    this.khamDoanChuaKetLuanSearch.LaHopDongDaKetLuan = false;
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.soHopDongChange = function (event) {
                    this.khamDoanChuaKetLuanSearch.LaHopDongDaKetLuan = false;
                    if (event != undefined && event != null) {
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.chinhSua = function (id, yeuCauTiepNhanId, congTyKhamSucKhoeId, hopdongId) {
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                KhamDoanChuaKetLuanKskListComponent.prototype.redirectKetLuan = function () {
                    this.router.navigate(['/kham-doan/ket-luan-kham-suc-khoe-doan'], { queryParams: { "holdQuery": true } });
                };
                KhamDoanChuaKetLuanKskListComponent.prototype.changeLookupHopDong = function (event) {
                ...
                return KhamDoanChuaKetLuanKskListComponent;
            }());
            KhamDoanChuaKetLuanKskListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanDaKetLuanKskListComponent = /** @class */ (function () {
                function KhamDoanDaKetLuanKskListComponent(authService, router, notificationService, route) {
                    this.authService = authService;
                    this.router = router;
                    this.notificationService = notificationService;
                    this.route = route;
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_2__["DocumentType"].KhamDoanKetLuanKhamSucKhoeDoan;
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.backWithSearch = function () {
                    var hasLocalSearchString = false;
                    if (this.route.snapshot.queryParams.holdQuery != undefined) {
                        var holdQuery = this.route.snapshot.queryParams.holdQuery;
                        if (holdQuery != null && holdQuery) {
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                KhamDoanDaKetLuanKskListComponent.prototype.clearSearch = function () {
                    this.khamDoanDaKetLuanSearch.SearchString = null;
                    this.gridChildDaKetLuan.search();
                };
                KhamDoanDaKetLuanKskListComponent.prototype.searchChanges = function (event) {
                    var self = this;
                    if (event != undefined && (event == null || event == "")) {
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.trangThaiCheckBox = function (event, tinhTrang) {
                    if (tinhTrang == "chuaketluan") {
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.timKiem = function () {
                    // this.location.replaceState(this.baseRoute + '?holdQuery=true');
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.congTyKhamSucKhoeChange = function (event) {
                    // this.location.replaceState(this.baseRoute + '?holdQuery=true');
                    this.changeDataCongTy = true;
                    if (event != undefined && event != null) {
                        this.router.navigateByUrl('/kham-doan/kham-doan-ket-luan-cls-ksk?holdQuery=true');
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.soHopDongChange = function (event) {
                    if (event != undefined && event != null) {
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.chinhSua = function (id, yeuCauTiepNhanId, congTyKhamSucKhoeId, hopdongId) {
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.openCombobox = function (event) {
                    if (event) {
                        this.isSelectDuocPham = true;
                    }
                    else {
                ...
                KhamDoanDaKetLuanKskListComponent.prototype.changeLookupHopDong = function (event) {
                    if (!this.lanDauLoadData && this.changeDataCongTy) {
                ...
                return KhamDoanDaKetLuanKskListComponent;
            }());
            KhamDoanDaKetLuanKskListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanKetLuanClsKskDoanDetailComponent = /** @class */ (function () {
                function KhamDoanKetLuanClsKskDoanDetailComponent(apiService, route, notificationService, authService, dialog, router, http, baseService) {
                    this.apiService = apiService;
                    this.route = route;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.ngOnInit = function () {
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.checkHopDongKetThuc = function (hopDongId, congTyId) {
                    var _this = this;
                    var model = {
                        HopDongId: hopDongId,
                        congTyId: congTyId
                    ...
                    this.apiService.post("KhamDoan/CheckHopDongKetThuc", model)
                        ...
                        _this.trangThaiHopDong = resultData;
                    }, function (err) {
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.onDataBound = function (event) {
                    this.data = event;
                };
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.ketQuaMau = function () {
                    var _this = this;
                    this.apiService.post("KhamDoan/GetListKetQuaTheoYeuCauTiepNhan?yeuCauTiepNhanId=" + this.yeuCauTiepNhanId)
                        ...
                        _this.dialog
                            ...
                            if (result != undefined) {
                                _this.khamDoanKetLuanCLS.KSKKetQuaCanLamSang = "";
                                var number_1 = 1;
                                var resultLenght_1 = result.length;
                                result.forEach(function (element) {
                                    if (element.IsCheck == true) {
                                        _this.khamDoanKetLuanCLS.KSKKetQuaCanLamSang += element.KetQuaCLS;
                                        if (resultLenght_1 > number_1) {
                                            _this.khamDoanKetLuanCLS.KSKKetQuaCanLamSang += "; ";
                                        }
                                        number_1++;
                                    }
                ...
                // cls
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.showPopupLoadingData = function () {
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.OpenClickPopupXemKetQuaCLS = function (dataItem) {
                    var _this = this;
                    if (dataItem.TenGuidList.length == 1) {
                        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_14__["HttpParams"]({
                            fromObject: {
                        ...
                        this.apiService
                            ...
                            if (result) {
                                if (dataItem.TenGuid.indexOf(".pdf") != -1 ||
                                    ...
                                    _this.dialog.open(src_app_shared_component_dialogs_view_image_pdf_view_image_pdf_component__WEBPACK_IMPORTED_MODULE_15__["ViewImagePdfComponent"], {
                                        disableClose: false,
                                        width: "1000px",
                                        height: "600px",
                                        data: {
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.downloadFile = function (dataItem) {
                    var _this = this;
                    ...
                    dataItem.TenGuidList.forEach(function (element) {
                        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_14__["HttpParams"]({
                            fromObject: {
                        ...
                        _this.apiService
                            ...
                            var options = new _angular_http__WEBPACK_IMPORTED_MODULE_11__["RequestOptions"]({ responseType: _angular_http__WEBPACK_IMPORTED_MODULE_11__["ResponseContentType"].Blob });
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.xemKetQua = function (dataItem) {
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.taiKetQua = function (dataItem) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var obj, html, objHtml, file, newBlob, datalocalURL, options;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.apiService.post("CanLamSang/XuLyInPhieuKetQua", obj).toPromise()
                                            .catch(function (err) {
                                            if (err.Message !== 'Validation Failed') {
                                                _this.notificationService.showError(err.Message);
                                            }
                                ...
                                case 1:
                                    html = _a.sent();
                                    if (!(html != undefined)) return [3 /*break*/, 3];
                                    objHtml = {
                                        "Html": html,
                                        "TenFile": "KetQuaCDHATDCN"
                                    };
                                    return [4 /*yield*/, this.apiService.postExportPdf('CanLamSang/GetFilePDFFromHtml', objHtml).toPromise()
                                            .catch(function (err) {
                                            if (err.Message !== 'Validation Failed') {
                                                _this.notificationService.showError(err.Message);
                                            }
                                ...
                                case 2:
                                    ...
                                    if (file != undefined) {
                                        ...
                                        datalocalURL = window.URL.createObjectURL(newBlob);
                                        options = new _angular_http__WEBPACK_IMPORTED_MODULE_11__["RequestOptions"]({ responseType: _angular_http__WEBPACK_IMPORTED_MODULE_11__["ResponseContentType"].Blob });
                                        this.http.get(datalocalURL, options).subscribe(function (result) {
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.OpenClickPopupXemKetQuaXNCLS = function (dataItem) {
                    var phienXetNghiemId = dataItem.PhienXetNghiemId;
                    var nhomDichVuBenhVienId = dataItem.NhomDichVuBenhVienId;
                    this.dialog.open(_kham_benh_kham_benh_lan_kham_hien_tai_phieu_in_xet_nghiem_popup_phieu_in_xet_nghiem_popup_component__WEBPACK_IMPORTED_MODULE_13__["PhieuInXetNghiemComponent"], {
                        disableClose: false,
                        width: '1000px',
                        data: { phienXetNghiemId: phienXetNghiemId, nhomDichVuBenhVienId: nhomDichVuBenhVienId }
                    }).afterClosed().subscribe(function (res) {
                        if (res == "Yes") {
                        }
                    });
                };
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.downloadXNCLS = function (dataItem) {
                    var _this = this;
                    ...
                    this.apiService.post('KhamBenh/ExportPdfKetQuaXetNghiem', this.phieuInXetNghiemVo).subscribe(function (arrHtml) {
                        _this.dialog.open(_kham_benh_kham_benh_lan_kham_hien_tai_lay_mau_xet_nghiem_ket_qua_popup_lay_mau_xet_nghiem_ket_qua_popup_component__WEBPACK_IMPORTED_MODULE_17__["LayMauXetNghiemKetQuaPopupComponent"], {
                            disableClose: false,
                            width: '1000px',
                            data: arrHtml
                        }).afterClosed().subscribe(function (result) {
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.getSharedData = function () {
                    return this.khamDoanKetLuanCLS;
                };
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.apiService.get("KhamDoan/GetDataCLS?id=" + id).subscribe(function (resultData) {
                        _this.khamDoanKetLuanCLS = resultData;
                    });
                };
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.save = function () {
                    var _this = this;
                    var self = this;
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_19__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_20__["SecurityOperation"].Update)) {
                                self.apiService.post("KhamDoan/LuuKetLuanCLS", self.khamDoanKetLuanCLS).subscribe(function (result) {
                                    ...
                                    _this.router.navigateByUrl('/kham-doan/kham-doan-ket-luan-cls-ksk?holdQuery=true');
                                }, function (err) {
                ...
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.cancel = function () {
                    this.ngOnInit();
                    this.router.navigateByUrl('/kham-doan/kham-doan-ket-luan-cls-ksk?holdQuery=true');
                };
                KhamDoanKetLuanClsKskDoanDetailComponent.prototype.redirectKetLuan = function () {
                    var _this = this;
                    var self = this;
                            ...
                            if (res == "Yes") {
                                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_20__["SecurityOperation"].Update)) {
                                    self.apiService.post("KhamDoan/LuuKetLuanCLS", self.khamDoanKetLuanCLS).subscribe(function (result) {
                                        self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_23__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_21__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                                        self.closePopupLoadingData();
                                        self.router.navigate(['/kham-doan/ket-luan-kham-suc-khoe-doan/chi-tiet'], { queryParams: { "Id": _this.khamDoanKetLuanCLS.HopDongKhamSucKhoeNhanVienId, "YeuCauTiepNhanId": _this.yeuCauTiepNhanId, "f": "ketluancls" } });
                                    }, function (err) {
                                        self.validationErrors = err.ValidationErrors;
                                        if (err.Message != "Validation Failed") {
                                            self.notificationService.showError(err.Message);
                ...
                return KhamDoanKetLuanClsKskDoanDetailComponent;
            }());
            KhamDoanKetLuanClsKskDoanDetailComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanKetLuanClsKskListComponent = /** @class */ (function () {
                function KhamDoanKetLuanClsKskListComponent(route) {
                    this.route = route;
                ...
                KhamDoanKetLuanClsKskListComponent.prototype.ngOnInit = function () {
                ...
                KhamDoanKetLuanClsKskListComponent.prototype.chuyenDen = function (event) {
                    if (event.index == 0) {
                        this.listStatusSelectTabKhamDoanKetLuan.selectedTabChuaKetLuan = true;
                        this.listStatusSelectTabKhamDoanKetLuan.selectedTabDaKetLuan = false;
                    }
                ...
                return KhamDoanKetLuanClsKskListComponent;
            }());
            KhamDoanKetLuanClsKskListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanKetLuanClsKskRoutingModule = /** @class */ (function () {
                function KhamDoanKetLuanClsKskRoutingModule() {
                }
                return KhamDoanKetLuanClsKskRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanKetLuanClsKskModule = /** @class */ (function () {
                function KhamDoanKetLuanClsKskModule() {
                }
                return KhamDoanKetLuanClsKskModule;
            }());
...
//# sourceMappingURL=default~kham-benh-kham-doan-tat-ca-phong-kham-doan-tat-ca-phong-module~kham-doan-kham-doan-ket-luan-~89aa333d-es5.js.map
//# sourceMappingURL=default~kham-benh-kham-doan-tat-ca-phong-kham-doan-tat-ca-phong-module~kham-doan-kham-doan-ket-luan-~89aa333d-es5.js.map