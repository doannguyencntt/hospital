...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-thuc-hien-cls-bao-cao-thuc-hien-cls-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThucHienClsListComponent = /** @class */ (function () {
                function BaoCaoThucHienClsListComponent(notificationService, authService, location, dialog, apiService) {
                ...
                BaoCaoThucHienClsListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoThucHienClsListComponent.prototype.onAdvanceSearch = function () {
                ...
                BaoCaoThucHienClsListComponent.prototype.RenderGroupHeader = function (titleGroup, aggregates) {
                    function onlyUnique(value, index, self) {
                        return self.indexOf(value) === index;
                    }
                    var numberOfPatiences = aggregates.items.map(function (x) { return x.BenhNhanId; }).filter(onlyUnique).length;
                    return titleGroup + ": " + numberOfPatiences + "/" + aggregates.items.length;
                };
                BaoCaoThucHienClsListComponent.prototype.onKey = function (event) {
                    if (event.key === 'Enter') {
                        this.onAdvanceSearch();
                    }
                };
                BaoCaoThucHienClsListComponent.prototype.searchChange = function () {
                    if (this.searchQuery.Searchterm == null || this.searchQuery.Searchterm === '') {
                        this.onAdvanceSearch();
                    }
                };
                BaoCaoThucHienClsListComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('BaoCaoThucHienCls/ExportBaoCaoThucHienCls', self.gridChild._gridQueryInfo).subscribe(function (resultData) {
                ...
                BaoCaoThucHienClsListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetBaoCaoBangKeBacSiCLSForGridAsync", this.gridChild._gridQueryInfo).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            //this.IsData = true;
                            _this.gridView = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_17__["process"])(resultData.Data, { group: _this.groups });
                ...
                BaoCaoThucHienClsListComponent.prototype.XuatBaoCao = function () {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
                        ...
                        self.apiService.postExportExcel('BaoCaoThucHienCls/ExportBaoCaoBangKeBacSiCLS', this.baoCaoClsBacSi).subscribe(function (resultData) {
                ...
                BaoCaoThucHienClsListComponent.prototype.showPopupLoadingData = function () {
                ...
                BaoCaoThucHienClsListComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                BaoCaoThucHienClsListComponent.prototype.GetListAsync = function (eventList) {
                    this.dataBaoCaoThucHienCls = eventList.Data.slice();
                };
                return BaoCaoThucHienClsListComponent;
            }());
            BaoCaoThucHienClsListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThucHienClsRoutingModule = /** @class */ (function () {
                function BaoCaoThucHienClsRoutingModule() {
                }
                return BaoCaoThucHienClsRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoClsBacSi = /** @class */ (function () {
                function BaoCaoClsBacSi(KhoaId, BacSiKetLuanId, 
                // public RangeFromDate: RangeDate = new RangeDate(),
                FromDate, ToDate, ThoiDiemTiepNhanTuFormat, ThoiDiemTiepNhanDenFormat) {
                    if (KhoaId === void 0) { KhoaId = null; }
                    if (BacSiKetLuanId === void 0) { BacSiKetLuanId = null; }
                ...
                return BaoCaoClsBacSi;
            }());
            var BaoCaoClsBacSiSearch = /** @class */ (function () {
                function BaoCaoClsBacSiSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                    if (FromDate === void 0) { FromDate = null; }
                    if (ToDate === void 0) { ToDate = null; }
            ...
            var BaoCaoThucHienClsVo = /** @class */ (function () {
                function BaoCaoThucHienClsVo(Id, NhomDv, ThoiGianChiDinh, ThoiGianChiDinhDisplay, MaTn, HoTenBn, BenhNhanId, NgaySinh, NgaySinhDisplay, GioiTinh, KhoaChiDinh, MaDv, DichVu, PhongThucHien, BsKetLuan, ThoiGianCoKq, ThoiGianCoKqDisplay) {
                    if (Id === void 0) { Id = null; }
                    if (NhomDv === void 0) { NhomDv = null; }
                    if (ThoiGianChiDinh === void 0) { ThoiGianChiDinh = null; }
                    if (ThoiGianChiDinhDisplay === void 0) { ThoiGianChiDinhDisplay = null; }
                    ...
                    if (PhongThucHien === void 0) { PhongThucHien = null; }
                    if (BsKetLuan === void 0) { BsKetLuan = null; }
                    if (ThoiGianCoKq === void 0) { ThoiGianCoKq = null; }
                    if (ThoiGianCoKqDisplay === void 0) { ThoiGianCoKqDisplay = null; }
                    this.Id = Id;
                    this.NhomDv = NhomDv;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThucHienClsModule = /** @class */ (function () {
                function BaoCaoThucHienClsModule() {
                }
                return BaoCaoThucHienClsModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThucHienClsService = /** @class */ (function (_super) {
                __extends(BaoCaoThucHienClsService, _super);
                function BaoCaoThucHienClsService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCaoThucHienCls';
                    return _this;
                }
                return BaoCaoThucHienClsService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            BaoCaoThucHienClsService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-thuc-hien-cls-bao-cao-thuc-hien-cls-module-es5.js.map
//# sourceMappingURL=bao-cao-thuc-hien-cls-bao-cao-thuc-hien-cls-module-es5.js.map