(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-thong-ke-so-luong-thu-thuat-bao-cao-thong-ke-so-luong-thu-thuat-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThongKeSoLuongThuThuatListComponent = /** @class */ (function () {
                function BaoCaoThongKeSoLuongThuThuatListComponent(authService, apiService, notificationService, dialog) {
                ...
                BaoCaoThongKeSoLuongThuThuatListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoThongKeSoLuongThuThuatListComponent.prototype.XemBaoCao = function () {
                    ...
                    var tuNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].formatDateTime(this.baoCaoSearch.TuNgayFormat, "mm/dd/yyyy");
                    var denNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].formatDateTime(this.baoCaoSearch.DenNgayFormat, "mm/dd/yyyy");
                ...
                BaoCaoThongKeSoLuongThuThuatListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                return BaoCaoThongKeSoLuongThuThuatListComponent;
            }());
            BaoCaoThongKeSoLuongThuThuatListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThongKeSoLuongThuThuatRoutingModule = /** @class */ (function () {
                function BaoCaoThongKeSoLuongThuThuatRoutingModule() {
                }
                return BaoCaoThongKeSoLuongThuThuatRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoThongKeSoLuongThuThuatSearchVT = /** @class */ (function () {
                function BaoCaoThongKeSoLuongThuThuatSearchVT(FromDate, ToDate, TuNgayFormat, DenNgayFormat, KhoaPhongId, HostingName) {
                ...
                return BaoCaoThongKeSoLuongThuThuatSearchVT;
            }());
            var InBaoCaoThongKeSoLuongThuThuat = /** @class */ (function () {
                function InBaoCaoThongKeSoLuongThuThuat(HostingName, FromDate, ToDate) {
                    if (HostingName === void 0) { HostingName = null; }
                    if (FromDate === void 0) { FromDate = null; }
                    if (ToDate === void 0) { ToDate = null; }
                    this.HostingName = HostingName;
                ...
                return InBaoCaoThongKeSoLuongThuThuat;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThongKeSoLuongThuThuatModule = /** @class */ (function () {
                function BaoCaoThongKeSoLuongThuThuatModule() {
                }
                return BaoCaoThongKeSoLuongThuThuatModule;
            }());
...
//# sourceMappingURL=bao-cao-bao-cao-thong-ke-so-luong-thu-thuat-bao-cao-thong-ke-so-luong-thu-thuat-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-thong-ke-so-luong-thu-thuat-bao-cao-thong-ke-so-luong-thu-thuat-module-es5.js.map