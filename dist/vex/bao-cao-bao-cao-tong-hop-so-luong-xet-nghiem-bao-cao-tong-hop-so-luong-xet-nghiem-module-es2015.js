...
let BaoCaoTongHopSoLuongXetNghiemListComponent = class BaoCaoTongHopSoLuongXetNghiemListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoTongHopSoLuongXetNghiemTheoThoiGianForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoTongHopSoLuongXetNghiemListComponent.ctorParameters = () => [
...
let BaoCaoTongHopSoLuongXetNghiemPopupComponent = class BaoCaoTongHopSoLuongXetNghiemPopupComponent {
    ...
    showBaoCao() {
        ...
        this.apiService.post("BaoCao/InBaoCaoTongHopSoLuongXetNghiem", this.inBaoCaoTongHopSoLuongXetNghiem).subscribe(resultData => {
...
BaoCaoTongHopSoLuongXetNghiemPopupComponent.ctorParameters = () => [
...
let BaoCaoTongHopSoLuongXetNghiemRoutingModule = class BaoCaoTongHopSoLuongXetNghiemRoutingModule {
};
...
class BaoCaoTongHopSoLuongXetNghiemSearch {
...
class BaoCaoTongHopSoLuongXetNghiem {
...
class InBaoCaoTongHopSoLuongXetNghiem {
...
let BaoCaoTongHopSoLuongXetNghiemModule = class BaoCaoTongHopSoLuongXetNghiemModule {
};
...
let BaoCaoTongHopSoLuongXetNghiemService = class BaoCaoTongHopSoLuongXetNghiemService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoTongHopSoLuongXetNghiemService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
