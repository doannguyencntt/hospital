(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-vat-tu-yeu-cau-linh-vat-tu-yeu-cau-linh-vat-tu-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachYeuCauLinhVatTuComponent = /** @class */ (function () {
                function DanhSachYeuCauLinhVatTuComponent(dialog, router, apiService, authService, notificationService, cd, route, location) {
                    this.dialog = dialog;
                    this.router = router;
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.TimKiemId = function () {
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.blur = function ($event) {
                    this.TimkiemNangCao();
                };
                DanhSachYeuCauLinhVatTuComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.TimkiemNangCao();
                    }
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.onKeyDateRange = function (event) {
                    if (event.key == 'Enter') {
                        this.TimkiemNangCao();
                    }
                };
                DanhSachYeuCauLinhVatTuComponent.prototype.changRange = function (event) {
                    this.TimkiemNangCao();
                };
                DanhSachYeuCauLinhVatTuComponent.prototype.searchChanges = function () {
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.TimkiemNangCao = function () {
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.checkTrangThaiDCT = function (event, type) {
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.loadingPageDaDuyet = function () {
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.closePopupLoadingDataDaDuyet = function () {
                    if (this.popupLoadingDataDaDuyet != undefined && this.popupLoadingDataDaDuyet != null) {
                        this.popupLoadingDataDaDuyet.close();
                    }
                };
                /// in 
                DanhSachYeuCauLinhVatTuComponent.prototype.InPhieuLinh = function (data) {
                    var _this = this;
                    var self = this;
                    if (data.LoaiPhieuLinh == 1 || data.LoaiPhieuLinh == 2) { //lĩnh dự trù(dự trù) hoặc lĩnh bù
                        ...
                        self.apiService.post("YeuCauLinhVatTu/InPhieuLinhThuongVatTu", self.inPhieuLinhThuong).subscribe(function (resData) {
                        ...
                        this.apiService.post("YeuCauLinhVatTu/InLinhVatTu", dataIn).subscribe(function (resultData) {
                            var dialogRef = _this.dialog.open(_in_linh_vat_tu_in_linh_vat_tu_component__WEBPACK_IMPORTED_MODULE_15__["InLinhVatTuComponent"], {
                                width: '1000px',
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.Huy = function (dataItem) {
                    var _this = this;
                    if (dataItem != undefined && dataItem != null) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_28__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                _this.apiService.post("YeuCauLinhVatTu/HuyItemYeuCauLinhThuoc?id=" + dataItem.Id).subscribe(function (resultData) {
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.Xem = function (id, loaiPhieuLinh, daGui) {
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    self.apiService.postExportExcel('YeuCauLinhVatTu/ExportDanhSachLinhVatTu', self.exportQueryInfoQueryInfo).subscribe(function (resultData) {
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.showPopupLoadingData = function () {
                ...
                DanhSachYeuCauLinhVatTuComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                DanhSachYeuCauLinhVatTuComponent.prototype.clearSearch = function () { };
                return DanhSachYeuCauLinhVatTuComponent;
            }());
            DanhSachYeuCauLinhVatTuComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InLinhVatTuComponent = /** @class */ (function () {
                function InLinhVatTuComponent(data, sanitizer, dialog) {
                    this.data = data;
                ...
                InLinhVatTuComponent.prototype.ngOnInit = function () {
                    this.modelPrint = this.data.Model;
                    this.loaiPhieuLinh = this.data.LoaiPhieuLinh;
                };
                InLinhVatTuComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        resolve(_this.modelPrint);
                    });
                };
                InLinhVatTuComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return InLinhVatTuComponent;
            }());
            InLinhVatTuComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            /* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
            var InPhieuLinhTrucTiepVatTuPopupComponent = /** @class */ (function () {
                function InPhieuLinhTrucTiepVatTuPopupComponent(data, sanitizer, dialog) {
                    this.data = data;
                    this.sanitizer = sanitizer;
                    this.dialog = dialog;
                    this.src = '';
                ...
                InPhieuLinhTrucTiepVatTuPopupComponent.prototype.ngOnInit = function () {
                    this.modelPrint = this.data.Model;
                    this.loaiPhieuLinh = this.data.LoaiPhieuLinh;
                };
                InPhieuLinhTrucTiepVatTuPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        resolve(_this.modelPrint);
                        _this.close();
                ...
                InPhieuLinhTrucTiepVatTuPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return InPhieuLinhTrucTiepVatTuPopupComponent;
            }());
            InPhieuLinhTrucTiepVatTuPopupComponent.ctorParameters = function () { return [
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"] },
                { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuLinhVatTuBuGuiLaiSharedComponent = /** @class */ (function () {
                function PhieuLinhVatTuBuGuiLaiSharedComponent(apiService, notificationService, authService, ref, dialog, route) {
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.authService = authService;
                    this.ref = ref;
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.route.queryParams.subscribe(function (params) {
                        ...
                        if (khoLinhId != undefined && khoBuId != undefined && khoLinhId > 0 && khoBuId > 0) {
                            _this.yeuCauLinhBuVatTu.KhoXuatId = parseInt(khoLinhId);
                            _this.yeuCauLinhBuVatTu.KhoNhapId = parseInt(khoBuId);
                            _this.linhTuKhoId = parseInt(khoLinhId);
                            _this.linhVeKhoId = parseInt(khoBuId);
                            _this.ganDieuKienLoadGridVatTu(parseInt(khoLinhId), parseInt(khoBuId));
                        }
                    });
                };
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.getCurrentUser = function () {
                    var _this = this;
                    if (this.yeuCauLinhBuVatTu.LaNguoiTaoPhieu == null) {
                        ...
                        if (this.yeuCauLinhBuVatTu.NhanVienDuyetId == null) {
                            this.apiService.get("YeuCauLinhVatTu/GetCurrentUserVatTu").subscribe(function (resultData) {
                                if (resultData != undefined && resultData != null) {
                                    _this.yeuCauLinhBuVatTu.NhanVienYeuCauId = resultData.NhanVienYeuCauId;
                                    _this.yeuCauLinhBuVatTu.HoTenNguoiYeuCau = resultData.HoTen;
                                }
                            });
                        }
                    }
                };
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.loadingPage = function () {
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.linhTuKhoChange = function (event) {
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.linhVeKhoChange = function (event) {
                    var _this = this;
                    if (event != undefined && event != null) {
                        ...
                        if (this.trangThaiVo != undefined
                            ...
                            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                                ...
                                if (result == "Yes") {
                                    _this.yeuCauLinhBuVatTu.KhoNhapId = event;
                                    _this.linhVeKhoId = event;
                                    _this.ganDieuKienLoadGridVatTu(_this.linhTuKhoId, event);
                                }
                                else {
                                    _this.yeuCauLinhBuVatTu.KhoNhapId = _this.linhVeKhoPreviousId;
                                    _this.linhVeKhoId = event;
                                    _this.ganDieuKienLoadGridVatTu(_this.linhTuKhoId, _this.linhVeKhoPreviousId);
                                }
                            });
                        }
                        else {
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.ganDieuKienLoadGridVatTu = function (linhTuKhoId, linhVeKhoId) {
                    if (this.trangThaiVo != undefined) {
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.onDataBoundGrid = function (event) {
                    var _this = this;
                    if (event != undefined && event != null) {
                        if (this.isCreate) {
                            ...
                            event.Data.forEach(function (element) {
                                var yeuCauVatTuBenhVien = new _yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_13__["YeuCauVatTuBenhVienViewModel"]();
                                ...
                                yeuCauVatTuBenhVien.KhoLinhTuId = _this.linhTuKhoId;
                                yeuCauVatTuBenhVien.KhoLinhVeId = _this.linhVeKhoId;
                                ...
                                _this.yeuCauLinhBuVatTu.YeuCauVatTuBenhViens.push(yeuCauVatTuBenhVien);
                            });
                        }
                        else {
                            this.yeuCauLinhBuVatTu.YeuCauVatTuBenhViens = [];
                            ...
                            event.Data.forEach(function (element) {
                                ...
                                yeuCauVatTuBenhVien.SoLuongCanBu = element.SoLuongCanBu;
                                yeuCauVatTuBenhVien.SoLuongTon = element.SoLuongTon;
                                yeuCauVatTuBenhVien.KhoLinhTuId = _this.yeuCauLinhBuVatTu.KhoXuatId;
                                yeuCauVatTuBenhVien.KhoLinhVeId = _this.yeuCauLinhBuVatTu.KhoNhapId;
                                yeuCauVatTuBenhVien.SoLuongYeuCau = element.SoLuongYeuCau;
                                yeuCauVatTuBenhVien.SoLuongDaBu = element.SoLuongDaBu;
                                yeuCauVatTuBenhVien.SLYeuCauLinhThucTe = element.SLYeuCauLinhThucTe;
                                yeuCauVatTuBenhVien.SLYeuCauLinhThucTeMax = element.SLYeuCauLinhThucTeMax;
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    var self = this;
                    self.loadingPage();
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].View)) {
                        self.apiService.get("YeuCauLinhVatTu/GetYeuCauLinhVatTuBuTao?id=" + id).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                self.closePopupLoadingData();
                                // console.log("data: ", resultData)
                                _this.yeuCauLinhBuVatTu = resultData;
                                if (_this.yeuCauLinhBuVatTu.LaNguoiTaoPhieu) {
                                    _this.disabledNguoiTaoPhieu.emit(true);
                                }
                                else {
                                    _this.disabledNguoiTaoPhieu.emit(false);
                                }
                                if (_this.yeuCauLinhBuVatTu.HoTenNguoiYeuCau == null) {
                                    _this.yeuCauLinhBuVatTu.HoTenNguoiYeuCau = resultData.TenNhanVienYeuCau;
                                }
                                console.log("yeuCauLinhBuVatTu: ", _this.yeuCauLinhBuVatTu);
                                if (_this.isCreate) {
                                    _this.linhVeKhoPreviousId = _this.yeuCauLinhBuVatTu.KhoNhapId;
                                }
                                _this.linhTuKhoId = _this.yeuCauLinhBuVatTu.KhoXuatId;
                                _this.linhVeKhoId = _this.yeuCauLinhBuVatTu.KhoNhapId;
                                if (_this.yeuCauLinhBuVatTu.DuocDuyet == null || _this.yeuCauLinhBuVatTu.DuocDuyet == false) {
                                    _this.isCreate = false;
                                }
                                _this.ganDieuKienLoadGridVatTu(_this.yeuCauLinhBuVatTu.KhoXuatId, _this.yeuCauLinhBuVatTu.KhoNhapId);
                            }
                        }, function (err) {
                            self.validationErrors = err.ValidationErrors;
                            if (err.Message != "Validation Failed") {
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.ganSLThucTeChange = function (soLuong, vatTuBenhVienId) {
                    if (soLuong != undefined && soLuong != null) {
                        this.yeuCauLinhBuVatTu.YeuCauVatTuBenhViens.filter(function (x) { return x.VatTuBenhVienId == vatTuBenhVienId; }).forEach(function (element) {
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.checkBoxDichVu = function (dataItem, event) {
                    var index = this.yeuCauLinhBuVatTu.YeuCauVatTuBenhViens.findIndex(function (z) { return z.VatTuBenhVienId == dataItem.VatTuBenhVienId; });
                    this.yeuCauLinhBuVatTu.YeuCauVatTuBenhViens[index].CheckBox = event;
                    var lstDataCurrent = this.gridVatTu.getAllDataFromDatasource();
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.checkBoxAllChange = function (event) {
                    var _this = this;
                    var lstDataCurrent = this.gridVatTu.getAllDataFromDatasource();
                    if (lstDataCurrent.length > 0) {
                        lstDataCurrent.forEach(function (element) {
                            element.CheckBox = event;
                            var index = _this.yeuCauLinhBuVatTu.YeuCauVatTuBenhViens.findIndex(function (z) { return z.VatTuBenhVienId == element.VatTuBenhVienId; });
                            _this.yeuCauLinhBuVatTu.YeuCauVatTuBenhViens[index].CheckBox = event;
                        });
                    }
                };
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.thoiDiemTNChange = function () {
                ...
                PhieuLinhVatTuBuGuiLaiSharedComponent.prototype.getSharedData = function () {
                ...
                return PhieuLinhVatTuBuGuiLaiSharedComponent;
            }());
            PhieuLinhVatTuBuGuiLaiSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuLinhVatTuBuGuiLaiComponent = /** @class */ (function () {
                function PhieuLinhVatTuBuGuiLaiComponent(dialog, route, notificationService, authService, apiService, router, ref) {
                    this.dialog = dialog;
                    this.route = route;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.loadingPage = function () {
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                PhieuLinhVatTuBuGuiLaiComponent.prototype.luuPhieuLinhBuVatTu = function (daGui) {
                    var self = this;
                    self.yeuCauLinhVatTu = self.shared.getSharedData();
                    if (self.yeuCauLinhVatTu.YeuCauVatTuBenhViens.every(function (z) { return !z.CheckBox; })) {
                        if (daGui) {
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.xacNhanLuuPhieuLinh = function () {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                        self.loadingPage();
                        self.yeuCauLinhVatTu.YeuCauLinhVatTuChiTiets = self.yeuCauLinhVatTu.YeuCauLinhVatTuChiTiets.sort(function (a, b) { return (a.Nhom > b.Nhom) ? 1 : -1; });
                        self.yeuCauLinhVatTu.YeuCauLinhVatTuChiTiets.forEach(function (element) {
                            element.DuocDuyet = null;
                        });
                        self.yeuCauLinhVatTu.DuocDuyet = null;
                        self.apiService.post("YeuCauLinhVatTu/GuiLaiPhieuLinhBu", self.yeuCauLinhVatTu).subscribe(function (result) {
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.xacNhanGuiPhieuLinh = function () {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                            ...
                            if (result != undefined && result != null) {
                                ...
                                self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmComponent"], {
                                    ...
                                    if (res == "Yes") {
                                        ...
                                        self.apiService.post("YeuCauLinhVatTu/InPhieuLinhThuongVatTu", self.inPhieuLinhBu).subscribe(function (resData) {
                                            if (resData != undefined && resData != null) {
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.loadingPageDaDuyet = function () {
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.closePopupLoadingDataDaDuyet = function () {
                    if (this.popupLoadingDataDaDuyet != undefined && this.popupLoadingDataDaDuyet != null) {
                        this.popupLoadingDataDaDuyet.close();
                    }
                };
                ...
                //   });
                // }
                PhieuLinhVatTuBuGuiLaiComponent.prototype.anHienButtonDuyet = function (event) {
                    if (event) {
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.disableNguoiTaoPhieu = function (event) {
                    if (event) {
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.GetTrangThaiPhieuLinh = function (id) {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].View)) {
                        self.apiService.get("YeuCauLinhVatTu/GetTrangThaiPhieuLinhVatTu?phieuLinhId=" + id).subscribe(function (result) {
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.inPhieu = function () {
                    var self = this;
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.cancel = function () {
                    var data;
                ...
                PhieuLinhVatTuBuGuiLaiComponent.prototype.keyEvent = function (event) {
                ...
                return PhieuLinhVatTuBuGuiLaiComponent;
            }());
            PhieuLinhVatTuBuGuiLaiComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _phieu_linh_vat_tu_thuong_popup_phieu_linh_vat_tu_thuong_popup_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../phieu-linh-vat-tu-thuong-popup/phieu-linh-vat-tu-thuong-popup.component */ "./src/app/modules/main/nhap-xuat/vat-tu/yeu-cau-linh-vat-tu/phieu-linh-vat-tu-thuong-popup/phieu-linh-vat-tu-thuong-popup.component.ts");
            var PhieuLinhVatTuThuongGuiLaiComponent = /** @class */ (function () {
                function PhieuLinhVatTuThuongGuiLaiComponent(apiService, dialog, notificationService, authService, router, route, ref) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.loadingPage = function () {
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.loadingPageDaDuyet = function () {
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.closePopupLoadingDataDaDuyet = function () {
                    if (this.popupLoadingDataDaDuyet != undefined && this.popupLoadingDataDaDuyet != null) {
                        this.popupLoadingDataDaDuyet.close();
                    }
                };
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.luuPhieuLinhThuong = function () {
                    var self = this;
                    self.yeuCauLinhVatTu = self.shared.getSharedData();
                    self.validationErrors = [];
                    self.ref.detectChanges();
                        ...
                        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                                    self.loadingPage();
                                    self.yeuCauLinhVatTu.YeuCauLinhVatTuChiTiets = self.yeuCauLinhVatTu.YeuCauLinhVatTuChiTiets.sort(function (a, b) { return (a.Nhom > b.Nhom || a.STT > b.STT || a.Ten > b.Ten) ? 1 : -1; });
                                    self.yeuCauLinhVatTu.YeuCauLinhVatTuChiTiets.forEach(function (element) {
                                        element.DuocDuyet = false;
                                    });
                                    self.yeuCauLinhVatTu.IsLuu = true;
                                    self.yeuCauLinhVatTu.DuocDuyet = false;
                                    self.apiService.post("YeuCauLinhVatTu/GuiLaiPhieuLinhThuongVatTu", self.yeuCauLinhVatTu).subscribe(function (result) {
                                        if (result != undefined && result != null) {
                                            self.yeuCauLinhVatTu.LastModified = result.LastModified;
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.guiPhieuLinhThuong = function () {
                    var _this = this;
                    var self = this;
                    self.yeuCauLinhVatTu = self.shared.getSharedData();
                    self.validationErrors = [];
                                        ...
                                        if (result != undefined && result != null) {
                                            ...
                                            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                                                ...
                                                if (res == "Yes") {
                                                    ...
                                                    self.closePopupLoadingDataDaDuyet();
                                                    _this.router.navigate(['/nhap-xuat/vat-tu/yeu-cau-linh-vat-tu']);
                                                }
                                            });
                                        }
                                    }, function (err) {
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.luuVaGuiDuyetLai = function () {
                    var _this = this;
                    var self = this;
                    self.yeuCauLinhVatTu = self.shared.getSharedData();
                    self.validationErrors = [];
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.inPhieu = function () {
                    var _this = this;
                    var self = this;
                    if (self.trangThaiVo != undefined && self.trangThaiVo != null && self.trangThaiVo.TrangThai == true) { //Đã duyệt
                        self.loadingPageDaDuyet();
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.anHienButtonDuyet = function (event) {
                    if (event) {
                        this.isHideDuyet = true;
                    }
                    else {
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.disableNguoiTaoPhieu = function (event) {
                    if (event) {
                        this.isDisabledNguoiTaoPhieu = true;
                    }
                    else {
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.GetTrangThaiPhieuLinh = function (id) {
                    var _this = this;
                    var self = this;
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.cancel = function () {
                    var data;
                    if (this.trangThaiDanhSach.holdQuery == '0') {
                        data = 0;
                    }
                ...
                PhieuLinhVatTuThuongGuiLaiComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 27 && !event.ctrlKey) {
                        //esc
                        this.cancel();
                        event.preventDefault();
                ...
                return PhieuLinhVatTuThuongGuiLaiComponent;
            }());
            PhieuLinhVatTuThuongGuiLaiComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            /* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
            var PhieuLinhVatTuThuongPopupComponent = /** @class */ (function () {
                function PhieuLinhVatTuThuongPopupComponent(dialog, sanitizer, dialogRef, data) {
                    this.dialog = dialog;
                    this.sanitizer = sanitizer;
                ...
                PhieuLinhVatTuThuongPopupComponent.prototype.ngOnInit = function () {
                    // this.src = "data:text/html;charset=utf-8," + encodeURIComponent(this.data);
                };
                PhieuLinhVatTuThuongPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                PhieuLinhVatTuThuongPopupComponent.prototype.getSharedPrintForm = function () {
                    var source = this.data.Model.replace("<p  style='background: #005dab;color:#fff; height:40px; font-size:30px;text-align:center'>" +
                ...
                return PhieuLinhVatTuThuongPopupComponent;
            }());
            PhieuLinhVatTuThuongPopupComponent.ctorParameters = function () { return [
                { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuLinhVatTuThuongSharedComponent = /** @class */ (function () {
                function PhieuLinhVatTuThuongSharedComponent(apiService, notificationService, authService, ref, route, dialog) {
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.authService = authService;
                    this.ref = ref;
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.ngOnInit = function () {
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.getCurrentUser = function () {
                    var _this = this;
                    ...
                    if (this.yeuCauLinhVatTu.LaNguoiTaoPhieu == null) {
                        ...
                        this.apiService.get("YeuCauLinhVatTu/GetCurrentUserVatTu").subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.yeuCauLinhVatTu.NhanVienYeuCauId = resultData.NhanVienYeuCauId;
                                _this.yeuCauLinhVatTu.HoTenNguoiYeuCau = resultData.HoTen;
                            }
                        });
                    }
                };
                PhieuLinhVatTuThuongSharedComponent.prototype.chonVatTu = function (dataItem) {
                    if (dataItem != undefined && dataItem != null) {
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.getArrayVatTuBenhVienId = function () {
                    var _this = this;
                    this.vatTuGrid.VatTuBenhViens = new Array();
                    this.lstVatTuGrid.forEach(function (element) {
                        var vatTuBenhVien = new _yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_6__["VatTuGridViewModelValidator"]();
                        vatTuBenhVien.VatTuBenhVienId = element.VatTuBenhVienId;
                        vatTuBenhVien.LaVatTuBHYT = element.LaVatTuBHYT;
                        _this.vatTuGrid.VatTuBenhViens.push(vatTuBenhVien);
                        console.log("data BenhViens: ", _this.vatTuGrid.VatTuBenhViens);
                    });
                };
                PhieuLinhVatTuThuongSharedComponent.prototype.themVatTu = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Add)) {
                        if (this.dangXuLy)
                            return;
                        this.dangXuLy = true;
                        self.apiService.post("YeuCauLinhVatTu/ThemLinhThuongVatTuGridVo", self.vatTuGrid).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.setValueForGridVatTu = function () {
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.pushDataVatTu = function () {
                    var _this = this;
                    this.yeuCauLinhVatTu.YeuCauLinhVatTuChiTiets = new Array();
                    this.lstVatTuGrid.forEach(function (obj) {
                        var model = new _yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_6__["YeuCauLinhVatTuChiTiet"]();
                        ...
                        _this.yeuCauLinhVatTu.YeuCauLinhVatTuChiTiets.push(model);
                    });
                };
                PhieuLinhVatTuThuongSharedComponent.prototype.xoaVatTu = function (dataItem) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_13__["ConfirmComponent"], {
                        ...
                        if (result === 'Yes') {
                            ...
                            _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
                            _this.validationErrorsLinhThuong = [];
                            _this.setValueForGridVatTu();
                        }
                    });
                };
                PhieuLinhVatTuThuongSharedComponent.prototype.huy = function () {
                    this.validationErrors = [];
                    this.vatTuGrid.Ten = null;
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.clearGridVatTu = function () {
                    this.huy();
                    this.lstVatTuGrid = [];
                    this.gridDataSource = {
                        data: this.lstVatTuGrid,
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].View)) {
                        self.apiService.get("YeuCauLinhVatTu/GetPhieuLinhThuongVatTu?id=" + id).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.yeuCauLinhVatTu = resultData;
                                if (_this.yeuCauLinhVatTu.LaNguoiTaoPhieu) {
                                    _this.disabledNguoiTaoPhieu.emit(true);
                                }
                                else {
                                    _this.disabledNguoiTaoPhieu.emit(false);
                                ...
                                // }
                                _this.lstVatTuGrid = [];
                                resultData.YeuCauLinhVatTuChiTiets.forEach(function (element) {
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.getSharedData = function () {
                    this.setValueForGridVatTu();
                    this.yeuCauLinhVatTu.YeuCauLinhVatTuChiTiets.forEach(function (element) {
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                ...
                PhieuLinhVatTuThuongSharedComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                return PhieuLinhVatTuThuongSharedComponent;
            }());
            PhieuLinhVatTuThuongSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuLinhVatTuTrucTiepGuiLaiComponent = /** @class */ (function () {
                function PhieuLinhVatTuTrucTiepGuiLaiComponent(apiService, dialog, notificationService, authService, router, ref, route) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.cancel = function () {
                    this.router.navigate(['/nhap-xuat/vat-tu/yeu-cau-linh-vat-tu'], { queryParams: { holdQuery: true } });
                };
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.inPhieu = function () {
                    var self = this;
                    if (self.shareChoGoi) {
                    ...
                    self.apiService.post("YeuCauLinhVatTu/InPhieuLinhTrucTiepVatTu", self.inPhieuLinhTrucTiep).subscribe(function (resData) {
                        if (resData != undefined && resData != null) {
                ...
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.loadingPage = function () {
                    this.popupLoadingData = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_11__["LoadingComponent"], {
                        disableClose: true,
                        width: "200px",
                        height: "90px",
                ...
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.getTrangThaiYeuCau = function (event) {
                    if (event != undefined && event != null) {
                ...
                //   this.save();
                // }
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.quyenUpdatePhieuLinh = function (event) {
                    this.quyenUpdate = event;
                };
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.guiLaiPhieu = function () {
                    var _this = this;
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
                        ...
                        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_15__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                var kiemTraCoDuocPhamKhongDuTon = _this.getItemKhongDuTon(self.yeuCauLinhVatTu.DanhSachVatTuTonKhongDus);
                                self.closePopupLoadingData();
                                self.validationErrors = [];
                                self.ref.detectChanges();
                ...
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.getItemKhongDuTon = function (danhSachYeuCauVatTuBenhVien) {
                    var data = [];
                    var dataKhongChoTao = [];
                    var dataList = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_19__["process"])(danhSachYeuCauVatTuBenhVien, this.state);
                ...
                PhieuLinhVatTuTrucTiepGuiLaiComponent.prototype.newCreate = function () {
                    var self = this;
                    self.loadingPage();
                    self.apiService.post("YeuCauLinhVatTu/GuiLaiPhieuLinhTrucTiep", self.yeuCauLinhVatTu).subscribe(function (result) {
                        if (result != undefined && result != null) {
                ...
                return PhieuLinhVatTuTrucTiepGuiLaiComponent;
            }());
            PhieuLinhVatTuTrucTiepGuiLaiComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuLinhVatTuTrucTiepSharedComponent = /** @class */ (function () {
                function PhieuLinhVatTuTrucTiepSharedComponent(notificationService, cdRef, dialog, apiService, route, baseService, authService) {
                    this.notificationService = notificationService;
                    this.cdRef = cdRef;
                    this.dialog = dialog;
                    this.apiService = apiService;
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.queryParams.subscribe(function (params) {
                        var khoLinhId = params['KhoLinhId'];
                        var phongLinhVeId = 0;
                        ...
                        if (khoLinhId != undefined && phongLinhVeId != undefined && khoLinhId > 0) {
                            ...
                            _this.apiService.post('YeuCauLinhVatTu/ThongTinDanhSachCanLinh?idKhoLinh=' + khoLinhId + "&phongLinhVeId=" + phongLinhVeId).subscribe(function (resultData) {
                                _this.linhTrucTiepVatTuObject.NhanVienYeuCauId = resultData.NhanVienYeuCauId;
                                _this.linhTrucTiepVatTuObject.KhoNhapId = resultData.LinhVePhongId;
                                _this.linhVeKhoa = resultData.LinhVeKhoa;
                                _this.ngayYeuCau = new Date();
                                _this.nguoiYeuCau = resultData.NguoiYeuCau;
                                _this.ghiChu = resultData.GhiChu;
                                _this.phieuLinhTrucTiep.KeyId = parseInt(khoLinhId);
                                _this.phonglamViecId = phongLinhVeId;
                                _this.apiService.post('YeuCauLinhVatTu/GetData', { idKhoLinh: parseInt(khoLinhId), phongLinhVeId: phongLinhVeId, dateSearchStart: "", dateSearchEnd: "" }).subscribe(
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.ChonKhoLinhChange = function (data) {
                    var _this = this;
                    this.linhVeKhoa = "";
                    ...
                    if (this.ishowpopupComBoBox == false) {
                        if (data == undefined || data == null) {
                            ...
                            this.apiService.post('YeuCauLinhVatTu/ThongTinLinhTuKho?idKhoLinh=' + data.KeyId).subscribe(function (resultData) {
                                _this.linhTrucTiepVatTuObject.NhanVienYeuCauId = resultData[0].NhanVienYeuCauId;
                                _this.linhTrucTiepVatTuObject.KhoNhapId = resultData[0].linhVeKhoaId;
                                _this.linhVeKhoa = resultData[0].linhVeKhoa;
                                _this.ngayYeuCau = new Date();
                                _this.nguoiYeuCau = resultData[0].NguoiYeuCau;
                                _this.ghiChu = resultData[0].GhiChu;
                                _this.apiService.post('YeuCauLinhVatTu/GetData?idKhoLinh=' + data.KeyId + '&phongDangNhapId=' + resultData[0].linhVeKhoaId).subscribe(function (resultData) {
                                    _this.gridDataSource = {
                                        data: resultData,
                                        total: resultData.length
                                    };
                        ...
                        if (data == undefined || data == null) {
                            ...
                            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
                                ...
                                _this.phieuLinhTrucTiep.KeyId = data.KeyId;
                                _this.phieuLinhTrucTiep.DisplayName = data.DisplayName;
                                _this.apiService.post('YeuCauLinhVatTu/ThongTinLinhTuKho?idKhoLinh=' + data.KeyId).subscribe(function (resultData) {
                                    _this.linhTrucTiepVatTuObject.NhanVienYeuCauId = resultData[0].NhanVienYeuCauId;
                                    _this.linhTrucTiepVatTuObject.KhoNhapId = resultData[0].linhVeKhoaId;
                                    _this.linhVeKhoa = resultData[0].linhVeKhoa;
                                    _this.ngayYeuCau = new Date();
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.setDataGridView = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.setDataGridViewRefesh = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.OnDataBound = function (dataChild) {
                };
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.getSharedData = function () {
                    var _this = this;
                    //thong tin login 
                    this.validationErrors = [];
                    ...
                    if (this.searchDanhSachThongVatTu.TuNgay != null) {
                        ...
                        var yeuCauVatTuBenhViens = [];
                        yeuCauVatTuBenhViens = this.gridDichVuDuocCheck();
                        if (yeuCauVatTuBenhViens.length != 0) {
                            var listSortNhoNhatDenLonNhat = yeuCauVatTuBenhViens.sort(function (a, b) { return (new Date(a.NgayDieuTri) > new Date(b.NgayDieuTri)) ? 1 : -1; });
                    ...
                    if (this.gridDataSource.data == null || this.gridDataSource.data == undefined) {
                        ...
                        this.gridDataSource.data.forEach(function (element) {
                            if (element.IsCheckRowItem == true) {
                                element.ListYeuCauVatTuBenhViens.forEach(function (item) {
                                    if (item.IsCheckRowItem == true) {
                                        var index = _this.linhTrucTiepVatTuObject.YeuCauVatTuBenhVienIds.findIndex(function (sp) { return sp == item.Id; });
                                        if (index == -1) {
                                            _this.linhTrucTiepVatTuObject.YeuCauVatTuBenhVienIds.push(item.Id);
                                            var vtKhongDuTon = {
                                            ...
                                            _this.linhTrucTiepVatTuObject.DanhSachVatTuTonKhongDus.push(vtKhongDuTon);
                                        }
                                    }
                                });
                            }
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.getTrangThaiDuyet = function (id) {
                    var _this = this;
                    this.apiService.post('YeuCauLinhVatTu/GetTrangThaiDuyet?IdYeuCauLinh=' + id).subscribe(function (resultData) {
                        _this.trangThaiDuyet = resultData;
                        if (_this.trangThaiDuyet == true) {
                            _this.trangThaiYeuCau.emit(new _yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_2__["TrangThaiDuyetYeuCauLinh"]("Đã duyệt", resultData));
                            _this.apiService.post('YeuCauLinhVatTu/GetDaDuyet?IdYeuCauLinh=' + id).subscribe(function (resultData) {
                            ...
                            _this.trangThaiYeuCau.emit(new _yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_2__["TrangThaiDuyetYeuCauLinh"]("Từ chối duyệt", resultData));
                            _this.apiService.post('YeuCauLinhVatTu/GetDaDuyet?IdYeuCauLinh=' + id).subscribe(function (resultData) {
                                _this.daDuyet.NguoiDuyet = resultData.NguoiDuyet;
                                _this.daDuyet.NgayDuyet = resultData.NgayDuyet;
                                if (_this.daDuyet.NguoiDuyet != null && _this.daDuyet.NgayDuyet != null) {
                            ...
                            _this.trangThaiYeuCau.emit(new _yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_2__["TrangThaiDuyetYeuCauLinh"]("Đang chờ duyệt", resultData));
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    var self = this;
                    this.linhTrucTiepVatTuObject.Id = id;
                    self.apiService.get("YeuCauLinhVatTu/GetALL?id=" + id).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            ...
                            self.apiService.post('YeuCauLinhVatTu/ThongTinLinhTuKhoDaTao?idYeuCauLinhDP=' + id).subscribe(function (resultDatas) {
                                _this.linhTrucTiepVatTuObject.NhanVienYeuCauId = resultDatas[0].NhanVienYeuCauId;
                                _this.linhTrucTiepVatTuObject.KhoNhapId = resultDatas[0].LinhVePhongId;
                                ...
                                _this.phonglamViecId = resultDatas[0].NoiChiDinhId;
                                if (_this.getNhanVienId.AccessToken.Id == _this.linhTrucTiepVatTuObject.NhanVienYeuCauId) {
                                    _this.quyenUpdatePhieu = true;
                                ...
                                _this.apiService.post('YeuCauLinhVatTu/GetDataDaTao?idKhoLinh=' + resultData.KhoXuatId + '&idYeuCauLinhVatTu=' + id + '&phongDangNhapId=' + resultDatas[0].NoiChiDinhId + "&trangThai=" + trangThai).subscribe(function (resultData) {
                                    _this.gridDataSource = {
                                        data: resultData,
                                        total: resultData.length
                                    };
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.changeTuNgay = function (event) {
                    this.timkiem();
                };
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.changeDenNgay = function (event) {
                    this.timkiem();
                };
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.blur = function () {
                    this.timkiem();
                };
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.timkiem = function () {
                    var _this = this;
                    if (this.khoLinhIdSearch != undefined && this.phongLinhIdSearch != undefined && this.khoLinhIdSearch > 0) {
                        ...
                        this.loadingPage();
                        this.apiService.post('YeuCauLinhVatTu/ThongTinDanhSachCanLinh?idKhoLinh=' + this.khoLinhIdSearch + "&phongLinhVeId=" + this.phongLinhIdSearch).subscribe(function (resultData) {
                            _this.linhTrucTiepVatTuObject.NhanVienYeuCauId = resultData.NhanVienYeuCauId;
                            _this.linhTrucTiepVatTuObject.KhoNhapId = resultData.LinhVePhongId;
                            _this.linhVeKhoa = resultData.LinhVeKhoa;
                            _this.ngayYeuCau = new Date();
                            ...
                            _this.dateBatDau = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_11__["CommonService"].formatDateTime(_this.searchDanhSachThongVatTu.TuNgay, "mm/dd/yyyy");
                            _this.dateKetThuc = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_11__["CommonService"].formatDateTime(_this.searchDanhSachThongVatTu.DenNgay, "mm/dd/yyyy");
                            _this.apiService.post('YeuCauLinhVatTu/GetData', { idKhoLinh: _this.khoLinhIdSearch, phongLinhVeId: _this.phongLinhIdSearch, dateSearchStart: _this.dateBatDau, dateSearchEnd: _this.dateKetThuc }).subscribe(
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.extCheckboxSelections = function (event) {
                    var _this = this;
                    ...
                    if (this.linhTrucTiepVatTuObject.CheckKhiTao.length != 0) {
                        ...
                        var _loop_1 = function (i) {
                            for (var j = 0; j < this_1.linhTrucTiepVatTuObject.CheckKhiTao.length; j++) {
                                if (this_1.linhTrucTiepVatTuObject.CheckKhiTao[j] == this_1.gridDataSource.data[i].YeuCauTiepNhanId) {
                                    if (this_1.checkChild == false) {
                                        this_1.gridDataSource.data[i].IsCheckRowItem = true;
                                        if (this_1.gridDataSource.data[i].ListYeuCauVatTuBenhViens.length == this_1.gridDataSource.data[i].ListYeuCauVatTuBenhViens.filter(function (sp) { return sp.IsCheckRowItem == false; }).length) {
                                            this_1.gridDataSource.data[i].ListYeuCauVatTuBenhViens.forEach(function (elements) {
                                                if (elements.SoLuongTon >= elements.SLYeuCau) {
                                                    elements.IsCheckRowItem = true;
                                                }
                                            });
                                        }
                                        this_1.getDataSourceChild(this_1.gridDataSource.data[i].ListYeuCauVatTuBenhViens);
                                        break;
                                    }
                                    else {
                                        this_1.gridDataSource.data[i].IsCheckRowItem = true;
                        ...
                        this.linhTrucTiepVatTuObject.CheckKhiTao.forEach(function (element) {
                        ...
                        gridCheckCu.forEach(function (element) {
                            ...
                            element.ListYeuCauVatTuBenhViens.forEach(function (elements) {
                                elements.IsCheckRowItem = false;
                            });
                            _this.getDataSourceChild(element.ListYeuCauVatTuBenhViens);
                        });
                    }
                    else {
                        this.gridDataSource.data.forEach(function (element) {
                ...
                // grid item con 
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.checkboxGridChild = function (event, dataItem) {
                    var _this = this;
                    if (event == true) {
                    ...
                    this.gridDataSource.data.forEach(function (element) {
                        if (dataItem.YeuCauTiepNhanId == element.Id) {
                            var inxdex = element.ListYeuCauVatTuBenhViens.findIndex(function (sp) { return sp.IsCheckRowItem == true; });
                            if (inxdex != -1) {
                                _this.checkChild = true;
                                var indexChange = element.ListYeuCauVatTuBenhViens.filter(function (sp) { return sp.Id == dataItem.Id; });
                                if (indexChange.length == 1) {
                                    indexChange.forEach(function (element) {
                                        element.IsCheckRowItem = event;
                                    });
                                }
                                var inxdex_1 = element.ListYeuCauVatTuBenhViens.filter(function (sp) { return sp.IsCheckRowItem == false; });
                                if (element.ListYeuCauVatTuBenhViens.length == inxdex_1.length) {
                                ...
                                _this.checkChild = true;
                                var inxdex_2 = element.ListYeuCauVatTuBenhViens.filter(function (sp) { return sp.IsCheckRowItem == false; });
                                if (element.ListYeuCauVatTuBenhViens.length == inxdex_2.length) {
                                    if (!jQuery('#' + _this.linhTrucTiepMasterName + 'selectCheckboxId' + element.Id).prop('unchecked')) {
                                        jQuery('#' + _this.linhTrucTiepMasterName + 'selectCheckboxId' + element.Id).trigger('click');
                                    }
                                }
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.getDataSourceChild = function (parentItem) {
                    return {
                        data: parentItem,
                        total: parentItem.length
                    };
                };
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.gridDichVuDuocCheck = function () {
                    var _this = this;
                    var yeuCauVatTuBenhViens = [];
                    this.gridDataSource.data.forEach(function (element) {
                        if (element.IsCheckRowItem == true) {
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.loadingPage = function () {
                ...
                PhieuLinhVatTuTrucTiepSharedComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                return PhieuLinhVatTuTrucTiepSharedComponent;
            }());
            PhieuLinhVatTuTrucTiepSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/shared/component/dialogs/loading/loading.component */ "./src/app/shared/component/dialogs/loading/loading.component.ts");
            var PhieuLinhVtTrucTiepChoGoiSharedComponent = /** @class */ (function () {
                function PhieuLinhVtTrucTiepChoGoiSharedComponent(notificationService, cdRef, dialog, apiService, route, baseService, authService) {
                    this.notificationService = notificationService;
                    this.cdRef = cdRef;
                    this.dialog = dialog;
                    this.apiService = apiService;
                ...
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.ngOnInit = function () {
                    this.gridChildColumns = [
                        { Field: "STT", Title: "#", Width: 60 },
                        { Field: "MaTN", Title: "Mã TN", Width: 100 },
                        { Field: "MaBN", Title: "Mã NB", Width: 100 },
                ...
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.setDataGridView = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.setDataGridViewRefesh = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.linhTrucTiepVatTuObject.Id = id;
                    this.apiService.get("YeuCauLinhVatTu/GetALL?id=" + id).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            _this.phieuLinhTrucTiep.KeyId = resultData.KhoXuatId;
                            _this.phieuLinhTrucTiep.DisplayName = resultData.TenKhoXuat;
                            var vo_1 = {
                            ...
                            _this.apiService.post('YeuCauLinhVatTu/ThongTinLinhTuKhoDaTao?idYeuCauLinhDP=' + id).subscribe(function (resultDatas) {
                                _this.linhTrucTiepVatTuObject.NhanVienYeuCauId = resultDatas[0].NhanVienYeuCauId;
                                _this.linhTrucTiepVatTuObject.KhoNhapId = resultDatas[0].LinhVePhongId;
                                _this.linhVeKhoa = resultDatas[0].LinhVeKhoa;
                                _this.nguoiYeuCau = resultDatas[0].NguoiYeuCau;
                                ...
                                _this.ngayYeuCau = dataTime;
                                _this.ghiChu = resultDatas[0].GhiChu;
                                _this.apiService.post('YeuCauLinhVatTu/GetDataGridYeuCauLinhVatTuLuuTamThoi', vo_1).subscribe(function (resultData) {
                                    _this.gridDataSource = {
                                        data: resultData,
                                        total: resultData.length
                                    };
                ...
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.changeTuNgay = function (event) {
                    this.timkiem();
                };
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.changeDenNgay = function (event) {
                    this.timkiem();
                };
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.blur = function () {
                    this.timkiem();
                };
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.timkiem = function () {
                    var _this = this;
                    this.loadingPage();
                    this.apiService.get("YeuCauLinhVatTu/GetALL?id=" + this.yeuCauLinhVatTuId).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            _this.phieuLinhTrucTiep.KeyId = resultData.KhoXuatId;
                            _this.phieuLinhTrucTiep.DisplayName = resultData.TenKhoXuat;
                            var vo_2 = {
                                KhoLinhId: resultData.KhoXuatId,
                                YeuCauLinhVatTuId: _this.yeuCauLinhVatTuId,
                                TuNgay: src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].formatDateTime(_this.searchDanhSachThongVatTu.TuNgay, "mm/dd/yyyy"),
                                DenNgay: src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].formatDateTime(_this.searchDanhSachThongVatTu.DenNgay, "mm/dd/yyyy")
                            };
                            _this.apiService.post('YeuCauLinhVatTu/ThongTinLinhTuKhoDaTao?idYeuCauLinhDP=' + _this.yeuCauLinhVatTuId).subscribe(function (resultDatas) {
                                _this.linhTrucTiepVatTuObject.NhanVienYeuCauId = resultDatas[0].NhanVienYeuCauId;
                                _this.linhTrucTiepVatTuObject.KhoNhapId = resultDatas[0].LinhVePhongId;
                                _this.linhVeKhoa = resultDatas[0].LinhVeKhoa;
                                _this.nguoiYeuCau = resultDatas[0].NguoiYeuCau;
                                ...
                                _this.ngayYeuCau = dataTime;
                                _this.ghiChu = resultDatas[0].GhiChu;
                                _this.apiService.post('YeuCauLinhVatTu/GetDataGridYeuCauLinhVatTuLuuTamThoi', vo_2).subscribe(function (resultData) {
                                    _this.gridDataSource = {
                                        data: resultData,
                                        total: resultData.length
                                    };
                ...
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.extCheckboxSelections = function (event) {
                    var _this = this;
                    this.cdRef.detectChanges();
                    var tmpArray = event;
                    var tmp = [];
                    ...
                    if (this.linhTrucTiepVatTuObject.CheckKhiTao.length != 0) {
                        ...
                        var _loop_2 = function (i) {
                            for (var j = 0; j < this_2.linhTrucTiepVatTuObject.CheckKhiTao.length; j++) {
                                if (this_2.linhTrucTiepVatTuObject.CheckKhiTao[j] == this_2.gridDataSource.data[i].YeuCauTiepNhanId) {
                                    if (this_2.checkChild == false) {
                                        this_2.gridDataSource.data[i].IsCheckRowItem = true;
                                        if (this_2.gridDataSource.data[i].ListYeuCauVatTuBenhViens.length == this_2.gridDataSource.data[i].ListYeuCauVatTuBenhViens.filter(function (sp) { return sp.IsCheckRowItem == false; }).length) {
                                            this_2.gridDataSource.data[i].ListYeuCauVatTuBenhViens.forEach(function (elements) {
                                                if (elements.SoLuongTon >= elements.SLYeuCau) {
                                                    elements.IsCheckRowItem = true;
                                                }
                                            });
                                        }
                                        this_2.getDataSourceChild(this_2.gridDataSource.data[i].ListYeuCauVatTuBenhViens);
                                        break;
                                    }
                                    else {
                                        this_2.gridDataSource.data[i].IsCheckRowItem = true;
                ...
                // grid item con 
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.checkboxGridChild = function (event, dataItem) {
                    var _this = this;
                    if (event == true) {
                        dataItem.IsCheckRowItem = true;
                    }
                    ...
                    this.gridDataSource.data.forEach(function (element) {
                        if (dataItem.YeuCauTiepNhanId == element.Id) {
                            ...
                            if (inxdex != -1) {
                                ...
                                var inxdex_3 = element.ListYeuCauVatTuBenhViens.filter(function (sp) { return sp.IsCheckRowItem == false; });
                                if (element.ListYeuCauVatTuBenhViens.length == inxdex_3.length) {
                                    if (!jQuery('#' + _this.linhTrucTiepMasterName + 'selectCheckboxId' + element.Id).prop('unchecked')) {
                                        jQuery('#' + _this.linhTrucTiepMasterName + 'selectCheckboxId' + element.Id).trigger('click');
                                    }
                                }
                                ...
                                _this.checkChild = true;
                                var inxdex_4 = element.ListYeuCauVatTuBenhViens.filter(function (sp) { return sp.IsCheckRowItem == false; });
                                if (element.ListYeuCauVatTuBenhViens.length == inxdex_4.length) {
                                    if (!jQuery('#' + _this.linhTrucTiepMasterName + 'selectCheckboxId' + element.Id).prop('unchecked')) {
                                        jQuery('#' + _this.linhTrucTiepMasterName + 'selectCheckboxId' + element.Id).trigger('click');
                                    }
                                }
                ...
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.getDataSourceChild = function (parentItem) {
                    return {
                        data: parentItem,
                        total: parentItem.length
                    };
                };
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.gridDichVuDuocCheck = function () {
                    var _this = this;
                    var yeuCauVatTuBenhViens = [];
                    this.gridDataSource.data.forEach(function (element) {
                        if (element.IsCheckRowItem == true) {
                ...
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.loadingPage = function () {
                    this.popupLoadingData = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_11__["LoadingComponent"], {
                        disableClose: true,
                        width: "200px",
                        height: "90px",
                ...
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.selectCheckBox = function (arr) {
                    var _this = this;
                    if (arr.length != 0) {
                ...
                PhieuLinhVtTrucTiepChoGoiSharedComponent.prototype.getSharedData = function () {
                    var _this = this;
                    //thong tin login 
                    this.validationErrors = [];
                    this.linhTrucTiepVatTuObject.GhiChu = this.ghiChu;
                ...
                return PhieuLinhVtTrucTiepChoGoiSharedComponent;
            }());
            PhieuLinhVtTrucTiepChoGoiSharedComponent.ctorParameters = function () { return [
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_3__["NotificationService"] },
                { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopupThongBaoVtKhongTheTaoComponent = /** @class */ (function () {
                function PopupThongBaoVtKhongTheTaoComponent(data, dialogRef) {
                    this.data = data;
                    this.dialogRef = dialogRef;
                ...
                PopupThongBaoVtKhongTheTaoComponent.prototype.ngOnInit = function () {
                ...
                PopupThongBaoVtKhongTheTaoComponent.prototype.Khong = function (item) {
                    if (item != undefined && item != null && item != "") {
                        this.close();
                    }
                };
                PopupThongBaoVtKhongTheTaoComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                PopupThongBaoVtKhongTheTaoComponent.prototype.Co = function (item) {
                    if (item != undefined && item != null && item != "") {
                        this.dialogRef.close(item);
                    }
                };
                return PopupThongBaoVtKhongTheTaoComponent;
            }());
            PopupThongBaoVtKhongTheTaoComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaoPhieuLinhVatTuBuComponent = /** @class */ (function () {
                function TaoPhieuLinhVatTuBuComponent(apiService, dialog, notificationService, authService, router, ref, location, urlService, route) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                TaoPhieuLinhVatTuBuComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                TaoPhieuLinhVatTuBuComponent.prototype.loadingPage = function () {
                    this.popupLoadingData = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_12__["LoadingComponent"], {
                        disableClose: true,
                        width: "200px",
                        height: "90px",
                ...
                TaoPhieuLinhVatTuBuComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TaoPhieuLinhVatTuBuComponent.prototype.loadingPageHoanThanh = function () {
                ...
                TaoPhieuLinhVatTuBuComponent.prototype.closePopupLoadingDataHoanThanh = function () {
                    if (this.popupLoadingDataHoanThanh != undefined && this.popupLoadingDataHoanThanh != null) {
                        this.popupLoadingDataHoanThanh.close();
                    }
                };
                TaoPhieuLinhVatTuBuComponent.prototype.luuPhieuLinhVatTu = function (daGui) {
                    var self = this;
                    self.yeuCauLinhBuVatTu = self.shared.getSharedData();
                    if (self.yeuCauLinhBuVatTu.YeuCauVatTuBenhViens.every(function (z) { return !z.CheckBox; })) {
                        if (daGui) {
                            self.notificationService.showError("Vui lòng chọn vật tư muốn gửi phiếu.");
                        }
                        else {
                ...
                TaoPhieuLinhVatTuBuComponent.prototype.xacNhanTaoPhieuLinh = function () {
                    var _this = this;
                    var self = this;
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
                        ...
                        self.loadingPage();
                        self.apiService.post("YeuCauLinhVatTu/GuiPhieuLinhBuVatTu", self.yeuCauLinhBuVatTu).subscribe(function (result) {
                            if (result != undefined && result != null) {
                ...
                TaoPhieuLinhVatTuBuComponent.prototype.xacNhanLuuPhieuLinh = function () {
                    var self = this;
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
                ...
                TaoPhieuLinhVatTuBuComponent.prototype.cancel = function () {
                    this.location.back();
                ...
                TaoPhieuLinhVatTuBuComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 27 && !event.ctrlKey) {
                        //esc
                        this.cancel();
                        event.preventDefault();
                ...
                TaoPhieuLinhVatTuBuComponent.prototype.XemPhieuLinh = function () {
                    var _this = this;
                    var self = this;
                    self.yeuCauLinhBuVatTu = self.shared.getSharedData();
                    self.validationErrors = [];
                            ...
                            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_15__["ConfirmComponent"], {
                                ...
                                if (res == "Yes") {
                                    ...
                                    var dataIn = {
                                        ...
                                        YeuCauVatTuBenhViens: self.yeuCauLinhBuVatTu.YeuCauVatTuBenhViens.filter(function (d) { return d.CheckBox; })
                                    };
                                    self.apiService.post("YeuCauLinhVatTu/InPhieuLinhBuVatTuXemTruoc", dataIn).subscribe(function (resData) {
                                        if (resData != undefined && resData != null) {
                                            self.closePopupLoadingDataHoanThanh();
                                            self.inPhieuLinhThuong.Header = false;
                                            self.dialog.open(_phieu_linh_vat_tu_thuong_popup_phieu_linh_vat_tu_thuong_popup_component__WEBPACK_IMPORTED_MODULE_18__["PhieuLinhVatTuThuongPopupComponent"], {
                ...
                return TaoPhieuLinhVatTuBuComponent;
            }());
            TaoPhieuLinhVatTuBuComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _phieu_linh_vat_tu_thuong_popup_phieu_linh_vat_tu_thuong_popup_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../phieu-linh-vat-tu-thuong-popup/phieu-linh-vat-tu-thuong-popup.component */ "./src/app/modules/main/nhap-xuat/vat-tu/yeu-cau-linh-vat-tu/phieu-linh-vat-tu-thuong-popup/phieu-linh-vat-tu-thuong-popup.component.ts");
            var TaoPhieuLinhVatTuThuongComponent = /** @class */ (function () {
                function TaoPhieuLinhVatTuThuongComponent(apiService, dialog, notificationService, authService, router, ref) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                TaoPhieuLinhVatTuThuongComponent.prototype.ngOnInit = function () {
                ...
                TaoPhieuLinhVatTuThuongComponent.prototype.loadingPage = function () {
                ...
                TaoPhieuLinhVatTuThuongComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TaoPhieuLinhVatTuThuongComponent.prototype.luuPhieuLinhThuongVatTu = function () {
                    var self = this;
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
                                self.loadingPage();
                                self.yeuCauLinhThuongVatTu.YeuCauLinhVatTuChiTiets = self.yeuCauLinhThuongVatTu.YeuCauLinhVatTuChiTiets.sort(function (a, b) { return (a.Nhom > b.Nhom || a.STT > b.STT || a.Ten > b.Ten) ? 1 : -1; });
                                self.apiService.post("YeuCauLinhVatTu/GuiPhieuLinhThuongVatTu", self.yeuCauLinhThuongVatTu).subscribe(function (result) {
                                    if (result != undefined && result != null) {
                ...
                TaoPhieuLinhVatTuThuongComponent.prototype.guiPhieuLinhThuongVatTu = function () {
                    var _this = this;
                    var self = this;
                    self.yeuCauLinhThuongVatTu = self.shared.getSharedData();
                    self.validationErrors = [];
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
                                ...
                                self.yeuCauLinhThuongVatTu.YeuCauLinhVatTuChiTiets = self.yeuCauLinhThuongVatTu.YeuCauLinhVatTuChiTiets.sort(function (a, b) { return (a.Nhom > b.Nhom || a.STT > b.STT) ? 1 : -1; });
                                self.apiService.post("YeuCauLinhVatTu/GuiPhieuLinhThuongVatTu", self.yeuCauLinhThuongVatTu).subscribe(function (result) {
                                    if (result != undefined && result != null) {
                                        self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                                        self.closePopupLoadingData();
                ...
                TaoPhieuLinhVatTuThuongComponent.prototype.cancel = function () {
                    this.router.navigate(['/nhap-xuat/vat-tu/yeu-cau-linh-vat-tu']);
                };
                TaoPhieuLinhVatTuThuongComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 27 && !event.ctrlKey) {
                        //esc
                        this.cancel();
                        event.preventDefault();
                ...
                return TaoPhieuLinhVatTuThuongComponent;
            }());
            TaoPhieuLinhVatTuThuongComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_8__["ApiService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_10__["NotificationService"] },
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_9__["AuthService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaoPhieuLinhVatTuTrucTiepComponent = /** @class */ (function () {
                function TaoPhieuLinhVatTuTrucTiepComponent(apiService, dialog, notificationService, authService, router, route, ref, location, urlService) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                TaoPhieuLinhVatTuTrucTiepComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                TaoPhieuLinhVatTuTrucTiepComponent.prototype.create = function (goi) {
                    var _this = this;
                    var self = this;
                    var messageLuu = "Bạn có muốn lưu phiếu lĩnh vật tư này không ?";
                    var messageGoi = "Bạn có muốn tạo phiếu lĩnh vật tư này không ?";
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Add)) {
                        ...
                        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                var kiemTraCoDuocPhamKhongDuTon = _this.getItemKhongDuTon(self.yeuCauLinhDuocPham.DanhSachVatTuTonKhongDus);
                                self.closePopupLoadingData();
                                self.validationErrors = [];
                                self.ref.detectChanges();
                                if (kiemTraCoDuocPhamKhongDuTon.length == 0) {
                ...
                TaoPhieuLinhVatTuTrucTiepComponent.prototype.cancel = function () {
                ...
                TaoPhieuLinhVatTuTrucTiepComponent.prototype.loadingPage = function () {
                    this.popupLoadingData = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_12__["LoadingComponent"], {
                        disableClose: true,
                        width: "200px",
                        height: "90px",
                ...
                TaoPhieuLinhVatTuTrucTiepComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TaoPhieuLinhVatTuTrucTiepComponent.prototype.xemPhieuLinh = function () {
                    var self = this;
                    self.yeuCauLinhDuocPham = self.shared.getSharedData();
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Add)) {
                        if (self.yeuCauLinhDuocPham.YeuCauVatTuBenhVienIds.length == 0) {
                            ...
                            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                                ...
                                if (res == "Yes") {
                                    self.loadingPage();
                                    var objInVatTuXemTruoc = new _yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_13__["XemTruocPhieuLinhVatTuTrucTiep"]();
                                    if (window.location.protocol == "http:") {
                                    ...
                                    self.apiService.post("YeuCauLinhVatTu/InXemTruocPhieuLinhTrucTiepVatTu", objInVatTuXemTruoc).subscribe(function (resData) {
                                        if (resData != undefined && resData != null) {
                                            self.inPhieuLinhTrucTiep.Header = false;
                ...
                TaoPhieuLinhVatTuTrucTiepComponent.prototype.getItemKhongDuTon = function (danhSachYeuCauVatTuBenhVien) {
                    var data = [];
                    var dataKhongChoTao = [];
                    var dataList = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_21__["process"])(danhSachYeuCauVatTuBenhVien, this.state);
                    console.log("::::::::::::::::::::::", dataList);
                    dataList.data.forEach(function (element) {
                        var tongSlYeuCau = 0;
                        var tenVatTu = "";
                ...
                TaoPhieuLinhVatTuTrucTiepComponent.prototype.newCreate = function () {
                    var self = this;
                    self.loadingPage();
                    self.apiService.post("YeuCauLinhVatTu/GuiPhieuLinhTrucTiep", self.yeuCauLinhDuocPham).subscribe(function (result) {
                        if (result != undefined && result != null) {
                ...
                return TaoPhieuLinhVatTuTrucTiepComponent;
            }());
            TaoPhieuLinhVatTuTrucTiepComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_11__["NotificationService"] },
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var YeuCauLinhVatTuRoutingModule = /** @class */ (function () {
                function YeuCauLinhVatTuRoutingModule() {
                }
                return YeuCauLinhVatTuRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var YeuCauLinhVatTuModule = /** @class */ (function () {
                function YeuCauLinhVatTuModule() {
                }
                return YeuCauLinhVatTuModule;
            }());
...
//# sourceMappingURL=nhap-xuat-vat-tu-yeu-cau-linh-vat-tu-yeu-cau-linh-vat-tu-module-es5.js.map
//# sourceMappingURL=nhap-xuat-vat-tu-yeu-cau-linh-vat-tu-yeu-cau-linh-vat-tu-module-es5.js.map