...
let BenhNhanCreateComponent = class BenhNhanCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
BenhNhanCreateComponent.ctorParameters = () => [
...
let BenhNhanListComponent = class BenhNhanListComponent {
    constructor(apiService, authService, router, notificationService, dialog, baseService) {
    ...
    XuatExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("BenhNhan/ExportBenhNhan", this.gridChild._gridQueryInfo).subscribe(resultData => {
...
BenhNhanListComponent.ctorParameters = () => [
...
let BenhNhanRoutingModule = class BenhNhanRoutingModule {
};
...
let BenhNhanSharedComponent = class BenhNhanSharedComponent {
    constructor(route, apiService, intl, dialog, ref, notificationService, authService, router, baseService) {
        this.route = route;
        this.apiService = apiService;
        this.intl = intl;
        this.dialog = dialog;
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Update)) {
            ...
            self.baseService.getById(id).subscribe(resultData => {
                ...
                if (self.benhNhan.BenhNhanTienSuBenhs != []) {
                    ...
                    let indexs = 1;
                    self.gridDataSourceTienSuBenh.data.forEach((obj) => {
                        obj.STT = indexs;
                        indexs++;
                    });
                ...
                if (self.benhNhan.BenhNhanDiUngThuocs != []) {
                    ...
                    let indexs = 1;
                    self.gridDataSourceDiUngThuoc.data.forEach((obj) => {
                        obj.STT = indexs;
                        indexs++;
                    });
                ...
                if (self.benhNhan.BenhNhanCongTyBaoHiemTuNhans != []) {
                    ...
                    let index2 = 1;
                    self.gridDataSourceBHTN.data.forEach((obj) => {
                        obj.STT = index2;
                        index2++;
                    });
    ...
    PhuongXaChange(event) {
        if (event != null && event != undefined) {
            this.apiService.post("benhNhan/SetTinhThanhQuanHuyen?phuongXaId=" + event).subscribe(resultData => {
    ...
    setNoiDKBD(benhNhan) {
        this.apiService.post("TiepNhanBenhNhan/GetNoiDangKyBaoHiem?ma=" + benhNhan.MaDKBD).subscribe(resultData => {
    ...
    changeSoTheBHYT(theBHYT) {
        if (!this.benhNhan.TuNhap) {
            theBHYT.IsChange = true;
        }
    }
    getThongTinTheBHYT(benhNhan) {
        if (benhNhan.BHYTMaSoThe
            && this.benhNhan.HoTen
            && (this.benhNhan.NamSinh != null || this.benhNhan.NgayThangNamSinh != null)
            && !this.benhNhan.TuNhap) {
            this.showPopupLoadingData();
            let thongTinBenhNhan = new src_app_modules_main_dieu_tri_noi_tru_tiep_nhan_noi_tru_tiep_nhan_noi_tru_model__WEBPACK_IMPORTED_MODULE_20__["ThongTinBenhNhanTimKiemBHYT"](benhNhan.BHYTMaSoThe, this.benhNhan.HoTen, this.benhNhan.NgayThangNamSinh, null, this.benhNhan.NamSinh);
            this.apiService
    ...
    getThongTinBHYTonKey(isSoTheBHYT) {
    ...
    congTyBaoHiemChange(event) {
        if (event != undefined && event != null) {
            ...
            this.apiService.post("benhNhan/GetThongTinBHTN/?congTyBaoHiemTuNhanId=" + event).subscribe(resultData => {
    ...
    themCongTyBHTN() {
        ...
        self.apiService.post("BenhNhan/ThemBHTN", self.baoHiemTuNhan).subscribe(resultData => {
            if (resultData != undefined && resultData != null) {
    ...
    xoaCongTyBHTN(dataItem) {
        this.lstBHTN.splice(this.lstBHTN.findIndex((x) => x == dataItem), 1);
        this.validationErrorsBHTN = [];
    ...
    pushDataCongTyBHTN() {
        ...
        this.lstBHTN.forEach(obj => {
            let model = new _benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["BenhNhanBaoHiemTuNhanViewModel"]();
    ...
    getArrayTenTienSuBenh() {
        ...
        this.lstTienSuBenh.forEach(element => {
            let model = new _benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["BenhNhanTienSuBenhChiTiet"]();
    ...
    themTienSuBenh() {
        ...
        self.ref.detectChanges();
        self.apiService.post("BenhNhan/ThemTienSuBenh", self.tienSuBenh).subscribe(resultData => {
            if (resultData != undefined && resultData != null) {
    ...
    xoaTienSuBenh(dataItem) {
        this.lstTienSuBenh.splice(this.lstTienSuBenh.findIndex((x) => x == dataItem), 1);
        this.validationErrorsTSB = [];
    ...
    pushDataTienSuBenh() {
        ...
        this.lstTienSuBenh.forEach(obj => {
            let model = new _benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["BenhNhanTienSuBenhViewModel"]();
            model.BenhNhanId = obj.BenhNhanId;
    ...
    getArrayDiUngThuoc() {
        ...
        this.lstDiUngThuoc.forEach(element => {
            let model = new _benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["BenhNhanDiUngThuocChiTiet"]();
    ...
    ThemDiUngThuoc() {
        ...
        self.apiService.post("BenhNhan/ThemDiUngThuoc", self.diUngThuoc).subscribe(resultData => {
            self.tenDiUng = null;
            if (resultData != undefined && resultData != null) {
    ...
    xoaDiUngThuoc(dataItem) {
        this.lstDiUngThuoc.splice(this.lstDiUngThuoc.findIndex((x) => x == dataItem), 1);
        this.validationErrorsDUT = [];
    ...
    pushDataDiUngThuoc() {
        ...
        this.lstDiUngThuoc.forEach(obj => {
            let model = new _benh_nhan_model__WEBPACK_IMPORTED_MODULE_2__["BenhNhanDiUngThuocViewModel"]();
            model.BenhNhanId = obj.BenhNhanId;
...
BenhNhanSharedComponent.ctorParameters = () => [
...
let BenhNhanUpdateComponent = class BenhNhanUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
BenhNhanUpdateComponent.ctorParameters = () => [
...
class BenhNhan {
    constructor(HoTen = null, NgayThangNamSinh = null, NgaySinh = null, ThangSinh = null, NamSinh = null, SoChungMinhThu = null, GioiTinh = null, GioiTinhDisplay = null, NgheNghiepId = null, NoiLamViec = null, QuocTichId = null, DanTocId = null, DiaChi = null, PhuongXaId = null, QuanHuyenId = null, TinhThanhId = null, SoDienThoai = null, Email = null, NguoiLienHeHoTen = null, NguoiLienHeQuanHeNhanThanId = null, NguoiLienHeSoDienThoai = null, NguoiLienHeEmail = null, NguoiLienHeDiaChi = null, NguoiLienHePhuongXaId = null, NguoiLienHeQuanHuyenId = null, NguoiLienHeTinhThanhId = null, BHYTMaSoThe = null, BHYTNgayHieuLuc = null, BHYTNgayHetHan = null, BHYTDiaChi = null, BHYTCoQuanBHXH = null, BHYTNgayDu5Nam = null, BHYTNgayDu5NamDisplay = null, BHYTMaDKBD = null, BHYTNgayHetHanDisplay = null, BHYTNgayHieuLucDisplay = null, NgheNghiepText = null, NhomMauText = null, NhomMau = null, QuocTichText = null, NguoiLienHeQuanHeNhanThanText = null, CoTienSuBenh = null, CoDiUngThuoc = null, CoBHYT = null, CoBHTN = null, BenhNhanTienSuBenhs = [], BenhNhanDiUngThuocs = [], BenhNhanCongTyBaoHiemTuNhans = [], TuNhap = false) {
        this.HoTen = HoTen;
...
class ThongTinBenhNhan {
    constructor(MaThe = null, TenBenhNhan = null, NgaySinh = null, NgaySinhDisplay = null) {
        this.MaThe = MaThe;
...
class BenhNhanTienSuBenhViewModel {
    constructor(STT = null, Id = 0, BenhNhanId = 0, TenBenh = null, LoaiTienSuBenh = null, TenLoaiTienSuBenh = null, TenTienSuBenhs = []) {
        this.STT = STT;
        this.Id = Id;
...
class BenhNhanTienSuBenhChiTiet {
    constructor(LoaiTienSuBenh = null, TenBenh = null) {
        this.LoaiTienSuBenh = LoaiTienSuBenh;
        this.TenBenh = TenBenh;
    }
}
class BenhNhanDiUngThuocViewModel {
    constructor(STT = null, Id = 0, BenhNhanId = 0, ThuocId = null, TenThuoc = null, BieuHienDiUng = null, TenDiUng = null, LoaiDiUng = null, LoaiDiUngDisplay = null, MucDo = null, MucDoDisplay = null, TenDiUngThuocs = []) {
        this.STT = STT;
        this.Id = Id;
        this.BenhNhanId = BenhNhanId;
...
class BenhNhanDiUngThuocChiTiet {
    constructor(LoaiDiUng = null, TenDiUng = null, ThuocId = null) {
        this.LoaiDiUng = LoaiDiUng;
        this.TenDiUng = TenDiUng;
        this.ThuocId = ThuocId;
    }
}
class BenhNhanBaoHiemTuNhanViewModel {
    constructor(STT = null, BenhNhanId = 0, CongTyBaoHiemTuNhanId = null, CongTyDisplay = null, MaSoThe = null, NgayHieuLuc = null, NgayHieuLucDisplay = null, NgayHetHan = null, NgayHetHanDisplay = null, SoDienThoai = null, DiaChi = null, CongTyBHTNIds = null) {
        this.STT = STT;
        this.BenhNhanId = BenhNhanId;
...
let BenhNhanModule = class BenhNhanModule {
};
...
let BenhNhanService = class BenhNhanService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BenhNhan';
    }
};
BenhNhanService.ctorParameters = () => [
...
let TheBenhNhanBenhNhanPopupComponent = class TheBenhNhanBenhNhanPopupComponent {
    ...
    xemTheBenhNhan() {
        ...
        this.apiService.get("BenhNhan/InTheBenhNhanBenhNhan?benhNhanId=" + benhNhanId + "&hostingName=" + this.hostingName).subscribe(resultData => {
            if (resultData != null) {
                var html = resultData;
...
TheBenhNhanBenhNhanPopupComponent.ctorParameters = () => [
