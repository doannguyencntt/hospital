...
let BhytThongTinXacNhanComponent = class BhytThongTinXacNhanComponent {
    constructor(route, apiService, notificationService, dialog, authService, cdRef) {
        this.route = route;
            ...
            case 'ThanhTienBenhVien': {
                if (this.dataHuongBh.data.length !== 0) {
                    return this.dataHuongBh.data
                        .reduce((sum, item) => sum + item.ThanhTienBenhVien, 0);
                }
            }
        }
    }
    totalThanhTienKDHBYT(field, typeGrid) {
        switch (field) {
            case 'ThanhTienBenhVien': {
    ...
    totalTTBHYTChiTra(field, typeGrid) {
        switch (field) {
            case 'TTBHYTChiTra': {
                if (this.dataHuongBh.data.length !== 0) {
    ...
    totalKTTBHYTChiTra(field, typeGrid) {
        switch (field) {
            case 'TTBHYTChiTra': {
                if (this.dataChuaHuongBh.data.length !== 0) {
    ...
    totalBNConPhaiThanhToanKDHBYT(field, typeGrid) {
        switch (field) {
            case 'BNThanhToan': {
                if (this.dataChuaHuongBh.data.length !== 0) {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_16__["SecurityOperation"].View)) {
            rxjs_Observable__WEBPACK_IMPORTED_MODULE_18__["Observable"].forkJoin([
                this.apiService.get(`XacNhanBHYT/GetDataForDvChuaHuongBhytNoiTruAsync?yeuCauTiepNhanId=${this.thisId}`)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_20__["retryWhen"])(errors => errors.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_20__["tap"])(_ => {
                    this.dataChuaHuongBh.data = [];
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_20__["delayWhen"])(_ => {
    ...
    SetBenefitRaioForWholeBenefitInsurance(wholeRatio = 100, isGiaSu = false, ignoreMucHuongSystem = false) {
        ...
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKhamBenh)) {
        ...
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKyThuat)) {
        ...
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].VatTuTieuHao)) {
        ...
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DuocPham)) {
        ...
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuGiuongBenh)) {
        ...
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DonThuocThanhToan)) {
    ...
    SetWarning() {
        ...
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKhamBenh) ||
            self.dataChuaHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKhamBenh)) {
            self.SetupWarning(src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKhamBenh);
        }
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKyThuat) ||
            self.dataChuaHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKyThuat)) {
            self.SetupWarning(src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKyThuat);
        }
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].VatTuTieuHao) ||
            self.dataChuaHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].VatTuTieuHao)) {
            self.SetupWarning(src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].VatTuTieuHao);
        }
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DuocPham) ||
            self.dataChuaHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DuocPham)) {
            self.SetupWarning(src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DuocPham);
        }
        if (self.dataHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuGiuongBenh) ||
            self.dataChuaHuongBh.data.some(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuGiuongBenh)) {
    ...
    MoveCuringServicesFromHuongInsuranceToNotHuongInsurance() {
        if (this.dataHuongBh.data.filter(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKhamBenh).length > 5) {
            ...
            const dataHuongMovingList = this.dataHuongBh.data
                .filter(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKhamBenh)
                .splice(5, this.dataHuongBh.data.filter(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKhamBenh).length);
            for (const dataHuongMove of dataHuongMovingList) {
                dataHuongMove.HighLightClass = '';
                dataHuongMove.HuongBhyt = false;
                const pushedPosition = this.dataChuaHuongBh.data.some(x => x) ? this.dataChuaHuongBh.data.indexOf(this.dataChuaHuongBh.data.filter(x => x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_11__["NhomGoiDichVu"].DichVuKhamBenh && x.Id > dataHuongMove.Id)[0]) : 0;
    ...
    showTooltip(dataItem) {
        const self = this;
        if (dataItem != null) {
            self.currentWarningMessage = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_9__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["DuyetBhytMessage"].MessageSpecifyPhong, [self.serviceGroupIds.filter(x => x.Id === dataItem.Id)[0].PhongBenhVienChiDinh,
            ...
            this.apiService
                ...
                if (resp) {
                    if (result.TenGuid.indexOf('.pdf') !== -1 || result.TenGuid.indexOf('.PDF') !== -1) {
                        this.dialog.open(src_app_shared_component_dialogs_view_image_pdf_view_image_pdf_component__WEBPACK_IMPORTED_MODULE_9__["ViewImagePdfComponent"], {
                            disableClose: false,
                            width: '1000px',
                            height: '600px',
                            data: {
...
let XacNhanBhytNoiTruModule = class XacNhanBhytNoiTruModule {
};
