...
let DuyetYeuCauLinhVatTuBuSharedComponent = class DuyetYeuCauLinhVatTuBuSharedComponent {
    ...
    getById(id) {
        this.apiService.get("YeuCauLinhVatTu/GetYeuCauLinhVatTuBu?id=" + id)
            ...
            if (resultData !== undefined && resultData != null) {
                ...
                this.trangThaiYeuCau.emit(new _duyet_yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_5__["TrangThaiDuyetYeuCauLinh"](this.yeuCauLinh.TenTrangThai, this.yeuCauLinh.DuocDuyet));
                this.gridColumns = [
                    { Field: "STT", Title: "#", Width: 60, Template: this.sttTemplate },
                    { Field: "TenVatTu", Title: "Tên vật tư", Width: 180 },
                    { Field: "Nhom", Title: "Nhóm", Width: 100, Sortable: true, Hidden: true, TemplateGroupHeader: this.nhomGroupHeaderTemplate },
...
DuyetYeuCauLinhVatTuBuSharedComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhVatTuBuComponent = class DuyetYeuCauLinhVatTuBuComponent {
        ...
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_2__["ConfirmComponent"], {
            ...
            if (result === 'Yes') {
                ...
                this.apiService.post("YeuCauLinhVatTu/XuLyDuyetYeuCauLinhVatTuBu", this.yeuCauLinhVatTu)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_15__["SystemMessage"].ActionSuccessfully, ["Duyệt"]));
                    if (resultData != undefined && resultData != null) {
                        this.dialog.open(_phieu_xuat_linh_vat_tu_popup_phieu_xuat_linh_vat_tu_popup_component__WEBPACK_IMPORTED_MODULE_7__["PhieuXuatLinhVatTuPopupComponent"], {
                            disableClose: false,
                            width: '1200px',
                            data: resultData,
                        }).afterClosed().subscribe(result => {
        ...
        this.dialog.open(_khong_duyet_popup_khong_duyet_component__WEBPACK_IMPORTED_MODULE_6__["KhongDuyetComponent"], {
            ...
            if (result !== null) {
                ...
                this.apiService.post("YeuCauLinhVatTu/XuLyKhongDuyetYeuCauLinhVatTuBu", this.yeuCauLinhVatTu)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_15__["SystemMessage"].ActionSuccessfully, ["Không duyệt"]));
                    this.quayVeDanhSach();
                }, (err) => {
                    if (err.Message != "Validation Failed") {
                        this.notificationService.showError(err.Message);
...
DuyetYeuCauLinhVatTuBuComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhVatTuListComponent = class DuyetYeuCauLinhVatTuListComponent {
    ...
    exportExcel() {
        ...
        self.apiService.postExportExcel('YeuCauLinhVatTu/ExportDanhSachDuyetLinhVatTu', self.exportQueryInfoQueryInfo).subscribe(resultData => {
    ...
    InDuocPham(dataItem, loaiPhieuLinh) {
        ...
        this.apiService.post("YeuCauLinhVatTu/InYeuCauLinhVatTuTrucTiep?yeuCauLinhId=" + dataItem + "&loaiPhieuLinh=" + loaiPhieuLinh)
            .subscribe((resultData) => {
            if (resultData != undefined && resultData != null) {
                this.dialog.open(_phieu_xuat_linh_vat_tu_popup_phieu_xuat_linh_vat_tu_popup_component__WEBPACK_IMPORTED_MODULE_21__["PhieuXuatLinhVatTuPopupComponent"], {
                    disableClose: false,
                    width: '1200px',
                    data: resultData,
                }).afterClosed().subscribe(result => {
...
DuyetYeuCauLinhVatTuListComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhVatTuRoutingModule = class DuyetYeuCauLinhVatTuRoutingModule {
};
...
let DuyetYeuCauLinhVatTuThuongSharedComponent = class DuyetYeuCauLinhVatTuThuongSharedComponent {
    constructor(apiService, route, notificationService) {
        this.apiService = apiService;
        this.route = route;
        this.notificationService = notificationService;
    ...
    getById(id) {
        this.apiService.get("YeuCauLinhVatTu/GetYeuCauLinhVatTuThuong?id=" + id)
            ...
            if (resultData !== undefined && resultData != null) {
                ...
                this.trangThaiYeuCau.emit(new _duyet_yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_6__["TrangThaiDuyetYeuCauLinh"](this.yeuCauLinh.TenTrangThai, this.yeuCauLinh.DuocDuyet));
                this.gridDataSource = {
...
DuyetYeuCauLinhVatTuThuongSharedComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhVatTuThuongComponent = class DuyetYeuCauLinhVatTuThuongComponent {
    constructor(dialog, location, apiService, notificationService, router, route) {
        this.dialog = dialog;
        this.location = location;
        this.apiService = apiService;
...
DuyetYeuCauLinhVatTuThuongComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhVatTuTrucTiepSharedComponent = class DuyetYeuCauLinhVatTuTrucTiepSharedComponent {
    constructor(apiService, route, notificationService) {
        this.apiService = apiService;
        this.route = route;
        this.notificationService = notificationService;
    ...
    getById(id) {
        this.apiService.get("YeuCauLinhVatTu/GetYeuCauLinhVatTuTrucTiep?id=" + id)
            ...
            if (resultData !== undefined && resultData != null) {
                this.yeuCauLinh = resultData;
                this.trangThaiYeuCau.emit(new _duyet_yeu_cau_linh_vat_tu_model__WEBPACK_IMPORTED_MODULE_4__["TrangThaiDuyetYeuCauLinh"](this.yeuCauLinh.TenTrangThai, this.yeuCauLinh.DuocDuyet));
...
DuyetYeuCauLinhVatTuTrucTiepSharedComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhVatTuTrucTiepComponent = class DuyetYeuCauLinhVatTuTrucTiepComponent {
    constructor(dialog, location, apiService, notificationService, router, route) {
        this.dialog = dialog;
        this.location = location;
        this.apiService = apiService;
...
DuyetYeuCauLinhVatTuTrucTiepComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_16__["Location"] },
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_10__["ApiService"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_11__["NotificationService"] },
...
class DuyetYeuCauLinhVatTu {
    constructor(Id = null, KhoXuatId = null, TenKhoXuat = null, KhoNhapId = null, TenKhoNhap = null, LoaiPhieuLinh = null, TenLoaiPhieuLinh = null, NhanVienYeuCauId = null, TenNhanVienYeuCau = null, NhanVienDuyetId = null, TenNhanVienDuyet = null, NgayYeuCau = null, NgayDuyet = null, GhiChu = null, SlYeuCau = null, NguoiXuatKhoId = null, TenNguoiXuatKho = null, NguoiNhapKhoId = null, TenNguoiNhapKho = null, isHideDuyet = false, DuocDuyet = null, TenTrangThai = null, LyDoKhongDuyet = null, DuyetYeuCauLinhVatTuChiTiets = [], LastModified = null) {
        this.Id = Id;
...
class DuyetYeuCauLinhVatTuChiTiet {
    constructor(VatTuBenhVienId = null, LaVatTuBhyt = null, TenDuocPham = null, NongDoHamLuong = null, HoatChat = null, DuongDung = null, Dvt = null, HangSanXuat = null, NuocSanXuat = null, SlTon = null, SoLuong = null, Nhom = null, Index = null) {
...
class LinhVatTuGridVo {
    constructor(NgayYeuCauRangDateStartDate = null, NgayYeuCauRangDateStartEnd = null, NgayDuyetRangDateStartDate = null, NgayDuyetRangDateStartEnd = null, Searching = null, TrangThaiCheck = null, DangChoDuyet = true, TuChoiDuyet = null, DaDuyet = null) {
...
let DuyetYeuCauLinhVatTuModule = class DuyetYeuCauLinhVatTuModule {
};
...
let KhongDuyetComponent = class KhongDuyetComponent {
...
KhongDuyetComponent.ctorParameters = () => [
...
let PhieuXuatLinhVatTuPopupComponent = class PhieuXuatLinhVatTuPopupComponent {
    constructor(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
...
PhieuXuatLinhVatTuPopupComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
];
