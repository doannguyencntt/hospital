...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-kiem-soat-nhiem-khuan-hoan-tra-duyet-hoan-tra-ksnk-duyet-hoan-tra-ksnk-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuyetHoanTraKSNKChiTietComponent = /** @class */ (function () {
                function DuyetHoanTraKSNKChiTietComponent(authService, dialog, elem, notificationService, apiService, router, route) {
                ...
                DuyetHoanTraKSNKChiTietComponent.prototype.ngOnInit = function () {
                ...
                DuyetHoanTraKSNKChiTietComponent.prototype.getCurrentUserInformation = function () {
                    var _this = this;
                ...
                DuyetHoanTraKSNKChiTietComponent.prototype.getThongTinDuyetKhoVatTu = function (id) {
                    var _this = this;
                    ...
                    if (this.loaiduocphamvattu === _hoan_tra_ksnk_model__WEBPACK_IMPORTED_MODULE_11__["LoaiDuocPhamVatTu"].LoaiDuocPham) {
                        this.apiService.get("YeuCauTraKSNK/GetThongTinDuyetHoanTraDuocPhamKSNK/" + id).subscribe(function (res) {
                            if (res) {
                                _this.thongTinHoanTraVatTu = res;
                                if (_this.thongTinHoanTraVatTu.ClassTrangThai === 'dang_cho_duyet') {
                                    _this.thongTinHoanTraVatTu.TenNguoiNhan = _this.thongTinHoanTraVatTu.TenNguoiYeuCau;
                                    _this.thongTinHoanTraVatTu.NguoiNhanId = _this.thongTinHoanTraVatTu.NguoiYeuCauId;
                                    _this.thongTinHoanTraVatTu.TenNguoiTra = _this.currentUserInformation.Ten;
                ...
                DuyetHoanTraKSNKChiTietComponent.prototype.BackToList = function () {
                    this.router.navigateByUrl("/nhap-xuat/ksnk/duyet-hoan-tra-ksnk?holdQuery=true");
                };
                DuyetHoanTraKSNKChiTietComponent.prototype.duyet = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Update)) {
                        ...
                        this.confrim = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                ...
                                _this.duyetHoanTraVatTu.LoaiDuocPhamVatTu = _this.loaiduocphamvattu;
                                _this.apiService.post("YeuCauTraKSNK/HoanTraKSNKKho/", _this.duyetHoanTraVatTu)
                                    .subscribe(function (resultData) {
                                    _this.notificationService.showSuccess("Duyệt thành công.");
                                    var yeuCauHoanTraVatTuId = _this.yeuCauNhapKhoVatTuId;
                                    var hoanTraDuocPhamId = _this.loaiduocphamvattu === _hoan_tra_ksnk_model__WEBPACK_IMPORTED_MODULE_11__["LoaiDuocPhamVatTu"].LoaiDuocPham ? yeuCauHoanTraVatTuId : null;
                                    var hoanTraVatTuId = _this.loaiduocphamvattu === _hoan_tra_ksnk_model__WEBPACK_IMPORTED_MODULE_11__["LoaiDuocPhamVatTu"].LoaiVatTu ? yeuCauHoanTraVatTuId : null;
                                    _this.dialog.open(_yeu_cau_tra_ksnk_in_phieu_hoan_tra_in_phieu_hoan_tra_component__WEBPACK_IMPORTED_MODULE_13__["InPhieuHoanTraKSNKComponent"], {
                                        disableClose: true,
                                        width: "1200px",
                ...
                DuyetHoanTraKSNKChiTietComponent.prototype.khongPheDuyet = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Update)) {
                        if (this.confrim != null) {
                            this.dialog.closeAll();
                        ...
                        this.confrim = this.dialog.open(_tu_choi_duyet_ksnk_tu_choi_duyet_ksnk_component__WEBPACK_IMPORTED_MODULE_12__["TuChoiDuyetKSNKComponent"], {
                            ...
                            if (result != "" && result != undefined) {
                                ...
                                _this.thongTinLyDoHuyNhapKhoVatTu.LoaiDuocPhamVatTu = _this.loaiduocphamvattu;
                                _this.apiService.post("YeuCauTraKSNK/TuChoiHoanTraKSNK", _this.thongTinLyDoHuyNhapKhoVatTu)
                                    .subscribe(function (resultData) {
                ...
                DuyetHoanTraKSNKChiTietComponent.prototype.InPhieuHoanTra = function () {
                    var yeuCauHoanTraVatTuId = this.yeuCauNhapKhoVatTuId;
                    var hoanTraDuocPhamId = this.loaiduocphamvattu === _hoan_tra_ksnk_model__WEBPACK_IMPORTED_MODULE_11__["LoaiDuocPhamVatTu"].LoaiDuocPham ? yeuCauHoanTraVatTuId : null;
                    var hoanTraVatTuId = this.loaiduocphamvattu === _hoan_tra_ksnk_model__WEBPACK_IMPORTED_MODULE_11__["LoaiDuocPhamVatTu"].LoaiVatTu ? yeuCauHoanTraVatTuId : null;
                ...
                return DuyetHoanTraKSNKChiTietComponent;
            }());
            DuyetHoanTraKSNKChiTietComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuyetHoanTraKSNKListComponent = /** @class */ (function () {
                function DuyetHoanTraKSNKListComponent(authService, location, dialog, elem, cd, notificationService, apiService, router, route) {
                    this.authService = authService;
                ...
                DuyetHoanTraKSNKListComponent.prototype.ngOnInit = function () {
                ...
                DuyetHoanTraKSNKListComponent.prototype.xemChiTiet = function (id, loaiDuocPhamVatTu) {
                ...
                DuyetHoanTraKSNKListComponent.prototype.Timkiem = function () {
                ...
                DuyetHoanTraKSNKListComponent.prototype.convertDateTimeToUTC = function () {
                ...
                DuyetHoanTraKSNKListComponent.prototype.reverseDateTime = function () {
                    if (this.duyetNhapKhoVatTu.RangeNhap.startDate) {
                ...
                DuyetHoanTraKSNKListComponent.prototype.CheckboxChange = function ($event, dangChoDuyet, tuChoiDuyet, daDuyet) {
                ...
                DuyetHoanTraKSNKListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.Timkiem();
                    }
                };
                DuyetHoanTraKSNKListComponent.prototype.clearSearch = function () {
                ...
                DuyetHoanTraKSNKListComponent.prototype.onKeyNgayNhap = function (event) {
                    if (event.key == "Enter") {
                        this.Timkiem();
                    }
                };
                DuyetHoanTraKSNKListComponent.prototype.changeNgayNhapRange = function (ev) {
                    this.Timkiem();
                };
                DuyetHoanTraKSNKListComponent.prototype.onKeyNgayDuyet = function (event) {
                    if (event.key == "Enter") {
                        this.Timkiem();
                    }
                };
                DuyetHoanTraKSNKListComponent.prototype.changeNgayDuyetRange = function (ev) {
                    this.Timkiem();
                };
                DuyetHoanTraKSNKListComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('YeuCauTraKSNK/ExportHoanTraKSNK', self.gridCha._gridQueryInfo).subscribe(function (resultData) {
                ...
                DuyetHoanTraKSNKListComponent.prototype.showPopupLoadingData = function () {
                ...
                DuyetHoanTraKSNKListComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                DuyetHoanTraKSNKListComponent.prototype.inYeuCauHoanTraVatTu = function (id, loaiduocphamvattu) {
                    var hoanTraDuocPhamId = loaiduocphamvattu === _hoan_tra_ksnk_model__WEBPACK_IMPORTED_MODULE_24__["LoaiDuocPhamVatTu"].LoaiDuocPham ? id : null;
                    var hoanTraVatTuId = loaiduocphamvattu === _hoan_tra_ksnk_model__WEBPACK_IMPORTED_MODULE_24__["LoaiDuocPhamVatTu"].LoaiVatTu ? id : null;
                ...
                return DuyetHoanTraKSNKListComponent;
            }());
            DuyetHoanTraKSNKListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuyetHoanTraKSNKRoutingModule = /** @class */ (function () {
                function DuyetHoanTraKSNKRoutingModule() {
                }
                return DuyetHoanTraKSNKRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuyetHoanTraKSNKModule = /** @class */ (function () {
                function DuyetHoanTraKSNKModule() {
                }
                return DuyetHoanTraKSNKModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuyetHoanTraKSNKService = /** @class */ (function (_super) {
                __extends(DuyetHoanTraKSNKService, _super);
                function DuyetHoanTraKSNKService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'YeuCauTraKSNK';
                    return _this;
                }
                return DuyetHoanTraKSNKService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            DuyetHoanTraKSNKService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TuChoiDuyetKSNKComponent = /** @class */ (function () {
                function TuChoiDuyetKSNKComponent(data, dialog, cdRef, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                    this.cdRef = cdRef;
                ...
                TuChoiDuyetKSNKComponent.prototype.ngOnInit = function () {
                    this.lyDoHuy = "";
                };
                TuChoiDuyetKSNKComponent.prototype.Huy = function () {
                    this.validationErrors = [];
                ...
                TuChoiDuyetKSNKComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                return TuChoiDuyetKSNKComponent;
            }());
            TuChoiDuyetKSNKComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=nhap-xuat-kiem-soat-nhiem-khuan-hoan-tra-duyet-hoan-tra-ksnk-duyet-hoan-tra-ksnk-module-es5.js.map
//# sourceMappingURL=nhap-xuat-kiem-soat-nhiem-khuan-hoan-tra-duyet-hoan-tra-ksnk-duyet-hoan-tra-ksnk-module-es5.js.map