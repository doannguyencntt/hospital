...
let DsVatTuTrungNccPopupComponent = class DsVatTuTrungNccPopupComponent {
...
DsVatTuTrungNccPopupComponent.ctorParameters = () => [
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_13__["ConfirmComponent"], {
            ...
            if (res == "Yes") {
                ...
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Add)) {
                    self.loadingPage();
                    self.apiService.post("NhapKhoVatTu/ThemYeuCauNhapKhoVatTu", self.nhapKhoVatTu).subscribe((result) => {
...
let NhapKhoListComponent = class NhapKhoListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            ...
            self.apiService.postExportExcel('NhapKhoVatTu/ExportNhapKhoVatTu', self.gridChild._gridQueryInfo).subscribe(resultData => {
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
            ...
            if (res == "Yes") {
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Delete)) {
                    this.apiService.post("NhapKhoVatTu/XoaYeuCauNhapKhoVatTu?id=" + id).subscribe(() => {
...
let NhapKhoShareComponent = class NhapKhoShareComponent {
    ...
    ngOnInit() {
        ...
        this.nhapKhoSource = new _nhap_kho__WEBPACK_IMPORTED_MODULE_2__["NhapKhoVatTu"]();
        this.nhapKhoChiTietSource = new _nhap_kho__WEBPACK_IMPORTED_MODULE_2__["NhapKhoVatTuChiTiet"]();
        let nhapKhoChiTietDataSource = new _nhap_kho__WEBPACK_IMPORTED_MODULE_2__["NhapKhoVatTuChiTiet"]();
    ...
    getById(id) {
        ...
        self.apiService.post("NhapKhoVatTu/GetGrid?id=" + id).subscribe(resultDataGrid => {
    ...
    getKhoVatTuYTe() {
        this.apiService.get("NhapKhoVatTu/GetKhoVatTuYTe").subscribe(result => {
    ...
    onChangeVatTu(event) {
        if (event !== null && event !== undefined) {
            ...
            //suggest nhom
            let self = this;
            this.apiService.post("NhapKhoVatTu/SuggestLoaiSuDung?id=" + event.KeyId).subscribe(resultData => {
                if (resultData != null && resultData != undefined) {
...
let NhapKhoTuChoiDuyetComponent = class NhapKhoTuChoiDuyetComponent {
    ...
    luu() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
            ...
            self.loading = true;
            self.nhapKhoVatTu = self.shared.getSharedData();
            self.apiService.post("NhapKhoVatTu/CapNhatYeuCauNhapKhoVatTu", self.nhapKhoVatTu).subscribe(resultData => {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
            ...
            self.apiService.post("NhapKhoVatTu/CapNhatYeuCauNhapKhoVatTu", self.nhapKhoVatTu).subscribe(resultData => {
                ...
                self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                    ...
                    if (result == "Yes") {
                        self.apiService.post("NhapKhoVatTu/GoiDuyetLai?id=" + self.id).subscribe(result => {
                            //self.router.navigate(['nhap-xuat/vat-tu/nhap-kho']);
                            self.router.navigateByUrl('nhap-xuat/vat-tu/nhap-kho?holdQuery=true');
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_13__["ConfirmComponent"], {
            ...
            if (res == "Yes") {
                ...
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_16__["SecurityOperation"].Update)) {
                    self.loadingPage();
                    self.apiService.post("NhapKhoVatTu/CapNhatYeuCauNhapKhoVatTu", self.nhapKhoVatTu).subscribe((result) => {
                        if (result != undefined && result != null) {
                            if (result.length > 0) {
...
let NhapKhoService = class NhapKhoService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'NhapKhoVatTu';
    }
};
...
let PhieuNhapKhoVatTuPopupComponent = class PhieuNhapKhoVatTuPopupComponent {
...
PhieuNhapKhoVatTuPopupComponent.ctorParameters = () => [
...
let XacNhanChonPhieuInVatTuPopupComponent = class XacNhanChonPhieuInVatTuPopupComponent {
    ...
    inPhieu() {
        var self = this;
        self.loadingPage();
        self.apiService.post("NhapKhoVatTu/InPhieuYeuCauNhapKhoVatTu", self.inPhieuNhapKhoVatTu).subscribe(resData => {
            if (resData != undefined && resData != null) {
                self.closePopupLoadingData();
...
XacNhanChonPhieuInVatTuPopupComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
