...
class DsBaoHiemYTe {
    constructor(MaTN = null, MaBN = null, HoTen = null, GioiTinh = null, DiaChi = null, MucHuong = null, SoTienBHYTDuyet = null, SearchString = null) {
        this.MaTN = MaTN;
        this.MaBN = MaBN;
        this.HoTen = HoTen;
...
class ThongTinBenhNhanViewModels {
    constructor() {
        this.ThongTinBenhNhanVMs = [];
    }
}
class XMLThongTinBenhNhan {
    constructor(MaLienKet = null, STT = null, MaBenhNhan = null, HoTen = null, NgaySinh = null, GioiTinh = null, DiaChi = null, MaThe = null, MaCoSoKCBBanDau = null, GiaTriTheTu = null, GiaTriTheDen = null, MienCungChiTra = null, TenBenh = null, MaBenh = null, MaBenhKhac = null, LyDoVaoVien = null, MaNoiChuyen = null, MaTaiNan = null, NgayVao = null, NgayRa = null, SoNgayDieuTri = null, KetQuaDieuTri = null, TinhTrangRaVien = null, TinhTrangRaVienText = null, NgayThanhToan = null, MucHuong = null, TienThuoc = null, TienVatTuYTe = null, DataJson = null, TienTongChi = null, TienBenhNhanTuTra = null, TienBenhNhanCungChiTra = null, TienBaoHiemThanhToan = null, TienNguonKhac = null, TienNgoaiDinhSuat = null, NamQuyetToan = null, ThangQuyetToan = null, MaLoaiKCB = null, MaKhoa = null, MaCSKCB = null, MaKhuVuc = null, MaPhauThuatQuocTe = null, CanNang = null, IsDownLoad = false, Version = null, WarningMessage = null, HoSoChiTietThuoc = [], HoSoChiTietDVKT = [], HoSoCanLamSang = [], HoSoChiTietDienBienBenh = []) {
...
class HoSoChiTietThuoc {
    constructor(MaLienKet = null, STT = null, MaThuoc = null, MaNhom = null, MaNhomChiPhi = null, MaNhomText = null, TenThuoc = null, DonViTinh = null, HamLuong = null, DuongDung = null, LieuDung = null, SoDangKy = null, SoLuong = null, DonGia = null, TyLeThanhToan = null, ThanhTien = null, MaKhoa = null, MaBacSi = null, MaBenh = null, NgayYLenh = null, ThongTinThau = null, PhamVi = null, MucHuong = null, TienBenhNhanTuTra = 0, TienNguonKhac = 0, TienBaoHiemThanhToan = 0, TienBenhNhanCungChiTra = 0, TienNgoaiDinhSuat = 0, MaPhuongThucThanhToan = null) {
        this.MaLienKet = MaLienKet;
        this.STT = STT;
...
class HoSoChiTietDVKT {
    constructor(MaDichVu = null, STT = null, MaVatTu = null, GoiVatTuYTe = null, TenVatTu = null, ThongTinThau = null, PhamVi = null, TienThanhToanToiDa = null, MucHuong = null, TienNguonKhac = null, TienBenhNhanTuTra = null, TienBaoHiemThanhToan = null, TienBenhNhanCungChiTra = null, TienNgoaiDinhSuat = null, MaGiuong = null, MaNhom = null, MaNhomText = null, TenDichVu = null, DonViTinh = null, SoLuong = null, DonGia = null, TyLeThanhToan = null, ThanhTien = null, MaKhoa = null, MaBacSi = null, MaBenh = null, NgayYLenh = null, NgayKetQua = null, MaPhuongThucThanhToan = null, MaLienKet = null) {
...
class HoSoCanLamSang {
    constructor(MaLienKet = null, STT = null, MaDichVu = null, MaChiSo = null, TenChiSo = null, GiaTri = null, MaMayXetNghiem = null, MaMay = null, MoTa = null, KetLuan = null, NgayKQ = null) {
        this.MaLienKet = MaLienKet;
        this.STT = STT;
        this.MaDichVu = MaDichVu;
...
class HoSoChiTietDienBienBenh {
    constructor(STT = null, DienBien = null, HoiChuan = null, PhauThuat = null, NgayYLenh = null, MaLienKet = null) {
        this.STT = STT;
...
class TimKiemDSBaoHiemYTe {
    constructor(TuNgay = null, DenNgay = null, TimKiem = null, FromDate = null, ToDate = null, ThoiDiemTiepNhanTuFormat = null, ThoiDiemTiepNhanDenFormat = null, SearchString = null) {
        this.TuNgay = TuNgay;
...
class GoiDanhSachThongTinBenhNhanCoBHYT {
    constructor(YeuCauTiepNhanIds) {
...
class DanhSachYeuCauTiepNhanIds {
    constructor(Id = []) {
        this.Id = Id;
    }
}
...
let DsBaoHiemYTeRoutingModule = class DsBaoHiemYTeRoutingModule {
};
...
let DsBaoHiemYTeModule = class DsBaoHiemYTeModule {
};
...
let DsBaoHiemYTeComponent = class DsBaoHiemYTeComponent {
    ...
    view(id) {
        this.apiService.post("BHYT/KiemTraYeuCauTiepNhanGoiBHYT/" + id).subscribe((resultData) => {
    ...
    clearSearch() {
        if (this.timKiemDSBaoHiemYTe.SearchString == "" || this.timKiemDSBaoHiemYTe.SearchString == null) {
            ...
            let dsBaoHiemYTe = JSON.parse(JSON.stringify(this.timKiemDSBaoHiemYTe));
    ...
    DownloadThongTinTongHopXMLNguoiBenh() {
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
            ...
            if (result == "Yes") {
                ...
                this.apiService.post("BHYT/DownloadHoSoGiamDinhXMLs", this.danhSachYeuCauTiepNhanIds).subscribe((resultData) => {
                    if (resultData != null) {
                        if (typeof resultData == "string" && resultData !== "") {
                            ...
                            this.apiService.postExportXML(`BHYT/DownloadHoSoGiamDinhXML?NameFileDown=${resultData.NameFileDown}`)
                                .subscribe(res => {
    ...
    GuiTongHopHoSoGiamDinh() {
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
            ...
            if (result == "Yes") {
                ...
                self.apiService.post("BHYT/GuiHoSoGiamDinhs", self.danhSachYeuCauTiepNhanIds).subscribe((resultData) => {
    ...
    DownloadFileExcels() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel("BHYT/ExportBaoHiemYTe", this.gridChild._gridQueryInfo).subscribe((resultData) => {
                self.closeAllDialogs();
    ...
    showPopupLoadingData(typeLoading = _bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_4__["EnumTypeLoadingData"].View) {
        let mess = "";
        switch (typeLoading) {
...
DsBaoHiemYTeComponent.ctorParameters = () => [
...
let ThongTinChiTietGoiBaoHiemYTeComponent = class ThongTinChiTietGoiBaoHiemYTeComponent {
    constructor(cdRef, dialog, route, apiService, router, notificationService) {
        this.cdRef = cdRef;
        this.dialog = dialog;
        this.route = route;
        this.apiService = apiService;
    ...
    loadDataEmun() {
        this.apiService.post("BHYT/GetMaNhom").subscribe((resultData) => {
            if (resultData !== null && resultData !== undefined) {
                this.MaNhom = resultData;
            }
        });
        this.apiService.post("BHYT/GetMaNhomDVKT").subscribe((resultData) => {
            if (resultData !== null && resultData !== undefined) {
                this.MaNhomDVKT = resultData;
            }
        });
        this.apiService.post("BHYT/GetEnumMatainan").subscribe((resultData) => {
            if (resultData !== null && resultData !== undefined) {
                this.MaTaiNan = resultData;
            }
        });
        this.apiService.post("BHYT/GetEnumLyDoVaoVien").subscribe((resultData) => {
            if (resultData !== null && resultData !== undefined) {
                this.LyDoRaVien = resultData;
            }
        });
        this.apiService.post("BHYT/GetEnumKetQuaDieuTri").subscribe((resultData) => {
            if (resultData !== null && resultData !== undefined) {
                this.KetQuaDieuTri = resultData;
            }
        });
        this.apiService.post("BHYT/GetEnumTinhTrangRaVien").subscribe((resultData) => {
            if (resultData !== null && resultData !== undefined) {
                this.TinhTrangRaVien = resultData;
            }
        });
        this.apiService.post("BHYT/GetEnumMaLoaiKCB").subscribe((resultData) => {
            if (resultData !== null && resultData !== undefined) {
                this.MaLoaiKCB = resultData;
            }
        });
        this.apiService.post("BHYT/GetEnumMaPhuongThucThanhToan").subscribe((resultData) => {
            if (resultData !== null && resultData !== undefined) {
                this.MaPhuongThucThanhToan = resultData;
            }
        });
        this.apiService.post("BHYT/GetEnumGioiTinh").subscribe((resultData) => {
            if (resultData !== null && resultData !== undefined) {
                this.DataGoiTinh = resultData;
            }
        });
    }
    getThongBenhNhanTheoYeuCauTiepNhan(id) {
        const self = this;
        ...
        self.apiService.post(`BHYT/GetThongTinHoSoGiamDinhs`, self.danhSachYeuCauTiepNhanIds).subscribe((resultData) => {
            if (resultData !== undefined && resultData !== null) {
                ...
                let lstWarningMessage = this.thongtinbenhnhan.WarningMessage != undefined && this.thongtinbenhnhan.WarningMessage != null &&
                    this.thongtinbenhnhan.WarningMessage != '' ? this.thongtinbenhnhan.WarningMessage.split('|') : null;
                if (lstWarningMessage != undefined && lstWarningMessage != null && lstWarningMessage.length > 0) {
                    lstWarningMessage.forEach(itemDichVu => {
                        this.showWarningMessages.push(itemDichVu);
                        this.showHTMLWarningMessagesPopup.push(`<span class="green-yellow">${itemDichVu.bold()} </span>`);
                    });
                }
                self.closeAllDialogs();
            }
    ...
    AddNewThuoc() {
        let viTriNew = new _bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_2__["HoSoChiTietThuoc"]();
    ...
    AddDichVuKyThuat() {
        let viTriNew = new _bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_2__["HoSoChiTietDVKT"]();
        viTriNew.MaLienKet = this.thongtinbenhnhan.MaLienKet;
        viTriNew.STT = this.thongtinbenhnhan.STT;
        this.thongtinbenhnhan.HoSoChiTietDVKT.push(viTriNew);
    }
    AddDichVuKyThuatCanLamSang() {
        let viTriNew = new _bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_2__["HoSoCanLamSang"]();
        viTriNew.MaLienKet = this.thongtinbenhnhan.MaLienKet;
        viTriNew.STT = this.thongtinbenhnhan.STT;
        this.thongtinbenhnhan.HoSoCanLamSang.push(viTriNew);
    }
    AddDienBienBenh() {
        let viTriNew = new _bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_2__["HoSoChiTietDienBienBenh"]();
        viTriNew.MaLienKet = this.thongtinbenhnhan.MaLienKet;
        viTriNew.STT = this.thongtinbenhnhan.STT;
        this.thongtinbenhnhan.HoSoChiTietDienBienBenh.push(viTriNew);
    }
    DeleteVitri(position) {
        this.dialog
    ...
    downloadThongTinXMLNguoiBenh() {
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmComponent"], {
            ...
            if (result == "Yes") {
                ...
                self.apiService.post(`BHYT/DownloadTungHoSoGiamDinhNguoiBenh`, self.thongtinbenhnhan).subscribe((resultData) => {
                    if (resultData.XMLError != undefined) {
                        self.notificationService.showSuccess(`Đã xảy ra lỗi vui lòng liên hệ admin`);
                        self.closeAllDialogs();
                    }
                        ...
                        self.apiService.postExportXML(`BHYT/DownloadHoSoGiamDinhXML?NameFileDown=${resultData.NameFileDown}`).subscribe(res => {
                            let dateTimeNow = new Date();
    ...
    goiHoSoGiamDinhNguoiBenh() {
        const self = this;
        let message = self.thongtinbenhnhan.WarningMessage !== undefined && self.thongtinbenhnhan.WarningMessage !== null && self.thongtinbenhnhan.WarningMessage !== '' ?
        ...
        self.confrim = self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmComponent"], {
            ...
            if (result == "Yes") {
                ...
                self.thongtinbenhnhan.IsDownLoad = true;
                self.apiService.post(`BHYT/GuiChiTietTungHoSoGiamDinhNguoiBenhs`, self.thongtinbenhnhan).subscribe((resultData) => {
    ...
    congThucTienBenhNhanCungChiTraXML2(item) {
    ...
    ChangeSoLuongDichVuKyThuat(ev, item) {
        item.ThanhTien = item.DonGia * ev * item.TyLeThanhToan / 100;
        this.congThucTienBaoHiemThanhToanXML3(item);
        this.totalTienNguoiBenhXML1();
    }
    ChangeDonGiaDichVuKyThuat(ev, item) {
        item.ThanhTien = item.SoLuong * ev * item.TyLeThanhToan / 100;
        this.congThucTienBaoHiemThanhToanXML3(item);
        this.totalTienNguoiBenhXML1();
    }
    ChangeTyLeThanhToanDichVuKyThuat(ev, item) {
        item.ThanhTien = item.SoLuong * item.DonGia * ev / 100;
        this.congThucTienBaoHiemThanhToanXML3(item);
        this.totalTienNguoiBenhXML1();
    }
    congThucTienBaoHiemThanhToanXML3(item) {
        item.TienBaoHiemThanhToan =
            ((item.ThanhTien - item.TienBenhNhanTuTra - item.TienNguonKhac) * item.MucHuong / 100) != undefined &&
                ((item.ThanhTien - item.TienBenhNhanTuTra - item.TienNguonKhac) * item.MucHuong / 100) != null &&
                (item.ThanhTien - item.TienBenhNhanTuTra - item.TienNguonKhac - item.TienBaoHiemThanhToan) >= 0 ?
    ...
    congThucTienBenhNhanCungChiTraXML3(item) {
    ...
    showPopupLoadingData(typeLoading = _bao_hiem_y_te__WEBPACK_IMPORTED_MODULE_2__["EnumTypeLoadingData"].View) {
        let mess = "";
        switch (typeLoading) {
...
ThongTinChiTietGoiBaoHiemYTeComponent.ctorParameters = () => [
...
let ThemMaBacSiComponent = class ThemMaBacSiComponent {
    constructor(data, sanitizer, dialogRef) {
        this.data = data;
...
ThemMaBacSiComponent.ctorParameters = () => [
...
let ThemMaBenhKhacComponent = class ThemMaBenhKhacComponent {
    constructor(data, sanitizer, dialogRef) {
        this.data = data;
        this.sanitizer = sanitizer;
        this.dialogRef = dialogRef;
...
ThemMaBenhKhacComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] }
];
