(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-hoat-dong-khoa-kham-benh-bao-cao-hoat-dong-khoa-kham-benh-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoHoatDongKhoaKhamBenhListComponent = /** @class */ (function () {
                function BaoCaoHoatDongKhoaKhamBenhListComponent(authService, apiService, notificationService, dialog) {
                ...
                BaoCaoHoatDongKhoaKhamBenhListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoHoatDongKhoaKhamBenhListComponent.prototype.pageChange = function (event) {
                ...
                BaoCaoHoatDongKhoaKhamBenhListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoHoatDongKhoaKhamBenhListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoHoatDongKhoaKhamBenhListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoHoatDongKhoaKhamBenhListComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoHoatDongKhoaKhamBenhListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetDataBaoCaoHoatDongKhoaKhamBenhForGridAsync", this.baoCaoSearch).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            ...
                            _this.sumTongSo = resultData.Data.reduce(function (sum, item) { return sum + item.TongSo; }, 0);
                            _this.sumBHYTCoGoi = resultData.Data.reduce(function (sum, item) { return sum + item.BhytCoGoi; }, 0);
                            _this.sumBHYTKhongGoiGoi = resultData.Data.reduce(function (sum, item) { return sum + item.BhytKhongGoi; }, 0);
                            _this.sumVienPhiCoGoi = resultData.Data.reduce(function (sum, item) { return sum + item.VienPhiCoGoi; }, 0);
                            _this.sumVienPhiKhongGoiGoi = resultData.Data.reduce(function (sum, item) { return sum + item.VienPhiKhongGoi; }, 0);
                            _this.sumKskBHTN = resultData.Data.reduce(function (sum, item) { return sum + item.KskBHTN; }, 0);
                            _this.sumKskDoanCongTy = resultData.Data.reduce(function (sum, item) { return sum + item.KskDoanCongTy; }, 0);
                            _this.sumGiayKsk = resultData.Data.reduce(function (sum, item) { return sum + item.GiayKsk; }, 0);
                            _this.sumTreEm = resultData.Data.reduce(function (sum, item) { return sum + item.TreEm; }, 0);
                            _this.sumSLCapCuu = resultData.Data.reduce(function (sum, item) { return sum + item.SoLanCapCuu; }, 0);
                            _this.sumSoNguoiVaoVien = resultData.Data.reduce(function (sum, item) { return sum + item.SoNguoiBenhVaoVien; }, 0);
                            _this.sumSoNguoiChuyenVien = resultData.Data.reduce(function (sum, item) { return sum + item.SoNguoiBenhChuyenVien; }, 0);
                            _this.sumSoNguoiTuVong = resultData.Data.reduce(function (sum, item) { return sum + item.SoNguoiBenhTuVong; }, 0);
                            _this.sumSoNguoiDieuTri = resultData.Data.reduce(function (sum, item) { return sum + item.SoNguoiBenhDieuTriNgoaiTru; }, 0);
                            _this.sumSoNgay = resultData.Data.reduce(function (sum, item) { return sum + item.SoNgayDieuTriNgoaiTru; }, 0);
                ...
                BaoCaoHoatDongKhoaKhamBenhListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                return BaoCaoHoatDongKhoaKhamBenhListComponent;
            }());
            BaoCaoHoatDongKhoaKhamBenhListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoHoatDongKhoaKhamBenhRoutingModule = /** @class */ (function () {
                function BaoCaoHoatDongKhoaKhamBenhRoutingModule() {
                }
                return BaoCaoHoatDongKhoaKhamBenhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoHoatDongKhoaKhamBenhSearch = /** @class */ (function () {
                function BaoCaoHoatDongKhoaKhamBenhSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, FromDateHoanThanh, ToDateHoanThanh, TuNgayFormatHoanThanh, DenNgayFormatHoanThanh, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                    if (FromDate === void 0) { FromDate = null; }
                    if (ToDate === void 0) { ToDate = null; }
                    if (TuNgayFormat === void 0) { TuNgayFormat = null; }
                    if (DenNgayFormat === void 0) { DenNgayFormat = null; }
                    if (FromDateHoanThanh === void 0) { FromDateHoanThanh = null; }
                    if (ToDateHoanThanh === void 0) { ToDateHoanThanh = null; }
                    if (TuNgayFormatHoanThanh === void 0) { TuNgayFormatHoanThanh = null; }
                    if (DenNgayFormatHoanThanh === void 0) { DenNgayFormatHoanThanh = null; }
                ...
                return BaoCaoHoatDongKhoaKhamBenhSearch;
            }());
            var InBaoCaoHoatDongKhoaKhamBenh = /** @class */ (function () {
                function InBaoCaoHoatDongKhoaKhamBenh(HostingName, FromDate, ToDate) {
                ...
                return InBaoCaoHoatDongKhoaKhamBenh;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoHoatDongKhoaKhamBenhModule = /** @class */ (function () {
                function BaoCaoHoatDongKhoaKhamBenhModule() {
                }
                return BaoCaoHoatDongKhoaKhamBenhModule;
            }());
...
//# sourceMappingURL=bao-cao-bao-cao-hoat-dong-khoa-kham-benh-bao-cao-hoat-dong-khoa-kham-benh-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-hoat-dong-khoa-kham-benh-bao-cao-hoat-dong-khoa-kham-benh-module-es5.js.map