...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["xet-nghiem-nhan-mau-xet-nghiem-nhan-mau-xet-nghiem-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhanMauXetNghiemChiTietComponent = /** @class */ (function () {
                function NhanMauXetNghiemChiTietComponent(dialog, router, route, authService, notificationService, apiService) {
                    this.dialog = dialog;
                    this.router = router;
                    this.route = route;
                ...
                NhanMauXetNghiemChiTietComponent.prototype.ngOnInit = function () {
                ...
                NhanMauXetNghiemChiTietComponent.prototype.getSoLuongMauCoTheTuChoi = function (id) {
                    var _this = this;
                    this.apiService.get("XetNghiem/TinhSoLuongMauCoTheTuChoi?phieuGoiMauId=" + id).subscribe(function (res) {
                        if (res != null && res > 0) {
                            _this.allowTiepNhanMau = true;
                            return;
                        }
                        _this.allowTiepNhanMau = false;
                    }, function (err) {
                        _this.notificationService.showError(err.Message);
                    });
                };
                NhanMauXetNghiemChiTietComponent.prototype.getChiTietPhieuGoiMauXetNghiem = function (id) {
                    var _this = this;
                    this.apiService.get("XetNghiem/GetPhieuGoiMauXetNghiem?id=" + id).subscribe(function (res) {
                        _this.thongTinPhieuGoiMauXetNghiem = res;
                    }, function (err) {
                        _this.notificationService.showError(err.Message);
                        _this.router.navigate(['/xet-nghiem/nhan-mau']);
                    });
                };
                NhanMauXetNghiemChiTietComponent.prototype.getTongSoLuongMauGoi = function (id) {
                    var _this = this;
                    this.apiService.get("XetNghiem/GetTongSoLuongMauGoiMauXetNghiem?id=" + id).subscribe(function (res) {
                        _this.tongSoLuongMauGoi = res;
                    }, function (err) {
                        _this.notificationService.showError(err.Message);
                    });
                };
                NhanMauXetNghiemChiTietComponent.prototype.getAdditionalSearchStringNhomDichVu = function (phieuGoiMauXetNghiemId) {
                    this.additionalSearchStringNhomDichVu = "{ \"PhieuGoiMauXetNghiemId\":\"" + phieuGoiMauXetNghiemId + "\" }";
                };
                NhanMauXetNghiemChiTietComponent.prototype.quayLai = function () {
                    this.router.navigateByUrl("/xet-nghiem/nhan-mau?holdQuery=true");
                };
                NhanMauXetNghiemChiTietComponent.prototype.tiepNhanMau = function () {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                        ...
                        if (result == "Yes") {
                            _this.apiService.post("XetNghiem/TiepNhanMau?phieuGoiMauXetNghiemId=" + _this.phieuGoiMauXetNghiemId).subscribe(function (res) {
                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_11__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ["Tiếp nhận mẫu"]));
                                // this.quayLai();
                                _this.getChiTietPhieuGoiMauXetNghiem(_this.phieuGoiMauXetNghiemId);
                                _this.getSoLuongMauCoTheTuChoi(_this.phieuGoiMauXetNghiemId);
                                _this.getTongSoLuongMauGoi(_this.phieuGoiMauXetNghiemId);
                                _this.getAdditionalSearchStringNhomDichVu(_this.phieuGoiMauXetNghiemId);
                            }, function (err) {
                                _this.notificationService.showError(err.Message);
                            });
                        }
                ...
                NhanMauXetNghiemChiTietComponent.prototype.tuChoiMau = function (dataItem) {
                    var _this = this;
                    this.dialog.open(_nhan_mau_xet_nghiem_tu_choi_popup_nhan_mau_xet_nghiem_tu_choi_popup_component__WEBPACK_IMPORTED_MODULE_9__["NhanMauXetNghiemTuChoiPopupComponent"], {
                        ...
                        if (res === 'Yes') {
                            if (_this.gridNhomXetNghiem) {
                                _this.gridNhomXetNghiem.search();
                                _this.getSoLuongMauCoTheTuChoi(_this.phieuGoiMauXetNghiemId);
                            }
                        }
                    });
                };
                NhanMauXetNghiemChiTietComponent.prototype.tooltipCustom = function (loaiMauXetNghiem) {
                    this.thongTinTuChoi = loaiMauXetNghiem;
                };
                return NhanMauXetNghiemChiTietComponent;
            }());
            NhanMauXetNghiemChiTietComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhanMauXetNghiemListComponent = /** @class */ (function () {
                function NhanMauXetNghiemListComponent(dialog, router, route, location, authService, notificationService, apiService) {
                    this.dialog = dialog;
                    this.router = router;
                    this.route = route;
                ...
                NhanMauXetNghiemListComponent.prototype.ngOnInit = function () {
                ...
                NhanMauXetNghiemListComponent.prototype.xemChiTiet = function (id) {
                ...
                NhanMauXetNghiemListComponent.prototype.checkboxChange = function ($event, choNhanMau, daNhanMau) {
                    if (choNhanMau === void 0) { choNhanMau = false; }
                ...
                NhanMauXetNghiemListComponent.prototype.clearSearch = function () {
                    if (this.nhanMauXetNghiemSearch.SearchString == "" || this.nhanMauXetNghiemSearch.SearchString == null) {
                        this.timKiem();
                    }
                };
                NhanMauXetNghiemListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                NhanMauXetNghiemListComponent.prototype.onKeyTuNgay = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                NhanMauXetNghiemListComponent.prototype.onKeyDenNgay = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                NhanMauXetNghiemListComponent.prototype.changeTuNgay = function (ev) {
                    this.timKiem();
                };
                NhanMauXetNghiemListComponent.prototype.changeDenNgay = function (ev) {
                    this.timKiem();
                };
                NhanMauXetNghiemListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        ...
                        this.apiService.postExportExcel('XetNghiem/ExportNhanMauXetNghiem', this.gridDanhSachXetNghiem._gridQueryInfo).subscribe(function (resultData) {
                ...
                NhanMauXetNghiemListComponent.prototype.timKiem = function () {
                ...
                NhanMauXetNghiemListComponent.prototype.convertDateTimeToUTC = function () {
                ...
                NhanMauXetNghiemListComponent.prototype.reverseDateTime = function () {
                    if (this.nhanMauXetNghiemSearch.RangeNgayGoiMau.startDate) {
                ...
                NhanMauXetNghiemListComponent.prototype.tiepNhanMau = function (dataItem) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                        ...
                        /* result is a string:Yes,No,No answer*/
                        if (result == "Yes") {
                            _this.apiService.post("XetNghiem/TiepNhanMau?phieuGoiMauXetNghiemId=" + dataItem.Id).subscribe(function (res) {
                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["Tiếp nhận mẫu"]));
                                _this.timKiem();
                            }, function (err) {
                                _this.notificationService.showError(err.Message);
                            });
                ...
                NhanMauXetNghiemListComponent.prototype.getAdditionalSearchStringNhomDichVu = function (dataItem) {
                    this.convertDateTimeToUTC();
                    var query = JSON.stringify(this.nhanMauXetNghiemSearch);
                    this.reverseDateTime();
                    return query.substr(0, query.length - 1) + ",\"PhieuGoiMauXetNghiemId\":\"" + dataItem.Id + "\"}";
                };
                NhanMauXetNghiemListComponent.prototype.QuetMaQRCodeClick = function () {
                    var elementBarcode = document.getElementById("barcodeActive");
                    if (elementBarcode != undefined) {
                        elementBarcode.click();
                    }
                };
                NhanMauXetNghiemListComponent.prototype.changeQR = function (evt) {
                ...
                return NhanMauXetNghiemListComponent;
            }());
            NhanMauXetNghiemListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhanMauXetNghiemRoutingModule = /** @class */ (function () {
                function NhanMauXetNghiemRoutingModule() {
                }
                return NhanMauXetNghiemRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhanMauXetNghiemTuChoiPopupComponent = /** @class */ (function () {
                function NhanMauXetNghiemTuChoiPopupComponent(data, dialog, dialogRef, apiService, notificationService, authService) {
                    this.data = data;
                    this.dialog = dialog;
                ...
                NhanMauXetNghiemTuChoiPopupComponent.prototype.ngOnInit = function () {
                    this.gridTuChoiMauColumns = [
                ...
                NhanMauXetNghiemTuChoiPopupComponent.prototype.onDataBoundGridTuChoiMau = function (event) {
                    if (event && event.Data.length > 0) {
                        // this.mauXetNghiems = event.Data;
                        this.mauXetNghiems = event.Data.slice();
                    }
                };
                NhanMauXetNghiemTuChoiPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                NhanMauXetNghiemTuChoiPopupComponent.prototype.tuChoiMau = function () {
                    var _this = this;
                    this.onValidateGridDichVuChoVoucher();
                    var mauKhongDatChatLuongs = this.mauXetNghiems.filter(function (p) { return p.KhongDatChatLuong; });
                    if (this.validationErrors && this.validationErrors.length === 0 && mauKhongDatChatLuongs && mauKhongDatChatLuongs.length > 0) {
                        this.apiService.postArray("XetNghiem/KhongTiepNhanMau", mauKhongDatChatLuongs).subscribe(function (res) {
                            _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_8__["SystemMessage"].ActionSuccessfully, ["Từ chối mẫu"]));
                ...
                NhanMauXetNghiemTuChoiPopupComponent.prototype.onValidateGridDichVuChoVoucher = function () {
                    this.validationErrors = [];
                    if (this.mauXetNghiems && this.mauXetNghiems.some(function (p) { return !p.LyDoKhongDat && p.KhongDatChatLuong; })) {
                        for (var _i = 0, _a = this.mauXetNghiems.filter(function (p) { return !p.LyDoKhongDat && p.KhongDatChatLuong; }); _i < _a.length; _i++) {
                            var mauXetNghiem = _a[_i];
                            var validate = {
                ...
                return NhanMauXetNghiemTuChoiPopupComponent;
            }());
            NhanMauXetNghiemTuChoiPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var NhanMauXetNghiemSearch = /** @class */ (function () {
                function NhanMauXetNghiemSearch() {
            ...
            // }
            var MauXetNghiem = /** @class */ (function () {
                function MauXetNghiem() {
                    this.Id = 0;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhanMauXetNghiemModule = /** @class */ (function () {
                function NhanMauXetNghiemModule() {
                }
                return NhanMauXetNghiemModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/base.service */ "./src/app/core/services/base.service.ts");
            var NhanMauXetNghiemService = /** @class */ (function (_super) {
                __extends(NhanMauXetNghiemService, _super);
                function NhanMauXetNghiemService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'NhanMauXetNghiem';
                    return _this;
                }
                return NhanMauXetNghiemService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            NhanMauXetNghiemService.ctorParameters = function () { return [
...
//# sourceMappingURL=xet-nghiem-nhan-mau-xet-nghiem-nhan-mau-xet-nghiem-module-es5.js.map
//# sourceMappingURL=xet-nghiem-nhan-mau-xet-nghiem-nhan-mau-xet-nghiem-module-es5.js.map