...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-duoc-pham-tong-hop-mua-duoc-pham-tai-giam-doc-du-tru-giam-doc-module"], {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Update)) {
                        this.dialog.open(_du_tru_giam_doc_declined_popup_du_tru_giam_doc_declined_popup_component__WEBPACK_IMPORTED_MODULE_12__["DuTruGiamDocDeclinedPopupComponent"], {
                            ...
                            if (result && result.includes('Yes')) {
                                ...
                                _this.apiService.post('TongHopDuTruMuaThuocTaiGiamDoc/Decline', reqParam).subscribe(function () {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                ...
                                _this.apiService.post('TongHopDuTruMuaThuocTaiGiamDoc/ApproveForm', reqParam).subscribe(function () {
            ...
            var DuTruGiamDocListComponent = /** @class */ (function () {
                ...
                DuTruGiamDocListComponent.prototype.exportExcel = function () {
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Process)) {
                        ...
                        self.apiService.postExportExcel('TongHopDuTruMuaThuocTaiGiamDoc/ExportTongHopDuTruMuaThuocTaiGiamDoc', self.gridParent._gridQueryInfo).subscribe(function (resultData) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                        this.dialog.open(_du_tru_giam_doc_declined_popup_du_tru_giam_doc_declined_popup_component__WEBPACK_IMPORTED_MODULE_21__["DuTruGiamDocDeclinedPopupComponent"], {
                            ...
                            if (result && result.includes('Yes')) {
                                ...
                                _this.apiService.post('TongHopDuTruMuaThuocTaiGiamDoc/Decline', approve).subscribe(function () {
                ...
                DuTruGiamDocListComponent.prototype.Approve = function (item) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_20__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                _this.apiService.get("TongHopDuTruMuaThuocTaiGiamDoc/Approve?id=" + item.Id).subscribe(function () {
            ...
            var DuTruGiamDocSharedComponent = /** @class */ (function () {
                ...
                DuTruGiamDocSharedComponent.prototype.ReturnData = function (lyDo) {
                    ...
                    this.duTruGiamDoc.DuTruGiamDocDetails.forEach(function (item) {
                        var approveDetail = new _du_tru_giam_doc_model__WEBPACK_IMPORTED_MODULE_5__["ChiTietDuocPham"]();
                ...
                DuTruGiamDocSharedComponent.prototype.GetListDuocPham = function (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuTruGiamDoc = /** @class */ (function () {
                function DuTruGiamDoc(SoPhieu, KyDuTruDisplay, KyDuTru, NguoiYeuCau, NguoiDuyet, NgayYeuCauDisplay, Id, NgayYeuCau, NgayDuyetDisplay, LyDoGiamDocTuChoi, NgayDuyet, GhiChu, TrangThai, // null: chờ, true: đã duyệt, false: từ chối duyệt
            ...
            var DuTruGiamDocDetail = /** @class */ (function () {
                function DuTruGiamDocDetail(Loai, IsBhyt, DuocPhamId, DuocPham, HoatChat, Id, NongDo, Sdk, Dvt, DuongDung, NhaSx, NuocSx, SoLuongDuTru, SoLuongDuKienTrongKy, SoLuongDuTruTrKhoa, SoLuongDuTruKhDuoc, SoLuongDuTruDirector, KhoDuTruTon, KhoTongTon, HdChuaNhap, TongTonList, HdChuaNhapList) {
            ...
            var DuTruTheoDuocPhamDetail = /** @class */ (function () {
                function DuTruTheoDuocPhamDetail(Khoa, Nhom, Kho, KyDuTruDisplay, KyDuTru, SoLuongDuTru, SoLuongDuKienTrongKy, NhomDieuTri) {
                    ...
                    if (SoLuongDuTru === void 0) { SoLuongDuTru = null; }
                    if (SoLuongDuKienTrongKy === void 0) { SoLuongDuKienTrongKy = null; }
                    if (NhomDieuTri === void 0) { NhomDieuTri = null; }
                    this.Khoa = Khoa;
                    this.Nhom = Nhom;
                    this.Kho = Kho;
                    this.KyDuTruDisplay = KyDuTruDisplay;
                ...
                return DuTruTheoDuocPhamDetail;
            }());
            ...
            var ApproveData = /** @class */ (function () {
                function ApproveData(Id, LyDo, ChiTietDuocPhamList) {
                    if (Id === void 0) { Id = null; }
                    if (LyDo === void 0) { LyDo = null; }
                    if (ChiTietDuocPhamList === void 0) { ChiTietDuocPhamList = []; }
                    this.Id = Id;
                    this.LyDo = LyDo;
            ...
            var ChiTietDuocPham = /** @class */ (function () {
                function ChiTietDuocPham(Id, SoLuongDuyet) {
                    if (Id === void 0) { Id = null; }
                    if (SoLuongDuyet === void 0) { SoLuongDuyet = null; }
                    this.Id = Id;
                    this.SoLuongDuyet = SoLuongDuyet;
                }
                return ChiTietDuocPham;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaThuocTaiGiamDocModule = /** @class */ (function () {
                function TongHopDuTruMuaThuocTaiGiamDocModule() {
                }
                return TongHopDuTruMuaThuocTaiGiamDocModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var TongHopDuTruMuaThuocTaiGiamDocService = /** @class */ (function (_super) {
                __extends(TongHopDuTruMuaThuocTaiGiamDocService, _super);
                function TongHopDuTruMuaThuocTaiGiamDocService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'TongHopDuTruMuaThuocTaiGiamDoc';
                    return _this;
                }
                return TongHopDuTruMuaThuocTaiGiamDocService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            TongHopDuTruMuaThuocTaiGiamDocService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
...
//# sourceMappingURL=nhap-xuat-duoc-pham-tong-hop-mua-duoc-pham-tai-giam-doc-du-tru-giam-doc-module-es5.js.map
//# sourceMappingURL=nhap-xuat-duoc-pham-tong-hop-mua-duoc-pham-tai-giam-doc-du-tru-giam-doc-module-es5.js.map