(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-doanh-thu-bao-cao-thu-tien-vien-phi-bao-cao-thu-tien-vien-phi-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThuTienVienPhiModule = /** @class */ (function () {
                function BaoCaoThuTienVienPhiModule() {
                }
                return BaoCaoThuTienVienPhiModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThuTienVienPhi = /** @class */ (function () {
                function BaoCaoThuTienVienPhi(NhanVienId, STT, NgayThu, NgayThuStr, MaBenhNhan, TenBenhNhan, SoBenhAn, GoiDichVu, SoBLHD, SoTienThu, HuyThu, ThucThu, CongNo, TienMat, ChuyenKhoan, Pos, Voucher, LyDo, NguoiThu) {
                    if (NhanVienId === void 0) { NhanVienId = 0; }
            ...
            var BaoCaoThuPhiVienPhiQueryInfoQueryInfo = /** @class */ (function () {
                function BaoCaoThuPhiVienPhiQueryInfoQueryInfo(TuNgay, DenNgay, NhanVienId, PhongBenhVienId, Skip, Take, PageSize, SearchString, AdditionalSearchString, 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThuTienVienPhiComponent = /** @class */ (function () {
                //================================End value total===========================
                function BaoCaoThuTienVienPhiComponent(apiService) {
                ...
                BaoCaoThuTienVienPhiComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoThuTienVienPhiComponent.prototype.searchRefresh = function () {
                    this.XemBaoCao();
                };
                BaoCaoThuTienVienPhiComponent.prototype.pageChange = function (event) {
                    this.skip = event.skip;
                    this.XemBaoCao();
                };
                BaoCaoThuTienVienPhiComponent.prototype.pageChangeDetail = function (event) {
                    if (event != null) {
                        this.skipDetail = event.skip;
                        this.XemBaoCao();
                    }
                };
                BaoCaoThuTienVienPhiComponent.prototype.columnResize = function (event) {
                    var _this = this;
                ...
                BaoCaoThuTienVienPhiComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoThuTienVienPhiComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoThuTienVienPhiComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                //daddy total master
                BaoCaoThuTienVienPhiComponent.prototype.getFieldColumnMaster = function (index) {
                    return this.gridColumnsMaster[index].Field;
                };
                BaoCaoThuTienVienPhiComponent.prototype.getTitleColumnMaster = function (index) {
                    return this.gridColumnsMaster[index].Title;
                };
                BaoCaoThuTienVienPhiComponent.prototype.getWidthColumnMaster = function (index) {
                ...
                //
                BaoCaoThuTienVienPhiComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoThuTienVienPhiComponent.prototype.detailExpand = function (event) {
                    this.showExpandReLoadPage = false;
                    this.baoCaoThuPhiVienPhiQueryInfoQueryInfo.TuNgay = this.search.RangeDateTimeFilter.DateStart;
                    this.baoCaoThuPhiVienPhiQueryInfoQueryInfo.DenNgay = this.search.RangeDateTimeFilter.DateEnd;
                    var denNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].formatDateTime(this.search.RangeDateTimeFilter.DateEnd, "mm/dd/yyyy");
                    var tuNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].formatDateTime(this.search.RangeDateTimeFilter.DateStart, "mm/dd/yyyy");
                ...
                BaoCaoThuTienVienPhiComponent.prototype.returnDetail = function () {
                    var denNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].formatDateTime(this.search.RangeDateTimeFilter.DateEnd, "mm/dd/yyyy");
                    var tuNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].formatDateTime(this.search.RangeDateTimeFilter.DateStart, "mm/dd/yyyy");
                    var string = tuNgay + "-" + denNgay + "-" + this.baoCaoThuPhiVienPhiQueryInfoQueryInfo.NhanVienId + "-" + this.quayThuNgan.KeyId;
                    return string;
                };
                BaoCaoThuTienVienPhiComponent.prototype.chonQuay = function (item) {
                    this.quayThuNgan = item;
                };
                BaoCaoThuTienVienPhiComponent.prototype.chonQuayChange = function (item) {
                    if (item != undefined) {
                ...
                BaoCaoThuTienVienPhiComponent.prototype.chonNhanVien = function (item) {
                    this.nhanVienThuNgan = item;
                };
                BaoCaoThuTienVienPhiComponent.prototype.chonNhanVienChange = function (item) {
                    if (item != undefined) {
                ...
                BaoCaoThuTienVienPhiComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoThuTienVienPhiComponent.prototype.changeValueStart = function (event) {
                ...
                BaoCaoThuTienVienPhiComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetBaoCaoChiTietThuTienVienPhiForMasterGridAsync", this.baoCaoThuPhiVienPhiQueryInfoQueryInfo).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            ...
                            _this.gridView.data.forEach(function (item, idx) {
                                _this.baoCaoChiTietThuVienPhiGrid.collapseRow(idx);
                            });
                    ...
                    this.apiService.post("BaoCao/GetTotalBaoCaoChiTietThuTienVienPhiForGridAsync", this.baoCaoThuPhiVienPhiQueryInfoQueryInfo).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.baoCaoThuTienVienPhi = resultData.Data;
                ...
                BaoCaoThuTienVienPhiComponent.prototype.XuatBaoCao = function () {
                    if (this.search.RangeDateTimeFilter.DateStart == null) {
                        this.minDateTuNgay = new Date();
                        this.minDateTuNgay.setHours(0, 0, 0, 0);
                        this.search.RangeDateTimeFilter.DateStart = this.minDateTuNgay;
                    ...
                    this.DateStart = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].formatDateTime(this.search.RangeDateTimeFilter.DateStart, "dd/mm/yyyy");
                    this.DateEnd = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].formatDateTime(this.search.RangeDateTimeFilter.DateEnd, "dd/mm/yyyy");
                    var data1 = this.nhanVienThuNgan.KeyId;
                    var data2 = this.quayThuNgan.KeyId;
                ...
                BaoCaoThuTienVienPhiComponent.prototype.formatPrice = function (value) {
                    var val = (value / 1).toFixed(2).replace('.', ',');
                    return val.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
                };
                return BaoCaoThuTienVienPhiComponent;
            }());
            BaoCaoThuTienVienPhiComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-bao-cao-thu-tien-vien-phi-bao-cao-thu-tien-vien-phi-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-bao-cao-thu-tien-vien-phi-bao-cao-thu-tien-vien-phi-module-es5.js.map