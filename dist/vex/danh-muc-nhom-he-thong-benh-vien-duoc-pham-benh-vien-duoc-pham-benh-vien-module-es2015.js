...
let DuocPhamBenhVienCreateComponent = class DuocPhamBenhVienCreateComponent {
    constructor(router, location, notificationService, authService, dialog, ref, apiService) {
        this.router = router;
    ...
    xuLyThemDuocPham() {
        ...
        self.apiService.post("DuocPhamBenhVien", self.shared.getSharedData()).subscribe(resultData => {
...
DuocPhamBenhVienCreateComponent.ctorParameters = () => [
...
let DuocPhamBenhVienListComponent = class DuocPhamBenhVienListComponent {
    constructor(dialog, route, location, authService, apiService, notificationService) {
        this.dialog = dialog;
        this.route = route;
        this.location = location;
        this.authService = authService;
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('DuocPhamBenhVien/ExportDuocPhamBenhVien', self.gridDuocPhamBenhVien._gridQueryInfo).subscribe(resultData => {
...
DuocPhamBenhVienListComponent.ctorParameters = () => [
...
let DuocPhamBenhVienRoutingModule = class DuocPhamBenhVienRoutingModule {
};
...
let DuocPhamBenhVienSharedComponent = class DuocPhamBenhVienSharedComponent {
    constructor(route, baseService, apiService, notificationService) {
        this.route = route;
    ...
    nhomChaChange(duocPhamBenhVienPhanNhomChaId) {
    ...
    nhomConChange(duocPhamBenhVienPhanNhomConId) {
    ...
    modelChangeLoaiDieuKienBaoQuanDuocPham(event) {
    ...
    getListTenNhaSanXuat() {
        this.apiService.get("DuocPham/GetListTenNhaSanXuatAsync").subscribe(resultData => {
            this.nhaSanXuatDataSource = resultData;
        });
    }
    getListTenNuocSanXuat() {
        this.apiService.get("DuocPham/GetListTenNuocSanXuatAsync").subscribe(resultData => {
    ...
    getMaTaoMoiDuocPham(tenDuocPham = null, phanNhomId = null) {
        if (this.duocPhamBenhVien.Id == null || this.duocPhamBenhVien.Id == 0) {
            ...
            if (tenDuocPhamTemp != null && phanNhomIdTemp != null) {
                ...
                this.apiService.post("DuocPhamBenhVien/GetMaTaoMoiDuocPham", obj).subscribe(resultData => {
                    if (resultData) {
...
DuocPhamBenhVienSharedComponent.ctorParameters = () => [
...
let DuocPhamBenhVienUpdateComponent = class DuocPhamBenhVienUpdateComponent {
...
DuocPhamBenhVienUpdateComponent.ctorParameters = () => [
...
class DuocPhamBenhVien {
    constructor(Id = 0, MaThuocBenhVien = null, Ten = null, TenTiengAnh = null, SoDangKy = null, STTHoatChat = null, MaHoatChat = null, HoatChat = null, NhaSanXuat = null, NuocSanXuat = null, DuongDungId = null, TenDuongDung = null, HamLuong = null, QuyCach = null, TieuChuan = null, DangBaoChe = null, DonViTinhId = null, TenDonViTinh = null, HanSuDung = null, HieuLuc = true, IsDisabled = false, HuongDan = null, MieuTa = null, MoTa = null, LoaiThuocHoacHoatChat = null, TenLoaiThuocHoacHoatChat = null, ChiDinh = null, ChongChiDinh = null, LieuLuongCachDung = null, TacDungPhu = null, ChuYDePhong = null, LaThucPhamChucNang = null, MaDuocPhamBenhVien = null, DieuKienBaoHiemThanhToan = null, DuocPhamBenhVienPhanNhomId = null, DuocPhamBenhVienPhanNhomConId = null, TenDuocPhamBenhVienPhanNhomCon = null, DuocPhamBenhVienPhanNhomChaId = null, TenDuocPhamBenhVienPhanNhomCha = null, TheTich = null, HeSoDinhMucDonViTinh = null, LaThuocHuongThanGayNghien = null, LoaiThuocTheoQuanLy = null, TenPhanLoaiThuocTheoQuanLy = null, MaATC = null, DuocPhamCoDau = null, MayXetNghiemIds = null, LoaiDieuKienBaoQuanDuocPham = null, ThongTinDieuKienBaoQuanDuocPham = null) {
        this.Id = Id;
...
class DuocPhamBenhVienGiaBaoHiem {
    constructor(DuocPhamBenhVienId = 0, Gia = null, TuNgay = null, DenNgay = null, TiLeBaoHiemThanhToan = null) {
...
let DuocPhamBenhVienModule = class DuocPhamBenhVienModule {
};
...
let DuocPhamBenhVienService = class DuocPhamBenhVienService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DuocPhamBenhVien';
    }
};
DuocPhamBenhVienService.ctorParameters = () => [
