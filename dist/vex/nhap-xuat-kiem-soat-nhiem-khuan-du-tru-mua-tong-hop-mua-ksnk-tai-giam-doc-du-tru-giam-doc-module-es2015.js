...
let DuTruGiamDocChiTietComponent = class DuTruGiamDocChiTietComponent {
...
DuTruGiamDocChiTietComponent.ctorParameters = () => [
...
let DuTruGiamDocListComponent = class DuTruGiamDocListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Process)) {
            ...
            self.apiService.postExportExcel('YeuCauMuaKSNK/ExportTongHopDuTruMuaKSNKTaiGiamDoc', self.gridParent._gridQueryInfo).subscribe(resultData => {
...
let DuTruGiamDocTuChoiPopupComponent = class DuTruGiamDocTuChoiPopupComponent {
...
DuTruGiamDocTuChoiPopupComponent.ctorParameters = () => [
...
let TongHopDuTruMuaKSNKTaiGiamDocModule = class TongHopDuTruMuaKSNKTaiGiamDocModule {
};
...
let TongHopDuTruMuaKSNKTaiGiamDocService = class TongHopDuTruMuaKSNKTaiGiamDocService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'YeuCauMuaKSNK';
    }
};
TongHopDuTruMuaKSNKTaiGiamDocService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
