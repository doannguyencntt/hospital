...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-xuat-nhap-ton-bao-cao-xuat-nhap-ton-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoXuatNhapTonListComponent = /** @class */ (function () {
                function BaoCaoXuatNhapTonListComponent(apiService, dialog, authService, notificationService, cd) {
                ...
                //end
                BaoCaoXuatNhapTonListComponent.prototype.pageChange = function (event) {
                ...
                BaoCaoXuatNhapTonListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoXuatNhapTonListComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoXuatNhapTonListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoXuatNhapTonListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoXuatNhapTonListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoXuatNhapTonListComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoXuatNhapTonListComponent.prototype.detailExpand = function (event) {
                ...
                BaoCaoXuatNhapTonListComponent.prototype.onDataBoundChild = function (event) {
                    console.log(event);
                    this.dataToSumThanhTien = event.Data;
                };
                BaoCaoXuatNhapTonListComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                BaoCaoXuatNhapTonListComponent.prototype.sumThanhTien = function (value) {
                    if (value) {
                        return value.sum;
                    }
                };
                BaoCaoXuatNhapTonListComponent.prototype.totalThanhTien = function (field) {
                    switch (field) {
                ...
                BaoCaoXuatNhapTonListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                    ...
                    this.baoCaoSearch.FromDate = this.baoCaoSearch.TuNgayFormat;
                    this.baoCaoSearch.ToDate = this.baoCaoSearch.DenNgayFormat;
                    this.apiService.post("BaoCao/GetDataBaoCaoXuatNhapTonForGridAsync", this.baoCaoSearch).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            ...
                            _this.gridView = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_15__["process"])(gridData, { group: _this.groups });
                ...
                BaoCaoXuatNhapTonListComponent.prototype.reFresh = function () {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoXuatNhapTonListComponent.prototype.InBaoCao = function () {
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                    }
                ...
                BaoCaoXuatNhapTonListComponent.prototype.changeValueStart = function () {
                ...
                return BaoCaoXuatNhapTonListComponent;
            }());
            BaoCaoXuatNhapTonListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoXuatNhapTonPopupComponent = /** @class */ (function () {
                function BaoCaoXuatNhapTonPopupComponent(apiService, dialogRef, dialog, sanitizer, data) {
                    this.apiService = apiService;
                ...
                BaoCaoXuatNhapTonPopupComponent.prototype.ngOnInit = function () {
                    this.inBaoCaoXuatNhapTon = this.data;
                    this.showBaoCao();
                };
                BaoCaoXuatNhapTonPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                BaoCaoXuatNhapTonPopupComponent.prototype.showBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/InBaoCaoXuatNhapTon", this.inBaoCaoXuatNhapTon).subscribe(function (resultData) {
                ...
                BaoCaoXuatNhapTonPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        _this.apiService.post("BaoCao/InBaoCaoXuatNhapTon", _this.inBaoCaoXuatNhapTon).subscribe(function (resultData) {
                            resolve(resultData);
                        });
                        _this.close();
                    });
                };
                return BaoCaoXuatNhapTonPopupComponent;
            }());
            BaoCaoXuatNhapTonPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoXuatNhapTonRoutingModule = /** @class */ (function () {
                function BaoCaoXuatNhapTonRoutingModule() {
                }
                return BaoCaoXuatNhapTonRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoXuatNhapTonSearch = /** @class */ (function () {
                function BaoCaoXuatNhapTonSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, KhoId, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                ...
                return BaoCaoXuatNhapTonSearch;
            }());
            var BaoCaoXuatNhapTon = /** @class */ (function () {
                function BaoCaoXuatNhapTon(STT, Ten, DVT, SLTonDauKy, ThanhTienTonDauKy, SLNhapTrongKy, ThanhTienNhapTrongKy, SLXuatTrongKy, ThanhTienXuatTrongKy, SLTonCuoiKy, Gia, ThanhTien) {
                ...
                return BaoCaoXuatNhapTon;
            }());
            var InBaoCaoXuatNhapTon = /** @class */ (function () {
                function InBaoCaoXuatNhapTon(KhoId, HostingName, FromDate, ToDate) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoXuatNhapTonModule = /** @class */ (function () {
                function BaoCaoXuatNhapTonModule() {
                }
                return BaoCaoXuatNhapTonModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoXuatNhapTonService = /** @class */ (function (_super) {
                __extends(BaoCaoXuatNhapTonService, _super);
                function BaoCaoXuatNhapTonService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoXuatNhapTonService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoXuatNhapTonService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
            ]; };
...
//# sourceMappingURL=bao-cao-bao-cao-xuat-nhap-ton-bao-cao-xuat-nhap-ton-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-xuat-nhap-ton-bao-cao-xuat-nhap-ton-module-es5.js.map