...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-giuong-benh-so-do-giuong-benh-so-do-giuong-benh-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuanLyGiuongBenhKhoaComponent = /** @class */ (function () {
                function QuanLyGiuongBenhKhoaComponent(authService, router, notificationService, dialog, apiService) {
                ...
                QuanLyGiuongBenhKhoaComponent.prototype.ngOnInit = function () {
                ...
                QuanLyGiuongBenhKhoaComponent.prototype.getDataSource = function (resultData) {
                ...
                QuanLyGiuongBenhKhoaComponent.prototype.khoaChange = function (event) {
                    this.soDoGiuongBenhSearch.KhoaId = event;
                    this.TimkiemNangCao();
                };
                QuanLyGiuongBenhKhoaComponent.prototype.TimkiemNangCao = function () {
                    var queryString = JSON.stringify(this.soDoGiuongBenhSearch);
                    this.gridChild._additionalSearchString = queryString;
                    this.gridChild.search();
                };
                QuanLyGiuongBenhKhoaComponent.prototype.Xem = function (item) {
                    //console.log("Xem = ", item, this.gridChild._gridDataSource.data[0]);
                    var dialogRef = this.dialog.open(_so_do_giuong_popup_so_do_giuong_popup_component__WEBPACK_IMPORTED_MODULE_9__["SoDoGiuongPopupComponent"], {
                        disableClose: false,
                        width: '1000px',
                        height: '500px',
                        data: item.Id,
                ...
                QuanLyGiuongBenhKhoaComponent.prototype.totalKhac = function (item) {
                    //console.log("totalKhac = ", item);
                };
                QuanLyGiuongBenhKhoaComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("SoDoGiuongBenh/ExportSoDoGiuongBenh", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return QuanLyGiuongBenhKhoaComponent;
            }());
            QuanLyGiuongBenhKhoaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuanLyGiuongBenhPhongComponent = /** @class */ (function () {
                function QuanLyGiuongBenhPhongComponent(authService, router, notificationService, dialog, route, apiService) {
                    this.authService = authService;
                    this.router = router;
                    this.notificationService = notificationService;
                    this.dialog = dialog;
                ...
                QuanLyGiuongBenhPhongComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.getTenKhoa(this.id).then(function (obj) {
                        _this.tenKhoa = obj;
                    });
                ...
                QuanLyGiuongBenhPhongComponent.prototype.getDataSource = function (resultData) {
                    //console.log("getDataSource = ", resultData);
                    if (resultData != null && resultData != undefined && resultData.length > 0) {
                        this.totalGiuongTrong = resultData[0].TongSoGiuongTrong;
                        this.totalGiuongCoBenhNhan = resultData[0].TongSoGiuongCoBenhNhan + " (" + resultData[0].TongSoGiuongGhep + ")";
                ...
                QuanLyGiuongBenhPhongComponent.prototype.khoaChange = function (event) {
                    this.soDoGiuongBenhSearch.KhoaId = event;
                    this.TimkiemNangCao();
                };
                QuanLyGiuongBenhPhongComponent.prototype.TimkiemNangCao = function () {
                    var queryString = JSON.stringify(this.soDoGiuongBenhSearch);
                    this.gridChild._additionalSearchString = queryString;
                    this.gridChild.search();
                };
                QuanLyGiuongBenhPhongComponent.prototype.Xem = function (event) {
                    // console.log("event = ", event);
                    this.router.navigate(['danh-muc/nhom-giuong-benh/so-do-giuong-benh/quan-ly-phong-khoa/' + event.Id + '/' + this.id]);
                };
                QuanLyGiuongBenhPhongComponent.prototype.quayLai = function () {
                    this.router.navigate(['danh-muc/nhom-giuong-benh/so-do-giuong-benh/']);
                };
                QuanLyGiuongBenhPhongComponent.prototype.getTenKhoa = function (id) {
                    return this.apiService.post("SoDoGiuongBenh/GetTenKhoa?khoaId=" + id).toPromise().catch(function () { return ""; });
                };
                return QuanLyGiuongBenhPhongComponent;
            }());
            QuanLyGiuongBenhPhongComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuanLyGiuongBenhComponent = /** @class */ (function () {
                function QuanLyGiuongBenhComponent(authService, router, notificationService, dialog, route, apiService) {
                    this.authService = authService;
                    this.router = router;
                    this.notificationService = notificationService;
                    this.dialog = dialog;
                ...
                QuanLyGiuongBenhComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.getTenKhoa(this.khoaId).then(function (obj) {
                        _this.tenKhoa = obj;
                    });
                    this.getMaTenPhong(this.phongId).then(function (obj) {
                        _this.maTenPhong = obj;
                    });
                ...
                QuanLyGiuongBenhComponent.prototype.getTenKhoa = function (id) {
                    return this.apiService.post("SoDoGiuongBenh/GetTenKhoa?khoaId=" + id).toPromise().catch(function () { return ""; });
                };
                QuanLyGiuongBenhComponent.prototype.getMaTenPhong = function (id) {
                    return this.apiService.post("SoDoGiuongBenh/GetMaTenPhong?phongId=" + id).toPromise().catch(function () { return ""; });
                };
                QuanLyGiuongBenhComponent.prototype.getDataSource = function (resultData) {
                    this.setDefaultColumnGrid();
                    //console.log("getDataSource = ", resultData);
                    var soBenhNhanMax = 0;
                ...
                QuanLyGiuongBenhComponent.prototype.setDefaultColumnGrid = function () {
                    this.gridColumns = [
                        { Field: "STT", Title: "STT", Width: 60 },
                ...
                QuanLyGiuongBenhComponent.prototype.setBenhNhanColumnForGrid = function (soBenhNhanMax) {
                    if (soBenhNhanMax != 0) {
                        for (var i = 0; i < soBenhNhanMax; i++) {
                            //let columnTemplate = this.gridColumns;
                            var title = "Người Bệnh " + (i + 1);
                            var fieldName = "BenhNhan" + (i + 1);
                ...
                // }
                QuanLyGiuongBenhComponent.prototype.getTotalBottomGrid = function (numberType) {
                    if (numberType === void 0) { numberType = 1; }
                ...
                QuanLyGiuongBenhComponent.prototype.setTitle = function (data, index) {
                    if (index === void 0) { index = 1; }
                    //return "Hello, World! \nvu le";
                    var result = "Mã NB: MaBN \nKhoa điều trị: KhoaDieuTri \nPhòng: Phong \n"
                        + "Họ và tên: HoVaTen \nNăm sinh: NamSinh \nSĐT: SoDienThoai \nTình trạng bệnh: TinhTrangBenh \n"
                        + "Ngày vào viện: NgayVaoVien \nNgày ra viện: NgayRaVien";
                    var item = data.lstBenhNhanGiuong[index - 1];
                ...
                QuanLyGiuongBenhComponent.prototype.displayFieldBenhNhan = function (data, index) {
                    if (index === void 0) { index = 1; }
                    var result = "";
                    switch (index) {
                        case 1:
                ...
                QuanLyGiuongBenhComponent.prototype.setBenhNhanDataForGrid = function (resultData) {
                    if (resultData != null && resultData != undefined) {
                        //console.log("setBenhNhanDataForGrid - resultData = ", resultData);
                        resultData.forEach(function (e) {
                            var stt = 0;
                            if (e.lstBenhNhanGiuong != null && e.lstBenhNhanGiuong != undefined) {
                                e.lstBenhNhanGiuong.forEach(function (p) {
                ...
                QuanLyGiuongBenhComponent.prototype.quayLai = function () {
                    this.router.navigate(['danh-muc/nhom-giuong-benh/so-do-giuong-benh/chinh-sua/' + this.khoaId]);
                };
                QuanLyGiuongBenhComponent.prototype.blur = function () {
                    //console.log("blur = ");
                    this.timKiem();
                };
                QuanLyGiuongBenhComponent.prototype.clearSearch = function (event) {
                ...
                QuanLyGiuongBenhComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                QuanLyGiuongBenhComponent.prototype.timKiem = function () {
                    this.gridChild.searchString = this.searchString;
                    this.gridChild.search();
                };
                return QuanLyGiuongBenhComponent;
            }());
            QuanLyGiuongBenhComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SoDoGiuongBenhRoutingModule = /** @class */ (function () {
                function SoDoGiuongBenhRoutingModule() {
                }
                return SoDoGiuongBenhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var SoDoGiuongBenh = /** @class */ (function () {
                function SoDoGiuongBenh() {
                }
                return SoDoGiuongBenh;
            }());
            var SoDoGiuongBenhSearchHeader = /** @class */ (function () {
                function SoDoGiuongBenhSearchHeader(KhoaId, PhongId) {
                    if (KhoaId === void 0) { KhoaId = null; }
                    if (PhongId === void 0) { PhongId = null; }
                    this.KhoaId = KhoaId;
                    this.PhongId = PhongId;
                }
                return SoDoGiuongBenhSearchHeader;
            }());
            var ResultSoDoPopup = /** @class */ (function () {
                function ResultSoDoPopup(KhoaId, PhongId, TenKhoa, GiuongTrong, GiuongDaCoBenhNhan, lstPhong) {
                    if (KhoaId === void 0) { KhoaId = null; }
                    if (PhongId === void 0) { PhongId = null; }
                    if (TenKhoa === void 0) { TenKhoa = null; }
                    if (GiuongTrong === void 0) { GiuongTrong = null; }
                    if (GiuongDaCoBenhNhan === void 0) { GiuongDaCoBenhNhan = null; }
                    if (lstPhong === void 0) { lstPhong = new Array(); }
                    this.KhoaId = KhoaId;
                    this.PhongId = PhongId;
                ...
                return ResultSoDoPopup;
            }());
            var LstPhong = /** @class */ (function () {
                function LstPhong(PhongId, DisplayName, lstGiuong) {
                    if (PhongId === void 0) { PhongId = null; }
                    if (DisplayName === void 0) { DisplayName = null; }
                    if (lstGiuong === void 0) { lstGiuong = new Array(); }
                    this.PhongId = PhongId;
            ...
            var LstGiuong = /** @class */ (function () {
                function LstGiuong(IsGiuongTrong, SoBenhNhan, TenGiuong) {
                    if (IsGiuongTrong === void 0) { IsGiuongTrong = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SoDoGiuongBenhModule = /** @class */ (function () {
                function SoDoGiuongBenhModule() {
                }
                return SoDoGiuongBenhModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SoDoGiuongBenhService = /** @class */ (function (_super) {
                __extends(SoDoGiuongBenhService, _super);
                function SoDoGiuongBenhService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'SoDoGiuongBenh';
                    return _this;
                }
                return SoDoGiuongBenhService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            SoDoGiuongBenhService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SoDoGiuongPopupComponent = /** @class */ (function () {
                function SoDoGiuongPopupComponent(data, dialog, apiService) {
                    this.data = data;
                    this.dialog = dialog;
                    this.apiService = apiService;
                ...
                SoDoGiuongPopupComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                SoDoGiuongPopupComponent.prototype.giuongTrongChange = function ($event) {
                    this.giuongTrong = $event;
                    //this.getListGiuongBenhFollowPhong(this.phongId);
                };
                SoDoGiuongPopupComponent.prototype.giuongDaCoBenhNhanChange = function ($event) {
                    this.giuongDaCoBenhNhan = $event;
                    //this.getListGiuongBenhFollowPhong(this.phongId);
                };
                SoDoGiuongPopupComponent.prototype.phongChange = function ($event) {
                    //console.log("phongChange = ", $event);
                    this.getListGiuongBenhFollowPhong($event);
                };
                SoDoGiuongPopupComponent.prototype.close = function () {
                    this.dialog.closeAll();
                };
                SoDoGiuongPopupComponent.prototype.getTenKhoa = function (id) {
                    return this.apiService.post("SoDoGiuongBenh/GetTenKhoa?khoaId=" + id).toPromise().catch(function () { return ""; });
                };
                SoDoGiuongPopupComponent.prototype.getListGiuongBenhFollowPhong = function (phongId) {
                    var _this = this;
                    ...
                    this.apiService.post("SoDoGiuongBenh/GetDanhSachGiuongKhoaPopup", this.modelGiuong).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            console.log("ResultSoDoPopup = ", resultData);
                            _this.resultGiuong = resultData;
                        }
                        else {
                        }
                    }, function (err) {
                ...
                return SoDoGiuongPopupComponent;
            }());
            SoDoGiuongPopupComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-giuong-benh-so-do-giuong-benh-so-do-giuong-benh-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-giuong-benh-so-do-giuong-benh-so-do-giuong-benh-module-es5.js.map