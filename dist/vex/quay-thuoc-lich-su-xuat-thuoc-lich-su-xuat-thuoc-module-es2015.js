...
let LichSuXuatThuocChiTietComponent = class LichSuXuatThuocChiTietComponent {
    ...
    InKeThuocKhongBhyt() {
        ...
        let xacNhanInThuocVatTuData = new _lich_su_xuat_thuoc_model__WEBPACK_IMPORTED_MODULE_4__["XacNhanInThuocVatTuViewModel"]();
...
LichSuXuatThuocChiTietComponent.ctorParameters = () => [
...
let LichSuXuatThuocListComponent = class LichSuXuatThuocListComponent {
    ...
    getDropdownItem(obj, keyValue, titleValue) {
        ...
        if (obj != undefined && obj.KeyId != null) {
            if (obj.KeyId == null) {
                ...
                if (index < 0) {
                    let item = new _lich_su_xuat_thuoc_model__WEBPACK_IMPORTED_MODULE_9__["TagItem"]();
                    item.Key = keyValue;
    ...
    exportExcel() {
        var self = this;
        let dialogRef = self.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_12__["LoadingComponent"], {
            disableClose: true,
            width: '200px',
            height: '90px',
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('QuayThuoc/ExportLichSuXuatThuoc', self.exportQueryInfoQueryInfo).subscribe(resultData => {
...
LichSuXuatThuocListComponent.ctorParameters = () => [
...
let LichSuXuatThuocRoutingModule = class LichSuXuatThuocRoutingModule {
};
...
let LichSuXuatThuocModule = class LichSuXuatThuocModule {
};
...
let LichSuXuatThuocService = class LichSuXuatThuocService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
    }
};
LichSuXuatThuocService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
