(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-duoc-pham-yeu-cau-linh-thuoc-danh-sach-duoc-pham-can-bu-danh-sach-duoc-pham-can-bu-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachDuocPhamCanBuRoutingModule = /** @class */ (function () {
                function DanhSachDuocPhamCanBuRoutingModule() {
                }
                return DanhSachDuocPhamCanBuRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachDuocPhamCanBuComponent = /** @class */ (function () {
                function DanhSachDuocPhamCanBuComponent(dialog, router, apiService, authService, notificationService, cd) {
                    this.dialog = dialog;
                    this.router = router;
                ...
                DanhSachDuocPhamCanBuComponent.prototype.ngOnInit = function () {
                ...
                DanhSachDuocPhamCanBuComponent.prototype.search = function (event, type) {
                    // this.additionalSearchString = "{'KhoLinhId':" + (this.duocPhamCanBuSearch.KhoLinhId != undefined ? this.duocPhamCanBuSearch.KhoLinhId : null) + ",'KhoBuId':" + (this.duocPhamCanBuSearch.KhoBuId != undefined ? this.duocPhamCanBuSearch.KhoBuId : null) + "}";
                ...
                DanhSachDuocPhamCanBuComponent.prototype.extOnDataBound = function (dataSource) {
                    var _this = this;
                    if (dataSource != null && dataSource.Data != null && dataSource.Data.length > 0 && this.dataSourceAfterSearch == null) {
                        ...
                        dataSource.Data.forEach(function (element) {
                            var checkExitLinhTuKho = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__["CommonService"].findObjectByKey(_this.danhSachLinhTuKho, "KeyId", element.KhoLinhId);
                            if (checkExitLinhTuKho == null) {
                                _this.danhSachLinhTuKho.push({ KeyId: element.KhoLinhId, DisplayName: element.KhoLinh });
                            }
                            var checkExitLinhVekho = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__["CommonService"].findObjectByKey(_this.danhSachLinhVekho, "KeyId", element.KhoBuId);
                            if (checkExitLinhVekho == null) {
                                _this.danhSachLinhVekho.push({ KeyId: element.KhoBuId, DisplayName: element.KhoBu });
                            }
                        });
                    }
                };
                DanhSachDuocPhamCanBuComponent.prototype.taoPhieuLinh = function (dataItem) {
                ...
                DanhSachDuocPhamCanBuComponent.prototype.loadingPage = function () {
                ...
                DanhSachDuocPhamCanBuComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                DanhSachDuocPhamCanBuComponent.prototype.khongBu = function (dataItem) {
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                                self.loadingPage();
                                self.apiService.post("YeuCauLinhDuocPham/KhongBuDuocPham?yeuCauLinhDuocPhamIdstring=" + dataItem.YeuCauLinhDuocPhamIdstring).subscribe(function () {
                ...
                return DanhSachDuocPhamCanBuComponent;
            }());
            DanhSachDuocPhamCanBuComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachDuocPhamCanBuModule = /** @class */ (function () {
                function DanhSachDuocPhamCanBuModule() {
                }
                return DanhSachDuocPhamCanBuModule;
            }());
...
//# sourceMappingURL=nhap-xuat-duoc-pham-yeu-cau-linh-thuoc-danh-sach-duoc-pham-can-bu-danh-sach-duoc-pham-can-bu-module-es5.js.map
//# sourceMappingURL=nhap-xuat-duoc-pham-yeu-cau-linh-thuoc-danh-sach-duoc-pham-can-bu-danh-sach-duoc-pham-can-bu-module-es5.js.map