...
let BaoCaoSoXetNghiemSangLocHivListComponent = class BaoCaoSoXetNghiemSangLocHivListComponent {
    ...
    XemBaoCao() {
        ...
        this.baoCaoSearch.ToDate = this.baoCaoSearch.DenNgayFormat;
        this.baoCaoSearch.AdditionalSearchString = tuNgay + ";" + denNgay;
        this.apiService.post("BaoCao/GetDataBaoCaoSoXetNghiemSangLocHivForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoSoXetNghiemSangLocHivListComponent.ctorParameters = () => [
...
let BaoCaoSoXetNghiemSangLocHivPopupComponent = class BaoCaoSoXetNghiemSangLocHivPopupComponent {
    ...
    showBaoCao() {
        ...
        this.apiService.post("BaoCao/InBaoCaoSoXetNghiemSangLocHiv", this.inBaoCaoSoXetNghiemSangLocHiv).subscribe(resultData => {
...
BaoCaoSoXetNghiemSangLocHivPopupComponent.ctorParameters = () => [
...
let BaoCaoSoXetNghiemSangLocHivRoutingModule = class BaoCaoSoXetNghiemSangLocHivRoutingModule {
};
...
class BaoCaoSoXetNghiemSangLocHivSearch {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, DichVuKyThuatBenhVienId = 3798, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
class BaoCaoSoXetNghiemSangLocHiv {
...
class InBaoCaoSoXetNghiemSangLocHiv {
    constructor(DichVuKyThuatBenhVienId = 0, HostingName = null, FromDate = null, ToDate = null) {
        this.DichVuKyThuatBenhVienId = DichVuKyThuatBenhVienId;
...
let BaoCaoSoXetNghiemSangLocHivModule = class BaoCaoSoXetNghiemSangLocHivModule {
};
...
let BaoCaoSoXetNghiemSangLocHivService = class BaoCaoSoXetNghiemSangLocHivService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoSoXetNghiemSangLocHivService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
