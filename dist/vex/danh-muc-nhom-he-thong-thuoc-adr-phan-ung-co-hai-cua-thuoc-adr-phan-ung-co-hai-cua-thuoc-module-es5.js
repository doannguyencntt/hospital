...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-thuoc-adr-phan-ung-co-hai-cua-thuoc-adr-phan-ung-co-hai-cua-thuoc-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdrPhanUngCoHaiCuaThuocCreateComponent = /** @class */ (function () {
                function AdrPhanUngCoHaiCuaThuocCreateComponent(router) {
                    this.router = router;
                }
                AdrPhanUngCoHaiCuaThuocCreateComponent.prototype.ngOnInit = function () {
                };
                AdrPhanUngCoHaiCuaThuocCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/thuoc/adr-phan-ung-co-hai-cua-thuoc']);
                };
                return AdrPhanUngCoHaiCuaThuocCreateComponent;
            }());
            AdrPhanUngCoHaiCuaThuocCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdrPhanUngCoHaiCuaThuocListComponent = /** @class */ (function () {
                function AdrPhanUngCoHaiCuaThuocListComponent(dialog, notificationService, apiService, authService) {
                    this.dialog = dialog;
                ...
                AdrPhanUngCoHaiCuaThuocListComponent.prototype.ngOnInit = function () {
                ...
                AdrPhanUngCoHaiCuaThuocListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("ADR/ExportADR", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return AdrPhanUngCoHaiCuaThuocListComponent;
            }());
            AdrPhanUngCoHaiCuaThuocListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdrPhanUngCoHaiCuaThuocRoutingModule = /** @class */ (function () {
                function AdrPhanUngCoHaiCuaThuocRoutingModule() {
                }
                return AdrPhanUngCoHaiCuaThuocRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdrPhanUngCoHaiCuaThuocSharedComponent = /** @class */ (function () {
                function AdrPhanUngCoHaiCuaThuocSharedComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.adr = {};
                    this.isCreate = true;
                }
                AdrPhanUngCoHaiCuaThuocSharedComponent.prototype.ngOnInit = function () {
                ...
                AdrPhanUngCoHaiCuaThuocSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.adr = resultData;
                    });
                };
                AdrPhanUngCoHaiCuaThuocSharedComponent.prototype.getSharedData = function () {
                    return this.adr;
                };
                return AdrPhanUngCoHaiCuaThuocSharedComponent;
            }());
            AdrPhanUngCoHaiCuaThuocSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdrPhanUngCoHaiCuaThuocUpdateComponent = /** @class */ (function () {
                function AdrPhanUngCoHaiCuaThuocUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                AdrPhanUngCoHaiCuaThuocUpdateComponent.prototype.ngOnInit = function () {
                };
                AdrPhanUngCoHaiCuaThuocUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/thuoc/adr-phan-ung-co-hai-cua-thuoc']);
                };
                return AdrPhanUngCoHaiCuaThuocUpdateComponent;
            }());
            AdrPhanUngCoHaiCuaThuocUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdrPhanUngCoHaiCuaThuocModule = /** @class */ (function () {
                function AdrPhanUngCoHaiCuaThuocModule() {
                }
                return AdrPhanUngCoHaiCuaThuocModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdrPhanUngCoHaiCuaThuocService = /** @class */ (function (_super) {
                __extends(AdrPhanUngCoHaiCuaThuocService, _super);
                function AdrPhanUngCoHaiCuaThuocService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'ADR';
                    return _this;
                }
                return AdrPhanUngCoHaiCuaThuocService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            AdrPhanUngCoHaiCuaThuocService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-thuoc-adr-phan-ung-co-hai-cua-thuoc-adr-phan-ung-co-hai-cua-thuoc-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-thuoc-adr-phan-ung-co-hai-cua-thuoc-adr-phan-ung-co-hai-cua-thuoc-module-es5.js.map