...
let KhamDoanLsTiepNhanDetailPopupComponent = class KhamDoanLsTiepNhanDetailPopupComponent {
    ...
    ngOnInit() {
        ...
        let modelgrid = new _kham_doan_ls_tiep_nhan_kham_suc_khoe_model__WEBPACK_IMPORTED_MODULE_17__["TiepNhanNhanVienTheoHopDongTimKiemNangCapVo"]();
...
KhamDoanLsTiepNhanDetailPopupComponent.ctorParameters = () => [
...
let KhamDoanLsTiepNhanInHoSoPopupComponent = class KhamDoanLsTiepNhanInHoSoPopupComponent {
...
KhamDoanLsTiepNhanInHoSoPopupComponent.ctorParameters = () => [
...
let KhamDoanLsTiepNhanKhamSucKhoeListComponent = class KhamDoanLsTiepNhanKhamSucKhoeListComponent {
    ...
    xuLyXuatExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_16__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("KhamDoan/ExportLichSuTiepNhanKhamSucKhoeDoan", this.gridDaHoanThanhKham._gridQueryInfo).subscribe(res => {
...
KhamDoanLsTiepNhanKhamSucKhoeListComponent.ctorParameters = () => [
...
let KhamDoanLsTiepNhanKhamSucKhoeRoutingModule = class KhamDoanLsTiepNhanKhamSucKhoeRoutingModule {
};
...
class KhamDoanLSTiepNhanTimKiem {
    constructor(SearchString = null, FromToDate = new SearchDateRange(), NgayBatDau = null, NgayKetThuc = null) {
...
class KhamDoanLSTiepNhanNhanVienTimKiem {
    constructor(SearchString = null, CongTyId = null, HopDongId = null, TrangThai = new KhamDoanLSTiepNhanNhanVienTrangThai()) {
        this.SearchString = SearchString;
...
class KhamDoanLSTiepNhanNhanVienTrangThai {
    constructor(ChuaKham = true, DangKham = true, DaKham = true, HuyKham = true) {
...
class TiepNhanNhanVienTheoHopDongTimKiemNangCapVo {
    constructor(CongTyId = null, HopDongId = null, IsDangKham = false, IsLichSu = false, TrangThai = new KhamDoanLSTiepNhanNhanVienTrangThai(), SearchString = null) {
        this.CongTyId = CongTyId;
        this.HopDongId = HopDongId;
...
class ExportQueryInfoQueryInfo {
    constructor(Skip = 0, Take = 50, PageSize = 50, Search = "", AdditionalSearchString = "", 
    // public searchTerms:  = "",
    Sort = []) {
        this.Skip = Skip;
        this.Take = Take;
...
class ChiTietHopDongKhamSucKhoe {
    constructor(TenCongTy = "", CongTyId = null, SoHopDong = "", HopDongId = null, NgayHopDong = null, LoaiHopDong = null, TrangThai = null, SoBenhNhan = null, NgayHieuLuc = null, NgayKetThuc = null) {
...
class YeuCauTiepNhanKhamSucKhoe {
    constructor(Id = 0, HopDongKhamSucKhoeNhanVien = null, TrangThaiYeuCauTiepNhan = null) {
        this.Id = Id;
...
let KhamDoanLsTiepNhanKhamSucKhoeModule = class KhamDoanLsTiepNhanKhamSucKhoeModule {
};
...
let KhamDoanLsTiepNhanNhanVienDetailPopupComponent = class KhamDoanLsTiepNhanNhanVienDetailPopupComponent {
    ...
    getDataNhanVien(id) {
        ...
        this.apiService
            ...
            this.isHoanThanhKham = this.thongTinHanhChinhNhanVien.TrangThaiYeuCauTiepNhan == src_app_shared_enum_kham_doan_enum__WEBPACK_IMPORTED_MODULE_11__["TrangThaiYeuCauTiepNhan"].DaHoanTat;
            this.closePopupLoadingData();
        }, (err) => {
...
KhamDoanLsTiepNhanNhanVienDetailPopupComponent.ctorParameters = () => [
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"] },
