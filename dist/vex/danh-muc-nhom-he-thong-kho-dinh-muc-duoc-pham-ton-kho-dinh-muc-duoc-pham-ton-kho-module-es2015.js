...
let DinhMucDuocPhamTonKhoCreateComponent = class DinhMucDuocPhamTonKhoCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
DinhMucDuocPhamTonKhoCreateComponent.ctorParameters = () => [
...
let DinhMucDuocPhamTonKhoListComponent = class DinhMucDuocPhamTonKhoListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("DinhMucDuocPhamTonKho/ExportDinhMucDuocPhamTonKho", this.gridChild._gridQueryInfo).subscribe(res => {
...
DinhMucDuocPhamTonKhoListComponent.ctorParameters = () => [
...
let DinhMucDuocPhamTonKhoRoutingModule = class DinhMucDuocPhamTonKhoRoutingModule {
};
...
let DinhMucDuocPhamTonKhoSharedComponent = class DinhMucDuocPhamTonKhoSharedComponent {
...
DinhMucDuocPhamTonKhoSharedComponent.ctorParameters = () => [
...
let DinhMucDuocPhamTonKhoUpdateComponent = class DinhMucDuocPhamTonKhoUpdateComponent {
...
DinhMucDuocPhamTonKhoUpdateComponent.ctorParameters = () => [
...
let DinhMucDuocPhamTonKhoModule = class DinhMucDuocPhamTonKhoModule {
};
...
let DinhMucDuocPhamTonKhoService = class DinhMucDuocPhamTonKhoService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DinhMucDuocPhamTonKho';
    }
};
DinhMucDuocPhamTonKhoService.ctorParameters = () => [
