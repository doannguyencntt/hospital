...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-doanh-thu-kham-doan-theo-khoa-phong-bao-cao-doanh-thu-kham-doan-theo-khoa-phong-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent = /** @class */ (function () {
                function BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent(apiService, dialog, authService, notificationService) {
                ...
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.xemBaoCao = function (isChagePage) {
                    var _this = this;
                    ...
                    var searchText = this.getSearchText();
                    this.queryInfo = { skip: this.skip, take: this.pageSize, pageSize: this.pageSize, searchString: searchText, additionalSearchString: JSON.stringify(this.baoCaoSearch), sort: null, lazyLoadPage: false };
                    this.apiService.post("BaoCao/GetDataBaoCaoDoanhThuKhamDoanTheoKhoaPhongForGridAsync", this.queryInfo).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            resultData.Data.forEach(function (element) {
                                element.DoanhThuTheoKhoas.forEach(function (khoa) {
                                    if (!_this.lstKhoaPhongCoDoanhThu.some(function (x) { return x.KhoaId == khoa.KhoaId; })) {
                                        _this.lstKhoaPhongCoDoanhThu.push(khoa);
                                    }
                                });
                            });
                            ...
                            _this.apiService.post("BaoCao/GetDataTotalPageBaoCaoDoanhThuKhamDoanTheoKhoaPhongForGridAsync", _this.queryInfo).subscribe(function (resultDataTotal) {
                ...
                //   });
                // }
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.pageChange = function (event) {
                    this.skip = event.skip;
                    this.xemBaoCao(true);
                };
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.getSearchText = function () {
                ...
                BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.prototype.getDoanhThu = function (dataItem, khoaId) {
                    var arrDoanhThu = dataItem.DoanhThuTheoKhoas.filter(function (x) { return x.KhoaId == khoaId && x.DoanhThu != null && x.DoanhThu != 0; });
                    if (arrDoanhThu.length > 0) {
                        return arrDoanhThu.reduce(function (sum, item) { return sum + item.DoanhThu; }, 0);
                    }
                    else {
                        return null;
                    }
                };
                return BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent;
            }());
            BaoCaoDoanhThuKhamDoanTheoKhoaPhongListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDoanhThuKhamDoanTheoKhoaPhongRoutingModule = /** @class */ (function () {
                function BaoCaoDoanhThuKhamDoanTheoKhoaPhongRoutingModule() {
                }
                return BaoCaoDoanhThuKhamDoanTheoKhoaPhongRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoDoanhThuKhamDoanTheoKhoaPhongSearch = /** @class */ (function () {
                function BaoCaoDoanhThuKhamDoanTheoKhoaPhongSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, SearchString, Hosting) {
                ...
                return BaoCaoDoanhThuKhamDoanTheoKhoaPhongSearch;
            }());
            var DoanhThuKhamDoanTheoKhoaPhong = /** @class */ (function () {
                function DoanhThuKhamDoanTheoKhoaPhong(STT, Ten, DVT, SLTonDauKy, ThanhTienTonDauKy, SLNhapTrongKy, ThanhTienNhapTrongKy, SLXuatTrongKy, ThanhTienXuatTrongKy, SLTonCuoiKy, Gia, ThanhTien) {
                ...
                return DoanhThuKhamDoanTheoKhoaPhong;
            }());
            var InBaoCaoDoanhThuKhamDoanTheoKhoaPhong = /** @class */ (function () {
                function InBaoCaoDoanhThuKhamDoanTheoKhoaPhong(KhoId, HostingName, FromDate, ToDate) {
                ...
                return InBaoCaoDoanhThuKhamDoanTheoKhoaPhong;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDoanhThuKhamDoanTheoKhoaPhongModule = /** @class */ (function () {
                function BaoCaoDoanhThuKhamDoanTheoKhoaPhongModule() {
                }
                return BaoCaoDoanhThuKhamDoanTheoKhoaPhongModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDoanhThuKhamDoanTheoKhoaPhongService = /** @class */ (function (_super) {
                __extends(BaoCaoDoanhThuKhamDoanTheoKhoaPhongService, _super);
                function BaoCaoDoanhThuKhamDoanTheoKhoaPhongService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoDoanhThuKhamDoanTheoKhoaPhongService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoDoanhThuKhamDoanTheoKhoaPhongService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-kham-doan-theo-khoa-phong-bao-cao-doanh-thu-kham-doan-theo-khoa-phong-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-kham-doan-theo-khoa-phong-bao-cao-doanh-thu-kham-doan-theo-khoa-phong-module-es5.js.map