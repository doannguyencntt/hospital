...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-bao-hiem-y-te-khoa-khoa-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaListComponent = /** @class */ (function () {
                function KhoaListComponent(authService, dialog, notificationService, apiService) {
                ...
                KhoaListComponent.prototype.ngOnInit = function () {
                ...
                KhoaListComponent.prototype.updateDanhMucChuyenKhoa = function (id, isDisabled) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                self.apiService.post('Khoa/KichHoatKhoa?id=' + id).subscribe(function () {
                ...
                KhoaListComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('Khoa/ExportChuyenKhoa', self.gridChild._gridQueryInfo).subscribe(function (resultData) {
                ...
                KhoaListComponent.prototype.showPopupLoadingData = function () {
                ...
                KhoaListComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return KhoaListComponent;
            }());
            KhoaListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaRoutingModule = /** @class */ (function () {
                function KhoaRoutingModule() {
                }
                return KhoaRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhoaService = /** @class */ (function (_super) {
                __extends(KhoaService, _super);
                function KhoaService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'Khoa';
                    return _this;
                }
                return KhoaService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            KhoaService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-bao-hiem-y-te-khoa-khoa-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-bao-hiem-y-te-khoa-khoa-module-es5.js.map