...
let BaoCaoBangKeXuatThuocTheoBenhNhanListComponent = class BaoCaoBangKeXuatThuocTheoBenhNhanListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoBangKeXuatThuocTheoBenhNhanForGridAsync", this.baoCaoSearch).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                ...
                this.gridView = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_13__["process"])(resultData.Data, { group: this.groups });
...
BaoCaoBangKeXuatThuocTheoBenhNhanListComponent.ctorParameters = () => [
...
let BaoCaoBangKeXuatThuocTheoBenhNhanRoutingModule = class BaoCaoBangKeXuatThuocTheoBenhNhanRoutingModule {
};
...
class BaoCaoBangKeXuatThuocTheoBenhNhanSearch {
...
class InBaoCaoBangKeXuatThuocTheoBenhNhan {
...
let BaoCaoBangKeXuatThuocTheoBenhNhanModule = class BaoCaoBangKeXuatThuocTheoBenhNhanModule {
};
