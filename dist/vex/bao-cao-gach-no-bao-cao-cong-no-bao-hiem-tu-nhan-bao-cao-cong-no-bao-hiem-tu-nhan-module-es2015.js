...
let BaoCaoCongNoBaoHiemTuNhanListComponent = class BaoCaoCongNoBaoHiemTuNhanListComponent {
    constructor(apiService, dialog, authService, notificationService, router, route, location) {
    ...
    timKiemNangCao(refresh = false) {
        ...
        this.apiService.post("GachNo/GetBaoCaoGachNoCongTyBaoHiemTuNhan", queryInfo).subscribe(resultData => {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].Process)) {
            ...
            this.apiService.postExportExcel("GachNo/ExportBaoCaoCongNoCongTyBaoHiemTuNhan", queryGridInfo).subscribe(res => {
...
BaoCaoCongNoBaoHiemTuNhanListComponent.ctorParameters = () => [
...
let BaoCaoCongNoBaoHiemTuNhanRoutingModule = class BaoCaoCongNoBaoHiemTuNhanRoutingModule {
};
...
let BaoCaoCongNoBaoHiemTuNhanModule = class BaoCaoCongNoBaoHiemTuNhanModule {
};
