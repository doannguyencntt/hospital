(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["reset-password-reset-password-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ResetPasswordComponent = /** @class */ (function () {
                function ResetPasswordComponent(router, route, cdRef, dialog, notificationService, apiService) {
                    this.router = router;
                    this.route = route;
                    this.cdRef = cdRef;
                    this.dialog = dialog;
                ...
                ResetPasswordComponent.prototype.ngOnInit = function () {
                    ...
                    this.apiService.post("Auth/VerifyPassCodeForForgottenPassword", this.request).subscribe(function (res) {
                        _this.isAnnouncement = !res;
                ...
                ResetPasswordComponent.prototype.onSubmit = function () {
                    ...
                    this.apiService.post("Auth/ResetPassword", this.request).subscribe(function (res) {
                        if (res == true) {
                            _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_4__["SystemMessage"].ActionSuccessfully, ["Thay đổi mật khẩu"]));
                            _this.router.navigate(['/dang-nhap']);
                        }
                        else {
                            _this.isAnnouncement = !res;
