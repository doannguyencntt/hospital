...
let BaoCaoSoChiTietVatTuHangHoaListComponent = class BaoCaoSoChiTietVatTuHangHoaListComponent {
    ...
    DuocPhamHoacVatTuBenhVienChange(event) {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoSoChiTietVatTuHangHoaForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoSoChiTietVatTuHangHoaListComponent.ctorParameters = () => [
...
let BaoCaoSoChiTietVatTuHangHoaRoutingModule = class BaoCaoSoChiTietVatTuHangHoaRoutingModule {
};
...
class BaoCaoSoChiTietVatTuHangHoaSearch {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, KhoId = 0, DuocPhamHoacVatTuBenhVienId = 0, LoaiDuocPhamHoacVatTu = 0, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
class InBaoCaoSoChiTietVatTuHangHoa {
...
class DataChiTietVatTuHangHoa {
    constructor(GroupNgayXuatNhap = null, NgayXuatNhap = null, NgayXuatNhapStr = null, SoChungTu = null, NgayChungTu = null, NgayChungTuStr = null, DienGiai = null, DonGia = 0, SoLuongNhap = 0, ThanhTienNhap = 0, SoLuongXuat = 0, ThanhTienXuat = 0, SoLuongTon = 0, ThanhTienTon = 0) {
...
let BaoCaoSoChiTietVatTuHangHoaModule = class BaoCaoSoChiTietVatTuHangHoaModule {
};
...
let BaoCaoSoChiTietVatTuHangHoaService = class BaoCaoSoChiTietVatTuHangHoaService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoSoChiTietVatTuHangHoaService.ctorParameters = () => [
