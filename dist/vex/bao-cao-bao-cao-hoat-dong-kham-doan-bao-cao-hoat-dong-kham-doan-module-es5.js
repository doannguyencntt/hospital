(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-hoat-dong-kham-doan-bao-cao-hoat-dong-kham-doan-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoHoatDongKhamDoanListComponent = /** @class */ (function () {
                function BaoCaoHoatDongKhamDoanListComponent(authService, dialog, notificationService, apiService) {
                ...
                BaoCaoHoatDongKhamDoanListComponent.prototype.totalSoLuong = function (field) {
                    switch (field) {
                        case 'TongSo':
                            return this.data.reduce(function (sum, item) { return sum + item.TongSo; }, 0);
                    }
                };
                ;
                BaoCaoHoatDongKhamDoanListComponent.prototype.ngOnInit = function () {
                    this.GetDatasource();
                };
                BaoCaoHoatDongKhamDoanListComponent.prototype.GetDatasource = function () {
                    var _this = this;
                    ...
                    this.apiService.post('BaoCaoKhamDoanHopDong/GetDataForGridAsyncTheoNhanVienKhamDichVuTheoPhongKham', this.hoatDongKhamDoanSearch).subscribe(function (resultData) {
                        if (resultData != null && resultData != []) {
                            ...
                            _this.data.forEach(function (item) {
                                item.NoiThucHienCuaNguoiBenhs.forEach(function (phongKham) {
                                    if (_this.dataHeader.every(function (z) { return z.TenNoiThucHien != phongKham.TenNoiThucHien; })) {
                                        _this.dataHeader.push(phongKham);
                                    }
                                    _this.dataSumSoLuongHeader.push(phongKham);
                                });
                            });
                        }
                    });
                };
                BaoCaoHoatDongKhamDoanListComponent.prototype.timKiem = function () {
                    var _this = this;
                    this.data = [];
                    this.dataHeader = [];
                    this.dataSumSoLuongHeader = [];
                ...
                BaoCaoHoatDongKhamDoanListComponent.prototype.getSum = function (noiThucHienId) {
                    var sum = 0;
                    for (var i = 0; i < this.dataSumSoLuongHeader.length; i++) {
                ...
                BaoCaoHoatDongKhamDoanListComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                BaoCaoHoatDongKhamDoanListComponent.prototype.xuatExcel = function () {
                    var _this = this;
                ...
                return BaoCaoHoatDongKhamDoanListComponent;
            }());
            BaoCaoHoatDongKhamDoanListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoHoatDongKhamDoanRoutingModule = /** @class */ (function () {
                function BaoCaoHoatDongKhamDoanRoutingModule() {
                }
                return BaoCaoHoatDongKhamDoanRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoHoatDongKhamDoanModule = /** @class */ (function () {
                function BaoCaoHoatDongKhamDoanModule() {
                }
                return BaoCaoHoatDongKhamDoanModule;
            }());
...
//# sourceMappingURL=bao-cao-bao-cao-hoat-dong-kham-doan-bao-cao-hoat-dong-kham-doan-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-hoat-dong-kham-doan-bao-cao-hoat-dong-kham-doan-module-es5.js.map