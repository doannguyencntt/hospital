(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["xet-nghiem-chi-so-xet-nghiem-chi-so-xet-nghiem-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChiSoXetNghiemListComponent = /** @class */ (function () {
                function ChiSoXetNghiemListComponent(baseService, apiService, authService, notificationService, ref, dialog) {
                    var _this = this;
                    ...
                    this.items = [];
                    this.hasChildren = function (item) { return item.HasChildren == true; };
                    this.fetchChildren = function (dataItem) {
                        return _this.fetchChiSoXetNghiem(dataItem);
                    };
                }
                ChiSoXetNghiemListComponent.prototype.iconClassConTextMenu = function (_a) {
                    var text = _a.text, items = _a.items;
                    return {
                        icon: 'plus',
                    };
                };
                ChiSoXetNghiemListComponent.prototype.expandLogic = function (dataItem, isDefault) {
                    var _this = this;
                    var index = this.expandedKeys.findIndex(function (key) { return key === dataItem.IdCap; });
                    var nhomDichVuBenhVienIds = dataItem.IdCap.split(";");
                    var nhomDichVuBenhVienId = nhomDichVuBenhVienIds[0];
                    if (!isDefault) {
                        if (index === -1 && dataItem.HasChildren) {
                            ...
                            expandedKeysTemp.forEach(function (element) {
                                var item = element.split(";");
                                var nhomDichVuBenhVienIdEx = item[0];
                                if (dataItem.Loai == 1) {
                                    if (nhomDichVuBenhVienIdEx == nhomDichVuBenhVienId) {
                                        _this.expandedKeys.splice(element, 1);
                                    }
                                }
                                else if (dataItem.Loai == 2) {
                                    if (nhomDichVuBenhVienIdEx == nhomDichVuBenhVienId && dataItem.DichVuXetNghiemChaId == null) {
                                        var data = dataItem.IdCap.split(";");
                                        var dataChaId = data[0];
                                        var dataId = data[3];
                                        ...
                                        if (elTen == "dvkt" && elLoai == "2" && elId == dataId && elChaId == dataChaId || (elTen == "dvxn" && elLoai == "3")) {
                                            var indexz = _this.expandedKeys.findIndex(function (key) { return key === element; });
                                            _this.expandedKeys.splice(indexz, 1);
                ...
                ChiSoXetNghiemListComponent.prototype.fetchChiSoXetNghiem = function (dataItem) {
                ...
                ChiSoXetNghiemListComponent.prototype.iconClass = function (dataItem) {
                    return {
                ...
                ChiSoXetNghiemListComponent.prototype.ngAfterContentInit = function () {
                    setTimeout(function () {
                ...
                ChiSoXetNghiemListComponent.prototype.getDataTreeView = function () {
                    var _this = this;
                ...
                ChiSoXetNghiemListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                ChiSoXetNghiemListComponent.prototype.timKiem = function () {
                    var _this = this;
                ...
                ChiSoXetNghiemListComponent.prototype.loadingPage = function () {
                ...
                ChiSoXetNghiemListComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                ChiSoXetNghiemListComponent.prototype.addingPage = function () {
                ...
                ChiSoXetNghiemListComponent.prototype.closePopupAddingData = function () {
                    if (this.popupAddingData != undefined && this.popupAddingData != null) {
                        this.popupAddingData.close();
                    }
                };
                ChiSoXetNghiemListComponent.prototype.savingPage = function () {
                ...
                ChiSoXetNghiemListComponent.prototype.closePopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                ChiSoXetNghiemListComponent.prototype.searchChanges = function (dataItem) {
                ...
                ChiSoXetNghiemListComponent.prototype.expand = function (dataItem) {
                ...
                ///////////////////////////////////////////////////// GET  <=======
                ChiSoXetNghiemListComponent.prototype.getInfoChuaCoXetNghiem = function (dataItem) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].View)) {
                        this.apiService.post("DichVuXetNghiem/GetChuaChiSoXetNghiem", dataItem).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.chiSoXNChiTiet = resultData;
                                _this.chiSoXNChiTiet.CoChiSoXetNghiem = _this.dataItemLeftClick.CoChiSoXetNghiem;
                            }
                            _this.isUpdate = true;
                ...
                ChiSoXetNghiemListComponent.prototype.getById = function (id, dichVuXetNghiemId, chiSoCha) {
                    var _this = this;
                    this.chiSoXNChiTiet = new _chi_so_xet_nghiem_model__WEBPACK_IMPORTED_MODULE_19__["ChiSoXetNghiemChiTiet"]();
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].View)) {
                        this.apiService.get("DichVuXetNghiem/GetChiSoXetNghiem?id=" + id + "&dichVuXetNghiemId=" + dichVuXetNghiemId + "&chiSoCha=" + chiSoCha).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.chiSoXNChiTiet = resultData;
                                if (_this.dataItemLeftClick != undefined && _this.dataItemLeftClick != null) {
                                    _this.chiSoXNChiTiet.CoChiSoXetNghiem = _this.dataItemLeftClick.CoChiSoXetNghiem;
                                }
                                else {
                                    _this.chiSoXNChiTiet.CoChiSoXetNghiem = resultData.CoChiSoXetNghiem;
                                }
                                _this.isUpdate = true;
                                _this.isCreate = false;
                                _this.isShow = true;
                ...
                /////////////////////////////////////////////////////END GET  <=======
                ///////////////////////////////////////////////////// CLICK  <=======
                ChiSoXetNghiemListComponent.prototype.onLeftClick = function (event, dataItem) {
                ...
                ChiSoXetNghiemListComponent.prototype.onRightClick = function (event, dataItem) {
                ...
                ChiSoXetNghiemListComponent.prototype.onSelect = function (_a) {
                    var item = _a.item;
                ...
                ///////////////////////////////////////////////////// END -  CLICK  <=======
                ChiSoXetNghiemListComponent.prototype.themChiSoCon = function () {
                ...
                ChiSoXetNghiemListComponent.prototype.reLoad = function () {
                    var _this = this;
                    this.baseService.getDataForGrid(this.gridQueryInfo, "DichVuXetNghiem/GetDataTreeView")
                        .subscribe(function (resultData) {
                        _this.data = resultData;
                ...
                ChiSoXetNghiemListComponent.prototype.xoa = function () {
                    var _this = this;
                    this.isCreate = false;
                    this.isUpdate = false;
                    this.isShow = false;
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_18__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            ...
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Delete)) {
                                ...
                                self.chiSoXNChiTiet.CapDichVu = _this.dataItemRighClick.CapDichVu;
                                self.apiService.post("DichVuXetNghiem/XoaChiSoXetNghiem", self.chiSoXNChiTiet).subscribe(function () {
                ...
                ChiSoXetNghiemListComponent.prototype.sua = function () {
                ...
                ChiSoXetNghiemListComponent.prototype.cancel = function () {
                    this.validationErrors = [];
                    this.chiSoXNChiTiet = new _chi_so_xet_nghiem_model__WEBPACK_IMPORTED_MODULE_19__["ChiSoXetNghiemChiTiet"]();
                    if (this.isUpdate) {
                        this.isUpdate = false;
                ...
                ChiSoXetNghiemListComponent.prototype.themChiSoXNChiTiet = function () {
                    var self = this;
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_18__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Add)) {
                                ...
                                self.apiService.post("DichVuXetNghiem/ThemChiSoXetNghiem", self.chiSoXNChiTiet).subscribe(function () {
                ...
                ChiSoXetNghiemListComponent.prototype.luuChiSoXNChiTiet = function () {
                    var self = this;
                    self.chiSoXNChiTiet = self.shared.getSharedData();
                    self.validationErrors = [];
                    self.ref.detectChanges();
                        ...
                        if (res == "Yes") {
                            if ((self.chiSoXNChiTiet.CoChiSoXetNghiem == true && self.chiSoXNChiTiet.CapDichVu == 1)
                                ...
                                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                                    ...
                                    self.apiService.post("DichVuXetNghiem/CapNhatChiSoXetNghiem", self.chiSoXNChiTiet).subscribe(function () {
                ...
                ChiSoXetNghiemListComponent.prototype.XuatExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("DichVuXetNghiem/ExportDataTreeView").subscribe(function (res) {
                ...
                ChiSoXetNghiemListComponent.prototype.keyEvent = function (event) {
                    if (event.type === "contextmenu") {
                        event.preventDefault();
                        setTimeout(function () {
                        }, 100);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChiSoXetNghiemSharedComponent = /** @class */ (function () {
                function ChiSoXetNghiemSharedComponent() {
                ...
                ChiSoXetNghiemSharedComponent.prototype.ngOnInit = function () {
                ...
                ChiSoXetNghiemSharedComponent.prototype.getSharedData = function () {
                ...
                ChiSoXetNghiemSharedComponent.prototype.themChiSo = function () {
                    this.chiSoXNChiTiet.KetNoiChiSoXetNghiems.push(new _chi_so_xet_nghiem_model__WEBPACK_IMPORTED_MODULE_1__["KetNoiChiSoXetNghiem"]());
                    // console.log("this.chiSoXNChiTiet.KetNoiChiSoXetNghiems: ", this.chiSoXNChiTiet.KetNoiChiSoXetNghiems)
                };
                ChiSoXetNghiemSharedComponent.prototype.xoaChiSo = function (item) {
                ...
                ChiSoXetNghiemSharedComponent.prototype.clearValidators = function () {
                    this.validationErrors = [];
                };
                return ChiSoXetNghiemSharedComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ChiSoXetNghiem = /** @class */ (function () {
                function ChiSoXetNghiem(Id, IdCap, Ma, Ten, TenCha, DichVuXetNghiemChaId, DichVuXetNghiemId, NhomDichVuBenhVienId, CapDichVu, MoTa, SearchString, SearchTermString, Loai, CoChiSoXetNghiem) {
                    if (Id === void 0) { Id = 0; }
                    if (IdCap === void 0) { IdCap = null; }
                    if (Ma === void 0) { Ma = null; }
                    if (Ten === void 0) { Ten = null; }
                    if (TenCha === void 0) { TenCha = null; }
                    if (DichVuXetNghiemChaId === void 0) { DichVuXetNghiemChaId = null; }
                    if (DichVuXetNghiemId === void 0) { DichVuXetNghiemId = null; }
                    if (NhomDichVuBenhVienId === void 0) { NhomDichVuBenhVienId = null; }
                    if (CapDichVu === void 0) { CapDichVu = 0; }
                    if (MoTa === void 0) { MoTa = null; }
                    if (SearchString === void 0) { SearchString = null; }
                    if (SearchTermString === void 0) { SearchTermString = null; }
                    if (Loai === void 0) { Loai = 0; }
                    if (CoChiSoXetNghiem === void 0) { CoChiSoXetNghiem = null; }
                    this.Id = Id;
                    this.IdCap = IdCap;
                    this.Ma = Ma;
                    this.Ten = Ten;
            ...
            var KetNoiChiSoXetNghiem = /** @class */ (function () {
                function KetNoiChiSoXetNghiem(Id, TenKetNoi, MaChiSo, MauMayXetNghiemId, TenMauMayXetNghiem, NotSendOrder) {
                    if (Id === void 0) { Id = 0; }
                    if (TenKetNoi === void 0) { TenKetNoi = null; }
                    if (MaChiSo === void 0) { MaChiSo = null; }
                    if (MauMayXetNghiemId === void 0) { MauMayXetNghiemId = null; }
                    if (TenMauMayXetNghiem === void 0) { TenMauMayXetNghiem = null; }
                    if (NotSendOrder === void 0) { NotSendOrder = null; }
                    this.Id = Id;
                ...
                return KetNoiChiSoXetNghiem;
            }());
            var ChiSoXetNghiemChiTiet = /** @class */ (function () {
                function ChiSoXetNghiemChiTiet(Id, NhomDichVuBenhVienId, TenCha, Ten, Ma, MaLIS, DichVuKyThuatBenhVienId, TenDichVuKyThuat, SoThuTu, DonVi, ChiSoCha, TenChiSo, NamMin, NamMax, NuMin, NuMax, TreEmMin, TreEmMax, KieuDuLieu, TreEm6Min, TreEm6Max, TreEm612Min, TreEm612Max, TreEm1218Min, TreEm1218Max, NguyHiemMax, NguyHiemMin, CoChiSoXetNghiem, CapDichVu, HasChildren, DichVuXetNghiemChaId, HieuLuc, DichVuXetNghiemId, IsCreateChild, IsDelete, MaKetNoi, TenKetNoi, TiLe, LoaiMauXetNghiem, TenLoaiMauXetNghiem, KetNoiChiSoXetNghiems) {
                    if (Id === void 0) { Id = 0; }
                    if (NhomDichVuBenhVienId === void 0) { NhomDichVuBenhVienId = 0; }
                    if (TenCha === void 0) { TenCha = null; }
                    if (Ten === void 0) { Ten = null; }
                    if (Ma === void 0) { Ma = null; }
                    if (MaLIS === void 0) { MaLIS = null; }
                    if (DichVuKyThuatBenhVienId === void 0) { DichVuKyThuatBenhVienId = 0; }
                    if (TenDichVuKyThuat === void 0) { TenDichVuKyThuat = null; }
                    if (SoThuTu === void 0) { SoThuTu = null; }
                    if (DonVi === void 0) { DonVi = null; }
                    if (ChiSoCha === void 0) { ChiSoCha = null; }
                    if (TenChiSo === void 0) { TenChiSo = null; }
                    if (NamMin === void 0) { NamMin = null; }
                    if (NamMax === void 0) { NamMax = null; }
                    if (NuMin === void 0) { NuMin = null; }
                    if (NuMax === void 0) { NuMax = null; }
                    if (TreEmMin === void 0) { TreEmMin = null; }
                    if (TreEmMax === void 0) { TreEmMax = null; }
                    if (KieuDuLieu === void 0) { KieuDuLieu = null; }
                    if (TreEm6Min === void 0) { TreEm6Min = null; }
                    if (TreEm6Max === void 0) { TreEm6Max = null; }
                    if (TreEm612Min === void 0) { TreEm612Min = null; }
                    if (TreEm612Max === void 0) { TreEm612Max = null; }
                    if (TreEm1218Min === void 0) { TreEm1218Min = null; }
                    if (TreEm1218Max === void 0) { TreEm1218Max = null; }
                    if (NguyHiemMax === void 0) { NguyHiemMax = null; }
                    if (NguyHiemMin === void 0) { NguyHiemMin = null; }
                    if (CoChiSoXetNghiem === void 0) { CoChiSoXetNghiem = null; }
                    if (CapDichVu === void 0) { CapDichVu = 0; }
                    if (HasChildren === void 0) { HasChildren = null; }
                    if (DichVuXetNghiemChaId === void 0) { DichVuXetNghiemChaId = null; }
                    if (HieuLuc === void 0) { HieuLuc = null; }
                    if (DichVuXetNghiemId === void 0) { DichVuXetNghiemId = null; }
                    if (IsCreateChild === void 0) { IsCreateChild = false; }
                    if (IsDelete === void 0) { IsDelete = false; }
                    if (MaKetNoi === void 0) { MaKetNoi = null; }
                    if (TenKetNoi === void 0) { TenKetNoi = null; }
                    if (TiLe === void 0) { TiLe = null; }
                    if (LoaiMauXetNghiem === void 0) { LoaiMauXetNghiem = null; }
                    if (TenLoaiMauXetNghiem === void 0) { TenLoaiMauXetNghiem = null; }
                    if (KetNoiChiSoXetNghiems === void 0) { KetNoiChiSoXetNghiems = []; }
                    this.Id = Id;
                    this.NhomDichVuBenhVienId = NhomDichVuBenhVienId;
                    this.TenCha = TenCha;
                    this.Ten = Ten;
                ...
                return ChiSoXetNghiemChiTiet;
            }());
            var ChuaCoDichVuXetNghiemViewModel = /** @class */ (function () {
                function ChuaCoDichVuXetNghiemViewModel(DichVuKyThuatBenhVienId, Ma, Ten, TenCha, TenDichVuKyThuat, CapDichVu, NhomDichVuBenhVienId, LoaiMauXetNghiem) {
                    if (DichVuKyThuatBenhVienId === void 0) { DichVuKyThuatBenhVienId = 0; }
                    if (Ma === void 0) { Ma = null; }
                    if (Ten === void 0) { Ten = null; }
                    if (TenCha === void 0) { TenCha = null; }
                    if (TenDichVuKyThuat === void 0) { TenDichVuKyThuat = null; }
                    if (CapDichVu === void 0) { CapDichVu = null; }
                    if (NhomDichVuBenhVienId === void 0) { NhomDichVuBenhVienId = null; }
                    if (LoaiMauXetNghiem === void 0) { LoaiMauXetNghiem = null; }
                    this.DichVuKyThuatBenhVienId = DichVuKyThuatBenhVienId;
                    this.Ma = Ma;
                ...
                return ChuaCoDichVuXetNghiemViewModel;
            }());
            /***/ 
        }),
...
//# sourceMappingURL=xet-nghiem-chi-so-xet-nghiem-chi-so-xet-nghiem-module-es5.js.map
//# sourceMappingURL=xet-nghiem-chi-so-xet-nghiem-chi-so-xet-nghiem-module-es5.js.map