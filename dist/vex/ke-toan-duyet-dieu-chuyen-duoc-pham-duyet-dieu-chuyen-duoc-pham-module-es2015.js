...
let DuyetDieuChuyenDuocPhamChiTietComponent = class DuyetDieuChuyenDuocPhamChiTietComponent {
    constructor(apiService, notificationService, authService, dialog, route, location) {
    ...
    TimkiemNangCao(yeuCauDieuChuyenDuocPhamId = null) {
        ...
        this.dialog.open(_nhap_xuat_duoc_pham_duyet_yeu_cau_linh_thuoc_khong_duyet_popup_khong_duyet_popup_component__WEBPACK_IMPORTED_MODULE_15__["KhongDuyetPopupComponent"], {
            ...
            if (result !== null) {
                if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Update)) {
                    this.savingPage();
                    this.apiService.post("XuatKhoDieuChuyenKhoNoiBoDuocPham/XuLyKhongDuyetDieuChuyenThuocAsync?yeuCauDieuChuyenDuocPhamId=" + this.yeuCauDieuChuyenDuocPhamId + "&lyDoKhongDuyet=" + result)
                        .subscribe(() => {
                        this.closepopupSavingData();
                        this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_10__["SystemMessage"].ActionSuccessfully, ["Không duyệt"]));
                        this.cancel();
                    }, (err) => {
...
DuyetDieuChuyenDuocPhamChiTietComponent.ctorParameters = () => [
...
let DuyetDieuChuyenDuocPhamListComponent = class DuyetDieuChuyenDuocPhamListComponent {
    ...
    xuatExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("XuatKhoDieuChuyenKhoNoiBoDuocPham/ExportDuyetYeuCauDieuChuyenThuoc", this.gridDuyetThuocChild._gridQueryInfo).subscribe(res => {
...
DuyetDieuChuyenDuocPhamListComponent.ctorParameters = () => [
...
let DuyetDieuChuyenDuocPhamRoutingModule = class DuyetDieuChuyenDuocPhamRoutingModule {
};
...
let DuyetDieuChuyenDuocPhamModule = class DuyetDieuChuyenDuocPhamModule {
};
