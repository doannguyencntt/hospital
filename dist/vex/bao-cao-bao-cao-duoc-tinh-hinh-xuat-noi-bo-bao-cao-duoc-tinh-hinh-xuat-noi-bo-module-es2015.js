...
let BaoCaoDuocTinhHinhXuatNoiBoListComponent = class BaoCaoDuocTinhHinhXuatNoiBoListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoDuocTinhHinhXuatNoiBoForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoDuocTinhHinhXuatNoiBoListComponent.ctorParameters = () => [
...
let BaoCaoDuocTinhHinhXuatNoiBoRoutingModule = class BaoCaoDuocTinhHinhXuatNoiBoRoutingModule {
};
...
class BaoCaoDuocTinhHinhXuatNoiBoSearch {
...
class InBaoCaoDuocTinhHinhXuatNoiBo {
...
let BaoCaoDuocTinhHinhXuatNoiBoModule = class BaoCaoDuocTinhHinhXuatNoiBoModule {
};
