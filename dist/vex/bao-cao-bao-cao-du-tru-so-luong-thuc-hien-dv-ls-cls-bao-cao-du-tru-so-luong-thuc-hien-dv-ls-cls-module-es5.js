...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-du-tru-so-luong-thuc-hien-dv-ls-cls-bao-cao-du-tru-so-luong-thuc-hien-dv-ls-cls-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDuTruSoLuongThucHienDvLsClsListComponent = /** @class */ (function () {
                function BaoCaoDuTruSoLuongThucHienDvLsClsListComponent(apiService, dialog, authService, notificationService) {
                ...
                BaoCaoDuTruSoLuongThucHienDvLsClsListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoDuTruSoLuongThucHienDvLsClsListComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                BaoCaoDuTruSoLuongThucHienDvLsClsListComponent.prototype.lastValueFormat = function (str) {
                    var strGroup = str.split(':');
                    if (strGroup.length != 0) {
                        return strGroup[strGroup.length];
                    }
                };
                BaoCaoDuTruSoLuongThucHienDvLsClsListComponent.prototype.xem = function (event) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Process)) {
                        if (this.baoCaoSearch.CongTyId == null || this.baoCaoSearch.HopDongId == null) {
                            this.notificationService.showError("Yêu cầu nhập công ty và hợp đồng");
                        ...
                        this.apiService.post("BaoCao/GetHTMLDuTruSoLuongNguoiThucHienDvLSCLS", this.baoCaoSearch).subscribe(function (resultData) {
                ...
                BaoCaoDuTruSoLuongThucHienDvLsClsListComponent.prototype.changeLookupHopDong = function (event) {
                ...
                BaoCaoDuTruSoLuongThucHienDvLsClsListComponent.prototype.changeCongTy = function (event) {
                    this.baoCaoSearch.CongTyId = event;
                    this.baoCaoSearch.HopDongId = null;
                    this.baoCaoSearch.Skip = 0;
                    this.setSkip();
                };
                BaoCaoDuTruSoLuongThucHienDvLsClsListComponent.prototype.setSkip = function () {
                    this.gridChild._skip = 0;
                };
                BaoCaoDuTruSoLuongThucHienDvLsClsListComponent.prototype.pageChange = function (event) {
                    this.xem(event);
                };
                return BaoCaoDuTruSoLuongThucHienDvLsClsListComponent;
            }());
            BaoCaoDuTruSoLuongThucHienDvLsClsListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDuTruSoLuongThucHienDvLsClsRoutingModule = /** @class */ (function () {
                function BaoCaoDuTruSoLuongThucHienDvLsClsRoutingModule() {
                }
                return BaoCaoDuTruSoLuongThucHienDvLsClsRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoDuTruSoLuongThucHienDVLSCLS = /** @class */ (function () {
                function BaoCaoDuTruSoLuongThucHienDVLSCLS(CongTyId, HopDongId, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                ...
                return BaoCaoDuTruSoLuongThucHienDVLSCLS;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDuTruSoLuongThucHienDvLsClsModule = /** @class */ (function () {
                function BaoCaoDuTruSoLuongThucHienDvLsClsModule() {
                }
                return BaoCaoDuTruSoLuongThucHienDvLsClsModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDuTruSoLuongThucHienDvLsClsService = /** @class */ (function (_super) {
                __extends(BaoCaoDuTruSoLuongThucHienDvLsClsService, _super);
                function BaoCaoDuTruSoLuongThucHienDvLsClsService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoDuTruSoLuongThucHienDvLsClsService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoDuTruSoLuongThucHienDvLsClsService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-du-tru-so-luong-thuc-hien-dv-ls-cls-bao-cao-du-tru-so-luong-thuc-hien-dv-ls-cls-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-du-tru-so-luong-thuc-hien-dv-ls-cls-bao-cao-du-tru-so-luong-thuc-hien-dv-ls-cls-module-es5.js.map