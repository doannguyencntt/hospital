(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-hiem-y-te-danh-sach-xuat-excel-chung-tu-danh-sach-xuat-excel-chung-tu-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachXuatChungTuExcelRoutingModule = /** @class */ (function () {
                function DanhSachXuatChungTuExcelRoutingModule() {
                }
                return DanhSachXuatChungTuExcelRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachXuatChungTuExcelModule = /** @class */ (function () {
                function DanhSachXuatChungTuExcelModule() {
                }
                return DanhSachXuatChungTuExcelModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ExcelChungTuQueryInfo = /** @class */ (function () {
                function ExcelChungTuQueryInfo(LoaiChungTu, YeuCauTiepNhanIds, MaYeuCauTiepNhans, ThongTinYeuCauTiepNhans) {
                    if (LoaiChungTu === void 0) { LoaiChungTu = null; }
                    if (YeuCauTiepNhanIds === void 0) { YeuCauTiepNhanIds = []; }
                    if (MaYeuCauTiepNhans === void 0) { MaYeuCauTiepNhans = []; }
                    if (ThongTinYeuCauTiepNhans === void 0) { ThongTinYeuCauTiepNhans = []; }
                ...
                return ExcelChungTuQueryInfo;
            }());
            var ThongTinYeuCauTiepNhans = /** @class */ (function () {
                function ThongTinYeuCauTiepNhans(YeuCauTiepNhanNoiTruId, MaYeuCauTiepNhan, YeuCauTiepNhanNgoaiTruId) {
                    if (YeuCauTiepNhanNoiTruId === void 0) { YeuCauTiepNhanNoiTruId = null; }
                    if (MaYeuCauTiepNhan === void 0) { MaYeuCauTiepNhan = null; }
                    if (YeuCauTiepNhanNgoaiTruId === void 0) { YeuCauTiepNhanNgoaiTruId = null; }
                ...
                return ThongTinYeuCauTiepNhans;
            }());
            var TimKiemThongTinBenhNhanXuatExcelChungTu = /** @class */ (function () {
                function TimKiemThongTinBenhNhanXuatExcelChungTu(LoaiChungTu, TuNgay, DenNgay, FromDate, ToDate, TimKiem, SearchString) {
                    if (LoaiChungTu === void 0) { LoaiChungTu = null; }
                ...
                return TimKiemThongTinBenhNhanXuatExcelChungTu;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachXuatChungTuExcelComponent = /** @class */ (function () {
                function DanhSachXuatChungTuExcelComponent(route, router, dialog, apiService, authService, location, notificationService) {
                    this.route = route;
                    this.router = router;
                    this.dialog = dialog;
                ...
                DanhSachXuatChungTuExcelComponent.prototype.ngOnInit = function () {
                ...
                DanhSachXuatChungTuExcelComponent.prototype.backWithSearch = function () {
                ...
                DanhSachXuatChungTuExcelComponent.prototype.closeMenu = function () {
                    this.trigger.closeMenu();
                };
                DanhSachXuatChungTuExcelComponent.prototype.timKiemNangCao = function () {
                ...
                DanhSachXuatChungTuExcelComponent.prototype.searchChanges = function (event) {
                    var self = this;
                ...
                DanhSachXuatChungTuExcelComponent.prototype.timKiemNguoiBenh = function () {
                };
                DanhSachXuatChungTuExcelComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiemNangCao();
                    }
                };
                DanhSachXuatChungTuExcelComponent.prototype.extCheckboxSelection = function (data) {
                    this.mySelection = [];
                    this.mySelection = data;
                };
                DanhSachXuatChungTuExcelComponent.prototype.onDataBoundGrid = function (event) {
                    if (event != undefined && event != null && event.Data.length > 0) {
                        this.dataSource.data = event.Data;
                    }
                };
                DanhSachXuatChungTuExcelComponent.prototype.taiChungTuNguoiBenh = function () {
                    var _this = this;
                    if (this.timKiemDSBaoHiemYTe.LoaiChungTu === undefined || this.timKiemDSBaoHiemYTe.LoaiChungTu === null) {
                        this.notificationService.showError("Vui lòng chọn chứng từ.");
                        return true;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].Process)) {
                        ...
                        if (this.mySelection.length === 0) {
                            ...
                            this.mySelection.forEach(function (yeuCauTiepNhanId) {
                                _this.thongTinXuatExcelChungTu.YeuCauTiepNhanIds.push(yeuCauTiepNhanId);
                                _this.dataSource.data.forEach(function (element) {
                                    if (element.Id === yeuCauTiepNhanId) {
                                        var thongTinYeuCauTiepNhans = new _danh_sach_xuat_excel_chung_tu__WEBPACK_IMPORTED_MODULE_21__["ThongTinYeuCauTiepNhans"]();
                                        ...
                                        _this.thongTinXuatExcelChungTu.ThongTinYeuCauTiepNhans.push(thongTinYeuCauTiepNhans);
                                    }
                                });
                            });
                ...
                DanhSachXuatChungTuExcelComponent.prototype.showPopupLoadingData = function () {
                ...
                DanhSachXuatChungTuExcelComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                DanhSachXuatChungTuExcelComponent.prototype.view = function (idNoiTru, idNgoaiTru) {
                    var _this = this;
                    if (this.timKiemDSBaoHiemYTe.LoaiChungTu != null) {
                        switch (this.timKiemDSBaoHiemYTe.LoaiChungTu) {
                            case _danh_sach_xuat_excel_chung_tu__WEBPACK_IMPORTED_MODULE_21__["LoaiChungTu"].GiayRaVien:
                                ...
                                this.apiService.post("BHYT/GetIdPhieuNoiTruHoSoKhac?id=" + idNoiTru + "&loai=" + 28).subscribe(function (resDataId) {
                                    if (resDataId != undefined && resDataId != null) {
                                        _this.apiService.post("DieuTriNoiTru/InGiayRaVien?noiTruHoSoKhacId=" + resDataId).subscribe(function (resData) {
                                            if (resData != undefined && resData != null) {
                                                showDialog.close();
                                                _this.dialog.open(_dieu_tri_noi_tru_danh_sach_dieu_tri_noi_tru_ho_so_khac_bien_ban_gay_me_popup_bien_ban_gay_me_popup_component__WEBPACK_IMPORTED_MODULE_25__["BienBanGayMePopupComponent"], {
                                                    disableClose: false,
                                                    width: '1200px',
                            ...
                            case _danh_sach_xuat_excel_chung_tu__WEBPACK_IMPORTED_MODULE_21__["LoaiChungTu"].GiayNghiHuongBHXH:
                                ...
                                this.apiService.post("DieuTriNoiTru/InGiayChungNhanNghiViecHuongBHXHNgoaTruVaNoTru", voBHXH).subscribe(function (result) {
                                    _this.dialog.open(_dieu_tri_noi_tru_danh_sach_dieu_tri_noi_tru_ho_so_khac_chung_nhan_nghi_viec_huong_bhxh_chung_nhan_nghi_viec_hbhxh_popup_chung_nhan_nghi_viec_hbhxh_popup_component__WEBPACK_IMPORTED_MODULE_23__["ChungNhanNghiViecHbhxhPopupComponent"], {
                                        disableClose: true,
                                        width: '1200px',
                                        data: { Model: result }
                                    }).afterClosed().subscribe(function () {
                            ...
                            case _danh_sach_xuat_excel_chung_tu__WEBPACK_IMPORTED_MODULE_21__["LoaiChungTu"].GiayNghiDuongThai:
                                ...
                                this.apiService.post("DieuTriNoiTru/InTatCaGiayNghiDuongThai", vo).subscribe(function (result) {
                                    _this.dialog.open(_dieu_tri_noi_tru_danh_sach_dieu_tri_noi_tru_ho_so_khac_giay_nghi_duong_thai_noi_tru_giay_nghi_duong_thai_noi_tru_popup_giay_nghi_duong_thai_noi_tru_popup_component__WEBPACK_IMPORTED_MODULE_26__["GiayNghiDuongThaiNoiTruPopupComponent"], {
                                        disableClose: true,
                                        width: '750px',
                                        data: { Model: result }
                                    }).afterClosed().subscribe(function () {
                            ...
                            case _danh_sach_xuat_excel_chung_tu__WEBPACK_IMPORTED_MODULE_21__["LoaiChungTu"].TomTatBenhAn:
                                ...
                                this.dialog.open(_dieu_tri_noi_tru_danh_sach_dieu_tri_noi_tru_ho_so_khac_tom_tat_ho_so_ba_popup_tom_tat_ho_so_ba_popup_component__WEBPACK_IMPORTED_MODULE_24__["TomTatHoSoBenhAnPopupComponent"], {
                                    disableClose: false,
                                    width: '1200px',
                                    data: { yeuCauTiepNhanId: yeuCauTiepNhanId }
                                }).afterClosed().subscribe(function () { });
                                break;
                            case _danh_sach_xuat_excel_chung_tu__WEBPACK_IMPORTED_MODULE_21__["LoaiChungTu"].GiayChungSinh:
                                ...
                                this.apiService.post("DieuTriNoiTru/InGiayChungSinhTatCa", { NoiTruHoSoKhacId: idNoiTru, Hosting: hot }).subscribe(function (resData) {
                                    if (resData != undefined && resData != null) {
                                        showDialog.close();
                                        _this.dialog.open(_dieu_tri_noi_tru_danh_sach_dieu_tri_noi_tru_ho_so_khac_giay_chung_sinh_popup_giay_chung_sinh_popup_component__WEBPACK_IMPORTED_MODULE_22__["GiayChungSinhPopupComponent"], {
                                            disableClose: false,
                                            width: '1200px',
                ...
                DanhSachXuatChungTuExcelComponent.prototype.changeLoaiChungTu = function (event) {
                    this.timKiemNangCao();
                };
                return DanhSachXuatChungTuExcelComponent;
            }());
            DanhSachXuatChungTuExcelComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-hiem-y-te-danh-sach-xuat-excel-chung-tu-danh-sach-xuat-excel-chung-tu-module-es5.js.map
//# sourceMappingURL=bao-hiem-y-te-danh-sach-xuat-excel-chung-tu-danh-sach-xuat-excel-chung-tu-module-es5.js.map