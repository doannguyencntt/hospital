...
let DuocPhamSapHetHanListComponent = class DuocPhamSapHetHanListComponent {
    ...
    GetValue() {
        ...
        this.apiService.post("DuocPhamSapHetHan/CheckCaoDuocPhamSapHetHan?search=" + queryString).subscribe(resultData => {
    ...
    KhoChange(khoDuocPhamId) {
        this.searchInfo.KhoId = khoDuocPhamId == undefined ? 0 : khoDuocPhamId;
        this.searchTonKho();
    }
    Gui() {
        let dialogRef = this.dialog.open(_duoc_pham_sap_het_han_popup_xem_duoc_pham_sap_het_han_popup_xem_component__WEBPACK_IMPORTED_MODULE_21__["DuocPhamSapHetHanPopupXemComponent"], {
            //disableClose: true,
            width: '1500px',
            // height: '500px',
    ...
    getSharedPrintForm() {
        ...
        return new Promise(resolve => {
            this.apiService.get("DuocPhamSapHetHan/InBaoCaoDuocPhamSapHetHan?search=" + queryString).subscribe(resultData => {
                resolve(resultData);
            });
        });
    }
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_23__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("DuocPhamSapHetHan/ExportDuocPhamSapHetHan", this.gridChild._gridQueryInfo).subscribe(res => {
...
DuocPhamSapHetHanListComponent.ctorParameters = () => [
...
let DuocPhamSapHetHanPopupXemComponent = class DuocPhamSapHetHanPopupXemComponent {
    ...
    GetValue() {
        ...
        let queryString = "{\"KhoId\":" + KhoQueryString + ",\"DuocPham\":" + SearchQueryString + "}";
        this.apiService.post("DuocPhamSapHetHan/GetDuocPhamSapHetHan?search=" + queryString).subscribe(resultData => {
    ...
    GetHTML() {
        ...
        let queryString = "{\"KhoId\":" + KhoQueryString + ",\"DuocPham\":" + SearchQueryString + "}";
        this.apiService.post("DuocPhamSapHetHan/GetHTML?search=" + queryString).subscribe(resultData => {
            if (resultData != null) {
                var html = resultData;
                $(".a").show();
                $(".showPdf").append(html);
...
DuocPhamSapHetHanPopupXemComponent.ctorParameters = () => [
...
let DuocPhamSapHetHanRoutingModule = class DuocPhamSapHetHanRoutingModule {
};
...
class DuocPhamSapHetHan {
}
class searchDuocPhamSapHetHan {
    constructor(KhoId = null, TenKho = null, searchString = null) {
        this.KhoId = KhoId;
        this.TenKho = TenKho;
...
let DuocPhamSapHetHanModule = class DuocPhamSapHetHanModule {
};
...
let DuocPhamSapHetHanService = class DuocPhamSapHetHanService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DuocPhamSapHetHan';
    }
};
DuocPhamSapHetHanService.ctorParameters = () => [
