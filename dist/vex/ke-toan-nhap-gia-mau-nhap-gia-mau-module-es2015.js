...
let NhapGiaMauDetailComponent = class NhapGiaMauDetailComponent {
    constructor(apiService, route, notificationService, authService, dialog, location) {
    ...
    getById(id) {
        ...
        this.apiService.get("NhapKhoMau/GetDuyetPhieuNhapKhoMau?id=" + id)
            ...
            if (resultData !== undefined && resultData != null) {
                ...
                this.trangThai = new _nhap_xuat_mau_mau_model__WEBPACK_IMPORTED_MODULE_14__["TrangThaiDuyetNhapKhoMau"](this.phieuNhapKhoMau.TenTrangThai, this.phieuNhapKhoMau.DuocKeToanDuyet);
        ...
        if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
            this.dialog
                ...
                if (result == "Yes") {
                    ...
                    this.apiService.put("NhapKhoMau/XuLyNhapGiaMau", this.phieuNhapKhoMau).subscribe(res => {
                        this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, [mess]));
                        this.closePopupLoadingData();
                        this.huy();
                    }, err => {
...
NhapGiaMauDetailComponent.ctorParameters = () => [
...
let NhapGiaMauListComponent = class NhapGiaMauListComponent {
...
NhapGiaMauListComponent.ctorParameters = () => [
...
let NhapGiaMauRoutingModule = class NhapGiaMauRoutingModule {
};
...
class DuyetPhieuNhapKhoMau {
    constructor(SoPhieu = null, SoHoaDon = null, KyHieuHoaDon = null, NgayHoaDon = null, LoaiNguoiGiao = 1, NguoiGiaoId = null, TenNguoiGiao = null, NhaThauId = null, TenNhaThau = null, NgayNhap = null, NguoiNhapId = null, TenNguoiNhap = null, DuocKeToanDuyet = null, TenTrangThai = null, NgayDuyet = null, NhanVienDuyetId = null, GhiChu = null, LastModified = null, DuyetNhapKhoMauChiTiets = new Array()) {
...
class DuyetNhapKhoMauChiTiet {
    constructor(MauVaChePhamId = null, TenMauVaChePham = null, MaTuiMau = null, NgaySanXuat = null, HanSuDung = null, DonGiaNhap = null, DonGiaBan = null, DonGiaBaoHiem = null, IsThanhToan = false) {
...
let NhapGiaMauModule = class NhapGiaMauModule {
};
