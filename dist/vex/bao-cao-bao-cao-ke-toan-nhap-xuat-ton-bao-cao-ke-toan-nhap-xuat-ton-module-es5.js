(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-ke-toan-nhap-xuat-ton-bao-cao-ke-toan-nhap-xuat-ton-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKeToanNhapXuatTonRoutingModule = /** @class */ (function () {
                function BaoCaoKeToanNhapXuatTonRoutingModule() {
                }
                return BaoCaoKeToanNhapXuatTonRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKeToanNhapXuatTonChiTietSearch = /** @class */ (function () {
                function BaoCaoKeToanNhapXuatTonChiTietSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, KhoaPhongId, 
                // public KhoId: number = null,
                CoVAT, CoThuoc, CoVTYT, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                    ...
                    if (CoVAT === void 0) { CoVAT = true; }
                    if (CoThuoc === void 0) { CoThuoc = true; }
                    if (CoVTYT === void 0) { CoVTYT = true; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKeToanNhapXuatTonModule = /** @class */ (function () {
                function BaoCaoKeToanNhapXuatTonModule() {
                }
                return BaoCaoKeToanNhapXuatTonModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoKeToanNhapXuatTonListComponent = /** @class */ (function () {
                function BaoCaoKeToanNhapXuatTonListComponent(apiService, dialog, authService, notificationService, cd) {
                ...
                BaoCaoKeToanNhapXuatTonListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoKeToanNhapXuatTonListComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoKeToanNhapXuatTonListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoKeToanNhapXuatTonListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoKeToanNhapXuatTonListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoKeToanNhapXuatTonListComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoKeToanNhapXuatTonListComponent.prototype.getSumThanhTien = function (value) {
                    if (this.gridView && value) {
                        return value.sum;
                    }
                };
                BaoCaoKeToanNhapXuatTonListComponent.prototype.totalThanhTien = function (field) {
                    switch (field) {
                ...
                ;
                BaoCaoKeToanNhapXuatTonListComponent.prototype.pageChange = function (event) {
                    this.baoCaoSearch.Skip = event.skip;
                    this.skip = event.skip;
                    this.XemBaoCao();
                };
                BaoCaoKeToanNhapXuatTonListComponent.prototype.changeKhoa = function (event) {
                ...
                BaoCaoKeToanNhapXuatTonListComponent.prototype.changeKho = function (event) {
                ...
                BaoCaoKeToanNhapXuatTonListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetDataBaoCaoKTNhapXuatTonChiTietForGridAsync", this.baoCaoSearch).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            ...
                            _this.gridView = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_11__["process"])(resultData.Data, { group: _this.groups });
                            _this._isLoading = false;
                            _this._isLoadingTotalPage = false;
                        }
                    });
                };
                BaoCaoKeToanNhapXuatTonListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                return BaoCaoKeToanNhapXuatTonListComponent;
            }());
            BaoCaoKeToanNhapXuatTonListComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-ke-toan-nhap-xuat-ton-bao-cao-ke-toan-nhap-xuat-ton-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-ke-toan-nhap-xuat-ton-bao-cao-ke-toan-nhap-xuat-ton-module-es5.js.map