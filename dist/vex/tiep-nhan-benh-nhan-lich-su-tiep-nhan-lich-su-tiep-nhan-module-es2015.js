...
let LichSuTaiKhamComponent = class LichSuTaiKhamComponent {
    constructor() {
        this.gridColumns = [];
...
let LichSuTiepNhanChiTietComponent = class LichSuTiepNhanChiTietComponent {
    constructor(apiService, router, cdRef, route, dialog, location) {
    ...
    getBenhNhan(id) {
        ...
        this.apiService.post("TiepNhanBenhNhan/GetYeuCauKhamBenh?id=" + id).subscribe(resultData => {
            ...
            var ngaySinh = Object(_progress_kendo_angular_intl__WEBPACK_IMPORTED_MODULE_15__["parseDate"])(this.tiepNhanBenhNhan.NgayThangNamSinh);
            if (ngaySinh != null) {
            ...
            if (resultData.BHYTNgayHieuLuc != null && resultData.BHYTNgayHieuLuc != undefined) {
                ...
                this.tiepNhanBenhNhan.NgayCoHieuLucDisplay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_5__["CommonService"].formatDate(ngayCoHieuLuc, "dd/mm/yyyy");
            }
            if (resultData.BHYTNgayHetHan != null && resultData.BHYTNgayHetHan != undefined) {
                let ngayHetHan = new Date(resultData.BHYTNgayHetHan);
                this.tiepNhanBenhNhan.NgayHetHieuLucDisplay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_5__["CommonService"].formatDate(ngayHetHan, "dd/mm/yyyy");
            }
            if (resultData.BHYTNgayDu5Nam != null && resultData.BHYTNgayDu5Nam != undefined) {
                let ngayDu5Nam = new Date(resultData.BHYTNgayDu5Nam);
                this.tiepNhanBenhNhan.NgayDu5NamDisplay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_5__["CommonService"].formatDate(ngayDu5Nam, "dd/mm/yyyy");
            }
            ...
            if (resultData.BaoHiemTuNhans != undefined && resultData.BaoHiemTuNhans != null) {
                resultData.BaoHiemTuNhans.forEach(item => {
                    let model = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_4__["ThemBaoHiemTuNhanGridVo"]();
                    model.Id = item.Id;
            ...
            if (this.tiepNhanBenhNhan.IsCheckedBHYT) {
                ...
                this.tiepNhanBenhNhan.TinhTrangThe = src_app_shared_enum_tinh_trang_the_enum__WEBPACK_IMPORTED_MODULE_6__["TinhTrangThe"].KhongXacDinh;
            }
            this.setDuocHuongBHYT(this.tiepNhanBenhNhan.CoBHYT, this.tiepNhanBenhNhan.LyDoVaoVien);
    ...
    setDataForDichVuKhac() {
        ...
        arrayNhomGoiCoChietKhau.forEach(e => {
            ...
            this.gridDataKhacCoChietKhauArray.push(Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_7__["process"])(resultArray, this.stateKhamBenh));
        });
    ...
    updateBHTN() {
        ...
        this.lstBHTN.forEach(obj => {
            let model = new _tiep_nhan_benh_nhan_model__WEBPACK_IMPORTED_MODULE_4__["BaoHiemTuNhanViewModel"]();
            model.Id = obj.Id;
...
LichSuTiepNhanChiTietComponent.ctorParameters = () => [
...
let LichSuTiepNhanListComponent = class LichSuTiepNhanListComponent {
    constructor(authService, router, notificationService, dialog, apiService, location, route) {
    ...
    InHoSoLichSuKhamBenh(id, laPhieuKhamBenh) {
        // this.dialog
    ...
    XuatExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_22__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("LichSuTiepNhan/ExportLichSuTiepNhan", this.gridChild._gridQueryInfo).subscribe(res => {
...
LichSuTiepNhanListComponent.ctorParameters = () => [
...
let LichSuTiepNhanPopupComponent = class LichSuTiepNhanPopupComponent {
    ...
    getALlFilePDFFromHtml(arrHtml) {
        ...
        this.apiService.postExportPdf('KhamBenh/GetFilePDFFromHtmls', obj).subscribe(file => {
...
LichSuTiepNhanPopupComponent.ctorParameters = () => [
...
let LichSuTiepNhanRoutingModule = class LichSuTiepNhanRoutingModule {
};
...
class LichSuTiepNhan {
    constructor(DoiTuongId = null, DoiTuongBHYT = null, DoiTuong = null, TenBenh = null, BenhNhanId = null, HoTen = null, NamSinh = null, DiaChi = null, BhytmaSoThe = null, MaYeuCauTiepNhan = null, ThoiDiemTiepNhan = null, ThoiDiemTiepNhanTuFormat = null, ThoiDiemTiepNhanDenFormat = null, ThoiDiemTiepNhanTu = null, ThoiDiemTiepNhanDen = null, NhanVienTiepNhanId = null, NoiTiepNhanId = null, TrieuChungId = null, TrieuChungTiepNhan = null, TrangThaiYeuCauTiepNhan = null, ThoiDiemCapNhatTrangThai = null, SearchString = null) {
...
let LichSuTiepNhanModule = class LichSuTiepNhanModule {
};
...
let LichSuTiepNhanService = class LichSuTiepNhanService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'LichSuTiepNhan';
    }
};
LichSuTiepNhanService.ctorParameters = () => [
...
let InBangKeChiPhiLSKhamBenhComponent = class InBangKeChiPhiLSKhamBenhComponent {
...
InBangKeChiPhiLSKhamBenhComponent.ctorParameters = () => [
