...
let QuaTangCreateComponent = class QuaTangCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
QuaTangCreateComponent.ctorParameters = () => [
...
let QuaTangListComponent = class QuaTangListComponent {
    constructor(authService, notificationService, apiService, dialog) {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("QuaTang/ExportQuaTang", this.gridChild._gridQueryInfo).subscribe(res => {
...
QuaTangListComponent.ctorParameters = () => [
...
let QuaTangRoutingModule = class QuaTangRoutingModule {
};
...
let QuaTangSharedComponent = class QuaTangSharedComponent {
    constructor(route, router, baseService, notificationService) {
        this.route = route;
        this.router = router;
...
QuaTangSharedComponent.ctorParameters = () => [
...
let QuaTangUpdateComponent = class QuaTangUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
QuaTangUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_qua_tang_shared_qua_tang_shared_component__WEBPACK_IMPORTED_MODULE_3__["QuaTangSharedComponent"], { static: true })
...
let QuaTangModule = class QuaTangModule {
};
...
let QuaTangService = class QuaTangService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'QuaTang';
    }
};
QuaTangService.ctorParameters = () => [
