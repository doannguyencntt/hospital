...
let NhomChucDanhCreateComponent = class NhomChucDanhCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
NhomChucDanhCreateComponent.ctorParameters = () => [
...
let NhomChucDanhListComponent = class NhomChucDanhListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("NhomChucDanh/ExportNhomChucDanh", this.gridChild._gridQueryInfo).subscribe(res => {
...
NhomChucDanhListComponent.ctorParameters = () => [
...
let NhomChucDanhRoutingModule = class NhomChucDanhRoutingModule {
};
...
let NhomChucDanhSharedComponent = class NhomChucDanhSharedComponent {
...
NhomChucDanhSharedComponent.ctorParameters = () => [
...
let NhomChucDanhUpdateComponent = class NhomChucDanhUpdateComponent {
...
NhomChucDanhUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let NhomChucDanhModule = class NhomChucDanhModule {
};
...
let NhomChucDanhService = class NhomChucDanhService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'NhomChucDanh';
    }
};
NhomChucDanhService.ctorParameters = () => [
