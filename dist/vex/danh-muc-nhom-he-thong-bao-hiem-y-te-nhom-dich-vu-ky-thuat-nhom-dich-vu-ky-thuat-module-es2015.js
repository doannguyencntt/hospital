...
let NhomDichVuKyThuatListComponent = class NhomDichVuKyThuatListComponent {
    ...
    iconClass({ text, NhomDichVuKyThuatChildren }) {
        return {
    ...
    ngOnInit() {
        ...
        this.baseService.getDataForGrid(this._gridQueryInfo, "NhomDichVuKyThuat/GetDataTreeView").subscribe((resultData) => {
...
NhomDichVuKyThuatListComponent.ctorParameters = () => [
...
let NhomDichVuKyThuatRoutingModule = class NhomDichVuKyThuatRoutingModule {
};
...
let NhomDichVuKyThuatModule = class NhomDichVuKyThuatModule {
};
...
let NhomDichVuKyThuatService = class NhomDichVuKyThuatService extends _app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'NhomDichVuKyThuat';
    }
};
NhomDichVuKyThuatService.ctorParameters = () => [
