(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-tu-dien-dich-vu-ky-thuat-tu-dien-dich-vu-ky-thuat-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TuDienDichVuKyThuatRoutingModule = /** @class */ (function () {
                function TuDienDichVuKyThuatRoutingModule() {
                }
                return TuDienDichVuKyThuatRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TuDienDichVuKyThuatSharedComponent = /** @class */ (function () {
                function TuDienDichVuKyThuatSharedComponent() {
                ...
                TuDienDichVuKyThuatSharedComponent.prototype.ngOnInit = function () {
                ...
                TuDienDichVuKyThuatSharedComponent.prototype.ngOnChanges = function (value) {
                    if (value.data != null) {
                        this.dichVuKyThuatChiTiet = value.data.currentValue;
                    }
                };
                TuDienDichVuKyThuatSharedComponent.prototype.huyDichVuKyThuat = function () {
                ...
                TuDienDichVuKyThuatSharedComponent.prototype.getSharedData = function () {
                    return this.dichVuKyThuatChiTiet;
                };
                return TuDienDichVuKyThuatSharedComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var DanhSachKyThuat = /** @class */ (function () {
                function DanhSachKyThuat(Id, IdCap, Ma, Ten, TenCha, DichVuXetNghiemChaId, DichVuKyThuatId, NhomDichVuBenhVienId, DichVuXetNghiemId, CapDichVu, MoTa, SearchString, SearchTermString, Loai, CoChiSoXetNghiem) {
                    if (Id === void 0) { Id = 0; }
            ...
            var DichVuKyThuatChiTiet = /** @class */ (function () {
                function DichVuKyThuatChiTiet(Id, NhomDichVuBenhVienId, TenCha, Ten, Ma, MaLIS, DichVuKyThuatBenhVienId, TenDichVuKyThuat, TenKetQuaMau, MaSo, UserLoginId, TenUserLogin, KetQua, KetLuan) {
                    if (Id === void 0) { Id = 0; }
                    ...
                    if (TenKetQuaMau === void 0) { TenKetQuaMau = null; }
                    if (MaSo === void 0) { MaSo = null; }
                    if (UserLoginId === void 0) { UserLoginId = null; }
                    if (TenUserLogin === void 0) { TenUserLogin = null; }
                    if (KetQua === void 0) { KetQua = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TuDienDichVuKyThuatModule = /** @class */ (function () {
                function TuDienDichVuKyThuatModule() {
                }
                return TuDienDichVuKyThuatModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TuDienDichVuKyThuatListComponent = /** @class */ (function () {
                function TuDienDichVuKyThuatListComponent(baseService, apiService, authService, notificationService, ref, dialog) {
                    var _this = this;
                ...
                TuDienDichVuKyThuatListComponent.prototype.iconClassConTextMenu = function (_a) {
                    var text = _a.text, items = _a.items;
                    return {
                        icon: 'plus',
                    };
                };
                TuDienDichVuKyThuatListComponent.prototype.expandLogic = function (dataItem, isDefault) {
                    var _this = this;
                ...
                TuDienDichVuKyThuatListComponent.prototype.fetchChiSoXetNghiem = function (dataItem) {
                ...
                TuDienDichVuKyThuatListComponent.prototype.iconClass = function (dataItem) {
                    return {
                        'k-i-folder': dataItem.HasChildren == true,
                        'k-icon': true
                    };
                };
                TuDienDichVuKyThuatListComponent.prototype.ngOnInit = function () {
                ...
                TuDienDichVuKyThuatListComponent.prototype.ngAfterContentInit = function () {
                    setTimeout(function () {
                ...
                TuDienDichVuKyThuatListComponent.prototype.getDataTreeView = function () {
                    var _this = this;
                ...
                TuDienDichVuKyThuatListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                TuDienDichVuKyThuatListComponent.prototype.timKiem = function () {
                    var _this = this;
                ...
                TuDienDichVuKyThuatListComponent.prototype.loadingPage = function () {
                ...
                TuDienDichVuKyThuatListComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TuDienDichVuKyThuatListComponent.prototype.addingPage = function () {
                ...
                TuDienDichVuKyThuatListComponent.prototype.closePopupAddingData = function () {
                    if (this.popupAddingData != undefined && this.popupAddingData != null) {
                        this.popupAddingData.close();
                    }
                };
                TuDienDichVuKyThuatListComponent.prototype.savingPage = function () {
                ...
                TuDienDichVuKyThuatListComponent.prototype.closePopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                TuDienDichVuKyThuatListComponent.prototype.searchChanges = function (dataItem) {
                ...
                TuDienDichVuKyThuatListComponent.prototype.expand = function (dataItem) {
                ...
                TuDienDichVuKyThuatListComponent.prototype.getInfo = function (dataItem) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].View)) {
                        this.apiService.post("TuDienDichVuKyThuat/GetDichVuKyThuats?dichVuKyThuatBenhVienId=" + dataItem.Id).subscribe(function (resultData) {
                            if (resultData != undefined && resultData != null) {
                                _this.dichVuKyThuatChiTiet = resultData;
                            }
                        }, function (err) {
                ...
                ///////////////////////////////////////////////////// CLICK  <=======
                TuDienDichVuKyThuatListComponent.prototype.onLeftClick = function (event, dataItem) {
                    if (event.type === "click") {
                ...
                TuDienDichVuKyThuatListComponent.prototype.reLoad = function () {
                    var _this = this;
                    this.baseService.getDataForGrid(this.gridQueryInfo, "TuDienDichVuKyThuat/GetDataTreeView")
                        .subscribe(function (resultData) {
                        _this.data = resultData;
                ...
                TuDienDichVuKyThuatListComponent.prototype.cancel = function () {
                ...
                TuDienDichVuKyThuatListComponent.prototype.luuDichVukyThuatBenhVienMauKetQua = function () {
                    var self = this;
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_18__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            self.apiService.post("TuDienDichVuKyThuat/LuuDichVukyThuatBenhVienMauKetQua", self.dichVuKyThuatChiTiet).subscribe(function () {
                ...
                TuDienDichVuKyThuatListComponent.prototype.keyEvent = function (event) {
                ...
                return TuDienDichVuKyThuatListComponent;
            }());
            TuDienDichVuKyThuatListComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-tu-dien-dich-vu-ky-thuat-tu-dien-dich-vu-ky-thuat-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-tu-dien-dich-vu-ky-thuat-tu-dien-dich-vu-ky-thuat-module-es5.js.map