...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-lich-phan-cong-lich-phan-cong-ngoai-tru-lich-phan-cong-ngoai-tru-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichPhanCongNgoaiTruPdfComponent = /** @class */ (function () {
                function LichPhanCongNgoaiTruPdfComponent() {
                }
                LichPhanCongNgoaiTruPdfComponent.prototype.ngOnInit = function () {
                };
                return LichPhanCongNgoaiTruPdfComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichPhanCongNgoaiTruRoutingModule = /** @class */ (function () {
                function LichPhanCongNgoaiTruRoutingModule() {
                }
                return LichPhanCongNgoaiTruRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichPhanCongNgoaiTruTheoThangComponent = /** @class */ (function () {
                function LichPhanCongNgoaiTruTheoThangComponent(intl, apiService, router, authService, notificationService) {
                    this.intl = intl;
                ...
                LichPhanCongNgoaiTruTheoThangComponent.prototype.ngOnInit = function () {
                ...
                LichPhanCongNgoaiTruTheoThangComponent.prototype.getDataTuanAsync = function (date) {
                    var _this = this;
                    var dateRequest = this.intl.formatDate(date, "yyyy-MM-dd");
                    this.apiService.post("LichPhanCongNgoaiTru/GetDataTuanAsync?date=" + dateRequest).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            if (_this.groups != null) {
                                var d = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_8__["process"])(resultData.Data, { group: _this.groups });
                                if (d != null) {
                                    d.total = resultData.TotalRowCount;
                                    _this.gridDataSource = d;
                                }
                                else {
                ...
                LichPhanCongNgoaiTruTheoThangComponent.prototype.getListKhoaPhongXepLich = function (date, khoaId) {
                    var _this = this;
                    var dateRequest = this.intl.formatDate(date, "yyyy-MM-dd");
                    this.apiService.post("LichPhanCongNgoaiTru/GetListKhoaPhongXepLich?date=" + dateRequest + "&&khoaId=" + khoaId)
                        .subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            _this.listKhoaPhongXepLich = resultData;
                        }
                    }, function () {
                    });
                };
                LichPhanCongNgoaiTruTheoThangComponent.prototype.formatDateLink = function (date) {
                ...
                LichPhanCongNgoaiTruTheoThangComponent.prototype.changeMonthLink = function (event) {
                ...
                LichPhanCongNgoaiTruTheoThangComponent.prototype.onSelectKhoaPhong = function (event) {
                    if (event !== undefined) {
                ...
                LichPhanCongNgoaiTruTheoThangComponent.prototype.prevMonthLink = function () {
                    this.monthLinkValue = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_6__["addMonths"])(this.monthLinkValue, -1);
                    this.monthLinkText = this.formatMonthLink(this.monthLinkValue);
                    this.getDataTuanAsync(this.monthLinkValue);
                    this.getListKhoaPhongXepLich(this.monthLinkValue, this.idKhoaPhong);
                };
                LichPhanCongNgoaiTruTheoThangComponent.prototype.nextMonthLink = function () {
                    this.monthLinkValue = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_6__["addMonths"])(this.monthLinkValue, 1);
                    this.monthLinkText = this.formatMonthLink(this.monthLinkValue);
                    this.getDataTuanAsync(this.monthLinkValue);
                    this.getListKhoaPhongXepLich(this.monthLinkValue, this.idKhoaPhong);
                };
                LichPhanCongNgoaiTruTheoThangComponent.prototype.formatMonthLink = function (date) {
                    return "Tháng <strong>" + (date.getMonth() + 1) + "/" + date.getFullYear();
                };
                LichPhanCongNgoaiTruTheoThangComponent.prototype.getDataTuan = function () {
                    this.weeks = this.gridDataSource.data;
                };
                LichPhanCongNgoaiTruTheoThangComponent.prototype.xepLich = function (type, item) {
                ...
                LichPhanCongNgoaiTruTheoThangComponent.prototype.xemChiTietLich = function (type, item) {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Add)) {
                        if (type === 1) {
                            this.router.navigate(["danh-muc/lich-phan-cong/ngoai-tru/xep-lich/" + item.IdKhoa + "/" + item.NgayStartTuan1.slice(0, 10)]);
                        }
                ...
                return LichPhanCongNgoaiTruTheoThangComponent;
            }());
            LichPhanCongNgoaiTruTheoThangComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichPhanCongNgoaiTruTheoTuanComponent = /** @class */ (function () {
                function LichPhanCongNgoaiTruTheoTuanComponent(renderer, route, elem, authService, apiService, intl, dialog, notificationService, cdRef) {
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.ngOnInit = function () {
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                    if (this.height == null) {
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.getById = function (id) {
                    var _this = this;
                    ...
                    this.apiService.post("LichPhanCongNgoaiTru/GetPhongByKhoaId?KhoaPhongId=" + id + "&&fromDate=" + fromDate + "&&toDate=" + toDate).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.tenkhoaphongparams = "Xếp Lịch " + resultData[0].TenKhoa;
                            _this.phongs = resultData;
                            _this.setDateTimeDayInWeek(_this.showDateTime, _this.dateLinkValue);
                            _this.setdataView(_this.phongs);
                            _this.ngAfterContentInit();
                            _this.IsShowGirpView = true;
                        }
                        else {
                            _this.strPhongNotExists = "không tìm thấy phòng để xếp lịch phân công";
                        }
                    }, function () { });
                };
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.resizeKendoGird = function () {
                    var elements = this.elem.nativeElement.querySelector('tbody > tr');
                    elements.style = "";
                };
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.RemovePosition = function (modelNVTruc, itemIndex, phongTruc) {
                    this.validationErrors = [];
                    var last = modelNVTruc.slice(itemIndex)[0];
                    var index = 0;
                    var lastIndexOf = modelNVTruc.forEach(function (element) {
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.AddPosition = function (modelNVTruc, item, isBS) {
                    this.validationErrors = [];
                    var viTriNewNhanVienLichPhanCong = new _lich_phan_cong_ngoai_tru_model__WEBPACK_IMPORTED_MODULE_10__["NhanVienLichPhanCong"]();
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.setDateTimeDayInWeek = function (modelshowDateTime, dateDay) {
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.changeDateLink = function (event) {
                    this.dateLinkValue = event;
                    this.dateLinkText = this.formatDateLink(event);
                    this.getById(this.getCurrentID);
                };
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.prevDateLink = function () {
                    this.dateLinkValue = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["addDays"])(this.dateLinkValue, -7);
                    this.dateLinkText = this.formatDateLink(this.dateLinkValue);
                    this.getById(this.getCurrentID);
                };
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.nextDateLink = function () {
                    this.dateLinkValue = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["addDays"])(this.dateLinkValue, 7);
                    this.dateLinkText = this.formatDateLink(this.dateLinkValue);
                    this.getById(this.getCurrentID);
                };
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.formatDateLink = function (date) {
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.onSelectionChangeNV = function (modelNV, modelThu, modelNVTruc, event) {
                    var _this = this;
                    this.validationErrors = [];
                    ...
                    if (event != undefined) {
                        modelNVTruc.forEach(function (element) {
                    ...
                    if (modelThu == 2) {
                        for (var i = 0; i < this.phongs.length; i++) {
                            if (this.phongs[i].PhongNgoaiTruId === modelNV.PhongNgoaiTruId) {
                                this.phongs[i].BacSis.forEach(function (value) {
                                    if (modelNV.IsBacSi == value.IsBacSi && event != undefined
                                        ...
                                        value.NgayPhanCong = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["addDays"])(Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["firstDayInWeek"])(_this.dateLinkValue, _progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["Day"].Monday), value.Thu - 2);
                                    }
                                });
                                this.phongs[i].YTas.forEach(function (value) {
                                    if (modelNV.IsBacSi == value.IsBacSi && event != undefined
                                        && (value.NhanVienId == 0 || value.TenNhanVien == null || value.TenNhanVien == "")) {
                                        value.NhanVienId = event.KeyId;
                                        value.TenNhanVien = event.DisplayName;
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.Save = function () {
                    var _this = this;
                    this.validationErrors = [];
                    var self = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].Add)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_15__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                self.phongs.forEach(function (element) {
                                    element.IsCopy = _this.copyDataLastWeek;
                                    element.ToDate = _this.dateLinkValue,
                                        element.FromDate = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["addDays"])(_this.dateLinkValue, 7);
                                });
                                self.apiService.post("LichPhanCongNgoaiTru/XepLichPhanCong", { Phong: self.phongs }).subscribe(function () {
                                    ...
                                    _this.getById(_this.getCurrentID);
                                    _this.isCopyForWeek = false;
                                    _this.copyDataLastWeek = false;
                                }, function (err) {
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.SavePrint = function () {
                    var _this = this;
                    this.validationErrors = [];
                    var self = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].Add)) {
                            ...
                            if (result == "Yes") {
                                self.phongs.forEach(function (element) {
                                    ...
                                    element.IsPrint = true,
                                        ...
                                        element.ToDate = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["addDays"])(Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["firstDayInWeek"])(_this.dateLinkValue, _progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["Day"].Monday), 0);
                                    element.FromDate = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["addDays"])(Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["firstDayInWeek"])(_this.dateLinkValue, _progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["Day"].Monday), 6);
                                    element.TenKhoa = _this.tenkhoaphongparams;
                                });
                                self.apiService.post("LichPhanCongNgoaiTru/XepLichPhanCong", { Phong: self.phongs }).subscribe(function (resultData) {
                                    _this.printForm(resultData);
                                    self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["SystemMessage"].ActionSuccessfully, ["Đã xếp lịch"]));
                                    _this.getById(_this.getCurrentID);
                                    _this.isCopyForWeek = false;
                                    _this.copyDataLastWeek = false;
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.CopyCalendar = function () {
                    var _this = this;
                    this.validationErrors = [];
                    var self = this;
                        ...
                        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].Add)) {
                            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_15__["ConfirmComponent"], {
                                ...
                                if (result == "Yes") {
                                    self.phongs.forEach(function (element) {
                                        element.IsCopy = true,
                                            element.CopyForWeek = _this.copyWeek == null ? 0 : _this.copyWeek,
                                            element.ToDate = toDate;
                                    });
                                    self.apiService.post("LichPhanCongNgoaiTru/LichPhanCongCopy", { Phong: self.phongs }).subscribe(function () {
                                        self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["SystemMessage"].ActionSuccessfully, ["Đã copy lịch cho " + _this.copyWeek + " tuần tới "]));
                                        _this.getById(_this.getCurrentID);
                                        _this.isCopyForWeek = false;
                                        _this.copyDataLastWeek = false;
                                    }, function (err) {
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.CopyCalendarLastWeek = function () {
                    var _this = this;
                    ...
                    var fromDate = this.intl.formatDate(Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["addDays"])(Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["firstDayInWeek"])(this.dateLinkValue, _progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["Day"].Monday), 6), "yyyy-MM-dd");
                    var toDate = this.intl.formatDate(Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["addDays"])(Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["firstDayInWeek"])(this.dateLinkValue, _progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_11__["Day"].Monday), 0), "yyyy-MM-dd");
                    this.apiService.post("LichPhanCongNgoaiTru/GetDataLastWeek?KhoaPhongId=" + this.getCurrentID + "&&fromDate=" + fromDate + "&&toDate=" + toDate).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.phongs = resultData;
                            _this.setDateTimeDayInWeek(_this.showDateTime, _this.dateLinkValue);
                            _this.setdataView(_this.phongs);
                            _this.gridData = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_19__["process"])(_this.phongs, { group: _this.groups });
                            _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_16__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["SystemMessage"].ActionSuccessfully, ["Đã copy lịch"]));
                        }
                        else
                            _this.notificationService.showError("Không tìm thấy lịch phân công gần đây");
                    }, function (err) {
                        _this.notificationService.showError("Không tìm thấy lịch phân công gần đây");
                    });
                };
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.printForm = function (responseHTML) {
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.Cancel = function () {
                    if (this.getCurrentID !== undefined && this.getCurrentID !== null) {
                        this.getById(this.getCurrentID);
                    }
                    // this.router.navigate(["danh-muc/lich-phan-cong/ngoai-tru"]);
                };
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.onChangecopyWeek = function (event) {
                    this.copyWeek = event;
                };
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.setdataView = function (phonglist) {
                    this.isCopyForWeek = this.phongs[0].IsShowCopyForWeek;
                    this.phongs.forEach(function (value, index) {
                        value.Id = index;
                    });
                    this.setHidenDeleteButton();
                };
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.setHidenDeleteButton = function () {
                    for (var i = 0; i < this.phongs.length; i++) {
                        this.phongs[i].BacSis.forEach(function (value, index) {
                            value.ListIdValidator = new Array();
                            if (index < 7)
                                value.IsDeleteHiden = true;
                        });
                        this.phongs[i].YTas.forEach(function (value, index) {
                            value.ListIdValidator = new Array();
                            if (index < 7)
                                value.IsDeleteHiden = true;
                        });
                ...
                LichPhanCongNgoaiTruTheoTuanComponent.prototype.GetListLookupNhanVien = function () {
                ...
                return LichPhanCongNgoaiTruTheoTuanComponent;
            }());
            LichPhanCongNgoaiTruTheoTuanComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichPhanCongNgoaiTruModule = /** @class */ (function () {
                function LichPhanCongNgoaiTruModule() {
                }
                return LichPhanCongNgoaiTruModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichPhanCongNgoaiTruService = /** @class */ (function (_super) {
                __extends(LichPhanCongNgoaiTruService, _super);
                function LichPhanCongNgoaiTruService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'LichPhanCongNgoaiTru';
                    return _this;
                }
                return LichPhanCongNgoaiTruService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            LichPhanCongNgoaiTruService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichPhanCongTheoTuanChinhSuaLichComponent = /** @class */ (function () {
                function LichPhanCongTheoTuanChinhSuaLichComponent(router) {
                    this.router = router;
                }
                LichPhanCongTheoTuanChinhSuaLichComponent.prototype.ngOnInit = function () {
                };
                return LichPhanCongTheoTuanChinhSuaLichComponent;
            }());
            LichPhanCongTheoTuanChinhSuaLichComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-lich-phan-cong-lich-phan-cong-ngoai-tru-lich-phan-cong-ngoai-tru-module-es5.js.map
//# sourceMappingURL=danh-muc-lich-phan-cong-lich-phan-cong-ngoai-tru-lich-phan-cong-ngoai-tru-module-es5.js.map