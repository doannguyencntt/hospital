...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-doanh-thu-bao-cao-chi-tiet-doanh-thu-theo-bac-si-bao-cao-chi-tiet-doanh-thu-theo-bac-si-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoChiTietDoanhThuTheoBacSiListComponent = /** @class */ (function () {
                function BaoCaoChiTietDoanhThuTheoBacSiListComponent(apiService) {
                ...
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.selectValueColumn = function (field, keyColumn) {
                    switch (field) {
                        case 'Ngay':
                ...
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.groupBySTT = function (keyColumn) {
                    var valueGroup = [];
                ...
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.chonBacSy = function (item) {
                    if (item != undefined) {
                ...
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.pageChange = function (event) {
                    this.baoCaoChiTietDoanhThuQueryInfoQueryInfo.Skip = event.skip;
                    this.skip = event.skip;
                    this.XemBaoCao();
                };
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.changeValueStart = function (event) {
                ...
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetBaoCaoChiTietDoanhThuTheoBacSiForGridAsync", this.baoCaoChiTietDoanhThuQueryInfoQueryInfo).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.baoCaoDanhThuTheoBacSi = resultData.Data;
                            _this.state.take = _this.baoCaoDanhThuTheoBacSi.length;
                            //
                            _this.groupSTT = _this.groupBy(_this.baoCaoDanhThuTheoBacSi, function (pet) { return pet.Stt; });
                            var dataList = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_9__["process"])(_this.baoCaoDanhThuTheoBacSi, _this.state);
                            _this.gridView = {
                    ...
                    this.apiService.post("BaoCao/GetTotalBaoCaoChiTietDoanhThuTheoBacSiForGridAsync", this.baoCaoChiTietDoanhThuQueryInfoQueryInfo).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.baoCaoDanhThuTheoBacSi = resultData;
                            _this.totalDoanhThu = resultData.DoanhThuTheoThang;
                            // this.totalCacKhoanGiamTru = resultData.DoanhThuTheoThang;
                            _this.totalKhac = resultData.CacKhoanGiamKhacTheoThang;
                            _this.totalMienGiam = resultData.MienGiamTheoThang;
                            _this.totalBHYT = resultData.BhytTheoThang;
                            _this.totalDoanhThuThuan = resultData.DoanhThuThuanTheoThang;
                        }
                    });
                };
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.XuatBaoCao = function () {
                ...
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.groupBy = function (list, keyGetter) {
                    var map = new Map();
                ...
                BaoCaoChiTietDoanhThuTheoBacSiListComponent.prototype.searchRefresh = function () {
                    this.XemBaoCao();
                };
                return BaoCaoChiTietDoanhThuTheoBacSiListComponent;
            }());
            BaoCaoChiTietDoanhThuTheoBacSiListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoChiTietDoanhThuTheoBacSiRoutingModule = /** @class */ (function () {
                function BaoCaoChiTietDoanhThuTheoBacSiRoutingModule() {
                }
                return BaoCaoChiTietDoanhThuTheoBacSiRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoDanhThuTheoBacSi = /** @class */ (function () {
                function BaoCaoDanhThuTheoBacSi(
                //Thông tin bác sĩ và người bệnh
                STT, MaTT, NgayForMat, MaBN, HoVaTenBenhNhan, TenDichVuChiDinh, MienGiam, Khac, 
                //Thông tin tháng
                Thang, 
                //Thông tin doanh thu của bác sĩ
                DoanhThu, BHYT, DoanhThuThuan) {
                    if (STT === void 0) { STT = null; }
                    if (MaTT === void 0) { MaTT = null; }
                    if (NgayForMat === void 0) { NgayForMat = null; }
                    if (MaBN === void 0) { MaBN = null; }
                    if (HoVaTenBenhNhan === void 0) { HoVaTenBenhNhan = null; }
                    if (TenDichVuChiDinh === void 0) { TenDichVuChiDinh = null; }
                    if (MienGiam === void 0) { MienGiam = 0; }
                    if (Khac === void 0) { Khac = 0; }
                    if (Thang === void 0) { Thang = null; }
                    if (DoanhThu === void 0) { DoanhThu = 0; }
                    if (BHYT === void 0) { BHYT = 0; }
                    if (DoanhThuThuan === void 0) { DoanhThuThuan = 0; }
                    this.STT = STT;
                    this.MaTT = MaTT;
                ...
                return BaoCaoDanhThuTheoBacSi;
            }());
            var BaoCaoChiTietDoanhThuQueryInfoQueryInfo = /** @class */ (function () {
                function BaoCaoChiTietDoanhThuQueryInfoQueryInfo(BacSiId, TuNgay, DenNgay, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                    if (BacSiId === void 0) { BacSiId = 0; }
                ...
                return BaoCaoChiTietDoanhThuQueryInfoQueryInfo;
            }());
            var DanhSachBacSy = /** @class */ (function () {
                function DanhSachBacSy(KeyId, DisplayName) {
                    if (KeyId === void 0) { KeyId = 0; }
                    if (DisplayName === void 0) { DisplayName = "Chọn bác sĩ"; }
                    this.KeyId = KeyId;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoChiTietDoanhThuTheoBacSiModule = /** @class */ (function () {
                function BaoCaoChiTietDoanhThuTheoBacSiModule() {
                }
                return BaoCaoChiTietDoanhThuTheoBacSiModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoChiTietDoanhThuTheoBacSiService = /** @class */ (function (_super) {
                __extends(BaoCaoChiTietDoanhThuTheoBacSiService, _super);
                function BaoCaoChiTietDoanhThuTheoBacSiService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoChiTietDoanhThuTheoBacSiService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            BaoCaoChiTietDoanhThuTheoBacSiService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-bao-cao-chi-tiet-doanh-thu-theo-bac-si-bao-cao-chi-tiet-doanh-thu-theo-bac-si-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-bao-cao-chi-tiet-doanh-thu-theo-bac-si-bao-cao-chi-tiet-doanh-thu-theo-bac-si-module-es5.js.map