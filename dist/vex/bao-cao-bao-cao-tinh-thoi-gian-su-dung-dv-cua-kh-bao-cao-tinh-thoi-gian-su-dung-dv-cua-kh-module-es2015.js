...
let BaoCaoTinhThoiGianSuDungDvCuaKhListComponent = class BaoCaoTinhThoiGianSuDungDvCuaKhListComponent {
    ...
    XemBaoCao() {
        ...
        this.showPopupLoadingData();
        this.ishowView = false;
        this.apiService.post("BaoCao/GetDataBaoCaoSoLieuTinhThoiGianSuDungDVCuaKHForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoTinhThoiGianSuDungDvCuaKhListComponent.ctorParameters = () => [
...
let BaoCaoTinhThoiGianSuDungDvCuaKhRoutingModule = class BaoCaoTinhThoiGianSuDungDvCuaKhRoutingModule {
};
...
class BaoCaoTinhThoiGianSuDungDVCuaKHSearch {
...
class TinhThoiGianSuDungDVCuaKH {
...
class InTinhThoiGianSuDungDVCuaKH {
...
let BaoCaoTinhThoiGianSuDungDvCuaKhModule = class BaoCaoTinhThoiGianSuDungDvCuaKhModule {
};
...
let BaoCaoTinhThoiGianSuDungDvCuaKhService = class BaoCaoTinhThoiGianSuDungDvCuaKhService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoTinhThoiGianSuDungDvCuaKhService.ctorParameters = () => [
