...
let ThietBiXetNghiemCreateComponent = class ThietBiXetNghiemCreateComponent {
...
ThietBiXetNghiemCreateComponent.ctorParameters = () => [
...
let ThietBiXetNghiemListComponent = class ThietBiXetNghiemListComponent {
    constructor(router, notificationService, dialog, apiService, authService) {
        this.router = router;
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel('ThietBiXetNghiem/ExportThietBiXetNghiem', this.gridChild._gridQueryInfo).subscribe(res => {
...
ThietBiXetNghiemListComponent.ctorParameters = () => [
...
let ThietBiXetNghiemRoutingModule = class ThietBiXetNghiemRoutingModule {
};
...
let ThietBiXetNghiemSharedComponent = class ThietBiXetNghiemSharedComponent {
    ...
    getById(id) {
        this.baseService.getById(id).subscribe(resultData => {
            this.thietBiXn = Object.assign({}, resultData);
...
ThietBiXetNghiemSharedComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
let ThietBiXetNghiemUpdateComponent = class ThietBiXetNghiemUpdateComponent {
    constructor(router, route) {
        this.router = router;
        this.route = route;
    }
...
ThietBiXetNghiemUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
class ThietBiXetNghiem {
    constructor(Id = null, NhomXetNghiemId = null, NhomXetNghiemDisplay = null, NhomThietBiId = null, NhomThietBiDisplay = null, Ma = null, Ten = null, Ncc = null, HieuLuc = true, IsCopy = false) {
        this.Id = Id;
...
let ThietBiXetNghiemModule = class ThietBiXetNghiemModule {
};
...
let ThietBiXetNghiemService = class ThietBiXetNghiemService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'ThietBiXetNghiem';
    }
};
ThietBiXetNghiemService.ctorParameters = () => [
