...
let DuyetKetQuaXetNghiemDetailedComponent = class DuyetKetQuaXetNghiemDetailedComponent {
            ...
            if (result) {
                if (result != undefined && result != null && result != "") {
                    if (result.LoaiIn != null) {
                        ...
                        this.apiService.post('DuyetKetQuaXetNghiem/DuyetPhienXetNghiem', this.duyetKqXetNghiemDetail).subscribe(() => {
                            this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_13__["SystemMessage"].ActionSuccessfully, ['Duyệt']));
                            ...
                            this.apiService.post('XetNghiem/GetAllHtmlPdfKetQuaXetNghiem', this.inPhieuDuyetKetQua).subscribe(arrHtml => {
                                this.dialog.open(_duyet_ket_qua_phieu_popup_duyet_ket_qua_phieu_popup_component__WEBPACK_IMPORTED_MODULE_18__["DuyetKetQuaPhieuPopupComponent"], {
                                    disableClose: false,
                                    width: '1000px',
                                    data: arrHtml
    ...
    setDataSourceForGrid() {
        ...
        if (this.searchString == null || this.searchString === '') {
            ...
            const search = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__["CommonService"].removeVietnamese(this.searchString).toLowerCase().trim().replace(/đ/g, 'd');
            this.ChiTietKetQuaXetNghiems = [...this.duyetKqXetNghiemDetail.ChiTietKetQuaXetNghiems].filter(o => (o.GiaTriCu != null && src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__["CommonService"].removeVietnamese(o.GiaTriCu).toLowerCase().replace(/đ/g, 'd')
                .indexOf(search) >= 0)
    ...
    ApproveOnGroup(currentValue, dataItem) {
        const duyetKetQuaTheoNhom = {
            Id: this.id,
            ChiTietKetQuaXetNghiems: dataItem.items
        };
        this.apiService.post('DuyetKetQuaXetNghiem/ApproveOnGroup?currentNhomId=' + dataItem.items.map(x => x.NhomId)[0] +
...
DuyetKetQuaXetNghiemDetailedComponent.ctorParameters = () => [
...
let DuyetKetQuaInNhomDvListPopupComponent = class DuyetKetQuaInNhomDvListPopupComponent {
...
DuyetKetQuaInNhomDvListPopupComponent.ctorParameters = () => [
...
let DuyetKetQuaXetNghiemListComponent = class DuyetKetQuaXetNghiemListComponent {
    ...
    Timkiem() {
        ...
        this.router.navigateByUrl('/xet-nghiem/duyet-ket-qua?holdQuery=true');
        const ycTraThuocUtilityClone = JSON.parse(JSON.stringify(this.search));
...
DuyetKetQuaXetNghiemListComponent.ctorParameters = () => [
...
let DuyetKetQuaNhomDvListPopupComponent = class DuyetKetQuaNhomDvListPopupComponent {
    ...
    print(id, yeuCauTiepNhanId) {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            ...
            this.apiService.post('XetNghiem/GetAllHtmlPdfKetQuaXetNghiem', this.inPhieuDuyetKetQua).subscribe(arrHtml => {
                this.dialog.open(_duyet_ket_qua_phieu_popup_duyet_ket_qua_phieu_popup_component__WEBPACK_IMPORTED_MODULE_12__["DuyetKetQuaPhieuPopupComponent"], {
                    disableClose: false,
                    width: '1000px',
                    data: arrHtml
                }).afterClosed().subscribe(() => {
    ...
    ok() {
        ...
        this.apiService.post("XetNghiem/XemPhieuXetNghiem", this.inPhieuDuyetKetQua).subscribe(resData => {
            if (resData != undefined && resData != null && resData.length > 0) {
                this.closePopupLoadingData();
                this.dialog.open(_duyet_ket_qua_in_nhom_dv_list_popup_duyet_ket_qua_in_nhom_dv_list_popup_component__WEBPACK_IMPORTED_MODULE_13__["DuyetKetQuaInNhomDvListPopupComponent"], {
                    disableClose: false,
                    width: '1200px',
                    data: resData[0].Html,
                }).afterClosed().subscribe(() => {
...
DuyetKetQuaNhomDvListPopupComponent.ctorParameters = () => [
...
let DuyetKetQuaPhieuPopupComponent = class DuyetKetQuaPhieuPopupComponent {
...
DuyetKetQuaPhieuPopupComponent.ctorParameters = () => [
...
let DuyetKetQuaXetNghiemPopupComponent = class DuyetKetQuaXetNghiemPopupComponent {
...
DuyetKetQuaXetNghiemPopupComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
...
let DuyetKetQuaXetNghiemRoutingModule = class DuyetKetQuaXetNghiemRoutingModule {
};
...
class Search {
    constructor(SearchString = null, ChoDuyet = true, DaDuyet = false, 
    // tslint:disable-next-line: no-use-before-declare
    RangeThucHien = new RangeDate(), 
    // tslint:disable-next-line: no-use-before-declare
...
class DuyetKetQua {
    constructor(Id = null, YeuCauTiepNhanId = null, Barcode = null, MaTn = null, MaBn = null, HoTen = null, MaBhyt = null, GioiTinhDisplay = null, NamSinh = null, DiaChi = null, Tuoi = null, Tuyen = null, MucHuong = null, DanToc = null, NgheNghiep = null, ChanDoanReadonly = null, Khoa = null, Phong = null, NguoiThucHien = null, NguoiThucHienId = null, ChanDoan = null, TrangThai = null, TrangThaiDisplay = null, GhiChu = null, ChiTietKetQuaXetNghiems = new Array(), 
    //BVHD-3364
    TenCongTy = null) {
        this.Id = Id;
        this.YeuCauTiepNhanId = YeuCauTiepNhanId;
...
let DuyetKetQuaXetNghiemModule = class DuyetKetQuaXetNghiemModule {
};
...
let DuyetKetQuaXetNghiemService = class DuyetKetQuaXetNghiemService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DuyetKetQuaXetNghiem';
    }
};
DuyetKetQuaXetNghiemService.ctorParameters = () => [
