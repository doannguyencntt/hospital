...
let LoaiBenhVienCreateComponent = class LoaiBenhVienCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
LoaiBenhVienCreateComponent.ctorParameters = () => [
...
let LoaiBenhVienListComponent = class LoaiBenhVienListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('LoaiBenhVien/ExportLoaiBenhVien', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
LoaiBenhVienListComponent.ctorParameters = () => [
...
let LoaiBenhVienRoutingModule = class LoaiBenhVienRoutingModule {
};
...
let LoaiBenhVienSharedComponent = class LoaiBenhVienSharedComponent {
...
LoaiBenhVienSharedComponent.ctorParameters = () => [
...
let LoaiBenhVienUpdateComponent = class LoaiBenhVienUpdateComponent {
...
LoaiBenhVienUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let LoaiBenhVienModule = class LoaiBenhVienModule {
};
...
let LoaiBenhVienService = class LoaiBenhVienService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'LoaiBenhVien';
    }
};
LoaiBenhVienService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
