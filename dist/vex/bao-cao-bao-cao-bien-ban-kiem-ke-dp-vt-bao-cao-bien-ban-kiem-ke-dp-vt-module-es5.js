(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-bien-ban-kiem-ke-dp-vt-bao-cao-bien-ban-kiem-ke-dp-vt-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBienBanKiemKeDpVtListComponent = /** @class */ (function () {
                function BaoCaoBienBanKiemKeDpVtListComponent(apiService, dialog, notificationService, authService) {
                ...
                BaoCaoBienBanKiemKeDpVtListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoBienBanKiemKeDpVtListComponent.prototype.seachChange = function (event) {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoBienBanKiemKeDpVtListComponent.prototype.pageChange = function (event) {
                    this.skip = event;
                ...
                BaoCaoBienBanKiemKeDpVtListComponent.prototype.XemBaoCao = function () {
                    if (this.baoCaoSearch.GioThongKeFormat == null) {
                        this.notificationService.showError("Giờ thống kê yêu cầu nhập");
                        return;
                    }
                ...
                BaoCaoBienBanKiemKeDpVtListComponent.prototype.getThongTinDataKiemKeDuocPhamVatTu = function (baoCaoSearch) {
                    var _this = this;
                    debugger;
                    this.apiService.post("BaoCao/GetDataBaoCaoBienBanKiemKeDPVTForGridAsync", baoCaoSearch).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            ...
                            _this.gridView.data = _this.gridDataSource.data;
                ...
                BaoCaoBienBanKiemKeDpVtListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.baoCaoSearch.GioThongKeFormat == null) {
                        this.notificationService.showError("Giờ thống kê yêu cầu nhập");
                        return;
                ...
                return BaoCaoBienBanKiemKeDpVtListComponent;
            }());
            BaoCaoBienBanKiemKeDpVtListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBienBanKiemKeDpVtRoutingModule = /** @class */ (function () {
                function BaoCaoBienBanKiemKeDpVtRoutingModule() {
                }
                return BaoCaoBienBanKiemKeDpVtRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoBienBanKiemKeDpVtSearch = /** @class */ (function () {
                function BaoCaoBienBanKiemKeDpVtSearch(GioThongKe, GioThongKeFormat, KhoId, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                    if (GioThongKe === void 0) { GioThongKe = null; }
                    if (GioThongKeFormat === void 0) { GioThongKeFormat = null; }
                ...
                return BaoCaoBienBanKiemKeDpVtSearch;
            }());
            var InBaoCaoBienBanKiemKeDpVt = /** @class */ (function () {
                function InBaoCaoBienBanKiemKeDpVt(HostingName, FromDate, ToDate) {
                ...
                return InBaoCaoBienBanKiemKeDpVt;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBienBanKiemKeDpVtModule = /** @class */ (function () {
                function BaoCaoBienBanKiemKeDpVtModule() {
                }
                return BaoCaoBienBanKiemKeDpVtModule;
            }());
...
//# sourceMappingURL=bao-cao-bao-cao-bien-ban-kiem-ke-dp-vt-bao-cao-bien-ban-kiem-ke-dp-vt-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-bien-ban-kiem-ke-dp-vt-bao-cao-bien-ban-kiem-ke-dp-vt-module-es5.js.map