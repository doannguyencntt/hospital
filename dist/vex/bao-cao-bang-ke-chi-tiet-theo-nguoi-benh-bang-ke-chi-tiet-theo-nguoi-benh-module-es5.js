(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bang-ke-chi-tiet-theo-nguoi-benh-bang-ke-chi-tiet-theo-nguoi-benh-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BangKeChiTietTheoNguoiBenhListComponent = /** @class */ (function () {
                function BangKeChiTietTheoNguoiBenhListComponent(apiService, dialog, authService, notificationService) {
                ...
                BangKeChiTietTheoNguoiBenhListComponent.prototype.ngOnInit = function () {
                ...
                BangKeChiTietTheoNguoiBenhListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                        ...
                        var tuNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].formatDateTime(this.baoCaoSearch.TuNgayFormat, "mm/dd/yyyy");
                        var denNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].formatDateTime(this.baoCaoSearch.DenNgayFormat, "mm/dd/yyyy");
                ...
                BangKeChiTietTheoNguoiBenhListComponent.prototype.XemBaoCao = function () {
                    // if (this.baoCaoSearch.NguoiBenhId == null || this.baoCaoSearch.NguoiBenhId == 0) {
                    if (this.baoCaoSearch.MaYeuCauTiepNhan == undefined || this.baoCaoSearch.MaYeuCauTiepNhan == null) {
                        this.notificationService.showError("Người bệnh yêu cầu nhập");
                        return;
                ...
                BangKeChiTietTheoNguoiBenhListComponent.prototype.getTongCong = function (queryInfo) {
                    var _this = this;
                    this.apiService.post("BaoCao/GetTongCongBangKeChiTietTheoNguoiBenh", queryInfo).subscribe(function (resultData) {
                        _this.tongThanhTien = resultData.TongCongChiPhi;
                        _this.tongCongGiaTonKho = resultData.TongChiPhiGiaTonKho;
                    }, function (err) {
                ...
                BangKeChiTietTheoNguoiBenhListComponent.prototype.changeHinhThucDen = function (event) {
                    this.cboTiepNhan.getDataForLookup();
                };
                BangKeChiTietTheoNguoiBenhListComponent.prototype.changeNguoiGioiThieu = function (event) {
                    this.cboTiepNhan.getDataForLookup();
                };
                BangKeChiTietTheoNguoiBenhListComponent.prototype.changeMaTiepNhan = function (event) {
                ...
                BangKeChiTietTheoNguoiBenhListComponent.prototype.ganThoiGianTimKiemMacDinh = function (xoaThoiGianMacDinh) {
                ...
                return BangKeChiTietTheoNguoiBenhListComponent;
            }());
            BangKeChiTietTheoNguoiBenhListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BangKeChiTietTheoNguoiBenhRoutingModule = /** @class */ (function () {
                function BangKeChiTietTheoNguoiBenhRoutingModule() {
                }
                return BangKeChiTietTheoNguoiBenhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BangKeChiTietTheoNguoiBenhTimKiemNangCao = /** @class */ (function () {
                function BangKeChiTietTheoNguoiBenhTimKiemNangCao(HinhThucDenId, NoiGioiThieuId, MaYeuCauTiepNhan, SearchString, FromDate, ToDate, TuNgayFormat, DenNgayFormat) {
                ...
                return BangKeChiTietTheoNguoiBenhTimKiemNangCao;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BangKeChiTietTheoNguoiBenhModule = /** @class */ (function () {
                function BangKeChiTietTheoNguoiBenhModule() {
                }
                return BangKeChiTietTheoNguoiBenhModule;
            }());
...
//# sourceMappingURL=bao-cao-bang-ke-chi-tiet-theo-nguoi-benh-bang-ke-chi-tiet-theo-nguoi-benh-module-es5.js.map
//# sourceMappingURL=bao-cao-bang-ke-chi-tiet-theo-nguoi-benh-bang-ke-chi-tiet-theo-nguoi-benh-module-es5.js.map