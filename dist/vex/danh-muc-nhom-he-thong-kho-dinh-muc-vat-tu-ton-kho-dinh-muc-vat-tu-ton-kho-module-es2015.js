...
let DinhMucVatTuTonKhoCreateComponent = class DinhMucVatTuTonKhoCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() { }
    ...
    onValidateClient(allowValidate) {
        if (allowValidate) {
            this.shared.onValidateClient();
        }
    }
};
DinhMucVatTuTonKhoCreateComponent.ctorParameters = () => [
...
let DinhMucVatTuTonKhoListComponent = class DinhMucVatTuTonKhoListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel('DinhMucVatTuTonKho/ExportDinhMucVatTuTonKho', this.gridChild._gridQueryInfo).subscribe(res => {
...
DinhMucVatTuTonKhoListComponent.ctorParameters = () => [
...
let DinhMucVatTuTonKhoRoutingModule = class DinhMucVatTuTonKhoRoutingModule {
};
...
let DinhMucVatTuTonKhoSharedComponent = class DinhMucVatTuTonKhoSharedComponent {
    constructor(route, dialog, baseService) {
        this.route = route;
        this.dialog = dialog;
...
DinhMucVatTuTonKhoSharedComponent.ctorParameters = () => [
...
let DinhMucVatTuTonKhoUpdateComponent = class DinhMucVatTuTonKhoUpdateComponent {
...
DinhMucVatTuTonKhoUpdateComponent.ctorParameters = () => [
...
let DinhMucVatTuTonKhoModule = class DinhMucVatTuTonKhoModule {
};
...
let DinhMucVatTuTonKhoService = class DinhMucVatTuTonKhoService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DinhMucVatTuTonKho';
    }
};
DinhMucVatTuTonKhoService.ctorParameters = () => [
