(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-duoc-pham-tong-hop-du-tru-mua-thuoc-tai-khoa-tong-hop-du-tru-mua-thuoc-tai-khoa-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DsTongHopDuTruMuaThuocTaiKhoaComponent = /** @class */ (function () {
                function DsTongHopDuTruMuaThuocTaiKhoaComponent(dialog, router, apiService, authService, notificationService, cd, route, location) {
                    this.dialog = dialog;
                    this.router = router;
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.ngOnInit = function () {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.backWithSearch = function () {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.theFirstValueFormat = function (str) {
                    var strGroup = str.split('.');
                    if (strGroup.length != 0) {
                        return strGroup[0];
                    }
                };
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.theFirstValueFormatChuKy = function (str) {
                    var strGroup = str.split('.');
                    if (strGroup.length != 0) {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.blur = function () {
                    this.timKiem();
                };
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                ...
                //   // this.gridChoDuyet.search();
                // }
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.searchChanges = function (event) {
                    var self = this;
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.timKiem = function () {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.guiKhoaDuyetTatCa = function (val) {
                    var kyDuTruMuaDuocPhamVatTuId = this.tongHopDuTruMuaThuocTaiKhoa.filter(function (cc) { return cc.TrangThai == val; }).map(function (cc) { return cc.KyDuTruMuaDuocPhamVatTuId; })[0];
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.tuChoiDuyet = function (id) {
                };
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.huyDuyet = function (id) {
                };
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.chiTiet = function (id, trangThai) {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.chiTietTuChoi = function (id) {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                        this.router.navigate(["/nhap-xuat/duoc-pham/tong-hop-mua-duoc-pham-tai-khoa/chi-tiet/" + id]);
                    }
                    else {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.inPhieuLinh = function (id) {
                };
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.loadingPage = function () {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.TuChoi = function (id) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
                        ...
                        this.confrim = this.dialog.open(_tong_hop_du_tru_mua_thuoc_tai_khoa_khong_duyet_tong_hop_du_tru_mua_thuoc_tai_khoa_khong_duyet_component__WEBPACK_IMPORTED_MODULE_29__["TongHopDuTruMuaThuocTaiKhoaKhongDuyetComponent"], {
                            ...
                            if (result != "" && result != undefined) {
                                ...
                                _this.apiService.post("YeuCauMuaDuocPham/TuChoiDuyetTaiKhoa", _this.thongTinLyDoHuyDuyetTaiKhoa)
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.PheDuyet = function (id) {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
                        ...
                        this.confrim = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_28__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                _this.apiService.post("YeuCauMuaDuocPham/DuyetTaiKhoa/", _this.duyetDuTruMuaDuocPhamViewModel)
                                    .subscribe(function (resultData) {
                                    if (resultData !== null && resultData !== undefined) {
                                        if (resultData) {
                                            _this.gridChoDuyet.search();
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.HuyDuyet = function (id) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
                        ...
                        this.confrim = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_28__["ConfirmComponent"], {
                            ...
                            /* result is a string:Yes,No,No answer*/
                            if (result == "Yes") {
                                _this.apiService.post("YeuCauMuaDuocPham/HuyDuyetTaiKhoa/" + id)
                                    .subscribe(function (resultData) {
                                    if (resultData !== null && resultData !== undefined) {
                                        if (resultData) {
                                            _this.gridChoDuyet.search();
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.changeTabParent = function (element, event) {
                };
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.CheckboxChange = function ($event, choDuyet, daDuyet) {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.onDataBound = function (event) {
                    if (event != undefined && event.Data.length > 0) {
                        this.tongHopDuTruMuaThuocTaiKhoa = event.Data;
                    }
                };
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.chiTietDaXuLyParent = function (id) {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.chiTietDaXuLy = function (id, tinhTrang, isParent) {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.unSelectedTab = function () {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.chuyenDen = function (element, event) {
                ...
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.TooltipCustom = function (duTruGiamDocDetail) {
                    this.khos = duTruGiamDocDetail.ThongTinChiTietTonKhoTongs.slice();
                    this.hdts = duTruGiamDocDetail.ThongTinChiTietTonHDTs.slice();
                };
                DsTongHopDuTruMuaThuocTaiKhoaComponent.prototype.trangThaiCheckBox = function (event, tinhTrang, tabSelected) {
                    if (tabSelected == 1) {
                ...
                return DsTongHopDuTruMuaThuocTaiKhoaComponent;
            }());
            DsTongHopDuTruMuaThuocTaiKhoaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GuiTongHopDuTruMuaThuocTaiKhoaConfirmComponent = /** @class */ (function () {
                function GuiTongHopDuTruMuaThuocTaiKhoaConfirmComponent(dialogRef, data) {
                ...
                GuiTongHopDuTruMuaThuocTaiKhoaConfirmComponent.prototype.ngOnInit = function () {
                    this.Title = this.data.Title;
                    this.Message = this.data.Message;
                };
                GuiTongHopDuTruMuaThuocTaiKhoaConfirmComponent.prototype.close = function (result) {
                    this.dialogRef.close(result);
                };
                return GuiTongHopDuTruMuaThuocTaiKhoaConfirmComponent;
            }());
            GuiTongHopDuTruMuaThuocTaiKhoaConfirmComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent = /** @class */ (function () {
                function GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent(dialog, router, apiService, authService, notificationService, cd, route, location, ref) {
                    this.dialog = dialog;
                    this.router = router;
                    this.apiService = apiService;
                    this.authService = authService;
                ...
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.ngOnInit = function () {
                ...
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.getThongTinTongHopDuTruMuaTaiKhoa = function () {
                    var _this = this;
                ...
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.getKyTheoId = function () {
                    var _this = this;
                    var phongBenhVienId = this.authService.getPhongLamViecId();
                    this.apiService.get("YeuCauMuaDuocPham/GetThongTinGoiTaiKhoa/" + phongBenhVienId)
                        .subscribe(function (resultData) {
                ...
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.onDataBoundChild = function (event) {
                    if (event != undefined && event.Data.length > 0) {
                        this.thongTinGoiTaiKhoa.KyDuTru = event.Data[0].KyDuTru;
                    }
                };
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.loadingPage = function () {
                ...
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.closepopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.savingPage = function () {
                ...
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.closePopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.onDataBound = function (event) {
                    if (event != undefined && event.Data.length > 0) {
                        this.duTruMuaDuocPhamTaiKhoaChiTietVo = event.Data;
                        this.thongTinGoiTaiKhoa.KyDuTru = event.Data[0].KyDuTru;
                    }
                };
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.guiTatCa = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                        self.dialog.open(_gui_tong_hop_du_tru_mua_thuoc_tai_khoa_confirm_gui_tong_hop_du_tru_mua_thuoc_tai_khoa_confirm_component__WEBPACK_IMPORTED_MODULE_16__["GuiTongHopDuTruMuaThuocTaiKhoaConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                ...
                                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                                    self.savingPage();
                                    self.apiService.post("YeuCauMuaDuocPham/GoiThongTinTaiKhoa", self.duyetDuTruMuaDuocPhamViewModel).subscribe(function (resultData) {
                                        if (resultData != undefined && resultData != null) {
                                            self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_10__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                                            self.closePopupSavingData();
                ...
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.cancel = function () {
                    this.location.back();
                };
                GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.keyEvent = function (event) {
                ...
                return GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent;
            }());
            GuiTongHopDuTruMuaThuocTaiKhoaDuyetComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuMuaTruTaiKhoaComponent = /** @class */ (function () {
                ...
                PhieuMuaTruTaiKhoaComponent.prototype.xem = function () {
                    ...
                    self.apiService.post("YeuCauMuaDuocPham/InPhieuDuTruMuaTaiKhoa", self.inPhieuDuocPham).subscribe(function (resData) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/services/notification.service */ "./src/app/core/services/notification.service.ts");
            /* harmony import */ var _tong_hop_du_tru_mua_thuoc_tai_khoa_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../tong-hop-du-tru-mua-thuoc-tai-khoa.model */ "./src/app/modules/main/nhap-xuat/duoc-pham/tong-hop-du-tru-mua-thuoc-tai-khoa/tong-hop-du-tru-mua-thuoc-tai-khoa.model.ts");
            var PhieuTongHopDuTruMuaThuocTaiKhoaDuyetComponent = /** @class */ (function () {
                function PhieuTongHopDuTruMuaThuocTaiKhoaDuyetComponent(dialogRef, apiService, notificationService, data, ref) {
                    this.dialogRef = dialogRef;
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.data = data;
                ...
                PhieuTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.ngOnInit = function () {
                    console.log(this.data);
                    this.xem();
                };
                PhieuTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.xem = function () {
                    var self = this;
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    ...
                    self.apiService.post("YeuCauMuaDuocPham/InPhieuDuTruMuaTaiKhoa", self.inPhieuDuocPhamTaiKhoaTaiKhoa).subscribe(function (resData) {
                        if (resData != undefined && resData != null) {
                            self.inPhieuDuocPhamTaiKhoaTaiKhoa.Header = false;
                            self.dataHTML = resData;
                            self.src = "data:text/html;charset=utf-8," + encodeURIComponent(resData);
                ...
                PhieuTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        resolve(_this.dataHTML);
                        _this.close();
                    });
                };
                PhieuTongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                return PhieuTongHopDuTruMuaThuocTaiKhoaDuyetComponent;
            }());
            PhieuTongHopDuTruMuaThuocTaiKhoaDuyetComponent.ctorParameters = function () { return [
                { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_5__["NotificationService"] },
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"],] }] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaThuocTaiKhoaDetailComponent = /** @class */ (function () {
                function TongHopDuTruMuaThuocTaiKhoaDetailComponent(dialog, authService, notificationService, location, ref, route, apiService) {
                    this.dialog = dialog;
                    this.authService = authService;
                    this.notificationService = notificationService;
                    this.location = location;
                ...
                TongHopDuTruMuaThuocTaiKhoaDetailComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_4__["DocumentType"].DanhSachTongHopDuTruMuaDuocPhamTaiKhoa;
                ...
                TongHopDuTruMuaThuocTaiKhoaDetailComponent.prototype.GetTrangThaiPhieuMuaDuTru = function (id) {
                    var _this = this;
                    var self = this;
                ...
                TongHopDuTruMuaThuocTaiKhoaDetailComponent.prototype.loadingPage = function () {
                ...
                TongHopDuTruMuaThuocTaiKhoaDetailComponent.prototype.closepopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TongHopDuTruMuaThuocTaiKhoaDetailComponent.prototype.inPhieu = function () {
                    var self = this;
                ...
                TongHopDuTruMuaThuocTaiKhoaDetailComponent.prototype.cancel = function () {
                    this.location.back();
                };
                TongHopDuTruMuaThuocTaiKhoaDetailComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 27 && !event.ctrlKey) {
                        //esc
                        this.cancel();
                        event.preventDefault();
                ...
                return TongHopDuTruMuaThuocTaiKhoaDetailComponent;
            }());
            TongHopDuTruMuaThuocTaiKhoaDetailComponent.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaThuocTaiKhoaDuyetComponent = /** @class */ (function () {
                function TongHopDuTruMuaThuocTaiKhoaDuyetComponent(dialog, router, apiService, authService, notificationService, cd, route, location, ref) {
                    this.dialog = dialog;
                    this.router = router;
                    this.apiService = apiService;
                    this.authService = authService;
                ...
                TongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.ngOnInit = function () {
                ...
                TongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.getThongTinTongHopDuTruMuaTaiKhoaDaXuLy = function (id) {
                    var _this = this;
                    this.apiService.get('YeuCauMuaDuocPham/GetThongTinDuTruDuocPhamTaiKhoaDaXuLy/' + id)
                        .subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                            _this.danhSachTongHopDuTruMuaThuocTaiKhoa = resultData;
                        }
                    });
                };
                TongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.getThongTinTongHopDuTruMuaTaiKhoa = function (id) {
                    var _this = this;
                ...
                TongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.loadingPage = function () {
                ...
                TongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.closepopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.savingPage = function () {
                ...
                TongHopDuTruMuaThuocTaiKhoaDuyetComponent.prototype.closepopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                return TongHopDuTruMuaThuocTaiKhoaDuyetComponent;
            }());
            TongHopDuTruMuaThuocTaiKhoaDuyetComponent.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @iconify/icons-ic/twotone-close */ "./node_modules/@iconify/icons-ic/twotone-close.js");
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            var TongHopDuTruMuaThuocTaiKhoaKhongDuyetComponent = /** @class */ (function () {
                function TongHopDuTruMuaThuocTaiKhoaKhongDuyetComponent(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                    this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
                    this.Title = null;
                ...
                TongHopDuTruMuaThuocTaiKhoaKhongDuyetComponent.prototype.ngOnInit = function () {
                    this.Title = "Xác nhận";
                    this.Message = "Bạn có muốn từ chối phiếu dự trù này không?";
                };
                TongHopDuTruMuaThuocTaiKhoaKhongDuyetComponent.prototype.close = function (result) {
                    if (result == 'Yes') {
                ...
                return TongHopDuTruMuaThuocTaiKhoaKhongDuyetComponent;
            }());
            TongHopDuTruMuaThuocTaiKhoaKhongDuyetComponent.ctorParameters = function () { return [
                { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
                { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaThuocTaiKhoaRoutingModule = /** @class */ (function () {
                function TongHopDuTruMuaThuocTaiKhoaRoutingModule() {
                }
                return TongHopDuTruMuaThuocTaiKhoaRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaThuocTaiKhoaSharedComponent = TongHopDuTruMuaThuocTaiKhoaSharedComponent_1 = /** @class */ (function () {
                function TongHopDuTruMuaThuocTaiKhoaSharedComponent(apiService, route, dialog, router, location, notificationService, authService) {
                    this.apiService = apiService;
                    this.route = route;
                    this.dialog = dialog;
                    this.router = router;
                ...
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.ngOnInit = function () {
                ...
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.getThongTinTongHopDuTruMuaTaiKhoa = function (id) {
                    var _this = this;
                    this.apiService.get('YeuCauMuaDuocPham/GetThongTinDuTruDuocPhamTaiKhoa/' + id)
                        .subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                ...
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.getThongTinTongHopDuTruMuaTaiKhoaDaXuLy = function (id) {
                    var _this = this;
                    this.apiService.get('YeuCauMuaDuocPham/GetThongTinDuTruDuocPhamTaiKhoaDaXuLy/' + id)
                        .subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                ...
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.onDataBound = function (event) {
                    if (event != undefined && event.Data.length > 0) {
                        this.duTruMuaDuocPhamTaiKhoaChiTietVo = event.Data;
                    }
                };
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.PheDuyet = function (id) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Update)) {
                        ...
                        this.confrim = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
                            ...
                            /* result is a string:Yes,No,No answer*/
                            if (result == 'Yes') {
                                _this.duyetDuTruMuaDuocPhamViewModel.DuTruMuaDuocPhamId = id;
                                _this.duyetDuTruMuaDuocPhamViewModel.DuTruMuaDuocPhamTaiKhoaChiTietVos = _this.duTruMuaDuocPhamTaiKhoaChiTietVo;
                                _this.apiService.post('YeuCauMuaDuocPham/DuyetTaiKhoa/', _this.duyetDuTruMuaDuocPhamViewModel)
                                    .subscribe(function (resultData) {
                                    if (resultData !== null && resultData !== undefined) {
                                        if (resultData) {
                ...
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.TuChoi = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Update)) {
                        if (this.confrim != null) {
                            this.dialog.closeAll();
                        ...
                        this.confrim = this.dialog.open(_tong_hop_du_tru_mua_thuoc_tai_khoa_khong_duyet_tong_hop_du_tru_mua_thuoc_tai_khoa_khong_duyet_component__WEBPACK_IMPORTED_MODULE_13__["TongHopDuTruMuaThuocTaiKhoaKhongDuyetComponent"], {
                            ...
                            if (result != '' && result != undefined) {
                                _this.thongTinLyDoHuyDuyetTaiKhoa.LyDoHuy = result;
                                _this.thongTinLyDoHuyDuyetTaiKhoa.Id = _this.duTruMuaDuocPhamTaiKhoaId;
                                _this.apiService.post('YeuCauMuaDuocPham/TuChoiDuyetTaiKhoa', _this.thongTinLyDoHuyDuyetTaiKhoa)
                                    .subscribe(function (resultData) {
                                    if (resultData !== null && resultData !== undefined) {
                                        if (resultData) {
                ...
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.HuyDuyet = function (id) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Update)) {
                        if (this.confrim != null) {
                            this.dialog.closeAll();
                            ...
                            if (result == "Yes") {
                                _this.apiService.post("YeuCauMuaDuocPham/HuyDuyetTaiKhoa/" + id)
                                    ...
                                    if (resultData !== null && resultData !== undefined) {
                                        if (resultData) {
                                            _this.notificationService.showSuccess("Hủy Duyệt thành công.");
                                            _this.router.navigate(['/nhap-xuat/duoc-pham/tong-hop-mua-duoc-pham-tai-khoa']);
                                        }
                                        else {
                                            _this.notificationService.showError("Hủy không thành công.");
                                        }
                ...
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.cancel = function () {
                    // this.router.navigate(["/nhap-xuat/duoc-pham/tong-hop-mua-duoc-pham-tai-khoa"], {
                    //   queryParamsHandling: "preserve",
                    // });
                    this.location.back();
                };
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode == 27 && !event.ctrlKey) {
                        // esc
                        this.cancel();
                        event.preventDefault();
                ...
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.TooltipCustom = function (duTruGiamDocDetail) {
                    this.khos = duTruGiamDocDetail.ThongTinChiTietTonKhoTongs.slice();
                    this.hdts = duTruGiamDocDetail.ThongTinChiTietTonHDTs.slice();
                };
                TongHopDuTruMuaThuocTaiKhoaSharedComponent.prototype.InPhieuTongHopTaiKhoa = function () {
                    var id = this.route.snapshot.params.id;
                ...
                return TongHopDuTruMuaThuocTaiKhoaSharedComponent;
            }());
            TongHopDuTruMuaThuocTaiKhoaSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaThuocTaiKhoaChiTietSharedComponent = /** @class */ (function () {
                function TongHopDuTruMuaThuocTaiKhoaChiTietSharedComponent(apiService, route) {
                    this.apiService = apiService;
                    this.route = route;
                    this.duTruMuaDuocPhamTaiKhoaChiTietVo = [];
                    this.duyetDuTruMuaDuocPhamViewModel = {};
                ...
                TongHopDuTruMuaThuocTaiKhoaChiTietSharedComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_3__["DocumentType"].DanhSachTongHopDuTruMuaDuocPhamTaiKhoa;
                ...
                TongHopDuTruMuaThuocTaiKhoaChiTietSharedComponent.prototype.getThongTinTongHopDuTruMuaTaiKhoa = function (id) {
                    var _this = this;
                    this.apiService.get("YeuCauMuaDuocPham/GetThongTinDuTruDuocPhamTaiKhoa/" + id)
                        .subscribe(function (resultData) {
                        if (resultData !== null && resultData !== undefined) {
                ...
                TongHopDuTruMuaThuocTaiKhoaChiTietSharedComponent.prototype.onDataBound = function (event) {
                    if (event != undefined && event.Data.length > 0) {
                        this.duTruMuaDuocPhamTaiKhoaChiTietVo = event.Data;
                    }
                };
                TongHopDuTruMuaThuocTaiKhoaChiTietSharedComponent.prototype.getSharedData = function () {
                    return this.danhSachTongHopDuTruMuaThuocTaiKhoa;
                };
                return TongHopDuTruMuaThuocTaiKhoaChiTietSharedComponent;
            }());
            TongHopDuTruMuaThuocTaiKhoaChiTietSharedComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaThuocTaiKhoaModule = /** @class */ (function () {
                function TongHopDuTruMuaThuocTaiKhoaModule() {
                }
                return TongHopDuTruMuaThuocTaiKhoaModule;
            }());
...
//# sourceMappingURL=nhap-xuat-duoc-pham-tong-hop-du-tru-mua-thuoc-tai-khoa-tong-hop-du-tru-mua-thuoc-tai-khoa-module-es5.js.map
//# sourceMappingURL=nhap-xuat-duoc-pham-tong-hop-du-tru-mua-thuoc-tai-khoa-tong-hop-du-tru-mua-thuoc-tai-khoa-module-es5.js.map