...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["xet-nghiem-goi-mau-xet-nghiem-goi-mau-xet-nghiem-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiMauXetNghiemChiTietComponent = /** @class */ (function () {
                function GoiMauXetNghiemChiTietComponent(dialog, router, route, authService, notificationService, apiService) {
                    this.dialog = dialog;
                    this.router = router;
                    this.route = route;
                ...
                GoiMauXetNghiemChiTietComponent.prototype.ngOnInit = function () {
                ...
                GoiMauXetNghiemChiTietComponent.prototype.getChiTietPhieuGoiMauXetNghiem = function (id) {
                    var _this = this;
                    this.apiService.get("XetNghiem/GetPhieuGoiMauXetNghiem?id=" + id).subscribe(function (res) {
                        ...
                        _this.router.navigate(['/xet-nghiem/goi-mau']);
                    });
                };
                ...
                // }
                GoiMauXetNghiemChiTietComponent.prototype.getTongSoLuongMauGoi = function (id) {
                    var _this = this;
                ...
                GoiMauXetNghiemChiTietComponent.prototype.getAdditionalSearchStringNhomDichVu = function (phieuGoiMauXetNghiemId) {
                ...
                //     }
                // }
                GoiMauXetNghiemChiTietComponent.prototype.getLoaiMauDisplay = function (dataItem) {
                    if (dataItem) {
                        return dataItem.LoaiMauXetNghiems.map(function (p) { return p.LoaiMauDisplay; }).join(', ');
                    }
                };
                GoiMauXetNghiemChiTietComponent.prototype.tooltipCustom = function (loaiMauXetNghiem) {
                    this.thongTinTuChoi = loaiMauXetNghiem;
                };
                GoiMauXetNghiemChiTietComponent.prototype.quayLai = function () {
                    this.router.navigateByUrl("/xet-nghiem/goi-mau?holdQuery=true");
                };
                return GoiMauXetNghiemChiTietComponent;
            }());
            GoiMauXetNghiemChiTietComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiMauXetNghiemListComponent = /** @class */ (function () {
                function GoiMauXetNghiemListComponent(dialog, router, route, location, authService, notificationService, apiService) {
                    this.dialog = dialog;
                    this.router = router;
                    this.route = route;
                ...
                GoiMauXetNghiemListComponent.prototype.ngOnInit = function () {
                ...
                //     return `{ PhienXetNghiemId: ${phienXetNghiemId}, NhomDichVuBenhVienId: ${nhomDichVuBenhVienId} }`
                // }
                GoiMauXetNghiemListComponent.prototype.keyEvent = function (event) {
                ...
                GoiMauXetNghiemListComponent.prototype.checkboxChange = function ($event, choNhanMau, daNhanMau) {
                ...
                GoiMauXetNghiemListComponent.prototype.clearSearch = function () {
                    if (this.goiMauXetNghiemSearch.SearchString == "" || this.goiMauXetNghiemSearch.SearchString == null) {
                        this.timKiem();
                    }
                };
                GoiMauXetNghiemListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                GoiMauXetNghiemListComponent.prototype.onKeyTuNgay = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                GoiMauXetNghiemListComponent.prototype.onKeyDenNgay = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                GoiMauXetNghiemListComponent.prototype.convertDateTimeToUTC = function () {
                ...
                GoiMauXetNghiemListComponent.prototype.reverseDateTime = function () {
                    if (this.goiMauXetNghiemSearch.RangeNgayGoiMau.startDate) {
                ...
                GoiMauXetNghiemListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                        ...
                        this.apiService.postExportExcel('XetNghiem/ExportGoiMauXetNghiem', this.gridDanhSachXetNghiem._gridQueryInfo).subscribe(function (resultData) {
                ...
                GoiMauXetNghiemListComponent.prototype.xoaPhieuGoiMauXetNghiem = function (dataItem) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_15__["ConfirmComponent"], {
                        ...
                        if (result == "Yes") {
                            _this.apiService.delete("XetNghiem/XoaPhieuGoiMauXetNghiem?id=" + dataItem.Id).subscribe(function (res) {
                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ['Xóa']));
                                _this.timKiem();
                            }, function (err) {
                                _this.notificationService.showError(err.Message);
                            });
                ...
                GoiMauXetNghiemListComponent.prototype.QuetMaQRCodeClick = function () {
                    var elementBarcode = document.getElementById("barcodeActive");
                    if (elementBarcode != undefined) {
                        elementBarcode.click();
                    }
                };
                GoiMauXetNghiemListComponent.prototype.changeQR = function (evt) {
                ...
                GoiMauXetNghiemListComponent.prototype.xemChiTiet = function (id) {
                ...
                GoiMauXetNghiemListComponent.prototype.timKiem = function () {
                ...
                GoiMauXetNghiemListComponent.prototype.getAdditionalSearchStringNhomDichVu = function (dataItem) {
                    this.convertDateTimeToUTC();
                    var query = JSON.stringify(this.goiMauXetNghiemSearch);
                    this.reverseDateTime();
                    return query.substr(0, query.length - 1) + ",\"PhieuGoiMauXetNghiemId\":\"" + dataItem.Id + "\"}";
                };
                return GoiMauXetNghiemListComponent;
            }());
            GoiMauXetNghiemListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiMauXetNghiemRoutingModule = /** @class */ (function () {
                function GoiMauXetNghiemRoutingModule() {
                }
                return GoiMauXetNghiemRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiMauXetNghiemModule = /** @class */ (function () {
                function GoiMauXetNghiemModule() {
                }
                return GoiMauXetNghiemModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiMauXetNghiemService = /** @class */ (function (_super) {
                __extends(GoiMauXetNghiemService, _super);
                function GoiMauXetNghiemService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'GoiMauXetNghiem';
                    return _this;
                }
                return GoiMauXetNghiemService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            GoiMauXetNghiemService.ctorParameters = function () { return [
...
//# sourceMappingURL=xet-nghiem-goi-mau-xet-nghiem-goi-mau-xet-nghiem-module-es5.js.map
//# sourceMappingURL=xet-nghiem-goi-mau-xet-nghiem-goi-mau-xet-nghiem-module-es5.js.map