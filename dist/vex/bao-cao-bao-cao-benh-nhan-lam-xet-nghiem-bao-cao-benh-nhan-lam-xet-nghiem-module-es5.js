...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-benh-nhan-lam-xet-nghiem-bao-cao-benh-nhan-lam-xet-nghiem-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBenhNhanLamXetNghiemListComponent = /** @class */ (function () {
                function BaoCaoBenhNhanLamXetNghiemListComponent(apiService, dialog, authService, notificationService) {
                ...
                BaoCaoBenhNhanLamXetNghiemListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoBenhNhanLamXetNghiemListComponent.prototype.pageChange = function (event) {
                    // this.skip = event;
                ...
                BaoCaoBenhNhanLamXetNghiemListComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                BaoCaoBenhNhanLamXetNghiemListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetDataBaoCaoBenhNhanLamXetNghiemForGridAsync", this.baoCaoSearch).subscribe(function (resultData) {
                ...
                return BaoCaoBenhNhanLamXetNghiemListComponent;
            }());
            BaoCaoBenhNhanLamXetNghiemListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBenhNhanLamXetNghiemPopupComponent = /** @class */ (function () {
                function BaoCaoBenhNhanLamXetNghiemPopupComponent(apiService, dialogRef, dialog, sanitizer, data) {
                    this.apiService = apiService;
                ...
                BaoCaoBenhNhanLamXetNghiemPopupComponent.prototype.ngOnInit = function () {
                    this.inBaoCaoBenhNhanLamXetNghiem = this.data;
                    this.showBaoCao();
                };
                BaoCaoBenhNhanLamXetNghiemPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                BaoCaoBenhNhanLamXetNghiemPopupComponent.prototype.showBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/InBaoCaoBenhNhanLamXetNghiem", this.inBaoCaoBenhNhanLamXetNghiem).subscribe(function (resultData) {
                ...
                BaoCaoBenhNhanLamXetNghiemPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        _this.apiService.post("BaoCao/InBaoCaoBenhNhanLamXetNghiem", _this.inBaoCaoBenhNhanLamXetNghiem).subscribe(function (resultData) {
                            resolve(resultData);
                        });
                        _this.close();
                    });
                };
                return BaoCaoBenhNhanLamXetNghiemPopupComponent;
            }());
            BaoCaoBenhNhanLamXetNghiemPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBenhNhanLamXetNghiemRoutingModule = /** @class */ (function () {
                function BaoCaoBenhNhanLamXetNghiemRoutingModule() {
                }
                return BaoCaoBenhNhanLamXetNghiemRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoBenhNhanLamXetNghiemSearch = /** @class */ (function () {
                function BaoCaoBenhNhanLamXetNghiemSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, KhoId, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                ...
                return BaoCaoBenhNhanLamXetNghiemSearch;
            }());
            var BaoCaoBenhNhanLamXetNghiem = /** @class */ (function () {
                function BaoCaoBenhNhanLamXetNghiem(STT, Ten, DVT, SLTonDauKy, ThanhTienTonDauKy, SLNhapTrongKy, ThanhTienNhapTrongKy, SLXuatTrongKy, ThanhTienXuatTrongKy, SLTonCuoiKy, Gia, ThanhTien) {
                ...
                return BaoCaoBenhNhanLamXetNghiem;
            }());
            var InBaoCaoBenhNhanLamXetNghiem = /** @class */ (function () {
                function InBaoCaoBenhNhanLamXetNghiem(KhoId, HostingName, FromDate, ToDate) {
                ...
                return InBaoCaoBenhNhanLamXetNghiem;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBenhNhanLamXetNghiemModule = /** @class */ (function () {
                function BaoCaoBenhNhanLamXetNghiemModule() {
                }
                return BaoCaoBenhNhanLamXetNghiemModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBenhNhanLamXetNghiemService = /** @class */ (function (_super) {
                __extends(BaoCaoBenhNhanLamXetNghiemService, _super);
                function BaoCaoBenhNhanLamXetNghiemService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoBenhNhanLamXetNghiemService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoBenhNhanLamXetNghiemService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
            ]; };
...
//# sourceMappingURL=bao-cao-bao-cao-benh-nhan-lam-xet-nghiem-bao-cao-benh-nhan-lam-xet-nghiem-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-benh-nhan-lam-xet-nghiem-bao-cao-benh-nhan-lam-xet-nghiem-module-es5.js.map