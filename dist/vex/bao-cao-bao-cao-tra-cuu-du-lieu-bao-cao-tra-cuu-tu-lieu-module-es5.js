...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-tra-cuu-du-lieu-bao-cao-tra-cuu-tu-lieu-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTraCuuDuLieuRoutingModule = /** @class */ (function () {
                function BaoCaoTraCuuDuLieuRoutingModule() {
                }
                return BaoCaoTraCuuDuLieuRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoTraCuuDuLieu = /** @class */ (function () {
                function BaoCaoTraCuuDuLieu(FromDate, ToDate, TuNgayFormat, DenNgayFormat, KhoId, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTraCuuDuLieuComponent = /** @class */ (function () {
                function BaoCaoTraCuuDuLieuComponent(apiService, dialog, authService, notificationService) {
                ...
                BaoCaoTraCuuDuLieuComponent.prototype.pageChange = function (event) {
                    this.baoCaoSearch.Skip = event.skip;
                    this.skip = event.skip;
                    //this.XemBaoCao();
                };
                BaoCaoTraCuuDuLieuComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoTraCuuDuLieuComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoTraCuuDuLieuComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoTraCuuDuLieuComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoTraCuuDuLieuComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoTraCuuDuLieuComponent.prototype.detailExpand = function (event) {
                ...
                BaoCaoTraCuuDuLieuComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                BaoCaoTraCuuDuLieuComponent.prototype.xemBaoCao = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                BaoCaoTraCuuDuLieuComponent.prototype.changeValueStart = function () {
                ...
                BaoCaoTraCuuDuLieuComponent.prototype.showLoadingPopup = function () {
                ...
                BaoCaoTraCuuDuLieuComponent.prototype.showSavingPopup = function () {
                    if (!this.loadingPopup) {
                        this.loadingPopup = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_7__["LoadingComponent"], {
                            disableClose: true,
                            width: '200px',
                ...
                BaoCaoTraCuuDuLieuComponent.prototype.closeAllDialogs = function () {
                    if (this.loadingPopup) {
                        this.loadingPopup.close();
                        this.loadingPopup = null;
                    }
                };
                return BaoCaoTraCuuDuLieuComponent;
            }());
            BaoCaoTraCuuDuLieuComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTraCuuDuLieuModule = /** @class */ (function () {
                function BaoCaoTraCuuDuLieuModule() {
                }
                return BaoCaoTraCuuDuLieuModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var BaoCaoTraCuuDuLieuKeService = /** @class */ (function (_super) {
                __extends(BaoCaoTraCuuDuLieuKeService, _super);
                function BaoCaoTraCuuDuLieuKeService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCaoThucHienCls';
                    return _this;
                }
                return BaoCaoTraCuuDuLieuKeService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            BaoCaoTraCuuDuLieuKeService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
...
//# sourceMappingURL=bao-cao-bao-cao-tra-cuu-du-lieu-bao-cao-tra-cuu-tu-lieu-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-tra-cuu-du-lieu-bao-cao-tra-cuu-tu-lieu-module-es5.js.map