...
let QuanLyTenBenhVienCreateComponent = class QuanLyTenBenhVienCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
QuanLyTenBenhVienCreateComponent.ctorParameters = () => [
...
let QuanLyTenBenhVienListComponent = class QuanLyTenBenhVienListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('BenhVien/ExportBenhVien', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
QuanLyTenBenhVienListComponent.ctorParameters = () => [
...
let QuanLyTenBenhVienRoutingModule = class QuanLyTenBenhVienRoutingModule {
};
...
let QuanLyTenBenhVienShareComponent = class QuanLyTenBenhVienShareComponent {
...
QuanLyTenBenhVienShareComponent.ctorParameters = () => [
...
let QuanLyTenBenhVienUpdateComponent = class QuanLyTenBenhVienUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
QuanLyTenBenhVienUpdateComponent.ctorParameters = () => [
...
let QuanLyTenBenhVienModule = class QuanLyTenBenhVienModule {
};
...
let QuanLyTenBenhVienService = class QuanLyTenBenhVienService extends _app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BenhVien';
    }
};
QuanLyTenBenhVienService.ctorParameters = () => [
