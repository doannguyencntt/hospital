...
let BaoCaoBenhNhanKhamNgoaiTruRoutingModule = class BaoCaoBenhNhanKhamNgoaiTruRoutingModule {
};
...
let BaoCaoBenhNhanKhamNgoaiTruModule = class BaoCaoBenhNhanKhamNgoaiTruModule {
};
...
let BaoCaoBenhNhanKhamNgoaiTruService = class BaoCaoBenhNhanKhamNgoaiTruService {
    constructor() { }
};
...
let BaoCaoBsDsKhamNgoaiTruPopupComponent = class BaoCaoBsDsKhamNgoaiTruPopupComponent {
...
BaoCaoBsDsKhamNgoaiTruPopupComponent.ctorParameters = () => [
...
class SearchBaoCao {
    constructor(PhongId = null, KhoaId = null, DateStart = null, DateEnd = null, TenKhoa = null, TenPhong = null) {
...
class BaoCaoBenhNhanKhamNgoaiTruAnVo {
    constructor(PhongId = 0, KhoaId = 0, TuNgay = null, DenNgay = null, hosting = null) {
        this.PhongId = PhongId;
        this.KhoaId = KhoaId;
        this.TuNgay = TuNgay;
...
let BaoCaoBsDsKhamNgoaiTruComponent = class BaoCaoBsDsKhamNgoaiTruComponent {
    constructor(route, router, apiService, dialog, notificationService, authService, ref) {
        this.route = route;
        this.router = router;
    ...
    theFirstValueFormatTotalGroup(str) {
        let strGroup = str.split('/');
        if (strGroup.length != 0) {
            return strGroup[1];
        }
    ...
    XemBaoCao() {
        ...
        let baoCaoBenhNhanKhamNgoaiTruAnVo = new _bao_cao_bs_ds_kham_ngoai_tru_model__WEBPACK_IMPORTED_MODULE_12__["BaoCaoBenhNhanKhamNgoaiTruAnVo"]();
        ...
        this.apiService.post("BaoCao/GetBaoCaoBenhNhanKhamNgoaiTruForGridAsync", baoCaoBenhNhanKhamNgoaiTruAnVo).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                if (resultData.TotalRowCount !== undefined && resultData.TotalRowCount != 0) {
                    this.showPrintExport = true;
                }
                this.showGrid = true;
                this.gridDataSource = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_13__["process"])(resultData.Data, this.state);
    ...
    InbaoCao() {
        if (this.showPrintExport == true) {
            ...
            this.apiService.post("BaoCao/InBaoCaoBenhNhanKhamNgoaiTru", baoCaoBenhNhanKhamNgoaiTruAnVo).subscribe((result) => {
                this.dialog.open(_bao_cao_bs_ds_kham_ngoai_tru_popup_bao_cao_bs_ds_kham_ngoai_tru_popup_component__WEBPACK_IMPORTED_MODULE_11__["BaoCaoBsDsKhamNgoaiTruPopupComponent"], {
                    disableClose: true,
                    width: '1000px',
                    data: { Model: result }
    ...
    XuatBaoCao() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('BaoCao/ExportBaoCaoBenhNhanKhamNgoaiTru', baoCaoBenhNhanKhamNgoaiTruAnVo).subscribe(resultData => {
...
BaoCaoBsDsKhamNgoaiTruComponent.ctorParameters = () => [
