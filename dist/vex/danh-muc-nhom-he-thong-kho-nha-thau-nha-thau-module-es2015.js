...
let NhaThauCreateComponent = class NhaThauCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
NhaThauCreateComponent.ctorParameters = () => [
...
let NhaThauListComponent = class NhaThauListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('NhaThau/ExportNhaThau', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
NhaThauListComponent.ctorParameters = () => [
...
let NhaThauRoutingModule = class NhaThauRoutingModule {
};
...
let NhaThauSharedComponent = class NhaThauSharedComponent {
...
NhaThauSharedComponent.ctorParameters = () => [
...
let NhaThauUpdateComponent = class NhaThauUpdateComponent {
...
NhaThauUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let NhaThauModule = class NhaThauModule {
};
...
let NhaThauService = class NhaThauService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'NhaThau';
    }
};
NhaThauService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
