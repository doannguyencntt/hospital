...
let KhamDoanKhthDuyetDetailPopupComponent = class KhamDoanKhthDuyetDetailPopupComponent {
    ...
    xuLyDuyet() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmComponent"], {
                ...
                if (result === 'Yes') {
                    this.apiService
                        .get(`KhamDoan/DuyetKhth?id=${this.id}`)
                        // tslint:disable-next-line: deprecation
                        .subscribe(() => {
...
KhamDoanKhthDuyetDetailPopupComponent.ctorParameters = () => [
...
let KhamDoanKhthDuyetListComponent = class KhamDoanKhthDuyetListComponent {
    ...
    ngOnInit() {
        ...
        if (holdQuery && src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_15__["LocalStorageHelper"].getItem('additionalSearchStringDanhSachKHTHDuyetYeuCauNhanSuKhamSucKhoe')) {
            const additionalSearchString = src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_15__["LocalStorageHelper"].getItem('additionalSearchStringDanhSachKHTHDuyetYeuCauNhanSuKhamSucKhoe');
...
KhamDoanKhthDuyetListComponent.ctorParameters = () => [
...
let KhamDoanKhthDuyetRoutingModule = class KhamDoanKhthDuyetRoutingModule {
};
...
let KhamDoanKhthDuyetTuChoiPopupComponent = class KhamDoanKhthDuyetTuChoiPopupComponent {
...
KhamDoanKhthDuyetTuChoiPopupComponent.ctorParameters = () => [
...
class KhamDoanKhthDuyetTimKiem {
    constructor(SearchString = null, TrangThai = new KhamDoanKhthDuyetTimKiemTrangThai(), NgayGui = new KhamDoanKhthDuyetTimKiemDateRange(), NgayKHTHDuyet = new KhamDoanKhthDuyetTimKiemDateRange(), NgayNhanSuDuyet = new KhamDoanKhthDuyetTimKiemDateRange(), NgayGiamDocDuyet = new KhamDoanKhthDuyetTimKiemDateRange()) {
...
class KhamDoanKhthDuyetTimKiemTrangThai {
...
class KhamDoanKhthDuyetTimKiemDateRange {
...
let KhamDoanKhthDuyetModule = class KhamDoanKhthDuyetModule {
};
