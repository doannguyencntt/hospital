...
let DuyetYeuCauLinhThuocBuSharedComponent = class DuyetYeuCauLinhThuocBuSharedComponent {
    constructor(apiService, route, notificationService) {
    ...
    getById(id) {
        this.apiService.get("YeuCauLinhDuocPham/GetYeuCauLinhDuocPhamBu?id=" + id)
            ...
            if (resultData !== undefined && resultData != null) {
                ...
                this.trangThaiYeuCau.emit(new _duyet_yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_5__["TrangThaiDuyetYeuCauLinh"](this.yeuCauLinh.TenTrangThai, this.yeuCauLinh.DuocDuyet));
                this.gridColumns = [
                    { Field: "STT", Title: "#", Width: 60, Template: this.sttTemplate },
                    { Field: "TenDuocPham", Title: "Tên dược phẩm", Width: 180 },
                    { Field: "Nhom", Title: "Nhóm", Width: 100, Sortable: true, Hidden: true, TemplateGroupHeader: this.nhomGroupHeaderTemplate },
...
DuyetYeuCauLinhThuocBuSharedComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhThuocBuComponent = class DuyetYeuCauLinhThuocBuComponent {
    constructor(dialog, apiService, location, notificationService, router, route) {
        this.dialog = dialog;
        this.apiService = apiService;
        ...
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_3__["ConfirmComponent"], {
            ...
            if (result === 'Yes') {
                ...
                this.apiService.post("YeuCauLinhDuocPham/XuLyDuyetYeuCauLinhDuocPhamBu", this.yeuCauLinhThuoc)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["SystemMessage"].ActionSuccessfully, ["Duyệt"]));
                    if (resultData != undefined && resultData != null) {
                        this.dialog.open(_phieu_xuat_linh_thuoc_popup_phieu_xuat_linh_thuoc_popup_component__WEBPACK_IMPORTED_MODULE_8__["PhieuXuatLinhThuocPopupComponent"], {
                            disableClose: false,
                            width: '1200px',
                            data: resultData,
                        }).afterClosed().subscribe(result => {
        ...
        this.dialog.open(_khong_duyet_popup_khong_duyet_popup_component__WEBPACK_IMPORTED_MODULE_7__["KhongDuyetPopupComponent"], {
            ...
            if (result !== null) {
                ...
                this.apiService.post("YeuCauLinhDuocPham/XuLyKhongDuyetYeuCauLinhDuocPhamBu", this.yeuCauLinhThuoc)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_16__["SystemMessage"].ActionSuccessfully, ["Không duyệt"]));
                    this.quayVeDanhSach();
                }, (err) => {
                    if (err.Message != "Validation Failed") {
                        this.notificationService.showError(err.Message);
...
DuyetYeuCauLinhThuocBuComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhThuocListComponent = class DuyetYeuCauLinhThuocListComponent {
    constructor(dialog, router, apiService, authService, notificationService, cd, location, route) {
        this.dialog = dialog;
        this.router = router;
        this.apiService = apiService;
    ...
    xemChiTietYeuCauLinh(id, loaiPhieuLinh) {
    ...
    exportExcel() {
        ...
        self.apiService.postExportExcel('YeuCauLinhDuocPham/ExportDanhSachDuyetLinhDuocPham', self.exportQueryInfoQueryInfo).subscribe(resultData => {
    ...
    InDuocPham(dataItem, loaiPhieuLinh) {
        this.apiService.post("YeuCauLinhDuocPham/InYeuCauLinhDuocPhamTrucTiep?yeuCauLinhId=" + dataItem + "&loaiPhieuLinh=" + loaiPhieuLinh)
            .subscribe((resultData) => {
            if (resultData != undefined && resultData != null) {
                this.dialog.open(_phieu_xuat_linh_thuoc_popup_phieu_xuat_linh_thuoc_popup_component__WEBPACK_IMPORTED_MODULE_23__["PhieuXuatLinhThuocPopupComponent"], {
                    disableClose: false,
                    width: '1200px',
                    data: resultData,
                }).afterClosed().subscribe(result => {
...
DuyetYeuCauLinhThuocListComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhThuocRoutingModule = class DuyetYeuCauLinhThuocRoutingModule {
};
...
let DuyetYeuCauLinhThuocThuongSharedComponent = class DuyetYeuCauLinhThuocThuongSharedComponent {
    constructor(apiService, route, notificationService) {
        this.apiService = apiService;
        this.route = route;
        this.notificationService = notificationService;
    ...
    getById(id) {
        this.apiService.get("YeuCauLinhDuocPham/GetYeuCauLinhDuocPhamThuong?id=" + id)
            ...
            if (resultData !== undefined && resultData != null) {
                ...
                this.trangThaiYeuCau.emit(new _duyet_yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_6__["TrangThaiDuyetYeuCauLinh"](this.yeuCauLinh.TenTrangThai, this.yeuCauLinh.DuocDuyet));
                this.gridDataSource = {
...
DuyetYeuCauLinhThuocThuongSharedComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhThuocThuongComponent = class DuyetYeuCauLinhThuocThuongComponent {
    constructor(dialog, location, apiService, notificationService, router, route) {
        this.dialog = dialog;
        this.location = location;
        this.apiService = apiService;
        this.notificationService = notificationService;
        ...
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
            ...
            if (result === 'Yes') {
                ...
                this.apiService.post("YeuCauLinhDuocPham/XuLyDuyetYeuCauLinhDuocPhamThuong", this.yeuCauLinhThuoc)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ["Duyệt"]));
                    if (resultData != undefined && resultData != null) {
                        this.dialog.open(_phieu_xuat_linh_thuoc_popup_phieu_xuat_linh_thuoc_popup_component__WEBPACK_IMPORTED_MODULE_7__["PhieuXuatLinhThuocPopupComponent"], {
                            disableClose: false,
                            width: '1200px',
                            data: resultData,
                        }).afterClosed().subscribe(result => {
        ...
        this.dialog.open(_khong_duyet_popup_khong_duyet_popup_component__WEBPACK_IMPORTED_MODULE_6__["KhongDuyetPopupComponent"], {
            ...
            if (result !== null) {
                ...
                this.apiService.post("YeuCauLinhDuocPham/XuLyKhongDuyetYeuCauLinhDuocPhamThuong", this.yeuCauLinhThuoc)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ["Không duyệt"]));
                    this.quayVeDanhSach();
                }, (err) => {
                    this.validationErrors = err.ValidationErrors;
                    if (err.Message != "Validation Failed") {
...
DuyetYeuCauLinhThuocThuongComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] },
...
let DuyetYeuCauLinhThuocTrucTiepSharedComponent = class DuyetYeuCauLinhThuocTrucTiepSharedComponent {
    constructor(apiService, route, notificationService) {
        this.apiService = apiService;
        this.route = route;
        this.notificationService = notificationService;
    ...
    getById(id) {
        this.apiService.get("YeuCauLinhDuocPham/GetYeuCauLinhDuocPhamTrucTiep?id=" + id)
            ...
            if (resultData !== undefined && resultData != null) {
                this.yeuCauLinh = resultData;
                this.trangThaiYeuCau.emit(new _duyet_yeu_cau_linh_thuoc_model__WEBPACK_IMPORTED_MODULE_4__["TrangThaiDuyetYeuCauLinh"](this.yeuCauLinh.TenTrangThai, this.yeuCauLinh.DuocDuyet));
...
DuyetYeuCauLinhThuocTrucTiepSharedComponent.ctorParameters = () => [
...
let DuyetYeuCauLinhThuocTrucTiepComponent = class DuyetYeuCauLinhThuocTrucTiepComponent {
    constructor(dialog, location, apiService, notificationService, router, route) {
        this.dialog = dialog;
        this.location = location;
        this.apiService = apiService;
        ...
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
            ...
            if (result === 'Yes') {
                ...
                this.apiService.post("YeuCauLinhDuocPham/XuLyDuyetYeuCauLinhDuocPhamTrucTiep", this.yeuCauLinhThuoc)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["SystemMessage"].ActionSuccessfully, ["Duyệt"]));
                    if (resultData != undefined && resultData != null) {
                        this.dialog.open(_phieu_xuat_linh_thuoc_popup_phieu_xuat_linh_thuoc_popup_component__WEBPACK_IMPORTED_MODULE_7__["PhieuXuatLinhThuocPopupComponent"], {
                            disableClose: false,
                            width: '1200px',
        ...
        this.dialog.open(_khong_duyet_popup_khong_duyet_popup_component__WEBPACK_IMPORTED_MODULE_6__["KhongDuyetPopupComponent"], {
            ...
            if (result !== null) {
                ...
                this.apiService.post("YeuCauLinhDuocPham/XuLyKhongDuyetYeuCauLinhDuocPhamTrucTiep", this.yeuCauLinhThuoc)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_15__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["SystemMessage"].ActionSuccessfully, ["Không duyệt"]));
                    this.quayVeDanhSach();
                }, (err) => {
                    if (err.Message != "Validation Failed") {
                        this.notificationService.showError(err.Message);
...
DuyetYeuCauLinhThuocTrucTiepComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_16__["Location"] },
...
class DuyetYeuCauLinhDuocPham {
    constructor(Id = null, KhoXuatId = null, TenKhoXuat = null, KhoNhapId = null, TenKhoNhap = null, LoaiPhieuLinh = null, TenLoaiPhieuLinh = null, NhanVienYeuCauId = null, TenNhanVienYeuCau = null, NhanVienDuyetId = null, TenNhanVienDuyet = null, NgayYeuCau = null, NgayDuyet = null, GhiChu = null, NguoiXuatKhoId = null, TenNguoiXuatKho = null, NguoiNhapKhoId = null, TenNguoiNhapKho = null, isHideDuyet = false, DuocDuyet = null, TenTrangThai = null, LyDoKhongDuyet = null, DuyetYeuCauLinhDuocPhamChiTiets = [], LastModified = null) {
        this.Id = Id;
...
class DuyetYeuCauLinhDuocPhamChiTiet {
    constructor(DuocPhamBenhVienId = null, LaDuocPhamBHYT = null, TenDuocPham = null, NongDoHamLuong = null, HoatChat = null, DuongDung = null, DVT = null, HangSanXuat = null, NuocSanXuat = null, SLTon = null, SoLuong = null, SoLuongCoTheXuat = null, Nhom = null, Index = null) {
...
class LinhVatTuGridVo {
    constructor(NgayYeuCauRangDateStartDate = null, NgayYeuCauRangDateStartEnd = null, NgayDuyetRangDateStartDate = null, NgayDuyetRangDateStartEnd = null, Searching = null, TrangThaiCheck = null, 
    // public DangChoGoi: boolean = true,
    DangChoDuyet = true, TuChoiDuyet = null, DaDuyet = null) {
...
let DuyetYeuCauLinhThuocModule = class DuyetYeuCauLinhThuocModule {
};
...
let KhongDuyetPopupComponent = class KhongDuyetPopupComponent {
...
KhongDuyetPopupComponent.ctorParameters = () => [
...
let PhieuXuatLinhThuocPopupComponent = class PhieuXuatLinhThuocPopupComponent {
    constructor(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    ...
    getSharedPrintForm() {
        ...
        const templateHeaderGayNghien = "<div class=\'wrap\'><div class=\'content\'>PHIẾU XUẤT THUỐC</div></div>";
...
PhieuXuatLinhThuocPopupComponent.ctorParameters = () => [
