...
let DanTocCreateComponent = class DanTocCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
DanTocCreateComponent.ctorParameters = () => [
...
let DanTocListComponent = class DanTocListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_4__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("DanToc/ExportDanToc", this.gridChild._gridQueryInfo).subscribe(res => {
...
DanTocListComponent.ctorParameters = () => [
...
let DanTocRoutingModule = class DanTocRoutingModule {
};
...
let DanTocSharedComponent = class DanTocSharedComponent {
...
DanTocSharedComponent.ctorParameters = () => [
...
let DanTocUpdateComponent = class DanTocUpdateComponent {
...
DanTocUpdateComponent.ctorParameters = () => [
...
let DanTocModule = class DanTocModule {
};
...
let DanTocService = class DanTocService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'DanToc';
    }
};
DanTocService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
