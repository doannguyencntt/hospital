...
let KhamDoanTatCaPhongDetailComponent = class KhamDoanTatCaPhongDetailComponent {
    constructor(dialog, apiService, authService, notificationService, ref, route, router, location, broadcastService) {
        this.dialog = dialog;
    ...
    ngOnInit() {
        ...
        if (!hasLocalSearchString) {
            ...
            if (menuInfo.HinhThucKhamBenh != src_app_shared_enum_kham_doan_enum__WEBPACK_IMPORTED_MODULE_11__["HinhThucKhamBenh"].KhamDoanNgoaiVien) {
    ...
    refreshPage() {
        ...
        this.router.navigateByUrl('/', { skipLocationChange: true }).then(() => this.router.navigate([currentUrl], { queryParams: queryParams }));
    }
    loadThongTinKhamDoanKhamBenh() {
        this.refreshHangDoiHienTai();
        this.getBenhNhanDangKham(this.benhNhanHienTai.Id);
    }
    refreshHangDoiHienTai(showPopupLoading = false) {
    ...
    getBenhNhanDangKham(hangDoiId, isLoading = true) {
        this.closePopupLoadingData();
        this.benhNhanHienTai = new _kham_benh_model__WEBPACK_IMPORTED_MODULE_13__["BenhVienHangDoi"]();
    ...
    processDynamicComponent(thongTinTempLateObj = null) {
        ...
        if (thongTinKhamTheoDichVuTemplateObj !== null) {
            thongTinKhamTheoDichVuTemplateObj.ComponentDynamics.forEach((item) => {
    ...
    bindDataDynamicComponent(thongTinTempLateObj = null, thongTinDataObj = null) {
        let tempplate = this.benhNhanHienTai.YeuCauKhamBenh.TemplateDichVuKhamSucKhoes.find(x => x.IsDungChuyenKhoaLogin);
        if (tempplate != null) {
            this.benhNhanHienTai.YeuCauKhamBenh.ThongTinKhamTheoDichVuTemplateObj
                = tempplate.TemplateKhamCacCoQuanObj != null && tempplate.TemplateKhamCacCoQuanObj != "" ? Object.assign({}, tempplate.TemplateKhamCacCoQuanObj) : null;
    ...
    chuyenDen(element, event, isKhamDoan = false) {
        var self = this;
        // setTimeout(function () {
    ...
    saveChangeData(hangDoiId = null, luaChonHoanThanhKham = null, phieuIn = null, chuyenPhong = null, isLoading = true) {
        //this.closePopupLoadingData();
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
            this.benhNhanHienTai.validationErrors = null;
            this.ref.detectChanges();
            ...
            this.apiService
                ...
                if (!this.isUpdateTimeSaveChuyenKhoaKSK) {
                    ...
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, [mess]));
                }
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_25__["ConfirmComponent"], {
                ...
                if (res == "Yes") {
                    ...
                    this.apiService.put("KhamBenh/KiemTraDichVuKhamDoanChuaThucHien", kiemTraVo).subscribe(resultData => {
                        ...
                        if (resultData && (resultData.DichVuKhamBenhs.length > 0 || resultData.DichVuKyThuats.length > 0)) {
                            this.dialog.open(_kham_doan_tat_ca_phong_dv_chua_thuc_hien_popup_kham_doan_tat_ca_phong_dv_chua_thuc_hien_popup_component__WEBPACK_IMPORTED_MODULE_26__["KhamDoanTatCaPhongDvChuaThucHienPopupComponent"], {
                                disableClose: false,
                                width: '750px',
                                data: resultData,
    ...
    inKetQuaKSK() {
        this.apiService.post("KhamDoan/GetDataKetQuaKSKDoanEdit?hopDongKhamSucKhoeId=" + this.benhNhanHienTai.YeuCauTiepNhan.HopDongKhamSucKhoeNhanVienId).subscribe((resData) => {
            if (resData != undefined && resData != null) {
                let dialogRef = this.dialog.open(_kham_doan_kham_doan_ket_luan_popup_ket_qua_ksk_edit_popup_ket_qua_ksk_edit_component__WEBPACK_IMPORTED_MODULE_23__["PopupKetQuaKskEditComponent"], {
                    disableClose: false,
                    width: '1500px',
                    height: 'auto',
                    data: {
...
KhamDoanTatCaPhongDetailComponent.ctorParameters = () => [
...
let KhamDoanTatCaPhongDvChuaThucHienPopupComponent = class KhamDoanTatCaPhongDvChuaThucHienPopupComponent {
...
KhamDoanTatCaPhongDvChuaThucHienPopupComponent.ctorParameters = () => [
...
let KhamDoanTatCaPhongRoutingModule = class KhamDoanTatCaPhongRoutingModule {
};
...
class KhamDoanTatCaPhongTimKiemNangCao {
    constructor(CongTyId = null, HopDongId = null, SearchString = null, HopDongKhamNhanVienId = null) {
...
let KhamDoanTatCaPhongModule = class KhamDoanTatCaPhongModule {
};
