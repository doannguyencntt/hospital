...
let LichSuSMSListComponent = class LichSuSMSListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("LichSuSMS/ExportLichSuSMS", this.gridChild._gridQueryInfo).subscribe(res => {
...
LichSuSMSListComponent.ctorParameters = () => [
...
let LichSuSMSRoutingModule = class LichSuSMSRoutingModule {
};
...
class LichSuSMS {
    constructor(GoiDen = null, NoiDung = null, TenTrangThai = "Tất cả", NgayGui = null, TuNgay = null, DenNgay = null, TrangThai = 0) {
        this.GoiDen = GoiDen;
...
let LichSuSMSModule = class LichSuSMSModule {
};
...
let LichSuSMSService = class LichSuSMSService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiservice) {
        super(apiservice);
        this.controllerName = 'LichSuSMS';
    }
};
LichSuSMSService.ctorParameters = () => [
