...
let ThongTinVatTuYTePopupComponent = class ThongTinVatTuYTePopupComponent {
    constructor(data) {
        this.data = data;
...
ThongTinVatTuYTePopupComponent.ctorParameters = () => [
...
let VatTuYTeChonFilePopupComponent = class VatTuYTeChonFilePopupComponent {
    constructor(dialog, dialogRef, cdRef, notificationService, apiService) {
        this.dialog = dialog;
    ...
    xuLyFile() {
        ...
        if (this.fileExcel != undefined && this.fileExcel != null) {
            ...
            self.apiService.get("VatTu/ImportVatTu", params).subscribe((resp) => {
                if (resp) {
...
VatTuYTeChonFilePopupComponent.ctorParameters = () => [
...
let VatTuYTeCreateComponent = class VatTuYTeCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
VatTuYTeCreateComponent.ctorParameters = () => [
...
let VatTuYTeListComponent = class VatTuYTeListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("VatTu/ExportVatTu", this.gridChild._gridQueryInfo).subscribe(res => {
    ...
    NhapTuFileExcel() {
        this.dialog.open(_vat_tu_y_te_chon_file_popup_vat_tu_y_te_chon_file_popup_component__WEBPACK_IMPORTED_MODULE_21__["VatTuYTeChonFilePopupComponent"], {
            ...
            if (result != undefined && result != null && result.length > 0) {
                this.dialog.open(_thong_tin_vat_tu_y_te_popup_thong_tin_vat_tu_y_te_popup_component__WEBPACK_IMPORTED_MODULE_22__["ThongTinVatTuYTePopupComponent"], {
                    disableClose: false,
                    width: '800px',
...
VatTuYTeListComponent.ctorParameters = () => [
...
let VatTuYTeRoutingModule = class VatTuYTeRoutingModule {
};
...
let VatTuYTeSharedComponent = class VatTuYTeSharedComponent {
...
VatTuYTeSharedComponent.ctorParameters = () => [
...
let VatTuYTeUpdateComponent = class VatTuYTeUpdateComponent {
...
VatTuYTeUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
class VatTuYTe {
    constructor(Ten = null, Ma = null, NhomVatTuId = null, NhomVatTuModelText = null, DonViTinh = null, TyLeBaoHiemThanhToan = null, QuyCach = null, NhaSanXuat = null, NuocSanXuat = null, MoTa = null, IsDisabled = false, SuDungVatTuBenhVien = true, LoaiSuDung = null, LoaiSuDungText = null, MaVatTuBenhVien = null, DieuKienBaoHiemThanhToan = null, HeSoDinhMucDonViTinh = null, VatTuBenhViewModel = null, 
    //BVHD-3472
    ChuaTaoVatTuBenhVien = true) {
        this.Ten = Ten;
        this.Ma = Ma;
...
class VatTuBenhViewModel {
    constructor(Id = 0, MaVatTuBenhVien = null, LoaiSuDung = null) {
        this.Id = Id;
        this.MaVatTuBenhVien = MaVatTuBenhVien;
        this.LoaiSuDung = LoaiSuDung;
    }
...
class ThongTinError {
    constructor(Ma = null, Ten = null, TotalThanhCong = null, Error = null) {
        this.Ma = Ma;
        this.Ten = Ten;
...
let VatTuYTeModule = class VatTuYTeModule {
};
...
let VatTuYTeService = class VatTuYTeService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'VatTu';
    }
};
VatTuYTeService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
