...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-ly-do-tiep-nhan-ly-do-tiep-nhan-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LyDoTiepNhanCreateComponent = /** @class */ (function () {
                function LyDoTiepNhanCreateComponent(router) {
                    this.router = router;
                }
                LyDoTiepNhanCreateComponent.prototype.ngOnInit = function () {
                };
                LyDoTiepNhanCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/ly-do-tiep-nhan']);
                };
                return LyDoTiepNhanCreateComponent;
            }());
            LyDoTiepNhanCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LyDoTiepNhanListComponent = /** @class */ (function () {
                function LyDoTiepNhanListComponent(baseService, apiService, router, authService, notificationService, dialog) {
                ...
                LyDoTiepNhanListComponent.prototype.iconClass = function (_a) {
                    var text = _a.text, LyDoTiepNhanChildList = _a.LyDoTiepNhanChildList;
                    return {
                ...
                LyDoTiepNhanListComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.baseService.getDataForGrid(this._gridQueryInfo, "LyDoTiepNhan/GetDataTreeView").subscribe(function (resultData) {
                ...
                LyDoTiepNhanListComponent.prototype.search = function () {
                    var _this = this;
                    this._skip = 0;
                ...
                LyDoTiepNhanListComponent.prototype.searchChanges = function () {
                    if (this.searchString == null || this.searchString == "") {
                        this.searchString = "";
                        this.search();
                    }
                };
                LyDoTiepNhanListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.search();
                    }
                };
                LyDoTiepNhanListComponent.prototype.add = function () {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].Add)) {
                        if (this.formIsPopup) {
                            this.dialog.open(this.componentCreate).afterClosed().subscribe(function () {
                            });
                        }
                        else {
                ...
                LyDoTiepNhanListComponent.prototype.Addchildren = function (id) {
                ...
                LyDoTiepNhanListComponent.prototype.edit = function (id) {
                ...
                LyDoTiepNhanListComponent.prototype.mySelectionAfterDelete = function (id) {
                ...
                LyDoTiepNhanListComponent.prototype.delete = function (id) {
                    var _this = this;
                    var self = this;
                ...
                return LyDoTiepNhanListComponent;
            }());
            LyDoTiepNhanListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LyDoTiepNhanRoutingModule = /** @class */ (function () {
                function LyDoTiepNhanRoutingModule() {
                }
                return LyDoTiepNhanRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LyDoTiepNhanSharedComponent = /** @class */ (function () {
                function LyDoTiepNhanSharedComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.lyDo = {};
                ...
                LyDoTiepNhanSharedComponent.prototype.ngOnInit = function () {
                ...
                LyDoTiepNhanSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    if (this.isShowView == "true") {
                        ...
                        this.baseService.getById(id).subscribe(function (result) {
                            //console.log(result)
                            _this.lyDo = result;
                            _this.lyDo.LyDoTiepNhanChaId = _this.lyDo.Id;
                            _this.lyDo.Id = 0;
                            _this.lyDo.Ten = null;
                        ...
                        this.baseService.getById(id).subscribe(function (resultData) {
                            if (resultData !== null && resultData !== undefined) {
                                _this.lyDo = resultData;
                            }
                        });
                    }
                };
                LyDoTiepNhanSharedComponent.prototype.getSharedData = function () {
                    // console.log(this.trieuChung);
                    return this.lyDo;
                };
                return LyDoTiepNhanSharedComponent;
            }());
            LyDoTiepNhanSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _ly_do_tiep_nhan_shared_ly_do_tiep_nhan_shared_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ly-do-tiep-nhan-shared/ly-do-tiep-nhan-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/benh-vien/ly-do-tiep-nhan/ly-do-tiep-nhan-shared/ly-do-tiep-nhan-shared.component.ts");
            var LyDoTiepNhanUpdateComponent = /** @class */ (function () {
                function LyDoTiepNhanUpdateComponent(router) {
                    this.router = router;
                }
                LyDoTiepNhanUpdateComponent.prototype.ngOnInit = function () {
                };
                LyDoTiepNhanUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/ly-do-tiep-nhan']);
                };
                return LyDoTiepNhanUpdateComponent;
            }());
            LyDoTiepNhanUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_ly_do_tiep_nhan_shared_ly_do_tiep_nhan_shared_component__WEBPACK_IMPORTED_MODULE_3__["LyDoTiepNhanSharedComponent"], { static: true })
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var LyDoTiepNhan = /** @class */ (function () {
                function LyDoTiepNhan(Id, Ten, TenCha, LyDoTiepNhanChaId, CapNhom, MoTa) {
                    if (Id === void 0) { Id = 0; }
                    if (Ten === void 0) { Ten = null; }
                    if (TenCha === void 0) { TenCha = null; }
                    if (LyDoTiepNhanChaId === void 0) { LyDoTiepNhanChaId = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LyDoTiepNhanModule = /** @class */ (function () {
                function LyDoTiepNhanModule() {
                }
                return LyDoTiepNhanModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LyDoTiepNhanService = /** @class */ (function (_super) {
                __extends(LyDoTiepNhanService, _super);
                function LyDoTiepNhanService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'LyDoTiepNhan';
                    return _this;
                }
                return LyDoTiepNhanService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            LyDoTiepNhanService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-ly-do-tiep-nhan-ly-do-tiep-nhan-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-ly-do-tiep-nhan-ly-do-tiep-nhan-module-es5.js.map