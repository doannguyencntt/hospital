...
let BaoCaoHieuQuaCongViecListComponent = class BaoCaoHieuQuaCongViecListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoHieuQuaCongViec", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoHieuQuaCongViecListComponent.ctorParameters = () => [
...
let BaoCaoHieuQuaCongViecRoutingModule = class BaoCaoHieuQuaCongViecRoutingModule {
};
...
class BaoCaoHieuQuaCongViecSearch {
...
let BaoCaoHieuQuaCongViecModule = class BaoCaoHieuQuaCongViecModule {
};
