(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~bao-cao-bao-cao-dich-vu-hop-dong-kham-doan-bao-cao-dich-vu-hop-dong-kham-doan-module~bao-cao~0a76087b"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichPhanCongNgoaiTru = /** @class */ (function () {
                function LichPhanCongNgoaiTru(PhongNgoaiTruId, NhanVienId, khoaPhongId, NgayPhanCong, LoaiThoiGianPhanCong, Tuan1Display, Tuan2Display, Tuan3Display, Tuan4Display, Tuan5Display, Tuan6Display) {
                    if (PhongNgoaiTruId === void 0) { PhongNgoaiTruId = 0; }
                    if (NhanVienId === void 0) { NhanVienId = 0; }
                    if (khoaPhongId === void 0) { khoaPhongId = 0; }
                    if (NgayPhanCong === void 0) { NgayPhanCong = null; }
                    if (LoaiThoiGianPhanCong === void 0) { LoaiThoiGianPhanCong = 1; }
                    if (Tuan1Display === void 0) { Tuan1Display = ""; }
                    if (Tuan2Display === void 0) { Tuan2Display = ""; }
                    if (Tuan3Display === void 0) { Tuan3Display = ""; }
                    if (Tuan4Display === void 0) { Tuan4Display = ""; }
                    if (Tuan5Display === void 0) { Tuan5Display = ""; }
                    if (Tuan6Display === void 0) { Tuan6Display = ""; }
                ...
                return LichPhanCongNgoaiTru;
            }());
            var NhanVienLichPhanCong = /** @class */ (function () {
                function NhanVienLichPhanCong(Id, PhongNgoaiTruId, NhanVienId, NgayPhanCong, LoaiThoiGianPhanCong, TenNhanVien, IsBacSi, IsUpdate, IsDelete, Thu, IndexNV, IsDeleteHiden, ListIdValidator) {
                    if (Id === void 0) { Id = 0; }
                    if (PhongNgoaiTruId === void 0) { PhongNgoaiTruId = 0; }
                    if (NhanVienId === void 0) { NhanVienId = 0; }
                    if (NgayPhanCong === void 0) { NgayPhanCong = new Date; }
                    if (LoaiThoiGianPhanCong === void 0) { LoaiThoiGianPhanCong = 1; }
                    if (TenNhanVien === void 0) { TenNhanVien = null; }
                    if (IsBacSi === void 0) { IsBacSi = false; }
                    if (IsUpdate === void 0) { IsUpdate = false; }
                    if (IsDelete === void 0) { IsDelete = false; }
                    if (Thu === void 0) { Thu = 0; }
                    if (IndexNV === void 0) { IndexNV = 0; }
                    if (IsDeleteHiden === void 0) { IsDeleteHiden = false; }
                    if (ListIdValidator === void 0) { ListIdValidator = []; }
                    this.Id = Id;
                    this.PhongNgoaiTruId = PhongNgoaiTruId;
                    this.NhanVienId = NhanVienId;
                    this.NgayPhanCong = NgayPhanCong;
                ...
                return NhanVienLichPhanCong;
            }());
            var Phong = /** @class */ (function () {
                function Phong(Id, TenPhong, // TenPhong
                PhongNgoaiTruId, // PhongId
                ThoiGianTrucNhanVienBuoiSangs, ThoiGianTrucNhanVienBuoiChieus, NhanVienTrucDelete, IsPrint, IsCopy, CopyForWeek, CaTruc, CaTrucInt, BacSis, YTas, ToDate, FromDate, HostingPrint, LookupDataYta, LookupDataBacsi, IsShowCopyForWeek, TenKhoa) {
                    if (Id === void 0) { Id = 0; }
                    if (TenPhong === void 0) { TenPhong = null; }
                    if (PhongNgoaiTruId === void 0) { PhongNgoaiTruId = 0; }
                    if (ThoiGianTrucNhanVienBuoiSangs === void 0) { ThoiGianTrucNhanVienBuoiSangs = null; }
                    if (ThoiGianTrucNhanVienBuoiChieus === void 0) { ThoiGianTrucNhanVienBuoiChieus = null; }
                    if (NhanVienTrucDelete === void 0) { NhanVienTrucDelete = []; }
                    if (IsPrint === void 0) { IsPrint = false; }
                    if (IsCopy === void 0) { IsCopy = false; }
                    if (CopyForWeek === void 0) { CopyForWeek = 0; }
                    if (CaTruc === void 0) { CaTruc = null; }
                    if (CaTrucInt === void 0) { CaTrucInt = 0; }
                    if (BacSis === void 0) { BacSis = []; }
                    if (YTas === void 0) { YTas = []; }
                    if (ToDate === void 0) { ToDate = null; }
                    if (FromDate === void 0) { FromDate = null; }
                    if (HostingPrint === void 0) { HostingPrint = null; }
                    if (LookupDataYta === void 0) { LookupDataYta = null; }
                    if (LookupDataBacsi === void 0) { LookupDataBacsi = null; }
                    if (IsShowCopyForWeek === void 0) { IsShowCopyForWeek = true; }
            ...
            var ThoiGianTrucNhanVien = /** @class */ (function () {
                function ThoiGianTrucNhanVien(NhanVienTrucT2, NhanVienTrucT3, NhanVienTrucT4, NhanVienTrucT5, NhanVienTrucT6, NhanVienTrucT7, NhanVienTrucT8) {
                    if (NhanVienTrucT2 === void 0) { NhanVienTrucT2 = []; }
                    if (NhanVienTrucT3 === void 0) { NhanVienTrucT3 = []; }
                    if (NhanVienTrucT4 === void 0) { NhanVienTrucT4 = []; }
                    if (NhanVienTrucT5 === void 0) { NhanVienTrucT5 = []; }
                    if (NhanVienTrucT6 === void 0) { NhanVienTrucT6 = []; }
                    if (NhanVienTrucT7 === void 0) { NhanVienTrucT7 = []; }
                    if (NhanVienTrucT8 === void 0) { NhanVienTrucT8 = []; }
                ...
                return ThoiGianTrucNhanVien;
            }());
            var ShowDateTime = /** @class */ (function () {
                function ShowDateTime(DateTimeT2, DateTimeT3, DateTimeT4, DateTimeT5, DateTimeT6, DateTimeT7, DateTimeT8) {
                    if (DateTimeT2 === void 0) { DateTimeT2 = new Date; }
                    if (DateTimeT3 === void 0) { DateTimeT3 = new Date; }
                    if (DateTimeT4 === void 0) { DateTimeT4 = new Date; }
                    if (DateTimeT5 === void 0) { DateTimeT5 = new Date; }
                    if (DateTimeT6 === void 0) { DateTimeT6 = new Date; }
                    if (DateTimeT7 === void 0) { DateTimeT7 = new Date; }
                    if (DateTimeT8 === void 0) { DateTimeT8 = new Date; }
            ...
            var LookupBacSisYta = /** @class */ (function () {
                function LookupBacSisYta(DisplayName, KeyId) {
                    if (DisplayName === void 0) { DisplayName = ""; }
                    if (KeyId === void 0) { KeyId = 0; }
                    this.DisplayName = DisplayName;
                    this.KeyId = KeyId;
                }
                return LookupBacSisYta;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopYLenhDetailBackgroundComponent = /** @class */ (function () {
                function TongHopYLenhDetailBackgroundComponent() {
                }
                TongHopYLenhDetailBackgroundComponent.prototype.ngOnInit = function () {
                };
                return TongHopYLenhDetailBackgroundComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopYLenhDetailComponent = /** @class */ (function () {
                function TongHopYLenhDetailComponent(intl, location, dialog, apiService, notificationService, authService, route) {
                    this.intl = intl;
                ...
                TongHopYLenhDetailComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    if (this.IsDieuTriNoiTru) {
                        ...
                        var fullNgayDieuTri_1 = new Date();
                        this.route.queryParams.subscribe(function (param) {
                            _this.id = param['NoiTruBenhAnId'];
                            var strFullNgayDieuTri = param['strNgayDieuTri'].split('.').join('/');
                            fullNgayDieuTri_1 = new Date(strFullNgayDieuTri);
                            _this.strNgayDieuTri = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].formatDateTime(fullNgayDieuTri_1, "mm/dd/yyyy"); //param['strNgayDieuTri'].split('.').join('/');
                        });
                        //this.getById(this.id);
                        this.ganVaKiemTraPhieuDieuTriTheoNgay(fullNgayDieuTri_1);
                    }
                    this.gridColumns = [
                ...
                //   }
                // }
                TongHopYLenhDetailComponent.prototype.getById = function (id, showLoadingPopup, inphieu) {
                    var _this = this;
                    if (showLoadingPopup === void 0) { showLoadingPopup = true; }
                    if (inphieu === void 0) { inphieu = null; }
                    if (showLoadingPopup) {
                        this.showPopupLoadingData();
                    }
                    var obj = {
                    ...
                    this.apiService.post("DieuTriNoiTru/GetTongHopYLenhThongTinHanhChinh", obj), this.apiService.post("DieuTriNoiTru/GetThongTinChiTietYLenhPhieuDieuTri", obj)).subscribe(function (res) {
                        _this.IsDisableEdit = false;
                        _this.IsChangeData = false;
                        _this.thongTinHanhChinh = res[0];
                        if (_this.thongTinHanhChinh.NamSinh != null &&
                            _this.thongTinHanhChinh.ThangSinh != null &&
                            _this.thongTinHanhChinh.NgaySinh != null) {
                            var ngaySinh = new Date(_this.thongTinHanhChinh.ThangSinh +
                                "/" +
                                _this.thongTinHanhChinh.NgaySinh +
                                "/" +
                                _this.thongTinHanhChinh.NamSinh +
                                "/");
                        ...
                        _this.tongHopYLenhPhieuDieuTri = res[1];
                        _this.IsDisableEdit = _this.tongHopYLenhPhieuDieuTri.IsDisableEdit;
                        _this.tongHopYLenhThem.NgayYLenh = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].formatDateTime(_this.tongHopYLenhPhieuDieuTri.NgayYLenh, "mm/dd/yyyy");
                        _this.gridDataSource.data = _this.tongHopYLenhPhieuDieuTri.TongHopYLenhDienBiens;
                        _this.gridDataSource.data.sort(function (n1, n2) { return n1.GioYLenh - n2.GioYLenh; });
                        ...
                        //   this.IsShowButtonIn = false;
                        // }
                        _this.IsShowButtonIn = _this.tongHopYLenhPhieuDieuTri.CoYLenhThemMoi;
                        _this.ganGiaTriNgayYLenh();
                        if (inphieu != null) {
                            _this.InPhieu(inphieu, false);
                        }
                        else {
                            _this.closePopupLoadingData();
                        }
                    }, function (err) {
                        _this.IsShowButtonIn = false;
                ...
                TongHopYLenhDetailComponent.prototype.xuLyXoaYLenh = function (itemDienBien, itemYLenh) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Delete) || this.authService.hasPermission(src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_9__["DocumentType"].DanhSachDieuTriNoiTru, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Delete)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_21__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                var indexDienBien = _this.gridDataSource.data.findIndex(function (x) { return x == itemDienBien; });
                                if (indexDienBien != -1) {
                                    if (itemDienBien.TongHopYLenhDienBienChiTiets.length == 1) {
                                        _this.gridDataSource.data.splice(indexDienBien, 1);
                                    }
                                    else {
                                        ...
                                        itemDienBien.TongHopYLenhDienBienChiTiets = itemDienBien.TongHopYLenhDienBienChiTiets.filter(function (x) { return x != itemYLenh; });
                                    }
                ...
                TongHopYLenhDetailComponent.prototype.xuLyThemYLenh = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Add) || this.authService.hasPermission(src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_9__["DocumentType"].DanhSachDieuTriNoiTru, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Add)) {
                        ...
                        this.apiService.post("DieuTriNoiTru/KiemTraThemYLenh", this.tongHopYLenhThem).subscribe(function (res) {
                            _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_20__["SystemMessage"].ActionSuccessfully, ["Thêm"]));
                            // xử lý thêm vào grid
                            // kiểm tra tồn tại diễn biến
                            var itemDienBien = _this.gridDataSource.data.find(function (x) { return x.GioYLenh == res.GioYLenh; });
                            if (itemDienBien == undefined || itemDienBien == null) {
                                _this.gridDataSource.data.push(res);
                            }
                            else {
                ...
                TongHopYLenhDetailComponent.prototype.xuLyLuuYLenh = function (backToGrid, date, inPhieu) {
                    var _this = this;
                    if (backToGrid === void 0) { backToGrid = true; }
                    ...
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Update) || this.authService.hasPermission(src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_9__["DocumentType"].DanhSachDieuTriNoiTru, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Update)) {
                        this.validationErrors = [];
                        this.apiService.put("DieuTriNoiTru/KiemTraLuuDienBienYLenh", this.tongHopYLenhPhieuDieuTri).subscribe(function (res) {
                            _this.apiService.put("DieuTriNoiTru/XuLyLuuDienBienYLenh", _this.tongHopYLenhPhieuDieuTri).subscribe(function (result) {
                                if (inPhieu == null) {
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_20__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                                }
                                _this.closePopupLoadingData();
                                if (!_this.IsDieuTriNoiTru) {
                                    if (backToGrid) {
                                        _this.quayLai();
                                    }
                                    else {
                                        _this.ganVaKiemTraPhieuDieuTriTheoNgay(date, inPhieu);
                                    }
                                }
                                else {
                                    _this.ganVaKiemTraPhieuDieuTriTheoNgay(_this.tongHopYLenhPhieuDieuTri.NgayYLenh, inPhieu);
                                }
                            }, function (err) {
                                _this.validationErrors = err.ValidationErrors;
                                if (err.Message != "Validation Failed") {
                ...
                TongHopYLenhDetailComponent.prototype.showPopupXacNhanLuu = function (backToGrid, date, inPhieu) {
                    var _this = this;
                    if (backToGrid === void 0) { backToGrid = true; }
                    if (date === void 0) { date = new Date(); }
                    if (inPhieu === void 0) { inPhieu = null; }
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_21__["ConfirmComponent"], {
                        ...
                        if (result == "Yes") {
                            _this.xuLyLuuYLenh(backToGrid, date, inPhieu);
                        }
                    });
                };
                TongHopYLenhDetailComponent.prototype.huyThemYLenh = function () {
                    this.validationErrors = [];
                    this.tongHopYLenhThem = new _tong_hop_y_lenh_model__WEBPACK_IMPORTED_MODULE_4__["TongHopYLenhThem"]();
                ...
                TongHopYLenhDetailComponent.prototype.kiemTraPhieuDieuTriTheoNgay = function (id, ngay, inphieu) {
                    var _this = this;
                    if (inphieu === void 0) { inphieu = null; }
                    this.showPopupLoadingData();
                    var obj = {
                    ...
                    this.apiService.post("DieuTriNoiTru/KiemTraPhieuDieuTriNoiTruByNgayDieuTri", obj)
                        ...
                        // this.id = resultData;
                        _this.getById(id, false, inphieu);
                    }, function (err) {
                        _this.IsDisableEdit = true;
                        _this.IsShowButtonIn = false;
                        if (err.Message != "Validation Failed") {
                        ...
                        _this.gridDataSource.data.splice(0, _this.gridDataSource.data.length);
                        _this.closePopupLoadingData();
                    });
                };
                TongHopYLenhDetailComponent.prototype.getAge = function (date_1, date_2) {
                ...
                TongHopYLenhDetailComponent.prototype.DaysInMonth = function (date2_UTC) {
                    var monthStart = new Date(date2_UTC.getFullYear(), date2_UTC.getMonth(), 1);
                    var monthEnd = new Date(date2_UTC.getFullYear(), date2_UTC.getMonth() + 1, 1);
                    var monthLength = (monthEnd - monthStart) / (1000 * 60 * 60 * 24);
                    return monthLength;
                };
                TongHopYLenhDetailComponent.prototype.showPopupLoadingData = function () {
                ...
                TongHopYLenhDetailComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                TongHopYLenhDetailComponent.prototype.chonYTaThucHien = function (event) {
                    if (event) {
                ...
                TongHopYLenhDetailComponent.prototype.clearValidateErrorOtherCallback = function (event) {
                ...
                TongHopYLenhDetailComponent.prototype.changeData = function () {
                    this.IsChangeData = true;
                };
                TongHopYLenhDetailComponent.prototype.changeXacNhanThucHien = function (event, item) {
                    var _this = this;
                    if (event && (item.NhanVienXacNhanThucHienId == null || item.GioThucHien == null)) {
                        this.showPopupLoadingData();
                        this.apiService.get("DieuTriNoiTru/GetThongTinYLenhNhanVienDangLogin").subscribe(function (res) {
                ...
                // xử lý date
                TongHopYLenhDetailComponent.prototype.ganGiaTriNgayYLenh = function () {
                ...
                TongHopYLenhDetailComponent.prototype.changeDateLink = function (event) {
                ...
                TongHopYLenhDetailComponent.prototype.prevDateLink = function () {
                    ...
                    var dateChange = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_3__["addDays"])(this.tongHopYLenhPhieuDieuTri.NgayYLenh, -1);
                    this.changeDateDieuTriNoiTru(dateChange);
                };
                TongHopYLenhDetailComponent.prototype.nextDateLink = function () {
                    // this.tongHopYLenhPhieuDieuTri.NgayYLenh=addDays(this.tongHopYLenhPhieuDieuTri.NgayYLenh,1);
                    // this.ganGiaTriNgayYLenh();
                    // this.kiemTraPhieuDieuTriTheoNgay(this.id, this.tongHopYLenhPhieuDieuTri.NgayYLenh);
                    var dateChange = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_3__["addDays"])(this.tongHopYLenhPhieuDieuTri.NgayYLenh, 1);
                ...
                TongHopYLenhDetailComponent.prototype.changeDateDieuTriNoiTru = function (date) {
                    var _this = this;
                    if (this.IsChangeData) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_21__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                _this.showPopupXacNhanLuu(false, date);
                            }
                            else {
                                _this.ganVaKiemTraPhieuDieuTriTheoNgay(date);
                            }
                        });
                    }
                    else {
                ...
                TongHopYLenhDetailComponent.prototype.ganVaKiemTraPhieuDieuTriTheoNgay = function (date, inphieu) {
                    if (inphieu === void 0) { inphieu = null; }
                    this.IsChangeData = false;
                ...
                TongHopYLenhDetailComponent.prototype.formatDateLink = function (date) {
                    return "<strong>" + this.intl.formatDate(date, "dd/MM/yyyy") + "</strong>";
                };
                TongHopYLenhDetailComponent.prototype.quayLai = function () {
                    this.location.back();
                };
                TongHopYLenhDetailComponent.prototype.xuLyKiemTraInPhieu = function (loaiIn) {
                    if (loaiIn === void 0) { loaiIn = false; }
                ...
                TongHopYLenhDetailComponent.prototype.InPhieu = function (inTatCa, showPopupLoadingData) {
                    var _this = this;
                    if (inTatCa === void 0) { inTatCa = false; }
                    if (showPopupLoadingData === void 0) { showPopupLoadingData = true; }
                    if (this.authService.hasPermission(this.documentype, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].View) || this.authService.hasPermission(src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_9__["DocumentType"].DanhSachDieuTriNoiTru, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].View)) {
                        ...
                        this.apiService.post("DieuTriNoiTru/InPhieuChamSoc", obj).subscribe(function (resultData) {
                            _this.closePopupLoadingData();
                            if (resultData != undefined && resultData != null) {
                                _this.dialog.open(_tong_hop_y_lenh_in_phieu_popup_tong_hop_y_lenh_in_phieu_popup_component__WEBPACK_IMPORTED_MODULE_22__["TongHopYLenhInPhieuPopupComponent"], {
                                    disableClose: false,
                                    width: '1200px',
                                    data: resultData,
                                }).afterClosed().subscribe(function (result) {
                ...
                TongHopYLenhDetailComponent.prototype.changeGioYLenh = function (event) {
                    if (event) {
                        this.tongHopYLenhThem.GioThucHien = event;
                    }
                };
                return TongHopYLenhDetailComponent;
            }());
            TongHopYLenhDetailComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopYLenhInPhieuPopupComponent = /** @class */ (function () {
                function TongHopYLenhInPhieuPopupComponent(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                    this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
                    this.src = "";
                }
                TongHopYLenhInPhieuPopupComponent.prototype.ngOnInit = function () {
                    this.src = "data:text/html;charset=utf-8," + encodeURIComponent(this.data);
                };
                TongHopYLenhInPhieuPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                TongHopYLenhInPhieuPopupComponent.prototype.replaceAll = function (str, find, replace) {
                    return str.replace(new RegExp(find, "g"), replace);
                };
                TongHopYLenhInPhieuPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    var source = this.replaceAll(this.data, "<p  style='background: #005dab;color:#fff; height:40px; font-size:30px;text-align:center'><th>PHIẾU CHĂM SÓC</th></p>", "");
                ...
                return TongHopYLenhInPhieuPopupComponent;
            }());
            TongHopYLenhInPhieuPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopYLenhListComponent = /** @class */ (function () {
                function TongHopYLenhListComponent(authService, notificationService, route, location, dialog, intl, router) {
                    this.authService = authService;
                    this.notificationService = notificationService;
                    this.route = route;
                    this.location = location;
                ...
                TongHopYLenhListComponent.prototype.ngOnInit = function () {
                    ...
                    this._gridColumnsFilter = this.gridColumns.filter(function (p) { return p.Title != '' && !p.Hidden; });
                };
                TongHopYLenhListComponent.prototype.ganGiaTriNgayYLenh = function () {
                ...
                TongHopYLenhListComponent.prototype.searchChanges = function (event) {
                    if ((event == null || event == "") && this.strAdditionalSearchString != "") {
                        this.timKiemNangCao();
                    }
                };
                TongHopYLenhListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiemNangCao();
                    }
                };
                TongHopYLenhListComponent.prototype.clearSearch = function () {
                    this.tongHopYLenhTimKiem.SearchString = null;
                    this.gridChild.searchString = null;
                    this.timKiemNangCao();
                };
                TongHopYLenhListComponent.prototype.timKiemNangCao = function () {
                ...
                TongHopYLenhListComponent.prototype.xuLyXuatExcel = function () {
                ...
                TongHopYLenhListComponent.prototype.xemChiTiet = function (dataItem) {
                ...
                // xử lý date
                TongHopYLenhListComponent.prototype.changeDateLink = function (event) {
                    this.tongHopYLenhTimKiem.NgayYLenh = event;
                    //this.dateLinkText=this.formatDateLink(event);
                    this.ganGiaTriNgayYLenh();
                    this.timKiemNangCao();
                };
                TongHopYLenhListComponent.prototype.prevDateLink = function () {
                ...
                TongHopYLenhListComponent.prototype.nextDateLink = function () {
                    this.tongHopYLenhTimKiem.NgayYLenh = Object(_progress_kendo_date_math__WEBPACK_IMPORTED_MODULE_22__["addDays"])(this.tongHopYLenhTimKiem.NgayYLenh, 1);
                    //this.dateLinkText=this.formatDateLink(this.tongHopYLenhTimKiem.NgayYLenh);
                    this.ganGiaTriNgayYLenh();
                    this.timKiemNangCao();
                };
                TongHopYLenhListComponent.prototype.formatDateLink = function (date) {
                    return "<strong>" + this.intl.formatDate(date, "dd/MM/yyyy") + "</strong>";
                };
                return TongHopYLenhListComponent;
            }());
            TongHopYLenhListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopYLenhRoutingModule = /** @class */ (function () {
                function TongHopYLenhRoutingModule() {
                }
                return TongHopYLenhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var TongHopYLenhTimKiem = /** @class */ (function () {
                function TongHopYLenhTimKiem(SearchString, KhoaId, PhongId, ChuaHoanThanh, NgayYLenh, strNgayYLenh) {
                    if (SearchString === void 0) { SearchString = null; }
                    if (KhoaId === void 0) { KhoaId = null; }
                    if (PhongId === void 0) { PhongId = null; }
                    if (ChuaHoanThanh === void 0) { ChuaHoanThanh = false; }
                    if (NgayYLenh === void 0) { NgayYLenh = null; }
                    if (strNgayYLenh === void 0) { strNgayYLenh = null; }
                ...
                return TongHopYLenhTimKiem;
            }());
            var TongHopYLenhThongTinBenhAn = /** @class */ (function () {
                function TongHopYLenhThongTinBenhAn(YeuCauTiepNhanId, BenhNhanId, MaBenhNhan, MaTiepNhan, HoTen, NgaySinh, ThangSinh, NamSinh, Tuoi, TenGioiTinh, DiaChi, NgheNghiep, SoBenhAn, LoaiBenhAn, Khoa, BacSiDieuTri, Phong, Giuong, DoiTuong, NgayDieuTri, 
                //BVHD-3800
                LaCapCuu) {
                    ...
                    if (BacSiDieuTri === void 0) { BacSiDieuTri = null; }
                    if (Phong === void 0) { Phong = null; }
                    if (Giuong === void 0) { Giuong = null; }
                ...
                return TongHopYLenhThongTinBenhAn;
            }());
            var TongHopYLenhThem = /** @class */ (function () {
                function TongHopYLenhThem(
                //public NoiTruPhieuDieuTriId: number = null,
                NoiTruBenhAnId, NgayYLenh, GioYLenh, DienBien, MoTaYLenh, NhanVienXacNhanThucHienId, NhanVienXacNhanThucHienDisplay, ThoiDiemXacNhanThucHien, GioThucHien, XacNhanThucHien) {
                    if (NoiTruBenhAnId === void 0) { NoiTruBenhAnId = null; }
                    if (NgayYLenh === void 0) { NgayYLenh = null; }
                    if (GioYLenh === void 0) { GioYLenh = null; }
                    if (DienBien === void 0) { DienBien = null; }
                    if (MoTaYLenh === void 0) { MoTaYLenh = null; }
                    if (NhanVienXacNhanThucHienId === void 0) { NhanVienXacNhanThucHienId = null; }
                    if (NhanVienXacNhanThucHienDisplay === void 0) { NhanVienXacNhanThucHienDisplay = null; }
                    if (ThoiDiemXacNhanThucHien === void 0) { ThoiDiemXacNhanThucHien = null; }
                    if (GioThucHien === void 0) { GioThucHien = null; }
                    if (XacNhanThucHien === void 0) { XacNhanThucHien = null; }
                ...
                return TongHopYLenhThem;
            }());
            var TongHopYLenhPhieuDieuTri = /** @class */ (function () {
                function TongHopYLenhPhieuDieuTri(
                //public NoiTruPhieuDieuTriId: number = null,
                NoiTruBenhAnId, NgayYLenh, NgayYLenhDisplay, IsDisableEdit, CoYLenhThemMoi, TongHopYLenhDienBiens) {
                    if (NoiTruBenhAnId === void 0) { NoiTruBenhAnId = null; }
                    if (NgayYLenh === void 0) { NgayYLenh = null; }
                    if (NgayYLenhDisplay === void 0) { NgayYLenhDisplay = null; }
                    if (IsDisableEdit === void 0) { IsDisableEdit = true; }
                    if (CoYLenhThemMoi === void 0) { CoYLenhThemMoi = null; }
                    if (TongHopYLenhDienBiens === void 0) { TongHopYLenhDienBiens = Array(); }
                    this.NoiTruBenhAnId = NoiTruBenhAnId;
                    this.NgayYLenh = NgayYLenh;
                ...
                return TongHopYLenhPhieuDieuTri;
            }());
            var TongHopYLenhDienBien = /** @class */ (function () {
                function TongHopYLenhDienBien(Id, GioYLenh, GioYLenhDisplay, DienBien, TongHopYLenhDienBienChiTiets) {
                    if (Id === void 0) { Id = null; }
                    if (GioYLenh === void 0) { GioYLenh = null; }
                    if (GioYLenhDisplay === void 0) { GioYLenhDisplay = null; }
                    if (DienBien === void 0) { DienBien = null; }
                    if (TongHopYLenhDienBienChiTiets === void 0) { TongHopYLenhDienBienChiTiets = new Array(); }
                    this.Id = Id;
                    this.GioYLenh = GioYLenh;
                ...
                return TongHopYLenhDienBien;
            }());
            var TongHopYLenhDienBienChiTiet = /** @class */ (function () {
                function TongHopYLenhDienBienChiTiet(Id, NoiTruPhieuDieuTriId, MoTaYLenh, GioYLenh, NhanVienXacNhanThucHienId, NhanVienXacNhanThucHienDisplay, GioThucHien, XacNhanThucHien, NhanVienCapNhatId, NhanVienCapNhatDisplay, ThoiDiemCapNhat, ThoiDiemCapNhatDisplay, NhanVienChiDinhId, NhanVienChiDinhDisplay, NoiChiDinhId) {
                    if (Id === void 0) { Id = null; }
                    if (NoiTruPhieuDieuTriId === void 0) { NoiTruPhieuDieuTriId = null; }
                    if (MoTaYLenh === void 0) { MoTaYLenh = null; }
                    if (GioYLenh === void 0) { GioYLenh = null; }
                    if (NhanVienXacNhanThucHienId === void 0) { NhanVienXacNhanThucHienId = null; }
                    if (NhanVienXacNhanThucHienDisplay === void 0) { NhanVienXacNhanThucHienDisplay = null; }
                    if (GioThucHien === void 0) { GioThucHien = null; }
                    if (XacNhanThucHien === void 0) { XacNhanThucHien = null; }
                    if (NhanVienCapNhatId === void 0) { NhanVienCapNhatId = null; }
                    if (NhanVienCapNhatDisplay === void 0) { NhanVienCapNhatDisplay = null; }
                    if (ThoiDiemCapNhat === void 0) { ThoiDiemCapNhat = null; }
                    if (ThoiDiemCapNhatDisplay === void 0) { ThoiDiemCapNhatDisplay = null; }
                    if (NhanVienChiDinhId === void 0) { NhanVienChiDinhId = null; }
                    if (NhanVienChiDinhDisplay === void 0) { NhanVienChiDinhDisplay = null; }
                ...
                return TongHopYLenhDienBienChiTiet;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopYLenhModule = /** @class */ (function () {
                function TongHopYLenhModule() {
                }
                return TongHopYLenhModule;
            }());
...
//# sourceMappingURL=default~bao-cao-bao-cao-dich-vu-hop-dong-kham-doan-bao-cao-dich-vu-hop-dong-kham-doan-module~bao-cao~0a76087b-es5.js.map
//# sourceMappingURL=default~bao-cao-bao-cao-dich-vu-hop-dong-kham-doan-bao-cao-dich-vu-hop-dong-kham-doan-module~bao-cao~0a76087b-es5.js.map