...
class NhapKhoVatTuSearch {
    constructor(KhoVatTuId = 0, TenKhoVatTu = null, DangChoDuyet = true, DaDuyet = false, TuChoiDuyet = false, LoaiNhapKho = 0, TenLoaiNhapKho = null, SearchString = "", RangeNhap = new _nhap_xuat_vat_tu_yeu_cau_mua_vat_tu_yeu_cau_mua_vat_tu_model__WEBPACK_IMPORTED_MODULE_1__["RangeDate"](), RangeDuyet = new _nhap_xuat_vat_tu_yeu_cau_mua_vat_tu_yeu_cau_mua_vat_tu_model__WEBPACK_IMPORTED_MODULE_1__["RangeDate"]()) {
        this.KhoVatTuId = KhoVatTuId;
        this.TenKhoVatTu = TenKhoVatTu;
...
class ThongTinLyDoHuyNhapKhoVatTu {
    constructor(YeuCauNhapKhoVatTuId = 0, LyDoHuy = null) {
