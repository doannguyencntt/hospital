...
let DsTongHopDuTruMuaVatTuTaiKhoaComponent = class DsTongHopDuTruMuaVatTuTaiKhoaComponent {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
            ...
            this.confrim = this.dialog.open(_tong_hop_du_tru_mua_vat_tu_tai_khoa_khong_duyet_tong_hop_du_tru_mua_vat_tu_tai_khoa_khong_duyet_component__WEBPACK_IMPORTED_MODULE_30__["TongHopDuTruMuaVatTuTaiKhoaKhongDuyetComponent"], {
                ...
                if (result !== '' && result) {
                    ...
                    this.apiService.post('YeuCauMuaVatTu/TuChoiDuyetTaiKhoa', this.thongTinLyDoHuyDuyetTaiKhoa)
    ...
    PheDuyet(id) {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
            ...
            this.confrim = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_29__["ConfirmComponent"], {
                ...
                .subscribe((result) => {
                if (result === 'Yes') {
                    this.apiService.post('YeuCauMuaVatTu/DuyetTaiKhoa/', this.duyetDuTruMuaVatTuViewModel)
                        .subscribe((resultData) => {
                        if (resultData !== null && resultData !== undefined) {
                            if (resultData) {
                                this.gridChoDuyet.search();
    ...
    HuyDuyet(id) {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
            ...
            this.confrim = this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_29__["ConfirmComponent"], {
                ...
                if (result === 'Yes') {
                    this.apiService.post('YeuCauMuaVatTu/HuyDuyetTaiKhoa/' + id)
                        .subscribe((resultData) => {
                        if (resultData !== null && resultData !== undefined) {
                            if (resultData) {
                                this.gridChoDuyet.search();
...
DsTongHopDuTruMuaVatTuTaiKhoaComponent.ctorParameters = () => [
...
let GuiTongHopDuTruMuaVatTuTaiKhoaConfirmComponent = class GuiTongHopDuTruMuaVatTuTaiKhoaConfirmComponent {
...
GuiTongHopDuTruMuaVatTuTaiKhoaConfirmComponent.ctorParameters = () => [
...
let GuiTongHopDuTruMuaVatTuTaiKhoaDuyetComponent = class GuiTongHopDuTruMuaVatTuTaiKhoaDuyetComponent {
    constructor(dialog, router, apiService, authService, notificationService, route, location, ref) {
        this.dialog = dialog;
        this.router = router;
        this.apiService = apiService;
        this.authService = authService;
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
            self.dialog.open(_gui_tong_hop_du_tru_mua_vat_tu_tai_khoa_confirm_gui_tong_hop_du_tru_mua_vat_tu_tai_khoa_confirm_component__WEBPACK_IMPORTED_MODULE_16__["GuiTongHopDuTruMuaVatTuTaiKhoaConfirmComponent"], {
                ...
                if (res === 'Yes') {
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                        self.savingPage();
                        self.apiService.post('YeuCauMuaVatTu/GoiThongTinTaiKhoa', self.duyetDuTruMuaVatTuViewModel).subscribe((resultData) => {
                            if (resultData) {
                                self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_10__["SystemMessage"].ActionSuccessfully, ['Lưu']));
                                self.closePopupSavingData();
...
GuiTongHopDuTruMuaVatTuTaiKhoaDuyetComponent.ctorParameters = () => [
...
let PhieuMuaTruTaiKhoaComponent = class PhieuMuaTruTaiKhoaComponent {
    ...
    xem() {
        ...
        self.apiService.post('YeuCauMuaVatTu/InPhieuDuTruMuaTaiKhoa', self.inPhieuVatTu).subscribe(resData => {
            if (resData) {
...
let PhieuTongHopDuTruMuaVatTuTaiKhoaDuyetComponent = class PhieuTongHopDuTruMuaVatTuTaiKhoaDuyetComponent {
    constructor() { }
    ngOnInit() { }
};
...
let TongHopDuTruMuaVatTuTaiKhoaDetailComponent = class TongHopDuTruMuaVatTuTaiKhoaDetailComponent {
...
TongHopDuTruMuaVatTuTaiKhoaDetailComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
...
let TongHopDuTruMuaVatTuTaiKhoaDuyetComponent = class TongHopDuTruMuaVatTuTaiKhoaDuyetComponent {
    constructor(apiService, dialog, route) {
        this.apiService = apiService;
        this.dialog = dialog;
        this.route = route;
        this.popupSavingData = null;
...
TongHopDuTruMuaVatTuTaiKhoaDuyetComponent.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
...
let TongHopDuTruMuaVatTuTaiKhoaKhongDuyetComponent = class TongHopDuTruMuaVatTuTaiKhoaKhongDuyetComponent {
    constructor(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
...
TongHopDuTruMuaVatTuTaiKhoaKhongDuyetComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
];
...
let TongHopDuTruMuaVatTuTaiKhoaRoutingModule = class TongHopDuTruMuaVatTuTaiKhoaRoutingModule {
};
...
let TongHopDuTruMuaVatTuTaiKhoaSharedComponent = TongHopDuTruMuaVatTuTaiKhoaSharedComponent_1 = class TongHopDuTruMuaVatTuTaiKhoaSharedComponent {
    constructor(apiService, route, dialog, router, notificationService, authService, location) {
        this.apiService = apiService;
        this.route = route;
        this.dialog = dialog;
        this.router = router;
...
TongHopDuTruMuaVatTuTaiKhoaSharedComponent.ctorParameters = () => [
...
let TongHopDuTruMuaVatTuTaiKhoaChiTietSharedComponent = class TongHopDuTruMuaVatTuTaiKhoaChiTietSharedComponent {
...
TongHopDuTruMuaVatTuTaiKhoaChiTietSharedComponent.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
class TongHopDuTruMuaVatTuTaiKhoaSreach {
    constructor(Id = 0, NgayYeuCauTuFormat = null, NgayYeuCauDenFormat = null, FromDate = null, ToDate = null, ChoDuyet = true, DaDuyet = true, DaDuyetDaXuLy = true, DaGuiChoDuyet = true, TuChoiDuyet = true, SearchString = null, SearchStringDaXuLy = null, SearchStringTuChoi = null, RangeFromDate = new _vat_tu_yeu_cau_mua_vat_tu_yeu_cau_mua_vat_tu_model__WEBPACK_IMPORTED_MODULE_1__["RangeDate"](), RangeFromDateDaXuLy = new _vat_tu_yeu_cau_mua_vat_tu_yeu_cau_mua_vat_tu_model__WEBPACK_IMPORTED_MODULE_1__["RangeDate"](), RangeFromDateTuChoi = new _vat_tu_yeu_cau_mua_vat_tu_yeu_cau_mua_vat_tu_model__WEBPACK_IMPORTED_MODULE_1__["RangeDate"]()) {
        this.Id = Id;
...
class TongHopDuTruMuaVatTuTaiKhoa {
    constructor(SoPhieu = null, TenNhanVienYeuCau = null, KyDuTru = null, Id = 0, LoaiDuTru = null, TenLoaiDuTru = null, KhoNhapId = null, TenKho = null, NhanVienYeuCauId = null, NhanVienYeuDuyetId = null, NgayYeuCau = null, GhiChu = null, TenNhanVienDuyet = null, TrangThai = null, KhoaPhongId = null, TenKhoaPhong = null, KyDuTruMuaDuocPhamVatTuId = null, LyDoTruongKhoaTuChoi = null, TinhTrang = null, TenNhanVienKhoDuocDuyet = null, NgayKhoDuocDuyet = null, TenGiamDocDuyet = null, NgayGiamDocDuyet = null, LyDoGiamDocTuChoi = null) {
...
class DuyetDuTruMuaVatTuViewModel {
    constructor(DuTruMuaVatTuId = null, NhanVienYeuCauId = null, KhoaPhongId = null, GhiChu = null, NgayYeuCau = null, DuTruMuaVatTuTaiKhoaChiTietVos = []) {
...
class ThongTinLyDoHuyDuyetTaiKhoa {
    constructor(Id = 0, LyDoHuy = null) {
        this.Id = Id;
        this.LyDoHuy = LyDoHuy;
    }
}
class DuTruMuaVatTuTaiKhoaChiTietVo {
    constructor(Id = 0, Nhom = null, KeyId = null, VatTuId = null, TenVatTu = null, LaBHYT = null, QuyCach = null, DonViTinh = null, HangSanXuat = null, SoLuongDuTru = null, SoLuongDuKienSuDung = null, NhomDuPhong = null, KhoDuTruTon = null, KhoTongTon = null, HDChuaNhap = null, NongDoHamLuong = null, SoLuongDuTruTruongKhoaDuyet = null, DuTruMuaVatTuIds, DuTruMuaVatTuChiTietIds) {
        this.Id = Id;
        this.Nhom = Nhom;
        this.KeyId = KeyId;
...
class PhieuInDuTruMuaTaiKhoa {
    constructor(DuTruMuaVatTuTheoKhoaId = 0, HostingName = null, Header = null) {
...
let TongHopDuTruMuaVatTuTaiKhoaModule = class TongHopDuTruMuaVatTuTaiKhoaModule {
};
