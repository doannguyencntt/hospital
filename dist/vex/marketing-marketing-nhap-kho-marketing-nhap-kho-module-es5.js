...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["marketing-marketing-nhap-kho-marketing-nhap-kho-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MarketingNhapKhoChiTietComponent = /** @class */ (function () {
                function MarketingNhapKhoChiTietComponent(apiService, authService, router, notificationService, dialog, route, location) {
                ...
                MarketingNhapKhoChiTietComponent.prototype.ngOnInit = function () {
                ...
                MarketingNhapKhoChiTietComponent.prototype.getById = function (Id) {
                    var _this = this;
                    var self = this;
                    this.nhapKhoChiTietMarketing.Id = Id;
                    self.apiService.get("Marketing/GetThongTinNhapKho?id=" + this.nhapKhoChiTietMarketing.Id).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            console.log("data:", resultData);
                            _this.nhapKhoChiTietMarketing = resultData;
                            _this.gridDataSource = {
                                data: resultData.DanhSachQuaTangDuocThemList,
                                total: resultData.DanhSachQuaTangDuocThemList.length
                            };
                            _this.TongCong = resultData.DanhSachQuaTangDuocThemList.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                ...
                MarketingNhapKhoChiTietComponent.prototype.setDataGridView = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                MarketingNhapKhoChiTietComponent.prototype.Them = function () {
                ...
                MarketingNhapKhoChiTietComponent.prototype.Huy = function () {
                ...
                MarketingNhapKhoChiTietComponent.prototype.Luu = function () {
                };
                MarketingNhapKhoChiTietComponent.prototype.modelChangeSoLuongMua = function (event, dataItem) {
                    for (var index = 0; index < this.gridDataSource.data.length; index++) {
                        ...
                        this.TongCong = this.gridDataSource.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                    }
                };
                MarketingNhapKhoChiTietComponent.prototype.modelChangeGiaNhapMua = function (event, dataItem) {
                    for (var index = 0; index < this.gridDataSource.data.length; index++) {
                        if (this.gridDataSource.data[index].Id === dataItem.Id) {
                ...
                MarketingNhapKhoChiTietComponent.prototype.ChangeQuaTang = function (event) {
                    var _this = this;
                    if (event != null) {
                        var self = this;
                        self.apiService.post("Marketing/GetDonViTinhQuaTang?idQuaTang=" + event.KeyId).subscribe(function (resultData) {
                            console.log("resultData", resultData);
                            _this.nhapKhoChiTietMarketing.DonViTinh = resultData;
                        });
                    }
                };
                MarketingNhapKhoChiTietComponent.prototype.modelChangeGiaNhap = function (event) {
                ...
                MarketingNhapKhoChiTietComponent.prototype.modelChangeSoLuong = function (event) {
                    // this.nhapKhoChiTietMarketing.SoLuong = event;
                    // if (this.nhapKhoChiTietMarketing.GiaNhap != 0) {
                    //   this.nhapKhoChiTietMarketing.ThanhTien = this.nhapKhoChiTietMarketing.SoLuong * this.nhapKhoChiTietMarketing.GiaNhap;
                    // }
                };
                MarketingNhapKhoChiTietComponent.prototype.Xoa = function (event) {
                    var _this = this;
                    console.log(event);
                    if (event != undefined && event != null) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                _this.gridDataSource.data.splice(_this.gridDataSource.data.findIndex(function (x) { return x == event; }), 1);
                                _this.TongCong = _this.gridDataSource.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                                _this.setDataGridView();
                ...
                return MarketingNhapKhoChiTietComponent;
            }());
            MarketingNhapKhoChiTietComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MarketingNhapKhoCreateComponent = /** @class */ (function () {
                function MarketingNhapKhoCreateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                MarketingNhapKhoCreateComponent.prototype.ngOnInit = function () {
                };
                MarketingNhapKhoCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['/marketing/nhap-kho-marketing']);
                };
                return MarketingNhapKhoCreateComponent;
            }());
            MarketingNhapKhoCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MarketingNhapKhoListComponent = /** @class */ (function () {
                function MarketingNhapKhoListComponent(authService, router, notificationService, route, location, apiService, dialog) {
                    this.authService = authService;
                    this.router = router;
                    this.notificationService = notificationService;
                    this.route = route;
                ...
                MarketingNhapKhoListComponent.prototype.ngOnInit = function () {
                ...
                MarketingNhapKhoListComponent.prototype.XuatExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_18__["SecurityOperation"].Process)) {
                        ...
                        this.apiService.postExportExcel("Marketing/ExportNhapKhoMarketing", this.exportQueryInfoQueryInfo).subscribe(function (res) {
                ...
                MarketingNhapKhoListComponent.prototype.Edit = function (data) {
                ...
                MarketingNhapKhoListComponent.prototype.Delete = function (event) {
                    var _this = this;
                    if (event != undefined && event != null) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_27__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                _this.apiService.post("Marketing/XoaQuaTang?id=" + event.Id).subscribe(function (resultData) {
                                    _this.notificationService.showSuccess("Xóa thành công");
                ...
                MarketingNhapKhoListComponent.prototype.backWithSearch = function () {
                ...
                MarketingNhapKhoListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.TimkiemNangCao();
                    }
                };
                MarketingNhapKhoListComponent.prototype.clearSearch = function () {
                    this.searchString = null;
                    //this.danhSachChoKham.SearchString = null;
                    this.gridChild.search();
                };
                MarketingNhapKhoListComponent.prototype.TimkiemNangCao = function () {
                ...
                MarketingNhapKhoListComponent.prototype.searchChanges = function (event) {
                    var self = this;
                ...
                MarketingNhapKhoListComponent.prototype.view = function (id) {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_18__["SecurityOperation"].View)) {
                ...
                return MarketingNhapKhoListComponent;
            }());
            MarketingNhapKhoListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MarketingNhapKhoRoutingModule = /** @class */ (function () {
                function MarketingNhapKhoRoutingModule() {
                }
                return MarketingNhapKhoRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MarketingNhapKhoSharedComponent = /** @class */ (function () {
                function MarketingNhapKhoSharedComponent(apiService, authService, router, notificationService, dialog, route, location, cdRef) {
                    this.apiService = apiService;
                    this.authService = authService;
                    this.router = router;
                    this.notificationService = notificationService;
                ...
                MarketingNhapKhoSharedComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    if (id !== undefined && id !== null) {
                        ...
                        this.apiService.get("Marketing/GetThongTinNhanVien?nhanVienId=" + this.getNhanVienId.AccessToken.Id).subscribe(function (resultData) {
                            _this.nhapKhoChiTietMarketing.NguoiNhapId = resultData.KeyId;
                            _this.nhapKhoChiTietMarketing.TenNguoiNhap = resultData.DisplayName;
                            _this.nhapKhoChiTietMarketing.NgayNhap = new Date();
                        });
                    }
                    this.gridColumns = [
                        { Field: "STT", Title: "#", Width: 20, Template: this.STTTemplate },
                ...
                MarketingNhapKhoSharedComponent.prototype.ChangLoaiNguoiGiao = function (event) {
                    if (event == 2) {
                        this.nhapKhoChiTietMarketing.TenNguoiGiao = "";
                    }
                };
                MarketingNhapKhoSharedComponent.prototype.getById = function (Id) {
                    var _this = this;
                    var self = this;
                    this.nhapKhoChiTietMarketing.Id = Id;
                    this.IdNhapKho = Id;
                    self.apiService.get("Marketing/GetThongTinNhapKho?id=" + this.nhapKhoChiTietMarketing.Id).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            ...
                            _this.nhapKhoChiTietMarketing = resultData;
                            var index_1 = 1;
                            resultData.DanhSachQuaTangDuocThemList.forEach(function (element) {
                                element.STT = index_1++;
                            });
                            _this.gridDataSource = {
                                data: resultData.DanhSachQuaTangDuocThemList,
                ...
                MarketingNhapKhoSharedComponent.prototype.setDataGridView = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                MarketingNhapKhoSharedComponent.prototype.Them = function () {
                    var _this = this;
                    this.marketingCombobox.focusManual();
                    var self = this;
                    self.validationErrorsChiTiet = [];
                    this.cdRef.detectChanges();
                    var kiemTraThem = true;
                    ...
                    if (self.gridDataSource.data != null) {
                        if (self.nhapKhoChiTietMarketing.NhaCungCap != null && self.nhapKhoChiTietMarketing.QuaTangId != null) {
                            ...
                            var indexNhaCungCap = self.gridDataSource.data.findIndex(function (x) { return x.NhaCungCap == self.nhapKhoChiTietMarketing.NhaCungCap.trim(); });
                            var indexQuaTang = self.gridDataSource.data.findIndex(function (x) { return x.QuaTangId == self.nhapKhoChiTietMarketing.QuaTangId; });
                    ...
                    if (self.nhapKhoChiTietMarketing.NhaCungCap != null && self.nhapKhoChiTietMarketing.QuaTangId != null && self.gridDataSource.data == null) {
                        self.apiService.post("Marketing/ValidateNhaCungCap?nhaCungCap=" + self.nhapKhoChiTietMarketing.NhaCungCap + "&quaTangId=" + self.nhapKhoChiTietMarketing.QuaTangId).subscribe(function (resultData) {
                            if (resultData == true) {
                                kiemTraThem = false;
                                self.validationErrorsChiTiet.push({ Message: 'Nhà cung cấp đã nhập quà tặng này.', Field: 'NhaCungCap' });
                            }
                    ...
                    if (kiemTraThem == true) {
                        var tenQuaTang_1 = "";
                        self.apiService.post("Marketing/GetTenQuaTang?idQuaTang=" + self.nhapKhoChiTietMarketing.QuaTangId).subscribe(function (resultData) {
                            tenQuaTang_1 = resultData;
                            var data = {
                                SoLuongDaXuat: 0,
                                NhapKhoQuaTangId: self.IdNhapKho,
                                QuaTangId: self.nhapKhoChiTietMarketing.QuaTangId,
                                QuaTang: tenQuaTang_1,
                            ...
                            var index = 1;
                            self.nhapKhoChiTietMarketing.DanhSachQuaTangDuocThemList.forEach(function (element) {
                                element.STT = index++;
                            });
                            self.gridDataSource = {
                            ...
                            _this.TongCong = self.nhapKhoChiTietMarketing.DanhSachQuaTangDuocThemList.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                            self.setDataGridView();
                            self.Huy();
                        });
                    }
                };
                MarketingNhapKhoSharedComponent.prototype.Huy = function () {
                    this.validationErrorsChiTiet = [];
                    this.validationErrors = [];
                    this.nhapKhoChiTietMarketing.NhaCungCap = null;
                ...
                MarketingNhapKhoSharedComponent.prototype.Luu = function () {
                };
                MarketingNhapKhoSharedComponent.prototype.modelChangeSoLuongMua = function (event, dataItem) {
                ...
                MarketingNhapKhoSharedComponent.prototype.modelChangeGiaNhapMua = function (event, dataItem) {
                    if (event == 0 || event === null) {
                        for (var index = 0; index < this.gridDataSource.data.length; index++) {
                            if (this.gridDataSource.data[index].STT === dataItem.STT) {
                                this.gridDataSource.data[index].ThanhTien = 0;
                ...
                MarketingNhapKhoSharedComponent.prototype.ChangeQuaTang = function (event) {
                    var _this = this;
                    if (event != null) {
                        var self = this;
                        self.apiService.post("Marketing/GetDonViTinhQuaTang?idQuaTang=" + event.KeyId).subscribe(function (resultData) {
                ...
                MarketingNhapKhoSharedComponent.prototype.modelChangeGiaNhap = function (event) {
                    if (event == 0) {
                        this.validationErrors = [];
                ...
                MarketingNhapKhoSharedComponent.prototype.modelChangeSoLuong = function (event) {
                    if (event == 0) {
                        this.validationErrors = [];
                ...
                MarketingNhapKhoSharedComponent.prototype.Xoa = function (event) {
                    var _this = this;
                    console.log(event);
                    if (event != undefined && event != null) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                if (event.SoLuongDaXuat != 0) {
                                    _this.notificationService.showError("Số lượng quà tặng đã được xuất");
                                }
                                else {
                                    _this.gridDataSource.data.splice(_this.gridDataSource.data.findIndex(function (x) { return x == event; }), 1);
                                    _this.TongCong = _this.gridDataSource.data.reduce(function (sum, item) { return sum + item.ThanhTien; }, 0);
                ...
                MarketingNhapKhoSharedComponent.prototype.NhanVienTaiBenhVien = function (event) {
                    if (event != undefined || event != null) {
                ...
                MarketingNhapKhoSharedComponent.prototype.getSharedData = function () {
                    var kiemtraSave = true;
                    this.validationErrorsChiTiet = [];
                ...
                MarketingNhapKhoSharedComponent.prototype.onKeyEnterAddItem = function (event) {
                ...
                MarketingNhapKhoSharedComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                MarketingNhapKhoSharedComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter" && !this.isSelectingItem) {
                        if (this.isSelectingItem != true) {
                            this.Them();
                        }
                ...
                return MarketingNhapKhoSharedComponent;
            }());
            MarketingNhapKhoSharedComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_vex_animations_stagger_animation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/@vex/animations/stagger.animation */ "./src/@vex/animations/stagger.animation.ts");
            /* harmony import */ var src_vex_animations_fade_in_up_animation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/@vex/animations/fade-in-up.animation */ "./src/@vex/animations/fade-in-up.animation.ts");
            var MarketingNhapKhoUpdateComponent = /** @class */ (function () {
                function MarketingNhapKhoUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                MarketingNhapKhoUpdateComponent.prototype.ngOnInit = function () {
                };
                MarketingNhapKhoUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/marketing/nhap-kho-marketing']);
                };
                return MarketingNhapKhoUpdateComponent;
            }());
            MarketingNhapKhoUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MarketingNhapKhoModule = /** @class */ (function () {
                function MarketingNhapKhoModule() {
                }
                return MarketingNhapKhoModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MarketingNhapKhoService = /** @class */ (function (_super) {
                __extends(MarketingNhapKhoService, _super);
                function MarketingNhapKhoService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'Marketing';
                    return _this;
                }
                return MarketingNhapKhoService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            MarketingNhapKhoService.ctorParameters = function () { return [
...
//# sourceMappingURL=marketing-marketing-nhap-kho-marketing-nhap-kho-module-es5.js.map
//# sourceMappingURL=marketing-marketing-nhap-kho-marketing-nhap-kho-module-es5.js.map