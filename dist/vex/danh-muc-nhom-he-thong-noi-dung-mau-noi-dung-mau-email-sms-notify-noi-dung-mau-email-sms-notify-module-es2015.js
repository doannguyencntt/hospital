...
let NoiDungMauEmailSmsNotifyListComponent = class NoiDungMauEmailSmsNotifyListComponent {
    constructor(router, dialog, authService, notificationService, apiService) {
        this.router = router;
        this.dialog = dialog;
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("TemplateEmail/ExportTemplate", this.gridChild._gridQueryInfo).subscribe(res => {
...
NoiDungMauEmailSmsNotifyListComponent.ctorParameters = () => [
...
let NoiDungMauEmailSmsNotifyRoutingModule = class NoiDungMauEmailSmsNotifyRoutingModule {
};
...
let NoiDungMauEmailSmsNotifyShareComponent = class NoiDungMauEmailSmsNotifyShareComponent {
...
NoiDungMauEmailSmsNotifyShareComponent.ctorParameters = () => [
...
let NoiDungMauEmailSmsNotifyUpdateComponent = class NoiDungMauEmailSmsNotifyUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
NoiDungMauEmailSmsNotifyUpdateComponent.ctorParameters = () => [
...
let NoiDungMauEmailSmsNotifyModule = class NoiDungMauEmailSmsNotifyModule {
};
...
let NoiDungMauEmailSmsNotifyService = class NoiDungMauEmailSmsNotifyService extends _app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'TemplateEmail';
    }
};
NoiDungMauEmailSmsNotifyService.ctorParameters = () => [
