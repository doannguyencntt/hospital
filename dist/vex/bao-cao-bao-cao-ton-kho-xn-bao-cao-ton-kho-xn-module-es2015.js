...
let BaoCaoTonKhoXnListComponent = class BaoCaoTonKhoXnListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoTonKhoXetNghiemForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoTonKhoXnListComponent.ctorParameters = () => [
...
let BaoCaoTonKhoXnRoutingModule = class BaoCaoTonKhoXnRoutingModule {
};
...
let BaoCaoTonKhoXnModule = class BaoCaoTonKhoXnModule {
};
...
let BaoCaoTonKhoXnService = class BaoCaoTonKhoXnService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoTonKhoXnService.ctorParameters = () => [
