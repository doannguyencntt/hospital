...
let BaoCaoTongHopCongNoChuaThanhToanListComponent = class BaoCaoTongHopCongNoChuaThanhToanListComponent {
    ...
    getTongCong(queryInfo) {
        this.apiService.post("BaoCao/GetTongCongCongNoChuaThanhToan", queryInfo).subscribe(resultData => {
...
BaoCaoTongHopCongNoChuaThanhToanListComponent.ctorParameters = () => [
...
let BaoCaoTongHopCongNoChuaThanhToanRoutingModule = class BaoCaoTongHopCongNoChuaThanhToanRoutingModule {
};
...
class BaoCaoTongHopCongNoChuaThanhToanTimKiemNangCao {
    constructor(HinhThucDenId = null, NoiGioiThieuId = null, MaYeuCauTiepNhan = "0", SearchString = "", FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null) {
...
let BaoCaoTongHopCongNoChuaThanhToanModule = class BaoCaoTongHopCongNoChuaThanhToanModule {
};
