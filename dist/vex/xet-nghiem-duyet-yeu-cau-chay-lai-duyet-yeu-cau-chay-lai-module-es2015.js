...
let DuyetYeuCauChayLaiDuyetComponent = class DuyetYeuCauChayLaiDuyetComponent {
    constructor(router, authService, route, notificationService, dialog, apiService) {
        this.router = router;
    ...
    xuLyTuChoi() {
        this.dialog.open(_duyet_yeu_cau_chay_lai_tu_choi_popup_duyet_yeu_cau_chay_lai_tu_choi_popup_component__WEBPACK_IMPORTED_MODULE_12__["DuyetYeuCauChayLaiTuChoiPopupComponent"], {
            ...
            if (result !== null) {
                let tuChoiYeuCauGoiLaiXetNghiem = new _duyet_yeu_cau_chay_lai_model__WEBPACK_IMPORTED_MODULE_13__["TuChoiYeuCauGoiLaiXetNghiem"]();
                ...
                this.apiService.post("XetNghiem/TuChoiXetNghiemLai", tuChoiYeuCauGoiLaiXetNghiem)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Từ chối"]));
                    this.quayLai();
                }, (err) => {
            ...
            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_8__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    ...
                    this.danhSachChoDuyetlais.forEach((element) => {
                        let duyet = new _duyet_yeu_cau_chay_lai_model__WEBPACK_IMPORTED_MODULE_13__["DuyetYeuCauGoiLaiXetNghiem"]();
                        duyet.Id = element.Id,
...
DuyetYeuCauChayLaiDuyetComponent.ctorParameters = () => [
...
let DuyetYeuCauChayLaiListComponent = class DuyetYeuCauChayLaiListComponent {
    ...
    xuLyTuChoi(dataItem) {
        this.dialog.open(_duyet_yeu_cau_chay_lai_tu_choi_popup_duyet_yeu_cau_chay_lai_tu_choi_popup_component__WEBPACK_IMPORTED_MODULE_15__["DuyetYeuCauChayLaiTuChoiPopupComponent"], {
            ...
            if (result !== null && result !== undefined && result !== "") {
                let tuChoiYeuCauGoiLaiXetNghiem = new _duyet_yeu_cau_chay_lai_model__WEBPACK_IMPORTED_MODULE_14__["TuChoiYeuCauGoiLaiXetNghiem"]();
                tuChoiYeuCauGoiLaiXetNghiem.PhienXetNghiemId = dataItem.PhienXetNghiemId;
                tuChoiYeuCauGoiLaiXetNghiem.LyDoTuChoi = result;
                this.apiService.post("XetNghiem/TuChoiXetNghiemLai", tuChoiYeuCauGoiLaiXetNghiem)
                    .subscribe((resultData) => {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_18__["SystemMessage"].ActionSuccessfully, ["Từ chối"]));
                    this.gridChild.search();
                }, (err) => {
                    if (err.Message != "Validation Failed") {
                        this.notificationService.showError(err.Message);
            ...
            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_17__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    ...
                    dataItem.DanhSachPhienXetNghiemIds.forEach((element) => {
                        let duyet = new _duyet_yeu_cau_chay_lai_model__WEBPACK_IMPORTED_MODULE_14__["DuyetYeuCauGoiLaiXetNghiem"]();
                        duyet.Id = element;
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_16__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('XetNghiem/ExportYeuCauXetNghiemChayLai', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
DuyetYeuCauChayLaiListComponent.ctorParameters = () => [
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"] },
...
let DuyetYeuCauChayLaiRoutingModule = class DuyetYeuCauChayLaiRoutingModule {
};
...
let DuyetYeuCauChayLaiTuChoiPopupComponent = class DuyetYeuCauChayLaiTuChoiPopupComponent {
...
DuyetYeuCauChayLaiTuChoiPopupComponent.ctorParameters = () => [
...
class DuyetYeuCauChayLaiXetNghiemTimKiem {
    constructor(SearchString = null, DangChoDuyet = true, DaDuyet = false, TuChoiDuyet = false, TuNgayDenNgay = new DuyetYeuCauChayLaiXetNghiemTimKiemDateRange()) {
...
class DuyetYeuCauChayLaiXetNghiemTimKiemDateRange {
...
class TuChoiYeuCauGoiLaiXetNghiem {
    constructor(LyDoTuChoi = null, PhienXetNghiemId = null) {
        this.LyDoTuChoi = LyDoTuChoi;
        this.PhienXetNghiemId = PhienXetNghiemId;
    }
}
class DanhSachGoiXetNghiemLai {
    constructor(DuyetYeuCauGoiLaiXetNghiems = []) {
        this.DuyetYeuCauGoiLaiXetNghiems = DuyetYeuCauGoiLaiXetNghiems;
    }
}
class DuyetYeuCauGoiLaiXetNghiem {
    constructor(Id = null, NhanVienYeuCauId = null) {
        this.Id = Id;
        this.NhanVienYeuCauId = NhanVienYeuCauId;
    }
}
class ThongTinHanhChinhXN {
    constructor(MaBarCode = null, MaBN = null, MaTN = null, HoTen = null, Tuoi = null, GioiTinh = null, DungTuyen = null, NgheNghiep = null, MucHuong = null, DanToc = null, DiaChi = null, ChuanDoan = null, KhoaChiDinh = null, PhongKham = null, TrangThai = null, MaBhyt = null, 
    //BVHD-3800
    LaCapCuu = null) {
...
let DuyetYeuCauChayLaiModule = class DuyetYeuCauChayLaiModule {
};
...
let ResizableDirective = class ResizableDirective {
    constructor(documentRef, elementRef) {
        ...
        this.resizable = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["fromEvent"])(this.elementRef.nativeElement, "mousedown").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(e => e.preventDefault()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            const { width, right } = this.elementRef.nativeElement
                .closest("th")
                .getBoundingClientRect();
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["fromEvent"])(this.documentRef, "mousemove").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(({ clientX }) => width + clientX - right), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["fromEvent"])(this.documentRef, "mouseup")));
        }));
    }
};
...
let ResizableModule = class ResizableModule {
};
