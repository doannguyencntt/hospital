...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-hanh-chinh-nghe-nghiep-nghe-nghiep-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgheNghiepCreateComponent = /** @class */ (function () {
                function NgheNghiepCreateComponent(router) {
                    this.router = router;
                }
                NgheNghiepCreateComponent.prototype.ngOnInit = function () {
                };
                NgheNghiepCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/hanh-chinh/nghe-nghiep']);
                };
                return NgheNghiepCreateComponent;
            }());
            NgheNghiepCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgheNghiepListComponent = /** @class */ (function () {
                function NgheNghiepListComponent(authService, dialog, notificationService, apiService) {
                ...
                NgheNghiepListComponent.prototype.ngOnInit = function () {
                ...
                NgheNghiepListComponent.prototype.updateNgheNghiep = function (id, isDisabled) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                self.apiService.post("NgheNghiep/KichHoatNgheNghiep?id=" + id).subscribe(function () {
                ...
                NgheNghiepListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("NgheNghiep/ExportNgheNghiep", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return NgheNghiepListComponent;
            }());
            NgheNghiepListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgheNghiepRoutingModule = /** @class */ (function () {
                function NgheNghiepRoutingModule() {
                }
                return NgheNghiepRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgheNghiepSharedComponent = /** @class */ (function () {
                function NgheNghiepSharedComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.ngheNghiep = {};
                }
                NgheNghiepSharedComponent.prototype.ngOnInit = function () {
                ...
                NgheNghiepSharedComponent.prototype.getSharedData = function () {
                    return this.ngheNghiep;
                };
                NgheNghiepSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.ngheNghiep = resultData;
                    });
                };
                return NgheNghiepSharedComponent;
            }());
            NgheNghiepSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _nghe_nghiep_shared_nghe_nghiep_shared_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../nghe-nghiep-shared/nghe-nghiep-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/hanh-chinh/nghe-nghiep/nghe-nghiep-shared/nghe-nghiep-shared.component.ts");
            var NgheNghiepUpdateComponent = /** @class */ (function () {
                function NgheNghiepUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                NgheNghiepUpdateComponent.prototype.ngOnInit = function () {
                };
                NgheNghiepUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/hanh-chinh/nghe-nghiep']);
                };
                return NgheNghiepUpdateComponent;
            }());
            NgheNghiepUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgheNghiepModule = /** @class */ (function () {
                function NgheNghiepModule() {
                }
                return NgheNghiepModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NgheNghiepService = /** @class */ (function (_super) {
                __extends(NgheNghiepService, _super);
                function NgheNghiepService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'NgheNghiep';
                    return _this;
                }
                return NgheNghiepService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            NgheNghiepService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-hanh-chinh-nghe-nghiep-nghe-nghiep-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-hanh-chinh-nghe-nghiep-nghe-nghiep-module-es5.js.map