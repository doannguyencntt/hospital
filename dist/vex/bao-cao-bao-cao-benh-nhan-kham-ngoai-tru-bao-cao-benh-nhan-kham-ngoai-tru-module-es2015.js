...
let BaoCaoBenhNhanKhamNgoaiPopupComponent = class BaoCaoBenhNhanKhamNgoaiPopupComponent {
...
BaoCaoBenhNhanKhamNgoaiPopupComponent.ctorParameters = () => [
...
let BaoCaoBenhNhanKhamNgoaiTruListComponent = class BaoCaoBenhNhanKhamNgoaiTruListComponent {
    constructor(route, router, apiService, dialog, notificationService, authService) {
        this.route = route;
        this.router = router;
    ...
    XemBaoCao() {
        ...
        let tuNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].formatDateTime(this.baoCaoSearch.TuNgayFormat, "dd/mm/yyyy");
        let denNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].formatDateTime(this.baoCaoSearch.DenNgayFormat, "dd/mm/yyyy");
        let khoaId = 0;
        ...
        this.ishowView = false;
        this.apiService.post("BaoCao/GetBaoCaoBenhNhanKhamNgoaiTruForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoBenhNhanKhamNgoaiTruListComponent.ctorParameters = () => [
...
class BaoCaoBenhNhanKhamNgoaiTruSearch {
    constructor(FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null, KhoaId = null, PhongId = null, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
class BaoCaoBenhNhanKhamNgoaiTru {
...
class InBaoCaoBenhNhanKhamNgoaiTru {
...
let BaoCaoBenhNhanKhamNgoaiTruService = class BaoCaoBenhNhanKhamNgoaiTruService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoBenhNhanKhamNgoaiTruService.ctorParameters = () => [
