...
let CongNoBaoHiemTuNhanBenhNhanPopupComponent = class CongNoBaoHiemTuNhanBenhNhanPopupComponent {
...
CongNoBaoHiemTuNhanBenhNhanPopupComponent.ctorParameters = () => [
...
let CongNoBaoHiemTuNhanCongTyPopupComponent = class CongNoBaoHiemTuNhanCongTyPopupComponent {
    constructor(dialogRef) {
        this.dialogRef = dialogRef;
        this.icClose = _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default.a;
        this.gridColumns = [];
...
CongNoBaoHiemTuNhanCongTyPopupComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('sttTemplate', { static: true })
...
let CongNoBaoHiemTuNhanLichSuPopupComponent = class CongNoBaoHiemTuNhanLichSuPopupComponent {
    constructor(data, apiService, notificationService) {
        this.data = data;
...
CongNoBaoHiemTuNhanLichSuPopupComponent.ctorParameters = () => [
...
let CongNoBaoHiemTuNhanListComponent = class CongNoBaoHiemTuNhanListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("GachNo/ExportGachNo", this.gridChild._gridQueryInfo).subscribe(res => {
...
CongNoBaoHiemTuNhanListComponent.ctorParameters = () => [
...
let CongNoBaoHiemTuNhanRoutingModule = class CongNoBaoHiemTuNhanRoutingModule {
};
...
let CongNoBaoHiemTuNhanThuNoPopupComponent = class CongNoBaoHiemTuNhanThuNoPopupComponent {
    ...
    xuLyThem() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Add) || this.authService.hasPermission(src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_4__["DocumentType"].CongNoBhtnXacNhanNhapLieu, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Add)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.validationErrors = [];
                    this.apiService.post("GachNo/XuLyTaoThongTinThuNo", this.gachNo)
                        .subscribe(() => {
    ...
    xuLyLuu() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Update) || this.authService.hasPermission(src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_4__["DocumentType"].CongNoBhtnXacNhanNhapLieu, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Update)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.validationErrors = [];
                    this.apiService.put("GachNo/XuLyCapNhatThongTinThuNo", this.gachNo)
                        .subscribe(() => {
    ...
    xacNhanNhapLieu() {
        if (this.authService.hasPermission(src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_4__["DocumentType"].CongNoBhtnXacNhanNhapLieu, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_6__["SecurityOperation"].Update)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.validationErrors = [];
                    this.apiService.put("GachNo/XuLyXacNhanNhapLieu", this.gachNo)
                        .subscribe(() => {
                        this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Xác nhận nhập liệu"]));
                        this.dialogRef.close();
                    }, (err) => {
                        this.validationErrors = err.ValidationErrors;
                        if (err.Message != "Validation Failed") {
...
CongNoBaoHiemTuNhanThuNoPopupComponent.ctorParameters = () => [
...
let CongNoBaoHiemTuNhanModule = class CongNoBaoHiemTuNhanModule {
};
