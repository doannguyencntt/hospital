...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-duoc-pham-tong-hop-du-tru-mua-tai-khoa-duoc-tong-hop-du-tru-mua-tai-khoa-duoc-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuyetDuTruMuaDuocPhamSharedComponent = /** @class */ (function () {
                function DuyetDuTruMuaDuocPhamSharedComponent(authService, dialog, notificationService, apiService, router, route) {
                ...
                DuyetDuTruMuaDuocPhamSharedComponent.prototype.ngOnInit = function () {
                ...
                DuyetDuTruMuaDuocPhamSharedComponent.prototype.TooltipCustom = function (duTruDetail) {
                    this.khos = duTruDetail.TongTonList.slice();
                    this.hdts = duTruDetail.HopDongChuahapList.slice();
                };
                DuyetDuTruMuaDuocPhamSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    ...
                    this.apiService.post("YeuCauMuaDuocPham/GetDataUpdate?id=" + id + "&typeLoaiKho=" + this.loaiKhoThuoc)
                        ...
                        if (resultData !== undefined && resultData != null) {
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.Id = resultData.Id;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.SoPhieu = resultData.SoPhieu;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.KhoId = resultData.KhoaId;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.Khoa = resultData.TenKhoa;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.KyDuTru = resultData.KyDuTru;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.NguoiYeuCauId = resultData.NguoiYeuCauId;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.TenNguoiYeuCau = resultData.TenNguoiYeuCau;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.NgayYeuCau = resultData.NgayYeuCau;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.GhiChu = resultData.GhiChu;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.TenKho = resultData.TenKho;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.TrangThai = resultData.TrangThai;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.TrangThaiHienThi = resultData.TrangThaiHienThi;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.KhoId = resultData.KhoId;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.LoaiDuTru = resultData.TenLoaiDuTru;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.LoaiDuTruId = resultData.LoaiDuTruId;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.LyDoTruongKhoaTuChoi = resultData.LyDoTuChoi;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList = resultData.thongTinChiTietTongHopDuTruTuaTaiKhoaDuocList;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.KhoaId = resultData.KhoaId;
                            _this.gridDataSource = {
                                data: _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList,
                                total: _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList.length
                            };
                            _this.setDataGridView();
                            _this.dataItem.emit(_this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc);
                        }
                    });
                };
                DuyetDuTruMuaDuocPhamSharedComponent.prototype.getSharedData = function () {
                    this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc;
                };
                DuyetDuTruMuaDuocPhamSharedComponent.prototype.setDataGridView = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                DuyetDuTruMuaDuocPhamSharedComponent.prototype.setDataGridViewRefesh = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                DuyetDuTruMuaDuocPhamSharedComponent.prototype.modelChangeSoLuongDuyet = function (event, dataItem) {
                    if (event != null) {
                        var index = this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList.findIndex(function (x) { return x.Id == dataItem.Id; });
                        var vitri = this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList.indexOf(dataItem);
                        if (index != -1) {
                            this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList[vitri].SLDuTruTKhoDuyet = event;
                        }
                    }
                };
                DuyetDuTruMuaDuocPhamSharedComponent.prototype.modelChangeSoLuongKDDuyet = function (event, dataItem) {
                    if (event != null) {
                        var index = this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList.findIndex(function (x) { return x.Id == dataItem.Id; });
                        var vitri = this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList.indexOf(dataItem);
                        if (index != -1) {
                ...
                return DuyetDuTruMuaDuocPhamSharedComponent;
            }());
            DuyetDuTruMuaDuocPhamSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DuyetDuTruMuaDuocPhamUpdateComponent = /** @class */ (function () {
                function DuyetDuTruMuaDuocPhamUpdateComponent(authService, dialog, notificationService, apiService, router, route) {
                    this.authService = authService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                ...
                DuyetDuTruMuaDuocPhamUpdateComponent.prototype.ngOnInit = function () {
                ...
                DuyetDuTruMuaDuocPhamUpdateComponent.prototype.huy = function () {
                    this.router.navigateByUrl('/nhap-xuat/duoc-pham/tong-hop-mua-thuoc-tai-khoa-duoc?holdQuery=true');
                };
                DuyetDuTruMuaDuocPhamUpdateComponent.prototype.tuChoi = function () {
                    var _this = this;
                    var self = this;
                ...
                DuyetDuTruMuaDuocPhamUpdateComponent.prototype.Duyet = function () {
                    var _this = this;
                    var self = this;
                    self.validationErrors = [];
                    self.thongTinDuTruMuaDuocPhamTaiKhoaDuoc = this.shared.thongTinDuTruMuaDuocPhamTaiKhoaDuoc;
                    ...
                    if (self.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList.length != 0) {
                        self.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList.forEach(function (element) {
                            var duTru = new _tong_hop_du_tru_mua_tai_khoa_duoc_model__WEBPACK_IMPORTED_MODULE_4__["DuTruMuaDuocPhamKhoDuocChiTietList"]();
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                        ...
                        if (result === 'Yes') {
                            self.apiService.post("YeuCauMuaDuocPham/DuyetDanhSach", _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc)
                                .subscribe(function (resultData) {
                ...
                DuyetDuTruMuaDuocPhamUpdateComponent.prototype.huyDuyet = function () {
                    var _this = this;
                    if (this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.KhoId != 0) {
                        var self = this;
                        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                self.apiService.post("YeuCauMuaDuocPham/HuyDuyet", { id: _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.Id, loaiKho: _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.KhoId })
                                    .subscribe(function (resultData) {
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["SystemMessage"].ActionSuccessfully, ["Hủy duyệt"]));
                                    _this.router.navigateByUrl('/nhap-xuat/duoc-pham/tong-hop-mua-thuoc-tai-khoa-duoc?holdQuery=true');
                                }, function (err) {
                                    if (err.Message != "Validation Failed") {
                                        _this.notificationService.showError(err.Message);
                                    }
                    ...
                    if (this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.KhoaId != 0) {
                        ...
                        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                self.apiService.post("YeuCauMuaDuocPham/HuyDuyet", { id: _this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc.Id, loaiKho: 5 })
                                    .subscribe(function (resultData) {
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_13__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_14__["SystemMessage"].ActionSuccessfully, ["Hủy duyệt"]));
                                    _this.router.navigateByUrl('/nhap-xuat/duoc-pham/tong-hop-mua-thuoc-tai-khoa-duoc?holdQuery=true');
                                }, function (err) {
                ...
                DuyetDuTruMuaDuocPhamUpdateComponent.prototype.back = function () {
                    this.router.navigateByUrl('/nhap-xuat/duoc-pham/tong-hop-mua-thuoc-tai-khoa-duoc?holdQuery=true');
                };
                DuyetDuTruMuaDuocPhamUpdateComponent.prototype.getTrangThaiYeuCau = function (event) {
                ...
                DuyetDuTruMuaDuocPhamUpdateComponent.prototype.getDataItem = function (event) {
                    this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc = event;
                };
                return DuyetDuTruMuaDuocPhamUpdateComponent;
            }());
            DuyetDuTruMuaDuocPhamUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_shared_component_grid_grid_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/component/grid/grid.component */ "./src/app/shared/component/grid/grid.component.ts");
            var GoiGiamDocDuTruMuaDuocPhamSharedComponent = /** @class */ (function () {
                function GoiGiamDocDuTruMuaDuocPhamSharedComponent(authService, dialog, notificationService, apiService, router, route) {
                    this.authService = authService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                ...
                GoiGiamDocDuTruMuaDuocPhamSharedComponent.prototype.ngOnInit = function () {
                ...
                GoiGiamDocDuTruMuaDuocPhamSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.isDisableTrangThai = true;
                    this.apiService.post("YeuCauMuaDuocPham/GetDataGoiDuyetDuTruMuaDuocPham?idKyDuTru=" + id)
                        .subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi = resultData;
                            _this.gridDataSource = {
                            ...
                            _this.setDataGridView();
                            _this.dataItem.emit(_this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi);
                        }
                    });
                };
                GoiGiamDocDuTruMuaDuocPhamSharedComponent.prototype.getDataSourceChild = function (parentItem) {
                    return {
                ...
                GoiGiamDocDuTruMuaDuocPhamSharedComponent.prototype.getByIdView = function (id, tinhTrang) {
                    var _this = this;
                    this.isDisableTrangThai = true;
                    this.apiService.post("YeuCauMuaDuocPham/GetDataGoiDuyetDuTruMuaDuocPhamView?idKyDuTru=" + id + "&tinhTrang=" + tinhTrang)
                        ...
                        if (resultData !== undefined && resultData != null) {
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi = resultData;
                            _this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi.LyDoTuChoi = resultData.LyDoTuChoi;
                            _this.gridDataSource = {
                                data: resultData.thongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList,
                                total: resultData.thongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList.length
                            };
                ...
                GoiGiamDocDuTruMuaDuocPhamSharedComponent.prototype.setDataGridView = function () {
                    this.gridChild.gridDataSource = this.gridDataSource;
                    if (this.gridChild !== undefined)
                        this.gridChild.setDataSource();
                };
                GoiGiamDocDuTruMuaDuocPhamSharedComponent.prototype.getSharedData = function () {
                    this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi;
                };
                return GoiGiamDocDuTruMuaDuocPhamSharedComponent;
            }());
            GoiGiamDocDuTruMuaDuocPhamSharedComponent.ctorParameters = function () { return [
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoiGiamDocDuTruMuaDuocPhamUpdateComponent = /** @class */ (function () {
                function GoiGiamDocDuTruMuaDuocPhamUpdateComponent(authService, dialog, notificationService, apiService, router, route, ref) {
                    this.authService = authService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                ...
                GoiGiamDocDuTruMuaDuocPhamUpdateComponent.prototype.ngOnInit = function () {
                ...
                GoiGiamDocDuTruMuaDuocPhamUpdateComponent.prototype.huy = function () {
                    this.router.navigateByUrl('/nhap-xuat/duoc-pham/tong-hop-mua-thuoc-tai-khoa-duoc?holdQuery=true');
                };
                GoiGiamDocDuTruMuaDuocPhamUpdateComponent.prototype.tinhTrangVieww = function (event) {
                    if (event != null) {
                        this.tinhTrangView = false;
                    }
                };
                GoiGiamDocDuTruMuaDuocPhamUpdateComponent.prototype.goi = function () {
                    var _this = this;
                    var self = this;
                    ...
                    if (this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi != undefined && this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi != null) {
                        ...
                        if (this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi.thongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList != undefined && this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi.thongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList != null) {
                            this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi.thongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList.forEach(function (item) {
                                var data = new _tong_hop_du_tru_mua_tai_khoa_duoc_model__WEBPACK_IMPORTED_MODULE_10__["DuTruMuaDuocPhamKhoDuocChiTiets"]();
                                ...
                                _this.duTruMuaDuocPhamTaiKhoaDuoc.DuTruMuaDuocPhamKhoDuocChiTiet.push(data);
                            });
                        }
                    }
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                        self.dialog.open(_gui_tong_hop_du_tru_mua_thuoc_tai_khoa_duoc_confirm_gui_tong_hop_du_tru_mua_thuoc_tai_khoa_duoc_confirm_component__WEBPACK_IMPORTED_MODULE_13__["GuiTongHopDuTruMuaThuocTaiKhoaDuocConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                ...
                                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                                    self.savingPage();
                                    self.apiService.post("YeuCauMuaDuocPham/GuiDuTruMuaDuocPhamTaiKhoaDuoc", self.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi).subscribe(function (resultData) {
                                        if (resultData != undefined && resultData != null) {
                                            self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_14__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_15__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                                            self.closePopupSavingData();
                ...
                GoiGiamDocDuTruMuaDuocPhamUpdateComponent.prototype.closePopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                GoiGiamDocDuTruMuaDuocPhamUpdateComponent.prototype.savingPage = function () {
                ...
                GoiGiamDocDuTruMuaDuocPhamUpdateComponent.prototype.getDataItem = function (event) {
                    this.thongTinDuTruMuaDuocPhamTaiKhoaDuocGoi = event;
                };
                return GoiGiamDocDuTruMuaDuocPhamUpdateComponent;
            }());
            GoiGiamDocDuTruMuaDuocPhamUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GuiTongHopDuTruMuaThuocTaiKhoaDuocConfirmComponent = /** @class */ (function () {
                function GuiTongHopDuTruMuaThuocTaiKhoaDuocConfirmComponent(dialogRef, data) {
                ...
                GuiTongHopDuTruMuaThuocTaiKhoaDuocConfirmComponent.prototype.ngOnInit = function () {
                    this.Title = this.data.Title;
                    this.Message = this.data.Message;
                };
                GuiTongHopDuTruMuaThuocTaiKhoaDuocConfirmComponent.prototype.close = function (result) {
                    this.dialogRef.close(result);
                };
                return GuiTongHopDuTruMuaThuocTaiKhoaDuocConfirmComponent;
            }());
            GuiTongHopDuTruMuaThuocTaiKhoaDuocConfirmComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuMuaTruTaiKhoaDuocComponent = /** @class */ (function () {
                function PhieuMuaTruTaiKhoaDuocComponent(dialogRef, apiService, notificationService, data, ref) {
                    this.dialogRef = dialogRef;
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.data = data;
                ...
                PhieuMuaTruTaiKhoaDuocComponent.prototype.ngOnInit = function () {
                    console.log(this.data);
                    this.xem();
                };
                PhieuMuaTruTaiKhoaDuocComponent.prototype.xem = function () {
                    var self = this;
                    self.validationErrors = [];
                    self.ref.detectChanges();
                    self.inPhieuDuocPham.DuTruMuaDuocPhamTheoKhoaId = self.data.Id;
                    self.inPhieuDuocPham.Header = true;
                    self.apiService.post("YeuCauMuaDuocPham/InPhieuDuTruMuaTaiKhoaDuoc", self.inPhieuDuocPham).subscribe(function (resData) {
                ...
                PhieuMuaTruTaiKhoaDuocComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                ...
                PhieuMuaTruTaiKhoaDuocComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                return PhieuMuaTruTaiKhoaDuocComponent;
            }());
            PhieuMuaTruTaiKhoaDuocComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent = /** @class */ (function () {
                function TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent(authService, dialog, notificationService, apiService, router, route) {
                    this.authService = authService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                ...
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.ngOnInit = function () {
                ...
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.TooltipCustom = function (duTruDetail) {
                    this.khos = duTruDetail.TongTonList.slice();
                    this.hdts = duTruDetail.HopDongChuahapList.slice();
                };
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.theFirstValueFormat = function (str) {
                    var strGroup = str.split('-');
                    if (strGroup.length != 0) {
                        return strGroup[0];
                    }
                };
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.theFirstValueFormatChuKy = function (str) {
                    var strGroup = str.split('-');
                    if (strGroup.length != 0) {
                        return strGroup[1] + '-' + strGroup[2];
                    }
                };
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.theFirstValueKyDuTruMuaDuocPhamVatTuId = function (str) {
                    var strGroup = str.split('-');
                    if (strGroup.length != 0) {
                        return strGroup[3];
                    }
                };
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.xemChiTietDuTruMuaDuocPhamTaiKhoDuoc = function (id, dataItem, TrangThaiDuTru) {
                ...
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.CheckboxChange = function ($event, dangChoDuyet, tuChoiDuyet, daDuyet) {
                ...
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.onKey = function (event) {
                    if (event.keyCode === 13) {
                        this.Timkiem();
                    }
                };
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.Timkiem = function () {
                    ...
                    this.router.navigateByUrl('/nhap-xuat/duoc-pham/tong-hop-mua-thuoc-tai-khoa-duoc?holdQuery=true');
                    var tongHopDuTruTuaTaiKhoaDuocSearchClone = JSON.parse(JSON.stringify(this.tongHopDuTruTuaTaiKhoaDuocSearch));
                    if (tongHopDuTruTuaTaiKhoaDuocSearchClone.RangeNhap.startDate != null) {
                        var startDate = new Date(tongHopDuTruTuaTaiKhoaDuocSearchClone.RangeNhap.startDate);
                    ...
                    if (tongHopDuTruTuaTaiKhoaDuocSearchClone.RangeNhap.endDate != null) {
                        var endDate = new Date(tongHopDuTruTuaTaiKhoaDuocSearchClone.RangeNhap.endDate);
                    ...
                    if (tongHopDuTruTuaTaiKhoaDuocSearchClone.RangeDuyet.startDate != null) {
                        var startDate = new Date(tongHopDuTruTuaTaiKhoaDuocSearchClone.RangeDuyet.startDate);
                    ...
                    if (tongHopDuTruTuaTaiKhoaDuocSearchClone.RangeDuyet.endDate != null) {
                        var endDate = new Date(tongHopDuTruTuaTaiKhoaDuocSearchClone.RangeDuyet.endDate);
                    ...
                    var queryForHole = JSON.parse(JSON.stringify(tongHopDuTruTuaTaiKhoaDuocSearchClone));
                ...
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.clearSearch = function () {
                    if (this.searchString == "") {
                        this.gridChild.searchString = "";
                        this.Timkiem();
                    }
                };
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.changeNgayNhapRange = function () {
                    this.Timkiem();
                };
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.changeNgayDuyetRange = function (range) {
                    this.Timkiem();
                };
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.TuChoi = function (Id, KhoId) {
                    var _this = this;
                    var self = this;
                                    ...
                                    self.dialog.open(_tu_choi_duyet_popup_tu_choi_duyet_popup_component__WEBPACK_IMPORTED_MODULE_29__["TuChoiDuyetPopupComponent"], {
                                        ...
                                        if (result != null) {
                                            ...
                                            self.apiService.post("YeuCauMuaDuocPham/TuChoi", self.duTruMuaDuocPhamKhoDuoc)
                                                .subscribe(function (resultData) {
                                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Từ chối"]));
                ...
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.duyet = function (Id, khoId) {
                    var _this = this;
                    var self = this;
                    self.duTruMuaDuocPhamKhoDuoc.Id = Id;
                    if (self.duTruMuaDuocPhamKhoDuoc.Id != undefined && self.duTruMuaDuocPhamKhoDuoc.Id != null) {
                                    ...
                                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                                        ...
                                        if (result === 'Yes') {
                                            self.apiService.post("YeuCauMuaDuocPham/Duyet", self.duTruMuaDuocPhamKhoDuoc)
                                                .subscribe(function (resultData) {
                                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Duyệt"]));
                                                _this.gridChild.search();
                                            }, function (err) {
                                                if (err.Message != "Validation Failed") {
                                                    _this.notificationService.showError(err.Message);
                ...
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.HuyDuyet = function (dataItem, khoId) {
                    var _this = this;
                    var self = this;
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                        disableClose: false,
                        ...
                        if (result === 'Yes') {
                            self.apiService.post("YeuCauMuaDuocPham/HuyDuyet", { id: dataItem.Id, loaiKho: dataItem.KhoId })
                                .subscribe(function (resultData) {
                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Hủy duyệt"]));
                                _this.gridChild.search();
                            }, function (err) {
                                if (err.Message != "Validation Failed") {
                                    _this.notificationService.showError(err.Message);
                ...
                TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.prototype.GoiGiamDocDuyet = function (value) {
                    var self = this;
                ...
                return TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent;
            }());
            TongHopDuTruMuaTaiKhoaDuocChoXuLyComponent.ctorParameters = function () { return [
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent = /** @class */ (function () {
                function TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent(authService, dialog, notificationService, apiService, router, route, location) {
                    this.authService = authService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                ...
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.ngOnInit = function () {
                ...
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.TooltipCustom = function (duTruDetail) {
                    this.khos = duTruDetail.TongTonList.slice();
                    this.hdts = duTruDetail.HopDongChuahapList.slice();
                };
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.xemChiTiet = function (id, TrangThaiDuTru) {
                ...
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.xemChiTietDuTru = function (IdKhoaDuTruDuocPhamTheoKhoa, dataItem) {
                ...
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.CheckboxChange = function ($event, dangChoDuyet, tuChoiDuyet, daDuyet) {
                    if (dangChoDuyet === void 0) { dangChoDuyet = false; }
                    if (tuChoiDuyet === void 0) { tuChoiDuyet = false; }
                    if (daDuyet === void 0) { daDuyet = false; }
                    this.router.navigateByUrl('/nhap-xuat/duoc-pham/tong-hop-mua-thuoc-tai-khoa-duoc?holdQuery=true');
                ...
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.onKey = function (event) {
                    if (event.keyCode === 13) {
                        this.Timkiem();
                    }
                };
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.Timkiem = function () {
                    var QueryString = null;
                    this.gridChild._additionalSearchString = null;
                    if (this.searchString !== "") {
                        QueryString = this.tongHopDuTruTuaTaiKhoaDuocSearch.SearchString;
                ...
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.clearSearch = function () {
                    if (this.searchString == "") {
                        this.gridChild.searchString = "";
                        this.Timkiem();
                    }
                };
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.changeNgayNhapRange = function () {
                    this.Timkiem();
                };
                TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.prototype.changeNgayDuyetRange = function (range) {
                    this.Timkiem();
                };
                return TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent;
            }());
            TongHopDuTruMuaTaiKhoaDuocDaXuLyComponent.ctorParameters = function () { return [
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatDialog"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaTaiKhoaDuocListComponent = /** @class */ (function () {
                function TongHopDuTruMuaTaiKhoaDuocListComponent(dialog, router, apiService, authService, notificationService, cd, route, location) {
                    this.dialog = dialog;
                    this.router = router;
                    this.apiService = apiService;
                    this.authService = authService;
                ...
                TongHopDuTruMuaTaiKhoaDuocListComponent.prototype.ngOnInit = function () {
                    if (this.route.snapshot.queryParams.holdQuery != null) {
                        this.holdQuery = this.route.snapshot.queryParams.holdQuery;
                    }
                    if (this.holdQuery != null &&
                ...
                TongHopDuTruMuaTaiKhoaDuocListComponent.prototype.chuyenDen = function (element, event) {
                    if (event.index == 0) {
                        this.lstStatusSelectTabTHDTKhoa.selectedTabChoXuLy = true;
                        this.lstStatusSelectTabTHDTKhoa.selectedTabDaXuLy = false;
                        this.lstStatusSelectTabTHDTKhoa.selectedTabTuChoi = false;
                ...
                return TongHopDuTruMuaTaiKhoaDuocListComponent;
            }());
            TongHopDuTruMuaTaiKhoaDuocListComponent.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaTaiKhoaDuocRoutingModule = /** @class */ (function () {
                function TongHopDuTruMuaTaiKhoaDuocRoutingModule() {
                }
                return TongHopDuTruMuaTaiKhoaDuocRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/core/services/notification.service */ "./src/app/core/services/notification.service.ts");
            /* harmony import */ var _tong_hop_du_tru_mua_tai_khoa_duoc_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../tong-hop-du-tru-mua-tai-khoa-duoc.model */ "./src/app/modules/main/nhap-xuat/duoc-pham/tong-hop-du-tru-mua-tai-khoa-duoc/tong-hop-du-tru-mua-tai-khoa-duoc.model.ts");
            var TongHopDuTruMuaTaiKhoaDuocSharedComponent = /** @class */ (function () {
                function TongHopDuTruMuaTaiKhoaDuocSharedComponent(authService, dialog, notificationService, apiService, router, route) {
                    this.authService = authService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                ...
                TongHopDuTruMuaTaiKhoaDuocSharedComponent.prototype.ngOnInit = function () {
                    this.thongTinDuTruMuaDuocPhamTaiKhoaDuoc = new _tong_hop_du_tru_mua_tai_khoa_duoc_model__WEBPACK_IMPORTED_MODULE_7__["TongHopDuTruMuaTaiKhoaDuoc"]();
                    var id = this.route.snapshot.params.id;
                ...
                TongHopDuTruMuaTaiKhoaDuocSharedComponent.prototype.getTrangThaiDuyet = function (id) {
                    var _this = this;
                    this.apiService.post('YeuCauLinhDuocPham/GetTrangThaiDuyet?IdYeuCauLinh=' + id).subscribe(function (resultData) {
                        ...
                        if (_this.trangThaiDuyet == true) {
                            _this.trangThaiYeuCau.emit(new _tong_hop_du_tru_mua_tai_khoa_duoc_model__WEBPACK_IMPORTED_MODULE_7__["TrangThaiDuyet"]("Đã duyệt", resultData));
                        }
                        else if (_this.trangThaiDuyet == false) {
                            _this.trangThaiYeuCau.emit(new _tong_hop_du_tru_mua_tai_khoa_duoc_model__WEBPACK_IMPORTED_MODULE_7__["TrangThaiDuyet"]("Từ chối duyệt", resultData));
                        }
                        else {
                            _this.trangThaiYeuCau.emit(new _tong_hop_du_tru_mua_tai_khoa_duoc_model__WEBPACK_IMPORTED_MODULE_7__["TrangThaiDuyet"]("Đang chờ duyệt", resultData));
                        }
                    }, function (err) {
                ...
                TongHopDuTruMuaTaiKhoaDuocSharedComponent.prototype.getById = function (id) {
                ...
                return TongHopDuTruMuaTaiKhoaDuocSharedComponent;
            }());
            TongHopDuTruMuaTaiKhoaDuocSharedComponent.ctorParameters = function () { return [
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! src/app/core/utilities/local-storage.helper */ "./src/app/core/utilities/local-storage.helper.ts");
            /* harmony import */ var _tong_hop_du_tru_mua_tai_khoa_duoc_model__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../tong-hop-du-tru-mua-tai-khoa-duoc.model */ "./src/app/modules/main/nhap-xuat/duoc-pham/tong-hop-du-tru-mua-tai-khoa-duoc/tong-hop-du-tru-mua-tai-khoa-duoc.model.ts");
            var TongHopDuTruMuaTaiKhoaDuocTuChoiComponent = /** @class */ (function () {
                function TongHopDuTruMuaTaiKhoaDuocTuChoiComponent(authService, dialog, notificationService, apiService, router, route) {
                    this.authService = authService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                ...
                TongHopDuTruMuaTaiKhoaDuocTuChoiComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_4__["DocumentType"].DanhSachTongHopDuTruMuaDuocPhamTaiKhoaDuoc;
                ...
                TongHopDuTruMuaTaiKhoaDuocTuChoiComponent.prototype.TooltipCustom = function (duTruDetail) {
                    this.khos = duTruDetail.TongTonList.slice();
                    this.hdts = duTruDetail.HopDongChuahapList.slice();
                };
                TongHopDuTruMuaTaiKhoaDuocTuChoiComponent.prototype.xemChiTiet = function (IdKhoaDuTruDuocPham, dataItem) {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
                ...
                TongHopDuTruMuaTaiKhoaDuocTuChoiComponent.prototype.onKey = function (event) {
                    if (event.keyCode === 13) {
                ...
                TongHopDuTruMuaTaiKhoaDuocTuChoiComponent.prototype.Timkiem = function () {
                    var QueryString = null;
                    this.gridChild._additionalSearchString = null;
                    if (this.searchString !== "") {
                        QueryString = this.tongHopDuTruTuaTaiKhoaDuocSearch.SearchString;
                ...
                TongHopDuTruMuaTaiKhoaDuocTuChoiComponent.prototype.clearSearch = function () {
                    if (this.searchString == "") {
                        this.gridChild.searchString = "";
                        // this.gridChild.search();
                        this.Timkiem();
                ...
                TongHopDuTruMuaTaiKhoaDuocTuChoiComponent.prototype.changeNgayNhapRange = function () {
                    this.Timkiem();
                };
                TongHopDuTruMuaTaiKhoaDuocTuChoiComponent.prototype.changeNgayDuyetRange = function (range) {
                    this.Timkiem();
                };
                return TongHopDuTruMuaTaiKhoaDuocTuChoiComponent;
            }());
            TongHopDuTruMuaTaiKhoaDuocTuChoiComponent.ctorParameters = function () { return [
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatDialog"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_7__["NotificationService"] },
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_vex_animations_stagger_animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/@vex/animations/stagger.animation */ "./src/@vex/animations/stagger.animation.ts");
            /* harmony import */ var src_vex_animations_fade_in_up_animation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/@vex/animations/fade-in-up.animation */ "./src/@vex/animations/fade-in-up.animation.ts");
            var TongHopDuTruMuaTaiKhoaDuocUpdateComponent = /** @class */ (function () {
                function TongHopDuTruMuaTaiKhoaDuocUpdateComponent() {
                    this.isShow = false;
                }
                TongHopDuTruMuaTaiKhoaDuocUpdateComponent.prototype.ngOnInit = function () {
                };
                TongHopDuTruMuaTaiKhoaDuocUpdateComponent.prototype.getTrangThaiYeuCau = function (event) {
                    if (event != undefined && event != null) {
                        this.trangThai = event;
                        if (this.trangThai.DuocDuyet == true) {
                            this.isShow = false;
                ...
                return TongHopDuTruMuaTaiKhoaDuocUpdateComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaTaiKhoaDuoc = /** @class */ (function () {
                function TongHopDuTruMuaTaiKhoaDuoc(Id, SoPhieu, Khoa, KhoaId, TenKhoa, KhoId, TenKho, NguoiYeuCauId, TenNguoiYeuCau, NgayYeuCau, TrangThai, TrangThaiHienThi, NgayKhoaDuocDuyet, NgayGiamDocDuyet, KyDuTru, KyDuTruId, LoaiDuTru, LoaiDuTruId, GhiChu, LyDoTruongKhoaTuChoi, LoaiDuyet, ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList, ListDuTruMuaDuocPhamKhoDuocChiTiet) {
                    ...
                    if (ListDuTruMuaDuocPhamKhoDuocChiTiet === void 0) { ListDuTruMuaDuocPhamKhoDuocChiTiet = []; }
                    this.Id = Id;
            ...
            var DuTruMuaDuocPhamKhoDuocChiTietList = /** @class */ (function () {
                function DuTruMuaDuocPhamKhoDuocChiTietList(Id, DuTruMuaDuocPhamId, DuTruMuaDuocPhamTheoKhoaId, DuocPhamId, LaDuocPhamBHYT, SoLuongDuTru, SoLuongDuKienSuDung, NhomDieuTriDuPhong, SoLuongDuTruTruongKhoaDuyet, SoLuongDuTruKhoDuocDuyet, DuTruMuaDuocPhamTheoKhoaChiTietId, DuTruMuaDuocPhamKhoDuocChiTietId) {
                    if (Id === void 0) { Id = 0; }
                    if (DuTruMuaDuocPhamId === void 0) { DuTruMuaDuocPhamId = 0; }
                    ...
                    if (DuTruMuaDuocPhamTheoKhoaChiTietId === void 0) { DuTruMuaDuocPhamTheoKhoaChiTietId = null; }
                    if (DuTruMuaDuocPhamKhoDuocChiTietId === void 0) { DuTruMuaDuocPhamKhoDuocChiTietId = null; }
                    this.Id = Id;
                ...
                return DuTruMuaDuocPhamKhoDuocChiTietList;
            }());
            var ThongTinChiTietTongHopDuTruTuaTaiKhoaDuoc = /** @class */ (function () {
                function ThongTinChiTietTongHopDuTruTuaTaiKhoaDuoc(Id, STT, Loai, TenLoai, DuocPhamId, TenDuocPham, HoatChat, NongDoVaHamLuong, SĐK, DuTruMuaDuocPhamTheoKhoaId, DVT, DD, NhaSX, NuocSX, NhomDieuTriDuPhong, SLDuTru, SLDuKienSuDungTrongKho, KhoDuTruTon, HDChuaNhan, SLDuTruTKhoDuyet, SLDuTruKhoDuocDuyet, KhoTongTon, thongTinChiTietTongHopDuTruTuaTaiKhoaDuocListChild) {
                    if (Id === void 0) { Id = 0; }
                    if (STT === void 0) { STT = 0; }
            ...
            var ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocChild = /** @class */ (function () {
                function ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocChild(STT, Nhom, Kho, TuNgay, DenNgay, SLDuTru, SLDuKienTrongKy, DuTruMuaDuocPhamTheoKhoaId, DuTruMuaDuocPhamTheoKhoaChiTietId, DuTruMuaDuocPhamId, DuTruMuaDuocPhamChiTietId, KyDuTru) {
                    if (STT === void 0) { STT = 0; }
                    ...
                    if (DuTruMuaDuocPhamChiTietId === void 0) { DuTruMuaDuocPhamChiTietId = null; }
                    if (KyDuTru === void 0) { KyDuTru = null; }
                    this.STT = STT;
                    this.Nhom = Nhom;
                    this.Kho = Kho;
            ...
            var DuTruMuaDuocPhamKhoDuoc = /** @class */ (function () {
                function DuTruMuaDuocPhamKhoDuoc(Id, LyDoTruongKhoaTuChoi, LoaiDuyet, ListDuTruMuaDuocPhamKhoDuocChiTiet) {
                ...
                return DuTruMuaDuocPhamKhoDuoc;
            }());
            var DuTruMuaDuocPhamKhoDuocChiTiet = /** @class */ (function () {
                function DuTruMuaDuocPhamKhoDuocChiTiet(DuTruMuaDuocPhamId, DuTruMuaDuocPhamTheoKhoaId, DuocPhamId, LaDuocPhamBHYT, SoLuongDuTru, SoLuongDuKienSuDung, SoLuongDuTruTruongKhoaDuyet, SoLuongDuTruKhoDuocDuyet, NhomDieuTriDuPhong, DuTruMuaDuocPhamTheoKhoaChiTietId, DuTruMuaDuocPhamKhoDuocChiTietId) {
                    if (DuTruMuaDuocPhamId === void 0) { DuTruMuaDuocPhamId = null; }
                    if (DuTruMuaDuocPhamTheoKhoaId === void 0) { DuTruMuaDuocPhamTheoKhoaId = null; }
                    if (DuocPhamId === void 0) { DuocPhamId = null; }
                    if (LaDuocPhamBHYT === void 0) { LaDuocPhamBHYT = null; }
                ...
                return DuTruMuaDuocPhamKhoDuocChiTiet;
            }());
            // goi
            var DuTruMuaTaiKhoaDuocGoi = /** @class */ (function () {
                function DuTruMuaTaiKhoaDuocGoi(Id, KyDuTru, KyDuTruId, TenNguoiYeuCau, NguoiYeuCauId, TrangThai, TrangThaiHienThi, GhiChu, TuNgay, DenNgay, NgayYeuCau, LyDoTuChoi, ListDuTruDuocPhamId, ListDuTruDuocPhamTheoKhoaId, thongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList) {
                    if (Id === void 0) { Id = 0; }
                    if (KyDuTru === void 0) { KyDuTru = null; }
                    if (KyDuTruId === void 0) { KyDuTruId = null; }
                    if (TenNguoiYeuCau === void 0) { TenNguoiYeuCau = null; }
                    ...
                    if (ListDuTruDuocPhamId === void 0) { ListDuTruDuocPhamId = []; }
                    if (ListDuTruDuocPhamTheoKhoaId === void 0) { ListDuTruDuocPhamTheoKhoaId = []; }
            ...
            var ThongTinChiTietTongHopDuTruMuaTaiKhoaDuoc = /** @class */ (function () {
                function ThongTinChiTietTongHopDuTruMuaTaiKhoaDuoc(Id, STT, Loai, TenLoai, DuocPhamId, TenDuocPham, HoatChat, NongDoVaHamLuong, SĐK, DuTruMuaDuocPhamTheoKhoaId, DVT, DD, NhaSX, NuocSX, NhomDieuTriDuPhong, SLDuTru, SLDuKienSuDungTrongKho, KhoDuTruTon, HDChuaNhan, SLDuTruTKhoDuyet, SLDuTruKhoDuocDuyet, KhoTongTon, ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocChildList) {
                    if (Id === void 0) { Id = 0; }
                    if (STT === void 0) { STT = 0; }
                    if (Loai === void 0) { Loai = null; }
                    if (TenLoai === void 0) { TenLoai = null; }
            ...
            var PhieuInDuTruMuaTaiKhoaDuoc = /** @class */ (function () {
                function PhieuInDuTruMuaTaiKhoaDuoc(DuTruMuaDuocPhamTheoKhoaId, HostingName, Header) {
                    if (DuTruMuaDuocPhamTheoKhoaId === void 0) { DuTruMuaDuocPhamTheoKhoaId = 0; }
            ...
            var DuTruMuaDuocPhamTaiKhoaDuoc = /** @class */ (function () {
                function DuTruMuaDuocPhamTaiKhoaDuoc(Id, SoPhieu, NhanVienYeuCauId, NgayYeuCau, TuNgay, DenNgay, GhiChu, GiamDocDuyet, GiamDocId, NgayGiamDocDuyet, LyDoGiamDocTuChoi, KyDuTruMuaDuocPhamVatTuId, ListDuTruDuocPhamId, ListDuTruDuocPhamTheoKhoaId, ListDuTruDuocPhamChiTietId, ListDuTruDuocPhamTheoKhoaChiTietId, DuTruMuaDuocPhamKhoDuocChiTiet) {
                    if (Id === void 0) { Id = 0; }
                    if (SoPhieu === void 0) { SoPhieu = null; }
                    ...
                    if (KyDuTruMuaDuocPhamVatTuId === void 0) { KyDuTruMuaDuocPhamVatTuId = 0; }
                    if (ListDuTruDuocPhamId === void 0) { ListDuTruDuocPhamId = []; }
                    if (ListDuTruDuocPhamTheoKhoaId === void 0) { ListDuTruDuocPhamTheoKhoaId = []; }
                    if (ListDuTruDuocPhamChiTietId === void 0) { ListDuTruDuocPhamChiTietId = []; }
                    if (ListDuTruDuocPhamTheoKhoaChiTietId === void 0) { ListDuTruDuocPhamTheoKhoaChiTietId = []; }
                    if (DuTruMuaDuocPhamKhoDuocChiTiet === void 0) { DuTruMuaDuocPhamKhoDuocChiTiet = []; }
                    this.Id = Id;
                    this.SoPhieu = SoPhieu;
                ...
                return DuTruMuaDuocPhamTaiKhoaDuoc;
            }());
            // view 
            ...
            var DuTruViewDetail = /** @class */ (function () {
                function DuTruViewDetail(Loai, IsBhyt, DuocPhamId, DuocPham, HoatChat, Id, NongDo, Sdk, Dvt, DuongDung, NhaSx, NuocSx, SoLuongDuTru, SoLuongDuKienTrongKy, SoLuongDuTruTrKhoa, SoLuongDuTruKhDuoc, SoLuongDuTruDirector, KhoDuTruTon, KhoTongTon, HdChuaNhap, TongTonList, HdChuaNhapList) {
                    if (Loai === void 0) { Loai = null; }
            ...
            var DuTruMuaDuocPhamKhoDuocChiTiets = /** @class */ (function () {
                function DuTruMuaDuocPhamKhoDuocChiTiets(Id, DuocPhamId, DuTruMuaDuocPhamKhoDuocId, LaDuocPhamBHYT, SoLuongDuTru, SoLuongDuKienSuDung, SoLuongDuTruTruongKhoaDuyet, SoLuongDuTruKhoDuocDuyet, SoLuongDuTruGiamDocDuyet) {
                    if (Id === void 0) { Id = 0; }
                    if (DuocPhamId === void 0) { DuocPhamId = 0; }
                    if (DuTruMuaDuocPhamKhoDuocId === void 0) { DuTruMuaDuocPhamKhoDuocId = 0; }
                    if (LaDuocPhamBHYT === void 0) { LaDuocPhamBHYT = null; }
                ...
                return DuTruMuaDuocPhamKhoDuocChiTiets;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaTaiKhoaDuocModule = /** @class */ (function () {
                function TongHopDuTruMuaTaiKhoaDuocModule() {
                }
                return TongHopDuTruMuaTaiKhoaDuocModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TongHopDuTruMuaTaiKhoaDuocService = /** @class */ (function (_super) {
                __extends(TongHopDuTruMuaTaiKhoaDuocService, _super);
                function TongHopDuTruMuaTaiKhoaDuocService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'YeuCauMuaDuocPham';
                    return _this;
                }
                return TongHopDuTruMuaTaiKhoaDuocService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            TongHopDuTruMuaTaiKhoaDuocService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TuChoiDuyetPopupComponent = /** @class */ (function () {
                function TuChoiDuyetPopupComponent(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                ...
                TuChoiDuyetPopupComponent.prototype.ngOnInit = function () {
                    this.Title = this.data.Title;
                    this.Message = this.data.Message;
                };
                TuChoiDuyetPopupComponent.prototype.close = function (data) {
                    if (data == 'ok') {
                ...
                return TuChoiDuyetPopupComponent;
            }());
            TuChoiDuyetPopupComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=nhap-xuat-duoc-pham-tong-hop-du-tru-mua-tai-khoa-duoc-tong-hop-du-tru-mua-tai-khoa-duoc-module-es5.js.map
//# sourceMappingURL=nhap-xuat-duoc-pham-tong-hop-du-tru-mua-tai-khoa-duoc-tong-hop-du-tru-mua-tai-khoa-duoc-module-es5.js.map