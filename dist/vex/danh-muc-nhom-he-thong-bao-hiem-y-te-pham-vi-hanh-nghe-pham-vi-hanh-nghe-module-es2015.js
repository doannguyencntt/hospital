...
let PhamViHanhNgheCreateComponent = class PhamViHanhNgheCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
PhamViHanhNgheCreateComponent.ctorParameters = () => [
...
let PhamViHanhNgheListComponent = class PhamViHanhNgheListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('PhamViHanhNghe/ExportPhamViHanhNghe', self.gridChild._gridQueryInfo).subscribe(resultData => {
...
PhamViHanhNgheListComponent.ctorParameters = () => [
...
let PhamViHanhNgheRoutingModule = class PhamViHanhNgheRoutingModule {
};
...
let PhamViHanhNgheSharedComponent = class PhamViHanhNgheSharedComponent {
...
PhamViHanhNgheSharedComponent.ctorParameters = () => [
...
let PhamViHanhNgheUpdateComponent = class PhamViHanhNgheUpdateComponent {
...
PhamViHanhNgheUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let PhamViHanhNgheModule = class PhamViHanhNgheModule {
};
...
let PhamViHanhNgheService = class PhamViHanhNgheService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'PhamViHanhNghe';
    }
};
PhamViHanhNgheService.ctorParameters = () => [
