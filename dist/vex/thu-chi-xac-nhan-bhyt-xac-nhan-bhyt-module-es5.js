...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["thu-chi-xac-nhan-bhyt-xac-nhan-bhyt-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BhytThongTinXacNhanComponent = /** @class */ (function () {
                function BhytThongTinXacNhanComponent(route, apiService, baseService, notificationService, dialog, authService, cdRef) {
                    this.route = route;
                    ...
                    switch (field) {
                        case 'ThanhTienBenhVien': {
                            if (this.dataHuongBh.data.length !== 0) {
                                return this.dataHuongBh.data.reduce(function (sum, item) { return sum + item.ThanhTienBenhVien; }, 0);
                            }
                        }
                    }
                };
                BhytThongTinXacNhanComponent.prototype.totalThanhTienKDHBHYT = function (field, typeGrid) {
                    switch (field) {
                        case 'ThanhTienBenhVien': {
                ...
                BhytThongTinXacNhanComponent.prototype.totalTTBHYTChiTraDHBHYT = function (field, typeGrid) {
                    switch (field) {
                        case 'TTBHYTChiTra': {
                            if (this.dataHuongBh.data.length !== 0) {
                ...
                BhytThongTinXacNhanComponent.prototype.totalTTBHYTChiTraKDHBHYT = function (field, typeGrid) {
                    switch (field) {
                        case 'TTBHYTChiTra': {
                            if (this.dataChuaHuongBh.data.length !== 0) {
                ...
                BhytThongTinXacNhanComponent.prototype.totalBNConPhaiThanhToanKHBHYT = function (field, typeGrid) {
                    switch (field) {
                        case 'BNThanhToan': {
                            if (this.dataChuaHuongBh.data.length !== 0) {
                ...
                BhytThongTinXacNhanComponent.prototype.extCheckboxSelectionDuocHuongBHYT = function (dataDaChon) {
                    if (dataDaChon.length > 0) {
                        var _loop_1 = function (index) {
                            this_1.dataHuongBh.data.forEach(function (dataItem) {
                                {
                ...
                BhytThongTinXacNhanComponent.prototype.GetDataForBhytDuocHuong = function () {
                    var _this = this;
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].View)) {
                        self.baseService.getDataForGrid(self.gridQueryInfo, self.urlGetDataGridDaHuong)
                            ...
                            self.dataHuongBh.data.filter(function (x) { return x.IsDaXacNhan; }).forEach(function (daXacNhanItem) {
                            ...
                            setTimeout(function () {
                                self.dataHuongBh.data.forEach(function (element) {
                ...
                BhytThongTinXacNhanComponent.prototype.GetDataForBhytChuaDuocHuong = function () {
                    var self = this;
                    // tslint:disable-next-line: triple-equals
                    var searchText = self.searchString != undefined ? self.searchString : '';
                    searchText = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_9__["CommonService"].convertSpecialXML(searchText);
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_17__["SecurityOperation"].View)) {
                        self.baseService.getDataForGrid(self.gridQueryInfo, self.urlGetDataGridChuaHuong)
                            ...
                            self.dataChuaHuongBh.data.filter(function (x) { return x.IsDaXacNhan; }).forEach(function (daXacNhanItem) {
                                daXacNhanItem.HighLightClass = 'bg-row-lightblue';
                            });
                            if (self.IsRequestChuaHuongBhyt && self.IsRequestHuongBhyt) {
                                self.SetWarning();
                            ...
                            setTimeout(function () {
                                self.dataChuaHuongBh.data.forEach(function (element) {
                                    if (!element.CanModify) {
                                        $('#' + 'bhytDuocHuongselectCheckboxId' + element.Id).attr('disabled', true);
                ...
                BhytThongTinXacNhanComponent.prototype.MoveCuringServicesFromHuongInsuranceToNotHuongInsurance = function () {
                    if (this.dataHuongBh.data.filter(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKhamBenh; }).length > 5) {
                        var insert = function (arr, index, newItem) { return arr.slice(0, index).concat([
                            newItem
                        ], arr.slice(index)); };
                        var dataHuongMovingList = this.dataHuongBh.data
                            .filter(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKhamBenh; })
                            .splice(5, this.dataHuongBh.data.filter(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKhamBenh; }).length);
                        var _loop_3 = function (dataHuongMove) {
                            dataHuongMove.HighLightClass = '';
                            dataHuongMove.HuongBhyt = false;
                            var pushedPosition = this_3.dataChuaHuongBh.data.some(function (x) { return x; }) ? this_3.dataChuaHuongBh.data.indexOf(this_3.dataChuaHuongBh.data.filter(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKhamBenh && x.Id > dataHuongMove.Id; })[0]) : 0;
                ...
                BhytThongTinXacNhanComponent.prototype.ResetBhytChuaHuong = function () {
                    var self = this;
                    self.dataChuaHuongBh.data.forEach(function (bhyt) {
                ...
                BhytThongTinXacNhanComponent.prototype.SetBenefitRaioForWholeBenefitInsurance = function (wholeRatio, isGiaSu, ignoreMucHuongSystem) {
                    ...
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKhamBenh; })) {
                    ...
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKyThuat; })) {
                    ...
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].VatTuTieuHao; })) {
                    ...
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DuocPham; })) {
                    ...
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuGiuongBenh; })) {
                    ...
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DonThuocThanhToan; })) {
                ...
                BhytThongTinXacNhanComponent.prototype.SetWarning = function () {
                    ...
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKhamBenh; }) ||
                        self.dataChuaHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKhamBenh; })) {
                        self.SetupWarning(src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKhamBenh);
                    }
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKyThuat; }) ||
                        self.dataChuaHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKyThuat; })) {
                        self.SetupWarning(src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuKyThuat);
                    }
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].VatTuTieuHao; }) ||
                        self.dataChuaHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].VatTuTieuHao; })) {
                        self.SetupWarning(src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].VatTuTieuHao);
                    }
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DuocPham; }) ||
                        self.dataChuaHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DuocPham; })) {
                        self.SetupWarning(src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DuocPham);
                    }
                    if (self.dataHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuGiuongBenh; }) ||
                        self.dataChuaHuongBh.data.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_12__["NhomGoiDichVu"].DichVuGiuongBenh; })) {
                ...
                BhytThongTinXacNhanComponent.prototype.SetDataSource = function (huongBh, khongHuongBh) {
                    if (huongBh === void 0) { huongBh = true; }
                    if (khongHuongBh === void 0) { khongHuongBh = true; }
                    if (huongBh) {
                ...
                BhytThongTinXacNhanComponent.prototype.showTooltip = function (dataItem) {
                    var self = this;
                    if (dataItem != null) {
                        self.currentWarningMessage = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_9__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_15__["DuyetBhytMessage"].MessageSpecifyPhong, [self.serviceGroupIds.filter(function (x) { return x.Id === dataItem.Id; })[0].PhongBenhVienChiDinh,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChiTietXacNhanBhytComponent = /** @class */ (function () {
                        ...
                        _this.apiService
                            ...
                            if (resp) {
                                if (result.TenGuid.indexOf('.pdf') !== -1 || result.TenGuid.indexOf('.PDF') !== -1) {
                                    _this.dialog.open(src_app_shared_component_dialogs_view_image_pdf_view_image_pdf_component__WEBPACK_IMPORTED_MODULE_8__["ViewImagePdfComponent"], {
                                        disableClose: false,
                                        width: '1000px',
                                        height: '600px',
                                        data: {
                ...
                ChiTietXacNhanBhytComponent.prototype.Request = function (insuranceModelRequest) {
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                        self.apiService
                            ...
                            var msgErrorTlHuongSauRequest = self.CheckValidationForTiLeHuong(insuranceModelRequest.BenefitInsurance, resultData.ErrorType);
                ...
                ChiTietXacNhanBhytComponent.prototype.CheckValidationForTiLeHuong = function (benefitInsurances, errorType) {
                    if (errorType === void 0) { errorType = 0; }
                    var self = this;
                    var message = null;
                    var showMessage = false;
                    self.bhytGrid.SetBenefitRaioForWholeBenefitInsurance(100, true);
                    var sumOfTTBHYTChiTraCurrent = self.bhytGrid.dataHuongBh.data
                        .reduce(function (sum, item) { return sum + item.TTBHYTChiTraGiaSu; }, 0);
                    if (errorType === 0) {
                        if (sumOfTTBHYTChiTraCurrent > self.bhytGrid.mucHuong15Percent) {
                ...
                ChiTietXacNhanBhytComponent.prototype.ShowPopupBaoLoi = function (benefitInsurances, isExceedQuarter) {
                    if (isExceedQuarter === void 0) { isExceedQuarter = false; }
                    var self = this;
                    if (isExceedQuarter) {
                        if (benefitInsurances.some(function (x) { return x.GroupType !== src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_14__["NhomGoiDichVu"].DichVuKhamBenh &&
                            x.MucHuong > self.bhytGrid.bhytInfo.MucHuong; })) {
                            return true;
                        }
                        if (benefitInsurances.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_14__["NhomGoiDichVu"].DichVuKhamBenh; })) {
                            var firstCuring = benefitInsurances.filter(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_14__["NhomGoiDichVu"].DichVuKhamBenh; })[0];
                            if (firstCuring != null && firstCuring.MucHuong > self.bhytGrid.bhytInfo.MucHuong) {
                                return true;
                            }
                            var secondCuring = benefitInsurances.filter(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_14__["NhomGoiDichVu"].DichVuKhamBenh; })[1];
                            if (secondCuring != null && secondCuring.MucHuong > self.bhytGrid.bhytInfo.MucHuong) {
                                return true;
                            }
                            var thirdCuring = benefitInsurances.filter(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_14__["NhomGoiDichVu"].DichVuKhamBenh; })[2];
                            if (thirdCuring != null && thirdCuring.MucHuong > self.bhytGrid.bhytInfo.MucHuong) {
                                return true;
                            }
                            var forthCuring = benefitInsurances.filter(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_14__["NhomGoiDichVu"].DichVuKhamBenh; })[3];
                            if (forthCuring != null && forthCuring.MucHuong > self.bhytGrid.bhytInfo.MucHuong) {
                                return true;
                            }
                            var fifthCuring = benefitInsurances.filter(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_14__["NhomGoiDichVu"].DichVuKhamBenh; })[4];
                        ...
                        if (benefitInsurances != null && benefitInsurances.some(function (x) { return x.GroupType !== src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_14__["NhomGoiDichVu"].DichVuKhamBenh &&
                            x.MucHuong !== 100; })) {
                            return true;
                        }
                        if (benefitInsurances != null && benefitInsurances.some(function (x) { return x.GroupType === src_app_shared_enum_nhom_goi_dich_vu_enum__WEBPACK_IMPORTED_MODULE_14__["NhomGoiDichVu"].DichVuKhamBenh; })) {
                ...
                ChiTietXacNhanBhytComponent.prototype.phieuLinhThuocBenhNhanBHYT = function () {
                    var _this = this;
                    ...
                    this.apiService.post("XacNhanBHYT/PhieuLinhThuocBenhNhanBHYTTheoYCTN?yeuCauTiepNhanId=" + this.yeuCauTiepNhanId + "&hostingName=" + hostingName).subscribe(function (arrHtml) {
                        var arrHtmls = [{
                                Html: arrHtml,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongTinBaoHiemXaHoi = /** @class */ (function () {
                function ThongTinBaoHiemXaHoi(SoThe, NgayHieuLucStr, NgayHetHanStr, NoiDangKyKhamBenh, TuyenKham, GiayChuyenVien, GiayChuyenVienId, GiayMiemCungTriTra, GiayMienCungTriTraId, MucHuong, NoiChuyenDi) {
                    ...
                    if (NoiChuyenDi === void 0) { NoiChuyenDi = null; }
                    this.SoThe = SoThe;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XacNhanBhytModule = /** @class */ (function () {
                function XacNhanBhytModule() {
                }
                return XacNhanBhytModule;
            }());
...
//# sourceMappingURL=thu-chi-xac-nhan-bhyt-xac-nhan-bhyt-module-es5.js.map
//# sourceMappingURL=thu-chi-xac-nhan-bhyt-xac-nhan-bhyt-module-es5.js.map