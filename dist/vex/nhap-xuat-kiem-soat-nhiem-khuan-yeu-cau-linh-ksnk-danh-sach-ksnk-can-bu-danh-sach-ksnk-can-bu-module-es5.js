(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-kiem-soat-nhiem-khuan-yeu-cau-linh-ksnk-danh-sach-ksnk-can-bu-danh-sach-ksnk-can-bu-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachKSNKCanBuRoutingModule = /** @class */ (function () {
                function DanhSachKSNKCanBuRoutingModule() {
                }
                return DanhSachKSNKCanBuRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachKSNKCanBuComponent = /** @class */ (function () {
                function DanhSachKSNKCanBuComponent(dialog, router, apiService, authService, notificationService, cd) {
                    this.dialog = dialog;
                    this.router = router;
                ...
                DanhSachKSNKCanBuComponent.prototype.ngOnInit = function () {
                ...
                DanhSachKSNKCanBuComponent.prototype.search = function ($event) {
                    this.additionalSearchString = "{'KhoLinhId':" + (this.kSNKCanBuSearch.KhoLinhId != undefined ? this.kSNKCanBuSearch.KhoLinhId : null) + ",'KhoBuId':" + (this.kSNKCanBuSearch.KhoBuId != undefined ? this.kSNKCanBuSearch.KhoBuId : null) + "}";
                    this.grid._additionalSearchString = this.additionalSearchString;
                    this.grid.setDataSource();
                };
                DanhSachKSNKCanBuComponent.prototype.extOnDataBound = function (dataSource) {
                };
                DanhSachKSNKCanBuComponent.prototype.taoPhieuLinh = function (dataItem) {
                ...
                DanhSachKSNKCanBuComponent.prototype.loadingPage = function () {
                ...
                DanhSachKSNKCanBuComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                DanhSachKSNKCanBuComponent.prototype.khongBu = function (dataItem) {
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                                self.loadingPage();
                                var queryStringSearch = JSON.stringify(dataItem.YeuCauLinhVatTuInFos);
                                self.apiService.post("YeuCauLinhKSNK/KhongBuKSNK?yeuCauLinhVatTuIdstring=" + queryStringSearch).subscribe(function () {
                ...
                return DanhSachKSNKCanBuComponent;
            }());
            DanhSachKSNKCanBuComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachKSNKCanBuModule = /** @class */ (function () {
                function DanhSachKSNKCanBuModule() {
                }
                return DanhSachKSNKCanBuModule;
            }());
...
//# sourceMappingURL=nhap-xuat-kiem-soat-nhiem-khuan-yeu-cau-linh-ksnk-danh-sach-ksnk-can-bu-danh-sach-ksnk-can-bu-module-es5.js.map
//# sourceMappingURL=nhap-xuat-kiem-soat-nhiem-khuan-yeu-cau-linh-ksnk-danh-sach-ksnk-can-bu-danh-sach-ksnk-can-bu-module-es5.js.map