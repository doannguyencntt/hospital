(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dieu-tri-noi-tru-gay-benh-an-gay-benh-an-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GayBenhAnCreateComponent = /** @class */ (function () {
                function GayBenhAnCreateComponent(apiService, dialog, notificationService, authService, ref, router) {
                ...
                GayBenhAnCreateComponent.prototype.ngOnInit = function () {
                };
                GayBenhAnCreateComponent.prototype.loadingPage = function () {
                ...
                GayBenhAnCreateComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                GayBenhAnCreateComponent.prototype.Luu = function () {
                    var _this = this;
                    var self = this;
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_13__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            ...
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Add)) {
                                self.loadingPage();
                                self.apiService.post("BenhAnDienTu/TaoGayBenhAn", self.gayBenhAn).subscribe(function () {
                                    ...
                                    _this.router.navigate(['/benh-an-dien-tu/gay-benh-an']);
                                }, function (err) {
                ...
                GayBenhAnCreateComponent.prototype.cancel = function () {
                    this.router.navigate(['benh-an-dien-tu/gay-benh-an']);
                };
                return GayBenhAnCreateComponent;
            }());
            GayBenhAnCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GayBenhAnListComponent = /** @class */ (function () {
                function GayBenhAnListComponent(authService, dialog, router, notificationService, apiService) {
                    this.authService = authService;
                    this.dialog = dialog;
                    this.router = router;
                    this.notificationService = notificationService;
                ...
                GayBenhAnListComponent.prototype.ngOnInit = function () {
                    this.gridColumns = [
                ...
                GayBenhAnListComponent.prototype.sua = function (id) {
                ...
                GayBenhAnListComponent.prototype.xoa = function (id) {
                    var _this = this;
                    var self = this;
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Delete)) {
                                _this.apiService.post("BenhAnDienTu/XoaGayBenhAn?id=" + id).subscribe(function () {
                ...
                GayBenhAnListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("BenhAnDienTu/ExportGayBenhAn", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return GayBenhAnListComponent;
            }());
            GayBenhAnListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GayBenhAnRoutingModule = /** @class */ (function () {
                function GayBenhAnRoutingModule() {
                }
                return GayBenhAnRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GayBenhAnSharedComponent = /** @class */ (function () {
                function GayBenhAnSharedComponent(apiService, notificationService, authService, route) {
                    this.apiService = apiService;
                    this.notificationService = notificationService;
                    this.authService = authService;
                    this.route = route;
                ...
                GayBenhAnSharedComponent.prototype.ngOnInit = function () {
                ...
                GayBenhAnSharedComponent.prototype.getById = function (id) {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].View)) {
                        self.apiService.get("BenhAnDienTu/GetGayBenhAn?id=" + id).subscribe(function (resultData) {
                ...
                GayBenhAnSharedComponent.prototype.getSharedData = function () {
                    return this.gayBenhAn;
                };
                return GayBenhAnSharedComponent;
            }());
            GayBenhAnSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GayBenhAnUpdateComponent = /** @class */ (function () {
                function GayBenhAnUpdateComponent(apiService, dialog, notificationService, authService, ref, router) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                GayBenhAnUpdateComponent.prototype.ngOnInit = function () {
                };
                GayBenhAnUpdateComponent.prototype.loadingPage = function () {
                ...
                GayBenhAnUpdateComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                GayBenhAnUpdateComponent.prototype.Luu = function () {
                    var _this = this;
                    var self = this;
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            ...
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
                                self.loadingPage();
                                self.apiService.post("BenhAnDienTu/CapNhatGayBenhAn", self.gayBenhAn).subscribe(function () {
                ...
                GayBenhAnUpdateComponent.prototype.cancel = function () {
                    this.router.navigate(['/benh-an-dien-tu/gay-benh-an']);
                };
                return GayBenhAnUpdateComponent;
            }());
            GayBenhAnUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var GayBenhAn = /** @class */ (function () {
                function GayBenhAn(Id, Ten, Ma, ViTriGay, IsDisabled, GayBenhAnPhieuHoSoIds) {
                    if (Id === void 0) { Id = 0; }
                    if (Ten === void 0) { Ten = null; }
                    if (Ma === void 0) { Ma = null; }
                    if (ViTriGay === void 0) { ViTriGay = null; }
                    if (IsDisabled === void 0) { IsDisabled = false; }
                    if (GayBenhAnPhieuHoSoIds === void 0) { GayBenhAnPhieuHoSoIds = []; }
                    this.Id = Id;
                    this.Ten = Ten;
                    this.Ma = Ma;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GayBenhAnModule = /** @class */ (function () {
                function GayBenhAnModule() {
                }
                return GayBenhAnModule;
            }());
...
//# sourceMappingURL=dieu-tri-noi-tru-gay-benh-an-gay-benh-an-module-es5.js.map
//# sourceMappingURL=dieu-tri-noi-tru-gay-benh-an-gay-benh-an-module-es5.js.map