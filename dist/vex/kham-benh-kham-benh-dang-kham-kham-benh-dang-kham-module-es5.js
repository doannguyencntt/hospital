(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["kham-benh-kham-benh-dang-kham-kham-benh-dang-kham-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamBenhDangKhamListComponent = /** @class */ (function () {
                function KhamBenhDangKhamListComponent(router, route, location, dialog, apiService, authService, notificationService) {
                    this.router = router;
                    this.route = route;
                ...
                KhamBenhDangKhamListComponent.prototype.ngOnInit = function () {
                ...
                KhamBenhDangKhamListComponent.prototype.searchChanges = function (event) {
                ...
                KhamBenhDangKhamListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        //this.gridChild.search();
                        this.timKiemNangCao();
                    }
                };
                KhamBenhDangKhamListComponent.prototype.clearSearch = function () {
                    this.timKiemNangCaoObj.SearchString = null;
                    this.gridChild.searchString = null;
                    // this.gridChild.search();
                    this.timKiemNangCao();
                };
                KhamBenhDangKhamListComponent.prototype.timKiemNangCao = function () {
                ...
                KhamBenhDangKhamListComponent.prototype.xemDanhSachBenhNhan = function (phongBenhVienId, tenPhongBenhVien) {
                ...
                KhamBenhDangKhamListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Process)) {
                        var queryGridInfo = this.gridChild._gridQueryInfo;
                        this.apiService.postExportExcel("KhamBenh/ExportKhamBenhDangKham", queryGridInfo).subscribe(function (res) {
                ...
                return KhamBenhDangKhamListComponent;
            }());
            KhamBenhDangKhamListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamBenhDangKhamRoutingModule = /** @class */ (function () {
                function KhamBenhDangKhamRoutingModule() {
                }
                return KhamBenhDangKhamRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamBenhDangKhamTheoPhongKhamChiTietComponent = /** @class */ (function () {
                function KhamBenhDangKhamTheoPhongKhamChiTietComponent(dialog, apiService, authService, notificationService, ref, route, router) {
                    this.dialog = dialog;
                    this.apiService = apiService;
                    this.authService = authService;
                    this.notificationService = notificationService;
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.ngOnInit = function () {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.showPopupLoadingData = function () {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.processDynamicComponent = function () {
                    ...
                    if (this.benhNhanHienTai.YeuCauKhamBenh.ThongTinKhamTheoDichVuTemplateObj !==
                        null) {
                        this.benhNhanHienTai.YeuCauKhamBenh.ThongTinKhamTheoDichVuTemplateObj.ComponentDynamics.forEach(function (item) {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.bindDataDynamicComponent = function () {
                    var strData = this.benhNhanHienTai.YeuCauKhamBenh
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.ganThongTinKhamTamThoi = function () {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.ganThongTinYeuCauKhamBenhPerevious = function () {
                    var yeuCauKhamBenhICDKhacs = [];
                    this.benhNhanHienTai.YeuCauKhamBenh.YeuCauKhamBenhICDKhacs.forEach(function (val) { return yeuCauKhamBenhICDKhacs.push(Object.assign({}, val)); });
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.cancelChangeDataKetLuan = function () {
                    ...
                    var yeuCauKhamBenhICDKhacs = [];
                    this.yeuCauKhamBenhPrevious.YeuCauKhamBenhICDKhacs.forEach(function (val) { return yeuCauKhamBenhICDKhacs.push(Object.assign({}, val)); });
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.getAge = function (date_1, date_2) {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.DaysInMonth = function (date2_UTC) {
                    var monthStart = new Date(date2_UTC.getFullYear(), date2_UTC.getMonth(), 1);
                    var monthEnd = new Date(date2_UTC.getFullYear(), date2_UTC.getMonth() + 1, 1);
                    var monthLength = (monthEnd - monthStart) / (1000 * 60 * 60 * 24);
                    return monthLength;
                };
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.unSelectedTab = function () {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.scrollTo = function (element) {
                    jQuery(".sidenav-content").animate({
                        scrollTop: jQuery("#" + element).position().top + 60,
                    });
                    this.tabActive = element;
                };
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.chuyenDen = function (element, event) {
                    var self = this;
                    setTimeout(function () {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.loadingPage = function () {
                    this.popupLoadingData = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_11__["LoadingComponent"], {
                        disableClose: true,
                        width: "200px",
                        height: "90px",
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.getBenhNhanDangKham = function (hangDoiId) {
                    var _this = this;
                    ...
                    this.apiService
                        ...
                        if (resultData !== undefined && resultData != null) {
                            ...
                            _this.ganThongTinYeuCauKhamBenhPerevious();
                            _this.unSelectedTab();
                            var phongBenhVienId = _this.authService.getPhongLamViecId();
                            var nhanVienId = _this.authService.getAccessUser().Id;
                            var yeuCauKhamBenhId = _this.benhNhanHienTai.YeuCauKhamBenhId;
                            ...
                            _this.benhNhanHienTai.YeuCauKhamBenh.IsKhamBenhDangKham = true;
                            _this.closePopupLoadingData();
                        }
                        else {
                            _this.benhNhanHienTai = new _kham_benh_model__WEBPACK_IMPORTED_MODULE_15__["BenhVienHangDoi"]();
                            _this.closePopupLoadingData();
                        }
                    }, function (err) {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.cancelChangeData = function () {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.saveChangeData = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                        ...
                        this.apiService
                            ...
                            .subscribe(function (resultData) {
                            _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_9__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                            _this.benhNhanHienTai.YeuCauKhamBenh.IsChangeKhamBenh = false;
                            _this.benhNhanHienTai.isShowPanelItemKhamBenh = false;
                            _this.benhNhanHienTai.YeuCauKhamBenh.YeuCauKhamBenhKhamBoPhanKhacs =
                                resultData.YeuCauKhamBenh.YeuCauKhamBenhKhamBoPhanKhacs;
                            _this.benhNhanHienTai.YeuCauKhamBenh.YeuCauKhamBenhChanDoanPhanBiets =
                            ...
                            if (resultData.YeuCauKhamBenh.GhiChuICDChinh != null && resultData.YeuCauKhamBenh.GhiChuICDChinh != "") {
                                _this.benhNhanHienTai.YeuCauKhamBenh.GhiChuICDChinh =
                                    resultData.YeuCauKhamBenh.GhiChuICDChinh;
                            }
                            _this.ganThongTinKhamTamThoi();
                            _this.closePopupLoadingData();
                        }, function (err) {
                            if (!_this.lstStatusSelectTabKhambenh.selectedTabKhamBenh) {
                                _this.notificationService.showError("Yêu cầu nhập đầy đủ các trường bắt buộc trong tab khám bệnh");
                            }
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.luuKetLuan = function () {
                    var self = this;
                    self.validationKetLuanErrors = [];
                    ...
                    if (this.benhNhanHienTai.YeuCauKhamBenh.CoNhapVien == true) {
                        ...
                        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                            ...
                            self.apiService.post("KhamBenh/LuuKetLuan", self.benhNhanHienTai.YeuCauKhamBenh).subscribe(function () {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.huy = function () {
                    this.cancelChangeDataKetLuan();
                };
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.xuLyChuyenDichVuKham = function () {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                        var self = this;
                        self.dialog
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.inPhieuKham = function () {
                    var self = this;
                    self.validationKetLuanErrors = [];
                    self.ref.detectChanges();
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].View)) {
                        ...
                        self.apiService.post("KhamBenh/InPhieuKhamBenh", this.phieuKhamBenhVo).subscribe(function (resultData) {
                            if (resultData != null) {
                                self.closePopupLoadingData();
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.inGiayNghiHuongBHXH = function () {
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.quayLaiDanhSach = function () {
                    this.router.navigate([this.baseRoute + "/danh-sach-dang-kham/" + this.benhNhanHienTai.PhongBenhVienId], { queryParams: { holdQuery: true } });
                };
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.hoanThanhKham = function (isNhapVien) {
                    var _this = this;
                    if (isNhapVien === void 0) { isNhapVien = false; }
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                        var self = this;
                            ...
                            self.apiService
                                ...
                                self.apiService
                                    ...
                                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmComponent"], {
                                        ...
                                        .subscribe(function (res) {
                                        if (res == "Yes") {
                                            self.phieuKhamBenhVo.YeuCauKhamBenhId = _this.benhNhanHienTai.YeuCauKhamBenhId;
                                            self.phieuKhamBenhVo.CoKhamBenh = true;
                                            self.apiService.post("KhamBenh/InPhieuKhamBenh", _this.phieuKhamBenhVo).subscribe(function (resultData) {
                                                if (resultData != null) {
                                                    self.dialog
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.keyEvent = function (event) {
                    var self = this;
                ...
                KhamBenhDangKhamTheoPhongKhamChiTietComponent.prototype.xuLyQuayLaiChuaKham = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_14__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmComponent"], {
                            ...
                            if (result == 'Yes') {
                                ...
                                _this.apiService.put("KhamBenh/XuLyQuayLaiChuaKham?hangDoiId=" + _this.benhNhanHienTai.Id)
                                    .subscribe(function () {
                                    _this.closePopupLoadingData();
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_9__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_12__["SystemMessage"].ActionSuccessfully, ["Quay lại chưa khám"]));
                                    _this.quayLaiDanhSach();
                                }, function (err) {
                                    if (err.Message != "Validation Failed") {
                                        _this.notificationService.showError(err.Message);
                                    }
                ...
                return KhamBenhDangKhamTheoPhongKhamChiTietComponent;
            }());
            KhamBenhDangKhamTheoPhongKhamChiTietComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamBenhDangKhamTheoPhongKhamComponent = /** @class */ (function () {
                function KhamBenhDangKhamTheoPhongKhamComponent(authService, notificationService, router, route, location, dialog, apiService) {
                    this.authService = authService;
                    this.notificationService = notificationService;
                    this.router = router;
                    this.route = route;
                ...
                KhamBenhDangKhamTheoPhongKhamComponent.prototype.ngOnInit = function () {
                ...
                KhamBenhDangKhamTheoPhongKhamComponent.prototype.searchChanges = function (event) {
                    if (event != undefined && (event == null || event == "")) {
                        this.gridChild.searchString = null;
                        //this.gridChild.search();
                        this.timKiemNangCao();
                ...
                KhamBenhDangKhamTheoPhongKhamComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        //this.gridChild.search();
                        this.timKiemNangCao();
                    }
                };
                KhamBenhDangKhamTheoPhongKhamComponent.prototype.clearSearch = function () {
                    this.timKiemNangCaoObj.SearchString = null;
                    this.gridChild.searchString = null;
                    //this.gridChild.search();
                    this.timKiemNangCao();
                };
                KhamBenhDangKhamTheoPhongKhamComponent.prototype.timKiemNangCao = function () {
                ...
                KhamBenhDangKhamTheoPhongKhamComponent.prototype.batDauKham = function (phongBenhVienHangDoiId) {
                ...
                KhamBenhDangKhamTheoPhongKhamComponent.prototype.quayLai = function () {
                    this.router.navigate([this.baseRoute], { queryParams: { holdQuery: true } });
                };
                KhamBenhDangKhamTheoPhongKhamComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_16__["SecurityOperation"].Process)) {
                        var queryGridInfo = this.gridChild._gridQueryInfo;
                        this.apiService.postExportExcel("KhamBenh/ExportKhamBenhDangKhamTheoPhongKham", queryGridInfo).subscribe(function (res) {
                            var dateTimeNow = new Date();
                ...
                return KhamBenhDangKhamTheoPhongKhamComponent;
            }());
            KhamBenhDangKhamTheoPhongKhamComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var KhamBenhDangKhamTimKiem = /** @class */ (function () {
                function KhamBenhDangKhamTimKiem(PhongBenhVienId, KhoaPhongId, SearchString, TrangThai, TuNgayDenNgay) {
                    ...
                    if (TrangThai === void 0) { TrangThai = new KhamBenhDangKhamTimKiemTrangThai(); }
                    if (TuNgayDenNgay === void 0) { TuNgayDenNgay = new KhamBenhDangKhamTimKiemDateRange(); }
                ...
                return KhamBenhDangKhamTimKiem;
            }());
            var KhamBenhDangKhamTimKiemTrangThai = /** @class */ (function () {
                function KhamBenhDangKhamTimKiemTrangThai(ChuaKham, DangKham, DangLamChiDinh, DangDoiKetLuan, DaKham) {
                    if (ChuaKham === void 0) { ChuaKham = true; }
                    if (DangKham === void 0) { DangKham = true; }
                    if (DangLamChiDinh === void 0) { DangLamChiDinh = true; }
                    if (DangDoiKetLuan === void 0) { DangDoiKetLuan = true; }
                ...
                return KhamBenhDangKhamTimKiemTrangThai;
            }());
            var KhamBenhDangKhamTimKiemDateRange = /** @class */ (function () {
                function KhamBenhDangKhamTimKiemDateRange(startDate, endDate, TuNgay, DenNgay) {
                ...
                return KhamBenhDangKhamTimKiemDateRange;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamBenhDangKhamModule = /** @class */ (function () {
                function KhamBenhDangKhamModule() {
                }
                return KhamBenhDangKhamModule;
            }());
...
//# sourceMappingURL=kham-benh-kham-benh-dang-kham-kham-benh-dang-kham-module-es5.js.map
//# sourceMappingURL=kham-benh-kham-benh-dang-kham-kham-benh-dang-kham-module-es5.js.map