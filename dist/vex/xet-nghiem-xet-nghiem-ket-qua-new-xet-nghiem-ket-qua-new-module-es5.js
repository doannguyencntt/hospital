...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["xet-nghiem-xet-nghiem-ket-qua-new-xet-nghiem-ket-qua-new-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KetQuaPhieuNewPopupComponent = /** @class */ (function () {
                function KetQuaPhieuNewPopupComponent(data, apiService, dialog, notificationService) {
                    this.data = data;
                ...
                KetQuaPhieuNewPopupComponent.prototype.ngOnInit = function () {
                    this.getALlFilePDFFromHtml(this.data);
                };
                KetQuaPhieuNewPopupComponent.prototype.getALlFilePDFFromHtml = function (arrHtml) {
                    var _this = this;
                ...
                KetQuaPhieuNewPopupComponent.prototype.downloadAllFile = function () {
                ...
                KetQuaPhieuNewPopupComponent.prototype.showPopupLoadingData = function () {
                ...
                KetQuaPhieuNewPopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData) {
                        this.popupLoadingData.close();
                    }
                };
                return KetQuaPhieuNewPopupComponent;
            }());
            KetQuaPhieuNewPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var KetQuaXetNghiemNewDetailComponent = /** @class */ (function () {
                function KetQuaXetNghiemNewDetailComponent() {
                }
                KetQuaXetNghiemNewDetailComponent.prototype.ngOnInit = function () {
                };
                return KetQuaXetNghiemNewDetailComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KetQuaXetNghiemNewListComponent = /** @class */ (function () {
                function KetQuaXetNghiemNewListComponent(dialog, router, route, authService, notificationService, location, renderer, apiService) {
                    this.dialog = dialog;
                    this.router = router;
                    this.route = route;
                ...
                KetQuaXetNghiemNewListComponent.prototype.ngOnInit = function () {
                    this.ketQuaXetNghiemSearch = new _xet_nghiem_ket_qua_new_model__WEBPACK_IMPORTED_MODULE_2__["KetQuaXetNghiemNewSearch"]();
                ...
                KetQuaXetNghiemNewListComponent.prototype.keyEvent = function (event) {
                ...
                KetQuaXetNghiemNewListComponent.prototype.barcodeClick = function (dataItem) {
                ...
                KetQuaXetNghiemNewListComponent.prototype.CheckboxChange = function (event, text) {
                    if (text === 'choKetQua') {
                ...
                KetQuaXetNghiemNewListComponent.prototype.clearSearch = function () {
                    if (this.ketQuaXetNghiemSearch.SearchString == "" || this.ketQuaXetNghiemSearch.SearchString == null) {
                        this.Timkiem();
                    }
                };
                KetQuaXetNghiemNewListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.Timkiem();
                    }
                };
                KetQuaXetNghiemNewListComponent.prototype.backWithSearch = function () {
                ...
                KetQuaXetNghiemNewListComponent.prototype.Timkiem = function () {
                ...
                KetQuaXetNghiemNewListComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                KetQuaXetNghiemNewListComponent.prototype.QuetMaQRCodeClick = function () {
                    var elementBarcode = document.getElementById("barcodeActive");
                    if (elementBarcode != undefined) {
                        elementBarcode.click();
                    }
                };
                KetQuaXetNghiemNewListComponent.prototype.changeQR = function (evt) {
                ...
                KetQuaXetNghiemNewListComponent.prototype.setUpDataTooltip = function (dataItem) {
                ...
                KetQuaXetNghiemNewListComponent.prototype.checkHiddenIcon = function (item, danhSachLoaiMau) {
                ...
                KetQuaXetNghiemNewListComponent.prototype.isMauKhongDat = function (mau, danhSachMauKhongDat) {
                ...
                KetQuaXetNghiemNewListComponent.prototype.showPopupLoadingData = function () {
                ...
                KetQuaXetNghiemNewListComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                KetQuaXetNghiemNewListComponent.prototype.print = function (id, yeuCauTiepNhanId) {
                    var _this = this;
                    this.showPopupLoadingData();
                    ...
                    this.apiService.post("DuyetKetQuaXetNghiem/GetDataXetNghiemKetQuaIn?yeuCauTiepNhanId=" + this.inPhieuDuyetKetQua.YeuCauTiepNhanId + "&phienXetNghiemId=" + this.inPhieuDuyetKetQua.PhienXetNghiemId).subscribe(function (result) {
                        if (result != null) {
                            ...
                            dialogRef = _this.dialog.open(_duyet_ket_qua_chon_loai_ket_qua_xet_nghiem_popup_chon_loai_ket_qua_xet_nghiem_popup_component__WEBPACK_IMPORTED_MODULE_29__["ChonLoaiKetQuaXetNghiemPopupComponent"], {
                                disableClose: true,
                                width: '1000px',
                                // height: '300px',
                                ...
                                if (result != undefined && result != null && result != "") {
                                    if (result == 'No') {
                                        ...
                                        _this.apiService.post('XetNghiem/GetAllHtmlPdfDuyetKetQuaXetNghiemDuocCheckGrid', _this.inPhieuDuyetKetQua).subscribe(function (arrHtml) {
                                            _this.dialog.open(_ket_qua_phieu_new_popup_ket_qua_phieu_new_popup_component__WEBPACK_IMPORTED_MODULE_28__["KetQuaPhieuNewPopupComponent"], {
                                                disableClose: false,
                                                width: '1000px',
                                                data: arrHtml
                                            }).afterClosed().subscribe(function (result) {
                ...
                return KetQuaXetNghiemNewListComponent;
            }());
            KetQuaXetNghiemNewListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @iconify/icons-ic/twotone-close */ "./node_modules/@iconify/icons-ic/twotone-close.js");
            /* harmony import */ var _iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_close__WEBPACK_IMPORTED_MODULE_3__);
            var KetQuaXetNghiemNewPopupGoiDuyetComponent = /** @class */ (function () {
                function KetQuaXetNghiemNewPopupGoiDuyetComponent(data, dialog, dialogRef) {
                    this.data = data;
                    this.dialog = dialog;
                ...
                KetQuaXetNghiemNewPopupGoiDuyetComponent.prototype.ngOnInit = function () {
                };
                KetQuaXetNghiemNewPopupGoiDuyetComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                KetQuaXetNghiemNewPopupGoiDuyetComponent.prototype.Khong = function () {
                    this.dialogRef.close();
                };
                KetQuaXetNghiemNewPopupGoiDuyetComponent.prototype.Co = function () {
                    this.dialogRef.close("Yes");
                };
                return KetQuaXetNghiemNewPopupGoiDuyetComponent;
            }());
            KetQuaXetNghiemNewPopupGoiDuyetComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KetQuaXetNghiemNewSharedComponent = /** @class */ (function () {
                function KetQuaXetNghiemNewSharedComponent(cdRef, dialog, baseService, route, notificationService, router, apiService, authService, errorService) {
                    this.cdRef = cdRef;
                    this.dialog = dialog;
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.ngOnInit = function () {
                    this.gridColumns = [
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.ngAfterContentInit = function () {
                    //Called after ngOnInit when the component's or directive's content has been initialized.
                    //Add 'implements AfterContentInit' to the class.
                };
                KetQuaXetNghiemNewSharedComponent.prototype.getDataMayXN = function () {
                    var _this = this;
                    var queryInfo = new src_app_shared_models_common_model__WEBPACK_IMPORTED_MODULE_18__["LookupQueryInfo"]();
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.loadingPage = function () {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                KetQuaXetNghiemNewSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.loadingPage();
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.searchChanges = function ($event) {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.onKeySearchChanges = function ($event) {
                    if ($event.keyCode == 13) {
                        this.setDataSourceForGrid();
                    }
                };
                KetQuaXetNghiemNewSharedComponent.prototype.setDataSourceForGrid = function () {
                    //search
                    if (this.searchString == undefined || this.searchString == null || this.searchString == "") {
                        ...
                        var search_1 = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].removeVietnamese(this.searchString).toLowerCase().trim().replace(/đ/g, 'd');
                        this.dataChildDisplay = this.ketQuaXetNghiem.dataChild.slice().filter(function (o) { return (o.Ten != null && src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].removeVietnamese(o.Ten).toLocaleLowerCase().trim().indexOf(search_1) != -1)
                            || (o.DonVi != null && src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].removeVietnamese(o.DonVi).toLocaleLowerCase().trim().indexOf(search_1) != -1)
                            || (o.TenMayXetNghiem != null && src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].removeVietnamese(o.TenMayXetNghiem).toLocaleLowerCase().trim().indexOf(search_1) != -1)
                            || (o.NguoiDuyet != null && src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].removeVietnamese(o.NguoiDuyet).toLocaleLowerCase().trim().indexOf(search_1) != -1)
                            || (o.NgayDuyetDisplay != null && src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].removeVietnamese(o.NgayDuyetDisplay).toLocaleLowerCase().trim().indexOf(search_1) != -1); });
                    }
                    this.ketQuaXetNghiem.dataChild.forEach(function (dataItem) {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.getSharedDataGoiDuyet = function () {
                    var lstDataCheckBoxCurrent = this.gridChiTietKetQuaXn.getAllDataFromDatasource();
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.setUpDataTooltip = function (dataItem) {
                    this.displayToolTipGridNguoiYeuCau = dataItem.items[0].NguoiYeuCau;
                    this.displayToolTipGridNgayYeuCau = dataItem.items[0].NgayYeuCauDisplay;
                    this.displayToolTipGridLyDoYeuCau = dataItem.items[0].LyDoYeuCau;
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.checkHiddenIcon = function (item, danhSachLoaiMau) {
                    // console.log("checkHiddenIcon = ", item, danhSachLoaiMau);
                    // return true;
                    for (var i = 0; i < danhSachLoaiMau.length; i++) {
                        if (item == danhSachLoaiMau[i]) {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.CheckHighlight = function (dataItem, currentValue) {
                    ...
                    var giaTriNhap = Number(currentValue);
                    if (!isNaN(giaTriNhap) || currentValue == '') {
                        if ((dataItem.GiaTriMin == null || dataItem.GiaTriMin == '') && (dataItem.GiaTriMax == null || dataItem.GiaTriMax == '') || currentValue == '') {
                            ...
                            var min = Number(dataItem.GiaTriMin);
                            if (giaTriNhap < min) {
                            ...
                            var max = Number(dataItem.GiaTriMax);
                            if (giaTriNhap > max) {
                                dataItem.ToDamGiaTri = true;
                            }
                            else {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.isMauKhongDat = function (mau, danhSachMauKhongDat) {
                    for (var i = 0; i < danhSachMauKhongDat.length; i++) {
                        if (mau == danhSachMauKhongDat[i]) {
                            return true;
                        }
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.mayXNChange = function (event, level, dichVuXetNghiemId) {
                    if (level == 1) {
                        var lstDataCurrent = this.gridChiTietKetQuaXn.getAllDataFromDatasource();
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.checkBoxChange = function (event, dataItem) {
                    var lstDataCurrent = this.gridChiTietKetQuaXn.getAllDataFromDatasource();
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.checkBoxAllChange = function (event) {
                    var lstDataCurrent = this.gridChiTietKetQuaXn.getAllDataFromDatasource();
                    this.checkAll = event;
                    lstDataCurrent.forEach(function (element) {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.checkBoxNhomChange = function (event, data) {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.TooltipCustom = function (dataItem) {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.updateDataSauKhiLuu = function (dataChilds) {
                    var lstDataCurrent = this.gridChiTietKetQuaXn.getAllDataFromDatasource();
                    lstDataCurrent.forEach(function (element) {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.luu = function () {
                    var self = this;
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_16__["SecurityOperation"].Update)) {
                        ...
                        self.baseService.update(self.ketQuaXetNghiem).subscribe(function (resData) {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.onKeydownGrid = function (obj) {
                    var self = this;
                        ...
                        setTimeout(function () {
                            ...
                            if (obj.Event.code === "Enter" || obj.Event.code === "NumpadEnter") {
                                if (obj.Event.target.id.indexOf('GiaTriNhapTay-') >= 0) {
                                    var id_1 = Number(obj.Event.target.id.replace('GiaTriNhapTay-', ''));
                                    var dataAll_1 = [];
                                    ...
                                    if (dataNext != undefined && dataNext != null) {
                                        ...
                                        $(document).ready(function () {
                                            ...
                                            $("#GiaTriNhapTay-" + idNext_1).focus().select();
                                        });
                                    }
                                }
                                //Action on Đậm KQ
                                ...
                                if (cellFocused != undefined && cellFocused.dataItem != null) {
                                    if (cellFocused.colIndex == 9) {
                                        var id_2 = cellFocused.dataItem.Id;
                                        var dataAll_2 = [];
                                        obj.Sender.data.data.forEach(function (item) {
                                            item.items.filter(function (z) { return !z.DaDuyet; }).forEach(function (e) {
                                                dataAll_2.push(e);
                                        ...
                                        var index = dataAll_2.findIndex((function (z) { return z.Id == id_2; }));
                                        var dataNext = dataAll_2[index + 1];
                                        if (dataNext != undefined && dataNext != null) {
                                            var idNext_2 = null;
                                            if (dataNext.IdChilds.length > 0 && dataNext.Level != 2 && dataNext.Level != 3) {
                                                idNext_2 = dataAll_2[index + 2].Id;
                                            }
                                            else {
                                                idNext_2 = dataAll_2[index + 1].Id;
                                            }
                                            // document.getElementById("GiaTriNhapTay-" + dataNext).focus();
                                            $(document).ready(function () {
                                                $("#MayXetNghiemId-" + idNext_2 + " input").focus();
                                            });
                                        }
                                    }
                                }
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.openCombobox = function (event) {
                    if (event) {
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.TooltipCustomNgayDuyet = function (dataItem) {
                    var _this = this;
                ...
                KetQuaXetNghiemNewSharedComponent.prototype.getSharedDataLuu = function () {
                    return this.ketQuaXetNghiem;
                };
                return KetQuaXetNghiemNewSharedComponent;
            }());
            KetQuaXetNghiemNewSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KetQuaXetNghiemNewUpdateComponent = /** @class */ (function () {
                function KetQuaXetNghiemNewUpdateComponent(router, route, baseService, apiService, authService, dialog, notificationService, errorService) {
                    this.router = router;
                    this.route = route;
                    this.baseService = baseService;
                    this.apiService = apiService;
                ...
                KetQuaXetNghiemNewUpdateComponent.prototype.ngOnInit = function () {
                };
                KetQuaXetNghiemNewUpdateComponent.prototype.xuatFileKetQua = function () {
                };
                KetQuaXetNghiemNewUpdateComponent.prototype.getTrangThaiIn = function (event) {
                    this.trangThaiIn = event;
                };
                KetQuaXetNghiemNewUpdateComponent.prototype.inKetQua = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                        ...
                        this.apiService.post("DuyetKetQuaXetNghiem/GetDataXetNghiemKetQuaIn?yeuCauTiepNhanId=" + this.yeuCauTiepNhanId + "&phienXetNghiemId=" + this.inPhieuDuyetKetQua.PhienXetNghiemId).subscribe(function (result) {
                            if (result != null) {
                                ...
                                dialogRef_1 = _this.dialog.open(_duyet_ket_qua_chon_loai_ket_qua_xet_nghiem_popup_chon_loai_ket_qua_xet_nghiem_popup_component__WEBPACK_IMPORTED_MODULE_16__["ChonLoaiKetQuaXetNghiemPopupComponent"], {
                                    disableClose: true,
                                    width: '1000px',
                                    // height: '300px',
                                    ...
                                    if (result != undefined && result != null && result != "") {
                                        if (result == 'No') {
                                            ...
                                            _this.apiService.post('XetNghiem/GetAllHtmlPdfKetQuaXetNghiem', _this.inPhieuDuyetKetQua).subscribe(function (arrHtml) {
                                                _this.dialog.open(_ket_qua_phieu_new_popup_ket_qua_phieu_new_popup_component__WEBPACK_IMPORTED_MODULE_17__["KetQuaPhieuNewPopupComponent"], {
                                                    disableClose: false,
                                                    width: '1000px',
                                                    data: arrHtml
                                                }).afterClosed().subscribe(function (result) {
                ...
                KetQuaXetNghiemNewUpdateComponent.prototype.showPopupDownloadData = function () {
                    if (this.popupLoadingData == null
                        || this.popupLoadingData.openDialogs == null
                        || (this.popupLoadingData.openDialogs != null && this.popupLoadingData.openDialogs.length === 0)) {
                ...
                KetQuaXetNghiemNewUpdateComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData) {
                        this.popupLoadingData.close();
                    }
                };
                KetQuaXetNghiemNewUpdateComponent.prototype.searchChangesNangCao = function ($event) {
                };
                KetQuaXetNghiemNewUpdateComponent.prototype.changeQR = function ($event) {
                };
                KetQuaXetNghiemNewUpdateComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.TimkiemNangCao();
                    }
                };
                KetQuaXetNghiemNewUpdateComponent.prototype.QuetMaQRCodeClick = function () {
                    var elementBarcode = document.getElementById("barcodeActive");
                    if (elementBarcode != undefined) {
                        elementBarcode.click();
                    }
                };
                KetQuaXetNghiemNewUpdateComponent.prototype.TimkiemNangCao = function () {
                    var _this = this;
                    ...
                    var data = this.shared.getSharedDataLuu();
                    this.apiService.post("DuyetKetQuaXetNghiem/TimKiemPhienXetNghiemGanNhat", this.search).subscribe(function (resultData) {
                        if (resultData != undefined && resultData != null) {
                            _this.apiService.post("KetQuaXetNghiem/TrangThaiPhienXetNghiemGanNhat?phienXetNghiemId=" + resultData).subscribe(function (type) {
                                if (type == 1) {
                                    _this.titleString = _this.ChoKQ;
                                }
                                else if (type == 2) {
                                    _this.titleString = _this.ChoKQChayLai;
                                }
                                else if (type == 3) {
                                    _this.titleString = _this.ChoDuyetKQ;
                                }
                                else if (type == 4) {
                                    _this.titleString = _this.DaCoKQ;
                                }
                                _this.router.navigate([_this.baseRoute + "/cap-nhat/" + resultData + "/" + type + "/" + data.YeuCauTiepNhanId]);
                                _this.shared.getById(resultData);
                            });
                        }
                    }, function (err) {
                        _this.validationErrors = err.ValidationErrors;
                ...
                KetQuaXetNghiemNewUpdateComponent.prototype.quayLai = function () {
                    this.router.navigateByUrl('xet-nghiem/ket-qua-new?holdQuery=true');
                };
                KetQuaXetNghiemNewUpdateComponent.prototype.luu = function () {
                ...
                return KetQuaXetNghiemNewUpdateComponent;
            }());
            KetQuaXetNghiemNewUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_7__["BaseService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XetNghiemKetQuaNEWRoutingModule = /** @class */ (function () {
                function XetNghiemKetQuaNEWRoutingModule() {
                }
                return XetNghiemKetQuaNEWRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var KetQuaXetNghiemNew = /** @class */ (function () {
                function KetQuaXetNghiemNew() {
                }
                return KetQuaXetNghiemNew;
            }());
            var KetQuaXetNghiemNewSearch = /** @class */ (function () {
                function KetQuaXetNghiemNewSearch(ChoKetQua, ChoDuyetKetQua, DaCoKetQua, SearchString, TuNgay, DenNgay, FromDate, ToDate, ThoiDiemTiepNhanTuFormat, ThoiDiemTiepNhanDenFormat) {
                ...
                return KetQuaXetNghiemNewSearch;
            }());
            var KetQuaXetNghiemViewKetQuaNewViewModel = /** @class */ (function () {
                function KetQuaXetNghiemViewKetQuaNewViewModel() {
                    this.BarCodeID = null;
                    this.MaSoBHYT = null;
                    this.MaBN = null;
                ...
                return KetQuaXetNghiemViewKetQuaNewViewModel;
            }());
            var ListDataChildNew = /** @class */ (function () {
                function ListDataChildNew() {
                    this.Ten = null;
                    this.GiaTriCu = null;
            ...
            var PhieuDuyetKetQuaNew = /** @class */ (function () {
                function PhieuDuyetKetQuaNew(HostingName, Header, PhienXetNghiemId, YeuCauTiepNhanId, LoaiIn, ListIn) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XetNghiemKetQuaNEWModule = /** @class */ (function () {
                function XetNghiemKetQuaNEWModule() {
                }
                return XetNghiemKetQuaNEWModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var XetNghiemKetQuaNewService = /** @class */ (function (_super) {
                __extends(XetNghiemKetQuaNewService, _super);
                function XetNghiemKetQuaNewService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'KetQuaXetNghiem';
                    return _this;
                }
                return XetNghiemKetQuaNewService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            XetNghiemKetQuaNewService.ctorParameters = function () { return [
...
//# sourceMappingURL=xet-nghiem-xet-nghiem-ket-qua-new-xet-nghiem-ket-qua-new-module-es5.js.map
//# sourceMappingURL=xet-nghiem-xet-nghiem-ket-qua-new-xet-nghiem-ket-qua-new-module-es5.js.map