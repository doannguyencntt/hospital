...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-bao-hiem-y-te-chuan-doan-hinh-anh-chuan-doan-hinh-anh-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChuanDoanHinhAnhCreateComponent = /** @class */ (function () {
                function ChuanDoanHinhAnhCreateComponent(router) {
                    this.router = router;
                }
                ChuanDoanHinhAnhCreateComponent.prototype.ngOnInit = function () {
                };
                ChuanDoanHinhAnhCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/bao-hiem-y-te/chuan-doan-hinh-anh']);
                };
                return ChuanDoanHinhAnhCreateComponent;
            }());
            ChuanDoanHinhAnhCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChuanDoanHinhAnhListComponent = /** @class */ (function () {
                function ChuanDoanHinhAnhListComponent(notificationService, authService, dialog, apiService) {
                ...
                ChuanDoanHinhAnhListComponent.prototype.ngOnInit = function () {
                ...
                ChuanDoanHinhAnhListComponent.prototype.exportExcel = function () {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        self.apiService.postExportExcel('ChuanDoanHinhAnh/ExportChuanDoanHinhAnh', self.gridChild._gridQueryInfo).subscribe(function (resultData) {
                ...
                ChuanDoanHinhAnhListComponent.prototype.showPopupLoadingData = function () {
                ...
                ChuanDoanHinhAnhListComponent.prototype.closePopupLoadingData = function () {
                    this.dialog.closeAll();
                };
                return ChuanDoanHinhAnhListComponent;
            }());
            ChuanDoanHinhAnhListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChuanDoanHinhAnhRoutingModule = /** @class */ (function () {
                function ChuanDoanHinhAnhRoutingModule() {
                }
                return ChuanDoanHinhAnhRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChuanDoanHinhAnhSharedComponent = /** @class */ (function () {
                function ChuanDoanHinhAnhSharedComponent(route, baseService) {
                    this.route = route;
                    this.baseService = baseService;
                    this.chuanDoanHinhAnh = {};
                }
                ChuanDoanHinhAnhSharedComponent.prototype.ngOnInit = function () {
                    var id = this.route.snapshot.params.id;
                    if (id !== undefined && id !== null) {
                        this.getById(id);
                    }
                };
                ChuanDoanHinhAnhSharedComponent.prototype.getSharedData = function () {
                    return this.chuanDoanHinhAnh;
                };
                ChuanDoanHinhAnhSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.chuanDoanHinhAnh = resultData;
                    });
                };
                return ChuanDoanHinhAnhSharedComponent;
            }());
            ChuanDoanHinhAnhSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _chuan_doan_hinh_anh_shared_chuan_doan_hinh_anh_shared_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../chuan-doan-hinh-anh-shared/chuan-doan-hinh-anh-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/bao-hiem-y-te/chuan-doan-hinh-anh/chuan-doan-hinh-anh-shared/chuan-doan-hinh-anh-shared.component.ts");
            var ChuanDoanHinhAnhUpdateComponent = /** @class */ (function () {
                function ChuanDoanHinhAnhUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                ChuanDoanHinhAnhUpdateComponent.prototype.ngOnInit = function () {
                };
                ChuanDoanHinhAnhUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/bao-hiem-y-te/chuan-doan-hinh-anh']);
                };
                return ChuanDoanHinhAnhUpdateComponent;
            }());
            ChuanDoanHinhAnhUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChuanDoanHinhAnhModule = /** @class */ (function () {
                function ChuanDoanHinhAnhModule() {
                }
                return ChuanDoanHinhAnhModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var ChuanDoanHinhAnhService = /** @class */ (function (_super) {
                __extends(ChuanDoanHinhAnhService, _super);
                function ChuanDoanHinhAnhService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'ChuanDoanHinhAnh';
                    return _this;
                }
                return ChuanDoanHinhAnhService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            ChuanDoanHinhAnhService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
...
//# sourceMappingURL=danh-muc-nhom-he-thong-bao-hiem-y-te-chuan-doan-hinh-anh-chuan-doan-hinh-anh-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-bao-hiem-y-te-chuan-doan-hinh-anh-chuan-doan-hinh-anh-module-es5.js.map