...
let LichSuCapThuocBHYTChiTietComponent = class LichSuCapThuocBHYTChiTietComponent {
    constructor(route, apiService, router, dialog, authService, notificationService) {
        this.route = route;
    ...
    ngOnInit() {
        ...
        const maBN = this.route.snapshot.params.maBN;
        if (maBN != null) {
    ...
    GetThongTinBenhNhanXuatThuoc(maBN) {
        const self = this;
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].View)) {
            self.apiService.post('QuayThuoc/GetThongTinBenhNhanTheoMaBN?MaBN=' + maBN).subscribe(resultData => {
    ...
    GetThongTinDonThuocVatTu(phieuXuatId, loaiDuocPhamVatTu) {
        const self = this;
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].View)) {
            self.apiService.post('QuayThuoc/GetDanhSachLichSuXuatThuocVatTuBHYT?phieuXuatId=' + phieuXuatId + '&loaiDuocPhamVatTu=' + loaiDuocPhamVatTu).subscribe(resultData => {
            ...
            self.apiService.post('QuayThuoc/GetDanhSachLichSuXuatThuocVatTukhongBHYT?phieuXuatId=' + phieuXuatId + '&loaiDuocPhamVatTu=' + loaiDuocPhamVatTu).subscribe(resultData => {
    ...
    InKeThuocKhongBhyt() {
        ...
        let xacNhanInThuocVatTuData = new _lich_su_cap_thuoc_bhyt_model__WEBPACK_IMPORTED_MODULE_11__["XacNhanInThuocVatTuViewModel"]();
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].View)) {
            self.apiService.postExportPdf('QuayThuoc/XacNhanInThuocVatTuKhongBhytXuatThuoc', xacNhanInThuocVatTuData).subscribe(resultData => {
    ...
    InKeThuocBhyt() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].View)) {
            self.apiService.postExportPdf('QuayThuoc/XacNhanInThuocVatTuCoBhytXuatThuoc', xacNhanInThuocVatTuData).subscribe(resultData => {
                self.dialog.open(_thong_tin_phieu_pdf_popup_thong_tin_phieu_pdf_popup_component__WEBPACK_IMPORTED_MODULE_12__["ThongTinPhieuPdfPopupComponent"], {
                    disableClose: true,
                    width: '1000px',
                    data: { Model: resultData }
...
LichSuCapThuocBHYTChiTietComponent.ctorParameters = () => [
...
let LichSuCapThuocBHYTListComponent = class LichSuCapThuocBHYTListComponent {
    constructor(router, dialog, authService, apiService, notificationService) {
        this.router = router;
        this.dialog = dialog;
        this.authService = authService;
        this.apiService = apiService;
    ...
    getDropdownItem(obj, keyValue, titleValue) {
        ...
        if (obj != undefined && obj.KeyId != null) {
            if (obj.KeyId == null) {
                ...
                if (index < 0) {
                    let item = new _lich_su_cap_thuoc_bhyt_model__WEBPACK_IMPORTED_MODULE_20__["TagItem"]();
                    item.Key = keyValue;
    ...
    exportExcel() {
        var self = this;
        let dialogRef = self.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_11__["LoadingComponent"], {
            disableClose: true,
            width: '200px',
            height: '90px',
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('QuayThuoc/ExportLichSuCapThuocBHYT', self.exportQueryInfoQueryInfo).subscribe(resultData => {
...
LichSuCapThuocBHYTListComponent.ctorParameters = () => [
...
let LichSuCapThuocBHYTRoutingModule = class LichSuCapThuocBHYTRoutingModule {
};
...
class BenhNhanThongTin {
    constructor(Id = null, MaBN = null, MaYeuCauTiepNhan = null, HoTen = null, DiaChiDayDu = null, GioiTinh = null, GioiTinhHienThi = null, NamSinh = null, DiaChi = null, SoDienThoai = null, Email = null, SoDuTaiKhoan = 0) {
        this.Id = Id;
        this.MaBN = MaBN;
...
class XacNhanInThuocVatTuViewModel {
    constructor(PhieuXuatId = null, Hosting = null, LoaiDuocPhamVatTu = null) {
...
class XacNhanInThuocViewModel {
    constructor(TiepNhanId = null, TaiKhoanBenhNhanThuId = null, TaiKhoanBenhNhanChiId = null, Hosting = null, IsBhyt = null) {
...
let LichSuCapThuocBHYTModule = class LichSuCapThuocBHYTModule {
};
...
let LichSuCapThuocBHYTService = class LichSuCapThuocBHYTService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
    }
};
LichSuCapThuocBHYTService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
