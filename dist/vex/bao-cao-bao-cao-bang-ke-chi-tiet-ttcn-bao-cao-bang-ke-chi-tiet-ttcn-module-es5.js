...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-bang-ke-chi-tiet-ttcn-bao-cao-bang-ke-chi-tiet-ttcn-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBangKeChiTietTtcnListComponent = /** @class */ (function () {
                function BaoCaoBangKeChiTietTtcnListComponent(apiService, dialog, notificationService, authService) {
                ...
                BaoCaoBangKeChiTietTtcnListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoBangKeChiTietTtcnListComponent.prototype.pageChange = function (event) {
                    this.skip = event;
                    // this.XemBaoCao();
                ...
                BaoCaoBangKeChiTietTtcnListComponent.prototype.seachChange = function (event) {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoBangKeChiTietTtcnListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetDataBaoCaoBangKeChiTietTTCNForGridAsync", this.baoCaoSearch).subscribe(function (resultData) {
                ...
                BaoCaoBangKeChiTietTtcnListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                // format tiền trên UI
                BaoCaoBangKeChiTietTtcnListComponent.prototype.formatPrice = function (value) {
                    var val = (value / 1).toFixed(2).replace('.', ',');
                    return val.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
                };
                return BaoCaoBangKeChiTietTtcnListComponent;
            }());
            BaoCaoBangKeChiTietTtcnListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var BaoCaoBangKeChiTietTtcnPopupComponent = /** @class */ (function () {
                function BaoCaoBangKeChiTietTtcnPopupComponent() {
                }
                BaoCaoBangKeChiTietTtcnPopupComponent.prototype.ngOnInit = function () {
                };
                return BaoCaoBangKeChiTietTtcnPopupComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBangKeChiTietTtcnRoutingModule = /** @class */ (function () {
                function BaoCaoBangKeChiTietTtcnRoutingModule() {
                }
                return BaoCaoBangKeChiTietTtcnRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoBangKeChiTietTTCNSearch = /** @class */ (function () {
                function BaoCaoBangKeChiTietTTCNSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                ...
                return BaoCaoBangKeChiTietTTCNSearch;
            }());
            var InBaoCaoBangKeChiTietTTCN = /** @class */ (function () {
                function InBaoCaoBangKeChiTietTTCN(HostingName, FromDate, ToDate) {
                ...
                return InBaoCaoBangKeChiTietTTCN;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBangKeChiTietTtcnModule = /** @class */ (function () {
                function BaoCaoBangKeChiTietTtcnModule() {
                }
                return BaoCaoBangKeChiTietTtcnModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoBangKeChiTietTtcnService = /** @class */ (function (_super) {
                __extends(BaoCaoBangKeChiTietTtcnService, _super);
                function BaoCaoBangKeChiTietTtcnService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCaoBangKeChiTietTTCN';
                    return _this;
                }
                return BaoCaoBangKeChiTietTtcnService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            BaoCaoBangKeChiTietTtcnService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-bang-ke-chi-tiet-ttcn-bao-cao-bang-ke-chi-tiet-ttcn-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-bang-ke-chi-tiet-ttcn-bao-cao-bang-ke-chi-tiet-ttcn-module-es5.js.map