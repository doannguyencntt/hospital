...
let InLichSuBanThuocComponent = class InLichSuBanThuocComponent {
...
InLichSuBanThuocComponent.ctorParameters = () => [
...
let LichSuQuayThuocRoutingModule = class LichSuQuayThuocRoutingModule {
};
...
let LichSuQuayThuocModule = class LichSuQuayThuocModule {
};
...
let LichSuQuayThuocService = class LichSuQuayThuocService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
    }
};
LichSuQuayThuocService.ctorParameters = () => [
...
let LichSuQuayXuatThuocDetailComponent = class LichSuQuayXuatThuocDetailComponent {
    ...
    GetThongTinDonThuoc(id, idTaiKhoanBenhNhanThu) {
        const self = this;
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].View)) {
            self.apiService.post('QuayThuoc/GetDanhSachXuatThuocKhongBHYTLS?tiepNhanId=' + id + '&idTaiKhoanThu=' + idTaiKhoanBenhNhanThu).subscribe(resultData => {
    ...
    InPhieuThu() {
        ...
        let xacNhanInData = new _lich_su_quay_thuoc_model__WEBPACK_IMPORTED_MODULE_4__["XacNhanInViewModel"]();
        xacNhanInData = {
...
LichSuQuayXuatThuocDetailComponent.ctorParameters = () => [
...
let LichSuQuayXuatThuocListComponent = class LichSuQuayXuatThuocListComponent {
    ...
    getDropdownItem(obj, keyValue, titleValue) {
        ...
        if (obj != undefined && obj.KeyId != null) {
            if (obj.KeyId == null) {
                ...
                if (index < 0) {
                    let item = new _lich_su_quay_thuoc_model__WEBPACK_IMPORTED_MODULE_9__["TagItem"]();
                    item.Key = keyValue;
    ...
    huyXuatThuoc(thongTinSoPhieuDaThu) {
        var self = this;
        let huyXuatThuocTrongNgay = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_21__["HuyXuatThuocTrongNgay"]();
        ...
        self.dialog
            .open(_xac_nhan_phieu_huy_thu_ban_thuoc_xac_nhan_phieu_huy_thu_ban_thuoc_component__WEBPACK_IMPORTED_MODULE_22__["XacNhanHuyThuBanThuocComponent"], { disableClose: true, width: "800px", data: { huyXuatThuocTrongNgay } })
            .afterClosed()
...
LichSuQuayXuatThuocListComponent.ctorParameters = () => [
