...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~ke-toan-duyet-nhap-kho-duyet-nhap-kho-module~nhap-xuat-duoc-pham-nhap-kho-nhap-kho-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapKhoDuocPham = /** @class */ (function () {
                function NhapKhoDuocPham(Id, KhoDuocPhamId, TenKhoDuocPham, SoChungTu, LoaiNhapKho, TenLoaiNhapKho, NguoiGiaoId, TenNguoiGiao, TenNguoiGiaoNgoai, NguoiNhapId, TenNguoiNhap, LoaiNguoiGiao, NhapKhoDuocPhamChiTiets, NgayNhap, DaXuatKho) {
                    if (Id === void 0) { Id = 0; }
                    if (KhoDuocPhamId === void 0) { KhoDuocPhamId = null; }
            ...
            var NhapKhoDuocPhamChiTiet = /** @class */ (function () {
                function NhapKhoDuocPhamChiTiet(Id, IdView, NhapKhoDuocPhamId, DuocPhamBenhVienId, TenDuocPham, HopDongThauDuocPhamId, TenHopDongThau, KhoDuocPhamViTriId, ViTri, DatChatLuong, TenDatChatLuong, HanSuDung, TextHanSuDung, Solo, SoLuongNhap, SoLuongNhapTrongGrid, SoLuongHienTaiDuocPhamTheoHopDongThauDaLuu, DonGiaNhap, DonGiaBan, TextDonGiaNhap, TextDonGiaBan, TextChietKhau, TextSoLuongNhap, TextVAT, VAT, ChietKhau, MaVach, NgayNhap) {
                    if (Id === void 0) { Id = 0; }
                    if (IdView === void 0) { IdView = 0; }
                    if (NhapKhoDuocPhamId === void 0) { NhapKhoDuocPhamId = 0; }
                    ...
                    if (KhoDuocPhamViTriId === void 0) { KhoDuocPhamViTriId = null; }
                    ...
                    if (SoLuongHienTaiDuocPhamTheoHopDongThauDaLuu === void 0) { SoLuongHienTaiDuocPhamTheoHopDongThauDaLuu = 0; }
                ...
                return NhapKhoDuocPhamChiTiet;
            }());
            var NhapKhoDuocPhamSearch = /** @class */ (function () {
                function NhapKhoDuocPhamSearch(DangChoDuyet, DaDuyet, TuChoiDuyet, SearchString, RangeNhap, RangeDuyet) {
            ...
            var ThongTinDuyetKhoDuocPham = /** @class */ (function () {
                function ThongTinDuyetKhoDuocPham(NguoiNhapId, SoChungTu, TenNguoiNhap, NgayNhap, TinhTrangDuyet, ClassTrangThai, NguoiDuyetId, NguoiDuyet, NgayDuyet) {
            ...
            var ThongTinLyDoHuyNhapKhoDuocPham = /** @class */ (function () {
                function ThongTinLyDoHuyNhapKhoDuocPham(YeuCauNhapKhoDuocPhamId, LyDoHuy) {
                    if (YeuCauNhapKhoDuocPhamId === void 0) { YeuCauNhapKhoDuocPhamId = 0; }
                    if (LyDoHuy === void 0) { LyDoHuy = null; }
                    this.YeuCauNhapKhoDuocPhamId = YeuCauNhapKhoDuocPhamId;
                    this.LyDoHuy = LyDoHuy;
                }
                return ThongTinLyDoHuyNhapKhoDuocPham;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DsDuocPhamTrungNccPopupComponent = /** @class */ (function () {
                function DsDuocPhamTrungNccPopupComponent(dialog, data) {
                    this.dialog = dialog;
                    this.data = data;
                ...
                DsDuocPhamTrungNccPopupComponent.prototype.ngOnInit = function () {
                    this.gridColumns = [
                ...
                DsDuocPhamTrungNccPopupComponent.prototype.setDataSourceGrid = function () {
                    this.gridDataSource = {
                        data: this.data,
                ...
                return DsDuocPhamTrungNccPopupComponent;
            }());
            DsDuocPhamTrungNccPopupComponent.ctorParameters = function () { return [
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            ...
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
                                self.loadingPage();
                                self.apiService.post("NhapKhoDuocPham/ThemYeuCauNhapKhoDuocPham", self.nhapKho).subscribe(function (result) {
                                    ...
                                    if (result != undefined && result != null) {
                                        if (result.length > 0) {
                                            ...
                                            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                                                ...
                                                if (res == "Yes") {
                                                    self.loadingPage();
                                                    self.apiService.post("NhapKhoDuocPham/InPhieuYeuCauNhapKhoDuocPham?yeuCauNhapKhoDuocPhamId=" + result).subscribe(function (resData) {
                                                        if (resData != undefined && resData != null) {
                                                            ...
                                                            self.dialog.open(_phieu_nhap_kho_duoc_pham_popup_phieu_nhap_kho_duoc_pham_popup_component__WEBPACK_IMPORTED_MODULE_17__["PhieuNhapKhoDuocPhamPopupComponent"], {
                                                                ...
                                                                self.closePopupLoadingData();
                                                                _this.router.navigate(['/nhap-xuat/duoc-pham/nhap-kho']);
                                                            });
                                                        }
                                                    }, function (err) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapKhoListComponent = /** @class */ (function () {
                ...
                NhapKhoListComponent.prototype.clearSearchInStore = function () {
                    this.additionalSearchString = src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_26__["LocalStorageHelper"].getItem('additionalSearchStringNhapKho');
                    var res = JSON.parse(this.additionalSearchString);
                ...
                NhapKhoListComponent.prototype.exportExcel = function () {
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        ...
                        self.apiService.postExportExcel('NhapKhoDuocPham/ExportNhapKhoDuocPham', self.gridChild._gridQueryInfo).subscribe(function (resultData) {
                    ...
                    self.apiService.post("NhapKhoDuocPham/InPhieuYeuCauNhapKhoDuocPham?yeuCauNhapKhoDuocPhamId=" + id).subscribe(function (resData) {
                        if (resData != undefined && resData != null) {
                            ...
                            self.dialog.open(_phieu_nhap_kho_duoc_pham_popup_phieu_nhap_kho_duoc_pham_popup_component__WEBPACK_IMPORTED_MODULE_29__["PhieuNhapKhoDuocPhamPopupComponent"], {
                                ...
                                _this.router.navigateByUrl('/nhap-xuat/duoc-pham/nhap-kho?holdQuery=true');
                            });
                        }
                    }, function (err) {
                        self.validationErrors = err.ValidationErrors;
                ...
                NhapKhoListComponent.prototype.chinhSua = function (id) {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Update)) {
                        this.router.navigate(["/nhap-xuat/duoc-pham/nhap-kho/chinh-sua/" + id]);
                    }
                    else {
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Delete)) {
                                _this.apiService.post("NhapKhoDuocPham/XoaYeuCauNhapKhoDuocPham?id=" + id).subscribe(function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapKhoShareComponent = /** @class */ (function () {
                ...
                NhapKhoShareComponent.prototype.ngOnInit = function () {
                    ...
                    this.nhapKhoSource = new _nhap_kho_model__WEBPACK_IMPORTED_MODULE_2__["NhapKhoDuocPham"]();
                    this.nhapKhoChiTietSource = new _nhap_kho_model__WEBPACK_IMPORTED_MODULE_2__["NhapKhoDuocPhamChiTiet"]();
                    var nhapKhoChiTietDataSource = new _nhap_kho_model__WEBPACK_IMPORTED_MODULE_2__["NhapKhoDuocPhamChiTiet"]();
                ...
                NhapKhoShareComponent.prototype.kiemTraThongTinXuatKho = function () {
                    // kiểm tra thông tin xuất kho
                    if (!this.nhapKho.DaXuatKho) {
                        if (this.gridColumns.findIndex(function (x) { return x.Field == "Action"; }) == -1)
                ...
                NhapKhoShareComponent.prototype.getById = function (id) {
                    ...
                    self.apiService.post("NhapKhoDuocPham/GetGrid?id=" + id).subscribe(function (resultDataGrid) {
                        self.nhapKhoSource.NhapKhoDuocPhamChiTiets = resultDataGrid.NhapKhoDuocPhamChiTiets;
                        self.nhapKhoSource.NhapKhoDuocPhamChiTiets.forEach(function (e) {
                            e.IdView = Math.random();
                            _this.nhapKhoChiTiet.HopDongThauDuocPhamId = e.HopDongThauDuocPhamId;
                            _this.nhapKhoChiTiet.HopDongThauDisplay = e.HopDongThauDisplay;
                            _this.HopDongthauId = e.HopDongThauDuocPhamId;
                        ...
                        _this.NhathauId = self.nhapKhoSource.NhapKhoDuocPhamChiTiets[self.nhapKhoSource.NhapKhoDuocPhamChiTiets.length - 1].NhaThauId;
                        _this.NhathauDisplay = self.nhapKhoSource.NhapKhoDuocPhamChiTiets[self.nhapKhoSource.NhapKhoDuocPhamChiTiets.length - 1].NhaThauDisplay;
                        self.nhapKhoSource.OldNhapKhoDuocPhamChiTiets = self.nhapKhoSource.NhapKhoDuocPhamChiTiets.slice();
                        self.ClearData();
                ...
                NhapKhoShareComponent.prototype.kyHieuHoaDonChange = function (event) {
                    this.kyHieuHD = event;
                };
                NhapKhoShareComponent.prototype.soChungTuChange = function (event) {
                    this.soCT = event;
                };
                ...
                NhapKhoShareComponent.prototype.ClearData = function () {
                    this.isUpdate = false;
                    this.blockLoaiNhap = false;
                ...
                NhapKhoShareComponent.prototype.AddRow = function () {
                    ...
                    if (self.validationErrors && !self.validationErrors.some(function (x) { return x; })) {
                        self.apiService.post("NhapKhoDuocPham/ThemDuocPhamNhapKho", nhapKhoChiTietDataSource).subscribe(function (resultData) {
                ...
                NhapKhoShareComponent.prototype.UpdateRow = function () {
                    ...
                    if (self.validationErrors && !self.validationErrors.some(function (x) { return x; })) {
                        self.apiService.post("NhapKhoDuocPham/ThemDuocPhamNhapKho", nhapKhoChiTietDataSource).subscribe(function (resultData) {
                            // update
                            var item = self.nhapKhoSource.NhapKhoDuocPhamChiTiets.filter(function (obj) { return obj.IdView == resultData.IdView; })[0];
                ...
                NhapKhoShareComponent.prototype.DeleteRowGripView = function (IdView) {
                    ...
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_8__["ConfirmComponent"], {
                        ...
                        if (result == "Yes") {
                            _this.nhapKhoSource.NhapKhoDuocPhamChiTiets.forEach(function (value, index) {
                                if (IdView == value.IdView) {
                                    _this.nhapKhoSource.NhapKhoDuocPhamChiTiets.splice(index, 1);
                                    if (_this.nhapKhoSource.NhapKhoDuocPhamChiTiets.length == 0)
                                        _this.isUpdate = false;
                                    _this.setDataGridView(_this.nhapKhoSource.NhapKhoDuocPhamChiTiets);
                                    _this.Huy();
                                    _this.notificationService.showSuccess(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_10__["NhapXuatKhoMessage"].MessageRemoveItemGrid);
                                }
                            });
                        }
                    });
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_18__["SecurityOperation"].Update)) {
                        ...
                        if (self.nhapKhoChiTiet.HopDongThauDuocPhamId) {
                            self.apiService.get("NhapKhoDuocPham/GetPriceOnContract?hopDongThauId="
                                ...
                                "&duocPhamId=" + self.nhapKhoChiTiet.DuocPhamBenhVienId).subscribe(function (result) {
                ...
                NhapKhoShareComponent.prototype.selectionChangeDuocPham = function (dataItem) {
                ...
                NhapKhoShareComponent.prototype.getSharedData = function () {
                    ...
                    this.nhapKho.OldNhapKhoDuocPhamChiTiets = this.nhapKhoSource.OldNhapKhoDuocPhamChiTiets.slice();
                    return this.nhapKho;
                };
                NhapKhoShareComponent.prototype.loaiNguoiGiaoChange = function () {
                    this.nhapKho.NguoiGiaoId = null;
                    this.nhapKho.TenNguoiGiao = null;
                };
                NhapKhoShareComponent.prototype.tenNguoiGiaoChange = function (event) {
                    this.tenNguoiGiao = event;
                };
                NhapKhoShareComponent.prototype.nguoiGiaoIdChange = function (event) {
                ...
                NhapKhoShareComponent.prototype.modelChangeSoLuongNhap = function (event) {
                    ...
                    if (!this.nhapKhoChiTiet.LaDuocPhamBHYT) {
                        var thanhTien = ((event != null ? event : 0) *
                            (this.nhapKhoChiTiet.DonGiaNhap != null ? this.nhapKhoChiTiet.DonGiaNhap : 0) +
                            (event != null ? event : 0) *
                ...
                NhapKhoShareComponent.prototype.modelChangeThueVatLamTron = function (event) {
                    if (event != undefined && event != null) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapKhoTuChoiDuyetComponent = /** @class */ (function () {
                ...
                NhapKhoTuChoiDuyetComponent.prototype.getById = function (id) {
                };
                ...
                NhapKhoTuChoiDuyetComponent.prototype.luu = function () {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                        ...
                        self.loading = true;
                        self.nhapKho = self.shared.getSharedData();
                        self.apiService.post("NhapKhoDuocPham/CapNhatYeuCauNhapKhoDuocPham", self.nhapKho).subscribe(function () {
                ...
                NhapKhoTuChoiDuyetComponent.prototype.luuVaDuyetLai = function () {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_9__["SecurityOperation"].Update)) {
                        ...
                        self.loading = true;
                        self.nhapKho = self.shared.getSharedData();
                        self.apiService.post("NhapKhoDuocPham/CapNhatYeuCauNhapKhoDuocPham", self.nhapKho).subscribe(function (resultData) {
                            // self.router.navigate(['nhap-xuat/duoc-pham/nhap-kho']);
                            ...
                            self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                                ...
                                if (result == "Yes") {
                                    self.apiService.post("NhapKhoDuocPham/GoiDuyetLai?id=" + self.id).subscribe(function (result) {
                                        //self.router.navigate(['nhap-xuat/duoc-pham/nhap-kho']);
                                        self.router.navigateByUrl('nhap-xuat/duoc-pham/nhap-kho?holdQuery=true');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhapKhoTuDaDuyetComponent = /** @class */ (function () {
                ...
                NhapKhoTuDaDuyetComponent.prototype.getById = function (id) {
                };
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            ...
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                                self.loadingPage();
                                self.apiService.post("NhapKhoDuocPham/CapNhatYeuCauNhapKhoDuocPham", self.nhapKho).subscribe(function (result) {
                                    if (result != undefined && result != null) {
                                        self.closePopupLoadingData();
                                        if (result.length > 0) {
                                            self.dialog.open(_ds_duoc_pham_trung_ncc_popup_ds_duoc_pham_trung_ncc_popup_component__WEBPACK_IMPORTED_MODULE_19__["DsDuocPhamTrungNccPopupComponent"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var NhapKhoDuocPham = /** @class */ (function () {
                function NhapKhoDuocPham(Id, SoChungTu, 
                ...
                LoaiNguoiGiao, NhapKhoDuocPhamChiTiets, OldNhapKhoDuocPhamChiTiets, NgayNhap, NgayHoaDon, DaXuatKho, NgayDuyet, NhanVienDuyetId, LyDoKhongDuyet, KyHieuHoaDon, DuocKeToanDuyet, KhoNhapSauKhiDuyetId, NguoiNhapSauKhiDuyetId) {
                    if (Id === void 0) { Id = 0; }
                    if (SoChungTu === void 0) { SoChungTu = null; }
                    if (NguoiGiaoId === void 0) { NguoiGiaoId = null; }
                    if (TenNguoiGiao === void 0) { TenNguoiGiao = null; }
                    ...
                    if (LoaiNguoiGiao === void 0) { LoaiNguoiGiao = 1; }
                    if (NhapKhoDuocPhamChiTiets === void 0) { NhapKhoDuocPhamChiTiets = []; }
                    if (OldNhapKhoDuocPhamChiTiets === void 0) { OldNhapKhoDuocPhamChiTiets = []; }
                    if (NgayNhap === void 0) { NgayNhap = new Date(); }
            ...
            var NhapKhoDuocPhamChiTiet = /** @class */ (function () {
                function NhapKhoDuocPhamChiTiet(TiLeBHYTThanhToan, Id, IdView, HopDongThauDuocPhamId, NhaThauId, NhaThauDisplay, DuocPhamBenhVienId, TenDuocPhamBenhVien, LaDuocPhamBHYT, DuocPhamBenhVienPhanNhomId, Solo, HanSuDung, MaVach, SoLuongNhap, DonGiaNhap, GiaApThau, VAT, KhoViTriId, LoaiNhap, // 1 là hdt, 2 là ncc
                DVT, 
                //for grid
                HopDongThauDisplay, DuocPhamDisplay, LoaiDisplay, NhomDisplay, HanSuDungDisplay, SoLuongNhapDisplay, ViTriDisplay, SoLuongNhapSoCap, HeSoDinhMucDonViTinh, MaRef, KhoNhapSauKhiDuyetId, NguoiNhapSauKhiDuyetId, ThanhTienTruocVat, ThanhTienSauVat, ThueVatLamTron, GhiChu) {
                    if (TiLeBHYTThanhToan === void 0) { TiLeBHYTThanhToan = 100; }
                    if (Id === void 0) { Id = 0; }
                    ...
                    if (DuocPhamBenhVienId === void 0) { DuocPhamBenhVienId = null; }
                    if (TenDuocPhamBenhVien === void 0) { TenDuocPhamBenhVien = null; }
                    if (LaDuocPhamBHYT === void 0) { LaDuocPhamBHYT = true; }
            ...
            var NhapKhoDuocPhamSearch = /** @class */ (function () {
                function NhapKhoDuocPhamSearch(
                ...
                // public TenLoaiNhapKho: string = null,
                DangChoDuyet, TuChoiDuyet, DaDuyet, SearchString, RangeNhap, RangeDuyet) {
                    if (DangChoDuyet === void 0) { DangChoDuyet = true; }
                    if (TuChoiDuyet === void 0) { TuChoiDuyet = false; }
                    if (DaDuyet === void 0) { DaDuyet = false; }
                    if (SearchString === void 0) { SearchString = null; }
            ...
            var LookupItemViTriVo = /** @class */ (function () {
                function LookupItemViTriVo(KeyId, DisplayName, KhoDuocPhamId) {
                    this.KeyId = KeyId;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhieuNhapKhoDuocPhamPopupComponent = /** @class */ (function () {
                function PhieuNhapKhoDuocPhamPopupComponent(dialog, sanitizer, dialogRef, data) {
                    this.dialog = dialog;
                ...
                PhieuNhapKhoDuocPhamPopupComponent.prototype.ngOnInit = function () {
                    this.src = "data:text/html;charset=utf-8," + encodeURIComponent(this.data);
                };
                PhieuNhapKhoDuocPhamPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                PhieuNhapKhoDuocPhamPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        resolve(_this.data);
                    });
                };
                return PhieuNhapKhoDuocPhamPopupComponent;
            }());
            PhieuNhapKhoDuocPhamPopupComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=default~ke-toan-duyet-nhap-kho-duyet-nhap-kho-module~nhap-xuat-duoc-pham-nhap-kho-nhap-kho-module-es5.js.map
//# sourceMappingURL=default~ke-toan-duyet-nhap-kho-duyet-nhap-kho-module~nhap-xuat-duoc-pham-nhap-kho-nhap-kho-module-es5.js.map