...
let ChuanDoanCreateComponent = class ChuanDoanCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
ChuanDoanCreateComponent.ctorParameters = () => [
...
let ChuanDoanListComponent = class ChuanDoanListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('ChuanDoan/ExportChanDoan', self.chanDoanGridCha._gridQueryInfo).subscribe(resultData => {
...
ChuanDoanListComponent.ctorParameters = () => [
...
let ChuanDoanRoutingModule = class ChuanDoanRoutingModule {
};
...
let ChuanDoanSharedComponent = class ChuanDoanSharedComponent {
    constructor(apiService, dialog, authService, router, notificationService, route, cd, baseService) {
        this.apiService = apiService;
        this.dialog = dialog;
        this.authService = authService;
        this.router = router;
...
ChuanDoanSharedComponent.ctorParameters = () => [
...
let ChuanDoanUpdateComponent = class ChuanDoanUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
ChuanDoanUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_chuan_doan_shared_chuan_doan_shared_component__WEBPACK_IMPORTED_MODULE_2__["ChuanDoanSharedComponent"], { static: true })
...
class ChuanDoan {
    constructor(DanhMucChuanDoanId = null, DanhMucChuanDoanName = null, Ma = null, TenTiengViet = null, TenTiengAnh = null, ChuanDoanLienKetICDIds = []) {
...
let ChuanDoanModule = class ChuanDoanModule {
};
...
let ChuanDoanService = class ChuanDoanService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'ChuanDoan';
    }
};
ChuanDoanService.ctorParameters = () => [
