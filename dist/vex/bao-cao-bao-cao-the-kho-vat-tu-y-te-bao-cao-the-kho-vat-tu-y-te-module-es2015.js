...
let BaoCaoTheKhoVatTuListComponent = class BaoCaoTheKhoVatTuListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCaoVatTu/GetDataTheKhoVatTuForGridAsync", this.baoCaoTheKhoSearch).subscribe(resultData => {
...
BaoCaoTheKhoVatTuListComponent.ctorParameters = () => [
...
class BaoCaoTheKhoSearch {
    constructor(RangeFromDate = new _nhap_xuat_vat_tu_yeu_cau_mua_vat_tu_yeu_cau_mua_vat_tu_model__WEBPACK_IMPORTED_MODULE_1__["RangeDate"](), startDate = null, endDate = null, KhoId = null, NgayThang = null, DuocPhamHoacVatTuBenhVienId = null, LoaiDuocPhamHoacVatTu = null, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
let BaoCaoTheKhoVatTuService = class BaoCaoTheKhoVatTuService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCaoTheKho';
    }
};
BaoCaoTheKhoVatTuService.ctorParameters = () => [
