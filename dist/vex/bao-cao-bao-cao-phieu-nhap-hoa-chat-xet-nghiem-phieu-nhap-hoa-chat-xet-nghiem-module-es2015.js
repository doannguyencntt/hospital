...
let PhieuNhapHoaChatXetNghiemChiTietPopupComponent = class PhieuNhapHoaChatXetNghiemChiTietPopupComponent {
    ...
    showDataXetNghiem(baoCaoSearch) {
        ...
        this.apiService.post("BaoCao/GetDataPhieuNhapHoaChatChiTietForGrid", baoCaoSearch).subscribe(resultData => {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
            let loading = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_13__["LoadingComponent"], {
                disableClose: true,
                width: '200px',
                height: '90px',
...
PhieuNhapHoaChatXetNghiemChiTietPopupComponent.ctorParameters = () => [
...
let BaoCaoPhieuNhapHoaChatXetNghiemListComponent = class BaoCaoPhieuNhapHoaChatXetNghiemListComponent {
    ...
    loadListDanhSachXetNghiem(skip, take) {
        this.baoCaoSearch.Skip = skip;
        this.baoCaoSearch.Take = take;
        this.apiService.post("BaoCao/GetDataPhieuNhapHoaChatForGrid", this.baoCaoSearch).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                this.dataSource = {
                    data: resultData.Data,
                    total: resultData.TotalRowCount
...
BaoCaoPhieuNhapHoaChatXetNghiemListComponent.ctorParameters = () => [
...
let BaoCaoPhieuNhapHoaChatXetNghiemRoutingModule = class BaoCaoPhieuNhapHoaChatXetNghiemRoutingModule {
};
...
class BaoCaoTonKhoSearch {
    constructor(FromDate = null, ToDate = null, TuNgay = null, DenNgay = null, KhoId = null, DuocPhamId = null, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
class ThongTinChiTietXetNghiem {
    constructor(KhoId = null, DuocPhamId = null, TenDuocPham = null, TenKho = null, TuNgay = null, DenNgay = null) {
        this.KhoId = KhoId;
        this.DuocPhamId = DuocPhamId;
...
let BaoCaoPhieuNhapTonKhoXetNghiemModule = class BaoCaoPhieuNhapTonKhoXetNghiemModule {
};
...
let BaoCaoPhieuNhapHoaChatXetNghiemService = class BaoCaoPhieuNhapHoaChatXetNghiemService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoPhieuNhapHoaChatXetNghiemService.ctorParameters = () => [
