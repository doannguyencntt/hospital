...
let CheDoAnCreateComponent = class CheDoAnCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
CheDoAnCreateComponent.ctorParameters = () => [
...
let CheDoAnListComponent = class CheDoAnListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_4__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("CheDoAn/ExportCheDoAn", this.gridChild._gridQueryInfo).subscribe(res => {
...
CheDoAnListComponent.ctorParameters = () => [
...
let CheDoAnRoutingModule = class CheDoAnRoutingModule {
};
...
let CheDoAnSharedComponent = class CheDoAnSharedComponent {
...
CheDoAnSharedComponent.ctorParameters = () => [
...
let CheDoAnUpdateComponent = class CheDoAnUpdateComponent {
...
CheDoAnUpdateComponent.ctorParameters = () => [
...
let CheDoAnModule = class CheDoAnModule {
};
...
let CheDoAnService = class CheDoAnService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'CheDoAn';
    }
};
CheDoAnService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
