...
let BaoCaoTongHopDoanhThuTheoKhoaPhongRoutingModule = class BaoCaoTongHopDoanhThuTheoKhoaPhongRoutingModule {
};
...
class Search {
    constructor(RangeDateTimeFilter = new DateTimeFilter, RangeDateTimeSoSanh = new DateTimeFilter) {
...
class DoanhThuTheoKhoaPhong {
    constructor(STT = null, KhoaPhong = null, Thang = null, DoanhThuThang = 0, MienGiamThang = 0, KhacThang = 0, BHYTThang = 0, DoanhThuThuanThang = 0, KySoSanh = null, DoanhThuKy = 0, MienGiamKy = 0, KhacKy = 0, BHYTKy = 0, DoanhThuThuanKy = 0) {
        this.STT = STT;
...
class BaoCaoTongHopDoanhThuTheoKhoaPhongQueryInfoQueryInfo {
    constructor(BacSyId = 0, TuNgay = null, DenNgay = null, KySoSanhTuNgay = null, KySoSanhDenNgay = null, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
let BaoCaoTongHopDoanhThuTheoKhoaPhongModule = class BaoCaoTongHopDoanhThuTheoKhoaPhongModule {
};
...
let BaoCaoTongHopDoanhThuTheoKhoaPhongService = class BaoCaoTongHopDoanhThuTheoKhoaPhongService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoTongHopDoanhThuTheoKhoaPhongService.ctorParameters = () => [
...
let BaoCaoTongHopDoanhThuTheoKhoaPhongListComponent = class BaoCaoTongHopDoanhThuTheoKhoaPhongListComponent {
    constructor(apiService) {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetBaoCaoTongHopDoanhThuTheoKhoaPhongForGridAsync", this.baoCaoTongHopDoanhThuTheoKhoaPhongQueryInfoQueryInfo).subscribe(resultData => {
        ...
        this.apiService.post("BaoCao/GetTotalBaoCaoTongHopDoanhThuTheoKhoaPhongForGridAsync", this.baoCaoTongHopDoanhThuTheoKhoaPhongQueryInfoQueryInfo).subscribe(resultData => {
            if (resultData !== undefined && resultData != null) {
                this.gridData = resultData;
                // thang
...
BaoCaoTongHopDoanhThuTheoKhoaPhongListComponent.ctorParameters = () => [
