...
let BaoCaoXuatNhapTonKhoXetNghiemListComponent = class BaoCaoXuatNhapTonKhoXetNghiemListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataXuatNhapTonKhoXetNghiemForGrid", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoXuatNhapTonKhoXetNghiemListComponent.ctorParameters = () => [
...
let BaoCaoXuatNhapTonKhoXetNghiemRoutingModule = class BaoCaoXuatNhapTonKhoXetNghiemRoutingModule {
};
...
class BaoCaoTonKhoSearch {
    constructor(FromDate = null, ToDate = null, TuNgay = null, DenNgay = null, KhoId = null, Skip = 0, Take = 50, PageSize = 50, SearchString = "", AdditionalSearchString = "", Sort = []) {
...
let BaoCaoXuatNhapTonKhoXetNghiemModule = class BaoCaoXuatNhapTonKhoXetNghiemModule {
};
...
let BaoCaoXuatNhapTonKhoXetNghiemService = class BaoCaoXuatNhapTonKhoXetNghiemService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoXuatNhapTonKhoXetNghiemService.ctorParameters = () => [
