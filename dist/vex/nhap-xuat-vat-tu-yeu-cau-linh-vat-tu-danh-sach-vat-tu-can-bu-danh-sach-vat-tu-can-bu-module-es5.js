(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nhap-xuat-vat-tu-yeu-cau-linh-vat-tu-danh-sach-vat-tu-can-bu-danh-sach-vat-tu-can-bu-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachVatTuCanBuRoutingModule = /** @class */ (function () {
                function DanhSachVatTuCanBuRoutingModule() {
                }
                return DanhSachVatTuCanBuRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachVatTuCanBuComponent = /** @class */ (function () {
                function DanhSachVatTuCanBuComponent(dialog, router, apiService, authService, notificationService, cd) {
                    this.dialog = dialog;
                    this.router = router;
                ...
                DanhSachVatTuCanBuComponent.prototype.ngOnInit = function () {
                ...
                DanhSachVatTuCanBuComponent.prototype.search = function ($event) {
                    this.additionalSearchString = "{'KhoLinhId':" + (this.vatTuCanBuSearch.KhoLinhId != undefined ? this.vatTuCanBuSearch.KhoLinhId : null) + ",'KhoBuId':" + (this.vatTuCanBuSearch.KhoBuId != undefined ? this.vatTuCanBuSearch.KhoBuId : null) + "}";
                    this.grid._additionalSearchString = this.additionalSearchString;
                    this.grid.setDataSource();
                };
                DanhSachVatTuCanBuComponent.prototype.extOnDataBound = function (dataSource) {
                };
                DanhSachVatTuCanBuComponent.prototype.taoPhieuLinh = function (dataItem) {
                ...
                DanhSachVatTuCanBuComponent.prototype.loadingPage = function () {
                ...
                DanhSachVatTuCanBuComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                DanhSachVatTuCanBuComponent.prototype.khongBu = function (dataItem) {
                    ...
                    self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmComponent"], {
                        ...
                        if (res == "Yes") {
                            if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
                                self.loadingPage();
                                self.apiService.post("YeuCauLinhVatTu/KhongBuVatTu?yeuCauLinhVatTuIdstring=" + dataItem.YeuCauLinhVatTuIdstring).subscribe(function () {
                ...
                return DanhSachVatTuCanBuComponent;
            }());
            DanhSachVatTuCanBuComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DanhSachVatTuCanBuModule = /** @class */ (function () {
                function DanhSachVatTuCanBuModule() {
                }
                return DanhSachVatTuCanBuModule;
            }());
...
//# sourceMappingURL=nhap-xuat-vat-tu-yeu-cau-linh-vat-tu-danh-sach-vat-tu-can-bu-danh-sach-vat-tu-can-bu-module-es5.js.map
//# sourceMappingURL=nhap-xuat-vat-tu-yeu-cau-linh-vat-tu-danh-sach-vat-tu-can-bu-danh-sach-vat-tu-can-bu-module-es5.js.map