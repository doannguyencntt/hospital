...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-cong-ty-uu-dai-cong-ty-uu-dai-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CongTyUuDaiCreateComponent = /** @class */ (function () {
                function CongTyUuDaiCreateComponent(router) {
                    this.router = router;
                }
                CongTyUuDaiCreateComponent.prototype.ngOnInit = function () { };
                CongTyUuDaiCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/cong-ty-uu-dai']);
                };
                CongTyUuDaiCreateComponent.prototype.onValidateClient = function (isValidate) {
                    if (isValidate) {
                        this.shared.OnValidate();
                    }
                };
                CongTyUuDaiCreateComponent.prototype.keyEvent = function (event) {
                ...
                return CongTyUuDaiCreateComponent;
            }());
            CongTyUuDaiCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CongTyUuDaiListComponent = /** @class */ (function () {
                function CongTyUuDaiListComponent(authService, dialog, notificationService, apiService) {
                ...
                CongTyUuDaiListComponent.prototype.ngOnInit = function () {
                ...
                CongTyUuDaiListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel('CongTyUuDai/ExportCongTyUuDai', this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                CongTyUuDaiListComponent.prototype.update = function (id, isDisabled) {
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Update)) {
                        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                self.apiService.post('CongTyUuDai/KichHoatCongTyUuDai?id=' + id).subscribe(function () {
                ...
                return CongTyUuDaiListComponent;
            }());
            CongTyUuDaiListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CongTyUuDaiRoutingModule = /** @class */ (function () {
                function CongTyUuDaiRoutingModule() {
                }
                return CongTyUuDaiRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CongTyUuDaiSharedComponent = /** @class */ (function () {
                function CongTyUuDaiSharedComponent(route, baseService, dialog) {
                    this.route = route;
                ...
                CongTyUuDaiSharedComponent.prototype.ngOnInit = function () {
                ...
                CongTyUuDaiSharedComponent.prototype.OpenLoading = function () {
                ...
                CongTyUuDaiSharedComponent.prototype.getSharedData = function () {
                    if (this.isCreate) {
                        this.congTyUuDai.Id = 0;
                    }
                    return this.congTyUuDai;
                };
                CongTyUuDaiSharedComponent.prototype.CloseLoading = function () {
                    this.dialog.closeAll();
                };
                CongTyUuDaiSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.congTyUuDai = resultData;
                        _this.congTyUuDai.IsDisabled = _this.congTyUuDai.IsDisabled ? _this.congTyUuDai.IsDisabled : false;
                        _this.CloseLoading();
                    });
                };
                CongTyUuDaiSharedComponent.prototype.OnValidate = function () {
                ...
                return CongTyUuDaiSharedComponent;
            }());
            CongTyUuDaiSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _cong_ty_uu_dai_shared_cong_ty_uu_dai_shared_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../cong-ty-uu-dai-shared/cong-ty-uu-dai-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/benh-vien/cong-ty-uu-dai/cong-ty-uu-dai-shared/cong-ty-uu-dai-shared.component.ts");
            var CongTyUuDaiUpdateComponent = /** @class */ (function () {
                function CongTyUuDaiUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                CongTyUuDaiUpdateComponent.prototype.ngOnInit = function () { };
                CongTyUuDaiUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/cong-ty-uu-dai']);
                };
                CongTyUuDaiUpdateComponent.prototype.onValidateClient = function (isValidate) {
                    if (isValidate) {
                        this.shared.OnValidate();
                    }
                };
                CongTyUuDaiUpdateComponent.prototype.keyEvent = function (event) {
                    if (event.keyCode === 83 && event.ctrlKey) {
                        // ctrl + s
                        this.footer.update();
                        event.preventDefault();
                ...
                return CongTyUuDaiUpdateComponent;
            }());
            CongTyUuDaiUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var CongTyUuDai = /** @class */ (function () {
                function CongTyUuDai(Id, Ten, MoTa, IsDisabled) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CongTyUuDaiModule = /** @class */ (function () {
                function CongTyUuDaiModule() {
                }
                return CongTyUuDaiModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CongTyUuDaiService = /** @class */ (function (_super) {
                __extends(CongTyUuDaiService, _super);
                function CongTyUuDaiService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'CongTyUuDai';
                    return _this;
                }
                return CongTyUuDaiService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            CongTyUuDaiService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-cong-ty-uu-dai-cong-ty-uu-dai-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-cong-ty-uu-dai-cong-ty-uu-dai-module-es5.js.map