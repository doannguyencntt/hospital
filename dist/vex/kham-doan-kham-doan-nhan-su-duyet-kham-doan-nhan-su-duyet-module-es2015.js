...
let KhamDoanNhanSuDuyetDetailPopupComponent = class KhamDoanNhanSuDuyetDetailPopupComponent {
    constructor(authService, dialog, notificationService, router, apiService, location, route) {
...
KhamDoanNhanSuDuyetDetailPopupComponent.ctorParameters = () => [
...
let KhamDoanNhanSuDuyetListComponent = class KhamDoanNhanSuDuyetListComponent {
    constructor(authService, notificationService, route, dialog, apiService, router) {
        this.authService = authService;
        this.notificationService = notificationService;
        this.route = route;
        this.dialog = dialog;
    ...
    ngOnInit() {
        ...
        if (holdQuery && src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_13__["LocalStorageHelper"].getItem('additionalSearchStringDanhSachNhanSuDuyetYeuCauNhanSuKhamSucKhoe')) {
            const additionalSearchString = src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_13__["LocalStorageHelper"].getItem('additionalSearchStringDanhSachNhanSuDuyetYeuCauNhanSuKhamSucKhoe');
...
KhamDoanNhanSuDuyetListComponent.ctorParameters = () => [
...
let KhamDoanNhanSuDuyetRoutingModule = class KhamDoanNhanSuDuyetRoutingModule {
};
...
class KhamDoanNhanSuDuyetTimKiem {
    constructor(SearchString = null, TrangThai = new KhamDoanNhanSuDuyetTimKiemTrangThai(), NgayGui = new KhamDoanNhanSuDuyetTimKiemDateRange(), NgayKHTHDuyet = new KhamDoanNhanSuDuyetTimKiemDateRange(), NgayNhanSuDuyet = new KhamDoanNhanSuDuyetTimKiemDateRange(), NgayGiamDocDuyet = new KhamDoanNhanSuDuyetTimKiemDateRange()) {
...
class KhamDoanNhanSuDuyetTimKiemTrangThai {
...
class KhamDoanNhanSuDuyetTimKiemDateRange {
...
let KhamDoanNhanSuDuyetModule = class KhamDoanNhanSuDuyetModule {
};
