...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-nhat-ky-he-thong-lich-su-email-lich-su-email-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuEmailListComponent = /** @class */ (function () {
                function LichSuEmailListComponent(dialog, apiService, notificationService, authService) {
                    this.dialog = dialog;
                ...
                LichSuEmailListComponent.prototype.ngOnInit = function () {
                ...
                LichSuEmailListComponent.prototype.searchHistoryEmail = function () {
                    var goiDenQueryString = null;
                    var TuNgayQueryString = null;
                    var DenNgayQueryString = null;
                    var TieuDeQueryString = null;
                    ...
                    var queryString = "{\"GoiDen\":" + goiDenQueryString + ",\"TrangThai\":" + TrangThaiQueryString + ",\"TuNgay\":" + TuNgayQueryString + ",\"DenNgay\":" + DenNgayQueryString + ",\"TieuDe\":" + TieuDeQueryString + "}";
                    this.gridChild._additionalSearchString = queryString;
                    this.gridChild.search();
                };
                LichSuEmailListComponent.prototype.reset = function () {
                    ...
                    this.searchInfo.TrangThai = 0;
                    this.displayResetButton = false;
                    var queryString = "{\"GoiDen\":null,\"TrangThai\":0,\"TuNgay\":null,\"DenNgay\":null,\"TieuDe\":null}";
                    this.gridChild._additionalSearchString = queryString;
                    this.gridChild.search();
                };
                LichSuEmailListComponent.prototype.ConvertDateTime = function (datime) {
                ...
                LichSuEmailListComponent.prototype.changeValueStart = function (event) {
                ...
                LichSuEmailListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("LichSuEmail/ExportLichSuEmail", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return LichSuEmailListComponent;
            }());
            LichSuEmailListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuEmailRoutingModule = /** @class */ (function () {
                function LichSuEmailRoutingModule() {
                }
                return LichSuEmailRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var searchLichSuEmail = /** @class */ (function () {
                function searchLichSuEmail(GoiDen, TieuDe, TuNgay, DenNgay, TrangThai, TenTrangThai) {
                    if (GoiDen === void 0) { GoiDen = null; }
                    if (TieuDe === void 0) { TieuDe = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuEmailModule = /** @class */ (function () {
                function LichSuEmailModule() {
                }
                return LichSuEmailModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LichSuEmailService = /** @class */ (function (_super) {
                __extends(LichSuEmailService, _super);
                function LichSuEmailService(apiservice) {
                    var _this = _super.call(this, apiservice) || this;
                    _this.controllerName = 'LichSuEmail';
                    return _this;
                }
                return LichSuEmailService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            LichSuEmailService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-nhat-ky-he-thong-lich-su-email-lich-su-email-module-es5.js.map
//# sourceMappingURL=bao-cao-nhat-ky-he-thong-lich-su-email-lich-su-email-module-es5.js.map