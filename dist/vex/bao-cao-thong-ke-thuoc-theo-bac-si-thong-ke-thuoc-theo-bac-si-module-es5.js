...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-thong-ke-thuoc-theo-bac-si-thong-ke-thuoc-theo-bac-si-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongKeThuocTheoBacSiNewComponent = /** @class */ (function () {
                function ThongKeThuocTheoBacSiNewComponent(apiService, dialog, notificationService, authService) {
                ...
                ThongKeThuocTheoBacSiNewComponent.prototype.ngOnInit = function () {
                ...
                ThongKeThuocTheoBacSiNewComponent.prototype.xemBaoCao = function () {
                    var _this = this;
                    var self = this;
                    ...
                    self.apiService.post("BaoCao/ThongKeThuocTheoBacSiHTML", self.baoCaoThongKeThuocTheoBacSiSearch).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.html = "";
                            _this.html = resultData;
                            self.closeAllDialogs();
                        }
                    });
                };
                ThongKeThuocTheoBacSiNewComponent.prototype.xuatBaoCao = function () {
                    var self = this;
                    if (self.baoCaoThongKeThuocTheoBacSiSearch.TuNgay == null ||
                        self.baoCaoThongKeThuocTheoBacSiSearch.DenNgay == null) {
                        self.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                ...
                ThongKeThuocTheoBacSiNewComponent.prototype.totalGroup = function (dataGroups) {
                    console.log(dataGroups);
                };
                ;
                ThongKeThuocTheoBacSiNewComponent.prototype.total = function (field) {
                    switch (field) {
                        case 'SoLuong':
                ...
                ;
                ThongKeThuocTheoBacSiNewComponent.prototype.XuLyTotalForField = function (field) {
                    var sum = 0;
                ...
                ThongKeThuocTheoBacSiNewComponent.prototype.showLoadingPopup = function () {
                ...
                ThongKeThuocTheoBacSiNewComponent.prototype.showSavingPopup = function () {
                    if (!this.loadingPopup) {
                        this.loadingPopup = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_7__["LoadingComponent"], {
                            disableClose: true,
                            width: '200px',
                ...
                ThongKeThuocTheoBacSiNewComponent.prototype.closeAllDialogs = function () {
                    if (this.loadingPopup) {
                        this.loadingPopup.close();
                        this.loadingPopup = null;
                    }
                };
                return ThongKeThuocTheoBacSiNewComponent;
            }());
            ThongKeThuocTheoBacSiNewComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongKeThuocTheoBacSiRoutingModule = /** @class */ (function () {
                function ThongKeThuocTheoBacSiRoutingModule() {
                }
                return ThongKeThuocTheoBacSiRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoThongKeThuocTheoBacSiSearch = /** @class */ (function () {
                function BaoCaoThongKeThuocTheoBacSiSearch(SearchString, TuNgay, DenNgay, BacSiId, Skip, Take, PageSize) {
                ...
                return BaoCaoThongKeThuocTheoBacSiSearch;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ThongKeThuocTheoBacSiModule = /** @class */ (function () {
                function ThongKeThuocTheoBacSiModule() {
                }
                return ThongKeThuocTheoBacSiModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var ThongKeThuocTheoBacSiService = /** @class */ (function (_super) {
                __extends(ThongKeThuocTheoBacSiService, _super);
                function ThongKeThuocTheoBacSiService(apiService) {
                    return _super.call(this, apiService) || this;
                }
                return ThongKeThuocTheoBacSiService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            ThongKeThuocTheoBacSiService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _iconify_icons_ic_twotone_filter_list__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/ __webpack_require__.n(_iconify_icons_ic_twotone_filter_list__WEBPACK_IMPORTED_MODULE_12__);
            /* harmony import */ var _thong_ke_thuoc_theo_bac_si_model__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../thong-ke-thuoc-theo-bac-si.model */ "./src/app/modules/main/bao-cao/thong-ke-thuoc-theo-bac-si/thong-ke-thuoc-theo-bac-si.model.ts");
            var ThongKeThuocTheoBacSiComponent = /** @class */ (function () {
                function ThongKeThuocTheoBacSiComponent(apiService, dialog, notificationService, authService) {
                    this.apiService = apiService;
                    this.dialog = dialog;
                    this.notificationService = notificationService;
                    this.authService = authService;
                ...
                ThongKeThuocTheoBacSiComponent.prototype.ngOnInit = function () {
                    this.documentType = src_app_shared_enum_document_type_enum__WEBPACK_IMPORTED_MODULE_9__["DocumentType"].ThongKeThuocTheoBacSi;
                    this.gridColumns = [
                ...
                ThongKeThuocTheoBacSiComponent.prototype.xemBaoCao = function () {
                    var self = this;
                    if (self.baoCaoThongKeThuocTheoBacSiSearch.TuNgay == null ||
                        self.baoCaoThongKeThuocTheoBacSiSearch.DenNgay == null) {
                        self.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                    ...
                    self.showLoadingPopup();
                    self.apiService.post("BaoCao/GetDataThongKeThuocTheoBacSiForGrid", self.baoCaoThongKeThuocTheoBacSiSearch).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            self.gridDataSource = {
                ...
                ThongKeThuocTheoBacSiComponent.prototype.xuatBaoCao = function () {
                    var self = this;
                    if (self.baoCaoThongKeThuocTheoBacSiSearch.TuNgay == null ||
                        self.baoCaoThongKeThuocTheoBacSiSearch.DenNgay == null) {
                        self.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                ...
                ThongKeThuocTheoBacSiComponent.prototype.totalGroup = function (dataGroups) {
                    console.log(dataGroups);
                };
                ;
                ThongKeThuocTheoBacSiComponent.prototype.total = function (field) {
                    switch (field) {
                        case 'SoLuong':
                            return this.XuLyTotalForField('SoLuong');
                        case 'ThanhTien':
                ...
                ;
                ThongKeThuocTheoBacSiComponent.prototype.XuLyTotalForField = function (field) {
                    var sum = 0;
                    if (this.gridDataSource.data != undefined && this.gridDataSource.data != null) {
                        this.gridDataSource.data.forEach(function (element) {
                            switch (field) {
                ...
                ThongKeThuocTheoBacSiComponent.prototype.showLoadingPopup = function () {
                    if (!this.loadingPopup) {
                        this.loadingPopup = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_7__["LoadingComponent"], {
                            disableClose: true,
                            width: '200px',
                ...
                ThongKeThuocTheoBacSiComponent.prototype.showSavingPopup = function () {
                    if (!this.loadingPopup) {
                        this.loadingPopup = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_7__["LoadingComponent"], {
                            disableClose: true,
                            width: '200px',
                ...
                ThongKeThuocTheoBacSiComponent.prototype.closeAllDialogs = function () {
                    if (this.loadingPopup) {
                        this.loadingPopup.close();
                        this.loadingPopup = null;
                    }
                };
                return ThongKeThuocTheoBacSiComponent;
            }());
            ThongKeThuocTheoBacSiComponent.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
                { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_5__["NotificationService"] },
                { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }
...
//# sourceMappingURL=bao-cao-thong-ke-thuoc-theo-bac-si-thong-ke-thuoc-theo-bac-si-module-es5.js.map
//# sourceMappingURL=bao-cao-thong-ke-thuoc-theo-bac-si-thong-ke-thuoc-theo-bac-si-module-es5.js.map