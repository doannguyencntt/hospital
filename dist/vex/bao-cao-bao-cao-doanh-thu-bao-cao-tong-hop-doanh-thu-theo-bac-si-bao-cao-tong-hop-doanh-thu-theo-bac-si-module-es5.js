...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-doanh-thu-bao-cao-tong-hop-doanh-thu-theo-bac-si-bao-cao-tong-hop-doanh-thu-theo-bac-si-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTongHopDoanhThuTheoBacSiListComponent = /** @class */ (function () {
                function BaoCaoTongHopDoanhThuTheoBacSiListComponent(apiService, intl) {
                ...
                BaoCaoTongHopDoanhThuTheoBacSiListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoTongHopDoanhThuTheoBacSiListComponent.prototype.pageChange = function (event) {
                    this.baoCaoDoanhThuBacSiQueryInfoQueryInfo.Skip = event.skip;
                    this.skip = event.skip;
                    this.XemBaoCao();
                };
                BaoCaoTongHopDoanhThuTheoBacSiListComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoTongHopDoanhThuTheoBacSiListComponent.prototype.changeValueStart = function (event) {
                ...
                BaoCaoTongHopDoanhThuTheoBacSiListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetBaoCaoTongHopDoanhThuTheoBacSiForGridAsync", this.baoCaoDoanhThuBacSiQueryInfoQueryInfo).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.gridData = resultData.Data;
                            _this.gridView = {
                                data: _this.gridData,
                    ...
                    this.apiService.post("BaoCao/GetTotalBaoCaoTongHopDoanhThuTheoBacSiForGridAsync", this.baoCaoDoanhThuBacSiQueryInfoQueryInfo).subscribe(function (resultData) {
                        if (resultData !== undefined && resultData != null) {
                            _this.totalDoanhThu = resultData.DoanhThu;
                            _this.totalBHYT = resultData.Bhyt;
                            _this.totalThucThu = 0;
                            _this.totalMienGiam = resultData.MienGiam;
                            _this.totalKhac = resultData.KhoanGiamTruKhac;
                        }
                    });
                };
                BaoCaoTongHopDoanhThuTheoBacSiListComponent.prototype.XuatBaoCao = function () {
                ...
                BaoCaoTongHopDoanhThuTheoBacSiListComponent.prototype.searchRefresh = function () {
                    this.XemBaoCao();
                };
                return BaoCaoTongHopDoanhThuTheoBacSiListComponent;
            }());
            BaoCaoTongHopDoanhThuTheoBacSiListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTongHopDoanhThuTheoBacSiRoutingModule = /** @class */ (function () {
                function BaoCaoTongHopDoanhThuTheoBacSiRoutingModule() {
                }
                return BaoCaoTongHopDoanhThuTheoBacSiRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Search = /** @class */ (function () {
                function Search(RangeDateTimeFilter) {
                    if (RangeDateTimeFilter === void 0) { RangeDateTimeFilter = new rangeDate; }
            ...
            var BaoCaoTongHopDoanhThuBacSy = /** @class */ (function () {
                function BaoCaoTongHopDoanhThuBacSy(Stt, HoTenBacSi, DoanhThu, MienGiam, Bhyt, ThucThu, KhoanGiamTruKhac) {
                    if (Stt === void 0) { Stt = null; }
                    if (HoTenBacSi === void 0) { HoTenBacSi = null; }
                    if (DoanhThu === void 0) { DoanhThu = null; }
                    if (MienGiam === void 0) { MienGiam = 0; }
                    if (Bhyt === void 0) { Bhyt = 0; }
                    if (ThucThu === void 0) { ThucThu = 0; }
                    if (KhoanGiamTruKhac === void 0) { KhoanGiamTruKhac = 0; }
                    this.Stt = Stt;
                ...
                return BaoCaoTongHopDoanhThuBacSy;
            }());
            var BaoCaoDoanhThuBacSiQueryInfoQueryInfo = /** @class */ (function () {
                function BaoCaoDoanhThuBacSiQueryInfoQueryInfo(TuNgay, DenNgay, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                ...
                return BaoCaoDoanhThuBacSiQueryInfoQueryInfo;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTongHopDoanhThuTheoBacSiModule = /** @class */ (function () {
                function BaoCaoTongHopDoanhThuTheoBacSiModule() {
                }
                return BaoCaoTongHopDoanhThuTheoBacSiModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTongHopDoanhThuTheoBacSiService = /** @class */ (function (_super) {
                __extends(BaoCaoTongHopDoanhThuTheoBacSiService, _super);
                function BaoCaoTongHopDoanhThuTheoBacSiService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'BaoCao';
                    return _this;
                }
                return BaoCaoTongHopDoanhThuTheoBacSiService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            BaoCaoTongHopDoanhThuTheoBacSiService.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-bao-cao-tong-hop-doanh-thu-theo-bac-si-bao-cao-tong-hop-doanh-thu-theo-bac-si-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-doanh-thu-bao-cao-tong-hop-doanh-thu-theo-bac-si-bao-cao-tong-hop-doanh-thu-theo-bac-si-module-es5.js.map