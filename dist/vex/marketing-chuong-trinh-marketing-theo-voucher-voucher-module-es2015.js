...
let VoucherChiTietPopupComponent = class VoucherChiTietPopupComponent {
    constructor(data, dialog, dialogRef, apiService, broadcastService, notificationService, authService) {
        this.data = data;
        this.dialog = dialog;
    ...
    getTongSoBenhNhanSuDungDichVu() {
        this.apiService.get(`Voucher/GetTongSoBenhNhanSuDungDichVu?voucherId=${this.idVoucher}`).subscribe(res => {
    ...
    getSoLuongPhatHanh() {
        this.apiService.get(`Voucher/GetSoLuongPhatHanhVoucher?voucherId=${this.idVoucher}`).subscribe(res => {
...
VoucherChiTietPopupComponent.ctorParameters = () => [
...
let VoucherCreateComponent = class VoucherCreateComponent {
    constructor(router, dialog, notificationService) {
        this.router = router;
        this.dialog = dialog;
        this.notificationService = notificationService;
    }
...
VoucherCreateComponent.ctorParameters = () => [
...
let VoucherInPopupComponent = class VoucherInPopupComponent {
    constructor(data, dialog, dialogRef, apiService, broadcastService, notificationService, authService) {
        this.data = data;
        this.dialog = dialog;
        this.dialogRef = dialogRef;
    ...
    getSharedPrintForm() {
        ...
        return new Promise(resolve => {
            this.apiService.post(`Voucher/GetHtmlVoucher`, this.voucherThongTinHTML).subscribe(resultData => {
                resolve(resultData);
            });
        });
        // return new Promise(resolve => {
...
VoucherInPopupComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
...
let VoucherListComponent = class VoucherListComponent {
                ...
                this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                    ...
                    if (result == 'Yes') {
                        this.apiService.delete(`Voucher/${dataItem.Id}`).subscribe(() => {
                            ...
                            this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_12__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_13__["SystemMessage"].ActionSuccessfully, ['Xóa']));
                        }, (err) => {
                            this.notificationService.showError(err.Message);
                        });
                    }
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("Voucher/ExportChuongTrinhMarketingTheoVoucher", this.gridChild._gridQueryInfo).subscribe(res => {
...
VoucherListComponent.ctorParameters = () => [
...
let VoucherSharedComponent = class VoucherSharedComponent {
    constructor(route, router, apiService, baseService, notificationService, cd, dialog) {
        this.route = route;
        this.router = router;
        this.apiService = apiService;
    ...
    tenDichVuChange(evt) {
        if (evt) {
            ...
            this.apiService.post(`Voucher/GetListTatCaLoaiGiaChoDichVu?loaiDichVu=${evt.LoaiDichVu}`).subscribe(res => {
                this.loaiGia = res;
    ...
    getDonGia() {
        if (this.dichVuVoucher.DichVuId && this.dichVuVoucher.LoaiGiaId && this.dichVuVoucher.LoaiDichVuBenhVien) {
            this.apiService.post(`Voucher/GetDonGiaChoDichVu?dichVuId=${this.dichVuVoucher.DichVuId}&loaiGiaId=${this.dichVuVoucher.LoaiGiaId}&loaiDichVu=${this.dichVuVoucher.LoaiDichVuBenhVien}`).subscribe(res => {
    ...
    getDonGiaDichVu(dataItem) {
        if (dataItem.DichVuId && dataItem.LoaiGiaId && dataItem.LoaiDichVuBenhVien) {
            this.apiService.post(`Voucher/GetDonGiaChoDichVu?dichVuId=${dataItem.DichVuId}&loaiGiaId=${dataItem.LoaiGiaId}&loaiDichVu=${dataItem.LoaiDichVuBenhVien}`).subscribe(res => {
                dataItem.DonGia = res;
                this.getDonGiaSauChietKhauChoDichVu(dataItem);
            }, (err) => {
                this.notificationService.showError(err.Message);
    ...
    checkExistNhomDichVu(nhomDichVuId) {
    ...
    checkExistNhomDichVuCha(nhomDichVuChaId) {
    ...
    checkExistNhomDichVuCon(nhomDichVuConItems) {
    ...
    themDichVuChoVoucher() {
        ...
        if (this.validationErrors && !this.validationErrors.some(x => x)) {
            if (this.idVoucher && this.idVoucher !== 0) {
                this.apiService.post(`Voucher/KiemTraDichVuDaTonTaiTrongNhomDichVu?voucherId=${this.idVoucher}&dichVuId=${this.dichVuVoucher.DichVuId}&loaiDichVuBenhVien=${this.dichVuVoucher.LoaiDichVuBenhVien}`).subscribe(res => {
                    if (res) {
                        this.dichVuVoucher.NhomDichVuId = null;
                        let dichVuVoucher = {};
                        dichVuVoucher = Object.assign({}, this.dichVuVoucher);
                ...
                this.apiService.post(`Voucher/KiemTraDichVuDaTonTaiTrongNhomDichVuTheoDanhSach?dichVuId=${this.dichVuVoucher.DichVuId}&loaiDichVuBenhVien=${this.dichVuVoucher.LoaiDichVuBenhVien}`, this.voucher).subscribe(res => {
                    if (res) {
                        this.dichVuVoucher.NhomDichVuId = null;
                        let dichVuVoucher = {};
                        dichVuVoucher = Object.assign({}, this.dichVuVoucher);
    ...
    themNhomDichVuChoVoucher() {
        ...
        if (this.validationErrors && !this.validationErrors.some(x => x)) {
            if (this.idVoucher && this.idVoucher !== 0) {
                this.apiService.post(`Voucher/KiemTraNhomDichVuDaBaoGomDichVu?voucherId=${this.idVoucher}&nhomDichVuId=${this.dichVuVoucher.NhomDichVuId}`).subscribe(res => {
                    if (res) {
                ...
                this.apiService.post(`Voucher/KiemTraNhomDichVuDaBaoGomDichVuTheoDanhSach?&nhomDichVuId=${this.dichVuVoucher.NhomDichVuId}`, this.voucher).subscribe(res => {
                    if (res) {
                        this.dichVuVoucher.DichVuId = null;
                        this.dichVuVoucher.LoaiGiaId = null;
                        let dichVuVoucher = {};
    ...
    luuDichVu() {
        ...
        if (this.validationErrors != null && this.validationErrors.length === 0) {
            ...
            this.apiService.put(`Voucher`, this.voucher).subscribe(res => {
                this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["Chỉnh sửa"]));
                this.router.navigate(['/marketing/ct-marketing/voucher']);
            }, (err) => {
                err.ValidationErrors === null || err.ValidationErrors.length == 0 ? this.notificationService.showError(err.Message) : this.validationErrors = err.ValidationErrors;
            });
    ...
    themDichVu() {
        ...
        if (this.validationErrors != null && this.validationErrors.length === 0) {
            ...
            this.voucher.TiLeChietKhau = null;
            this.voucher.SoTienChietKhau = null;
            this.apiService.post(`Voucher`, this.voucher).subscribe(res => {
                this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["Thêm"]));
                this.router.navigate(['/marketing/ct-marketing/voucher']);
            }, (err) => {
                err.ValidationErrors === null || err.ValidationErrors.length == 0 ? this.notificationService.showError(err.Message) : this.validationErrors = err.ValidationErrors;
            });
    ...
    onDataBoundGridDichVuDonLe(event) {
    ...
    onDataBoundGridNhomDichVu(event) {
...
VoucherSharedComponent.ctorParameters = () => [
...
let VoucherUpdateComponent = class VoucherUpdateComponent {
    constructor(router, dialog, notificationService) {
        this.router = router;
        this.dialog = dialog;
        this.notificationService = notificationService;
...
VoucherUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
class VoucherThongTinHTML {
    constructor(HostingName = null, Ten = null, Ma = null, SoLuong = null, MaSoTu = null, SoLuongPhatHanh = null) {
...
let VoucherService = class VoucherService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
