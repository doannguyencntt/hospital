...
class ThongKeKhamBenhSearch {
    constructor(TuNgay = null, DenNgay = null, FromDate = null, ToDate = null) {
        this.TuNgay = TuNgay;
...
class ThongKeBenhVien {
    constructor(ThongKeTiepNhan = null, ThongKeKhamBenh = null, ThongKeGiuongBenh = null, ThongKeNoiTru = null, ThongKeSoSinh = null) {
...
class ThongKeTiepNhan {
    constructor(TongSoTiepNhan = null, TongSoBHYT = null, TongSoDichVu = null, TongSoVienPhi = null, TongSoKSK = null) {
...
class ThongKeKhamBenh {
    constructor(TongSoNguoiKhamBenh = null, TongSoChoKham = null, TongSoDangKham = null, TongSoHoanThanh = null) {
...
class ThongKeGiuongBenh {
    constructor(TongSoGiuongBenh = null, TongSoDaDung = null, TongSoTrong = null) {
...
class ThongKeNoiTru {
    constructor(TongSoNhapVien = null, TongChuyenVien = null, TongSoDieuTri = null, TongSoTuVong = null, TongSoRaVien = null) {
...
class ThongKeSoSinh {
    constructor(TongSoSSThuong = null, TongSoSSBenh = null, TongSoRaVien = null, TongSoChuyenVien = null, TongSoTuVong = null) {
...
let TrangChuComponent = class TrangChuComponent {
    ...
    lamMoi() {
        ...
        this.apiService.post("Home/ThongKeBenhVien", this.thongKeKhamBenhSearch).subscribe(resultData => {
    ...
    handleChartTinhTrangKham(dataTinhtrangKhamBenhs) {
        this.khoaKhams = [];
    ...
    handleChartGiuongBenhVien(dataGiuongBenhViens) {
        this.giuongTheokhoaKhams = [];
    ...
    handleChartDieuTriNoiTru(dataDieuTriNoiTrus) {
        this.khoaNoiTru = [];
