...
let NoiGioiThieuCreateComponent = class NoiGioiThieuCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
NoiGioiThieuCreateComponent.ctorParameters = () => [
...
let NoiGioiThieuListComponent = class NoiGioiThieuListComponent {
    ...
    updateNoiGioiThieu(id, isDisabled) {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("NoiGioiThieu/ExportNoiGioiThieu", this.gridChild._gridQueryInfo).subscribe(res => {
...
NoiGioiThieuListComponent.ctorParameters = () => [
...
let NoiGioiThieuPopupComponent = class NoiGioiThieuPopupComponent {
    ...
    luu() {
        if (this.isCreate) {
            if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Add)) {
                this.addingPage();
                this.apiService.post("NoiGioiThieu/ThemDonViMau", this.donViMau).subscribe(() => {
            ...
            if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Update)) {
                if (this.isDefault) {
                    ...
                    this.savingPage();
                    this.apiService.post("NoiGioiThieu/CapNhatDonViMau", this.donViMau).subscribe(() => {
            ...
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                ...
                if (result === 'Yes') {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Delete)) {
                        this.deletingPage();
                        this.apiService.post("NoiGioiThieu/XoaDonViMau?id=" + id)
                            .subscribe(() => {
...
NoiGioiThieuPopupComponent.ctorParameters = () => [
...
let NoiGioiThieuRoutingModule = class NoiGioiThieuRoutingModule {
};
...
let NoiGioiThieuSharedComponent = class NoiGioiThieuSharedComponent {
    constructor(route, baseService, dialog, notificationService, authService) {
        this.route = route;
...
NoiGioiThieuSharedComponent.ctorParameters = () => [
...
let NoiGioiThieuUpdateComponent = class NoiGioiThieuUpdateComponent {
...
NoiGioiThieuUpdateComponent.ctorParameters = () => [
...
class NoiGioiThieu {
    constructor(Id = 0, Ten = null, SoDienThoai = null, SoDienThoaiDisplay = null, NhanVienQuanLyId = null, HoTenNguoiQuanLy = null, DonVi = null, DonViMauId = null, TenDonViMau = null, IsDisabled = null, MoTa = null) {
        this.Id = Id;
        this.Ten = Ten;
...
let NoiGioiThieuModule = class NoiGioiThieuModule {
};
...
let NoiGioiThieuService = class NoiGioiThieuService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'NoiGioiThieu';
    }
};
NoiGioiThieuService.ctorParameters = () => [
