(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["kham-doan-kham-doan-nhan-su-kham-suc-khoe-kham-doan-nhan-su-kham-suc-khoe-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanNhanSuKhamSucKhoeDetailPopupComponent = /** @class */ (function () {
                function KhamDoanNhanSuKhamSucKhoeDetailPopupComponent(dialog, router, authService, notificationService, apiService, route, cdRef, http) {
                    this.dialog = dialog;
                    this.router = router;
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.ngOnInit = function () {
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.showPopupLoadingData = function () {
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.DisplayContagiousInfo = function (currentEvent) {
                    var _this = this;
                    if (!currentEvent) {
                    ...
                    if (currentEvent) {
                        this.apiService
                            ...
                            _this.khamDoanNhanSuDetail.SoNguoiKham = resultData.SoNguoiKham;
                            _this.khamDoanNhanSuDetail.NgayHieuLuc = resultData.NgayHieuLuc;
                            _this.khamDoanNhanSuDetail.NgayKetThuc = resultData.NgayKetThuc;
                            if (resultData.KhamDoanHopDongDiaDiems && resultData.KhamDoanHopDongDiaDiems.some(function (x) { return x; })) {
                                _this.diaDiemKhamDisplay = true;
                                _this.gridDiaDiemKhamDatasource.data = Array.from(resultData.KhamDoanHopDongDiaDiems);
                                _this.gridDiaDiemKhamDatasource.total = resultData.KhamDoanHopDongDiaDiems.length;
                            }
                        }, function (err) {
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.DisplayNhanVienRelatedInfo = function (currentEvent) {
                    var _this = this;
                    if (!currentEvent) {
                        this.yeuCauNhanSuKhamSucKhoeChiTietCurrent = new _kham_doan_nhan_su_kham_suc_khoe_model__WEBPACK_IMPORTED_MODULE_17__["YeuCauNhanSuKhamSucKhoeChiTiet"]();
                    }
                    if (currentEvent) {
                        this.apiService
                            ...
                            // tslint:disable-next-line: deprecation
                            .subscribe(function (resultData) {
                            _this.yeuCauNhanSuKhamSucKhoeChiTietCurrent.DonVi = resultData.DonVi;
                            _this.yeuCauNhanSuKhamSucKhoeChiTietCurrent.SoDienThoai = resultData.SoDienThoai;
                        }, function (err) {
                            _this.validationErrors = err.ValidationErrors;
                            if (err.Message !== 'Validation Failed') {
                                _this.notificationService.showError(err.Message);
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData) {
                        this.popupLoadingData.close();
                    }
                };
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.getData = function (id) {
                    var _this = this;
                    ...
                    this.apiService
                        ...
                        _this.selection = _this.khamDoanNhanSuDetail.TrangThai === 1 ? 1 : null;
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.getTenTaiLieuDinhKem = function (dataItem) {
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.ShowToControl = function (dataItem) {
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.xuLyThem = function () {
                    var _this = this;
                    this.validateWhenThemNhanSu();
                    if (this.validationErrorsThemNhanSu && this.validationErrorsThemNhanSu.some(function (x) { return x; })) {
                        return;
                    }
                    if (this.operationCommand === _kham_doan_nhan_su_kham_suc_khoe_model__WEBPACK_IMPORTED_MODULE_17__["CommandName"].Update) {
                        var currentIndex_1 = this.gridNhanSuDatasource.data.map(function (x) { return x.Id; }).indexOf(this.yeuCauNhanSuKhamSucKhoeChiTietCurrent.Id);
                        this.gridNhanSuDatasource.data[currentIndex_1] = JSON.parse(JSON.stringify(this.yeuCauNhanSuKhamSucKhoeChiTietCurrent));
                        this.gridNhanSuDatasource.data[currentIndex_1].NguonNhanSu = this.selection;
                        this.gridNhanSuDatasource.data[currentIndex_1].IsCreate =
                            this.gridNhanSuDatasource.data[currentIndex_1].IsCreate === true ? true : null;
                        this.gridNhanSuDatasource.data[currentIndex_1].IsUpdate =
                            this.gridNhanSuDatasource.data[currentIndex_1].IsCreate === true ? null : true;
                        this.gridNhanSuDatasource.data[currentIndex_1].NhanSuKhamSucKhoeTaiLieuDinhKemId =
                            this.gridNhanSuDatasource.data[currentIndex_1].NhanSuKhamSucKhoeTaiLieuDinhKem.some(function (x) { return x; }) ?
                                this.gridNhanSuDatasource.data[currentIndex_1].NhanSuKhamSucKhoeTaiLieuDinhKemId : null;
                        this.gridNhanSuDatasource.data[currentIndex_1].NhanSuKhamSucKhoeTaiLieuDinhKem =
                            this.gridNhanSuDatasource.data[currentIndex_1].NhanSuKhamSucKhoeTaiLieuDinhKem.some(function (x) { return x; }) ?
                                this.gridNhanSuDatasource.data[currentIndex_1].NhanSuKhamSucKhoeTaiLieuDinhKem.reduce(function (a, v) { return a.concat(v); }, []) : [];
                        this.apiService
                            .post('KhamDoan/GetThongTinNhanSuConLai', this.gridNhanSuDatasource.data[currentIndex_1])
                            // tslint:disable-next-line: deprecation
                            .subscribe(function (resultData) {
                            if (resultData.LoaiNhanVien) {
                                _this.khamDoanNhanSuDetail.TongSoBs = _this.gridNhanSuDatasource.data.filter(function (x) { return x.LoaiNhanVien === 1; }).length;
                                _this.khamDoanNhanSuDetail.TongSoDd = _this.gridNhanSuDatasource.data.filter(function (x) { return x.LoaiNhanVien === 2; }).length;
                                _this.khamDoanNhanSuDetail.TongNvKhac = _this.gridNhanSuDatasource.data.filter(function (x) { return x.LoaiNhanVien === 3; }).length;
                            }
                            _this.gridNhanSuDatasource.data[currentIndex_1].DoiTuongLamViecDisplay =
                                resultData.DoiTuongLamViecDisplay;
                            _this.gridNhanSuDatasource.data[currentIndex_1].NguoiGioiThieu =
                                resultData.NguoiGioiThieu;
                            _this.gridNhanSuDatasource.data[currentIndex_1].HoTen =
                                resultData.HoTen;
                            _this.khamDoanNhanSuDetail.YeuCauNhanSuKhamSucKhoeChiTiets
                                = JSON.parse(JSON.stringify(_this.gridNhanSuDatasource.data));
                            _this.gridNhanSu._gridDataSource = JSON.parse(JSON.stringify(_this.gridNhanSuDatasource));
                            _this.gridNhanSu.setDataSource();
                            _this.Reset();
                        }, function (err) {
                            _this.validationErrors = err.ValidationErrors;
                            if (err.Message !== 'Validation Failed') {
                    ...
                    this.yeuCauNhanSuKhamSucKhoeChiTietCurrent.NhanSuKhamSucKhoeTaiLieuDinhKemId =
                        this.yeuCauNhanSuKhamSucKhoeChiTietCurrent.NhanSuKhamSucKhoeTaiLieuDinhKem.some(function (x) { return x; }) ? 0 : null;
                    this.yeuCauNhanSuKhamSucKhoeChiTietCurrent.NhanSuKhamSucKhoeTaiLieuDinhKem =
                        this.yeuCauNhanSuKhamSucKhoeChiTietCurrent.NhanSuKhamSucKhoeTaiLieuDinhKem.some(function (x) { return x; }) ?
                            this.yeuCauNhanSuKhamSucKhoeChiTietCurrent.NhanSuKhamSucKhoeTaiLieuDinhKem.reduce(function (a, v) { return a.concat(v); }, []) : [];
                    ...
                    this.apiService
                        ...
                        _this.gridNhanSuDatasource.data[_this.gridNhanSuDatasource.data.length - 1].DoiTuongLamViecDisplay =
                            resultData.DoiTuongLamViecDisplay;
                        _this.gridNhanSuDatasource.data[_this.gridNhanSuDatasource.data.length - 1].NguoiGioiThieu =
                            resultData.NguoiGioiThieu;
                        _this.gridNhanSuDatasource.data[_this.gridNhanSuDatasource.data.length - 1].HoTen =
                            resultData.HoTen;
                        _this.khamDoanNhanSuDetail.YeuCauNhanSuKhamSucKhoeChiTiets
                            = JSON.parse(JSON.stringify(_this.gridNhanSuDatasource.data));
                        _this.gridNhanSu._gridDataSource = JSON.parse(JSON.stringify(_this.gridNhanSuDatasource));
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.validateWhenThemNhanSu = function () {
                    this.validationErrorsThemNhanSu = [];
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.validateWhenYeuCauNhanSu = function () {
                    this.validationErrors = [];
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.GuiYeuCauNhanSu = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                            ...
                            if (result == 'Yes') {
                                _this.apiService
                                    .post('KhamDoan/ThemYeuCauNhanSu', _this.khamDoanNhanSuDetail)
                                    // tslint:disable-next-line: deprecation
                                    .subscribe(function () {
                                    _this.notificationService.showSuccess(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_15__["YeuCauNhanSuMessage"].MessageXnThanhCong);
                                    _this.router.navigate(['/kham-doan/nhan-su-kham'], {
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.Save = function () {
                    var _this = this;
                    this.validateWhenYeuCauNhanSu();
                    if (this.validationErrors && this.validationErrors.some(function (x) { return x; })) {
                        return;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                            ...
                            if (result == 'Yes') {
                                _this.apiService
                                    .post('KhamDoan/UpdateYeuCauNhanSu', _this.khamDoanNhanSuDetail)
                                    // tslint:disable-next-line: deprecation
                                    .subscribe(function () {
                                    _this.notificationService.showSuccess(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_15__["YeuCauNhanSuMessage"].MessageCapNhatThanhCong);
                                    _this.router.navigate(['/kham-doan/nhan-su-kham'], {
                                        queryParamsHandling: 'preserve',
                                    });
                                    return;
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.Reset = function (currentEvent) {
                ...
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.uploadFileDone = function (event) {
                    this.fileTaiLieu = event;
                    this.cdRef.detectChanges();
                };
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.delete = function (dataItem) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                        disableClose: false,
                        width: '500px',
                        ...
                        if (res === 'Yes') {
                            if (dataItem.IsCreate !== true) {
                                _this.khamDoanNhanSuDetail.NhanSuBiLoaiBo.push(dataItem.Id);
                            }
                            _this.gridNhanSuDatasource.data.splice(_this.gridNhanSuDatasource.data.indexOf(dataItem), 1);
                            _this.gridNhanSu._gridDataSource = JSON.parse(JSON.stringify(_this.gridNhanSuDatasource));
                            _this.gridNhanSu.setDataSource();
                        }
                    });
                };
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.quayLai = function () {
                    this.router.navigateByUrl('/kham-doan/nhan-su-kham?holdQuery=true');
                };
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.viewFile = function (dataItem) {
                    var _this = this;
                    //console.log(file);
                    ...
                    var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_18__["HttpParams"]({
                        fromObject: {
                            ...
                            if (file.validationErrors == null || file.validationErrors.length <= 0) {
                                if (file.LoaiTapTin == 2) {
                                    ...
                                    if (file.LoaiTapTin == 1) {
                                        ...
                                        _this.downloadFile(resp, file.name);
                                ...
                                _this.notificationService.showError("Tải file bị lỗi: " + file.error);
                            }
                        }
                    });
                };
                KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.prototype.downloadFile = function (url, fileName) {
                    var options = new _angular_http__WEBPACK_IMPORTED_MODULE_19__["RequestOptions"]({ responseType: _angular_http__WEBPACK_IMPORTED_MODULE_19__["ResponseContentType"].Blob });
                ...
                return KhamDoanNhanSuKhamSucKhoeDetailPopupComponent;
            }());
            KhamDoanNhanSuKhamSucKhoeDetailPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanNhanSuKhamSucKhoeListComponent = /** @class */ (function () {
                function KhamDoanNhanSuKhamSucKhoeListComponent(authService, notificationService, route, location, dialog, apiService, router) {
                    this.authService = authService;
                    this.notificationService = notificationService;
                    this.route = route;
                ...
                KhamDoanNhanSuKhamSucKhoeListComponent.prototype.ngOnInit = function () {
                    ...
                    if (holdQuery && src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_15__["LocalStorageHelper"].getItem('additionalSearchStringDanhSachYeuCauNhanSuKhamSucKhoe')) {
                        var additionalSearchString = src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_15__["LocalStorageHelper"].getItem('additionalSearchStringDanhSachYeuCauNhanSuKhamSucKhoe');
                ...
                KhamDoanNhanSuKhamSucKhoeListComponent.prototype.searchChanges = function (event) {
                    if ((event == null || event == '') && this.strAdditionalSearchString != '') {
                        this.timKiemNangCao();
                    }
                };
                KhamDoanNhanSuKhamSucKhoeListComponent.prototype.onKey = function (event) {
                    if (event.key == 'Enter') {
                        this.timKiemNangCao();
                    }
                };
                KhamDoanNhanSuKhamSucKhoeListComponent.prototype.clearSearch = function () {
                    this.timKiemObj.SearchString = null;
                    this.gridChild.searchString = null;
                    this.timKiemNangCao();
                };
                KhamDoanNhanSuKhamSucKhoeListComponent.prototype.timKiemNangCao = function () {
                ...
                KhamDoanNhanSuKhamSucKhoeListComponent.prototype.xuLyXuatExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel('KhamDoan/ExportDanhSachYeuCauNhanSuKhamSucKhoe', this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                KhamDoanNhanSuKhamSucKhoeListComponent.prototype.xemChiTiet = function (id) {
                ...
                KhamDoanNhanSuKhamSucKhoeListComponent.prototype.xoa = function (Id) {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Delete)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_21__["ConfirmComponent"], {
                            ...
                            if (result == 'Yes') {
                                _this.apiService.delete('KhamDoan/XuLyXoaYeuCauNhanSuKhamSucKhoe?id=' + Id).subscribe(function (res) {
                                    _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_20__["SystemMessage"].ActionSuccessfully, ['Xóa']));
                ...
                return KhamDoanNhanSuKhamSucKhoeListComponent;
            }());
            KhamDoanNhanSuKhamSucKhoeListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanNhanSuKhamSucKhoeRoutingModule = /** @class */ (function () {
                function KhamDoanNhanSuKhamSucKhoeRoutingModule() {
                }
                return KhamDoanNhanSuKhamSucKhoeRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var KhamDoanNhanSuKhamSucKhoeTimKiem = /** @class */ (function () {
                function KhamDoanNhanSuKhamSucKhoeTimKiem(SearchString, TrangThai, NgayGui, NgayKHTHDuyet, NgayNhanSuDuyet, NgayGiamDocDuyet) {
                    if (SearchString === void 0) { SearchString = null; }
                    if (TrangThai === void 0) { TrangThai = new KhamDoanNhanSuKhamSucKhoeTimKiemTrangThai(); }
                    if (NgayGui === void 0) { NgayGui = new KhamDoanNhanSuKhamSucKhoeTimKiemDateRange(); }
                    if (NgayKHTHDuyet === void 0) { NgayKHTHDuyet = new KhamDoanNhanSuKhamSucKhoeTimKiemDateRange(); }
                    if (NgayNhanSuDuyet === void 0) { NgayNhanSuDuyet = new KhamDoanNhanSuKhamSucKhoeTimKiemDateRange(); }
                    if (NgayGiamDocDuyet === void 0) { NgayGiamDocDuyet = new KhamDoanNhanSuKhamSucKhoeTimKiemDateRange(); }
                ...
                return KhamDoanNhanSuKhamSucKhoeTimKiem;
            }());
            var KhamDoanNhanSuKhamSucKhoeTimKiemTrangThai = /** @class */ (function () {
                function KhamDoanNhanSuKhamSucKhoeTimKiemTrangThai(ChoDuyet, DaDuyet, TuChoi) {
            ...
            var YeuCauNhanSuKhamSucKhoeDetail = /** @class */ (function () {
                function YeuCauNhanSuKhamSucKhoeDetail(Id, HopDongKhamSucKhoeId, CongTyId, CongTy, SoNguoiKham, NgayHieuLuc, NgayHieuLucDisplay, NgayKetThuc, NgayKetThucDisplay, TongSoBs, TongSoDd, TongNvKhac, NhanVienGuiYeuCauId, NhanVienGui, NgayGuiYeuCau, DuocKHTHDuyet, NgayKHTHDuyet, NgayKhthDuyetDisplay, NhanVienKHTHDuyetId, NhanVienKhthDuyet, LyDoKHTHKhongDuyet, DuocNhanSuDuyet, NgayNhanSuDuyet, NgayNhanSuDuyetDisplay, NhanVienNhanSuDuyetId, NhanVienNhanSuDuyet, LyDoNhanSuKhongDuyet, DuocGiamDocDuyet, NgayGiamDocDuyet, NgayGiamDocDuyetDisplay, GiamDocId, GiamDoc, LyDoGiamDocKhongDuyet, TrangThai, TenTinhTrang, YeuCauNhanSuKhamSucKhoeChiTiets, NhanSuBiLoaiBo, IsDuyet) {
                    ...
                    if (NhanSuBiLoaiBo === void 0) { NhanSuBiLoaiBo = []; }
                    if (IsDuyet === void 0) { IsDuyet = null; }
                    this.Id = Id;
            ...
            var HopDongKhamSucKhoeDiaDiem = /** @class */ (function () {
                function HopDongKhamSucKhoeDiaDiem(Id, DiaDiem, CongViec, Ngay, NgayDisplay, GhiChu) {
                    if (Id === void 0) { Id = null; }
                    if (DiaDiem === void 0) { DiaDiem = null; }
                    if (CongViec === void 0) { CongViec = null; }
                    if (Ngay === void 0) { Ngay = null; }
                    if (NgayDisplay === void 0) { NgayDisplay = null; }
                ...
                return HopDongKhamSucKhoeDiaDiem;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanNhanSuKhamSucKhoeModule = /** @class */ (function () {
                function KhamDoanNhanSuKhamSucKhoeModule() {
                }
                return KhamDoanNhanSuKhamSucKhoeModule;
            }());
...
//# sourceMappingURL=kham-doan-kham-doan-nhan-su-kham-suc-khoe-kham-doan-nhan-su-kham-suc-khoe-module-es5.js.map
//# sourceMappingURL=kham-doan-kham-doan-nhan-su-kham-suc-khoe-kham-doan-nhan-su-kham-suc-khoe-module-es5.js.map