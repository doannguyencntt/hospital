(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dieu-tri-noi-tru-luu-tru-ho-so-luu-tru-ho-so-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LuuTruHoSoListComponent = /** @class */ (function () {
                function LuuTruHoSoListComponent(dialog, apiService, authService, notificationService) {
                    this.dialog = dialog;
                ...
                LuuTruHoSoListComponent.prototype.ngOnInit = function () {
                ...
                LuuTruHoSoListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                LuuTruHoSoListComponent.prototype.clearSearch = function () {
                    this.luuTruHoSo.SearchString = null;
                    this.gridChild.search();
                };
                LuuTruHoSoListComponent.prototype.searchChanges = function (event) {
                    var self = this;
                ...
                LuuTruHoSoListComponent.prototype.trangThaiCheckBox = function (event, tinhTrang) {
                ...
                LuuTruHoSoListComponent.prototype.timKiem = function () {
                    var queryString = JSON.stringify(this.luuTruHoSo);
                    this.gridChild._additionalSearchString = queryString;
                    this.gridChild.search();
                };
                LuuTruHoSoListComponent.prototype.chinhSua = function (id) {
                    var self = this;
                ...
                LuuTruHoSoListComponent.prototype.XuatExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("DieuTriNoiTru/ExportLuuTruBenhAn", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                LuuTruHoSoListComponent.prototype.changTuNgay = function (event) {
                    if (event != null) {
                ...
                LuuTruHoSoListComponent.prototype.changDenNgay = function (event) {
                    if (event != null) {
                ...
                LuuTruHoSoListComponent.prototype.changeKhoaPhong = function (event) {
                    this.timKiem();
                };
                return LuuTruHoSoListComponent;
            }());
            LuuTruHoSoListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LuuTruHoSoRoutingModule = /** @class */ (function () {
                function LuuTruHoSoRoutingModule() {
                }
                return LuuTruHoSoRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LuuTruHoSoUpdatePopupComponent = /** @class */ (function () {
                function LuuTruHoSoUpdatePopupComponent(ref, notificationService, apiService, dialog, cdRef, data, dialogRef) {
                    this.ref = ref;
                    this.notificationService = notificationService;
                    this.apiService = apiService;
                    this.dialog = dialog;
                ...
                LuuTruHoSoUpdatePopupComponent.prototype.ngOnInit = function () {
                    this.thongLuuTruHoSo = new _luu_tru_ho_so_model__WEBPACK_IMPORTED_MODULE_10__["ThongLuuTruHoSo"]();
                    this.getById(this.data);
                };
                LuuTruHoSoUpdatePopupComponent.prototype.getById = function (id) {
                    var _this = this;
                    var self = this;
                    self.apiService.get("DieuTriNoiTru/GetThongTiLuuTruBenhAnNoiTru?id=" + id).subscribe(function (result) {
                        if (result != undefined && result != null) {
                            _this.thongLuuTruHoSo = result;
                            if (_this.thongLuuTruHoSo.ThuTuSapXepLuuTru == null || _this.thongLuuTruHoSo.ThuTuSapXepLuuTru == '') {
                ...
                LuuTruHoSoUpdatePopupComponent.prototype.thuTuSapXepLuuTruChange = function (dataItem) {
                ...
                LuuTruHoSoUpdatePopupComponent.prototype.savingPage = function () {
                ...
                LuuTruHoSoUpdatePopupComponent.prototype.closepopupSavingData = function () {
                    if (this.popupSavingData != undefined && this.popupSavingData != null) {
                        this.popupSavingData.close();
                    }
                };
                LuuTruHoSoUpdatePopupComponent.prototype.luu = function () {
                    var _this = this;
                    ...
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmComponent"], {
                        ...
                        if (result == "Yes") {
                            _this.apiService.post("DieuTriNoiTru/CapNhatLuuTruBenhAn", valudObj).subscribe(function () {
                                _this.closepopupSavingData();
                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_6__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_8__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                ...
                return LuuTruHoSoUpdatePopupComponent;
            }());
            LuuTruHoSoUpdatePopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var LuuTruHoSo = /** @class */ (function () {
                function LuuTruHoSo(MaTN, SoBA, MaBN, HoTen, KhoaNhapVien, ChuaSapXep, DaSapXep, ThuTuSapXepLuuTru, SearchString, TuNgay, DenNgay, TuNgayText, DenNgaytext, KhoaPhongId, CheckBHYT, CheckVienPhi) {
                    if (MaTN === void 0) { MaTN = null; }
                    if (SoBA === void 0) { SoBA = null; }
                    if (MaBN === void 0) { MaBN = null; }
                    if (HoTen === void 0) { HoTen = null; }
                    if (KhoaNhapVien === void 0) { KhoaNhapVien = null; }
                    if (ChuaSapXep === void 0) { ChuaSapXep = true; }
                    if (DaSapXep === void 0) { DaSapXep = true; }
                    if (ThuTuSapXepLuuTru === void 0) { ThuTuSapXepLuuTru = null; }
                    if (SearchString === void 0) { SearchString = null; }
                    if (TuNgay === void 0) { TuNgay = null; }
                    if (DenNgay === void 0) { DenNgay = null; }
                    if (TuNgayText === void 0) { TuNgayText = null; }
                    if (DenNgaytext === void 0) { DenNgaytext = null; }
                    if (KhoaPhongId === void 0) { KhoaPhongId = 0; }
                    if (CheckBHYT === void 0) { CheckBHYT = true; }
                    if (CheckVienPhi === void 0) { CheckVienPhi = true; }
                    this.MaTN = MaTN;
                    this.SoBA = SoBA;
                    this.MaBN = MaBN;
                    this.HoTen = HoTen;
            ...
            var ThongLuuTruHoSo = /** @class */ (function () {
                function ThongLuuTruHoSo(MaTN, SoBA, MaBN, HoTen, Tuoi, GioiTinh, GioiTinhDisplay, DiaChi, NgheNghiep, SoBenhAn, LoaiBenhAn, KhoaNhapVien, DoiTuong, NhanVienThucHien, NgayThucHien, ThuTuSapXepLuuTru, TrangThaiSapXep, Khoa, SoLuuTru, 
                //BVHD-3800
                LaCapCuu) {
                    if (MaTN === void 0) { MaTN = null; }
                    if (SoBA === void 0) { SoBA = null; }
                    ...
                    if (NhanVienThucHien === void 0) { NhanVienThucHien = null; }
                    if (NgayThucHien === void 0) { NgayThucHien = null; }
                    if (ThuTuSapXepLuuTru === void 0) { ThuTuSapXepLuuTru = null; }
                    if (TrangThaiSapXep === void 0) { TrangThaiSapXep = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LuuTruHoSoModule = /** @class */ (function () {
                function LuuTruHoSoModule() {
                }
                return LuuTruHoSoModule;
            }());
...
//# sourceMappingURL=dieu-tri-noi-tru-luu-tru-ho-so-luu-tru-ho-so-module-es5.js.map
//# sourceMappingURL=dieu-tri-noi-tru-luu-tru-ho-so-luu-tru-ho-so-module-es5.js.map