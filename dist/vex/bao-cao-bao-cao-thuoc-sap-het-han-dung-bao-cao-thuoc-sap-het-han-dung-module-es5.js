(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-thuoc-sap-het-han-dung-bao-cao-thuoc-sap-het-han-dung-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThuocSapHetHanDungListComponent = /** @class */ (function () {
                function BaoCaoThuocSapHetHanDungListComponent(apiService, dialog, notificationService, authService) {
                ...
                BaoCaoThuocSapHetHanDungListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoThuocSapHetHanDungListComponent.prototype.totalThanhTien = function () {
                ...
                BaoCaoThuocSapHetHanDungListComponent.prototype.seachChange = function (event) {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoThuocSapHetHanDungListComponent.prototype.pageChange = function (event) {
                    this.skip = event;
                    this.XemBaoCao();
                };
                BaoCaoThuocSapHetHanDungListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/GetDataBaoCaoThuocSapHetHanForGridAsync", this.baoCaoSearch).subscribe(function (resultData) {
                ...
                BaoCaoThuocSapHetHanDungListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                ...
                return BaoCaoThuocSapHetHanDungListComponent;
            }());
            BaoCaoThuocSapHetHanDungListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThuocSapHetHanDungRoutingModule = /** @class */ (function () {
                function BaoCaoThuocSapHetHanDungRoutingModule() {
                }
                return BaoCaoThuocSapHetHanDungRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var BaoCaoThuocSapHetHanSearch = /** @class */ (function () {
                function BaoCaoThuocSapHetHanSearch(FromDate, ToDate, TuNgayFormat, DenNgayFormat, KhoId, Skip, Take, PageSize, SearchString, AdditionalSearchString, Sort) {
                ...
                return BaoCaoThuocSapHetHanSearch;
            }());
            var InBaoCaoThuocSapHetHan = /** @class */ (function () {
                function InBaoCaoThuocSapHetHan(KhoId, HostingName, FromDate, ToDate) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoThuocSapHetHanDungModule = /** @class */ (function () {
                function BaoCaoThuocSapHetHanDungModule() {
                }
                return BaoCaoThuocSapHetHanDungModule;
            }());
...
//# sourceMappingURL=bao-cao-bao-cao-thuoc-sap-het-han-dung-bao-cao-thuoc-sap-het-han-dung-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-thuoc-sap-het-han-dung-bao-cao-thuoc-sap-het-han-dung-module-es5.js.map