...
let DsVatTuKSNKTrungNccPopupComponent = class DsVatTuKSNKTrungNccPopupComponent {
...
DsVatTuKSNKTrungNccPopupComponent.ctorParameters = () => [
...
let NhapKhoKSNKCreateComponent = class NhapKhoKSNKCreateComponent {
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
            ...
            if (res == "Yes") {
                ...
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_5__["SecurityOperation"].Add)) {
                    self.loadingPage();
                    self.apiService.post("NhapKhoVatTuKSNK/ThemYeuCauNhapKhoVatTu", self.nhapKhoVatTu).subscribe((result) => {
                            ...
                            if (result.length > 0) {
                                ...
                                self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                                    ...
                                    if (res == "Yes") {
                                        ...
                                        this.router.navigate(['/nhap-xuat/ksnk/nhap-kho']);
                                    }
                                });
                            }
                        }
...
NhapKhoKSNKCreateComponent.ctorParameters = () => [
...
let NhapKhoKSNKListComponent = class NhapKhoKSNKListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            ...
            self.apiService.postExportExcel('NhapKhoVatTuKSNK/ExportNhapKhoKSNK', self.gridChild._gridQueryInfo).subscribe(resultData => {
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmComponent"], {
            ...
            if (res == "Yes") {
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Delete)) {
                    this.apiService.post("NhapKhoVatTuKSNK/XoaYeuCauNhapKhoVatTu?id=" + id).subscribe(() => {
...
NhapKhoKSNKListComponent.ctorParameters = () => [
...
let NhapKhoKSNKRoutingModule = class NhapKhoKSNKRoutingModule {
};
...
let NhapKhoKSNKShareComponent = class NhapKhoKSNKShareComponent {
    ...
    ngOnInit() {
        ...
        this.nhapKhoSource = new _nhap_kho_ksnk__WEBPACK_IMPORTED_MODULE_2__["NhapKhoVatTu"]();
        this.nhapKhoChiTietSource = new _nhap_kho_ksnk__WEBPACK_IMPORTED_MODULE_2__["NhapKhoVatTuChiTiet"]();
        let nhapKhoChiTietDataSource = new _nhap_kho_ksnk__WEBPACK_IMPORTED_MODULE_2__["NhapKhoVatTuChiTiet"]();
    ...
    getById(id) {
        ...
        self.apiService.post("NhapKhoVatTuKSNK/GetGrid?id=" + id).subscribe(resultDataGrid => {
    ...
    getKhoVatTuYTe() {
        this.apiService.get("NhapKhoVatTuKSNK/GetKhoVatTuYTe").subscribe(result => {
    ...
    UpdateRow() {
        ...
        this.rowIndex = this.nhapKhoSource.NhapKhoVatTuChiTiets.findIndex((x) => x.IdView == this.nhapKhoChiTiet.IdView);
        ...
        if (self.validationErrors && !self.validationErrors.some(x => x)) {
            self.apiService.post("NhapKhoVatTu/ThemVatTuNhapKho", nhapKhoChiTietDataSource).subscribe(resultData => {
                // update
            ...
            if (result == "Yes") {
                this.nhapKhoSource.NhapKhoVatTuChiTiets.forEach((value, index) => {
                    if (IdView == value.IdView) {
                        ...
                        this.setDataGridView(this.nhapKhoSource.NhapKhoVatTuChiTiets);
                        this.Huy();
                        this.notificationService.showSuccess(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_15__["NhapXuatKhoMessage"].MessageRemoveItemGrid);
                    }
                });
            }
        });
    ...
    onChangeVatTu(event) {
        if (event !== null && event !== undefined) {
            ...
            //suggest nhom
            let self = this;
            this.apiService.post("NhapKhoVatTuKSNK/SuggestLoaiSuDung?id=" + event.KeyId).subscribe(resultData => {
                if (resultData != null && resultData != undefined) {
...
NhapKhoKSNKShareComponent.ctorParameters = () => [
...
let NhapKhoKSNKTuChoiDuyetComponent = class NhapKhoKSNKTuChoiDuyetComponent {
    ...
    luu() {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
            ...
            self.loading = true;
            self.nhapKhoVatTu = self.shared.getSharedData();
            self.apiService.post("NhapKhoVatTuKSNK/CapNhatYeuCauNhapKhoVatTu", self.nhapKhoVatTu).subscribe(resultData => {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Update)) {
            ...
            self.apiService.post("NhapKhoVatTuKSNK/CapNhatYeuCauNhapKhoVatTu", self.nhapKhoVatTu).subscribe(resultData => {
                ...
                self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_15__["ConfirmComponent"], {
                    ...
                    if (result == "Yes") {
                        self.apiService.post("NhapKhoVatTuKSNK/GoiDuyetLai?id=" + self.id).subscribe(result => {
                            //self.router.navigate(['nhap-xuat/vat-tu-ksnk/nhap-kho']);
                            self.router.navigateByUrl('nhap-xuat/ksnk/nhap-kho?holdQuery=true');
...
NhapKhoKSNKTuChoiDuyetComponent.ctorParameters = () => [
...
let NhapKhoKSNKTuDaDuyetComponent = class NhapKhoKSNKTuDaDuyetComponent {
...
NhapKhoKSNKTuDaDuyetComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"] },
...
let NhapKhoKSNKUpdateComponent = class NhapKhoKSNKUpdateComponent {
    constructor(apiService, dialog, notificationService, authService, router, ref, location) {
        this.apiService = apiService;
        this.dialog = dialog;
        this.notificationService = notificationService;
        ...
        self.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
            ...
            if (res == "Yes") {
                ...
                if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_15__["SecurityOperation"].Update)) {
                    self.loadingPage();
                    self.apiService.post("NhapKhoVatTuKSNK/CapNhatYeuCauNhapKhoVatTu", self.nhapKhoVatTu).subscribe((result) => {
                        if (result != undefined && result != null) {
                            if (result.length > 0) {
...
NhapKhoKSNKUpdateComponent.ctorParameters = () => [
...
let NhapKhoKSNKModule = class NhapKhoKSNKModule {
};
...
let NhapKhoKSNKService = class NhapKhoKSNKService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'NhapKhoVatTuKSNK';
    }
};
NhapKhoKSNKService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
...
class NhapKhoVatTuSearch {
    constructor(DangChoDuyet = true, TuChoiDuyet = false, DaDuyet = false, SearchString = null, RangeNhap = new rangeDate, RangeDuyet = new rangeDate) {
...
class LookupItemViTriVo {
    constructor(KeyId, DisplayName, KhoVatTuId) {
        this.KeyId = KeyId;
...
class NhapKhoVatTu {
    constructor(Id = 0, SoChungTu = null, NgayDuyet = null, NhanVienDuyetId = null, 
    ...
    LoaiNguoiGiao = 1, NhapKhoVatTuChiTiets = [], OldNhapKhoVatTuChiTiets = [], NgayNhap = new Date(), NgayHoaDon = new Date(), DaXuatKho = null, LyDoKhongDuyet = null, DuocKeToanDuyet = null, KyHieuHoaDon = null, KhoVatTuYTeId = null, KhoVatTuYTeDisplayName = null) {
        this.Id = Id;
...
class NhapKhoVatTuChiTiet {
    ...
    TiLeBHYTThanhToan = null, Id = 0, IdView = Math.random(), HopDongThauVatTuId = null, VatTuBenhVienId = null, LaVatTuBHYT = false, 
    //public DuocPhamBenhVienPhanNhomId: number = null,
    Solo = null, HanSuDung = null, MaVach = null, SoLuongNhapSoCap = null, SoLuongNhap = null, HeSoDinhMucDonViTinh = null, GiaApThau = null, DonGiaNhap = null, VAT = 0, KhoViTriId = null, LoaiNhap = 1, // 1 là hdt, 2 là ncc
    NhaThauId = null, NhaThauDisplay = null, DVT = null, LoaiSuDung = null, 
    //for grid
    HopDongThauDisplay = null, VatTuDisplay = null, LoaiDisplay = null, NhomDisplay = null, HanSuDungDisplay = null, SoLuongNhapDisplay = null, ViTriDisplay = null, MaRef = null, KhoNhapSauKhiDuyetId = null, KhoNhapSauKhiDuyetDisplayName = null, NguoiNhapSauKhiDuyetId = null, ThanhTienTruocVat = 0, ThanhTienSauVat = 0, ThueVatLamTron = 0, GhiChu = null) {
...
class InPhieuNhapKhoVatTu {
    constructor(YeuCauNhapKhoVatTuId = null, CoTheoBenhVien = true, CoTheoThongTu = true, HostingName = null) {
...
let PhieuNhapKhoVatTuKSNKPopupComponent = class PhieuNhapKhoVatTuKSNKPopupComponent {
...
PhieuNhapKhoVatTuKSNKPopupComponent.ctorParameters = () => [
...
let XacNhanChonPhieuInVatTuKSNKPopupComponent = class XacNhanChonPhieuInVatTuKSNKPopupComponent {
    constructor(dialog, apiService, notificationService, data) {
        this.dialog = dialog;
        this.apiService = apiService;
        this.notificationService = notificationService;
        this.data = data;
    ...
    inPhieu() {
        var self = this;
        self.loadingPage();
        self.apiService.post("NhapKhoVatTuKSNK/InPhieuYeuCauNhapKhoVatTu", self.inPhieuNhapKhoVatTu).subscribe(resData => {
...
XacNhanChonPhieuInVatTuKSNKPopupComponent.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
