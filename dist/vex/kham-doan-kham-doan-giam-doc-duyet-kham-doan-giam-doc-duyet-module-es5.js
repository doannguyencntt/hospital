(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["kham-doan-kham-doan-giam-doc-duyet-kham-doan-giam-doc-duyet-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanGiamDocDuyetDetailPopupComponent = /** @class */ (function () {
                function KhamDoanGiamDocDuyetDetailPopupComponent(authService, dialog, notificationService, apiService, router, route) {
                ...
                KhamDoanGiamDocDuyetDetailPopupComponent.prototype.ngOnInit = function () {
                ...
                KhamDoanGiamDocDuyetDetailPopupComponent.prototype.showPopupLoadingData = function () {
                ...
                KhamDoanGiamDocDuyetDetailPopupComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData) {
                        this.popupLoadingData.close();
                    }
                };
                KhamDoanGiamDocDuyetDetailPopupComponent.prototype.getData = function (id) {
                    var _this = this;
                ...
                KhamDoanGiamDocDuyetDetailPopupComponent.prototype.xuLyDuyet = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmComponent"], {
                            ...
                            if (result === 'Yes') {
                                _this.apiService
                                    .get("KhamDoan/DuyetGiamDoc?id=" + _this.id)
                                    // tslint:disable-next-line: deprecation
                                    .subscribe(function () {
                ...
                KhamDoanGiamDocDuyetDetailPopupComponent.prototype.xuLyTuChoi = function () {
                    var _this = this;
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
                ...
                KhamDoanGiamDocDuyetDetailPopupComponent.prototype.getTenTaiLieuDinhKem = function (dataItem) {
                ...
                KhamDoanGiamDocDuyetDetailPopupComponent.prototype.quayLai = function () {
                    this.router.navigateByUrl('/kham-doan/giam-doc-duyet?holdQuery=true');
                };
                return KhamDoanGiamDocDuyetDetailPopupComponent;
            }());
            KhamDoanGiamDocDuyetDetailPopupComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanGiamDocDuyetListComponent = /** @class */ (function () {
                function KhamDoanGiamDocDuyetListComponent(authService, notificationService, route, location, dialog, apiService, router) {
                    this.authService = authService;
                    this.notificationService = notificationService;
                    this.route = route;
                ...
                KhamDoanGiamDocDuyetListComponent.prototype.ngOnInit = function () {
                    ...
                    if (holdQuery && src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_14__["LocalStorageHelper"].getItem('additionalSearchStringDanhSachGiamDocDuyetYeuCauNhanSuKhamSucKhoe')) {
                        var additionalSearchString = src_app_core_utilities_local_storage_helper__WEBPACK_IMPORTED_MODULE_14__["LocalStorageHelper"].getItem('additionalSearchStringDanhSachGiamDocDuyetYeuCauNhanSuKhamSucKhoe');
                ...
                KhamDoanGiamDocDuyetListComponent.prototype.searchChanges = function (event) {
                    if ((event == null || event == '') && this.strAdditionalSearchString != '') {
                        this.timKiemNangCao();
                    }
                };
                KhamDoanGiamDocDuyetListComponent.prototype.onKey = function (event) {
                    if (event.key == 'Enter') {
                        this.timKiemNangCao();
                    }
                };
                KhamDoanGiamDocDuyetListComponent.prototype.clearSearch = function () {
                    this.timKiemObj.SearchString = null;
                    this.gridChild.searchString = null;
                    this.timKiemNangCao();
                };
                KhamDoanGiamDocDuyetListComponent.prototype.timKiemNangCao = function () {
                ...
                KhamDoanGiamDocDuyetListComponent.prototype.xuLyXuatExcel = function () {
                    var _this = this;
                ...
                KhamDoanGiamDocDuyetListComponent.prototype.xemChiTiet = function (id) {
                ...
                return KhamDoanGiamDocDuyetListComponent;
            }());
            KhamDoanGiamDocDuyetListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanGiamDocDuyetRoutingModule = /** @class */ (function () {
                function KhamDoanGiamDocDuyetRoutingModule() {
                }
                return KhamDoanGiamDocDuyetRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var KhamDoanGiamDocDuyetTimKiem = /** @class */ (function () {
                function KhamDoanGiamDocDuyetTimKiem(SearchString, TrangThai, NgayGui, NgayKHTHDuyet, NgayNhanSuDuyet, NgayGiamDocDuyet) {
                    if (SearchString === void 0) { SearchString = null; }
                    if (TrangThai === void 0) { TrangThai = new KhamDoanGiamDocDuyetTimKiemTrangThai(); }
                    if (NgayGui === void 0) { NgayGui = new KhamDoanGiamDocDuyetTimKiemDateRange(); }
                    if (NgayKHTHDuyet === void 0) { NgayKHTHDuyet = new KhamDoanGiamDocDuyetTimKiemDateRange(); }
                    if (NgayNhanSuDuyet === void 0) { NgayNhanSuDuyet = new KhamDoanGiamDocDuyetTimKiemDateRange(); }
                    if (NgayGiamDocDuyet === void 0) { NgayGiamDocDuyet = new KhamDoanGiamDocDuyetTimKiemDateRange(); }
                ...
                return KhamDoanGiamDocDuyetTimKiem;
            }());
            var KhamDoanGiamDocDuyetTimKiemTrangThai = /** @class */ (function () {
                function KhamDoanGiamDocDuyetTimKiemTrangThai(ChoDuyet, DaDuyet, TuChoi) {
                ...
                return KhamDoanGiamDocDuyetTimKiemTrangThai;
            }());
            var KhamDoanGiamDocDuyetTimKiemDateRange = /** @class */ (function () {
                function KhamDoanGiamDocDuyetTimKiemDateRange(startDate, endDate, TuNgay, DenNgay) {
                ...
                return KhamDoanGiamDocDuyetTimKiemDateRange;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KhamDoanGiamDocDuyetModule = /** @class */ (function () {
                function KhamDoanGiamDocDuyetModule() {
                }
                return KhamDoanGiamDocDuyetModule;
            }());
...
//# sourceMappingURL=kham-doan-kham-doan-giam-doc-duyet-kham-doan-giam-doc-duyet-module-es5.js.map
//# sourceMappingURL=kham-doan-kham-doan-giam-doc-duyet-kham-doan-giam-doc-duyet-module-es5.js.map