...
let MauVaChePhamCreateComponent = class MauVaChePhamCreateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
MauVaChePhamCreateComponent.ctorParameters = () => [
...
let MauVaChePhamListComponent = class MauVaChePhamListComponent {
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_7__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('MauVaChePham/ExportMauVaChePham', self.gridMauVaChePham._gridQueryInfo).subscribe(resultData => {
...
MauVaChePhamListComponent.ctorParameters = () => [
...
let MauVaChePhamRoutingModule = class MauVaChePhamRoutingModule {
};
...
let MauVaChePhamSharedComponent = class MauVaChePhamSharedComponent {
...
MauVaChePhamSharedComponent.ctorParameters = () => [
...
let MauVaChePhamUpdateComponent = class MauVaChePhamUpdateComponent {
...
MauVaChePhamUpdateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let MauVaChePhamModule = class MauVaChePhamModule {
};
...
let MauVaChePhamService = class MauVaChePhamService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'MauVaChePham';
    }
};
MauVaChePhamService.ctorParameters = () => [
