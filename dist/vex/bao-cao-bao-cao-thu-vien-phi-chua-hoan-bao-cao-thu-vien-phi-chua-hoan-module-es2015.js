...
let BaoCaoThuVienPhiChuaHoanListComponent = class BaoCaoThuVienPhiChuaHoanListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
            ...
            let tuNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].formatDateTime(this.baoCaoSearch.TuNgayFormat, "mm/dd/yyyy");
            let denNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].formatDateTime(this.baoCaoSearch.DenNgayFormat, "mm/dd/yyyy");
    ...
    getTongCong(queryInfo) {
        this.apiService.post("BaoCao/GetTongCongThuVienPhiChuaHoan", queryInfo).subscribe(resultData => {
...
BaoCaoThuVienPhiChuaHoanListComponent.ctorParameters = () => [
...
let BaoCaoThuVienPhiChuaHoanRoutingModule = class BaoCaoThuVienPhiChuaHoanRoutingModule {
};
...
class BaoCaoThuVienPhiChuaHoanTimKiemNangCao {
    constructor(NhomThuVienPhi = null, SearchString = null, FromDate = null, ToDate = null, TuNgayFormat = null, DenNgayFormat = null) {
...
let BaoCaoThuVienPhiChuaHoanModule = class BaoCaoThuVienPhiChuaHoanModule {
};
