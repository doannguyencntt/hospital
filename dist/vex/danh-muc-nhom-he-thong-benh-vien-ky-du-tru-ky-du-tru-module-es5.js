...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-ky-du-tru-ky-du-tru-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KyDuTruCreateComponent = /** @class */ (function () {
                function KyDuTruCreateComponent(router) {
                    this.router = router;
                }
                KyDuTruCreateComponent.prototype.ngOnInit = function () {
                };
                // onCreated() {
                //     this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/ky-du-tru']);
                // }
                KyDuTruCreateComponent.prototype.huy = function () {
                    this.router.navigateByUrl("/danh-muc/nhom-he-thong/benh-vien/ky-du-tru?holdQuery=true");
                };
                KyDuTruCreateComponent.prototype.them = function () {
                    this.shared.them();
                };
                return KyDuTruCreateComponent;
            }());
            KyDuTruCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KyDuTruListComponent = /** @class */ (function () {
                function KyDuTruListComponent(authService, notificationService, apiService, dialog, router, route, location) {
                ...
                KyDuTruListComponent.prototype.ngOnInit = function () {
                ...
                KyDuTruListComponent.prototype.add = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/ky-du-tru/them']);
                };
                KyDuTruListComponent.prototype.updateTinhTrang = function (dataItem) {
                    var self = this;
                    ...
                    if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
                            ...
                            if (res == "Yes") {
                                self.apiService.post("KyDuTru/KichHoatTrangThai?id=" + dataItem.Id).subscribe(function () {
                ...
                KyDuTruListComponent.prototype.edit = function (dataItem) {
                    if (dataItem) {
                        this.router.navigate(["/danh-muc/nhom-he-thong/benh-vien/ky-du-tru/chinh-sua/" + dataItem.Id]);
                    }
                };
                KyDuTruListComponent.prototype.delete = function (dataItem) {
                    var _this = this;
                    if (dataItem) {
                        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Delete)) {
                            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmComponent"], {
                                ...
                                if (result == 'Yes') {
                                    _this.apiService.delete("KyDuTru/" + dataItem.Id).subscribe(function () {
                                        _this.gridChild.search();
                                        _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_10__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ['Xóa']));
                                    }, function (err) {
                ...
                KyDuTruListComponent.prototype.copy = function (dataItem) {
                    if (dataItem) {
                        this.router.navigateByUrl("/danh-muc/nhom-he-thong/benh-vien/ky-du-tru/them?clone=" + dataItem.Id);
                    }
                };
                KyDuTruListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_8__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("KyDuTru/ExportKyDuTru", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                KyDuTruListComponent.prototype.checkboxChange = function (event, duocPham, vatTu) {
                    if (duocPham === void 0) { duocPham = false; }
                    if (vatTu === void 0) { vatTu = false; }
                    if (duocPham) {
                ...
                KyDuTruListComponent.prototype.timKiem = function () {
                    if (this.gridChild) {
                ...
                KyDuTruListComponent.prototype.convertDateTimeToUTC = function () {
                ...
                KyDuTruListComponent.prototype.reverseDateTime = function () {
                    if (this.kyDuTruSearch.RangeApDung.startDate) {
                ...
                KyDuTruListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                KyDuTruListComponent.prototype.onKeyNgayApDung = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                KyDuTruListComponent.prototype.onKeyNgayLap = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                KyDuTruListComponent.prototype.clearSearch = function () {
                    if (this.kyDuTruSearch.SearchString == "" || this.kyDuTruSearch.SearchString == null) {
                        this.timKiem();
                    }
                };
                KyDuTruListComponent.prototype.changeNgayApDungRange = function (ev) {
                    this.timKiem();
                };
                KyDuTruListComponent.prototype.changeNgayLapRange = function (ev) {
                    this.timKiem();
                };
                return KyDuTruListComponent;
            }());
            KyDuTruListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KyDuTruRoutingModule = /** @class */ (function () {
                function KyDuTruRoutingModule() {
                }
                return KyDuTruRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KyDuTruSharedComponent = /** @class */ (function () {
                function KyDuTruSharedComponent(route, router, dialog, apiService, baseService, notificationService, authService) {
                    this.route = route;
                    this.router = router;
                    this.dialog = dialog;
                    this.apiService = apiService;
                ...
                KyDuTruSharedComponent.prototype.ngOnInit = function () {
                ...
                KyDuTruSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (res) {
                        _this.kyDuTru = res;
                    });
                };
                KyDuTruSharedComponent.prototype.cloneById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (res) {
                        _this.kyDuTru = res;
                        _this.kyDuTru.Id = 0;
                ...
                KyDuTruSharedComponent.prototype.checkIsDaDuocSuDung = function (id) {
                    var _this = this;
                    this.apiService.get("KyDuTru/IsDaDuocSuDung?kyDuTruId=" + id).subscribe(function (res) {
                        _this.isDaDuocSuDung = res;
                        _this.outputIsDaDuocSuDung.emit(res);
                        // if(res) {
                ...
                KyDuTruSharedComponent.prototype.checkIsDaDuocSuDungChoDuTruMuaDuocPham = function (id) {
                    var _this = this;
                    this.apiService.get("KyDuTru/IsDaDuocSuDungChoDuTruMuaDuocPham?kyDuTruId=" + id).subscribe(function (res) {
                        _this.isDaDuocSuDungChoDuTruMuaDuocPham = res;
                    }, function (err) {
                        _this.notificationService.showError(err.Message);
                    });
                };
                KyDuTruSharedComponent.prototype.checkIsDaDuocSuDungChoDuTruMuaVatTu = function (id) {
                    var _this = this;
                    this.apiService.get("KyDuTru/IsDaDuocSuDungChoDuTruMuaVatTu?kyDuTruId=" + id).subscribe(function (res) {
                        _this.isDaDuocSuDungChoDuTruMuaVatTu = res;
                    }, function (err) {
                        _this.notificationService.showError(err.Message);
                    });
                };
                KyDuTruSharedComponent.prototype.getSharedData = function () {
                    return this.kyDuTru;
                };
                KyDuTruSharedComponent.prototype.apDungChange = function (evt) {
                    if (this.validationErrors && this.validationErrors.filter(function (p) { return p.Field.includes('MuaDuocPham'); }).length !== 0) {
                        this.validationErrors.splice(this.validationErrors.indexOf(this.validationErrors.filter(function (p) { return p.Field.includes('MuaDuocPham'); })), 1);
                    }
                };
                KyDuTruSharedComponent.prototype.them = function () {
                    var _this = this;
                    this.validationErrors = [];
                    this.apiService.post("KyDuTru", this.kyDuTru).subscribe(function (res) {
                        ...
                        _this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/ky-du-tru']);
                    }, function (err) {
                ...
                KyDuTruSharedComponent.prototype.luu = function () {
                    var _this = this;
                    this.validationErrors = [];
                    this.apiService.put("KyDuTru", this.kyDuTru).subscribe(function (res) {
                ...
                return KyDuTruSharedComponent;
            }());
            KyDuTruSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KyDuTruUpdateComponent = /** @class */ (function () {
                function KyDuTruUpdateComponent(router) {
                    this.router = router;
                    this.isDaDuocSuDung = false;
                }
                KyDuTruUpdateComponent.prototype.ngOnInit = function () {
                };
                // onUpdated() {
                //     this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/ky-du-tru']);
                // }
                KyDuTruUpdateComponent.prototype.huy = function () {
                    this.router.navigateByUrl("/danh-muc/nhom-he-thong/benh-vien/ky-du-tru?holdQuery=true");
                };
                KyDuTruUpdateComponent.prototype.luu = function () {
                    this.shared.luu();
                };
                KyDuTruUpdateComponent.prototype.checkIsDaDuocSuDung = function (evt) {
                    this.isDaDuocSuDung = evt;
                };
                return KyDuTruUpdateComponent;
            }());
            KyDuTruUpdateComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var KyDuTru = /** @class */ (function () {
                function KyDuTru() {
                }
                return KyDuTru;
            }());
            var KyDuTruSearch = /** @class */ (function () {
                function KyDuTruSearch() {
                    this.DuocPham = true;
                    this.VatTu = true;
                    this.SearchString = "";
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KyDuTruModule = /** @class */ (function () {
                function KyDuTruModule() {
                }
                return KyDuTruModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/base.service */ "./src/app/core/services/base.service.ts");
            var KyDuTruService = /** @class */ (function (_super) {
                __extends(KyDuTruService, _super);
                function KyDuTruService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'KyDuTru';
                    return _this;
                }
                return KyDuTruService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"]));
            KyDuTruService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-ky-du-tru-ky-du-tru-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-ky-du-tru-ky-du-tru-module-es5.js.map