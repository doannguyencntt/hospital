...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-nhom-dich-vu-benh-vien-nhom-dich-vu-benh-vien-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomDichVuBenhVienCreateComponent = /** @class */ (function () {
                function NhomDichVuBenhVienCreateComponent(router) {
                    this.router = router;
                }
                NhomDichVuBenhVienCreateComponent.prototype.ngOnInit = function () {
                };
                NhomDichVuBenhVienCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/benh-vien/nhom-dich-vu-benh-vien']);
                };
                return NhomDichVuBenhVienCreateComponent;
            }());
            NhomDichVuBenhVienCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomDichVuBenhVienListComponent = /** @class */ (function () {
                function NhomDichVuBenhVienListComponent(dialog, notificationService, apiService, baseService, router, authService) {
                    var _this = this;
                    this.dialog = dialog;
                    ...
                    this.fetchChildren = function (dataItem) {
                        return _this.fetchDichVuKhamBenhCons(dataItem);
                    };
                }
                NhomDichVuBenhVienListComponent.prototype.fetchDichVuKhamBenhCons = function (dataItem) {
                    ...
                    var idCaps = dataItem.IdCap.split(";");
                    var nhom = idCaps[1];
                    if (nhom === 'nhomCon') {
                ...
                NhomDichVuBenhVienListComponent.prototype.expandLogic = function (dataItem) {
                ...
                NhomDichVuBenhVienListComponent.prototype.iconClass = function (dataItem) {
                    return {
                        'k-i-folder': dataItem.HasChildren == true,
                        'k-icon': true
                    };
                };
                NhomDichVuBenhVienListComponent.prototype.ngOnInit = function () {
                ...
                //     }
                // }
                NhomDichVuBenhVienListComponent.prototype.expand = function (dataItem) {
                    this.expandLogic(dataItem);
                };
                NhomDichVuBenhVienListComponent.prototype.loadingPage = function () {
                ...
                NhomDichVuBenhVienListComponent.prototype.closePopupLoadingData = function () {
                    if (this.popupLoadingData != undefined && this.popupLoadingData != null) {
                        this.popupLoadingData.close();
                    }
                };
                NhomDichVuBenhVienListComponent.prototype.getDataTreeView = function () {
                    var _this = this;
                ...
                NhomDichVuBenhVienListComponent.prototype.searchChanges = function (dataItem) {
                ...
                NhomDichVuBenhVienListComponent.prototype.onKey = function (event) {
                    if (event.key == "Enter") {
                        this.timKiem();
                    }
                };
                NhomDichVuBenhVienListComponent.prototype.timKiem = function () {
                    var _this = this;
                ...
                NhomDichVuBenhVienListComponent.prototype.themNhomDichVu = function () {
                ...
                NhomDichVuBenhVienListComponent.prototype.chinhSua = function (id) {
                ...
                NhomDichVuBenhVienListComponent.prototype.themCon = function (id) {
                ...
                NhomDichVuBenhVienListComponent.prototype.mySelectionAfterDelete = function (id) {
                ...
                NhomDichVuBenhVienListComponent.prototype.xoaCon = function (id) {
                    var self = this;
                ...
                return NhomDichVuBenhVienListComponent;
            }());
            NhomDichVuBenhVienListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomDichVuBenhVienRoutingModule = /** @class */ (function () {
                function NhomDichVuBenhVienRoutingModule() {
                }
                return NhomDichVuBenhVienRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomDichVuBenhVienSharedComponent = /** @class */ (function () {
                function NhomDichVuBenhVienSharedComponent(route, baseService, router) {
                    this.route = route;
                    this.baseService = baseService;
                    this.router = router;
                ...
                NhomDichVuBenhVienSharedComponent.prototype.ngOnInit = function () {
                    this.nhomDichVuBenhVien = new _nhom_dich_vu_benh_vien_model__WEBPACK_IMPORTED_MODULE_4__["NhomDichVuBenhVien"]();
                ...
                NhomDichVuBenhVienSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    if (this.isShowView == "true") {
                        this.isCreate = true;
                        this.baseService.getById(id).subscribe(function (result) {
                            _this.nhomDichVuBenhVien = result;
                            _this.nhomDichVuBenhVien.NhomDichVuBenhVienChaId = result.Id;
                            _this.nhomDichVuBenhVien.NhomDichVuBenhVienCha = result.Ten;
                            _this.nhomDichVuBenhVien.Id = 0;
                            _this.nhomDichVuBenhVien.Ten = null;
                            _this.nhomDichVuBenhVien.Ma = null;
                            _this.nhomDichVuBenhVien.MoTa = null;
                        ...
                        this.baseService.getById(id).subscribe(function (resultData) {
                            if (resultData !== null && resultData !== undefined) {
                                _this.nhomDichVuBenhVien = resultData;
                                _this.isDisabled = true;
                                // console.log("data: ", this.nhomDichVuBenhVien)
                            }
                        });
                ...
                NhomDichVuBenhVienSharedComponent.prototype.getSharedData = function () {
                    return this.nhomDichVuBenhVien;
                };
                NhomDichVuBenhVienSharedComponent.prototype.onUpdated = function () {
                    this.router.navigate(['/danh-muc/nhom-he-thong/benh-vien/nhom-dich-vu-benh-vien']);
                };
                return NhomDichVuBenhVienSharedComponent;
            }());
            NhomDichVuBenhVienSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomDichVuBenhVienUpdateComponent = /** @class */ (function () {
                function NhomDichVuBenhVienUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                NhomDichVuBenhVienUpdateComponent.prototype.ngOnInit = function () {
                };
                NhomDichVuBenhVienUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/benh-vien/nhom-dich-vu-benh-vien']);
                };
                return NhomDichVuBenhVienUpdateComponent;
            }());
            NhomDichVuBenhVienUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var NhomDichVuBenhVien = /** @class */ (function () {
                function NhomDichVuBenhVien(Id, Ma, Ten, MoTa, IsDefault, NhomDichVuBenhVienChaId, NhomDichVuBenhVienCha, SearchString, CapNhomDichVuBenhVien) {
                    if (Id === void 0) { Id = 0; }
                    if (Ma === void 0) { Ma = null; }
                    if (Ten === void 0) { Ten = null; }
                    if (MoTa === void 0) { MoTa = null; }
                    if (IsDefault === void 0) { IsDefault = false; }
                    if (NhomDichVuBenhVienChaId === void 0) { NhomDichVuBenhVienChaId = null; }
                    if (NhomDichVuBenhVienCha === void 0) { NhomDichVuBenhVienCha = null; }
                    if (SearchString === void 0) { SearchString = null; }
                    if (CapNhomDichVuBenhVien === void 0) { CapNhomDichVuBenhVien = null; }
                    this.Id = Id;
                    this.Ma = Ma;
                    this.Ten = Ten;
                    this.MoTa = MoTa;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomDichVuBenhVienModule = /** @class */ (function () {
                function NhomDichVuBenhVienModule() {
                }
                return NhomDichVuBenhVienModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NhomDichVuBenhVienService = /** @class */ (function (_super) {
                __extends(NhomDichVuBenhVienService, _super);
                function NhomDichVuBenhVienService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'NhomDichVuBenhVien';
                    return _this;
                }
                return NhomDichVuBenhVienService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            NhomDichVuBenhVienService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-nhom-dich-vu-benh-vien-nhom-dich-vu-benh-vien-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-nhom-dich-vu-benh-vien-nhom-dich-vu-benh-vien-module-es5.js.map