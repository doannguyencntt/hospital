...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-toa-thuoc-mau-toa-thuoc-mau-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToaThuocMauCreateComponent = /** @class */ (function () {
                function ToaThuocMauCreateComponent(router) {
                    this.router = router;
                }
                ToaThuocMauCreateComponent.prototype.ngOnInit = function () {
                };
                ToaThuocMauCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/benh-vien/toa-thuoc-mau']);
                };
                return ToaThuocMauCreateComponent;
            }());
            ToaThuocMauCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToaThuocMauListComponent = /** @class */ (function () {
                function ToaThuocMauListComponent(authService, dialog, notificationService, apiService) {
                ...
                ToaThuocMauListComponent.prototype.ngOnInit = function () {
                ...
                ToaThuocMauListComponent.prototype.updateTrangThaiToaThuoc = function (id, isDisabled) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_4__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                self.apiService.post("ToaThuocMau/KichHoatToaThuocMau?id=" + id).subscribe(function () {
                ...
                ToaThuocMauListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    this.apiService.postExportExcel("ToaThuocMau/ExportToaThuocMau", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return ToaThuocMauListComponent;
            }());
            ToaThuocMauListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToaThuocMauRoutingModule = /** @class */ (function () {
                function ToaThuocMauRoutingModule() {
                }
                return ToaThuocMauRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToaThuocMauSharedComponent = /** @class */ (function () {
                function ToaThuocMauSharedComponent(route, baseService, apiService, dialog, notificationService) {
                    this.route = route;
                ...
                ToaThuocMauSharedComponent.prototype.ngOnInit = function () {
                ...
                ToaThuocMauSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.toaMau = resultData;
                        _this.isDisableSoLuongChinhSua();
                    });
                };
                ToaThuocMauSharedComponent.prototype.getSharedData = function () {
                    return this.toaMau;
                };
                ToaThuocMauSharedComponent.prototype.themToaMauChiTiet = function () {
                    this.toaMau.ToaThuocMauChiTiets.push(new _toa_thuoc_mau_model__WEBPACK_IMPORTED_MODULE_4__["ToaThuocMauChiTiet"]());
                };
                ToaThuocMauSharedComponent.prototype.isDisableSoLuongChinhSua = function () {
                    //console.log("this dataTOaMau: ", this.toaMau)
                    if (this.toaMau.ToaThuocMauChiTiets != []) {
                        for (var i = 0; i < this.toaMau.ToaThuocMauChiTiets.length; i++) {
                ...
                ToaThuocMauSharedComponent.prototype.getThoiGianDonThuoc = function () {
                    var _this = this;
                    this.apiService.get("KhamBenh/ThoiGianDonThuoc").subscribe(function (resultData) {
                        _this.thoiGianDonThuocDataSource = resultData;
                    });
                };
                ToaThuocMauSharedComponent.prototype.xoaToaMauChiTiet = function (viTri) {
                    var _this = this;
                    this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmComponent"], {
                        ...
                        if (result === 'Yes') {
                            if (_this.toaMau.ToaThuocMauChiTiets.length > 1) {
                                _this.toaMau.ToaThuocMauChiTiets.splice(viTri, 1);
                                _this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
                            }
                        }
                    });
                };
                ToaThuocMauSharedComponent.prototype.onValueChange = function (buoi, index) {
                    if (buoi == "Sang" && this.validationErrors != undefined && this.validationErrors != null) {
                        var lenValidate = this.validationErrors.length;
                        if (lenValidate > 0 && lenValidate != undefined) {
                            for (var i = 0; i < lenValidate; i++) {
                ...
                ToaThuocMauSharedComponent.prototype.tinhTongSoLuong = function (soNgay, dungSang, dungTrua, dungChieu, dungToi) {
                    var sang, trua, chieu, toi, sum, result;
                ...
                ToaThuocMauSharedComponent.prototype.inputSoNgayDeTinhSoLuong = function (soNgayDung, index) {
                ...
                ToaThuocMauSharedComponent.prototype.kiemTraNhapCacBuoiTrongNgay = function (input, buoi, index) {
                ...
                return ToaThuocMauSharedComponent;
            }());
            ToaThuocMauSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _toa_thuoc_mau_shared_toa_thuoc_mau_shared_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../toa-thuoc-mau-shared/toa-thuoc-mau-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/benh-vien/toa-thuoc-mau/toa-thuoc-mau-shared/toa-thuoc-mau-shared.component.ts");
            var ToaThuocMauUpdateComponent = /** @class */ (function () {
                function ToaThuocMauUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                ToaThuocMauUpdateComponent.prototype.ngOnInit = function () {
                };
                ToaThuocMauUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/benh-vien/toa-thuoc-mau']);
                };
                return ToaThuocMauUpdateComponent;
            }());
            ToaThuocMauUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ToaThuocMau = /** @class */ (function () {
                function ToaThuocMau(Id, Ten, ICDId, TenICD, TrieuChungId, TenTrieuChung, ChuanDoanId, BacSiKeToaId, TenBacSiKeToa, TenChuanDoan, GhiChu, IsDisabled, ToaThuocMauChiTiets) {
                    if (Id === void 0) { Id = 0; }
                    if (Ten === void 0) { Ten = null; }
                    if (ICDId === void 0) { ICDId = null; }
                    if (TenICD === void 0) { TenICD = null; }
                    if (TrieuChungId === void 0) { TrieuChungId = null; }
                    if (TenTrieuChung === void 0) { TenTrieuChung = null; }
                    if (ChuanDoanId === void 0) { ChuanDoanId = null; }
                    if (BacSiKeToaId === void 0) { BacSiKeToaId = null; }
                    if (TenBacSiKeToa === void 0) { TenBacSiKeToa = null; }
                    if (TenChuanDoan === void 0) { TenChuanDoan = null; }
                    if (GhiChu === void 0) { GhiChu = null; }
                    if (IsDisabled === void 0) { IsDisabled = false; }
                    if (ToaThuocMauChiTiets === void 0) { ToaThuocMauChiTiets = []; }
                    this.Id = Id;
                    this.Ten = Ten;
                    this.ICDId = ICDId;
                    this.TenICD = TenICD;
            ...
            var ToaThuocMauChiTiet = /** @class */ (function () {
                function ToaThuocMauChiTiet(Id, ToaThuocMauId, DuocPhamId, TenDuocPham, SoLuong, SoNgayDung, DungSang, DungTrua, DungChieu, DungToi, DungSangDisplay, DungTruaDisplay, DungChieuDisplay, DungToiDisplay, ThoiGianDungSang, ThoiGianDungTrua, ThoiGianDungChieu, ThoiGianDungToi, IsDisabled) {
                    if (Id === void 0) { Id = 0; }
                    if (ToaThuocMauId === void 0) { ToaThuocMauId = null; }
                    if (DuocPhamId === void 0) { DuocPhamId = null; }
                    if (TenDuocPham === void 0) { TenDuocPham = null; }
                    if (SoLuong === void 0) { SoLuong = null; }
                    if (SoNgayDung === void 0) { SoNgayDung = null; }
                    if (DungSang === void 0) { DungSang = null; }
                    if (DungTrua === void 0) { DungTrua = null; }
                    if (DungChieu === void 0) { DungChieu = null; }
                    if (DungToi === void 0) { DungToi = null; }
                    if (DungSangDisplay === void 0) { DungSangDisplay = null; }
                    if (DungTruaDisplay === void 0) { DungTruaDisplay = null; }
                    if (DungChieuDisplay === void 0) { DungChieuDisplay = null; }
                    if (DungToiDisplay === void 0) { DungToiDisplay = null; }
                    if (ThoiGianDungSang === void 0) { ThoiGianDungSang = null; }
                    if (ThoiGianDungTrua === void 0) { ThoiGianDungTrua = null; }
                    if (ThoiGianDungChieu === void 0) { ThoiGianDungChieu = null; }
                    if (ThoiGianDungToi === void 0) { ThoiGianDungToi = null; }
                    if (IsDisabled === void 0) { IsDisabled = false; }
                    this.Id = Id;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToaThuocMauModule = /** @class */ (function () {
                function ToaThuocMauModule() {
                }
                return ToaThuocMauModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToaThuocMauService = /** @class */ (function (_super) {
                __extends(ToaThuocMauService, _super);
                function ToaThuocMauService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'ToaThuocMau';
                    return _this;
                }
                return ToaThuocMauService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            ToaThuocMauService.ctorParameters = function () { return [
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-toa-thuoc-mau-toa-thuoc-mau-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-toa-thuoc-mau-toa-thuoc-mau-module-es5.js.map