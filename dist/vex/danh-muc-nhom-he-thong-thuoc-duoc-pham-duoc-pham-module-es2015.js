...
let DuocPhamChonFilePopupComponent = class DuocPhamChonFilePopupComponent {
    constructor(dialog, dialogRef, cdRef, data, notificationService, apiService) {
        this.dialog = dialog;
    ...
    TaiFileMau() {
        const self = this;
        self.apiService.postExportExcel('DuocPham/DownloadTemplateDuocPham').subscribe(resultData => {
    ...
    xuLyFile() {
        ...
        if (this.fileExcel != undefined && this.fileExcel != null) {
            ...
            self.apiService.get("DuocPham/ImportDuocPham", params).subscribe((resp) => {
                if (resp) {
...
DuocPhamChonFilePopupComponent.ctorParameters = () => [
...
let DuocPhamCreateComponent = class DuocPhamCreateComponent {
    ...
    xuLyThemDuocPham() {
        ...
        self.apiService.post("DuocPham", self.shared.getSharedData()).subscribe(resultData => {
...
DuocPhamCreateComponent.ctorParameters = () => [
...
let DuocPhamListComponent = class DuocPhamListComponent {
    ...
    exportExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("DuocPham/ExportDuocPham", this.gridChild._gridQueryInfo).subscribe(res => {
    ...
    NhapTuFileExcel() {
        this.dialog.open(_duoc_pham_chon_file_popup_duoc_pham_chon_file_popup_component__WEBPACK_IMPORTED_MODULE_19__["DuocPhamChonFilePopupComponent"], {
            ...
            if (result != undefined && result != null && result.length > 0) {
                this.dialog.open(_thong_tin_duoc_pham_popup_thong_tin_duoc_pham_popup_component__WEBPACK_IMPORTED_MODULE_20__["ThongTinDuocPhamPopupComponent"], {
                    disableClose: false,
                    width: '800px',
...
DuocPhamListComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_8__["NotificationService"] },
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"] },
...
let DuocPhamSharedComponent = class DuocPhamSharedComponent {
...
DuocPhamSharedComponent.ctorParameters = () => [
...
let DuocPhamUpdateComponent = class DuocPhamUpdateComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
DuocPhamUpdateComponent.ctorParameters = () => [
...
class DuocPham {
    constructor(Id = 0, MaThuocBenhVien = null, Ten = null, TenTiengAnh = null, SoDangKy = null, STTHoatChat = null, MaHoatChat = null, HoatChat = null, NhaSanXuat = null, NuocSanXuat = null, DuongDungId = null, TenDuongDung = null, HamLuong = null, QuyCach = null, TieuChuan = null, BaoChe = null, DonViTinhId = null, TenDonViTinh = null, HanSuDung = null, HieuLuc = true, IsDisabled = false, HuongDan = null, MieuTa = null, MoTa = null, LoaiThuocHoacHoatChat = null, TenLoaiThuocHoacHoatChat = null, ChiDinh = null, ChongChiDinh = null, LieuLuongCachDung = null, TacDungPhu = null, ChuYDePhong = null, LaThucPhamChucNang = false, SuDungThuocBenhVien = false, MaDuocPhamBenhVien = null, DieuKienBaoHiemThanhToan = null, DuocPhamBenhVienPhanNhomId = 0, DuocPhamBenhVienPhanNhomModelText = null, DuocPhamBenhVienModel = null, TheTich = null, HeSoDinhMucDonViTinh = null, LaThuocHuongThanGayNghien = false, 
    //BVHD-3454
    ChuaTaoDuocPhamBenhVien = true) {
        this.Id = Id;
...
class DuocPhamBenhVienModel {
    constructor(Id = 0, MaDuocPhamBenhVien = null, DuocPhamBenhVienPhanNhomId = null) {
        this.Id = Id;
        this.MaDuocPhamBenhVien = MaDuocPhamBenhVien;
        this.DuocPhamBenhVienPhanNhomId = DuocPhamBenhVienPhanNhomId;
    }
...
class ThongTinError {
    constructor(Ten = null, TotalThanhCong = null, Error = null) {
        this.Ten = Ten;
...
let DuocPhamService = class DuocPhamService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        // controllerName = 'ThuocBenhVien';
        this.controllerName = 'DuocPham';
    }
};
...
let ThongTinDuocPhamPopupComponent = class ThongTinDuocPhamPopupComponent {
    constructor(data) {
        this.data = data;
...
ThongTinDuocPhamPopupComponent.ctorParameters = () => [
