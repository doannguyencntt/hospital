...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["danh-muc-nhom-he-thong-benh-vien-icd-icd-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IcdCreateComponent = /** @class */ (function () {
                function IcdCreateComponent(router) {
                    this.router = router;
                }
                IcdCreateComponent.prototype.ngOnInit = function () {
                };
                IcdCreateComponent.prototype.onCreated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/benh-vien/icd']);
                };
                return IcdCreateComponent;
            }());
            IcdCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IcdListComponent = /** @class */ (function () {
                function IcdListComponent(authService, dialog, notificationService, apiService) {
                ...
                IcdListComponent.prototype.ngOnInit = function () {
                ...
                IcdListComponent.prototype.updateICD = function (id, hieuLuc) {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Update)) {
                        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                            ...
                            if (result == "Yes") {
                                self.apiService.post("QuanLyICD/KichHoatHieuLuc?id=" + id).subscribe(function () {
                ...
                IcdListComponent.prototype.exportExcel = function () {
                    var _this = this;
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_11__["SecurityOperation"].Process)) {
                        this.apiService.postExportExcel("QuanLyICD/ExportICD", this.gridChild._gridQueryInfo).subscribe(function (res) {
                ...
                return IcdListComponent;
            }());
            IcdListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IcdRoutingModule = /** @class */ (function () {
                function IcdRoutingModule() {
                }
                return IcdRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IcdSharedComponent = /** @class */ (function () {
                function IcdSharedComponent(route, baseService) {
                    this.route = route;
                ...
                IcdSharedComponent.prototype.ngOnInit = function () {
                ...
                IcdSharedComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.baseService.getById(id).subscribe(function (resultData) {
                        _this.icd = resultData;
                ...
                IcdSharedComponent.prototype.getSharedData = function () {
                    return this.icd;
                };
                return IcdSharedComponent;
            }());
            IcdSharedComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _icd_shared_icd_shared_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../icd-shared/icd-shared.component */ "./src/app/modules/main/danh-muc/nhom-he-thong/benh-vien/icd/icd-shared/icd-shared.component.ts");
            var IcdUpdateComponent = /** @class */ (function () {
                function IcdUpdateComponent(router, route) {
                    this.router = router;
                    this.route = route;
                }
                IcdUpdateComponent.prototype.ngOnInit = function () {
                };
                IcdUpdateComponent.prototype.onUpdated = function () {
                    this.router.navigate(['danh-muc/nhom-he-thong/benh-vien/icd']);
                };
                return IcdUpdateComponent;
            }());
            IcdUpdateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ICD = /** @class */ (function () {
                function ICD(Id, Ma, TenTiengViet, TenTiengAnh, LoaiICDId, TenLoaiICD, ChuanDoanLamSan, ThongTinThamKhaoChoBenhNhan, TenGoiKhac, HieuLuc, LoiDanCuaBacSi, ManTinh, GioiTinh, GioiTinhDisplay, BenhThuongGap, BenhNam, KhongBaoHiem, NgoaiDinhSuat, KhoaId, TenKhoa, MoTa, MaChiTiet) {
                    if (Id === void 0) { Id = 0; }
                    if (Ma === void 0) { Ma = null; }
                    if (TenTiengViet === void 0) { TenTiengViet = null; }
                    if (TenTiengAnh === void 0) { TenTiengAnh = null; }
                    if (LoaiICDId === void 0) { LoaiICDId = null; }
                    if (TenLoaiICD === void 0) { TenLoaiICD = null; }
                    if (ChuanDoanLamSan === void 0) { ChuanDoanLamSan = null; }
                    if (ThongTinThamKhaoChoBenhNhan === void 0) { ThongTinThamKhaoChoBenhNhan = null; }
                    if (TenGoiKhac === void 0) { TenGoiKhac = null; }
                    if (HieuLuc === void 0) { HieuLuc = null; }
                    if (LoiDanCuaBacSi === void 0) { LoiDanCuaBacSi = null; }
                    if (ManTinh === void 0) { ManTinh = null; }
                    if (GioiTinh === void 0) { GioiTinh = null; }
                    if (GioiTinhDisplay === void 0) { GioiTinhDisplay = null; }
                    if (BenhThuongGap === void 0) { BenhThuongGap = null; }
                    if (BenhNam === void 0) { BenhNam = null; }
                    if (KhongBaoHiem === void 0) { KhongBaoHiem = null; }
                    if (NgoaiDinhSuat === void 0) { NgoaiDinhSuat = null; }
                    if (KhoaId === void 0) { KhoaId = null; }
                    if (TenKhoa === void 0) { TenKhoa = null; }
                    if (MoTa === void 0) { MoTa = null; }
                    if (MaChiTiet === void 0) { MaChiTiet = null; }
                    this.Id = Id;
                    this.Ma = Ma;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/api.service */ "./src/app/core/services/api.service.ts");
            var IcdService = /** @class */ (function (_super) {
                __extends(IcdService, _super);
                function IcdService(apiService) {
                    var _this = _super.call(this, apiService) || this;
                    _this.controllerName = 'QuanLyICD';
                    return _this;
                }
                return IcdService;
            }(src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"]));
            IcdService.ctorParameters = function () { return [
                { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
            ]; };
...
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-icd-icd-module-es5.js.map
//# sourceMappingURL=danh-muc-nhom-he-thong-benh-vien-icd-icd-module-es5.js.map