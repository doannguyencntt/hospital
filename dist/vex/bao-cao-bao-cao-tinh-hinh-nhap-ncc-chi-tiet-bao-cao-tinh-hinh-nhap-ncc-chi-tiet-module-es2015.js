...
let BaoCaoTinhHinhNhapNccChiTietListComponent = class BaoCaoTinhHinhNhapNccChiTietListComponent {
    ...
    XemBaoCao() {
        ...
        this.apiService.post("BaoCao/GetDataBaoCaoTinhHinhNhapNCCChiTietForGridAsync", this.baoCaoSearch).subscribe(resultData => {
...
BaoCaoTinhHinhNhapNccChiTietListComponent.ctorParameters = () => [
...
let BaoCaoTinhHinhNhapNccChiTietRoutingModule = class BaoCaoTinhHinhNhapNccChiTietRoutingModule {
};
...
class BaoCaoTinhHinhNhapNCCChiTietSearch {
...
class InBaoCaoTinhHinhNhapNCCChiTiet {
...
let BaoCaoTinhHinhNhapNccChiTietModule = class BaoCaoTinhHinhNhapNccChiTietModule {
};
