...
let GoiKhamViewPopupComponent = class GoiKhamViewPopupComponent {
    ...
    afterChangedFromHopDongKham(ev) {
        this.dialogRef.close("Yes");
    }
};
GoiKhamViewPopupComponent.ctorParameters = () => [
...
let KhamDoanGoiKhamSucKhoeChungComponent = class KhamDoanGoiKhamSucKhoeChungComponent {
    ...
    pushDataDichVu() {
        ...
        this.lstDichVuKhamSucKhoeDoanGrid.forEach(obj => {
            let model = new _kham_doan_goi_kham_suc_khoe_model__WEBPACK_IMPORTED_MODULE_14__["DichVuKhamSucKhoeDoanViewModel"]();
            model.Id = obj.Id;
            ...
            model.GoiKhamSucKhoeNoiThucHienIds.forEach(element => {
                let goiKham = new _kham_doan_goi_kham_suc_khoe_model__WEBPACK_IMPORTED_MODULE_14__["GoiKhamSucKhoeNoiThucHienViewModel"]();
            ...
            if (res == "Yes") {
                ...
                if (this.id != null && this.id != 0 && !this.IsCopy) {
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Update)) {
                        ...
                        self.apiService.post("KhamDoan/CapNhatGoiKhamSucKhoeDoan", self.khamSucKhoeDoan).subscribe(() => {
                    ...
                    if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].Add)) {
                        ...
                        self.khamSucKhoeDoan.Id = 0;
                        self.apiService.post("KhamDoan/ThemGoiKhamSucKhoeDoan", self.khamSucKhoeDoan).subscribe(() => {
                            self.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_8__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                            if (this.dataKhamDoan != undefined && this.dataKhamDoan != null) {
                                this.afterChangedFromHopDongKham.emit(true);
                            }
...
KhamDoanGoiKhamSucKhoeChungComponent.ctorParameters = () => [
...
let KhamDoanGoiKhamSucKhoeChonFilePopupComponent = class KhamDoanGoiKhamSucKhoeChonFilePopupComponent {
...
KhamDoanGoiKhamSucKhoeChonFilePopupComponent.ctorParameters = () => [
...
let KhamDoanGoiKhamSucKhoeDetailPopupComponent = class KhamDoanGoiKhamSucKhoeDetailPopupComponent {
    constructor(authService, dialog, notificationService, apiService, location, ref, router, route) {
        this.authService = authService;
        this.dialog = dialog;
        this.notificationService = notificationService;
    ...
    getById(id) {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].View)) {
            self.showPopupLoadingData();
            self.apiService.get("KhamDoan/GetGoiKhamSucKhoeDoan?id=" + id).subscribe(resultData => {
                if (resultData != undefined && resultData != null) {
                    resultData.GoiKhamSucKhoeDichVuDichVuKyThuats = [];
                    resultData.GoiKhamSucKhoeDichVuKhamBenhs = [];
                    self.khamSucKhoeDoan = resultData;
    ...
    themDichVu() {
        ...
        self.dichVuKhamSucKhoeDoan.GoiKhamSucKhoeNoiThucHienIds.forEach(element => {
            let goikham = new _kham_doan_goi_kham_suc_khoe_model__WEBPACK_IMPORTED_MODULE_14__["GoiKhamSucKhoeNoiThucHienViewModel"]();
            goikham.PhongBenhVienId = element;
        ...
        self.apiService.post("KhamDoan/ThemDichVuKhamDoan", self.dichVuKhamSucKhoeDoan).subscribe(resultData => {
            if (resultData != undefined && resultData != null) {
    ...
    capNhatDichVu() {
        ...
        self.apiService.post("KhamDoan/CapNhatDichVuKhamDoan", dataUpdate).subscribe(resultData => {
            if (resultData != undefined && resultData != null) {
    ...
    xoaDichVu(dataItem) {
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_17__["ConfirmComponent"], {
            ...
            if (result === 'Yes') {
                ...
                this.apiService.post("KhamDoan/KiemTraNhanVienSuDungGoiKham?id=" + this.id).subscribe((res) => {
                    if (res.Item1) {
...
KhamDoanGoiKhamSucKhoeDetailPopupComponent.ctorParameters = () => [
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"] },
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
...
let KhamDoanGoiKhamSucKhoeListComponent = class KhamDoanGoiKhamSucKhoeListComponent {
    ...
    xuLyXuatExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("KhamDoan/ExportDanhSachKhamSucKhoeDoan", this.grid._gridQueryInfo).subscribe(res => {
    ...
    xoa(Id) {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Delete)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_22__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.apiService.post("KhamDoan/XoaGoiKhamSucKhoeDoan?id=" + Id).subscribe(() => {
...
KhamDoanGoiKhamSucKhoeListComponent.ctorParameters = () => [
...
let KhamDoanGoiKhamSucKhoeRoutingModule = class KhamDoanGoiKhamSucKhoeRoutingModule {
};
...
let KhamDoanGoiKhamSucKhoeModule = class KhamDoanGoiKhamSucKhoeModule {
};
...
let DanhSachPhongKhamCongTyComponent = class DanhSachPhongKhamCongTyComponent {
    constructor(dialog, dialogRef, cdRef, authService, cd, notificationService, data, apiService, router, route) {
        this.dialog = dialog;
        this.dialogRef = dialogRef;
        this.cdRef = cdRef;
        this.authService = authService;
    ...
    createOrUpdate() {
        ...
        let securityOperation = src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add;
        ...
        if (this.authService.hasPermission(this.documentType, securityOperation)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_14__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    ...
                    this.apiService.post("KhamDoan/ThemHoacSuaDanhSachPhongKhamTaiCongTy", this.danhSachPhongTaiCongTy).subscribe(res => {
                        if (res != 0) {
                            this.dialogRef.close("Yes");
                            this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_6__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
    ...
    changeMultiDanhSachNhanSu(ev) {
    }
    closeChangeDanhSachNhanSu(ev) {
    }
    close(result = null) {
    }
};
DanhSachPhongKhamCongTyComponent.ctorParameters = () => [
...
let HopDongKhamChonGoiKhamFilePopupComponent = class HopDongKhamChonGoiKhamFilePopupComponent {
    constructor(dialog, dialogRef, cdRef, authService, cd, notificationService, data, apiService, router, route) {
        this.dialog = dialog;
        this.dialogRef = dialogRef;
        this.cdRef = cdRef;
    ...
    xuLyFile() {
        ...
        if (this.fileExcel != undefined && this.fileExcel != null) {
            ...
            self.apiService.get("KhamDoan/ImportGoiKham", params).subscribe((resp) => {
                if (resp) {
    ...
    TaiFileMau() {
        const self = this;
        self.apiService.postExportExcel('KhamDoan/DownloadTemplateGoiKham').subscribe(resultData => {
...
HopDongKhamChonGoiKhamFilePopupComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialogRef"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
...
let KhamDoanDvGoiKhamPopupComponent = class KhamDoanDvGoiKhamPopupComponent {
    constructor(data, dialogRef) {
        this.data = data;
        this.dialogRef = dialogRef;
    ...
    totalThanhTien(field) {
        switch (field) {
            case 'ThanhTien':
                return this.dataToSumThanhTien.reduce((sum, item) => sum + item.ThanhTien, 0);
        }
    }
    ;
    ngOnInit() {
...
KhamDoanDvGoiKhamPopupComponent.ctorParameters = () => [
...
let KhamDoanDvThongKePopupComponent = class KhamDoanDvThongKePopupComponent {
    constructor(apiService, authService, notificationService, dialog, data, dialogRef) {
        this.apiService = apiService;
        this.authService = authService;
        this.notificationService = notificationService;
        this.dialog = dialog;
    ...
    totalTongChiPhi(field) {
        switch (field) {
            case 'TongChiPhiTrongGoi':
                return this.dataToSumChiPhi.reduce((sum, item) => sum + item.TongChiPhiTrongGoi, 0);
            case 'TongChiPhiNgoaiGoi':
                return this.dataToSumChiPhi.reduce((sum, item) => sum + item.TongChiPhiNgoaiGoi, 0);
        }
    }
    ;
    ngOnInit() {
    ...
    chiTietTrongGoi(goiKhamSucKhoeIds, yeuCauTiepNhanId, benhNhanId) {
    ...
    chiTietNgoaiGoi(yeuCauTiepNhanId, benhNhanId) {
        this.dialog.open(_kham_doan_dv_goi_kham_popup_kham_doan_dv_goi_kham_popup_component__WEBPACK_IMPORTED_MODULE_10__["KhamDoanDvGoiKhamPopupComponent"], {
            width: "1400px",
            disableClose: true,
    ...
    onDataBoundChild(data) {
        ...
        if (data.Data.some((item) => item.TongChiPhiNgoaiGoi != 0)) {
            this.disabled = true;
        }
        else {
            this.disabled = false;
    ...
    xuatExcel(laDichVuTrongGoi) {
        let dia = this.dialog.open(src_app_shared_component_dialogs_loading_loading_component__WEBPACK_IMPORTED_MODULE_9__["LoadingComponent"], {
            disableClose: true,
            width: '200px',
            height: '90px',
            data: { Title: 'Đang xuất excel...' }
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_12__["SecurityOperation"].Process)) {
            ...
            this.apiService.postExportExcel("KhamDoan/XuatFileExcelTrongGoi", this.xuatFileExcelTrongGoiHoacNgoaiGoi).subscribe(res => {
                let dateTimeNow = new Date();
...
KhamDoanDvThongKePopupComponent.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
...
let KhamDoanHopDongKhamChonFilePopupComponent = class KhamDoanHopDongKhamChonFilePopupComponent {
    constructor(dialog, dialogRef, cdRef, data, notificationService, apiService, router, route) {
        this.dialog = dialog;
        this.dialogRef = dialogRef;
        this.cdRef = cdRef;
        this.data = data;
    ...
    TaiFileMau() {
        const self = this;
        self.apiService.postExportExcel('KhamDoan/DownloadTemplateNhanVienKSK').subscribe(resultData => {
    ...
    xuLyFile() {
        ...
        if (this.fileExcel != undefined && this.fileExcel != null) {
            ...
            self.apiService.get("KhamDoan/ImportNhanVien", params).subscribe((resp) => {
                if (resp) {
...
KhamDoanHopDongKhamChonFilePopupComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
...
let KhamDoanHopDongKhamDetailPopupComponent = class KhamDoanHopDongKhamDetailPopupComponent {
    constructor(authService, dialog, notificationService, apiService, location, route, cdRef, router) {
        this.authService = authService;
        this.dialog = dialog;
        this.notificationService = notificationService;
        this.apiService = apiService;
    ...
    getDataHopDongKham(id) {
        this.showPopupLoadingData();
        this.apiService.get("KhamDoan/GetThongTinHopDongKham?hopDongKhamId=" + id).subscribe((resultData) => {
            if (resultData !== undefined && resultData != null) {
    ...
    xoaHopDongKhamSucKhoeNhanVien(id) {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                ...
                if (result === 'Yes') {
                    this.apiService.post("KhamDoan/XoaHopDongKhamSucKhoeNhanVien?nhanVienHDKhamId=" + id).subscribe((resultData) => {
                        if (resultData !== undefined && resultData != null) {
                            this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
    ...
    showPopupChiTietGoiKham(id = null) {
        let securityOperation = src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add;
        let url = '/them';
        if (id != null) {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
            ...
            this.dialog.open(_kham_doan_hop_dong_kham_list_nhan_vien_popup_kham_doan_hop_dong_kham_list_nhan_vien_popup_component__WEBPACK_IMPORTED_MODULE_15__["KhamDoanHopDongKhamListNhanVienPopupComponent"], {
                ...
                if (result != undefined && result != null && result != "") {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["thêm nhân viên"]));
                    this.nhanVienGrid.search();
                    //Cập nhật lại sô lương nhân viên khám trong hop đồng
                    this.capNhanSoLuongNhanVienKhamTrongHopDong(this.id);
                    this.getTotalDanhSachNhanVienCongTyTheoHopDongKham();
    ...
    capNhanSoLuongNhanVienKhamTrongHopDong(id) {
        this.apiService.post("KhamDoan/CapNhatSoLuongNhanVienKhamTrongHopDong?hopDongKhamId=" + id).subscribe((resultData) => {
        }, (err) => {
            this.validationErrors = err.ValidationErrors;
            if (err.Message != "Validation Failed") {
                this.notificationService.showError(err.Message);
    ...
    viewEditHopDongNVSK(hopDongNhanVienKhamSKId) {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Update)) {
            let id = this.id;
            this.dialog.open(_kham_doan_hop_dong_kham_list_nhan_vien_popup_kham_doan_hop_dong_kham_list_nhan_vien_popup_component__WEBPACK_IMPORTED_MODULE_15__["KhamDoanHopDongKhamListNhanVienPopupComponent"], {
                disableClose: false,
                ...
                if (result != undefined && result != null && result != "") {
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["sữa nhân viên"]));
                    this.nhanVienGrid.search();
                    //Cập nhật lại sô lương nhân viên khám trong hop đồng
                    this.capNhanSoLuongNhanVienKhamTrongHopDong(this.id);
                    this.getTotalDanhSachNhanVienCongTyTheoHopDongKham();
    ...
    NhapTuFileExcel() {
        ...
        this.dialog.open(_kham_doan_hop_dong_kham_chon_file_popup_kham_doan_hop_dong_kham_chon_file_popup_component__WEBPACK_IMPORTED_MODULE_14__["KhamDoanHopDongKhamChonFilePopupComponent"], {
            ...
            if (result != undefined && result != null && result.length > 0) {
                this.dialog.open(_thong_tin_nhan_vien_popup_thong_tin_nhan_vien_popup_component__WEBPACK_IMPORTED_MODULE_24__["ThongTinNhanVienPopupComponent"], {
                    disableClose: false,
                    width: '800px',
    ...
    NhapGoiKhamTuFileExcel() {
        this.dialog.open(_goi_kham_suc_khoe_chon_file_popup_goi_kham_suc_khoe_chon_file_popup_component__WEBPACK_IMPORTED_MODULE_21__["HopDongKhamChonGoiKhamFilePopupComponent"], {
            ...
            if (result) {
                if (result.length > 0) {
                    this.dialog.open(_thong_tin_goi_kham_popup_thong_tin_goi_kham_popup_component__WEBPACK_IMPORTED_MODULE_25__["ThongTinGoiKhamPopupComponent"], {
                        disableClose: false,
                        width: '800px',
    ...
    showPopupDanhSachPhongKhamCongTy(data) {
    ...
    xoaPhongKhamTaiCongTy(id) {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Delete)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.apiService.post("KhamDoan/XoaPhongKhamTaiCongTy?id=" + id).subscribe(() => {
                        this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["Xóa"]));
                        this.gridDanhSachNhanSuGrid.search();
                    }, err => {
                        if (err.Message != "Validation Failed") {
    ...
    xoaDiaDiemDanhSachKham(item) {
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
            ...
            if (result == "Yes") {
                this.dataSachDiaDiemKham.data.splice(this.dataSachDiaDiemKham.data.findIndex((x) => x == item), 1);
            }
        });
    }
    onChangeSetTenCongViec(dataItem, rowIndex) {
        ...
        if (this.authService.hasPermission(this.documentType, securityOperation)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    ...
                    this.apiService.post("KhamDoan/ThemHoacCapNhatHopDongKham", this.khamDoanHopDongKham).subscribe(res => {
                        if (res != 0) {
                            this.id = res;
                            this.router.navigate([this.baseRoute + '/chi-tiet/' + res]);
                            this.getDataHopDongKham(this.id);
                            this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["Lưu"]));
                        }
                        else {
                            this.quayLai();
                        }
    ...
    ketThucHopDong() {
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_16__["ConfirmComponent"], {
            ...
            if (result == "Yes") {
                this.apiService.get("KhamDoan/KiemTraHopDongNhanVienChuaKham?hopDongKhamId=" + this.id).subscribe((resultData) => {
                    if (resultData !== undefined && resultData != null) {
                        if (resultData[0].NhanVienKhamXong) {
                            this.apiService.post("KhamDoan/KetThucHopDongKham?hopDongKhamId=" + this.id).subscribe((resultData) => {
                                this.router.navigateByUrl("/kham-doan/hop-dong-kham");
                                this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["kết thúc hợp đồng"]));
                            }, (err) => {
                                this.validationErrors = err.ValidationErrors;
                                if (err.Message != "Validation Failed") {
                                    this.notificationService.showError(err.Message);
                            ...
                            this.dialog.open(_thong_tin_ket_thuc_hop_popup_thong_tin_ket_thuc_hop_popup_component__WEBPACK_IMPORTED_MODULE_26__["ThongTinKetThucHopDongPopupComponent"], {
                                disableClose: false,
                                width: '900px',
                                data: { hopDongKhamSucKhoeId: this.id }
                            }).afterClosed().subscribe(result => {
    ...
    moLaiThucHopDong() {
        this.dialog.open(_mo_lai_hop_dong_kham_popup_mo_lai_hop_dong_kham_popup_component__WEBPACK_IMPORTED_MODULE_28__["MoLaiHopDongKhamComponent"], {
            ...
            if (result !== null && result != "") {
                let moLaiHopDong = new _kham_doan_hop_dong_kham_model__WEBPACK_IMPORTED_MODULE_20__["MoLaiHopDong"]();
                moLaiHopDong.HopDongKhamSucKhoeId = this.id;
                moLaiHopDong.LyDoMoLaiHopDong = result;
                this.apiService.post("KhamDoan/MoLaiHopDongKham", moLaiHopDong).subscribe((resultData) => {
                    this.router.navigateByUrl("/kham-doan/hop-dong-kham");
                    this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_17__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_11__["SystemMessage"].ActionSuccessfully, ["Mở lại hợp đồng"]));
                }, (err) => {
                    this.validationErrors = err.ValidationErrors;
                    if (err.Message != "Validation Failed") {
                        this.notificationService.showError(err.Message);
...
KhamDoanHopDongKhamDetailPopupComponent.ctorParameters = () => [
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_9__["NotificationService"] },
...
let KhamDoanHopDongKhamListNhanVienPopupComponent = class KhamDoanHopDongKhamListNhanVienPopupComponent {
    constructor(authService, dialog, route, cdRef, notificationService, apiService, data, dialogRef) {
        this.authService = authService;
        this.dialog = dialog;
        this.route = route;
        this.cdRef = cdRef;
    ...
    loaiTienSuBenhChange(dataItem, rowIndex) {
        if (dataItem != undefined && dataItem != null && rowIndex != undefined && rowIndex != null) {
    ...
    xuLyLuuNhanVienCongTy() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Add)) {
            ...
            this.apiService.post("KhamDoan/ThemHoacCapNhatHopDongKhamSucKhoeNhanVien", this.danhSachNhanVienCongTy).subscribe(res => {
                if (res != 0) {
                    this.dialogRef.close("Yes");
                }
            }, err => {
    ...
    xoaCongViecTruocDo(item) {
        this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_19__["ConfirmComponent"], {
            ...
            if (result === 'Yes') {
                this.dataSourceCongViec.data.splice(this.dataSourceCongViec.data.findIndex((x) => x == item), 1);
            }
        });
    }
    ThemTienSuBenh() {
    ...
    showPopupTimNhanVien() {
        this.dialog.open(_kham_doan_hop_dong_kham_tim_nhan_vien_popup_kham_doan_hop_dong_kham_tim_nhan_vien_popup_component__WEBPACK_IMPORTED_MODULE_15__["KhamDoanHopDongKhamTimNhanVienPopupComponent"], {
            ...
            if (result !== undefined && result !== null) {
                ...
                this.danhSachNhanVienCongTy.GioiTinh = result.GioiTinh == 1 ? src_app_shared_enum_common_type_enums__WEBPACK_IMPORTED_MODULE_18__["GioiTinh"].Nam : src_app_shared_enum_common_type_enums__WEBPACK_IMPORTED_MODULE_18__["GioiTinh"].Nu;
    ...
    ThongTinBenhNhanNamSinhChange(event) {
        this.danhSachNhanVienCongTy.Tuoi = new Date().getFullYear() - event;
    }
    getDataHopDongKhamSucKhoeNhanVien(id) {
        this.showPopupLoadingData();
        this.apiService.get("KhamDoan/GetThongTinHopDongKhamSucKhoeNhanVien?hopDongKhamSucKhoeNhanVienId=" + id).subscribe((resultData) => {
            if (resultData !== undefined && resultData != null) {
...
KhamDoanHopDongKhamListNhanVienPopupComponent.ctorParameters = () => [
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
...
let KhamDoanHopDongKhamListComponent = class KhamDoanHopDongKhamListComponent {
    constructor(authService, notificationService, route, location, dialog, apiService, router) {
        this.authService = authService;
        this.notificationService = notificationService;
        this.route = route;
    ...
    xuLyXuatExcel() {
        ...
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Process)) {
            this.apiService.postExportExcel("KhamDoan/ExportDanhSachHopDongKham", this.gridChild._gridQueryInfo).subscribe(res => {
                let dateTimeNow = new Date();
    ...
    xoa(Id) {
        if (this.authService.hasPermission(this.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_19__["SecurityOperation"].Delete)) {
            this.dialog.open(src_app_shared_component_dialogs_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_22__["ConfirmComponent"], {
                ...
                if (result == "Yes") {
                    this.apiService.delete("KhamDoan/XuLyXoaHopDongKham?id=" + Id).subscribe(res => {
                        if (res.Item1) {
                            this.notificationService.showError(res.Item2);
                        }
                        else {
...
KhamDoanHopDongKhamListComponent.ctorParameters = () => [
    { type: src_app_core_services_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_11__["NotificationService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_12__["ActivatedRoute"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_13__["Location"] },
...
let KhamDoanHopDongKhamRoutingModule = class KhamDoanHopDongKhamRoutingModule {
};
...
let KhamDoanHopDongKhamTimNhanVienPopupComponent = class KhamDoanHopDongKhamTimNhanVienPopupComponent {
    constructor(data, dialog, dialogRef, apiService) {
        this.data = data;
        this.dialog = dialog;
        this.dialogRef = dialogRef;
        this.apiService = apiService;
...
KhamDoanHopDongKhamTimNhanVienPopupComponent.ctorParameters = () => [
...
let KhamDoanHopDongKhamModule = class KhamDoanHopDongKhamModule {
};
...
let MoLaiHopDongKhamComponent = class MoLaiHopDongKhamComponent {
...
MoLaiHopDongKhamComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
...
let ThongTinGoiKhamPopupComponent = class ThongTinGoiKhamPopupComponent {
    constructor(dialog, cdRef, data, notificationService, apiService, router, route) {
        this.dialog = dialog;
        this.cdRef = cdRef;
        this.data = data;
        this.notificationService = notificationService;
...
ThongTinGoiKhamPopupComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
...
let ThongTinKetThucHopDongPopupComponent = class ThongTinKetThucHopDongPopupComponent {
    constructor(data, notificationService, dialogRef, dialog, router, apiService) {
        this.data = data;
        this.notificationService = notificationService;
        this.dialogRef = dialogRef;
        this.dialog = dialog;
    ...
    getDataHopDongKhamSucKhoeNhanVien(id) {
        this.apiService.get("KhamDoan/KiemTraHopDongNhanVienChuaKham?hopDongKhamId=" + id).subscribe((resultData) => {
            if (resultData !== undefined && resultData != null) {
    ...
    KetThucHopDongKham() {
        if (this.dataDaKham.length > 0) {
            ...
            this.apiService.post("KhamDoan/KetThucHopDongKham?hopDongKhamId=" + this.hopDongKhamSucKhoeId).subscribe((resultData) => {
                this.notificationService.showSuccess(src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_8__["CommonService"].format(src_app_shared_configdata_system_message__WEBPACK_IMPORTED_MODULE_9__["SystemMessage"].ActionSuccessfully, ["kết thúc hợp đồng"]));
                this.dialogRef.close(null);
                this.router.navigateByUrl("/kham-doan/hop-dong-kham");
            }, (err) => {
                this.validationErrors = err.ValidationErrors;
...
ThongTinKetThucHopDongPopupComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_7__["NotificationService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
...
let ThongTinNhanVienPopupComponent = class ThongTinNhanVienPopupComponent {
    constructor(dialog, cdRef, data, notificationService, apiService, router, route) {
        this.dialog = dialog;
        this.cdRef = cdRef;
        this.data = data;
...
ThongTinNhanVienPopupComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: src_app_core_services_notification_service__WEBPACK_IMPORTED_MODULE_7__["NotificationService"] },
