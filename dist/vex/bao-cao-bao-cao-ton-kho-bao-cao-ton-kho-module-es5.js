...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bao-cao-bao-cao-ton-kho-bao-cao-ton-kho-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTonKhoListComponent = /** @class */ (function () {
                function BaoCaoTonKhoListComponent(apiService, dialog, authService, notificationService, cd) {
                ...
                //end
                BaoCaoTonKhoListComponent.prototype.pageChange = function (event) {
                ...
                BaoCaoTonKhoListComponent.prototype.ngOnInit = function () {
                ...
                BaoCaoTonKhoListComponent.prototype.getFieldColumn = function (index) {
                    return this.gridColumns[index].Field;
                };
                BaoCaoTonKhoListComponent.prototype.getTitleColumn = function (index) {
                    return this.gridColumns[index].Title;
                };
                BaoCaoTonKhoListComponent.prototype.getWidthColumn = function (index) {
                    return this.gridColumns[index].Width != null ? this.gridColumns[index].Width : this.getMinWidthColumn(this.gridColumns[index].MinWidth != null ? this.gridColumns[index].MinWidth : 100);
                };
                BaoCaoTonKhoListComponent.prototype.getMinWidthColumn = function (minWidth) {
                ...
                BaoCaoTonKhoListComponent.prototype.detailExpand = function (event) {
                ...
                BaoCaoTonKhoListComponent.prototype.onDataBoundChild = function (event) {
                    console.log(event);
                    this.dataToSumThanhTien = event.Data;
                };
                BaoCaoTonKhoListComponent.prototype.ngAfterContentInit = function () {
                    var self = this;
                ...
                BaoCaoTonKhoListComponent.prototype.exportExcel = function () {
                    var _this = this;
                ...
                BaoCaoTonKhoListComponent.prototype.reFresh = function () {
                    this.skip = 0;
                    this.XemBaoCao();
                };
                BaoCaoTonKhoListComponent.prototype.XemBaoCao = function () {
                    var _this = this;
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                    ...
                    this.apiService.post("BaoCao/GetDataBaoCaoTonKhoForGridAsync", this.baoCaoSearch).subscribe(function (resultData) {
                ...
                BaoCaoTonKhoListComponent.prototype.InBaoCao = function () {
                    if (this.baoCaoSearch.TuNgayFormat == null || this.baoCaoSearch.DenNgayFormat == null) {
                        this.notificationService.showError("Từ ngày và đến ngày yêu cầu nhập");
                        return;
                    }
                ...
                BaoCaoTonKhoListComponent.prototype.changeValueStart = function () {
                ...
                return BaoCaoTonKhoListComponent;
            }());
            BaoCaoTonKhoListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaoCaoTonKhoPopupComponent = /** @class */ (function () {
                function BaoCaoTonKhoPopupComponent(apiService, dialogRef, dialog, sanitizer, data) {
                    this.apiService = apiService;
                ...
                BaoCaoTonKhoPopupComponent.prototype.ngOnInit = function () {
                    this.inBaoCaoTonKho = this.data;
                    this.showBaoCao();
                };
                BaoCaoTonKhoPopupComponent.prototype.close = function () {
                    this.dialogRef.close();
                };
                BaoCaoTonKhoPopupComponent.prototype.showBaoCao = function () {
                    var _this = this;
                    ...
                    this.apiService.post("BaoCao/InBaoCaoTonKho", this.inBaoCaoTonKho).subscribe(function (resultData) {
                ...
                BaoCaoTonKhoPopupComponent.prototype.getSharedPrintForm = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        _this.apiService.post("BaoCao/InBaoCaoTonKho", _this.inBaoCaoTonKho).subscribe(function (resultData) {
                            resolve(resultData);
                        });
                        _this.close();
                    });
                };
                return BaoCaoTonKhoPopupComponent;
            }());
            BaoCaoTonKhoPopupComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=bao-cao-bao-cao-ton-kho-bao-cao-ton-kho-module-es5.js.map
//# sourceMappingURL=bao-cao-bao-cao-ton-kho-bao-cao-ton-kho-module-es5.js.map