...
let LichSuHuyBanThuocRoutingModule = class LichSuHuyBanThuocRoutingModule {
};
...
let DanhSachHuyBanThuocModule = class DanhSachHuyBanThuocModule {
};
...
let LichSuHuyBanThuocService = class LichSuHuyBanThuocService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
    }
};
LichSuHuyBanThuocService.ctorParameters = () => [
...
let LichSuHuyBanThuocDetailComponent = class LichSuHuyBanThuocDetailComponent {
    ...
    ngOnInit() {
        ...
        const idBenhNhan = this.route.snapshot.params.idBenhNhan;
        const id = this.idTiepNhan;
    ...
    GetThongTinBenhNhanXuatThuoc(id, idBenhNhan) {
        const self = this;
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].View)) {
            self.apiService.post('QuayThuoc/GetThongTinBenhNhanXuatThuoc?ycTiepNhanId=' + id + '&idBenhNhan=' + idBenhNhan).subscribe(resultData => {
    ...
    GetThongTinDonThuoc(id, idTaiKhoanBenhNhanThu) {
        const self = this;
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].View)) {
            self.apiService.post('QuayThuoc/GetDanhSachHuyThuocKhongBHYTLS?tiepNhanId=' + id + '&idTaiKhoanThu=' + idTaiKhoanBenhNhanThu).subscribe(resultData => {
    ...
    InPhieuThu() {
        ...
        let xacNhanInData = new _danh_sach_lich_su_huy_ban_thuoc_model__WEBPACK_IMPORTED_MODULE_12__["XacNhanInViewModel"]();
        xacNhanInData = {
    ...
    InKeThuocKhongBhyt() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_10__["SecurityOperation"].View)) {
            self.apiService.postExportPdf('QuayThuoc/XacNhanHuyBanThuocIn', xacNhanInData).subscribe(resultData => {
                self.dialog.open(_thong_tin_phieu_pdf_popup_thong_tin_phieu_pdf_popup_component__WEBPACK_IMPORTED_MODULE_11__["ThongTinPhieuPdfPopupComponent"], {
                    disableClose: true,
                    width: '1000px',
                    data: { Model: resultData }
...
LichSuHuyBanThuocDetailComponent.ctorParameters = () => [
...
let LichSuHuyBanThuocListComponent = class LichSuHuyBanThuocListComponent {
    ...
    getDropdownItem(obj, keyValue, titleValue) {
        ...
        if (obj != undefined && obj.KeyId != null) {
            if (obj.KeyId == null) {
                ...
                if (index < 0) {
                    let item = new _danh_sach_lich_su_huy_ban_thuoc_model__WEBPACK_IMPORTED_MODULE_22__["TagItem"]();
                    item.Key = keyValue;
    ...
    exportExcel() {
        ...
        if (self.authService.hasPermission(self.documentType, src_app_shared_enum_security_operation_enum__WEBPACK_IMPORTED_MODULE_13__["SecurityOperation"].Process)) {
            self.apiService.postExportExcel('QuayThuoc/ExportLichSuBanThuoc', self.exportQueryInfoQueryInfo).subscribe(resultData => {
    ...
    huyXuatThuoc(thongTinSoPhieuDaThu) {
        var self = this;
        let huyXuatThuocTrongNgay = new _quay_thuoc_model__WEBPACK_IMPORTED_MODULE_20__["HuyXuatThuocTrongNgay"]();
        ...
        self.dialog
            .open(_xac_nhan_phieu_huy_thu_ban_thuoc_xac_nhan_phieu_huy_thu_ban_thuoc_component__WEBPACK_IMPORTED_MODULE_21__["XacNhanHuyThuBanThuocComponent"], { disableClose: true, width: "800px", data: { huyXuatThuocTrongNgay } })
            .afterClosed()
...
LichSuHuyBanThuocListComponent.ctorParameters = () => [
