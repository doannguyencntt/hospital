...
let KetQuaTimKiemRoutingModule = class KetQuaTimKiemRoutingModule {
};
...
let KetQuaTimKiemComponent = class KetQuaTimKiemComponent {
    constructor(route, apiService, router, notificationService) {
        this.route = route;
...
KetQuaTimKiemComponent.ctorParameters = () => [
...
let KetQuaTimKiemModule = class KetQuaTimKiemModule {
};
