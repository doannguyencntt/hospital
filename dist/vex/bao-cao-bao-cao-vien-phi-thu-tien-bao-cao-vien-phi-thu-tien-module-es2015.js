...
let BaoCaoVienPhiThuTienListComponent = class BaoCaoVienPhiThuTienListComponent {
    ...
    totalThanhTienTienmatCapNhat(field) {
        let thanhTien = null;
        switch (field) {
            case 'TienmatCapNhat':
    ...
    ;
    totalThanhTienChuyenKhoanCapNhat(field) {
        let thanhTien = null;
        switch (field) {
    ...
    ;
    totalThanhTienPosCapNhat(field) {
        let thanhTien = null;
        switch (field) {
            case 'PosCapNhat':
                if (this.gridView != undefined) {
    ...
    ;
    totalThanhTienChuyenKhoan(field) {
        let thanhTien = null;
        switch (field) {
            case 'ChuyenKhoan':
                if (this.gridView != undefined) {
    ...
    XemBaoCao() {
        ...
        let baoCaoVienPhiThuTienVo = new _bao_cao_vien_phi_thu_tien_model__WEBPACK_IMPORTED_MODULE_6__["BaoCaoVienPhiThuTienVo"]();
        ...
        this.ishowView = true;
        this.apiService.post("BaoCao/GetBaoCaoThuTienVienPhiForGridAsync", baoCaoVienPhiThuTienVo).subscribe(resultData => {
    ...
    detailExpand(event) {
        ...
        baoCaoVienPhiThuTienVo.TuNgay = this.search.DateStart;
        baoCaoVienPhiThuTienVo.DenNgay = this.search.DateEnd;
        let denNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].formatDateTime(baoCaoVienPhiThuTienVo.TuNgay, "mm/dd/yyyy");
        let tuNgay = src_app_core_utilities_common_helper__WEBPACK_IMPORTED_MODULE_7__["CommonService"].formatDateTime(baoCaoVienPhiThuTienVo.DenNgay, "mm/dd/yyyy");
        baoCaoVienPhiThuTienVo.NhanVienThuNganId = this.search.NhanVienThuNganId;
    ...
    InbaoCao() {
        ...
        if (this.showPrintExport == true) {
            ...
            this.apiService.post("BaoCao/InBaoCaoVienPhiThuTien", baoCaoVienPhiThuTienVo).subscribe((result) => {
                this.dialog.open(_bao_cao_vien_phi_thu_tien_popup_bao_cao_vien_phi_thu_tien_popup_component__WEBPACK_IMPORTED_MODULE_8__["BaoCaoVienPhiThuTienPopupComponent"], {
                    disableClose: true,
                    width: '1000px',
                    data: { Model: result }
...
BaoCaoVienPhiThuTienListComponent.ctorParameters = () => [
...
let BaoCaoVienPhiThuTienPopupComponent = class BaoCaoVienPhiThuTienPopupComponent {
...
BaoCaoVienPhiThuTienPopupComponent.ctorParameters = () => [
...
let BaoCaoVienPhiThuTienRoutingModule = class BaoCaoVienPhiThuTienRoutingModule {
};
...
class SearchBaoCao {
    constructor(DateStart = null, DateEnd = null, NhanVienThuNganId = null, NhanVienThuNgan = null) {
...
class BaoCaoVienPhiThuTienVo {
    constructor(TuNgay = null, DenNgay = null, NhanVienThuNganId = null, hosting = null) {
        this.TuNgay = TuNgay;
...
class BaoCaoVienPhiThuTien {
    constructor(STT = null, Ngay = null, NgayString = null, SoBLHD = null, MaYTe = null, TenBenhNhan = null, SoBenhAn = null, TamUng = null, HoanUng = null, ThuTien = null, Hoan = null, GoiDichVu = null, CongNo = null, Pos = null, ChuyenKhoan = null, Tienmat = null, CongNoCapNhat = null, PosCapNhat = null, ChuyenKhoanCapNhat = null, TienmatCapNhat = null) {
        this.STT = STT;
        this.Ngay = Ngay;
...
let BaoCaoVienPhiThuTienModule = class BaoCaoVienPhiThuTienModule {
};
...
let BaoCaoVienPhiThuTienService = class BaoCaoVienPhiThuTienService extends src_app_core_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(apiService) {
        super(apiService);
        this.controllerName = 'BaoCao';
    }
};
BaoCaoVienPhiThuTienService.ctorParameters = () => [
    { type: src_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
