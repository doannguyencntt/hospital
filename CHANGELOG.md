<img height="60px" width="60px" style="float: left;" src="/assets/img/demo/logo.svg" alt="Camino Logo">
<h2 style="height: 60px; line-height: 60px; margin-left: 70px; font-weight: 500; border: none;">Camino</h2>
